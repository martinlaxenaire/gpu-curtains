...
window.addEventListener('load', async () => {
  ...
  const bundleTransformationBinding = new BufferBinding({
    label: 'Bundle transformations',
    name: 'bundleTransformations',
    bindingType: 'storage',
    visibility: ['vertex'],
    struct: {
      model: {
        type: 'array<mat4x4f>',
        value: new Float32Array(16 * bundleSize),
      },
      modelView: {
      ...
      normal: {
        // normal matrix
        type: 'array<mat3x3f>',
        value: new Float32Array(12 * bundleSize),
      },
    },
  })

  debugBindings.push(bundleTransformationBinding)
