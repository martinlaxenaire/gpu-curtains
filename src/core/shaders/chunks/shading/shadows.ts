...
export const getDefaultShadowDepthVs = (lightShadowIndex = 0, hasInstances = false) => /* wgsl */ `
@vertex fn main(
...
export const getDefaultPointShadowDepthVs = (pointShadowIndex = 0, hasInstances = false) => /* wgsl */ `
