...
export const buildShaders = (
  ...
  if (!shaderParameters) {
    ...
    if (!shaderParameters.ambientContribution) shaderParameters.ambientContribution = defaultAmbientContribution
    if (!shaderParameters.lightContribution) shaderParameters.lightContribution = defaultLightContribution
  }
