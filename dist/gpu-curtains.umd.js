...
`
    ...
    updateModelMatrix() {
      ...
      const coverRatio =
        parentRatio > sourceRatio !== parentWidth > parentHeight
          ...
          ? __privateGet$9(this, _parentRatio).x * __privateGet$9(this, _sourceRatio).x
          : __privateGet$9(this, _sourceRatio).y * __privateGet$9(this, _parentRatio).y
      ...
      this.modelMatrix
        ...
        .premultiplyScale(__privateGet$9(this, _coverScale))
        .premultiplyScale(__privateGet$9(this, _parentRatio))
        .premultiply(__privateGet$9(this, _rotationMatrix))
        .premultiplyScale(__privateGet$9(this, _sourceRatio))
  ...
  class Texture {
     ...
     */
    resize(size = null) {
      if (!__privateGet$7(this, _autoResize)) return
      if (!size) {
        size = {
          width: Math.floor(this.renderer.canvas.width * this.options.qualityRatio),
          height: Math.floor(this.renderer.canvas.height * this.options.qualityRatio),
  ...
  class Scene extends Object3D {
    ...
    addMesh(mesh) {
      ...
      similarMeshes.sort((a, b) => {
        return (
          a.renderOrder - b.renderOrder || //a.material.pipelineEntry.index - b.material.pipelineEntry.index ||
          a.index - b.index
        )
      })
      ...
      this.cameraBinding = new BufferBinding({
        ...
        struct: {
          ...
          position: {
            ...
            onBeforeUpdate: () => {
              this.cameraBinding.inputs.position.value
...
@fragment fn main(fsInput: VSOutput) -> @location(0) vec4f {
      ...
      for (const [primitive, primitiveInstance] of __privateGet(this, _primitiveInstances)) {
        ...
        const materialUniformStruct = {
          ...
          metallicFactor: {
            type: 'f32',
            value:
              material.pbrMetallicRoughness?.metallicFactor === void 0
                ? 1
  ...
  parseData_fn = function (stream, header) {
    ...
    if (hash === 514) {
      ...
      if (header.flipX) __privateMethod(this, _flipX, flipX_fn).call(this, data, header)
      if (header.flipY) __privateMethod(this, _flipY, flipY_fn).call(this, data, header)
    } else {
