...
`
  ...
  class Object3D {
    ...
    updateMatrixStack() {
      ...
      const matrixShouldUpdate = !!Object.keys(this.matrices).find(
        (matrixName) => this.matrices[matrixName].shouldUpdate
      )
    ...
    updateModelMatrix() {
      ...
      const coverRatio =
        parentRatio > sourceRatio !== parentWidth > parentHeight
          ...
          ? __privateGet$7(this, _parentRatio).x * __privateGet$7(this, _sourceRatio).x
          : __privateGet$7(this, _sourceRatio).y * __privateGet$7(this, _parentRatio).y
      ...
      this.modelMatrix
        ...
        .premultiplyScale(__privateGet$7(this, _coverScale))
        .premultiplyScale(__privateGet$7(this, _parentRatio))
        .premultiply(__privateGet$7(this, _rotationMatrix))
        .premultiplyScale(__privateGet$7(this, _sourceRatio))
  ...
  class RenderTexture {
     ...
     */
    resize(size = null) {
      if (!__privateGet$5(this, _autoResize)) return
      if (!size) {
        size = {
          width: Math.floor(this.renderer.displayBoundingRect.width),
          height: Math.floor(this.renderer.displayBoundingRect.height),
  ...
  class Geometry {
     ...
     */
    constructor({ verticesOrder = 'ccw', topology = 'triangle-list', instancesCount = 1, vertexBuffers = [] } = {}) {
      /**
      ...
      (_a = class extends Base {
        ...
        addToScene() {
          ...
          this.setRenderingOptionsForRenderPass(
            this.renderTarget ? this.renderTarget.renderPass : this.renderer.renderPass
          )
...
@fragment fn main(fsInput: VSOutput) -> @location(0) vec4f {
  ...
  class RenderPass {
    ...
    setClearValue(clearValue = [0, 0, 0, 0], colorAttachmentIndex = 0) {
      ...
      if (
        ...
        this.descriptor.colorAttachments[colorAttachmentIndex]
      ) {
  ...
  class GPUDeviceManager {
     ...
     */
    constructor({ label, production = false, onError = () => {}, onDeviceLost = (info) => {} }) {
      this.index = 0
