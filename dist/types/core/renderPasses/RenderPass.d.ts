...
export declare class RenderPass {
     ...
     */
    constructor(renderer: Renderer | GPUCurtains, { label, loadOp, clearValue, targetFormat, sampleCount, depth, depthTexture, depthLoadOp, depthClearValue, }?: RenderPassParams);
    /**
