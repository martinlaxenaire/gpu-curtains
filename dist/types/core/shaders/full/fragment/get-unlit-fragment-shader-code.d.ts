 ...
 */
export declare const getUnlitFragmentShaderCode: ({ chunks, toneMapping, outputColorSpace, fragmentOutput, geometry, additionalVaryings, materialUniform, materialUniformName, baseColorTexture, emissiveTexture, occlusionTexture, }: UnlitFragmentShaderInputParams) => string;
