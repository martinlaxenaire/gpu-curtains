 ...
 */
export declare const getLambertFragmentShaderCode: ({ chunks, toneMapping, outputColorSpace, fragmentOutput, geometry, additionalVaryings, materialUniform, materialUniformName, receiveShadows, baseColorTexture, normalTexture, emissiveTexture, occlusionTexture, }: LambertFragmentShaderInputParams) => string;
