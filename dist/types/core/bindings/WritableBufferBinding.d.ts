...
export declare class WritableBufferBinding extends BufferBinding {
     ...
     */
    constructor({ label, name, bindingType, visibility, useStruct, access, usage, struct, childrenBindings, buffer, parent, minOffset, offset, shouldCopyResult, }: WritableBufferBindingParams);
}
