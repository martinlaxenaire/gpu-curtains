...
export declare class WritableBufferBinding extends BufferBinding {
     ...
     */
    constructor({ label, name, bindingType, visibility, useStruct, access, usage, struct, childrenBindings, parent, minOffset, offset, shouldCopyResult, }: WritableBufferBindingParams);
}
