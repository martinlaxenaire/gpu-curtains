...
export declare class DirectionalShadow extends Shadow {
     ...
     */
    constructor(renderer: CameraRenderer | GPUCurtains, { light, intensity, bias, normalBias, pcfSamples, radius, depthTextureSize, depthTextureFormat, autoRender, useRenderBundle, camera, }?: DirectionalShadowParams);
    /**
     ...
     */
    cast({ intensity, bias, normalBias, pcfSamples, radius, depthTextureSize, depthTextureFormat, autoRender, useRenderBundle, camera, }?: Omit<DirectionalShadowParams, "light">): void;
    /**
