...
export declare class GPUCurtains {
     ...
     */
    constructor({ container, pixelRatio, preferredFormat, alphaMode, production, multisampled, renderPass, camera, autoRender, autoResize, watchScroll, }?: GPUCurtainsParams);
    /**
