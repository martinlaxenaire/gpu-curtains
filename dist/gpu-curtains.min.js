var GPUCurtains=(()=>{var qe=Object.defineProperty;var pt=Object.getOwnPropertyDescriptor;var ct=Object.getOwnPropertyNames;var ft=Object.prototype.hasOwnProperty;var xt=(d,e)=>{for(var t in e)qe(d,t,{get:e[t],enumerable:!0})},gt=(d,e,t,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of ct(e))!ft.call(d,s)&&s!==t&&qe(d,s,{get:()=>e[s],enumerable:!(r=pt(e,s))||r.enumerable});return d};var yt=d=>gt(qe({},"__esModule",{value:!0}),d);var Gt={};xt(Gt,{BindGroup:()=>X,Bindings:()=>Y,Box3:()=>re,BoxGeometry:()=>Ye,BufferBindings:()=>L,Camera:()=>xe,ComputeMaterial:()=>ye,ComputePass:()=>_e,ComputePipelineEntry:()=>Te,DOMElement:()=>W,DOMFrustum:()=>Pe,DOMMesh:()=>de,DOMObject3D:()=>Ce,FullscreenPlane:()=>oe,GPUCameraRenderer:()=>ve,GPUCurtains:()=>Ne,GPUCurtainsRenderer:()=>Oe,GPURenderer:()=>Ue,Geometry:()=>se,IndexedGeometry:()=>Q,Mat4:()=>z,Material:()=>te,Mesh:()=>Ie,Object3D:()=>K,PingPongPlane:()=>We,PipelineEntry:()=>ue,PipelineManager:()=>Ge,Plane:()=>we,PlaneGeometry:()=>ie,ProjectedObject3D:()=>ae,Quat:()=>I,RenderMaterial:()=>be,RenderPass:()=>he,RenderPipelineEntry:()=>Me,RenderTarget:()=>Se,RenderTexture:()=>ne,Sampler:()=>ge,SamplerBindings:()=>fe,Scene:()=>Ee,ShaderPass:()=>$e,SphereGeometry:()=>Xe,Texture:()=>ee,TextureBindGroup:()=>ce,TextureBindings:()=>q,Vec2:()=>j,Vec3:()=>p,WorkBufferBindings:()=>me});var N=()=>"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,d=>{let e=Math.random()*16|0;return(d==="x"?e:e&3|8).toString(16).toUpperCase()}),ze=d=>d.replace(/(?:^\w|[A-Z]|\b\w)/g,(e,t)=>t===0?e.toLowerCase():e.toUpperCase()).replace(/\s+/g,""),le=d=>{let e=ze(d);return e.charAt(0).toUpperCase()+e.slice(1)},Qe=0,k=d=>{Qe>100||(console.warn(Qe===100?"GPUCurtains: too many warnings thrown, stop logging.":d),Qe++)};var A=d=>{throw new Error(d)};var Ze=(d,e="GPURenderer",t)=>{let r=t?`Unable to create ${t} because the ${e} is not defined: ${d}`:`The ${e} is not defined: ${d}`;A(r)},P=(d,e)=>{let t=d&&(d.type==="GPURenderer"||d.type==="GPUCameraRenderer"||d.type==="GPUCurtainsRenderer");return t||Ze(d,"GPURenderer",e),t},J=(d,e)=>{let t=d&&(d.type==="GPUCameraRenderer"||d.type==="GPUCurtainsRenderer");return t||Ze(d,"GPUCameraRenderer",e),t},pe=(d,e)=>{let t=d&&d.type==="GPUCurtainsRenderer";return t||Ze(d,"GPUCurtainsRenderer",e),t},tt=((d,e)=>{let t,r,s={};return function(n,o){r||(r=n.createShaderModule({label:"textured quad shaders for mip level generation",code:`
            struct VSOutput {
...
`;var Ve={vertex:{get_scaled_uv:et},fragment:{get_scaled_uv:et,get_vertex_to_uv_coords:lt}},De={vertex:{get_output_position:ht},fragment:{}};var Me=class extends ue{constructor(t){let{renderer:r}=t,{label:s,cullMode:i,depthWriteEnabled:n,depthCompare:o,transparent:u,verticesOrder:a,useProjection:h}=t;r=r&&r.renderer||r;let l="RenderPipelineEntry";P(r,s?s+" "+l:l);super(t);this.type=l,this.shaders={vertex:{head:"",code:"",module:null},fragment:{head:"",code:"",module:null},full:{code:"",module:null}},this.descriptor=null,this.options={...this.options,cullMode:i,depthWriteEnabled:n,depthCompare:o,transparent:u,verticesOrder:a,useProjection:h}}setPipelineEntryBindGroups(t){this.bindGroups="cameraBindGroup"in this.renderer&&this.options.useProjection?[this.renderer.cameraBindGroup,...t]:t}setPipelineEntryBuffers(t){let{attributes:r,bindGroups:s}=t;this.attributes=r,this.setPipelineEntryBindGroups(s),this.setPipelineEntry()}patchShaders(){this.shaders.vertex.head="",this.shaders.vertex.code="",this.shaders.fragment.head="",this.shaders.fragment.code="";for(let r in Ve.vertex)this.shaders.vertex.head=`${Ve.vertex[r]}
