var GPUCurtains=(()=>{var Xe=Object.defineProperty;var xt=Object.getOwnPropertyDescriptor;var gt=Object.getOwnPropertyNames;var yt=Object.prototype.hasOwnProperty;var Pt=(d,e)=>{for(var t in e)Xe(d,t,{get:e[t],enumerable:!0})},bt=(d,e,t,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of gt(e))!yt.call(d,s)&&s!==t&&Xe(d,s,{get:()=>e[s],enumerable:!(r=xt(e,s))||r.enumerable});return d};var Bt=d=>bt(Xe({},"__esModule",{value:!0}),d);var Et={};Pt(Et,{BindGroup:()=>Q,Binding:()=>q,Box3:()=>te,BoxGeometry:()=>Qe,BufferBinding:()=>L,Camera:()=>ge,ComputeMaterial:()=>Pe,ComputePass:()=>_e,ComputePipelineEntry:()=>Te,DOMElement:()=>H,DOMFrustum:()=>be,DOMMesh:()=>ue,DOMObject3D:()=>Ce,FullscreenPlane:()=>ne,GPUCameraRenderer:()=>ve,GPUCurtains:()=>qe,GPUCurtainsRenderer:()=>Oe,GPURenderer:()=>Ue,Geometry:()=>re,IndexedGeometry:()=>X,Mat4:()=>z,Material:()=>ee,Mesh:()=>We,Object3D:()=>J,PingPongPlane:()=>He,PipelineEntry:()=>ae,PipelineManager:()=>Ge,Plane:()=>we,PlaneGeometry:()=>se,ProjectedObject3D:()=>oe,Quat:()=>W,RenderMaterial:()=>Be,RenderPass:()=>de,RenderPipelineEntry:()=>Me,RenderTarget:()=>Se,RenderTexture:()=>ie,Sampler:()=>ye,SamplerBinding:()=>xe,Scene:()=>Ee,ShaderPass:()=>$e,SphereGeometry:()=>Ye,Texture:()=>K,TextureBindGroup:()=>fe,TextureBinding:()=>Y,Vec2:()=>j,Vec3:()=>m,WritableBufferBinding:()=>le});var I=()=>"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,d=>{let e=Math.random()*16|0;return(d==="x"?e:e&3|8).toString(16).toUpperCase()}),ze=d=>d.replace(/(?:^\w|[A-Z]|\b\w)/g,(e,t)=>t===0?e.toLowerCase():e.toUpperCase()).replace(/\s+/g,""),he=d=>{let e=ze(d);return e.charAt(0).toUpperCase()+e.slice(1)},Ze=0,k=d=>{Ze>100||(console.warn(Ze===100?"GPUCurtains: too many warnings thrown, stop logging.":d),Ze++)};var A=d=>{throw new Error(d)};var Je=(d,e="GPURenderer",t)=>{let r=t?`Unable to create ${t} because the ${e} is not defined: ${d}`:`The ${e} is not defined: ${d}`;A(r)},g=(d,e)=>{let t=d&&(d.type==="GPURenderer"||d.type==="GPUCameraRenderer"||d.type==="GPUCurtainsRenderer");return t||Je(d,"GPURenderer",e),t},pe=(d,e)=>{let t=d&&(d.type==="GPUCameraRenderer"||d.type==="GPUCurtainsRenderer");return t||Je(d,"GPUCameraRenderer",e),t},ce=(d,e)=>{let t=d&&d.type==="GPUCurtainsRenderer";return t||Je(d,"GPUCurtainsRenderer",e),t},rt=(()=>{let d,e,t={};return function(s,i){e||(e=s.createShaderModule({label:"textured quad shaders for mip level generation",code:`
            struct VSOutput {
...
`;var Ve={vertex:{get_uv_cover:tt},fragment:{get_uv_cover:tt,get_vertex_to_uv_coords:ct}},De={vertex:{get_output_position:pt},fragment:{}};var Me=class extends ae{constructor(t){let{renderer:r}=t,{label:s,cullMode:i,depthWriteEnabled:n,depthCompare:o,transparent:u,verticesOrder:a,useProjection:h}=t;r=r&&r.renderer||r;let l="RenderPipelineEntry";g(r,s?s+" "+l:l);super(t);this.type=l,this.shaders={vertex:{head:"",code:"",module:null},fragment:{head:"",code:"",module:null},full:{code:"",module:null}},this.descriptor=null,this.options={...this.options,cullMode:i,depthWriteEnabled:n,depthCompare:o,transparent:u,verticesOrder:a,useProjection:h}}setPipelineEntryBindGroups(t){this.bindGroups="cameraBindGroup"in this.renderer&&this.options.useProjection?[this.renderer.cameraBindGroup,...t]:t}setPipelineEntryProperties(t){let{attributes:r,bindGroups:s}=t;this.attributes=r,this.setPipelineEntryBindGroups(s),this.setPipelineEntry()}patchShaders(){this.shaders.vertex.head="",this.shaders.vertex.code="",this.shaders.fragment.head="",this.shaders.fragment.code="";for(let r in Ve.vertex)this.shaders.vertex.head=`${Ve.vertex[r]}
