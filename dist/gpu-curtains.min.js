var GPUCurtains=(()=>{var tt=Object.defineProperty;var Rt=Object.getOwnPropertyDescriptor;var Tt=Object.getOwnPropertyNames;var Gt=Object.prototype.hasOwnProperty;var Ct=(h,e)=>{for(var t in e)tt(h,t,{get:e[t],enumerable:!0})},wt=(h,e,t,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of Tt(e))!Gt.call(h,s)&&s!==t&&tt(h,s,{get:()=>e[s],enumerable:!(r=Rt(e,s))||r.enumerable});return h};var Et=h=>wt(tt({},"__esModule",{value:!0}),h);var Vt={};Ct(Vt,{BindGroup:()=>J,Binding:()=>Z,Box3:()=>ne,BoxGeometry:()=>Ke,BufferBinding:()=>j,Camera:()=>Ge,ComputeMaterial:()=>we,ComputePass:()=>qe,ComputePipelineEntry:()=>Pe,DOMElement:()=>Y,DOMFrustum:()=>Ee,DOMMesh:()=>le,DOMObject3D:()=>Oe,FullscreenPlane:()=>ue,GPUCameraRenderer:()=>De,GPUCurtains:()=>Je,GPUCurtainsRenderer:()=>Le,GPURenderer:()=>Ve,Geometry:()=>oe,IndexedGeometry:()=>te,Mat4:()=>w,Material:()=>ie,Mesh:()=>Qe,Object3D:()=>ee,PingPongPlane:()=>Xe,PipelineEntry:()=>he,PipelineManager:()=>Se,Plane:()=>ze,PlaneGeometry:()=>ae,ProjectedObject3D:()=>de,Quat:()=>k,RenderMaterial:()=>Ue,RenderPass:()=>me,RenderPipelineEntry:()=>ye,RenderTarget:()=>Fe,RenderTexture:()=>I,Sampler:()=>Ce,SamplerBinding:()=>Te,Scene:()=>Ae,ShaderPass:()=>Ye,SphereGeometry:()=>et,Texture:()=>_,TextureBindGroup:()=>ge,TextureBinding:()=>K,Vec2:()=>W,Vec3:()=>c,WritableBufferBinding:()=>xe});var F=()=>"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,h=>{let e=Math.random()*16|0;return(h==="x"?e:e&3|8).toString(16).toUpperCase()}),ce=h=>h.replace(/(?:^\w|[A-Z]|\b\w)/g,(e,t)=>t===0?e.toLowerCase():e.toUpperCase()).replace(/\s+/g,""),ke=h=>{let e=ce(h);return e.charAt(0).toUpperCase()+e.slice(1)},rt=0,A=h=>{rt>100||(console.warn(rt===100?"GPUCurtains: too many warnings thrown, stop logging.":h),rt++)};var S=h=>{throw new Error(h)};var st=(h,e="GPURenderer",t)=>{let r=t?`Unable to create ${t} because the ${e} is not defined: ${h}`:`The ${e} is not defined: ${h}`;S(r)},b=(h,e)=>{let t=h&&(h.type==="GPURenderer"||h.type==="GPUCameraRenderer"||h.type==="GPUCurtainsRenderer");return t||st(h,"GPURenderer",e),t},Be=(h,e)=>{let t=h&&(h.type==="GPUCameraRenderer"||h.type==="GPUCurtainsRenderer");return t||st(h,"GPUCameraRenderer",e),t},Me=(h,e)=>{let t=h&&h.type==="GPUCurtainsRenderer";return t||st(h,"GPUCurtainsRenderer",e),t},lt=(()=>{let h,e,t={};return function(s,i){e||(e=s.createShaderModule({label:"textured quad shaders for mip level generation",code:`
            struct VSOutput {
...
`;var Ie={vertex:{get_uv_cover:ht},fragment:{get_uv_cover:ht,get_vertex_to_uv_coords:Bt}},$e={vertex:{get_output_position:bt},fragment:{}};var ye=class extends he{constructor(t){let{renderer:r}=t,{label:s,cullMode:i,depthWriteEnabled:n,depthCompare:o,transparent:a,verticesOrder:u,topology:d,useProjection:l}=t;r=r&&r.renderer||r;let m="RenderPipelineEntry";b(r,s?s+" "+m:m);super(t);this.type=m,this.shaders={vertex:{head:"",code:"",module:null},fragment:{head:"",code:"",module:null},full:{code:"",module:null}},this.descriptor=null,this.options={...this.options,cullMode:i,depthWriteEnabled:n,depthCompare:o,transparent:a,verticesOrder:u,topology:d,useProjection:l}}setPipelineEntryBindGroups(t){this.bindGroups="cameraBindGroup"in this.renderer&&this.options.useProjection?[this.renderer.cameraBindGroup,...t]:t}setPipelineEntryProperties(t){let{attributes:r,bindGroups:s}=t;this.attributes=r,this.setPipelineEntryBindGroups(s),this.setPipelineEntry()}patchShaders(){this.shaders.vertex.head="",this.shaders.vertex.code="",this.shaders.fragment.head="",this.shaders.fragment.code="";for(let r in Ie.vertex)this.shaders.vertex.head=`${Ie.vertex[r]}
