var GPUCurtains=(()=>{var Xe=Object.defineProperty;var pt=Object.getOwnPropertyDescriptor;var ct=Object.getOwnPropertyNames;var ft=Object.prototype.hasOwnProperty;var xt=(u,e)=>{for(var t in e)Xe(u,t,{get:e[t],enumerable:!0})},gt=(u,e,t,r)=>{if(e&&typeof e=="object"||typeof e=="function")for(let s of ct(e))!ft.call(u,s)&&s!==t&&Xe(u,s,{get:()=>e[s],enumerable:!(r=pt(e,s))||r.enumerable});return u};var yt=u=>gt(Xe({},"__esModule",{value:!0}),u);var Tt={};xt(Tt,{BindGroup:()=>Y,Bindings:()=>q,Box3:()=>te,BoxGeometry:()=>qe,BufferBindings:()=>L,Camera:()=>xe,ComputeMaterial:()=>ye,ComputePass:()=>Le,ComputePipelineEntry:()=>Me,DOMElement:()=>H,DOMFrustum:()=>Pe,DOMMesh:()=>de,DOMObject3D:()=>Te,FullscreenPlane:()=>ne,GPUCameraRenderer:()=>Ue,GPUCurtains:()=>Ne,GPUCurtainsRenderer:()=>Se,GPURenderer:()=>Ee,Geometry:()=>re,IndexedGeometry:()=>Q,Mat4:()=>z,Material:()=>ee,Mesh:()=>Ie,Object3D:()=>J,PingPongPlane:()=>$e,PipelineEntry:()=>ae,PipelineManager:()=>Ge,Plane:()=>Ce,PlaneGeometry:()=>se,ProjectedObject3D:()=>oe,Quat:()=>W,RenderMaterial:()=>be,RenderPass:()=>ue,RenderPipelineEntry:()=>Be,RenderTarget:()=>ve,RenderTexture:()=>ie,Sampler:()=>ge,SamplerBindings:()=>fe,Scene:()=>we,ShaderPass:()=>We,SphereGeometry:()=>Ye,Texture:()=>K,TextureBindGroup:()=>ce,TextureBindings:()=>X,Vec2:()=>I,Vec3:()=>m,WorkBufferBindings:()=>le});var j=()=>"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,u=>{let e=Math.random()*16|0;return(u==="x"?e:e&3|8).toString(16).toUpperCase()}),Oe=u=>u.replace(/(?:^\w|[A-Z]|\b\w)/g,(e,t)=>t===0?e.toLowerCase():e.toUpperCase()).replace(/\s+/g,""),he=u=>{let e=Oe(u);return e.charAt(0).toUpperCase()+e.slice(1)},Qe=0,k=u=>{Qe>100||(console.warn(Qe===100?"GPUCurtains: too many warnings thrown, stop logging.":u),Qe++)};var V=u=>{throw new Error(u)};var Ze=(u,e="GPURenderer",t)=>{let r=t?`Unable to create ${t} because the ${e} is not defined: ${u}`:`The ${e} is not defined: ${u}`;V(r)},g=(u,e)=>{let t=u&&(u.type==="GPURenderer"||u.type==="GPUCameraRenderer"||u.type==="GPUCurtainsRenderer");return t||Ze(u,"GPURenderer",e),t},me=(u,e)=>{let t=u&&(u.type==="GPUCameraRenderer"||u.type==="GPUCurtainsRenderer");return t||Ze(u,"GPUCameraRenderer",e),t},pe=(u,e)=>{let t=u&&u.type==="GPUCurtainsRenderer";return t||Ze(u,"GPUCurtainsRenderer",e),t},tt=(()=>{let u,e,t={};return function(s,i){e||(e=s.createShaderModule({label:"textured quad shaders for mip level generation",code:`
            struct VSOutput {
...
`;var Ve={vertex:{get_uv_cover:et},fragment:{get_uv_cover:et,get_vertex_to_uv_coords:lt}},Ae={vertex:{get_output_position:ht},fragment:{}};var Be=class extends ae{constructor(t){let{renderer:r}=t,{label:s,cullMode:i,depthWriteEnabled:n,depthCompare:o,transparent:d,verticesOrder:a,useProjection:h}=t;r=r&&r.renderer||r;let l="RenderPipelineEntry";g(r,s?s+" "+l:l);super(t);this.type=l,this.shaders={vertex:{head:"",code:"",module:null},fragment:{head:"",code:"",module:null},full:{code:"",module:null}},this.descriptor=null,this.options={...this.options,cullMode:i,depthWriteEnabled:n,depthCompare:o,transparent:d,verticesOrder:a,useProjection:h}}setPipelineEntryBindGroups(t){this.bindGroups="cameraBindGroup"in this.renderer&&this.options.useProjection?[this.renderer.cameraBindGroup,...t]:t}setPipelineEntryProperties(t){let{attributes:r,bindGroups:s}=t;this.attributes=r,this.setPipelineEntryBindGroups(s),this.setPipelineEntry()}patchShaders(){this.shaders.vertex.head="",this.shaders.vertex.code="",this.shaders.fragment.head="",this.shaders.fragment.code="";for(let r in Ve.vertex)this.shaders.vertex.head=`${Ve.vertex[r]}
${this.shaders.vertex.head}`;for(let r in Ve.fragment)this.shaders.fragment.head=`${Ve.fragment[r]}
${this.shaders.fragment.head}`;if(this.options.useProjection){for(let r in Ae.vertex)this.shaders.vertex.head=`${Ae.vertex[r]}
