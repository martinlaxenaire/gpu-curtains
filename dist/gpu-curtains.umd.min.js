...
`:""}
  ...
  normal = getWorldNormal(normal);
    `,t},"getVertexSkinnedPositionNormal"),ws=c(({bindings:n=[],geometry:e})=>{let t="";return t+=Za({bindings:n,geometry:e}),t+=`
  var worldPosition: vec4f = vec4(position, 1.0);
  `,t+=Ja({bindings:n,geometry:e}),t},"getVertexTransformedPositionNormal"),Qa=c((n=0,{bindings:e=[],geometry:t})=>`
@vertex fn main(
  attributes: Attributes,
...
}`,"getDefaultPointShadowDepthVs"),ro=c((n=0)=>`
struct PointShadowVSOutput {
  @builtin(position) position: vec4f,
  @location(0) worldPosition: vec3f,
}
...
`,go=c(n=>{const e=n.shadowCastingLights.filter(i=>i.type==="directionalLights"),t=Math.max(n.lightsBindingParams.directionalLights.max,1);return`
...
fn getPCFPointShadowContribution(index: i32, shadowPosition: vec4f, depthCubeTexture: texture_depth_cube) -> f32 {
  ...
  return visibility;
}`,xo=c(n=>{const e=n.shadowCastingLights.filter(i=>i.type==="pointLights"),t=Math.max(n.lightsBindingParams.pointLights.max,1);return`
...
`);this.shaders.compute.code=this.shaders.compute.head+this.options.shaders.compute.code}createShaders(){this.patchShaders(),this.shaders.compute.module=this.createShaderModule({code:this.shaders.compute.code,type:"compute"})}createPipelineDescriptor(){this.shaders.compute.module&&(this.descriptor={label:this.options.label,layout:this.layout,compute:{module:this.shaders.compute.module,entryPoint:this.options.shaders.compute.entryPoint}})}createComputePipeline(){if(this.shaders.compute.module)try{this.pipeline=this.renderer.createComputePipeline(this.descriptor)}catch(e){this.status.error=e,ee(e)}}async createComputePipelineAsync(){if(this.shaders.compute.module)try{this.pipeline=await this.renderer.createComputePipelineAsync(this.descriptor),this.status.compiled=!0,this.status.compiling=!1,this.status.error=null}catch(e){this.status.error=e,ee(e)}}async compilePipelineEntry(){super.compilePipelineEntry(),this.options.useAsync?await this.createComputePipelineAsync():(this.createComputePipeline(),this.status.compiled=!0,this.status.compiling=!1,this.status.error=null)}}class xn{static{c(this,"PipelineManager")}constructor(){this.type="PipelineManager",this.currentPipelineIndex=null,this.pipelineEntries=[],this.activeBindGroups=[]}compareShaders(e,t){return e.code===t.code&&e.entryPoint===t.entryPoint}isSameRenderPipeline(e){return this.pipelineEntries.filter(t=>t instanceof tt).find(t=>{const{options:i}=t,{shaders:s,rendering:r,cacheKey:a}=e,o=a===i.cacheKey,h=this.compareShaders(s.vertex,i.shaders.vertex),l=!s.fragment&&!i.shaders.fragment||this.compareShaders(s.fragment,i.shaders.fragment),u=Jr(r,i.rendering);return o&&!u.length&&h&&l})}createRenderPipeline(e){const{renderer:t,attributes:i,bindGroups:s,cacheKey:r,options:a}=e,{shaders:o,label:h,useAsyncPipeline:l,rendering:u}=a,d={renderer:t,label:h+" render pipeline",shaders:o,useAsync:l,bindGroups:s,cacheKey:r,rendering:u,attributes:i},f=this.isSameRenderPipeline(d);if(f)return f;{const p=new tt(d);return this.pipelineEntries.push(p),p}}isSameComputePipeline(e){return this.pipelineEntries.filter(t=>t instanceof Rs).find(t=>{const{options:i}=t,{shaders:s,cacheKey:r}=e,a=r===i.cacheKey,o=this.compareShaders(s.compute,i.shaders.compute);return a&&o})}createComputePipeline(e){const{renderer:t,bindGroups:i,cacheKey:s,options:r}=e,{shaders:a,label:o,useAsyncPipeline:h}=r,l={renderer:t,label:o+" compute pipeline",shaders:a,useAsync:h,bindGroups:i,cacheKey:s},u=this.isSameComputePipeline(l);if(u)return u;{const d=new Rs(l);return this.pipelineEntries.push(d),d}}setCurrentPipeline(e,t){t.index!==this.currentPipelineIndex&&(e.setPipeline(t.pipeline),this.currentPipelineIndex=t.index)}setActiveBindGroups(e,t){t.forEach((i,s)=>{(!this.activeBindGroups[s]||this.activeBindGroups[s].uuid!==i.uuid||this.activeBindGroups[s].index!==i.index)&&(this.activeBindGroups[s]=i,e.setBindGroup(i.index,i.bindGroup))})}resetCurrentPipeline(){this.currentPipelineIndex=null,this.activeBindGroups=[]}}class vo{static{c(this,"ResizeManager")}constructor(){this.shouldWatch=!0,this.entries=[],typeof window=="object"&&"ResizeObserver"in window&&(this.resizeObserver=new ResizeObserver(e=>{e.map(i=>this.entries.filter(s=>s.element.isSameNode(i.target))).flat().sort((i,s)=>s.priority-i.priority)?.forEach(i=>{i&&i.callback&&i.callback()})}))}useObserver(e=!0){this.shouldWatch=e}observe({element:e,priority:t,callback:i}){if(!e||!this.shouldWatch)return;this.resizeObserver?.observe(e);const s={element:e,priority:t,callback:i};this.entries.push(s)}unobserve(e){this.resizeObserver?.unobserve(e),this.entries=this.entries.filter(t=>!t.element.isSameNode(e))}destroy(){this.resizeObserver?.disconnect()}}const Es=new vo;class zs{static{c(this,"DOMElement")}constructor({element:e=document.body,priority:t=1,onSizeChanged:i=c((r=null)=>{},"onSizeChanged"),onPositionChanged:s=c((r=null)=>{},"onPositionChanged")}={}){if(typeof e=="string"){if(this.element=document.querySelector(e),!this.element){const r=typeof e=="string"?`'${e}' selector`:`${e} HTMLElement`;ee(`DOMElement: corresponding ${r} not found.`)}}else this.element=e;this.priority=t,this.isResizing=!1,this.onSizeChanged=i,this.onPositionChanged=s,this.resizeManager=Es,this.resizeManager.observe({element:this.element,priority:this.priority,callback:()=>{this.setSize()}}),this.setSize()}compareBoundingRect(e,t){return!["x","y","left","top","right","bottom","width","height"].some(i=>e[i]!==t[i])}get boundingRect(){return this._boundingRect}set boundingRect(e){const t=!!this.boundingRect&&this.compareBoundingRect(e,this.boundingRect);this._boundingRect={top:e.top,right:e.right,bottom:e.bottom,left:e.left,width:e.width,height:e.height,x:e.x,y:e.y},t||this.onSizeChanged(this.boundingRect)}updateScrollPosition(e={x:0,y:0}){this.isResizing||(this._boundingRect.top+=e.y,this._boundingRect.left+=e.x,(e.x||e.y)&&this.onPositionChanged(this.boundingRect))}setSize(e=null){!this.element||this.isResizing||(this.isResizing=!0,this.boundingRect=e??this.element.getBoundingClientRect(),setTimeout(()=>{this.isResizing=!1},10))}destroy(){this.resizeManager.unobserve(this.element)}}const bo=new y,wo=new y,As=new y,_s=new y;class vn extends xe{static{c(this,"Scene")}constructor({renderer:e}){super(),e=$(e,"Scene"),this.renderer=e,this.computePassEntries=[],this.renderPassEntries={pingPong:[],renderTarget:[],prePass:[],screen:[],postProPass:[]}}createScreenPassEntry(e="",t=1){const i={label:e,renderPass:this.renderer.renderPass,renderTexture:null,onBeforeRenderPass:null,onAfterRenderPass:null,element:null,stack:{unProjected:{opaque:[],transparent:[]},projected:{opaque:[],transparent:[]}}};return t>=0?this.renderPassEntries.screen.push(i):this.renderPassEntries.screen.unshift(i),i}setMainRenderPassEntry(){this.createScreenPassEntry("Main scene screen render pass")}getRenderPassEntryLength(e){return e?e.element?e.element.visible?1:0:e.stack.unProjected.opaque.length+e.stack.unProjected.transparent.length+e.stack.projected.opaque.length+e.stack.projected.transparent.length:0}addComputePass(e){this.computePassEntries.push(e),this.computePassEntries.sort((t,i)=>t.renderOrder!==i.renderOrder?t.renderOrder-i.renderOrder:t.index-i.index)}removeComputePass(e){this.computePassEntries=this.computePassEntries.filter(t=>t.uuid!==e.uuid)}addRenderTarget(e){this.renderPassEntries.renderTarget.find(t=>t.renderPass.uuid===e.renderPass.uuid)||this.renderPassEntries.renderTarget.push({label:e.options.label,renderPass:e.renderPass,renderTexture:e.renderTexture,onBeforeRenderPass:null,onAfterRenderPass:null,element:null,stack:{unProjected:{opaque:[],transparent:[]},projected:{opaque:[],transparent:[]}}})}removeRenderTarget(e){this.renderPassEntries.renderTarget=this.renderPassEntries.renderTarget.filter(t=>t.renderPass.uuid!==e.renderPass.uuid)}getRenderTargetPassEntry(e=null){return e?this.renderPassEntries.renderTarget.find(t=>t.renderPass.uuid===e.renderPass.uuid):this.renderPassEntries.screen.find(t=>t.renderPass.uuid===this.renderer.renderPass.uuid)}getMeshProjectionStack(e){const t=e.options.useCustomScenePassEntry?e.options.useCustomScenePassEntry:"transmissive"in e.options&&e.options.transmissive?this.renderer.transmissionTarget.passEntry:this.getRenderTargetPassEntry(e.outputTarget),{stack:i}=t;return e.material.options.rendering.useProjection?i.projected:i.unProjected}orderStack(e){e.sort((t,i)=>t.renderOrder-i.renderOrder||t.index-i.index)}isStackObjectRenderBundle(e){return e.type==="RenderBundle"}addMeshToRenderTargetStack(e,t=null){const i=this.getRenderTargetPassEntry(t),{stack:s}=i,r=e.material.options.rendering.useProjection?s.projected:s.unProjected,o=!!e.transparent?r.transparent:r.opaque;o.push(e),this.orderStack(o)}addMesh(e){e.renderBundle&&e.renderBundle.addMesh(e,e.outputTarget?e.outputTarget.renderPass:this.renderer.renderPass);const{useProjection:t}=e.material.options.rendering;if(!e.renderBundle){const i=this.getMeshProjectionStack(e),r=!!e.transparent?i.transparent:i.opaque;r.push(e),this.orderStack(r)}"parent"in e&&!e.parent&&t&&(e.parent=this)}removeMesh(e){if(e.renderBundle)e.renderBundle.removeMesh(e,!1);else{const t=e.material.options.rendering.useProjection?"projected":"unProjected",s=!!e.transparent?"transparent":"opaque";for(const r of Object.values(this.renderPassEntries))r.forEach(a=>{a.stack&&(a.stack[t][s]=a.stack[t][s].filter(o=>o.uuid!==e.uuid))})}if("transmissive"in e.options&&e.options.transmissive){const t=this.renderer.transmissionTarget.passEntry;(t?this.getRenderPassEntryLength(t):0)===0&&this.renderer.destroyTransmissionTarget()}"parent"in e&&e.parent&&e.parent.object3DIndex===this.object3DIndex&&(e.parent=null)}addRenderBundle(e,t){const i=e.transparent?t.transparent:t.opaque;i.push(e),this.orderStack(i)}removeRenderBundle(e){const i=!!e.useProjection?"projected":"unProjected",r=!!e.transparent?"transparent":"opaque",a=this.renderPassEntries.renderTarget.find(o=>o.renderPass.uuid===e.options.renderPass?.uuid);if(a){const{stack:o}=a,h=o[i];h[r]=h[r].filter(l=>l.uuid!==e.uuid)}else this.renderPassEntries.screen.forEach(o=>{o.stack&&(o.stack[i][r]=o.stack[i][r].filter(h=>h.uuid!==e.uuid))})}addShaderPass(e){const t=e.inputTarget||e.outputTarget?null:(o,h)=>{e.renderTexture&&h&&o.copyTextureToTexture({texture:h},{texture:e.renderTexture.texture},[e.renderTexture.size.width,e.renderTexture.size.height]),this.renderer.postProcessingPass.setLoadOp("clear")},i=!e.outputTarget&&e.options.copyOutputToRenderTexture?(o,h)=>{e.renderTexture&&h&&o.copyTextureToTexture({texture:h},{texture:e.renderTexture.texture},[e.renderTexture.size.width,e.renderTexture.size.height])}:null,s=e.outputTarget?e.outputTarget.renderPass:e.options.isPrePass?this.renderer.renderPass:this.renderer.postProcessingPass,a={label:e.options.isPrePass?e.options.label+" scene pre pass":e.options.label+" scene post processing pass",renderPass:s,renderTexture:e.outputTarget?e.outputTarget.renderTexture:null,onBeforeRenderPass:t,onAfterRenderPass:i,element:e,stack:null};if(e.renderBundle){const{renderBundle:o}=e;o.meshes.size>=1?(A(`${o.options.label} (${o.type}): Cannot add more than 1 ShaderPass to a render bundle. This ShaderPass will not be added: ${e.options.label}`),e.renderBundle=null):o.addMesh(e,s)}e.options.isPrePass?(this.renderPassEntries.prePass.push(a),this.renderPassEntries.prePass.sort((o,h)=>o.element.renderOrder-h.element.renderOrder||o.element.index-h.element.index)):(this.renderPassEntries.postProPass.push(a),this.renderPassEntries.postProPass.sort((o,h)=>{const l=o.element&&!o.element.outputTarget,u=o.element?o.element.renderOrder:0,d=o.element?o.element.index:0,f=h.element&&!h.element.outputTarget,p=h.element?h.element.renderOrder:0,m=h.element?h.element.index:0;return l&&!f?1:!l&&f?-1:u!==p?u-p:d-m}))}removeShaderPass(e){e.renderBundle&&e.renderBundle.empty(),e.options.isPrePass?this.renderPassEntries.prePass=this.renderPassEntries.prePass.filter(t=>!t.element||t.element.uuid!==e.uuid):this.renderPassEntries.postProPass=this.renderPassEntries.postProPass.filter(t=>!t.element||t.element.uuid!==e.uuid)}addPingPongPlane(e){if(this.renderPassEntries.pingPong.push({label:e.options.label+" scene pass",renderPass:e.outputTarget.renderPass,renderTexture:e.outputTarget.renderTexture,onBeforeRenderPass:null,onAfterRenderPass:(t,i)=>{t.copyTextureToTexture({texture:i},{texture:e.renderTexture.texture},[e.renderTexture.size.width,e.renderTexture.size.height])},element:e,stack:null}),e.renderBundle){const{renderBundle:t}=e;t.meshes.size>=1?(A(`${t.options.label} (${t.type}): Cannot add more than 1 PingPongPlane to a render bundle. This PingPongPlane will not be added: ${e.options.label}`),e.renderBundle=null):t.addMesh(e,e.outputTarget.renderPass)}this.renderPassEntries.pingPong.sort((t,i)=>t.element.renderOrder-i.element.renderOrder)}removePingPongPlane(e){e.renderBundle&&e.renderBundle.empty(),this.renderPassEntries.pingPong=this.renderPassEntries.pingPong.filter(t=>t.element.uuid!==e.uuid)}getObjectRenderPassEntry(e){if(e.type==="RenderTarget")return this.renderPassEntries.renderTarget.find(t=>t.renderPass.uuid===e.renderPass.uuid);if(e.type==="PingPongPlane")return this.renderPassEntries.pingPong.find(t=>t.element.uuid===e.uuid);if(e.type==="ShaderPass")return this.renderPassEntries.screen.find(t=>t.element?.uuid===e.uuid);{const t=e.outputTarget?"renderTarget":"screen";return e.renderBundle?this.renderPassEntries[t].find(i=>[...i.stack.unProjected.opaque,...i.stack.unProjected.transparent,...i.stack.projected.opaque,...i.stack.projected.transparent].filter(s=>s.type==="RenderBundle").some(s=>s.meshes.get(e.uuid))):this.renderPassEntries[t].find(i=>[...i.stack.unProjected.opaque,...i.stack.unProjected.transparent,...i.stack.projected.opaque,...i.stack.projected.transparent].some(s=>s.uuid===e.uuid))}}sortTransparentMeshes(e){e.sort((t,i)=>{if(t.renderOrder!==i.renderOrder||this.isStackObjectRenderBundle(t)||this.isStackObjectRenderBundle(i))return t.renderOrder-i.renderOrder;t.geometry?As.copy(t.geometry.boundingBox.center).applyMat4(t.worldMatrix):t.worldMatrix.getTranslation(As),i.geometry?_s.copy(i.geometry.boundingBox.center).applyMat4(i.worldMatrix):i.worldMatrix.getTranslation(_s);const s=t.geometry?t.geometry.boundingBox.radius*t.worldMatrix.getMaxScaleOnAxis():0,r=i.geometry?i.geometry.boundingBox.radius*i.worldMatrix.getMaxScaleOnAxis():0;return i.camera.worldMatrix.getTranslation(wo).distance(_s)-r-(t.camera.worldMatrix.getTranslation(bo).distance(As)-s)})}renderSinglePassEntry(e,t){const i=t.renderPass.updateView(t.renderTexture?.texture);t.onBeforeRenderPass&&t.onBeforeRenderPass(e,i);const s=e.beginRenderPass(t.renderPass.descriptor);if(this.renderer.production||s.pushDebugGroup(t.element?`${t.element.options.label} render pass using ${t.renderPass.options.label} descriptor`:`Render stack pass using ${t.renderPass.options.label}${t.renderTexture?" onto "+t.renderTexture.options.label:""}`),t.element)t.element.renderBundle?t.element.renderBundle.render(s):t.element.render(s);else if(t.stack){for(const r of t.stack.unProjected.opaque)r.render(s);for(const r of t.stack.unProjected.transparent)r.render(s);if(t.stack.projected.opaque.length||t.stack.projected.transparent.length){for(const r of t.stack.projected.opaque)r.render(s);this.sortTransparentMeshes(t.stack.projected.transparent);for(const r of t.stack.projected.transparent)r.render(s)}}this.renderer.production||s.popDebugGroup(),s.end(),t.onAfterRenderPass&&t.onAfterRenderPass(e,i),this.renderer.pipelineManager.resetCurrentPipeline()}onBeforeRender(){for(let e=0,t=this.renderer.meshes.length;e<t;e++)this.renderer.meshes[e].onBeforeRenderScene();this.renderer.animations.forEach(e=>e.update()),this.updateMatrixStack(),this.renderer.animations.forEach(e=>e.onAfterUpdate());for(const e of this.renderer.meshes)"checkFrustumCulling"in e&&e.visible&&e.checkFrustumCulling()}render(e){for(const t of this.computePassEntries){const i=e.beginComputePass();this.renderer.production||i.pushDebugGroup(`${t.options.label}: begin compute pass`),t.render(i),this.renderer.production||i.popDebugGroup(),i.end(),t.copyBufferToResult(e),this.renderer.pipelineManager.resetCurrentPipeline()}for(const t in this.renderPassEntries){t==="postProPass"&&this.renderer.renderPass.setDepthLoadOp("clear");let i=0;this.renderPassEntries[t].forEach(s=>{if(!this.getRenderPassEntryLength(s))return;const r=t==="screen"&&(i!==0||this.renderPassEntries.prePass.length),a=t==="postProPass"||t==="prePass"&&i!==0||r;s.renderPass.setLoadOp(a?"load":"clear"),r&&s.renderPass.setDepthLoadOp("load"),i++,this.renderSinglePassEntry(e,s)})}}}var bn=c((n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},"__accessCheck$b"),wn=c((n,e,t)=>(bn(n,e,"read from private field"),t?t.call(n):e.get(n)),"__privateGet$8"),Bo=c((n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},"__privateAdd$b"),Co=c((n,e,t,i)=>(bn(n,e,"write to private field"),e.set(n,t),t),"__privateSet$8"),So=c((n,e,t,i)=>({set _(s){Co(n,e,s)},get _(){return wn(n,e,i)}}),"__privateWrapper"),wi;class Bi{static{c(this,"TasksQueueManager")}constructor(){Bo(this,wi,0),this.queue=[]}add(e=s=>{},{order:t=this.queue.length,once:i=!1}={}){const s={callback:e,order:t,once:i,id:wn(this,wi)};return So(this,wi)._++,this.queue.push(s),this.queue.sort((r,a)=>r.order-a.order),s.id}remove(e=0){this.queue=this.queue.filter(t=>t.id!==e)}execute(e){this.queue.forEach(t=>{t.callback(e),t.once&&this.remove(t.id)})}}wi=new WeakMap;class Ls{static{c(this,"GPURenderer")}constructor({deviceManager:e,label:t,container:i,pixelRatio:s=1,autoResize:r=!0,context:a={},renderPass:o}){this._onBeforeRenderCallback=p=>{},this._onAfterRenderCallback=p=>{},this._onResizeCallback=()=>{},this._onAfterResizeCallback=()=>{},this.type="GPURenderer",this.uuid=O(),(!e||e.constructor.name!=="GPUDeviceManager")&&ee(t?`${t} (${this.type}): no device manager or wrong device manager provided: ${e}`:`${this.type}: no device manager or wrong device manager provided: ${e}`),t||(t=`${this.constructor.name}${e.renderers.length}`),this.deviceManager=e,this.deviceManager.addRenderer(this),this.shouldRender=!0,this.shouldRenderScene=!0;const h={alphaMode:"premultiplied",format:this.deviceManager.gpu?.getPreferredCanvasFormat(),...a};o={useDepth:!0,sampleCount:4,...o},this.options={deviceManager:e,label:t,container:i,pixelRatio:s,autoResize:r,context:h,renderPass:o},this.pixelRatio=s??window.devicePixelRatio??1;const l=i instanceof OffscreenCanvas,u=l||i instanceof HTMLCanvasElement;this.canvas=u?i:document.createElement("canvas");const{width:d,height:f}=this.canvas;this.rectBBox={width:d,height:f,top:0,left:0},this.setScene(),this.setTasksQueues(),this.setRendererObjects(),l||(this.domElement=new zs({element:i,priority:5,onSizeChanged:()=>{this.options.autoResize&&this.resize()}}),this.resize(),u||this.domElement.element.appendChild(this.canvas)),this.deviceManager.device&&this.setContext()}setSize(e=null){e={width:Math.max(1,this.boundingRect.width),height:Math.max(1,this.boundingRect.height),top:this.boundingRect.top,left:this.boundingRect.left,...e},this.rectBBox=e;const t={width:this.rectBBox.width,height:this.rectBBox.height};t.width*=this.pixelRatio,t.height*=this.pixelRatio,this.clampToMaxDimension(t),this.canvas.width=Math.floor(t.width),this.canvas.height=Math.floor(t.height),this.canvas.style&&(this.canvas.style.width=this.rectBBox.width+"px",this.canvas.style.height=this.rectBBox.height+"px")}setPixelRatio(e=1){this.pixelRatio=e,this.resize(this.rectBBox)}resize(e=null){this.setSize(e),this._onResizeCallback&&this._onResizeCallback(),this.resizeObjects(),this._onAfterResizeCallback&&this._onAfterResizeCallback()}resizeObjects(){this.textures.forEach(e=>{e.resize()}),this.renderPass?.resize(),this.postProcessingPass?.resize(),this.renderTargets.forEach(e=>e.resize()),this.computePasses.forEach(e=>e.resize()),this.pingPongPlanes.forEach(e=>e.resize(this.boundingRect)),this.shaderPasses.forEach(e=>e.resize(this.boundingRect)),this.resizeMeshes()}resizeMeshes(){this.meshes.forEach(e=>{e.resize(this.boundingRect)})}get boundingRect(){if(this.domElement&&this.domElement.boundingRect)return this.domElement.boundingRect;if(this.domElement){const e=this.domElement.element?.getBoundingClientRect();return{top:e.top,right:e.right,bottom:e.bottom,left:e.left,width:e.width,height:e.height,x:e.x,y:e.y}}else return{top:this.rectBBox.top,right:this.rectBBox.left+this.rectBBox.width,bottom:this.rectBBox.top+this.rectBBox.height,left:this.rectBBox.left,width:this.rectBBox.width,height:this.rectBBox.height,x:this.rectBBox.left,y:this.rectBBox.top}}clampToMaxDimension(e){this.device&&(e.width=Math.min(this.device.limits.maxTextureDimension2D,e.width),e.height=Math.min(this.device.limits.maxTextureDimension2D,e.height))}get device(){return this.deviceManager.device}get ready(){return this.deviceManager.ready&&!!this.context&&!!this.canvas.width&&!!this.canvas.height}get production(){return this.deviceManager.production}get samplers(){return this.deviceManager.samplers}get buffers(){return this.deviceManager.buffers}get indirectBuffers(){return this.deviceManager.indirectBuffers}get pipelineManager(){return this.deviceManager.pipelineManager}get deviceRenderedObjects(){return this.deviceManager.deviceRenderedObjects}configureContext(){this.context.configure({device:this.device,...this.options.context,usage:GPUTextureUsage.RENDER_ATTACHMENT|GPUTextureUsage.COPY_SRC|GPUTextureUsage.COPY_DST})}setContext(){this.context=this.canvas.getContext("webgpu"),this.device&&(this.configureContext(),this.setMainRenderPasses())}loseContext(){this.renderBundles.forEach(e=>e.loseContext()),this.renderedObjects.forEach(e=>e.loseContext())}restoreContext(){this.configureContext(),this.textures.forEach(e=>{e.createTexture()}),this.renderPass?.resize(),this.postProcessingPass?.resize(),this.renderTargets.forEach(e=>e.resize()),this.renderedObjects.forEach(e=>e.restoreContext())}setMainRenderPasses(){this.renderPass=new di(this,{label:this.options.label+" render pass",...this.options.renderPass}),this.scene.setMainRenderPassEntry(),this.postProcessingPass=new di(this,{label:this.options.label+" post processing render pass",useDepth:!1,sampleCount:1})}setScene(){this.scene=new vn({renderer:this})}createBuffer(e){const t=this.deviceManager.device?.createBuffer(e.options);return this.deviceManager.addBuffer(e),t}removeBuffer(e){this.deviceManager.removeBuffer(e)}queueWriteBuffer(e,t,i){this.deviceManager.device?.queue.writeBuffer(e,t,i)}copyBufferToBuffer({srcBuffer:e,dstBuffer:t,commandEncoder:i}){if(!e||!e.GPUBuffer)return A(`${this.options.label} (${this.type}): cannot copy to buffer because the source buffer has not been provided`),null;if(t||(t=new Ne),t.GPUBuffer||t.createBuffer(this,{label:`GPURenderer (${this.options.label}): destination copy buffer from: ${e.options.label}`,size:e.GPUBuffer.size,usage:["copyDst","mapRead"]}),e.GPUBuffer.mapState!=="unmapped"){A(`${this.options.label} (${this.type}): Cannot copy from ${e.GPUBuffer} because it is currently mapped`);return}if(t.GPUBuffer.mapState!=="unmapped"){A(`${this.options.label} (${this.type}): Cannot copy from ${t.GPUBuffer} because it is currently mapped`);return}const s=!!i;if(s||(i=this.deviceManager.device?.createCommandEncoder({label:`${this.type} (${this.options.label}): Copy buffer command encoder`}),!this.production&&i.pushDebugGroup(`${this.type} (${this.options.label}): Copy buffer command encoder`)),i.copyBufferToBuffer(e.GPUBuffer,0,t.GPUBuffer,0,t.GPUBuffer.size),!s){!this.production&&i.popDebugGroup();const r=i.finish();this.deviceManager.device?.queue.submit([r])}return t}get bindGroups(){return this.deviceManager.bindGroups}addBindGroup(e){this.deviceManager.addBindGroup(e)}removeBindGroup(e){this.deviceManager.removeBindGroup(e)}createBindGroupLayout(e){return this.deviceManager.device?.createBindGroupLayout(e)}createBindGroup(e){return this.deviceManager.device?.createBindGroup(e)}createShaderModule(e){return this.device?.createShaderModule(e)}createPipelineLayout(e){return this.device?.createPipelineLayout(e)}createRenderPipeline(e){return this.device?.createRenderPipeline(e)}async createRenderPipelineAsync(e){return await this.device?.createRenderPipelineAsync(e)}createComputePipeline(e){return this.device?.createComputePipeline(e)}async createComputePipelineAsync(e){return await this.device?.createComputePipelineAsync(e)}get domTextures(){return this.deviceManager.domTextures}addDOMTexture(e){this.deviceManager.addDOMTexture(e)}removeDOMTexture(e){this.deviceManager.removeDOMTexture(e)}addTexture(e){this.textures.push(e)}removeTexture(e){this.textures=this.textures.filter(t=>t.uuid!==e.uuid)}createTexture(e){return this.deviceManager.device?.createTexture(e)}uploadTexture(e){this.deviceManager.uploadTexture(e)}generateMips(e,t=null){this.deviceManager.generateMips(e,t)}importExternalTexture(e){return this.deviceManager.device?.importExternalTexture({source:e})}createSampler(e){const t=this.samplers.find(i=>JSON.stringify(i.options)===JSON.stringify(e.options)&&i.sampler);if(t)return t.sampler;{const{type:i,...s}=e.options,r=this.deviceManager.device?.createSampler({label:e.label,...s});return this.deviceManager.addSampler(e),r}}removeSampler(e){this.deviceManager.removeSampler(e)}setTasksQueues(){this.onBeforeCommandEncoderCreation=new Bi,this.onBeforeRenderScene=new Bi,this.onAfterRenderScene=new Bi,this.onAfterCommandEncoderSubmission=new Bi}setRendererObjects(){this.computePasses=[],this.pingPongPlanes=[],this.shaderPasses=[],this.renderTargets=[],this.meshes=[],this.textures=[],this.renderBundles=new Map,this.animations=new Map}get renderedObjects(){return[...this.computePasses,...this.meshes,...this.shaderPasses,...this.pingPongPlanes]}getObjectsByBindGroup(e){return this.deviceRenderedObjects.filter(t=>[...t.material.bindGroups,...t.material.inputsBindGroups,...t.material.clonedBindGroups].some(i=>i.uuid===e.uuid))}getObjectsByTexture(e){return this.deviceRenderedObjects.filter(t=>[...t.material.domTextures,...t.material.textures].some(i=>i.uuid===e.uuid))}onBeforeRender(e){return e&&(this._onBeforeRenderCallback=e),this}onAfterRender(e){return e&&(this._onAfterRenderCallback=e),this}onResize(e){return e&&(this._onResizeCallback=e),this}onAfterResize(e){return e&&(this._onAfterResizeCallback=e),this}renderSingleComputePass(e,t){const i=e.beginComputePass();t.render(i),i.end(),t.copyBufferToResult(e)}renderSingleMesh(e,t){const i=e.beginRenderPass(this.renderPass.descriptor);t.render(i),i.end()}renderOnce(e){const t=this.device?.createCommandEncoder({label:"Render once command encoder"});!this.production&&t.pushDebugGroup("Render once command encoder"),this.pipelineManager.resetCurrentPipeline(),e.forEach(s=>{s.type==="ComputePass"?this.renderSingleComputePass(t,s):this.renderSingleMesh(t,s)}),!this.production&&t.popDebugGroup();const i=t.finish();this.device?.queue.submit([i]),this.pipelineManager.resetCurrentPipeline()}forceClear(e){const t=!!e;if(t||(e=this.device?.createCommandEncoder({label:`${this.type} (${this.options.label}): Force clear command encoder`}),!this.production&&e.pushDebugGroup(`${this.type} (${this.options.label}): Force clear command encoder`)),this.renderPass.updateView(),this.renderPass.setLoadOp("clear"),this.renderPass.setDepthLoadOp("clear"),e.beginRenderPass(this.renderPass.descriptor).end(),!t){!this.production&&e.popDebugGroup();const s=e.finish();this.device?.queue.submit([s])}}onBeforeCommandEncoder(){this.ready&&(this.shouldRenderScene&&this.scene?.onBeforeRender(),this.onBeforeCommandEncoderCreation.execute())}onAfterCommandEncoder(){this.ready&&this.onAfterCommandEncoderSubmission.execute()}render(e){!this.ready||!this.shouldRender||(this._onBeforeRenderCallback&&this._onBeforeRenderCallback(e),this.onBeforeRenderScene.execute(e),this.shouldRenderScene&&this.scene?.render(e),this._onAfterRenderCallback&&this._onAfterRenderCallback(e),this.onAfterRenderScene.execute(e))}destroy(){this.deviceManager.renderers=this.deviceManager.renderers.filter(e=>e.uuid!==this.uuid),this.domElement?.destroy(),this.renderBundles.forEach(e=>e.destroy()),this.animations=new Map,this.renderPass?.destroy(),this.postProcessingPass?.destroy(),this.renderTargets.forEach(e=>e.destroy()),this.renderedObjects.forEach(e=>e.remove()),this.textures.forEach(e=>e.destroy()),this.context?.unconfigure()}}var Bn=c((n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},"__accessCheck$a"),Mo=c((n,e,t)=>(Bn(n,e,"read from private field"),e.get(n)),"__privateGet$7"),To=c((n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},"__privateAdd$a"),Ds=c((n,e,t,i)=>(Bn(n,e,"write to private field"),e.set(n,t),t),"__privateSet$7"),st;class Fs extends Ls{static{c(this,"GPUCameraRenderer")}constructor({deviceManager:e,label:t,container:i,pixelRatio:s=1,autoResize:r=!0,context:a={},renderPass:o,camera:h={},lights:l={}}){super({deviceManager:e,label:t,container:i,pixelRatio:s,autoResize:r,context:a,renderPass:o}),To(this,st,void 0),this.type="GPUCameraRenderer",h={fov:50,near:.1,far:1e3,...h},l!==!1&&(l={maxAmbientLights:2,maxDirectionalLights:5,maxPointLights:5,...l}),this.options={...this.options,camera:h,lights:l},this.bindings={},Ds(this,st,!0),this.lights=[],this.setCamera(h),this.setCameraBinding(),this.options.lights&&(this.setLightsBinding(),this.setShadowsBinding()),this.setCameraLightsBindGroup(),this.transmissionTarget={sampler:new He(this,{label:"Transmission sampler",name:"transmissionSampler",magFilter:"linear",minFilter:"linear",mipmapFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"})}}loseContext(){super.loseContext(),this.cameraLightsBindGroup.loseContext()}restoreContext(){super.restoreContext(),this.cameraLightsBindGroup?.restoreContext(),this.updateCameraBindings()}setCamera(e){const{width:t,height:i}=this.rectBBox;this.useCamera(new ls({fov:e.fov,near:e.near,far:e.far,width:t,height:i,pixelRatio:this.pixelRatio,onMatricesChanged:()=>{this.onCameraMatricesChanged()}}))}useCamera(e){if(!(this.camera&&e&&this.camera.uuid===e.uuid)&&(this.camera&&(this.camera.parent=null,this.camera.onMatricesChanged=()=>{}),this.camera=e,this.camera.parent=this.scene,this.bindings.camera)){this.camera.onMatricesChanged=()=>this.onCameraMatricesChanged(),this.bindings.camera.inputs.view.value=this.camera.viewMatrix,this.bindings.camera.inputs.projection.value=this.camera.projectionMatrix;for(const t of this.meshes)"modelViewMatrix"in t&&(t.camera=this.camera)}}onCameraMatricesChanged(){this.updateCameraBindings();for(const e of this.meshes)"modelViewMatrix"in e&&e.shouldUpdateProjectionMatrixStack()}setCameraBinding(){this.bindings.camera=new X({label:"Camera",name:"camera",visibility:["vertex","fragment"],struct:{view:{type:"mat4x4f",value:this.camera.viewMatrix},projection:{type:"mat4x4f",value:this.camera.projectionMatrix},position:{type:"vec3f",value:this.camera.position.clone().setFromMatrixPosition(this.camera.worldMatrix),onBeforeUpdate:()=>{this.bindings.camera.inputs.position.value.copy(this.camera.position).setFromMatrixPosition(this.camera.worldMatrix)}}}})}addLight(e){this.lights.push(e),this.bindings[e.type].inputs.count.value++,this.bindings[e.type].inputs.count.shouldUpdate=!0}removeLight(e){this.lights=this.lights.filter(t=>t.uuid!==e.uuid),this.bindings[e.type].inputs.count.value--,this.bindings[e.type].inputs.count.shouldUpdate=!0}setLightsBinding(){if(!this.options.lights)return;this.lightsBindingParams={ambientLights:{max:this.options.lights.maxAmbientLights,label:"Ambient lights",params:{color:{type:"array<vec3f>",size:3}}},directionalLights:{max:this.options.lights.maxDirectionalLights,label:"Directional lights",params:{color:{type:"array<vec3f>",size:3},direction:{type:"array<vec3f>",size:3}}},pointLights:{max:this.options.lights.maxPointLights,label:"Point lights",params:{color:{type:"array<vec3f>",size:3},position:{type:"array<vec3f>",size:3},range:{type:"array<f32>",size:1}}}},Object.keys({ambientLights:null,directionalLights:null,pointLights:null}).forEach(t=>{this.setLightsTypeBinding(t)})}setLightsTypeBinding(e){const t=Object.keys(this.lightsBindingParams[e].params).map(i=>({key:i,type:this.lightsBindingParams[e].params[i].type,size:this.lightsBindingParams[e].params[i].size})).reduce((i,s)=>(i[s.key]={type:s.type,value:new Float32Array(Math.max(this.lightsBindingParams[e].max,1)*s.size)},i),{});this.bindings[e]=new X({label:this.lightsBindingParams[e].label,name:e,bindingType:"storage",visibility:["vertex","fragment","compute"],struct:{count:{type:"i32",value:0},...t}})}onMaxLightOverflow(e){this.production||A(`${this.options.label} (${this.type}): You are overflowing the current max lights count of '${this.lightsBindingParams[e].max}' for this type of lights: ${e}. This should be avoided by setting a larger ${"max"+e.charAt(0).toUpperCase()+e.slice(1)} when instancing your ${this.type}.`),this.lightsBindingParams[e].max++;const t=this.cameraLightsBindGroup.getBindingByName(e);t&&this.cameraLightsBindGroup.destroyBufferBinding(t),this.setLightsTypeBinding(e);const i=this.cameraLightsBindGroup.bindings.findIndex(s=>s.name===e);if(i!==-1?this.cameraLightsBindGroup.bindings[i]=this.bindings[e]:(this.bindings[e].shouldResetBindGroup=!0,this.bindings[e].shouldResetBindGroupLayout=!0,this.cameraLightsBindGroup.addBinding(this.bindings[e]),this.shouldUpdateCameraLightsBindGroup()),e==="directionalLights"||e==="pointLights"){const s=e.replace("Lights","")+"Shadows",r=this.cameraLightsBindGroup.getBindingByName(s);r&&this.cameraLightsBindGroup.destroyBufferBinding(r),this.setShadowsTypeBinding(e);const a=this.cameraLightsBindGroup.bindings.findIndex(o=>o.name===s);a!==-1?this.cameraLightsBindGroup.bindings[a]=this.bindings[s]:(this.bindings[s].shouldResetBindGroup=!0,this.bindings[s].shouldResetBindGroupLayout=!0,this.cameraLightsBindGroup.addBinding(this.bindings[s]),this.shouldUpdateCameraLightsBindGroup())}this.cameraLightsBindGroup.resetEntries(),this.cameraLightsBindGroup.createBindGroup(),this.lights.forEach(s=>{s.type===e&&s.reset()})}get shadowCastingLights(){return this.lights.filter(e=>e.type==="directionalLights"||e.type==="pointLights")}setShadowsBinding(){this.shadowsBindingsStruct={directional:eo,point:oo},this.setShadowsTypeBinding("directionalLights"),this.setShadowsTypeBinding("pointLights")}setShadowsTypeBinding(e){const t=e.replace("Lights",""),i=t+"Shadows",s=this.shadowsBindingsStruct[t],r=t.charAt(0).toUpperCase()+t.slice(1)+" shadows";this.bindings[i]=new X({label:r,name:i,bindingType:"storage",visibility:["vertex","fragment","compute"],childrenBindings:[{binding:new X({label:r+" element",name:i+"Elements",bindingType:"uniform",visibility:["vertex","fragment"],struct:s}),count:Math.max(1,this.lightsBindingParams[e].max),forceArray:!0}]})}setCameraLightsBindGroup(){this.cameraLightsBindGroup=new Kt(this,{label:this.options.label+": Camera and lights uniform bind group",bindings:Object.keys(this.bindings).map(e=>this.bindings[e]).flat()}),this.cameraLightsBindGroup.consumers.add(this.uuid)}setCameraBindGroup(){this.cameraLightsBindGroup&&this.cameraLightsBindGroup.shouldCreateBindGroup&&(this.cameraLightsBindGroup.setIndex(0),this.cameraLightsBindGroup.createBindGroup())}shouldUpdateCameraLightsBindGroup(){Ds(this,st,!0)}updateCameraBindings(){this.bindings.camera?.shouldUpdateBinding("view"),this.bindings.camera?.shouldUpdateBinding("projection"),this.bindings.camera?.shouldUpdateBinding("position"),this.shouldUpdateCameraLightsBindGroup()}updateCameraLightsBindGroup(){this.cameraLightsBindGroup&&Mo(this,st)&&(this.cameraLightsBindGroup.update(),Ds(this,st,!1))}getObjectsByBindGroup(e){return this.deviceRenderedObjects.filter(t=>[...t.material.bindGroups,...t.material.inputsBindGroups,...t.material.clonedBindGroups,this.cameraLightsBindGroup].some(i=>i.uuid===e.uuid))}setPerspective({fov:e,near:t,far:i}={}){this.camera?.setPerspective({fov:e,near:t,far:i,width:this.rectBBox.width,height:this.rectBBox.height,pixelRatio:this.pixelRatio})}setCameraPosition(e=new y(0,0,1)){this.camera.position.copy(e)}createTransmissionTarget(){this.transmissionTarget.texture||(this.transmissionTarget.passEntry=this.scene.createScreenPassEntry("Transmission scene screen render pass"),this.transmissionTarget.texture=new j(this,{label:"Transmission background scene render target output",name:"transmissionBackgroundTexture",generateMips:!0,format:this.options.context.format,autoDestroy:!1}),this.transmissionTarget.passEntry.onBeforeRenderPass=(e,t)=>{e.copyTextureToTexture({texture:t},{texture:this.transmissionTarget.texture.texture},[this.transmissionTarget.texture.size.width,this.transmissionTarget.texture.size.height]),this.generateMips(this.transmissionTarget.texture,e)})}destroyTransmissionTarget(){this.transmissionTarget.texture&&(this.transmissionTarget.texture.destroy(),this.scene.renderPassEntries.screen=this.scene.renderPassEntries.screen.filter(e=>e.label!=="Transmission scene screen render pass"),this.transmissionTarget.texture=null,this.transmissionTarget.passEntry=null)}resize(e=null){this.setSize(e),this.setPerspective(),this._onResizeCallback&&this._onResizeCallback(),this.resizeObjects(),this._onAfterResizeCallback&&this._onAfterResizeCallback()}render(e){this.ready&&(this.setCameraBindGroup(),this.updateCameraLightsBindGroup(),super.render(e),this.cameraLightsBindGroup&&(this.cameraLightsBindGroup.needsPipelineFlush=!1))}destroy(){this.cameraLightsBindGroup?.destroy(),this.lights.forEach(e=>e.remove()),this.destroyTransmissionTarget(),super.destroy()}}st=new WeakMap;var Cn=c((n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},"__accessCheck$9"),Re=c((n,e,t)=>(Cn(n,e,"read from private field"),t?t.call(n):e.get(n)),"__privateGet$6"),Po=c((n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},"__privateAdd$9"),Ro=c((n,e,t,i)=>(Cn(n,e,"write to private field"),e.set(n,t),t),"__privateSet$6"),pe;class Sn{static{c(this,"GPUDeviceManager")}constructor({label:e,production:t=!1,adapterOptions:i={},autoRender:s=!0,onError:r=c(()=>{},"onError"),onDeviceLost:a=c(h=>{},"onDeviceLost"),onDeviceDestroyed:o=c(h=>{},"onDeviceDestroyed")}={}){this._onBeforeRenderCallback=()=>{},this._onAfterRenderCallback=()=>{},Po(this,pe,void 0),this.index=0,this.label=e??"GPUDeviceManager instance",this.production=t,this.ready=!1,this.adapterOptions=i,this.onError=r,this.onDeviceLost=a,this.onDeviceDestroyed=o,this.gpu=navigator.gpu,this.setPipelineManager(),this.setDeviceObjects(),Ro(this,pe,{sampler:null,module:null,pipelineByFormat:{}}),s&&this.animate()}async setAdapterAndDevice({adapter:e=null,device:t=null}={}){await this.setAdapter(e),await this.setDevice(t)}async init({adapter:e=null,device:t=null}={}){if(await this.setAdapterAndDevice({adapter:e,device:t}),this.device)for(const i of this.renderers)i.context||i.setContext()}async setAdapter(e=null){if(this.gpu||(this.onError(),ee("GPUDeviceManager: WebGPU is not supported on your browser/OS. No 'gpu' object in 'navigator'.")),e)this.adapter=e;else try{this.adapter=await this.gpu?.requestAdapter(this.adapterOptions),this.adapter||(this.onError(),ee("GPUDeviceManager: WebGPU is not supported on your browser/OS. 'requestAdapter' failed."))}catch(t){this.onError(),ee("GPUDeviceManager: "+t.message)}}async setDevice(e=null){if(e)this.device=e,this.ready=!0,this.index++;else try{const t=[];this.adapter.features.has("float32-filterable")&&t.push("float32-filterable"),this.device=await this.adapter?.requestDevice({label:this.label+" "+this.index,requiredFeatures:t}),this.device&&(this.ready=!0,this.index++)}catch(t){this.onError(),ee(`${this.label}: WebGPU is not supported on your browser/OS. 'requestDevice' failed: ${t}`)}this.device?.lost.then(t=>{A(`${this.label}: WebGPU device was lost: ${t.message}`),this.loseDevice(),t.reason!=="destroyed"?this.onDeviceLost(t):this.onDeviceDestroyed(t)})}setPipelineManager(){this.pipelineManager=new xn}loseDevice(){this.ready=!1,this.pipelineManager.resetCurrentPipeline(),this.samplers.forEach(e=>e.sampler=null),this.renderers.forEach(e=>e.loseContext()),this.bindGroupLayouts.clear(),this.buffers.clear()}async restoreDevice({adapter:e=null,device:t=null}={}){await this.setAdapterAndDevice({adapter:e,device:t}),this.device&&(this.samplers.forEach(i=>{const{type:s,...r}=i.options;i.sampler=this.device.createSampler({label:i.label,...r})}),this.indirectBuffers.forEach(i=>i.create()),this.renderers.forEach(i=>i.restoreContext()))}setDeviceObjects(){this.renderers=[],this.bindGroups=new Map,this.buffers=new Map,this.indirectBuffers=new Map,this.bindGroupLayouts=new Map,this.bufferBindings=new Map,this.samplers=[],this.domTextures=[],this.texturesQueue=[]}addRenderer(e){this.renderers.push(e)}removeRenderer(e){this.renderers=this.renderers.filter(t=>t.uuid!==e.uuid)}get deviceRenderedObjects(){return this.renderers.map(e=>e.renderedObjects).flat()}addBindGroup(e){this.bindGroups.set(e.uuid,e)}removeBindGroup(e){this.bindGroups.delete(e.uuid)}addBuffer(e){this.buffers.set(e.uuid,e)}removeBuffer(e){this.buffers.delete(e?.uuid)}addSampler(e){this.samplers.push(e)}removeSampler(e){this.samplers=this.samplers.filter(t=>t.uuid!==e.uuid)}addDOMTexture(e){this.domTextures.push(e)}uploadTexture(e){if(e.source)try{this.device?.queue.copyExternalImageToTexture({source:e.source,flipY:e.options.flipY},{texture:e.texture,premultipliedAlpha:e.options.premultipliedAlpha},{width:e.size.width,height:e.size.height}),e.texture.mipLevelCount>1&&this.generateMips(e),this.texturesQueue.push(e)}catch({message:t}){ee(`GPUDeviceManager: could not upload texture: ${e.options.name} because: ${t}`)}else this.device?.queue.writeTexture({texture:e.texture},new Uint8Array(e.options.placeholderColor),{bytesPerRow:e.size.width*4},{width:e.size.width,height:e.size.height})}generateMips(e,t=null){if(!this.device)return;Re(this,pe).module||(Re(this,pe).module=this.device.createShaderModule({label:"textured quad shaders for mip level generation",code:`
          ...
          `}),Re(this,pe).sampler=this.device.createSampler({minFilter:"linear",magFilter:"linear"})),Re(this,pe).pipelineByFormat[e.texture.format]||(Re(this,pe).pipelineByFormat[e.texture.format]=this.device.createRenderPipeline({label:"Mip level generator pipeline",layout:"auto",vertex:{module:Re(this,pe).module},fragment:{module:Re(this,pe).module,targets:[{format:e.texture.format}]}}));const i=Re(this,pe).pipelineByFormat[e.texture.format],s=t||this.device.createCommandEncoder({label:"Mip gen encoder"});let r=e.texture.width,a=e.texture.height,o=0;for(;r>1||a>1;){r=Math.max(1,r/2|0),a=Math.max(1,a/2|0);for(let h=0;h<e.texture.depthOrArrayLayers;++h){const l=this.device.createBindGroup({layout:i.getBindGroupLayout(0),entries:[{binding:0,resource:Re(this,pe).sampler},{binding:1,resource:e.texture.createView({dimension:"2d",baseMipLevel:o,mipLevelCount:1,baseArrayLayer:h,arrayLayerCount:1})}]}),u={label:"Mip generation render pass",colorAttachments:[{view:e.texture.createView({dimension:"2d",baseMipLevel:o+1,mipLevelCount:1,baseArrayLayer:h,arrayLayerCount:1}),loadOp:"clear",storeOp:"store"}]},d=s.beginRenderPass(u);d.setPipeline(i),d.setBindGroup(0,l),d.draw(6),d.end()}++o}if(!t){const h=s.finish();this.device.queue.submit([h])}}removeDOMTexture(e){this.domTextures=this.domTextures.filter(t=>t.uuid!==e.uuid)}animate(){this.render(),this.animationFrameID=requestAnimationFrame(this.animate.bind(this))}onBeforeRender(e){return e&&(this._onBeforeRenderCallback=e),this}onAfterRender(e){return e&&(this._onAfterRenderCallback=e),this}render(){if(!this.ready)return;this._onBeforeRenderCallback&&this._onBeforeRenderCallback();for(const i of this.renderers)i.shouldRender&&i.onBeforeCommandEncoder();const e=this.device?.createCommandEncoder({label:this.label+" command encoder"});!this.production&&e.pushDebugGroup(this.label+" command encoder: main render loop"),this.renderers.forEach(i=>i.render(e)),!this.production&&e.popDebugGroup();const t=e.finish();this.device?.queue.submit([t]),this.domTextures.filter(i=>!i.parentMesh&&i.sourceLoaded&&!i.sourceUploaded).forEach(i=>this.uploadTexture(i));for(const i of this.texturesQueue)i.sourceUploaded=!0;this.texturesQueue=[];for(const i of this.renderers)i.shouldRender&&i.onAfterCommandEncoder();this._onAfterRenderCallback&&this._onAfterRenderCallback()}destroy(){this.animationFrameID&&cancelAnimationFrame(this.animationFrameID),this.animationFrameID=null,this.device?.destroy(),this.device=null,this.renderers.forEach(e=>e.destroy()),this.bindGroups.forEach(e=>e.destroy()),this.buffers.forEach(e=>e?.destroy()),this.indirectBuffers.forEach(e=>e.destroy()),this.domTextures.forEach(e=>e.destroy()),this.setDeviceObjects()}}pe=new WeakMap;var Eo=c((n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},"__accessCheck$8"),zo=c((n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},"__privateAdd$8"),Ao=c((n,e,t)=>(Eo(n,e,"access private method"),t),"__privateMethod$7"),Gs,Mn;const _o=5;class Tn{static{c(this,"IndirectBuffer")}constructor(e,{label:t="Indirect buffer",geometries:i=[],minEntrySize:s=_o}={}){zo(this,Gs),this.type="IndirectBuffer",e=$(e,this.type),this.renderer=e,this.uuid=O(),this.options={label:t,geometries:i,minEntrySize:s},this.geometries=new Map,this.buffer=null,this.addGeometries(i),this.renderer.indirectBuffers.set(this.uuid,this)}get size(){return this.geometries.size}addGeometries(e=[]){e.forEach(t=>this.addGeometry(t))}addGeometry(e){this.geometries.set(e.uuid,e)}getByteOffsetAtIndex(e=0){return e*this.options.minEntrySize*Uint32Array.BYTES_PER_ELEMENT}create(){const e=this.getByteOffsetAtIndex(this.geometries.size);this.buffer?(this.buffer.destroy(),this.buffer.options.size=e):this.buffer=new Ne({label:this.options.label,size:e,usage:["copyDst","indirect","storage"],mappedAtCreation:!0}),this.buffer.consumers.add(this.uuid),this.buffer.createBuffer(this.renderer);const t=new Uint32Array(this.buffer.GPUBuffer.getMappedRange());let i=0;this.geometries.forEach(s=>{Ao(this,Gs,Mn).call(this,s,t,i*this.options.minEntrySize),s.useIndirectBuffer({buffer:this.buffer,offset:this.getByteOffsetAtIndex(i)}),i++}),this.buffer.GPUBuffer.unmap()}destroy(){this.renderer.removeBuffer(this.buffer),this.renderer.indirectBuffers.delete(this.uuid),this.geometries.forEach(e=>e.indirectDraw=null),this.buffer?.destroy(),this.buffer=null,this.geometries=null}}Gs=new WeakSet,Mn=c(function(n,e,t=0){"indexBuffer"in n&&n.indexBuffer?(e[t]=n.indexBuffer.bufferLength,e[t+1]=n.instancesCount,e[t+2]=0,e[t+3]=0,e[t+4]=0):(e[t]=n.verticesCount,e[t+1]=n.instancesCount,e[t+2]=0,e[t+3]=0,e[t+4]=0)},"addGeometryToIndirectMappedBuffer_fn");var $s=c((n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},"__accessCheck$7"),Pn=c((n,e,t)=>($s(n,e,"read from private field"),t?t.call(n):e.get(n)),"__privateGet$5"),Fe=c((n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},"__privateAdd$7"),Ci=c((n,e,t,i)=>($s(n,e,"write to private field"),e.set(n,t),t),"__privateSet$5"),Ge=c((n,e,t)=>($s(n,e,"access private method"),t),"__privateMethod$6"),Et,zt,Os,Rn,Si,ks,Is,En,Us,zn,Vs,An,Mi,Ns;let Lo=0;class Do{static{c(this,"RenderBundle")}constructor(e,{label:t,renderPass:i=null,renderOrder:s=0,transparent:r=null,visible:a=!0,size:o=0,useBuffer:h=!1,useIndirectDraw:l=!1}={}){Fe(this,Os),Fe(this,Si),Fe(this,Is),Fe(this,Us),Fe(this,Vs),Fe(this,Mi),Fe(this,Et,void 0),Fe(this,zt,void 0),this.type="RenderBundle",e=$(e,this.type),this.uuid=O(),Object.defineProperty(this,"index",{value:Lo++}),this.renderOrder=s,this.transparent=r,this.visible=a,t=t??this.type+this.index,this.options={label:t,renderPass:i,useBuffer:h,size:o,useIndirectDraw:l},this.meshes=new Map,this.encoder=null,this.bundle=null,Ci(this,zt,!1),this.binding=null,this.indirectBuffer=null,this.setRenderer(e),this.options.useIndirectDraw&&(this.indirectBuffer=new Tn(this.renderer)),this.options.useBuffer&&(Ci(this,Et,!0),this.options.size!==0?Ge(this,Os,Rn).call(this):(this.options.useBuffer=!1,this.renderer.production||A(`${this.options.label} (${this.type}): Cannot use a single transformation buffer if the size parameter has not been set upon creation.`)))}setRenderer(e){this.renderer&&(this.removeFromScene(),this.renderer.renderBundles.delete(this.uuid)),this.renderer=e,this.renderer.renderBundles.set(this.uuid,this),this.meshes.size>=1&&this.addToScene()}addToScene(){const e=this.meshes.entries().next();if(e&&e.value&&e.value.length&&e.value[1]){const t=e.value[1],i=!!t.transparent;if(this.transparent===null&&(this.transparent=i),t.constructor.name!=="ShaderPass"&&t.constructor.name!=="PingPongPlane"){const{useProjection:s}=t.material.options.rendering;this.useProjection===null&&(this.useProjection=s);const r=this.renderer.scene.getMeshProjectionStack(t);this.renderer.scene.addRenderBundle(this,r)}else this.size=1,t.renderOrder=this.renderOrder,this.useProjection=!1}}removeFromScene(){this.renderer.scene.removeRenderBundle(this)}get useProjection(){return Pn(this,Et)}set useProjection(e){Ci(this,Et,e)}set size(e){e!==this.options.size&&(this.ready&&!this.renderer.production&&A(`${this.options.label} (${this.type}): The content of a render bundle is meant to be static. You should not change its size after it has been created.`),this.ready=!1,Ge(this,Is,En).call(this,e),this.options.size=e)}get ready(){return Pn(this,zt)}set ready(e){e&&!this.ready?(this.size=this.meshes.size,this.options.useIndirectDraw&&(this.meshes.forEach(t=>{this.indirectBuffer.addGeometry(t.geometry)}),this.indirectBuffer.create()),Ge(this,Vs,An).call(this)):!e&&this.ready&&(this.bundle=null),Ci(this,zt,e)}addMesh(e,t){if(!this.options.renderPass)this.options.renderPass=t;else if(t.uuid!==this.options.renderPass.uuid){A(`${this.options.label} (${this.type}): Cannot add Mesh ${e.options.label} to this render bundle because the output render passes do not match.`),e.renderBundle=null;return}this.ready&&!this.renderer.production&&A(`${this.options.label} (${this.type}): The content of a render bundle is meant to be static. You should not add meshes to it after it has been created (mesh added: ${e.options.label}).`),this.ready=!1,this.meshes.set(e.uuid,e),this.meshes.size===1&&this.addToScene()}removeSceneObject(e){this.ready&&!this.renderer.production&&A(`${this.options.label} (${this.type}): The content of a render bundle is meant to be static. You should not remove meshes from it after it has been created (mesh removed: ${e.options.label}).`),this.ready=!1,this.meshes.delete(e.uuid),e.setRenderBundle(null,!1),this.options.useIndirectDraw&&(e.geometry.indirectDraw=null)}removeMesh(e,t=!0){this.removeSceneObject(e),t&&e.type!=="ShaderPass"&&e.type!=="PingPongPlane"&&this.renderer.scene.addMesh(e),this.meshes.size===0&&this.renderer.scene.removeRenderBundle(this)}updateBinding(){this.binding&&this.binding.shouldUpdate&&this.binding.buffer.GPUBuffer&&(this.renderer.queueWriteBuffer(this.binding.buffer.GPUBuffer,0,this.binding.arrayBuffer),this.binding.shouldUpdate=!1)}render(e){if(this.ready&&this.bundle&&this.visible&&(this.meshes.forEach(t=>{t.onBeforeRenderPass()}),this.updateBinding(),this.renderer.pipelineManager.resetCurrentPipeline(),this.renderer.production||e.pushDebugGroup(`${this.options.label}: execute bundle`),e.executeBundles([this.bundle]),this.renderer.production||e.popDebugGroup(),this.renderer.pipelineManager.resetCurrentPipeline(),this.meshes.forEach(t=>{t.onAfterRenderPass()})),!this.ready){let t=!0;for(const[i,s]of this.meshes)s.render(e),s.ready||(t=!1),"sourcesReady"in s&&!s.sourcesReady&&(t=!1);this.ready=t}}loseContext(){this.ready=!1}empty(e=!0){this.ready=!1,this.meshes.forEach(t=>{this.removeMesh(t,e)}),this.size=0}remove(){this.empty(!0),Ge(this,Mi,Ns).call(this)}destroy(){this.ready=!1,this.meshes.forEach(e=>{e.remove()}),this.size=0,Ge(this,Mi,Ns).call(this)}}Et=new WeakMap,zt=new WeakMap,Os=new WeakSet,Rn=c(function(){this.binding=new X({label:this.options.label+" matrices",name:"matrices",visibility:["vertex","fragment"],struct:{model:{type:"array<mat4x4f>",value:new Float32Array(16*this.options.size)},modelView:{type:"array<mat4x4f>",value:new Float32Array(16*this.options.size)},normal:{type:"array<mat3x3f>",value:new Float32Array(12*this.options.size)}}}),Ge(this,Si,ks).call(this,this.options.size)},"setBinding_fn"),Si=new WeakSet,ks=c(function(n){const e=this.renderer.device.limits.minUniformBufferOffsetAlignment;this.binding.arrayBufferSize<n*e&&(this.binding.arrayBufferSize=n*e,this.binding.arrayBuffer=new ArrayBuffer(this.binding.arrayBufferSize),this.binding.buffer.size=this.binding.arrayBuffer.byteLength)},"patchBindingOffset_fn"),Is=new WeakSet,En=c(function(n){if(n>this.options.size&&this.binding&&(Ge(this,Si,ks).call(this,n),this.binding.buffer.GPUBuffer)){this.binding.buffer.GPUBuffer.destroy(),this.binding.buffer.createBuffer(this.renderer,{label:this.binding.options.label,usage:["copySrc","copyDst",this.binding.bindingType,...this.binding.options.usage]});let e=0;this.meshes.forEach(t=>{t.patchRenderBundleBinding(e),e++}),this.binding.shouldUpdate=!0}},"onSizeChanged_fn"),Us=new WeakSet,zn=c(function(){this.descriptor={...this.options.renderPass.options.colorAttachments&&{colorFormats:this.options.renderPass.options.colorAttachments.map(n=>n.targetFormat)},...this.options.renderPass.options.useDepth&&{depthStencilFormat:this.options.renderPass.options.depthFormat},sampleCount:this.options.renderPass.options.sampleCount}},"setDescriptor_fn"),Vs=new WeakSet,An=c(function(){Ge(this,Us,zn).call(this),this.renderer.pipelineManager.resetCurrentPipeline(),this.encoder=this.renderer.device.createRenderBundleEncoder({...this.descriptor,label:this.options.label+" (encoder)"}),this.renderer.production||this.encoder.pushDebugGroup(`${this.options.label}: create encoder`),this.meshes.forEach(n=>{n.material.render(this.encoder),n.geometry.render(this.encoder)}),this.renderer.production||this.encoder.popDebugGroup(),this.bundle=this.encoder.finish({label:this.options.label+" (bundle)"}),this.renderer.pipelineManager.resetCurrentPipeline()},"encodeRenderCommands_fn"),Mi=new WeakSet,Ns=c(function(){this.binding&&(this.renderer.removeBuffer(this.binding.buffer),this.binding.buffer.destroy()),this.indirectBuffer&&this.indirectBuffer.destroy(),this.renderer.renderBundles.delete(this.uuid)},"cleanUp_fn");const Fo=`
struct VSOutput {
  @builtin(position) position: vec4f,
  @location(0) uv: vec2f,
};
...
${Ti}
${Pi}
`,$o=c(({addUtils:n=!0,receiveShadows:e=!1,toneMapping:t="Linear",useOcclusion:i=!1}={})=>`
${n?Ri:""}
${_n}
${t?Ke:""}
...
`,Fn=c(({receiveShadows:n=!1}={})=>`
  ...
  var outgoingLight: vec3f = totalDirect + totalIndirect;`,"getPhongShading"),Oo=c(({addUtils:n=!0,receiveShadows:e=!1,toneMapping:t="Linear",useOcclusion:i=!1}={})=>`
${n?Ri:""}
${Dn}
${t?Ke:""}
...
`,In=c(({receiveShadows:n=!1,environmentMap:e=null,transmissionBackgroundTexture:t=null,extensionsUsed:i=[]}={})=>{const s=e?`
  getIBLIndirect(
    normal,
    viewDirection,
    roughness,
  ...
  `:"",a=i.includes("KHR_materials_dispersion")?"getIBLVolumeRefractionWithDispersion":"getIBLVolumeRefraction",o=t?`
  ...
  var outgoingLight: vec3f = totalDiffuse + totalSpecular;`},"getPBRShading"),ko=c(({addUtils:n=!0,receiveShadows:e=!1,toneMapping:t="Linear",useOcclusion:i=!1,environmentMap:s=null,transmissionBackgroundTexture:r=null,extensionsUsed:a=[]}={})=>`
${n?Ri:""}
${Gn}
${$n}
${kn}
...
`,"getPBR"),Un=c(({geometry:n})=>{const e=n.getAttributeByName("tangent"),t=[];return n.vertexBuffers&&n.vertexBuffers.length&&n.vertexBuffers.forEach(s=>{s.attributes.forEach(r=>{r.name!=="position"&&t.push(r)})}),e&&t.push({name:"bitangent",type:"vec3f"}),`
  @builtin(position) position: vec4f,
  ${t.map((s,r)=>`
  @location(${r}) ${s.name}: ${s.type},`).join("")}
  @location(${t.length}) viewDirection: vec3f,
  @location(${t.length+1}) worldPosition: vec3f,
  @location(${t.length+2}) modelScale: vec3f,`},"getVertexOutputStructContent"),Io=c(({geometry:n})=>`
struct VSOutput {
  ${Un({geometry:n})}
};`,"getVertexOutputStruct"),Uo=c(({geometry:n})=>{let e=`
...
@vertex fn main(
  ...
  return vsOutput;
}`),"getVertexShaderCode"),Ei=c(({geometry:n})=>`
struct FSInput {
  @builtin(front_facing) frontFacing: bool,
  ${Un({geometry:n})}
};`,"getFragmentInputStruct"),zi=c(({geometry:n})=>{let e=`
  ...
  `,e},"declareAttributesVars"),Ai=c(({materialUniform:n=null,materialUniformName:e="material",shadingModel:t="PBR",environmentMap:i=null}={})=>{var s=n&&n.struct||{},r="";return s.color?r+=`
  ...
  var envSpecularIntensity: f32 = 1.0;`)),r},"declareMaterialVars"),_i=c(({geometry:n=null,baseColorTexture:e=null}={})=>{let t=`
  ...
  `,t},"getBaseColor"),Li=c(({toneMapping:n="Linear"}={})=>(()=>{switch(n){case"Linear":return"outputColor = vec4(linearToOutput3(outputColor.rgb), outputColor.a);";case"Khronos":return"outputColor = vec4(linearTosRGB(toneMapKhronosPbrNeutral(outputColor.rgb)), outputColor.a);";case!1:default:return""}})(),"applyToneMapping"),Nn=c(({chunks:n=null,toneMapping:e="Linear",geometry:t,materialUniform:i=null,materialUniformName:s="material",baseColorTexture:r=null})=>(n=At(n),`  
${n.additionalHead}
...
@fragment fn main(fsInput: FSInput) -> @location(0) vec4f {       
  ...
  ${Li({toneMapping:e})}
  return outputColor;
}`),"getUnlitFragmentShaderCode"),Hs=c(({geometry:n=null,normalTexture:e=null}={})=>{let t=`
  ...
  normal = geometryNormal;`,t},"getNormalTangentBitangent"),Ys=c(({emissiveTexture:n=null,occlusionTexture:e=null}={})=>{let t=`
  ...
  occlusion = 1.0 + occlusionIntensity * (occlusion - 1.0);`,t},"getEmissiveOcclusion"),Wn=c(({chunks:n=null,toneMapping:e="Linear",geometry:t,materialUniform:i=null,materialUniformName:s="material",receiveShadows:r=!1,baseColorTexture:a=null,normalTexture:o=null,emissiveTexture:h=null,occlusionTexture:l=null})=>(n=At(n),`  
${n.additionalHead}
...
@fragment fn main(fsInput: FSInput) -> @location(0) vec4f {
  ...
  ${Ys({emissiveTexture:h,occlusionTexture:l})}
  ...
  `,e},"getMetallicRoughness"),qn=c(({specularTexture:n=null,specularFactorTexture:e=null,specularColorTexture:t=null}={})=>{let i="";return n?i+=`
...
@fragment fn main(fsInput: FSInput) -> @location(0) vec4f {       
  ...
  ${qn({specularTexture:d,specularFactorTexture:f,specularColorTexture:p})}
  ${Ys({emissiveTexture:h,occlusionTexture:l})}
...
`,No=c(({transmissionTexture:n=null,thicknessTexture:e=null}={})=>{let t="";return n&&(t+=`
...
@fragment fn main(fsInput: FSInput) -> @location(0) vec4f {
  ...
  ${_i({geometry:t,baseColorTexture:o})}
  ...
  ${Li({toneMapping:e})}
  return outputColor;
}`),"getPbrFragmentShaderCode"),Xn=c(({shadingModel:n="PBR",chunks:e=null,toneMapping:t="Linear",geometry:i,materialUniform:s=null,materialUniformName:r="material",extensionsUsed:a=[],receiveShadows:o=!1,baseColorTexture:h=null,normalTexture:l=null,emissiveTexture:u=null,occlusionTexture:d=null,metallicRoughnessTexture:f=null,specularTexture:p=null,specularFactorTexture:m=null,specularColorTexture:g=null,transmissionTexture:x=null,thicknessTexture:v=null,transmissionBackgroundTexture:B=null,environmentMap:R=null})=>(()=>{switch(n){case"Unlit":return Nn({chunks:e,toneMapping:t,geometry:i,materialUniform:s,materialUniformName:r,baseColorTexture:h});case"Lambert":return Wn({chunks:e,toneMapping:t,geometry:i,materialUniform:s,materialUniformName:r,receiveShadows:o,baseColorTexture:h,normalTexture:l,emissiveTexture:u,occlusionTexture:d});case"Phong":return Hn({chunks:e,toneMapping:t,geometry:i,materialUniform:s,materialUniformName:r,receiveShadows:o,baseColorTexture:h,normalTexture:l,emissiveTexture:u,occlusionTexture:d,metallicRoughnessTexture:f,specularTexture:p,specularFactorTexture:m,specularColorTexture:g});case"PBR":default:return Yn({chunks:e,toneMapping:t,geometry:i,materialUniform:s,materialUniformName:r,extensionsUsed:a,receiveShadows:o,baseColorTexture:h,normalTexture:l,emissiveTexture:u,occlusionTexture:d,metallicRoughnessTexture:f,specularTexture:p,specularFactorTexture:m,specularColorTexture:g,transmissionTexture:x,thicknessTexture:v,transmissionBackgroundTexture:B,environmentMap:R})}})(),"getFragmentShaderCode");var Kn=c((n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},"__accessCheck$6"),Ee=c((n,e,t)=>(Kn(n,e,"read from private field"),t?t.call(n):e.get(n)),"__privateGet$4"),Xs=c((n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},"__privateAdd$6"),Wo=c((n,e,t,i)=>(Kn(n,e,"write to private field"),e.set(n,t),t),"__privateSet$4"),_t,Ze,Di;class Zn extends Ps{static{c(this,"DOMObject3D")}constructor(e,t,i={}){super(e),Xs(this,_t,new y),Xs(this,Ze,new y(1)),Xs(this,Di,1),this.boundingBox=new Se(new y(-1),new y(1)),this._onAfterDOMElementResizeCallback=()=>{},e=ss(e,"DOM3DObject"),this.renderer=e,this.size={shouldUpdate:!0,normalizedWorld:{size:new _(1),position:new _},cameraWorld:{size:new _(1)},scaledWorld:{size:new y(1),position:new y}},this.watchScroll=i.watchScroll,this.camera=this.renderer.camera,this.boundingBox.min.onChange(()=>this.shouldUpdateComputedSizes()),this.boundingBox.max.onChange(()=>this.shouldUpdateComputedSizes()),this.setDOMElement(t),this.renderer.domObjects.push(this)}setDOMElement(e){this.domElement=new zs({element:e,onSizeChanged:t=>this.resize(t),onPositionChanged:()=>this.onPositionChanged()}),this.updateSizeAndPosition()}onPositionChanged(){this.watchScroll&&this.shouldUpdateComputedSizes()}resetDOMElement(e){this.domElement&&this.domElement.destroy(),this.setDOMElement(e)}resize(e=null){!e&&(!this.domElement||this.domElement?.isResizing)||(this.updateSizeAndPosition(),this._onAfterDOMElementResizeCallback&&this._onAfterDOMElementResizeCallback())}get boundingRect(){return this.domElement?.boundingRect??{width:1,height:1,top:0,right:0,bottom:0,left:0,x:0,y:0}}setTransforms(){super.setTransforms(),this.transforms.origin.model.set(.5,.5,0),this.transforms.origin.world=new y,this.transforms.position.document=new y,this.documentPosition.onChange(()=>this.applyPosition()),this.transformOrigin.onChange(()=>this.setWorldTransformOrigin())}get documentPosition(){return this.transforms.position.document}set documentPosition(e){this.transforms.position.document=e,this.applyPosition()}get DOMObjectWorldScale(){return Ee(this,Ze).clone()}get worldScale(){return this.DOMObjectWorldScale.multiply(this.scale)}get worldPosition(){return Ee(this,_t).clone()}get transformOrigin(){return this.transforms.origin.model}set transformOrigin(e){this.transforms.origin.model=e,this.setWorldTransformOrigin()}get worldTransformOrigin(){return this.transforms.origin.world}set worldTransformOrigin(e){this.transforms.origin.world=e}shouldUpdateMatrices(){super.shouldUpdateMatrices(),(this.matricesNeedUpdate||this.size.shouldUpdate)&&(this.updateSizeAndPosition(),this.matricesNeedUpdate=!0),this.size.shouldUpdate=!1}shouldUpdateComputedSizes(){this.size.shouldUpdate=!0}updateSizeAndPosition(){this.setWorldSizes(),this.applyDocumentPosition(),this.shouldUpdateModelMatrix()}applyDocumentPosition(){let e=new y(0,0,0);this.documentPosition.equals(e)||(e=this.documentToWorldSpace(this.documentPosition)),Ee(this,_t).set(this.position.x+this.size.scaledWorld.position.x+e.x,this.position.y+this.size.scaledWorld.position.y+e.y,this.position.z+this.size.scaledWorld.position.z+this.documentPosition.z/this.camera.CSSPerspective)}applyTransformOrigin(){this.size&&(this.setWorldTransformOrigin(),super.applyTransformOrigin())}updateModelMatrix(){this.modelMatrix.composeFromOrigin(Ee(this,_t),this.quaternion,this.scale,this.worldTransformOrigin),this.modelMatrix.scale(this.DOMObjectWorldScale),this.shouldUpdateWorldMatrix()}documentToWorldSpace(e=new y){return new y(e.x*this.renderer.pixelRatio/this.renderer.boundingRect.width*this.camera.visibleSize.width,-(e.y*this.renderer.pixelRatio/this.renderer.boundingRect.height)*this.camera.visibleSize.height,e.z)}computeWorldSizes(){const e=this.renderer.boundingRect,t={x:this.boundingRect.width/2+this.boundingRect.left,y:this.boundingRect.height/2+this.boundingRect.top},i={x:e.width/2+e.left,y:e.height/2+e.top},{size:s,center:r}=this.boundingBox;s.x!==0&&s.y!==0&&s.z!==0&&r.divide(s),this.size.normalizedWorld.size.set(this.boundingRect.width/e.width,this.boundingRect.height/e.height),this.size.normalizedWorld.position.set((t.x-i.x)/e.width,(i.y-t.y)/e.height),this.size.cameraWorld.size.set(this.size.normalizedWorld.size.x*this.camera.visibleSize.width,this.size.normalizedWorld.size.y*this.camera.visibleSize.height),this.size.scaledWorld.size.set(this.size.cameraWorld.size.x/s.x,this.size.cameraWorld.size.y/s.y,1),this.size.scaledWorld.size.z=this.size.scaledWorld.size.y*(s.x/s.y/(this.boundingRect.width/this.boundingRect.height)),this.size.scaledWorld.position.set(this.size.normalizedWorld.position.x*this.camera.visibleSize.width,this.size.normalizedWorld.position.y*this.camera.visibleSize.height,0)}setWorldSizes(){this.computeWorldSizes(),this.setWorldScale(),this.setWorldTransformOrigin()}setWorldScale(){Ee(this,Ze).set(this.size.scaledWorld.size.x,this.size.scaledWorld.size.y,this.size.scaledWorld.size.z*Ee(this,Di)),this.shouldUpdateMatrixStack()}set DOMObjectDepthScaleRatio(e){Wo(this,Di,e),this.setWorldScale()}setWorldTransformOrigin(){this.transforms.origin.world=new y((this.transformOrigin.x*2-1)*Ee(this,Ze).x,-(this.transformOrigin.y*2-1)*Ee(this,Ze).y,this.transformOrigin.z*Ee(this,Ze).z),this.shouldUpdateMatrixStack()}updateScrollPosition(e={x:0,y:0}){(e.x||e.y)&&this.domElement.updateScrollPosition(e)}onAfterDOMElementResize(e){return e&&(this._onAfterDOMElementResizeCallback=e),this}destroy(){super.destroy(),this.domElement?.destroy()}}_t=new WeakMap,Ze=new WeakMap,Di=new WeakMap;const Jn={autoloadSources:!0,watchScroll:!0};class Qn extends gn(Zn){static{c(this,"DOMMesh")}constructor(e,t,i){super(e,t,{...Jn,...i}),this._onLoadingCallback=r=>{},i={...Jn,...i},ss(e,i.label?i.label+" DOMMesh":"DOMMesh"),this.type="DOMMesh";const{autoloadSources:s}=i;this.autoloadSources=s,this.sourcesReady=!1,this.setInitSources()}get ready(){return this._ready}set ready(e){e&&!this._ready&&this.sourcesReady&&this._onReadyCallback&&this._onReadyCallback(),this._ready=e}get sourcesReady(){return this._sourcesReady}set sourcesReady(e){e&&!this._sourcesReady&&this.ready&&this._onReadyCallback&&this._onReadyCallback(),this._sourcesReady=e}addToScene(e=!1){super.addToScene(e),e&&this.renderer.domMeshes.push(this)}removeFromScene(e=!1){super.removeFromScene(e),e&&(this.renderer.domMeshes=this.renderer.domMeshes.filter(t=>t.uuid!==this.uuid))}setInitSources(){let e=0,t=0;if(this.autoloadSources){const i=this.domElement.element.querySelectorAll("img"),s=this.domElement.element.querySelectorAll("video"),r=this.domElement.element.querySelectorAll("canvas");e=i.length+s.length+r.length;const a=c(o=>{t++,this._onLoadingCallback&&this._onLoadingCallback(o),t===e&&(this.sourcesReady=!0)},"onSourceUploaded");e||(this.sourcesReady=!0),i.length&&i.forEach(o=>{const h=this.createDOMTexture({name:o.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>a(h)).loadImage(o.src)}),s.length&&s.forEach(o=>{const h=this.createDOMTexture({name:o.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>a(h)).loadVideo(o)}),r.length&&r.forEach(o=>{const h=this.createDOMTexture({name:o.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>a(h)).loadCanvas(o)})}else this.sourcesReady=!0}resetDOMElement(e){e?super.resetDOMElement(e):!e&&!this.renderer.production&&A(`${this.options.label}: You are trying to reset a ${this.type} with a HTML element that does not exist. The old HTML element will be kept instead.`)}get pixelRatioBoundingRect(){const e=window.devicePixelRatio??1,t=this.renderer.pixelRatio/e;return Object.keys(this.domElement.boundingRect).reduce((i,s)=>({...i,[s]:this.domElement.boundingRect[s]*t}),{x:0,y:0,width:0,height:0,top:0,right:0,bottom:0,left:0})}computeGeometry(){super.computeGeometry(),this.boundingBox.copy(this.geometry.boundingBox)}onLoading(e){return e&&(this._onLoadingCallback=e),this}}const jo={label:"Plane",instancesCount:1,vertexBuffers:[]};class ea extends Qn{static{c(this,"Plane")}constructor(e,t,i={}){e=ss(e,i.label?i.label+" Plane":"Plane");const s={...jo,...i};let{geometry:r,widthSegments:a,heightSegments:o,...h}=s;const{instancesCount:l,vertexBuffers:u,...d}=h;if(!r||r.type!=="PlaneGeometry"){a=a??1,o=o??1;const f=a*o+a;u.length||(r=bi.getPlaneGeometryByID(f)),r?r.instancesCount=l:(r=new cs({widthSegments:a,heightSegments:o,instancesCount:l,vertexBuffers:u}),bi.addPlaneGeometry(r))}super(e,t,{geometry:r,...d}),this.type="Plane"}}class Fi extends Fs{static{c(this,"GPUCurtainsRenderer")}constructor({deviceManager:e,label:t,container:i,pixelRatio:s=1,autoResize:r=!0,context:a={},renderPass:o,camera:h,lights:l}){super({deviceManager:e,label:t,container:i,pixelRatio:s,autoResize:r,context:a,renderPass:o,camera:h,lights:l}),this.type="GPUCurtainsRenderer"}setRendererObjects(){super.setRendererObjects(),this.domMeshes=[],this.domObjects=[]}onCameraMatricesChanged(){super.onCameraMatricesChanged(),this.domObjects.forEach(e=>{e.updateSizeAndPosition()})}resizeMeshes(){this.meshes.forEach(e=>{"domElement"in e||e.resize(this.boundingRect)}),this.domObjects.forEach(e=>{e.domElement.isResizing||e.domElement.setSize()})}}class qo{static{c(this,"ScrollManager")}constructor({scroll:e={x:0,y:0},delta:t={x:0,y:0},shouldWatch:i=!0,onScroll:s=c((r={x:0,y:0})=>{},"onScroll")}={}){this.scroll=e,this.delta=t,this.shouldWatch=i,this.onScroll=s,this.shouldWatch&&window.addEventListener("scroll",this.setScroll.bind(this),{passive:!0})}setScroll(){this.updateScrollValues({x:window.pageXOffset,y:window.pageYOffset})}updateScrollValues({x:e,y:t}){const i=this.scroll;this.scroll={x:e,y:t},this.delta={x:i.x-this.scroll.x,y:i.y-this.scroll.y},this.onScroll&&this.onScroll(this.delta)}destroy(){this.shouldWatch&&window.removeEventListener("scroll",this.setScroll.bind(this),{passive:!0})}}class Ho{static{c(this,"GPUCurtains")}constructor({container:e,label:t,pixelRatio:i=window.devicePixelRatio??1,context:s={},production:r=!1,adapterOptions:a={},renderPass:o,camera:h,lights:l,autoRender:u=!0,autoResize:d=!0,watchScroll:f=!0}={}){this._onScrollCallback=()=>{},this._onErrorCallback=()=>{},this._onContextLostCallback=()=>{},this._onContextDestroyedCallback=()=>{},this.type="CurtainsGPU",this.options={container:e,label:t,pixelRatio:i,camera:h,lights:l,production:r,adapterOptions:a,context:s,renderPass:o,autoRender:u,autoResize:d,watchScroll:f},this.setDeviceManager(),e&&this.setContainer(e),this.initEvents()}setContainer(e){if(e)if(typeof e=="string")if(e=document.querySelector(e),e)this.options.container=e;else{const t=document.createElement("div");t.setAttribute("id","curtains-gpu-canvas"),document.body.appendChild(t),this.options.container=t}else e instanceof Element&&(this.options.container=e);else{const t=document.createElement("div");t.setAttribute("id","curtains-gpu-canvas"),document.body.appendChild(t),this.options.container=t}this.container=this.options.container,this.setMainRenderer()}setMainRenderer(){this.createCurtainsRenderer({deviceManager:this.deviceManager,label:this.options.label||"GPUCurtains main GPUCurtainsRenderer",container:this.options.container,pixelRatio:this.options.pixelRatio,autoResize:this.options.autoResize,context:this.options.context,renderPass:this.options.renderPass,camera:this.options.camera,lights:this.options.lights})}patchRendererOptions(e){return e.pixelRatio===void 0&&(e.pixelRatio=this.options.pixelRatio),e.autoResize===void 0&&(e.autoResize=this.options.autoResize),e}createRenderer(e){return e=this.patchRendererOptions(e),new Ls({...e,deviceManager:this.deviceManager})}createCameraRenderer(e){return e=this.patchRendererOptions(e),new Fs({...e,deviceManager:this.deviceManager})}createCurtainsRenderer(e){return e=this.patchRendererOptions(e),new Fi({...e,deviceManager:this.deviceManager})}setDeviceManager(){this.deviceManager=new Sn({label:"GPUCurtains default device",production:this.options.production,adapterOptions:this.options.adapterOptions,autoRender:this.options.autoRender,onError:()=>setTimeout(()=>{this._onErrorCallback&&this._onErrorCallback()},0),onDeviceLost:e=>this._onContextLostCallback&&this._onContextLostCallback(e),onDeviceDestroyed:e=>this._onContextDestroyedCallback&&this._onContextDestroyedCallback(e)})}get renderers(){return this.deviceManager.renderers}get renderer(){return this.renderers[0]}async setDevice({adapter:e=null,device:t=null}={}){await this.deviceManager.init({adapter:e,device:t})}async restoreContext(){await this.deviceManager.restoreDevice()}get pingPongPlanes(){return this.renderers?.map(e=>e.pingPongPlanes).flat()}get shaderPasses(){return this.renderers?.map(e=>e.shaderPasses).flat()}get meshes(){return this.renderers?.map(e=>e.meshes).flat()}get domMeshes(){return this.renderers?.filter(e=>e instanceof Fi).map(e=>e.domMeshes).flat()}get domObjects(){return this.renderers?.filter(e=>e instanceof Fi).map(e=>e.domObjects).flat()}get planes(){return this.domMeshes.filter(e=>e instanceof ea)}get computePasses(){return this.renderers?.map(e=>e.computePasses).flat()}get boundingRect(){return this.renderer?.boundingRect}initScroll(){this.scrollManager=new qo({scroll:{x:window.pageXOffset,y:window.pageYOffset},delta:{x:0,y:0},shouldWatch:this.options.watchScroll,onScroll:e=>this.updateScroll(e)})}updateScroll(e={x:0,y:0}){this.domObjects.forEach(t=>{t.domElement&&t.watchScroll&&t.updateScrollPosition(e)}),this._onScrollCallback&&this._onScrollCallback()}updateScrollValues(e={x:0,y:0}){this.scrollManager.updateScrollValues(e)}get scrollDelta(){return this.scrollManager.delta}get scrollValues(){return this.scrollManager.scroll}initEvents(){Es.useObserver(this.options.autoResize),this.initScroll()}onBeforeRender(e){return this.deviceManager.onBeforeRender(e),this}onAfterRender(e){return this.deviceManager.onAfterRender(e),this}onScroll(e){return e&&(this._onScrollCallback=e),this}onError(e){return e&&(this._onErrorCallback=e),this}onContextLost(e){return e&&(this._onContextLostCallback=e),this}onContextDestroyed(e){return e&&(this._onContextDestroyedCallback=e),this}render(){this.deviceManager.render()}destroy(){this.deviceManager.destroy(),this.scrollManager?.destroy(),Es.destroy()}}var Ks=c((n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},"__accessCheck$5"),T=c((n,e,t)=>(Ks(n,e,"read from private field"),t?t.call(n):e.get(n)),"__privateGet$3"),k=c((n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},"__privateAdd$5"),Oe=c((n,e,t,i)=>(Ks(n,e,"write to private field"),e.set(n,t),t),"__privateSet$3"),F=c((n,e,t)=>(Ks(n,e,"access private method"),t),"__privateMethod$5"),U,oe,ke,G,nt,at,Lt,ot,Gi,Zs,Js,ta,Qs,ia,$i,er,Oi,tr,ki,ir,Ii,sr,Ui,rr,Vi,nr,Ni,ar,Wi,or,Je,ht,ji,hr,lr,sa,ur,ra;const lt=new _,ut=new _,Ie=new y;class Yo{static{c(this,"OrbitControls")}constructor({camera:e,element:t=null,target:i=new y,enableZoom:s=!0,minZoom:r=0,maxZoom:a=1/0,zoomSpeed:o=1,enableRotate:h=!0,minPolarAngle:l=0,maxPolarAngle:u=Math.PI,minAzimuthAngle:d=-1/0,maxAzimuthAngle:f=1/0,rotateSpeed:p=1,enablePan:m=!0,panSpeed:g=1}){if(k(this,Gi),k(this,Js),k(this,Qs),k(this,$i),k(this,Oi),k(this,ki),k(this,Ii),k(this,Ui),k(this,Vi),k(this,Ni),k(this,Wi),k(this,Je),k(this,ji),k(this,lr),k(this,ur),k(this,U,null),k(this,oe,new y),k(this,ke,!1),k(this,G,{radius:1,phi:0,theta:0}),k(this,nt,new _),k(this,at,!1),k(this,Lt,new _),k(this,ot,new y),!e){A("OrbitControls: cannot initialize without a camera.");return}F(this,Gi,Zs).call(this,{target:i,enableZoom:s,minZoom:r,maxZoom:a,zoomSpeed:o,enableRotate:h,minPolarAngle:l,maxPolarAngle:u,minAzimuthAngle:d,maxAzimuthAngle:f,rotateSpeed:p,enablePan:m,panSpeed:g}),this.element=t??(typeof window<"u"?window:null),this.useCamera(e)}useCamera(e){this.camera=e,this.camera.position.onChange(()=>{this.camera.lookAt(this.target)}),T(this,oe).copy(this.camera.position).sub(this.target),T(this,G).radius=T(this,oe).length(),T(this,G).theta=Math.atan2(T(this,oe).x,T(this,oe).z),T(this,G).phi=Math.acos(Math.min(Math.max(T(this,oe).y/T(this,G).radius,-1),1)),F(this,Je,ht).call(this)}reset({position:e,target:t,enableZoom:i=this.enableZoom,minZoom:s=this.minZoom,maxZoom:r=this.maxZoom,zoomSpeed:a=this.zoomSpeed,enableRotate:o=this.enableRotate,minPolarAngle:h=this.minPolarAngle,maxPolarAngle:l=this.maxPolarAngle,minAzimuthAngle:u=this.minAzimuthAngle,maxAzimuthAngle:d=this.maxAzimuthAngle,rotateSpeed:f=this.rotateSpeed,enablePan:p=this.enablePan,panSpeed:m=this.panSpeed}={}){F(this,Gi,Zs).call(this,{target:t,enableZoom:i,minZoom:s,maxZoom:r,zoomSpeed:a,enableRotate:o,minPolarAngle:h,maxPolarAngle:l,minAzimuthAngle:u,maxAzimuthAngle:d,rotateSpeed:f,enablePan:p,panSpeed:m}),e&&this.updatePosition(e)}updatePosition(e=new y){e.sub(this.target),T(this,G).radius=e.length(),T(this,G).theta=Math.atan2(e.x,e.z),T(this,G).phi=Math.acos(Math.min(Math.max(e.y/T(this,G).radius,-1),1)),F(this,Je,ht).call(this)}set element(e){T(this,U)&&(!e||T(this,U)!==e)&&F(this,Qs,ia).call(this),Oe(this,U,e),e&&F(this,Js,ta).call(this)}get element(){return T(this,U)}destroy(){this.element=null}}U=new WeakMap,oe=new WeakMap,ke=new WeakMap,G=new WeakMap,nt=new WeakMap,at=new WeakMap,Lt=new WeakMap,ot=new WeakMap,Gi=new WeakSet,Zs=c(function({target:n,enableZoom:e=this.enableZoom,minZoom:t=this.minZoom,maxZoom:i=this.maxZoom,zoomSpeed:s=this.zoomSpeed,enableRotate:r=this.enableRotate,minPolarAngle:a=this.minPolarAngle,maxPolarAngle:o=this.maxPolarAngle,minAzimuthAngle:h=this.minAzimuthAngle,maxAzimuthAngle:l=this.maxAzimuthAngle,rotateSpeed:u=this.rotateSpeed,enablePan:d=this.enablePan,panSpeed:f=this.panSpeed}={}){n&&(this.target=n),this.enableZoom=e,this.minZoom=t,this.maxZoom=i,this.zoomSpeed=s,this.enableRotate=r,this.minPolarAngle=a,this.maxPolarAngle=o,this.minAzimuthAngle=h,this.maxAzimuthAngle=l,this.rotateSpeed=u,this.enablePan=d,this.panSpeed=f},"setBaseParams_fn"),Js=new WeakSet,ta=c(function(){T(this,U).addEventListener("contextmenu",F(this,Wi,or).bind(this),!1),T(this,U).addEventListener("mousedown",F(this,$i,er).bind(this),!1),T(this,U).addEventListener("mousemove",F(this,ki,ir).bind(this),!1),T(this,U).addEventListener("mouseup",F(this,Ui,rr).bind(this),!1),T(this,U).addEventListener("touchstart",F(this,Oi,tr).bind(this),{passive:!1}),T(this,U).addEventListener("touchmove",F(this,Ii,sr).bind(this),{passive:!1}),T(this,U).addEventListener("touchend",F(this,Vi,nr).bind(this),!1),T(this,U).addEventListener("wheel",F(this,Ni,ar).bind(this),{passive:!1})},"addEvents_fn"),Qs=new WeakSet,ia=c(function(){T(this,U).removeEventListener("contextmenu",F(this,Wi,or).bind(this),!1),T(this,U).removeEventListener("mousedown",F(this,$i,er).bind(this),!1),T(this,U).removeEventListener("mousemove",F(this,ki,ir).bind(this),!1),T(this,U).removeEventListener("mouseup",F(this,Ui,rr).bind(this),!1),T(this,U).removeEventListener("touchstart",F(this,Oi,tr).bind(this),{passive:!1}),T(this,U).removeEventListener("touchmove",F(this,Ii,sr).bind(this),{passive:!1}),T(this,U).removeEventListener("touchend",F(this,Vi,nr).bind(this),!1),T(this,U).removeEventListener("wheel",F(this,Ni,ar).bind(this),{passive:!1})},"removeEvents_fn"),$i=new WeakSet,er=c(function(n){n.button===0&&this.enableRotate?(Oe(this,ke,!0),T(this,nt).set(n.clientX,n.clientY)):n.button===2&&this.enablePan&&(Oe(this,at,!0),T(this,Lt).set(n.clientX,n.clientY)),n.stopPropagation(),n.preventDefault()},"onMouseDown_fn"),Oi=new WeakSet,tr=c(function(n){n.touches.length===1&&this.enableRotate&&(Oe(this,ke,!0),T(this,nt).set(n.touches[0].pageX,n.touches[0].pageY))},"onTouchStart_fn"),ki=new WeakSet,ir=c(function(n){T(this,ke)&&this.enableRotate?F(this,ji,hr).call(this,n.clientX,n.clientY):T(this,at)&&this.enablePan&&F(this,lr,sa).call(this,n.clientX,n.clientY)},"onMouseMove_fn"),Ii=new WeakSet,sr=c(function(n){T(this,ke)&&this.enableRotate&&F(this,ji,hr).call(this,n.touches[0].pageX,n.touches[0].pageY)},"onTouchMove_fn"),Ui=new WeakSet,rr=c(function(n){Oe(this,ke,!1),Oe(this,at,!1)},"onMouseUp_fn"),Vi=new WeakSet,nr=c(function(n){Oe(this,ke,!1),Oe(this,at,!1)},"onTouchEnd_fn"),Ni=new WeakSet,ar=c(function(n){this.enableZoom&&(F(this,ur,ra).call(this,n.deltaY),n.preventDefault())},"onMouseWheel_fn"),Wi=new WeakSet,or=c(function(n){n.preventDefault()},"onContextMenu_fn"),Je=new WeakSet,ht=c(function(){const n=T(this,G).radius*Math.sin(Math.max(1e-6,T(this,G).phi));T(this,oe).x=n*Math.sin(T(this,G).theta),T(this,oe).y=T(this,G).radius*Math.cos(T(this,G).phi),T(this,oe).z=n*Math.cos(T(this,G).theta),this.camera.position.copy(this.target).add(T(this,oe))},"update_fn"),ji=new WeakSet,hr=c(function(n,e){lt.set(n,e),ut.copy(lt).sub(T(this,nt)).multiplyScalar(this.rotateSpeed),T(this,G).theta-=2*Math.PI*ut.x/this.camera.size.height,T(this,G).phi-=2*Math.PI*ut.y/this.camera.size.height,T(this,G).theta=Math.min(this.maxAzimuthAngle,Math.max(this.minAzimuthAngle,T(this,G).theta)),T(this,G).phi=Math.min(this.maxPolarAngle,Math.max(this.minPolarAngle,T(this,G).phi)),T(this,nt).copy(lt),F(this,Je,ht).call(this)},"rotate_fn"),lr=new WeakSet,sa=c(function(n,e){lt.set(n,e),ut.copy(lt).sub(T(this,Lt)).multiplyScalar(this.panSpeed),T(this,ot).set(0),Ie.copy(this.camera.position).sub(this.target);let t=Ie.length();t*=Math.tan(this.camera.fov/2*Math.PI/180),Ie.set(this.camera.modelMatrix.elements[0],this.camera.modelMatrix.elements[1],this.camera.modelMatrix.elements[2]),Ie.multiplyScalar(-(2*ut.x*t)/this.camera.size.height),T(this,ot).add(Ie),Ie.set(this.camera.modelMatrix.elements[4],this.camera.modelMatrix.elements[5],this.camera.modelMatrix.elements[6]),Ie.multiplyScalar(2*ut.y*t/this.camera.size.height),T(this,ot).add(Ie),T(this,Lt).copy(lt),this.target.add(T(this,ot)),T(this,oe).copy(this.camera.position).sub(this.target),T(this,G).radius=T(this,oe).length(),F(this,Je,ht).call(this)},"pan_fn"),ur=new WeakSet,ra=c(function(n){T(this,G).radius=Math.min(this.maxZoom,Math.max(this.minZoom+1e-6,T(this,G).radius+n*this.zoomSpeed/100)),F(this,Je,ht).call(this)},"zoom_fn");var Xo=c((n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},"__accessCheck$4"),ze=c((n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},"__privateAdd$4"),he=c((n,e,t)=>(Xo(n,e,"access private method"),t),"__privateMethod$4"),dr,na,cr,aa,qi,pr,Dt,Hi,fr,oa,mr,ha,Yi,gr,yr,la,xr,ua;class da{static{c(this,"HDRLoader")}constructor(){ze(this,dr),ze(this,cr),ze(this,qi),ze(this,Dt),ze(this,fr),ze(this,mr),ze(this,Yi),ze(this,yr),ze(this,xr)}async loadFromUrl(e){const t=await(await fetch(e)).arrayBuffer();return he(this,dr,na).call(this,new DataView(t))}}dr=new WeakSet,na=c(function(n){const e={data:n,offset:0},t=he(this,cr,aa).call(this,e);return{width:t.width,height:t.height,exposure:t.exposure,gamma:t.gamma,data:he(this,fr,oa).call(this,e,t)}},"decodeRGBE_fn"),cr=new WeakSet,aa=c(function(n){let e=he(this,Dt,Hi).call(this,n);const t={colorCorr:[1,1,1],exposure:1,gamma:1,width:0,height:0,flipX:!1,flipY:!1};if(e!=="#?RADIANCE"&&e!=="#?RGBE")throw new Error("Incorrect file format!");for(;e!=="";){e=he(this,Dt,Hi).call(this,n);const s=e.split("=");switch(s[0]){case"GAMMA":t.gamma=parseFloat(s[1]);break;case"FORMAT":if(s[1]!=="32-bit_rle_rgbe"&&s[1]!=="32-bit_rle_xyze")throw new Error("Incorrect encoding format!");break;case"EXPOSURE":t.exposure=parseFloat(s[1]);break;case"COLORCORR":t.colorCorr=s[1].replace(/^\s+|\s+$/g,"").split(" ").map(r=>parseFloat(r));break}}e=he(this,Dt,Hi).call(this,n);const i=e.split(" ");return he(this,qi,pr).call(this,i[0],parseInt(i[1]),t),he(this,qi,pr).call(this,i[2],parseInt(i[3]),t),t},"parseHeader_fn"),qi=new WeakSet,pr=c(function(n,e,t){switch(n){case"+X":t.width=e;break;case"-X":t.width=e,t.flipX=!0,console.warn("Flipping horizontal orientation not currently supported");break;case"-Y":t.height=e,t.flipY=!0;break;case"+Y":t.height=e;break}},"parseSize_fn"),Dt=new WeakSet,Hi=c(function(n){let e,t="";for(;(e=n.data.getUint8(n.offset++))!==10;)t+=String.fromCharCode(e);return t},"readLine_fn"),fr=new WeakSet,oa=c(function(n,e){const t=n.data.getUint16(n.offset);let i;if(t===514)i=he(this,mr,ha).call(this,n,e),e.flipX&&he(this,yr,la).call(this,i,e),e.flipY&&he(this,xr,ua).call(this,i,e);else throw new Error("Obsolete HDR file version!");return i},"parseData_fn"),mr=new WeakSet,ha=c(function(n,e){const{width:t,height:i,colorCorr:s}=e,r=new Float32Array(t*i*4);let a=0,{offset:o,data:h}=n;for(let l=0;l<i;++l){if(h.getUint16(o)!==514)throw new Error("Incorrect scanline start hash");if(h.getUint16(o+2)!==t)throw new Error("Scanline doesn't match picture dimension!");o+=4;const u=t*4,d=[];let f=0;for(;f<u;){let p=h.getUint8(o++);if(p>128){const m=p-128;p=h.getUint8(o++);for(let g=0;g<m;++g)d[f++]=p}else for(let m=0;m<p;++m)d[f++]=h.getUint8(o++)}for(f=0;f<t;++f){const p=d[f],m=d[f+t],g=d[f+t*2];let x=d[f+t*3];x=x?Math.pow(2,x-136):0,r[a++]=p*x*s[0],r[a++]=m*x*s[1],r[a++]=g*x*s[2],r[a++]=x}}return r},"parseNewRLE_fn"),Yi=new WeakSet,gr=c(function(n,e,t){e*=4,t*=4;for(let i=0;i<4;++i){const s=n[e+i];n[e+i]=n[t+i],n[t+i]=s}},"swap_fn"),yr=new WeakSet,la=c(function(n,e){const{width:t,height:i}=e,s=t>>1;for(let r=0;r<i;++r){const a=r*t;for(let o=0;o<s;++o){const h=a+o,l=a+t-1-o;he(this,Yi,gr).call(this,n,h,l)}}},"flipX_fn"),xr=new WeakSet,ua=c(function(n,e){const{width:t,height:i}=e,s=i>>1;for(let r=0;r<s;++r){const a=r*t,o=(i-1-r)*t;for(let h=0;h<t;++h)he(this,Yi,gr).call(this,n,a+h,o+h)}},"flipY_fn");const ca=`
...
`,"computeDiffuseFromSpecularCubemap");var Qo=c((n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},"__accessCheck$3"),eh=c((n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},"__privateAdd$3"),vr=c((n,e,t)=>(Qo(n,e,"access private method"),t),"__privateMethod$3"),Ft,Xi;class th{static{c(this,"EnvironmentMap")}constructor(e,t={}){eh(this,Ft),e=$(e,"EnvironmentMap"),this.renderer=e,t={lutTextureParams:{size:256,computeSampleCount:1024,label:"Environment LUT texture",name:"lutTexture",format:"rgba32float"},diffuseTextureParams:{size:128,computeSampleCount:2048,label:"Environment diffuse texture",name:"envDiffuseTexture",format:"rgba16float"},specularTextureParams:{label:"Environment specular texture",name:"envSpecularTexture",format:"rgba16float",generateMips:!0},diffuseIntensity:1,specularIntensity:1,...t},this.options=t,this.sampler=new He(this.renderer,{label:"Clamp sampler",name:"clampSampler",magFilter:"linear",minFilter:"linear",mipmapFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),this.rotation=new ve(new Float32Array([0,0,1,0,1,0,-1,0,0])),this.hdrLoader=new da,this.computeBRDFLUTTexture()}async computeBRDFLUTTexture(){const{size:e,computeSampleCount:t,...i}=this.options.lutTextureParams;this.lutTexture=new j(this.renderer,{...i,visibility:["fragment"],fixedSize:{width:e,height:e},autoDestroy:!1});let s=new j(this.renderer,{label:"LUT storage texture",name:"lutStorageTexture",format:this.lutTexture.options.format,visibility:["compute"],usage:["copySrc","storageBinding"],type:"storage",fixedSize:{width:this.lutTexture.size.width,height:this.lutTexture.size.height}}),r=new hi(this.renderer,{label:"Compute LUT texture",autoRender:!1,dispatchSize:[Math.ceil(s.size.width/16),Math.ceil(s.size.height/16),1],shaders:{compute:{code:Ko}},uniforms:{params:{struct:{sampleCount:{type:"u32",value:t}}}},textures:[s]});await r.material.compileMaterial(),this.renderer.onBeforeRenderScene.add(a=>{this.renderer.renderSingleComputePass(a,r),vr(this,Ft,Xi).call(this,a,s,this.lutTexture)},{once:!0}),this.renderer.onAfterCommandEncoderSubmission.add(()=>{r.destroy(),s.destroy(),s=null,r=null},{once:!0})}async computeSpecularCubemapFromHDRData(e){let t=new j(this.renderer,{label:"Specular storage cubemap",name:"specularStorageCubemap",format:this.specularTexture.options.format,visibility:["compute"],usage:["copySrc","storageBinding"],type:"storage",fixedSize:{width:this.specularTexture.size.width,height:this.specularTexture.size.height,depth:6},viewDimension:"2d-array"}),i=new hi(this.renderer,{label:"Compute specular cubemap from equirectangular",autoRender:!1,dispatchSize:[Math.ceil(this.specularTexture.size.width/8),Math.ceil(this.specularTexture.size.height/8),6],shaders:{compute:{code:Zo}},storages:{params:{struct:{hdrImageData:{type:"array<vec4f>",value:e.data},imageSize:{type:"vec2f",value:new _(e.width,e.height)},faceSize:{type:"u32",value:this.specularTexture.size.width}}}},textures:[t]});await i.material.compileMaterial();const s=this.renderer.device?.createCommandEncoder({label:"Render once command encoder"});this.renderer.production||s.pushDebugGroup("Render once command encoder"),this.renderer.renderSingleComputePass(s,i),vr(this,Ft,Xi).call(this,s,t,this.specularTexture),this.specularTexture.texture.mipLevelCount>1&&this.renderer.generateMips(this.specularTexture,s),this.renderer.production||s.popDebugGroup();const r=s.finish();this.renderer.device?.queue.submit([r]),i.destroy(),t.destroy(),t=null,i=null}async computeDiffuseFromSpecular(){if(this.specularTexture.options.viewDimension!=="cube"){A("Could not compute the diffuse texture because the specular texture is not a cube map:"+this.specularTexture.options.viewDimension);return}let e=new j(this.renderer,{label:"Diffuse storage cubemap",name:"diffuseEnvMap",format:this.diffuseTexture.options.format,visibility:["compute"],usage:["copySrc","storageBinding"],type:"storage",fixedSize:{width:this.diffuseTexture.size.width,height:this.diffuseTexture.size.height,depth:6},viewDimension:"2d-array"}),t=new hi(this.renderer,{label:"Compute diffuse map from specular map",autoRender:!1,dispatchSize:[Math.ceil(this.diffuseTexture.size.width/8),Math.ceil(this.diffuseTexture.size.height/8),6],shaders:{compute:{code:Jo(this.specularTexture)}},uniforms:{params:{struct:{faceSize:{type:"u32",value:this.diffuseTexture.size.width},maxMipLevel:{type:"u32",value:this.specularTexture.texture.mipLevelCount},sampleCount:{type:"u32",value:this.options.diffuseTextureParams.computeSampleCount}}}},samplers:[this.sampler],textures:[this.specularTexture,e]});await t.material.compileMaterial(),this.renderer.onBeforeRenderScene.add(i=>{this.renderer.renderSingleComputePass(i,t),vr(this,Ft,Xi).call(this,i,e,this.diffuseTexture)},{once:!0}),this.renderer.onAfterCommandEncoderSubmission.add(()=>{t.destroy(),e.destroy(),e=null,t=null},{once:!0})}async loadAndComputeFromHDR(e){const t=await this.hdrLoader.loadFromUrl(e),{width:i,height:s}=t||{width:1024,height:512},r=Math.max(i/4,s/2),a={viewDimension:"cube",autoDestroy:!1};this.specularTexture?(this.specularTexture.size.width!==r||this.specularTexture.size.height!==r)&&(this.specularTexture.options.fixedSize.width=r,this.specularTexture.options.fixedSize.height=r,this.specularTexture.size.width=r,this.specularTexture.size.height=r,this.specularTexture.createTexture()):this.specularTexture=new j(this.renderer,{...this.options.specularTextureParams,visibility:["fragment","compute"],fixedSize:{width:r,height:r},...a});const{size:o,computeSampleCount:h,...l}=this.options.diffuseTextureParams,u=Math.min(o,r);this.diffuseTexture?(this.diffuseTexture.size.width!==u||this.diffuseTexture.size.height!==u)&&(this.diffuseTexture.options.fixedSize.width=u,this.diffuseTexture.options.fixedSize.height=u,this.diffuseTexture.size.width=u,this.diffuseTexture.size.height=u,this.diffuseTexture.createTexture()):this.diffuseTexture=new j(this.renderer,{...l,visibility:["fragment"],fixedSize:{width:u,height:u},...a}),t&&this.computeSpecularCubemapFromHDRData(t).then(()=>{this.computeDiffuseFromSpecular()})}destroy(){this.lutTexture?.destroy(),this.diffuseTexture?.destroy(),this.specularTexture?.destroy()}}Ft=new WeakSet,Xi=c(function(n,e,t){n.copyTextureToTexture({texture:e.texture},{texture:t.texture},[t.texture.width,t.texture.height,t.texture.depthOrArrayLayers])},"copyComputeStorageTextureToTexture_fn");class ih extends Bt{static{c(this,"BoxGeometry")}constructor({instancesCount:e=1,vertexBuffers:t=[],topology:i,mapBuffersAtCreation:s=!0,widthSegments:r=1,heightSegments:a=1,depthSegments:o=1}={}){super({verticesOrder:"ccw",topology:i,instancesCount:e,vertexBuffers:t,mapBuffersAtCreation:s}),this.type="BoxGeometry",r=Math.floor(r),a=Math.floor(a),o=Math.floor(o);const h=[],l=[],u=[],d=[];let f=0;const p=c((m,g,x,v,B,R,b,C,M,S)=>{const z=R/M,E=b/S,D=R/2,J=b/2,ie=C/2,N=M+1,Le=S+1;let Pe=0;const W=new y;for(let H=0;H<Le;H++){const Q=H*E-J;for(let se=0;se<N;se++){const ge=se*z-D;W[m]=ge*v,W[g]=Q*B,W[x]=ie,h.push(W.x,W.y,W.z),W[m]=0,W[g]=0,W[x]=C>0?1:-1,u.push(W.x,W.y,W.z),l.push(se/M),l.push(H/S),Pe+=1}}for(let H=0;H<S;H++)for(let Q=0;Q<M;Q++){const se=f+Q+N*H,ge=f+Q+N*(H+1),yt=f+(Q+1)+N*(H+1),va=f+(Q+1)+N*H;d.push(se,ge,va),d.push(ge,yt,va),f+=Pe}},"buildPlane");p("z","y","x",-1,-1,2,2,2,o,a),p("z","y","x",1,-1,2,2,-2,o,a),p("x","z","y",1,1,2,2,2,r,o),p("x","z","y",1,-1,2,2,-2,r,o),p("x","y","z",1,-1,2,2,2,r,a),p("x","y","z",-1,-1,2,2,-2,r,a),this.setAttribute({name:"position",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(h)}),this.setAttribute({name:"uv",type:"vec2f",bufferFormat:"float32x2",size:2,array:new Float32Array(l)}),this.setAttribute({name:"normal",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(u)}),this.setIndexBuffer({array:this.useUint16IndexArray?new Uint16Array(d):new Uint32Array(d),bufferFormat:this.useUint16IndexArray?"uint16":"uint32"})}}class sh extends Bt{static{c(this,"SphereGeometry")}constructor({topology:e,instancesCount:t=1,vertexBuffers:i=[],mapBuffersAtCreation:s=!0,widthSegments:r=32,heightSegments:a=16,phiStart:o=0,phiLength:h=Math.PI*2,thetaStart:l=0,thetaLength:u=Math.PI}={}){super({verticesOrder:"ccw",topology:e,instancesCount:t,vertexBuffers:i,mapBuffersAtCreation:s}),this.type="SphereGeometry",r=Math.max(3,Math.floor(r)),a=Math.max(2,Math.floor(a));const d=1,f=Math.min(l+u,Math.PI);let p=0;const m=[],g=new y,x=new y,v=[],B=[],R=[],b=[];for(let C=0;C<=a;C++){const M=[],S=C/a;let z=0;C===0&&l===0?z=.5/r:C===a&&f===Math.PI&&(z=-.5/r);for(let E=0;E<=r;E++){const D=E/r;g.x=-d*Math.cos(o+D*h)*Math.sin(l+S*u),g.y=d*Math.cos(l+S*u),g.z=d*Math.sin(o+D*h)*Math.sin(l+S*u),B.push(g.x,g.y,g.z),x.copy(g).normalize(),R.push(x.x,x.y,x.z),b.push(D+z,S),M.push(p++)}m.push(M)}for(let C=0;C<a;C++)for(let M=0;M<r;M++){const S=m[C][M+1],z=m[C][M],E=m[C+1][M],D=m[C+1][M+1];(C!==0||l>0)&&v.push(S,z,D),(C!==a-1||f<Math.PI)&&v.push(z,E,D)}this.setAttribute({name:"position",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(B)}),this.setAttribute({name:"uv",type:"vec2f",bufferFormat:"float32x2",size:2,array:new Float32Array(b)}),this.setAttribute({name:"normal",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(R)}),this.setIndexBuffer({array:this.useUint16IndexArray?new Uint16Array(v):new Uint32Array(v),bufferFormat:this.useUint16IndexArray?"uint16":"uint32"})}}class rh extends Ts{static{c(this,"PingPongPlane")}constructor(e,t={}){e=$(e,t.label?t.label+" PingPongPlane":"PingPongPlane");const i=t.targets&&t.targets.length&&t.targets.map(s=>({targetFormat:s.format}));t.outputTarget=new fs(e,{label:t.label?t.label+" render target":"Ping Pong render target",useDepth:!1,...i&&{colorAttachments:i}}),t.transparent=!1,t.depth=!1,t.label=t.label??"PingPongPlane "+e.pingPongPlanes?.length,super(e,t),this.type="PingPongPlane",this.createTexture({label:t.label?`${t.label} render texture`:"PingPongPlane render texture",name:"renderTexture",...t.targets&&t.targets.length&&{format:t.targets[0].format},usage:["copyDst","textureBinding"]})}get renderTexture(){return this.textures.find(e=>e.options.name==="renderTexture")}addToScene(e=!1){e&&this.renderer.pingPongPlanes.push(this),this.autoRender&&this.renderer.scene.addPingPongPlane(this)}removeFromScene(e=!1){this.outputTarget&&this.outputTarget.destroy(),this.autoRender&&this.renderer.scene.removePingPongPlane(this),e&&(this.renderer.pingPongPlanes=this.renderer.pingPongPlanes.filter(t=>t.uuid!==this.uuid))}}var br=c((n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},"__accessCheck$2"),P=c((n,e,t)=>(br(n,e,"read from private field"),t?t.call(n):e.get(n)),"__privateGet$2"),le=c((n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},"__privateAdd$2"),fe=c((n,e,t,i)=>(br(n,e,"write to private field"),e.set(n,t),t),"__privateSet$2"),nh=c((n,e,t)=>(br(n,e,"access private method"),t),"__privateMethod$2"),be,Ae,dt,ct,we,Be,Gt,$t,Ot,kt,It,Ut,wr,fa;class ah{static{c(this,"Raycaster")}constructor(e){le(this,wr),le(this,be,void 0),le(this,Ae,void 0),le(this,dt,void 0),le(this,ct,void 0),le(this,we,void 0),le(this,Be,void 0),le(this,Gt,void 0),le(this,$t,void 0),le(this,Ot,void 0),le(this,kt,void 0),le(this,It,void 0),le(this,Ut,void 0),this.type="Raycaster",e=Ve(e,this.type),this.renderer=e,this.camera=this.renderer.camera,this.pointer=new _(1/0),this.ray={origin:new y,direction:new y},fe(this,be,{origin:this.ray.origin.clone(),direction:this.ray.direction.clone()}),fe(this,Ae,new y),fe(this,dt,new y),fe(this,ct,new y),fe(this,we,new y),fe(this,Be,new y),fe(this,Gt,new _),fe(this,$t,new _),fe(this,Ot,new _),fe(this,kt,new y),fe(this,It,new y),fe(this,Ut,new y)}setFromMouse(e){const{clientX:t,clientY:i}=e.targetTouches&&e.targetTouches.length?e.targetTouches[0]:e;this.setFromNDCCoords((t-this.renderer.boundingRect.left)/this.renderer.boundingRect.width*2-1,-((i-this.renderer.boundingRect.top)/this.renderer.boundingRect.height)*2+1)}setFromNDCCoords(e=0,t=0){this.pointer.set(e,t),this.setRay()}setRay(){this.camera.worldMatrix.getTranslation(this.ray.origin),this.ray.direction.set(this.pointer.x,this.pointer.y,-1).unproject(this.camera).sub(this.ray.origin).normalize()}rayIntersectsTriangle(e){const i=new y,s=new y;i.crossVectors(P(this,be).direction,P(this,Be));const r=P(this,we).dot(i);if(Math.abs(r)<1e-6)return!1;const a=1/r,o=P(this,be).origin.clone().sub(P(this,Ae)),h=a*o.dot(i);if(h<0||h>1)return!1;s.crossVectors(o,P(this,we));const l=a*P(this,be).direction.dot(s);if(l<0||h+l>1)return!1;const u=a*P(this,Be).dot(s);return u>1e-6?(e.copy(P(this,be).origin).add(P(this,be).direction.clone().multiplyScalar(u)),!0):!1}getBarycentricCoordinates(e){const t=e.clone().sub(P(this,Ae)),i=P(this,we).dot(P(this,we)),s=P(this,we).dot(P(this,Be)),r=P(this,Be).dot(P(this,Be)),a=t.dot(P(this,we)),o=t.dot(P(this,Be)),h=i*r-s*s,l=new y(0,(r*a-s*o)/h,(i*o-s*a)/h);return l.x=1-l.y-l.z,l}getTriangleNormal(){return new y().crossVectors(P(this,we),P(this,Be)).normalize()}setAttributeVectorAtIndex(e,t,i,s,r){const a=i?i[e*3+t]:e*3+t;r.x=s.array[a*s.size],r.y=s.array[a*s.size+1],"z"in r&&(r.z=s.array[a*s.size+2])}intersectObject(e,t=!0,i=[]){if(!(e instanceof xe))return this.renderer.production||A(`${this.type}: object to test intersection again is not of type Object3D`),i;const s=ba(e);return s&&nh(this,wr,fa).call(this,s,i),t&&e.children.forEach(r=>{this.intersectObject(r,t,i)}),i.length&&i.sort((r,a)=>this.ray.origin.distance(r.point)-this.ray.origin.distance(a.point)),i}intersectObjects(e,t=!0,i=[]){return e.forEach(s=>{this.intersectObject(s,t,i)}),i.length&&i.sort((s,r)=>this.ray.origin.distance(s.point)-this.ray.origin.distance(r.point)),i}}be=new WeakMap,Ae=new WeakMap,dt=new WeakMap,ct=new WeakMap,we=new WeakMap,Be=new WeakMap,Gt=new WeakMap,$t=new WeakMap,Ot=new WeakMap,kt=new WeakMap,It=new WeakMap,Ut=new WeakMap,wr=new WeakSet,fa=c(function(n,e=[]){if(!n.geometry)return e;const t=n.geometry.getAttributeByName("position");if(!t)return this.renderer.production||A(`Raycaster: can't raycast on a mesh that has no position attribute: ${n.options.label}`),e;if(!t.array)return this.renderer.production||A(`Raycaster: can't raycast on a mesh that has no position attribute array: ${n.options.label}`),e;if(n.frustumCulling&&n.domFrustum){const{clipSpaceBoundingRect:h}=n.domFrustum;if(n.domFrustum.isIntersecting){if(this.pointer.x>h.left+h.width||this.pointer.x<h.left||this.pointer.y>h.top||this.pointer.y<h.top-h.height)return e}else return e}const i=n.worldMatrix.getInverse();P(this,be).origin.copy(this.ray.origin).applyMat4(i),P(this,be).direction.copy(this.ray.direction).transformDirection(i);const s=n.geometry.getAttributeByName("uv"),r=n.geometry.getAttributeByName("normal"),a=n.geometry.indexBuffer?.array,o=a?a.length/3:t.array.length/9;for(let h=0;h<o;h++){if(this.setAttributeVectorAtIndex(h,0,a,t,P(this,Ae)),this.setAttributeVectorAtIndex(h,1,a,t,P(this,dt)),this.setAttributeVectorAtIndex(h,2,a,t,P(this,ct)),P(this,we).copy(P(this,dt)).sub(P(this,Ae)),P(this,Be).copy(P(this,ct)).sub(P(this,Ae)),n.material.options.rendering.cullMode!=="none"){const f=this.getTriangleNormal().dot(P(this,be).direction);if(f>0&&n.material.options.rendering.cullMode==="back")continue;if(f<0&&n.material.options.rendering.cullMode==="front")continue}const l=new y;if(this.rayIntersectsTriangle(l)){const d=this.getBarycentricCoordinates(l),f=l.clone().applyMat4(n.worldMatrix),p=this.ray.origin.distance(f),m={object:n,distance:p,localPoint:l,point:f,triangle:[P(this,Ae).clone(),P(this,dt).clone(),P(this,ct).clone()],triangleIndex:h};s&&s.array&&s.array.length&&(this.setAttributeVectorAtIndex(h,0,a,s,P(this,Gt)),this.setAttributeVectorAtIndex(h,1,a,s,P(this,$t)),this.setAttributeVectorAtIndex(h,2,a,s,P(this,Ot)),m.uv=P(this,Gt).clone().multiplyScalar(d.x).add(P(this,$t).clone().multiplyScalar(d.y)).add(P(this,Ot).clone().multiplyScalar(d.z))),r&&r.array&&r.array.length&&(this.setAttributeVectorAtIndex(h,0,a,r,P(this,kt)),this.setAttributeVectorAtIndex(h,1,a,r,P(this,It)),this.setAttributeVectorAtIndex(h,2,a,r,P(this,Ut)),m.normal=P(this,kt).clone().multiplyScalar(d.x).add(P(this,It).clone().multiplyScalar(d.y)).add(P(this,Ut).clone().multiplyScalar(d.z))),e.push(m)}}return e},"intersectMesh_fn");const Vt=new y,pt=new re;class Br{static{c(this,"KeyframesAnimation")}constructor({label:e="",inputIndex:t=null,keyframes:i=null,values:s=null,path:r=null,interpolation:a="LINEAR"}={}){this.label=e,this.keyframes=i,this.values=s,this.path=r,this.interpolation=a,this.inputIndex=t,this.weightsBindingInputs=[],this.onAfterUpdate=null,this.duration=this.keyframes?this.keyframes[this.keyframes.length-1]:0}addWeightBindingInput(e){this.weightsBindingInputs.push(e)}getCubicSplineComponentValue(e,t,i,s,r){const a=e*e,o=a*e;return(2*o-3*a+1)*t+(o-2*a+e)*s+(-2*o+3*a)*i+(o-a)*r}getIndexFromInterpolation(e=0,t=1){return this.interpolation==="CUBICSPLINE"?e*3*t+t:e*t}update(e,t=0){if(!this.keyframes||!this.values||!this.path)return;const i=this.keyframes.findIndex(l=>l>=t);if(i===-1)return;const s=i-1;if(s===-1)return;const r=this.keyframes[i],a=this.keyframes[s],o=(t-a)/(r-a),h=r-a;if(this.path==="rotation"){const l=this.getIndexFromInterpolation(s,4),u=this.getIndexFromInterpolation(i,4);if(e.quaternion.setFromArray([this.values[l],this.values[l+1],this.values[l+2],this.values[l+3]]),this.interpolation==="LINEAR"||this.interpolation==="CUBICSPLINE")if(pt.setFromArray([this.values[u],this.values[u+1],this.values[u+2],this.values[u+3]]),this.interpolation==="CUBICSPLINE"){const d=[this.values[l+4],this.values[l+5],this.values[l+6],this.values[l+7]],f=[this.values[u-4],this.values[u-3],this.values[u-2],this.values[u-1]],p=[this.getCubicSplineComponentValue(o,e.quaternion.elements[0],pt.elements[0],h*d[0],h*f[0]),this.getCubicSplineComponentValue(o,e.quaternion.elements[1],pt.elements[1],h*d[1],h*f[1]),this.getCubicSplineComponentValue(o,e.quaternion.elements[2],pt.elements[2],h*d[2],h*f[2]),this.getCubicSplineComponentValue(o,e.quaternion.elements[3],pt.elements[3],h*d[3],h*f[3])];e.quaternion.setFromArray(p).normalize()}else e.quaternion.slerp(pt,o);e.shouldUpdateModelMatrix()}else if(this.path==="translation"||this.path==="scale"){const l=this.path==="translation"?"position":this.path,u=this.getIndexFromInterpolation(s,3),d=this.getIndexFromInterpolation(i,3);if(e[l].set(this.values[u],this.values[u+1],this.values[u+2]),this.interpolation==="LINEAR"||this.interpolation==="CUBICSPLINE")if(Vt.set(this.values[d],this.values[d+1],this.values[d+2]),this.interpolation==="CUBICSPLINE"){const f=[this.values[u+3],this.values[u+4],this.values[u+5]],p=[this.values[d-3],this.values[d-2],this.values[d-1]],m=[this.getCubicSplineComponentValue(o,e[l].x,Vt.x,h*f[0],h*p[0]),this.getCubicSplineComponentValue(o,e[l].y,Vt.y,h*f[1],h*p[1]),this.getCubicSplineComponentValue(o,e[l].z,Vt.z,h*f[2],h*p[2])];e[l].set(m[0],m[1],m[2])}else e[l].lerp(Vt,o)}else if(this.path==="weights"){const l=this.getIndexFromInterpolation(s,this.weightsBindingInputs.length),u=this.getIndexFromInterpolation(i,this.weightsBindingInputs.length);for(let d=0;d<this.weightsBindingInputs.length;d++){const f=this.values[l+d];if(this.weightsBindingInputs[d].value=f,this.interpolation==="LINEAR"){const p=this.values[u+d];this.weightsBindingInputs[d].value+=(p-f)*o}else if(this.interpolation==="CUBICSPLINE"){const p=this.values[u+d],m=this.values[l+d+1],g=this.values[u+d-1];this.weightsBindingInputs[d].value=this.getCubicSplineComponentValue(o,f,p,h*m[0],h*g[0])}}}}}var Cr=c((n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},"__accessCheck$1"),_e=c((n,e,t)=>(Cr(n,e,"read from private field"),t?t.call(n):e.get(n)),"__privateGet$1"),ft=c((n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},"__privateAdd$1"),Z=c((n,e,t,i)=>(Cr(n,e,"write to private field"),e.set(n,t),t),"__privateSet$1"),ma=c((n,e,t)=>(Cr(n,e,"access private method"),t),"__privateMethod$1"),Te,Nt,mt,Ue,gt,Ki,Sr;class ga{static{c(this,"TargetsAnimationsManager")}constructor(e,{label:t="",targets:i=[]}={}){ft(this,Ki),ft(this,Te,void 0),ft(this,Nt,void 0),ft(this,mt,void 0),ft(this,Ue,void 0),ft(this,gt,void 0),this.uuid=O(),this.inputIndices=[],this.setRenderer(e),this.label=t,this.targets=[],this.duration=0,this.timeScale=1,Z(this,Te,performance.now()),Z(this,Nt,performance.now()),Z(this,mt,0),Z(this,Ue,0),Z(this,Ue,0),Z(this,gt,1/0),this.isPlaying=!1,this.siblings=new Map,i&&i.length&&(this.targets=[...this.targets,...i])}setRenderer(e){this.renderer&&(this.renderer.animations.delete(this.uuid),this.renderer.animations.forEach(t=>t.siblings.delete(this.uuid))),e&&(e=$(e,"TargetsAnimationsManager"),this.renderer=e,this.renderer.animations.set(this.uuid,this),this.inputIndices.length&&ma(this,Ki,Sr).call(this))}addTarget(e){const t={object:e,animations:[]};return this.targets.push(t),t}addTargets(e){e.forEach(t=>this.addTarget(t))}addTargetAnimation(e,t){this.duration=Math.max(this.duration,t.duration);let i=this.getTargetByObject3D(e);i||(i=this.addTarget(e)),i.animations.push(t),t.inputIndex!==null&&!this.inputIndices.includes(t.inputIndex)&&this.inputIndices.push(t.inputIndex),ma(this,Ki,Sr).call(this)}getTargetByObject3D(e){return this.targets.find(t=>t.object.object3DIndex===e.object3DIndex)}getAnimationByObject3DAndPath(e,t){const i=this.getTargetByObject3D(e);return i?i.animations.find(s=>s.path===t):null}play(){this.isPlaying=!0}playOnce(){Z(this,gt,1),this.play()}pause(){this.isPlaying=!1,Z(this,Te,-1)}stop(){this.isPlaying=!1,Z(this,Ue,0),this.siblings.size||Z(this,Te,0),this.targets.forEach(e=>e.animations.forEach(t=>t.update(e.object,Math.min(t.duration,this.duration)))),this.renderer.onAfterRenderScene.add(()=>{this.targets.forEach(e=>{e.animations.forEach(t=>{t.onAfterUpdate&&t.onAfterUpdate()})})},{once:!0})}stopAtEndOfLoop(){Z(this,gt,_e(this,Ue)+1)}update(){if(!this.isPlaying)return;_e(this,Te)===-1?Z(this,Te,performance.now()-_e(this,mt)):_e(this,Te)===0&&Z(this,Te,performance.now()),Z(this,Nt,performance.now()),Z(this,mt,_e(this,Nt)-_e(this,Te));const e=_e(this,mt)*this.timeScale/1e3,t=e%this.duration;if(Z(this,Ue,Math.floor(e/this.duration)),_e(this,Ue)>=_e(this,gt)){this.stop();return}this.targets.forEach(i=>i.animations.forEach(s=>s.update(i.object,t)))}onAfterUpdate(){this.isPlaying&&this.targets.forEach(e=>e.animations.forEach(t=>{t.onAfterUpdate&&t.onAfterUpdate()}))}}Te=new WeakMap,Nt=new WeakMap,mt=new WeakMap,Ue=new WeakMap,gt=new WeakMap,Ki=new WeakSet,Sr=c(function(){this.siblings=new Map,this.renderer.animations.forEach(n=>{n.uuid!==this.uuid&&JSON.stringify(n.inputIndices)===JSON.stringify(this.inputIndices)?(this.siblings.set(n.uuid,n),n.siblings.set(this.uuid,this)):n.siblings.delete(this.uuid)})},"setSiblings_fn");var Mr=c((n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},"__accessCheck"),Tr=c((n,e,t)=>(Mr(n,e,"read from private field"),t?t.call(n):e.get(n)),"__privateGet"),Pr=c((n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},"__privateAdd"),ya=c((n,e,t,i)=>(Mr(n,e,"write to private field"),e.set(n,t),t),"__privateSet"),Wt=c((n,e,t)=>(Mr(n,e,"access private method"),t),"__privateMethod"),Qe,jt,Zi,Ji,Rr;const q=WebGLRenderingContext,me=class ue{static{c(this,"_GLTFScenesManager")}constructor({renderer:e,gltf:t}){Pr(this,jt),Pr(this,Ji),Pr(this,Qe,void 0),e=Ve(e,"GLTFScenesManager"),this.renderer=e,this.gltf=t,ya(this,Qe,new Map),this.scenesManager={node:new xe,nodes:new Map,boundingBox:new Se,samplers:[],materialsTextures:[],scenes:[],meshes:[],meshesDescriptors:[],animations:[],cameras:[],skins:[]},this.createSamplers(),this.createMaterialTextures(),this.createAnimations(),this.createScenes()}static getVertexAttributeParamsFromType(e){switch(e){case"VEC2":return{type:"vec2f",bufferFormat:"float32x2",size:2};case"VEC3":return{type:"vec3f",bufferFormat:"float32x3",size:3};case"VEC4":return{type:"vec4f",bufferFormat:"float32x4",size:4};case"MAT2":return{type:"mat2x2f",bufferFormat:"float32x2",size:6};case"MAT3":return{type:"mat3x3f",bufferFormat:"float32x3",size:9};case"MAT4":return{type:"mat4x4f",bufferFormat:"float32x4",size:16};case"SCALAR":default:return{type:"f32",bufferFormat:"float32",size:1}}}static getTypedArrayConstructorFromComponentType(e){switch(e){case q.BYTE:return Int8Array;case q.UNSIGNED_BYTE:return Uint8Array;case q.SHORT:return Int16Array;case q.UNSIGNED_SHORT:return Uint16Array;case q.UNSIGNED_INT:return Uint32Array;case q.FLOAT:default:return Float32Array}}static gpuPrimitiveTopologyForMode(e){switch(e){case q.TRIANGLES:return"triangle-list";case q.TRIANGLE_STRIP:return"triangle-strip";case q.LINES:return"line-list";case q.LINE_STRIP:return"line-strip";case q.POINTS:return"point-list"}}static gpuAddressModeForWrap(e){switch(e){case q.CLAMP_TO_EDGE:return"clamp-to-edge";case q.MIRRORED_REPEAT:return"mirror-repeat";default:return"repeat"}}createAnimations(){this.gltf.animations?.forEach((e,t)=>{this.scenesManager.animations.push(new ga(this.renderer,{label:e.name??"Animation "+t}))})}createSamplers(){if(this.gltf.samplers)for(const[e,t]of Object.entries(this.gltf.samplers)){const i={label:"glTF sampler "+e,name:"gltfSampler"+e,addressModeU:ue.gpuAddressModeForWrap(t.wrapS),addressModeV:ue.gpuAddressModeForWrap(t.wrapT)};switch((!t.magFilter||t.magFilter===q.LINEAR)&&(i.magFilter="linear"),t.minFilter){case q.NEAREST:break;case q.LINEAR:case q.LINEAR_MIPMAP_NEAREST:i.minFilter="linear";break;case q.NEAREST_MIPMAP_LINEAR:i.mipmapFilter="linear";break;case q.LINEAR_MIPMAP_LINEAR:default:i.minFilter="linear",i.mipmapFilter="linear";break}this.scenesManager.samplers.push(new He(this.renderer,i))}else this.scenesManager.samplers.push(new He(this.renderer,{label:"Default sampler",name:"defaultSampler",magFilter:"linear",minFilter:"linear",mipmapFilter:"linear"}))}createTexture(e,t,i){const s=(()=>{switch(i){case"baseColorTexture":case"emissiveTexture":return"bgra8unorm-srgb";case"occlusionTexture":return"r8unorm";default:return"bgra8unorm"}})(),r=new j(this.renderer,{label:e.name?e.name+": "+i:i,name:i,format:s,visibility:["fragment"],generateMips:!0,fixedSize:{width:t.width,height:t.height}});return r.uploadSource({source:t}),r}createMaterialTextures(){if(this.scenesManager.materialsTextures=[],this.gltf.materials)for(const[e,t]of Object.entries(this.gltf.materials)){const i={material:e,texturesDescriptors:[]},s=c(u=>u.texCoord&&u.texCoord!==0?"uv"+u.texCoord:"uv","getUVAttributeName"),r=c((u,d)=>{const f=u.index,p=this.gltf.imagesBitmaps[this.gltf.textures[f].source],m=this.createTexture(t,p,d),g=this.gltf.textures.find(x=>x.source===f)?.sampler;i.texturesDescriptors.push({texture:m,sampler:this.scenesManager.samplers[g??0],texCoordAttributeName:s(u)})},"createTexture");this.scenesManager.materialsTextures[e]=i,t.pbrMetallicRoughness&&(t.pbrMetallicRoughness.baseColorTexture&&t.pbrMetallicRoughness.baseColorTexture.index!==void 0&&r(t.pbrMetallicRoughness.baseColorTexture,"baseColorTexture"),t.pbrMetallicRoughness.metallicRoughnessTexture&&t.pbrMetallicRoughness.metallicRoughnessTexture.index!==void 0&&r(t.pbrMetallicRoughness.metallicRoughnessTexture,"metallicRoughnessTexture")),t.normalTexture&&t.normalTexture.index!==void 0&&r(t.normalTexture,"normalTexture"),t.occlusionTexture&&t.occlusionTexture.index!==void 0&&r(t.occlusionTexture,"occlusionTexture"),t.emissiveTexture&&t.emissiveTexture.index!==void 0&&r(t.emissiveTexture,"emissiveTexture");const{extensions:a}=t,o=a&&a.KHR_materials_transmission||null,h=a&&a.KHR_materials_specular||null,l=a&&a.KHR_materials_volume||null;if(o&&o.transmissionTexture&&o.transmissionTexture.index!==void 0&&r(o.transmissionTexture,"transmissionTexture"),h&&(h.specularTexture||h.specularColorTexture)){const{specularTexture:u,specularColorTexture:d}=h;u&&d&&(u.index!==void 0&&d.index!==void 0&&u.index===d.index?r(h.specularTexture,"specularTexture"):(u&&u.index!==void 0&&r(h.specularTexture,"specularFactorTexture"),d&&d.index!==void 0&&r(h.specularColorTexture,"specularColorTexture")))}l&&l.thicknessTexture&&l.thicknessTexture.index!==void 0&&r(l.thicknessTexture,"thicknessTexture")}}createNode(e,t,i){const s={index:i,name:t.name,node:new xe,children:[]};this.scenesManager.nodes.set(i,s.node),e.children.push(s),s.node.parent=e.node,t.matrix?(s.node.modelMatrix.setFromArray(new Float32Array(t.matrix)),s.node.matrices.model.shouldUpdate=!1):(t.translation&&s.node.position.set(t.translation[0],t.translation[1],t.translation[2]),t.scale&&s.node.scale.set(t.scale[0],t.scale[1],t.scale[2]),t.rotation&&s.node.quaternion.setFromArray(new Float32Array(t.rotation))),t.children&&t.children.forEach(a=>{const o=this.gltf.nodes[a];this.createNode(s,o,a)});let r=null;if(t.mesh!==void 0){let a=null;if(t.extensions&&t.extensions.EXT_mesh_gpu_instancing){const{attributes:h}=t.extensions.EXT_mesh_gpu_instancing;a={count:0,nodesTransformations:{}};for(const l of Object.entries(h)){const u=this.gltf.accessors[l[1]],d=this.gltf.bufferViews[u.bufferView],f=ue.getTypedArrayConstructorFromComponentType(u.componentType),p=ue.getVertexAttributeParamsFromType(u.type).size,m=new f(this.gltf.arrayBuffers[d.buffer],u.byteOffset+d.byteOffset,u.count*p);a.count=u.count,a.nodesTransformations[l[0].toLowerCase()]=m}}const o=this.gltf.meshes[t.mesh];o.primitives.forEach((h,l)=>{const u={parent:s.node,textures:[],parameters:{label:o.name?o.name+" "+l:"glTF mesh "+l},nodes:[],extensionsUsed:[]};if(r=Tr(this,Qe).get(h),r||(r={instances:[],nodes:[],meshDescriptor:u},Tr(this,Qe).set(h,r)),r.instances.push(t),r.nodes.push(s.node),a&&a.count)for(let d=0;d<a.count;d++){const f=new xe;if(a.nodesTransformations){const{translation:p,scale:m,rotation:g}=a.nodesTransformations;p&&f.position.set(p[d*3],p[d*3+1],p[d*3+2]),m&&f.scale.set(m[d*3],m[d*3+1],m[d*3+2]),g&&f.quaternion.setFromArray(Float32Array.from([g[d*4],g[d*4+1],g[d*4+2],g[d*4+3]]))}f.parent=s.node,r.instances.push(t),r.nodes.push(f)}})}if(t.camera!==void 0){const a=this.gltf.cameras[t.camera];if(a.type==="perspective"){const o=Math.min(this.renderer.boundingRect.width,this.renderer.boundingRect.height),h=o/a.perspective.aspectRatio,l=o*a.perspective.aspectRatio,u=a.perspective.yfov*180/Math.PI,d=new ls({fov:u,near:a.perspective.znear,far:a.perspective.zfar,width:h,height:l,pixelRatio:this.renderer.pixelRatio});d.parent=s.node,this.scenesManager.cameras.push(d)}else a.type==="orthographic"&&A("GLTFScenesManager: Orthographic cameras are not supported yet.")}this.gltf.animations&&this.scenesManager.animations.forEach((a,o)=>{const h=this.gltf.animations[o],l=h.channels.filter(u=>u.target.node===i);l&&l.length&&(a.addTarget(s.node),l.forEach(u=>{const d=h.samplers[u.sampler],f=u.target.path,p=this.gltf.accessors[d.input],m=this.gltf.bufferViews[p.bufferView],g=ue.getTypedArrayConstructorFromComponentType(p.componentType),x=this.gltf.accessors[d.output],v=this.gltf.bufferViews[x.bufferView],B=ue.getTypedArrayConstructorFromComponentType(x.componentType),R=new g(this.gltf.arrayBuffers[m.buffer],p.byteOffset+m.byteOffset,p.count*ue.getVertexAttributeParamsFromType(p.type).size),b=new B(this.gltf.arrayBuffers[v.buffer],x.byteOffset+v.byteOffset,x.count*ue.getVertexAttributeParamsFromType(x.type).size),C=t.name?`${t.name} animation`:`${u.target.path} animation ${i}`,M=new Br({label:h.name?`${h.name} ${C}`:`Animation ${o} ${C}`,inputIndex:d.input,keyframes:R,values:b,path:f,interpolation:d.interpolation});a.addTargetAnimation(s.node,M)}))})}static getCleanAttributeName(e){return e==="TEXCOORD_0"?"uv":e.replace("_","").replace("TEXCOORD","uv").toLowerCase()}sortAttributesByNames(e,t){t.sort((i,s)=>{let r=e.findIndex(o=>o===i.name);r=r===-1?1/0:r;let a=e.findIndex(o=>o===s.name);return a=a===-1?1/0:a,r-a})}createGeometry(e,t){const{instances:i,meshDescriptor:s}=t,r=new Se;for(const[m,g]of Object.entries(e.attributes))if(m==="POSITION"){const x=this.gltf.accessors[g];r&&(r.min.min(new y(x.min[0],x.min[1],x.min[2])),r.max.max(new y(x.max[0],x.max[1],x.max[2])))}let a=[],o=Wt(this,Ji,Rr).call(this,e.attributes,a);const h="indices"in e;let l=null,u=null;if(h){const m=this.gltf.accessors[e.indices],g=this.gltf.bufferViews[m.bufferView];u=ue.getTypedArrayConstructorFromComponentType(m.componentType);const x=u.name==="Uint8Array"?Uint16Array.BYTES_PER_ELEMENT:u.BYTES_PER_ELEMENT,v=m.byteOffset+g.byteOffset,B=this.gltf.arrayBuffers[g.buffer],R=Math.ceil(m.count/x)*x;l=u.name==="Uint8Array"?Uint16Array.from(new u(B,v,R)):new u(B,v,R)}const d=a.find(m=>m.name==="normal");d||(a=a.filter(m=>m.name!=="tangent"),o=null),o||this.sortAttributesByNames(["position","uv","normal"],a);const f={instancesCount:i.length,topology:ue.gpuPrimitiveTopologyForMode(e.mode),vertexBuffers:[{name:"attributes",stepMode:"vertex",attributes:a,...o&&{array:o}}]},p=h?Bt:ds;s.parameters.geometry=new p(f),d||s.parameters.geometry.computeGeometry(),s.parameters.geometry.boundingBox=r,h&&u&&l&&s.parameters.geometry.setIndexBuffer({bufferFormat:u.name==="Uint32Array"?"uint32":"uint16",array:l})}createSkins(){this.gltf.skins&&this.gltf.skins.forEach((e,t)=>{const s=this.gltf.nodes.find(d=>d.skin!==void 0&&d.mesh!==void 0&&d.skin===t).mesh;let r;if(e.inverseBindMatrices){const d=this.gltf.accessors[e.inverseBindMatrices],f=this.gltf.bufferViews[d.bufferView],p=ue.getTypedArrayConstructorFromComponentType(d.componentType);r=new p(this.gltf.arrayBuffers[f.buffer],d.byteOffset+f.byteOffset,d.count*ue.getVertexAttributeParamsFromType(d.type).size)}else{r=new Float32Array(16*e.joints.length);for(let d=0;d<e.joints.length*16;d+=16)r[d]=1,r[d+5]=1,r[d+10]=1,r[d+15]=1}const a=new X({label:"Skin "+t,name:"skin"+t,bindingType:"storage",visibility:["vertex"],childrenBindings:[{binding:new X({label:"Joints "+t,name:"joints",bindingType:"storage",visibility:["vertex"],struct:{jointMatrix:{type:"mat4x4f",value:new Float32Array(16)},normalMatrix:{type:"mat4x4f",value:new Float32Array(16)}}}),count:e.joints.length,forceArray:!0}]});for(let d=0;d<e.joints.length;d++){for(let f=0;f<16;f++)a.childrenBindings[d].inputs.jointMatrix.value[f]=r[d*16+f],a.childrenBindings[d].inputs.normalMatrix.value[f]=r[d*16+f];a.childrenBindings[d].inputs.jointMatrix.shouldUpdate=!0,a.childrenBindings[d].inputs.normalMatrix.shouldUpdate=!0}const o=e.joints.map(d=>this.scenesManager.nodes.get(d)),h=new L,l=new L,u=this.gltf.nodes.findIndex(d=>d.mesh!==void 0&&d.skin!==void 0&&d.mesh===s);if(u!==-1){const d=this.scenesManager.nodes.get(u),f=new L,p=d.updateWorldMatrix.bind(d);if(d.updateWorldMatrix=()=>{p(),f.copy(d.worldMatrix).invert()},this.scenesManager.animations.length)for(const m of this.scenesManager.animations)o.forEach((g,x)=>{const v=c(()=>{m.isPlaying?h.setFromArray(r,x*16).premultiply(g.worldMatrix).premultiply(f):h.identity(),l.copy(h).invert().transpose();for(let C=0;C<16;C++)a.childrenBindings[x].inputs.jointMatrix.value[C]=h.elements[C],a.childrenBindings[x].inputs.normalMatrix.value[C]=l.elements[C];a.childrenBindings[x].inputs.jointMatrix.shouldUpdate=!0,a.childrenBindings[x].inputs.normalMatrix.shouldUpdate=!0},"updateJointMatrix"),B=this.gltf.nodes[x],R=B.name?`${B.name} skin animation`:`skin animation ${x}`,b=new Br({label:m.label?`${m.label} ${R}`:`Animation ${R}`});b.onAfterUpdate=v,m.addTargetAnimation(g,b)});else o.forEach((m,g)=>{h.setFromArray(r,g*16).premultiply(m.worldMatrix).premultiply(f),l.copy(h).invert().transpose();for(let x=0;x<16;x++)a.childrenBindings[g].inputs.jointMatrix.value[x]=h.elements[x],a.childrenBindings[g].inputs.normalMatrix.value[x]=l.elements[x];a.childrenBindings[g].inputs.jointMatrix.shouldUpdate=!0,a.childrenBindings[g].inputs.normalMatrix.shouldUpdate=!0});this.scenesManager.skins.push({parentNode:d,joints:o,inverseBindMatrices:r,jointMatrix:h,normalMatrix:l,parentInverseWorldMatrix:f,binding:a})}})}createMaterial(e,t){const{instances:i,nodes:s,meshDescriptor:r}=t,a=i.length,o=i[0].mesh;if(e.targets){const b=[],C=this.gltf.meshes[o].weights;let M;for(const S of this.scenesManager.animations)if(M=S.getAnimationByObject3DAndPath(r.parent,"weights"),M)break;e.targets.forEach((S,z)=>{const E=[];Wt(this,Ji,Rr).call(this,S,E);const D=E.reduce((ie,N)=>ie={...ie,[N.name]:{type:`array<${N.type}>`,value:N.array}},{weight:{type:"f32",value:C&&C.length?C[z]:0}}),J=new X({label:"Morph target "+z,name:"morphTarget"+z,bindingType:"storage",visibility:["vertex"],struct:D});M&&M.addWeightBindingInput(J.inputs.weight),b.push(J)}),r.parameters.bindings||(r.parameters.bindings=[]),r.parameters.bindings=[...r.parameters.bindings,...b]}this.gltf.skins&&this.gltf.skins.forEach((b,C)=>{r.parameters.bindings||(r.parameters.bindings=[]),i.forEach((M,S)=>{if(M.skin!==void 0&&M.skin===C){const z=this.scenesManager.skins[C];if(r.parameters.bindings=[...r.parameters.bindings,z.binding],S>0){const E=r.parameters.geometry.boundingBox.clone(),D=new L;z.joints.forEach((J,ie)=>{D.setFromArray(z.inverseBindMatrices,ie*16);const N=E.applyMat4(D).applyMat4(J.worldMatrix);this.scenesManager.boundingBox.min.min(N.min),this.scenesManager.boundingBox.max.max(N.max)})}}})});const h=this.gltf.materials&&this.gltf.materials[e.material]||{},{extensions:l}=h;if(l)for(const b of Object.keys(l))b==="KHR_materials_unlit"&&this.gltf.extensionsRequired&&this.gltf.extensionsRequired.includes(b),r.extensionsUsed.push(b);const u=l&&l.KHR_materials_dispersion||null,d=l&&l.KHR_materials_emissive_strength||null,f=l&&l.KHR_materials_ior||null,p=l&&l.KHR_materials_transmission||null,m=l&&l.KHR_materials_specular||null,g=l&&l.KHR_materials_volume||null,x=p||g||u,v=this.gltf.extensionsUsed&&(this.gltf.extensionsUsed.includes("KHR_materials_transmission")||this.gltf.extensionsUsed.includes("KHR_materials_volume")||this.gltf.extensionsUsed.includes("KHR_materials_dispersion")),B=this.scenesManager.materialsTextures[e.material];r.parameters.samplers=[],r.parameters.textures=[],v&&x&&(r.parameters.transmissive=!0),B?.texturesDescriptors.forEach(b=>{r.textures.push({texture:b.texture.options.name,sampler:b.sampler.name,texCoordAttributeName:b.texCoordAttributeName}),r.parameters.samplers.find(M=>M.uuid===b.sampler.uuid)||r.parameters.samplers.push(b.sampler),r.parameters.textures.push(b.texture)}),r.parameters.cullMode=h.doubleSided?"none":"back",h.alphaMode==="BLEND"&&(r.parameters.transparent=!0,r.parameters.targets=[{blend:{color:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha"},alpha:{srcFactor:"one",dstFactor:"one"}}}]);const R={color:{type:"vec3f",value:h.pbrMetallicRoughness&&h.pbrMetallicRoughness.baseColorFactor!==void 0?new y(h.pbrMetallicRoughness.baseColorFactor[0],h.pbrMetallicRoughness.baseColorFactor[1],h.pbrMetallicRoughness.baseColorFactor[2]):new y(1)},opacity:{type:"f32",value:h.pbrMetallicRoughness&&h.pbrMetallicRoughness.baseColorFactor!==void 0?h.pbrMetallicRoughness.baseColorFactor[3]:1},alphaCutoff:{type:"f32",value:h.alphaCutoff!==void 0?h.alphaCutoff:h.alphaMode==="MASK"?.5:0},metallic:{type:"f32",value:h.pbrMetallicRoughness?.metallicFactor===void 0?1:h.pbrMetallicRoughness.metallicFactor},roughness:{type:"f32",value:h.pbrMetallicRoughness?.roughnessFactor===void 0?1:h.pbrMetallicRoughness.roughnessFactor},normalMapScale:{type:"f32",value:h.normalTexture?.scale===void 0?1:h.normalTexture.scale},occlusionIntensity:{type:"f32",value:h.occlusionTexture?.strength===void 0?1:h.occlusionTexture.strength},emissiveColor:{type:"vec3f",value:h.emissiveFactor!==void 0?new y(h.emissiveFactor[0],h.emissiveFactor[1],h.emissiveFactor[2]):new y(0)},emissiveIntensity:{type:"f32",value:d&&d.emissiveStrength!==void 0?d.emissiveStrength:1},specularIntensity:{type:"f32",value:m&&m.specularFactor!==void 0?m.specularFactor:1},specularColor:{type:"vec3f",value:m&&m.specularColorFactor!==void 0?new y(m.specularColorFactor[0],m.specularColorFactor[1],m.specularColorFactor[2]):new y(1)},transmission:{type:"f32",value:p&&p.transmissionFactor!==void 0?p.transmissionFactor:0},ior:{type:"f32",value:f&&f.ior!==void 0?f.ior:1.5},dispersion:{type:"f32",value:u&&u.dispersion!==void 0?u.dispersion:0},thickness:{type:"f32",value:g&&g.thicknessFactor!==void 0?g.thicknessFactor:0},attenuationDistance:{type:"f32",value:g&&g.attenuationDistance!==void 0?g.attenuationDistance:1/0},attenuationColor:{type:"vec3f",value:g&&g.attenuationColor!==void 0?new y(g.attenuationColor[0],g.attenuationColor[1],g.attenuationColor[2]):new y(1)}};if(Object.keys(R).length&&(r.parameters.uniforms={material:{visibility:["fragment"],struct:R}}),a>1){const b=new X({label:"Instance matrices",name:"matrices",visibility:["vertex","fragment"],bindingType:"storage",struct:{model:{type:"mat4x4f",value:new L},normal:{type:"mat3x3f",value:new ve}}}),C=new X({label:"Instances",name:"instances",visibility:["vertex","fragment"],bindingType:"storage",childrenBindings:[{binding:b,count:a,forceArray:!0}]});C.childrenBindings.forEach((M,S)=>{const z=s[S],E=c(()=>{M.inputs.model.value.copy(z.worldMatrix),M.inputs.normal.value.getNormalMatrix(z.worldMatrix),M.inputs.model.shouldUpdate=!0,M.inputs.normal.shouldUpdate=!0},"updateInstanceMatrices"),D=z.updateWorldMatrix.bind(z);z.updateWorldMatrix=()=>{D(),E()},E()}),r.parameters.bindings||(r.parameters.bindings=[]),r.parameters.bindings.push(C)}for(let b=0;b<s.length;b++){const M=r.parameters.geometry.boundingBox.clone().applyMat4(r.nodes[b].worldMatrix);this.scenesManager.boundingBox.min.min(M.min),this.scenesManager.boundingBox.max.max(M.max)}this.scenesManager.boundingBox.max.max(new y(.001))}createScenes(){this.scenesManager.node.parent=this.renderer.scene,this.gltf.scenes.forEach(e=>{const t={name:e.name,children:[],node:new xe};t.node.parent=this.scenesManager.node,this.scenesManager.scenes.push(t),e.nodes.forEach(i=>{const s=this.gltf.nodes[i];this.createNode(t,s,i)})}),this.scenesManager.node.updateMatrixStack(),this.createSkins();for(const[e,t]of Tr(this,Qe)){const{nodes:i,meshDescriptor:s}=t;s.nodes=i,this.scenesManager.meshesDescriptors.push(s),this.createGeometry(e,t),this.createMaterial(e,t)}}addMeshes(e=t=>{}){return this.scenesManager.node.updateMatrixStack(),this.scenesManager.meshesDescriptors.map(t=>{if(t.parameters.geometry){e(t);const i=new yn(this.renderer,{...t.parameters});return i.parent=t.parent,this.scenesManager.meshes.push(i),i}})}destroy(){this.scenesManager.meshes.forEach(e=>e.remove()),this.scenesManager.meshes=[],this.scenesManager.nodes.forEach(e=>{e.destroy()}),this.scenesManager.nodes=new Map,this.scenesManager.scenes.forEach(e=>{e.node.destroy()}),this.scenesManager.animations.forEach(e=>e.setRenderer(null)),this.scenesManager.node.destroy(),ya(this,Qe,new Map)}};Qe=new WeakMap,jt=new WeakSet,Zi=c(function(n){if(!n.sparse)return{indices:null,values:null};const e=me.getTypedArrayConstructorFromComponentType(n.componentType),t=me.getVertexAttributeParamsFromType(n.type).size,i=me.getTypedArrayConstructorFromComponentType(n.sparse.indices.componentType),s=this.gltf.bufferViews[n.sparse.indices.bufferView],r=new i(this.gltf.arrayBuffers[s.buffer],n.byteOffset+s.byteOffset,n.sparse.count),a=this.gltf.bufferViews[n.sparse.values.bufferView],o=new e(this.gltf.arrayBuffers[a.buffer],n.byteOffset+a.byteOffset,n.sparse.count*t);return{indices:r,values:o}},"getSparseAccessorIndicesAndValues_fn"),Ji=new WeakSet,Rr=c(function(n,e){let t=null,i=null,s=0;const r=Object.entries(n);r.sort((o,h)=>o[1]-h[1]);const a=Object.values(n);a.sort((o,h)=>o-h);for(const[o,h]of r){const l=me.getCleanAttributeName(o),u=this.gltf.accessors[h],d=u.componentType?me.getTypedArrayConstructorFromComponentType(u.componentType):Float32Array,f=this.gltf.bufferViews[u.bufferView],p=f.byteStride,m=u.byteOffset;p!==void 0&&m!==void 0&&m<p?s=Math.max(m,s):s=0,l==="position"&&(i=f);const x=me.getVertexAttributeParamsFromType(u.type),{size:v}=x;let B;if(s>0){const b=new d(this.gltf.arrayBuffers[f.buffer],0,f.byteLength/d.BYTES_PER_ELEMENT);B=new d(u.count*v);const C=m/d.BYTES_PER_ELEMENT;for(let M=0;M<u.count;M++)for(let S=0;S<v;S++)B[M*v+S]=b[C+v*M+v*M+S]}else if(f.byteStride&&f.byteStride>d.BYTES_PER_ELEMENT*v){const b=new DataView(this.gltf.arrayBuffers[f.buffer],f.byteOffset+u.byteOffset);B=new d(u.count*v);for(let C=0;C<u.count;C++){const M=C*f.byteStride;for(let S=0;S<v;S++)B[C*v+S]=b.getUint16(M+S*d.BYTES_PER_ELEMENT,!0)}}else B=new d(this.gltf.arrayBuffers[f.buffer],u.byteOffset+f.byteOffset,u.count*v);if(u.sparse){const{indices:b,values:C}=Wt(this,jt,Zi).call(this,u);for(let M=0;M<b.length;M++)for(let S=0;S<v;S++)B[b[M]*v+S]=C[M*v+S]}if(l.includes("weights"))for(let b=0;b<u.count*v;b+=v){const C=B[b],M=B[b+1],S=B[b+2],z=B[b+3];let E=Math.abs(C)+Math.abs(M)+Math.abs(S)+Math.abs(z);E>0?E=1/Math.sqrt(E):E=1,B[b]*=E,B[b+1]*=E,B[b+2]*=E,B[b+3]*=E}const R={name:l,...x,array:B};e.push(R)}if(s>0){const o=a.map(h=>this.gltf.accessors[h].bufferView);if(o.every(h=>h===o[0])){t=new Float32Array(this.gltf.arrayBuffers[i.buffer],i.byteOffset,Math.ceil(i.byteLength/4)*4/Float32Array.BYTES_PER_ELEMENT);let h=0;a.forEach(d=>{const f=this.gltf.accessors[d],p=me.getVertexAttributeParamsFromType(f.type).size,{indices:m,values:g}=Wt(this,jt,Zi).call(this,f);if(m&&g)for(let x=0;x<m.length;x++)for(let v=0;v<p;v++){const B=h+p*x;t[B+m[x]*p+v]=g[x*p+v]}h+=p});const u=Object.entries(n).sort((d,f)=>{const p=this.gltf.accessors[d[1]].byteOffset,m=this.gltf.accessors[f[1]].byteOffset;return p-m}).map(d=>me.getCleanAttributeName(d[0]));this.sortAttributesByNames(u,e)}else{let h=0;const l={},u=a.reduce((f,p)=>{const m=this.gltf.accessors[p],g=me.getVertexAttributeParamsFromType(m.type).size;return l[m.bufferView]||(l[m.bufferView]=0),l[m.bufferView]=Math.max(l[m.bufferView],m.byteOffset+g*Float32Array.BYTES_PER_ELEMENT),h+=g*Float32Array.BYTES_PER_ELEMENT,f+m.count*g},0);t=new Float32Array(Math.ceil(u/4)*4),a.forEach(f=>{const p=this.gltf.accessors[f],m=this.gltf.bufferViews[p.bufferView],g=me.getVertexAttributeParamsFromType(p.type).size,{indices:x,values:v}=Wt(this,jt,Zi).call(this,p);for(let B=0;B<p.count;B++){const R=p.byteOffset/Float32Array.BYTES_PER_ELEMENT+B*h/Float32Array.BYTES_PER_ELEMENT,b=new Float32Array(this.gltf.arrayBuffers[m.buffer],m.byteOffset+p.byteOffset+B*l[p.bufferView],g);if(x&&v&&x.includes(B))for(let C=0;B<g;C++)b[C]=v[B*g+C];t.subarray(R,R+g).set(b)}});const d=Object.entries(n).map(f=>me.getCleanAttributeName(f[0]));this.sortAttributesByNames(d,e)}}return t},"parsePrimitiveProperty_fn");let oh=me;const hh=c((n,e={})=>{const t=n.textures.find(b=>b.texture==="baseColorTexture"),i=n.textures.find(b=>b.texture==="normalTexture"),s=n.textures.find(b=>b.texture==="emissiveTexture"),r=n.textures.find(b=>b.texture==="occlusionTexture"),a=n.textures.find(b=>b.texture==="metallicRoughnessTexture"),o=n.textures.find(b=>b.texture==="specularTexture"),h=o||n.textures.find(b=>b.texture==="specularFactorTexture"),l=o||n.textures.find(b=>b.texture==="specularColorTexture"),u=n.textures.find(b=>b.texture==="transmissionTexture"),d=n.textures.find(b=>b.texture==="thicknessTexture"),f=n.parameters.transmissive?{texture:"transmissionBackgroundTexture",sampler:"transmissionSampler",texCoordAttributeName:"uv"}:null;let{shadingModel:p}=e;p||(p="PBR"),n.extensionsUsed.includes("KHR_materials_unlit")&&(p="Unlit");let{vertexChunks:g,fragmentChunks:x}=e||{};const{environmentMap:v}=e||{};v&&(n.parameters.textures=[...n.parameters.textures,v.lutTexture,v.diffuseTexture,v.specularTexture],n.parameters.samplers=[...n.parameters.samplers,v.sampler]);const B=Vn({bindings:n.parameters.bindings,geometry:n.parameters.geometry,chunks:g}),R=Xn({shadingModel:p,chunks:x,receiveShadows:!!n.parameters.receiveShadows,toneMapping:"Khronos",geometry:n.parameters.geometry,materialUniform:n.parameters.uniforms.material,materialUniformName:"material",extensionsUsed:n.extensionsUsed,baseColorTexture:t,normalTexture:i,metallicRoughnessTexture:a,specularTexture:o,specularFactorTexture:h,specularColorTexture:l,transmissionTexture:u,thicknessTexture:d,emissiveTexture:s,occlusionTexture:r,transmissionBackgroundTexture:f,environmentMap:v});return{vertex:{code:B,entryPoint:"main"},fragment:{code:R,entryPoint:"main"}}},"buildShaders"),xa=WebGLRenderingContext,lh=1179937895,Er={JSON:1313821514,BIN:5130562},uh=[0,0,0],dh=[0,0,0,1],ch=[1,1,1],ph=typeof window<"u"&&new RegExp(`^${window.location.protocol}`,"i")||RegExp("^(http|https):","i"),fh=/^data:/;class Qi{static{c(this,"GLTFLoader")}constructor(){this.gltf=null}static resolveUri(e,t){return e.match(ph)||e.match(fh)?e:t+e}async loadFromUrl(e){const t=e.lastIndexOf("/"),i=t!==0?e.substring(0,t+1):"",s=await fetch(e);if(e.endsWith(".gltf"))return this.loadFromJson(await s.json(),i);if(e.endsWith(".glb"))return this.loadFromBinary(await s.arrayBuffer(),i);throw new Error("Unrecognized file extension")}async loadFromJsonBase(e,t,i=null){if(!t)throw new Error("baseUrl must be specified.");if(!e.asset)throw new Error("Missing asset description.");if(e.asset.minVersion!=="2.0"&&e.asset.version!=="2.0")throw new Error("Incompatible asset version.");for(const a of e.accessors)a.byteOffset=a.byteOffset??0,a.normalized=a.normalized??!1;for(const a of e.bufferViews)a.byteOffset=a.byteOffset??0;for(const a of e.nodes)a.matrix||(a.rotation=a.rotation??dh,a.scale=a.scale??ch,a.translation=a.translation??uh);if(e.samplers)for(const a of e.samplers)a.wrapS=a.wrapS??xa.REPEAT,a.wrapT=a.wrapT??xa.REPEAT;const s=[];if(i)s.push(Promise.resolve(i));else for(const a in e.buffers){const o=e.buffers[a],h=Qi.resolveUri(o.uri,t);s[a]=fetch(h).then(l=>l.arrayBuffer())}const r=[];for(let a=0;a<e.images?.length;++a){const o=e.images[a];if(o.uri)r[a]=fetch(Qi.resolveUri(o.uri,t)).then(async h=>createImageBitmap(await h.blob()));else{const h=e.bufferViews[o.bufferView];r[a]=s[h.buffer].then(l=>{const u=new Blob([new Uint8Array(l,h.byteOffset,h.byteLength)],{type:o.mimeType});return createImageBitmap(u)})}}return{...e,arrayBuffers:await Promise.all(s),imagesBitmaps:await Promise.all(r)}}async loadFromBinary(e,t){const i=new DataView(e,0,12),s=i.getUint32(0,!0),r=i.getUint32(4,!0),a=i.getUint32(8,!0);if(s!==lh)throw new Error("Invalid magic string in binary header.");if(r!==2)throw new Error("Incompatible version in binary header.");const o={};let h=12;for(;h<a;){const d=new DataView(e,h,8),f=d.getUint32(0,!0),p=d.getUint32(4,!0);o[p]=e.slice(h+8,h+8+f),h+=f+8}if(!o[Er.JSON])throw new Error("File contained no json chunk.");const u=new TextDecoder("utf-8").decode(o[Er.JSON]);return this.loadFromJson(JSON.parse(u),t,o[Er.BIN])}async loadFromJson(e,t,i=null){return this.gltf=await this.loadFromJsonBase(e,t,i),this.gltf}}w.AmbientLight=ja,w.BindGroup=Kt,w.Binding=Ht,w.Box3=Se,w.BoxGeometry=ih,w.Buffer=Ne,w.BufferBinding=X,w.Camera=ls,w.ComputeMaterial=Ur,w.ComputePass=hi,w.ComputePipelineEntry=Rs,w.DOMElement=zs,w.DOMFrustum=jr,w.DOMMesh=Qn,w.DOMObject3D=Zn,w.DOMTexture=qe,w.DirectionalLight=io,w.EnvironmentMap=th,w.FullscreenPlane=Ts,w.GLTFLoader=Qi,w.GLTFScenesManager=oh,w.GPUCameraRenderer=Fs,w.GPUCurtains=Ho,w.GPUCurtainsRenderer=Fi,w.GPUDeviceManager=Sn,w.GPURenderer=Ls,w.Geometry=ds,w.HDRLoader=da,w.IndexedGeometry=Bt,w.IndirectBuffer=Tn,w.KeyframesAnimation=Br,w.Mat3=ve,w.Mat4=L,w.Material=us,w.Mesh=yn,w.Object3D=xe,w.OrbitControls=Yo,w.PingPongPlane=rh,w.PipelineEntry=ms,w.PipelineManager=xn,w.Plane=ea,w.PlaneGeometry=cs,w.PointLight=lo,w.ProjectedObject3D=Ps,w.Quat=re,w.Raycaster=ah,w.RenderBundle=Do,w.RenderMaterial=vs,w.RenderPass=di,w.RenderPipelineEntry=tt,w.RenderTarget=fs,w.Sampler=He,w.SamplerBinding=$r,w.Scene=vn,w.ShaderPass=Go,w.SphereGeometry=sh,w.TargetsAnimationsManager=ga,w.Texture=j,w.TextureBindGroup=hs,w.TextureBinding=os,w.Vec2=_,w.Vec3=y,w.WritableBufferBinding=as,w.buildShaders=hh,w.getFragmentShaderCode=Xn,w.getLambert=$o,w.getLambertFragmentShaderCode=Wn,w.getPBR=ko,w.getPbrFragmentShaderCode=Yn,w.getPhong=Oo,w.getPhongFragmentShaderCode=Hn,w.getUnlitFragmentShaderCode=Nn,w.getVertexShaderCode=Vn,w.lambertUtils=Ri});
