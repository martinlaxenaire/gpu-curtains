...
@fragment fn main(fsInput: VSOutput) -> @location(0) vec4f {
  ...
  `;return{vertex:{code:b,entryPoint:"main"},fragment:{code:_,entryPoint:"main"}}},ms=(o,e=null)=>{let{chunks:t}=e;const s=`
