...
`,gr=n=>{const e=n.shadowCastingLights.filter(t=>t.type==="directionalLights");return`
...
fn getPCFPointShadowContribution(index: i32, shadowPosition: vec4f, depthCubeTexture: texture_depth_cube) -> f32 {
  ...
  return visibility;
}`,wr=n=>{const e=n.shadowCastingLights.filter(t=>t.type==="pointLights");return`
