(function(x,Y){typeof exports=="object"&&typeof module<"u"?Y(exports):typeof define=="function"&&define.amd?define(["exports"],Y):(x=typeof globalThis<"u"?globalThis:x||self,Y(x.window=x.window||{}))})(this,function(x){"use strict";const Y=()=>"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,n=>{const e=Math.random()*16|0;return(n==="x"?e:e&3|8).toString(16).toUpperCase()}),st=n=>n.replace(/(?:^\w|[A-Z]|\b\w)/g,(e,t)=>t===0?e.toLowerCase():e.toUpperCase()).replace(/\s+/g,""),rt=n=>{const e=st(n);return e.charAt(0).toUpperCase()+e.slice(1)};let Ri=0;const L=n=>{Ri>100||(console.warn(Ri===100?"GPUCurtains: too many warnings thrown, stop logging.":n),Ri++)},ie=n=>{throw new Error(n)},zi=(n,e="GPURenderer",t)=>{const i=t?`Unable to create ${t} because the ${e} is not defined: ${n}`:`The ${e} is not defined: ${n}`;ie(i)},N=(n,e)=>(n=n&&n.renderer||n,n&&(n.type==="GPURenderer"||n.type==="GPUCameraRenderer"||n.type==="GPUCurtainsRenderer")||zi(n,"GPURenderer",e),n),Oe=(n,e)=>(n=n&&n.renderer||n,n&&(n.type==="GPUCameraRenderer"||n.type==="GPUCurtainsRenderer")||zi(n,"GPUCameraRenderer",e),n),Ei=(n,e)=>(n=n&&n.renderer||n,n&&n.type==="GPUCurtainsRenderer"||zi(n,"GPUCurtainsRenderer",e),n),Sn=n=>n.constructor.name==="Mesh"||n.constructor.name==="DOMMesh"||n.constructor.name==="Plane"?n:!1,Li=(()=>{let n,e;const t={};return function(s,r){e||(e=s.createShaderModule({label:"textured quad shaders for mip level generation",code:`
            struct VSOutput {
          ...
          `}),n=s.createSampler({minFilter:"linear",magFilter:"linear"})),t[r.format]||(t[r.format]=s.createRenderPipeline({label:"Mip level generator pipeline",layout:"auto",vertex:{module:e},fragment:{module:e,targets:[{format:r.format}]}}));const o=t[r.format],a=s.createCommandEncoder({label:"Mip gen encoder"});let h=r.width,l=r.height,u=0;for(;h>1||l>1;){h=Math.max(1,h/2|0),l=Math.max(1,l/2|0);for(let p=0;p<r.depthOrArrayLayers;++p){const d=s.createBindGroup({layout:o.getBindGroupLayout(0),entries:[{binding:0,resource:n},{binding:1,resource:r.createView({dimension:"2d",baseMipLevel:u,mipLevelCount:1,baseArrayLayer:p,arrayLayerCount:1})}]}),f={label:"Mip generation render pass",colorAttachments:[{view:r.createView({dimension:"2d",baseMipLevel:u+1,mipLevelCount:1,baseArrayLayer:p,arrayLayerCount:1}),loadOp:"clear",storeOp:"store"}]},g=a.beginRenderPass(f);g.setPipeline(o),g.setBindGroup(0,d),g.draw(6),g.end()}++u}const c=a.finish();s.queue.submit([c])}})(),_i=typeof GPUShaderStage<"u"?GPUShaderStage:{VERTEX:1,FRAGMENT:2,COMPUTE:4},xe=typeof GPUBufferUsage<"u"?GPUBufferUsage:{MAP_READ:1,MAP_WRITE:2,COPY_SRC:4,COPY_DST:8,INDEX:16,VERTEX:32,UNIFORM:64,STORAGE:128,INDIRECT:256,QUERY_RESOLVE:512},nt=typeof GPUTextureUsage<"u"?GPUTextureUsage:{COPY_SRC:1,COPY_DST:2,TEXTURE_BINDING:4,STORAGE_BINDING:8,RENDER_ATTACHMENT:16},Pn=new Map([["vertex",_i.VERTEX],["fragment",_i.FRAGMENT],["compute",_i.COMPUTE]]),Tn=(n=[])=>n.reduce((e,t)=>e|Pn.get(t),0),Rn={i32:{numElements:1,align:4,size:4,type:"i32",View:Int32Array},u32:{numElements:1,align:4,size:4,type:"u32",View:Uint32Array},f32:{numElements:1,align:4,size:4,type:"f32",View:Float32Array},f16:{numElements:1,align:2,size:2,type:"u16",View:Uint16Array},vec2f:{numElements:2,align:8,size:8,type:"f32",View:Float32Array},vec2i:{numElements:2,align:8,size:8,type:"i32",View:Int32Array},vec2u:{numElements:2,align:8,size:8,type:"u32",View:Uint32Array},vec2h:{numElements:2,align:4,size:4,type:"u16",View:Uint16Array},vec3i:{numElements:3,align:16,size:12,type:"i32",View:Int32Array},vec3u:{numElements:3,align:16,size:12,type:"u32",View:Uint32Array},vec3f:{numElements:3,align:16,size:12,type:"f32",View:Float32Array},vec3h:{numElements:3,align:8,size:6,type:"u16",View:Uint16Array},vec4i:{numElements:4,align:16,size:16,type:"i32",View:Int32Array},vec4u:{numElements:4,align:16,size:16,type:"u32",View:Uint32Array},vec4f:{numElements:4,align:16,size:16,type:"f32",View:Float32Array},vec4h:{numElements:4,align:8,size:8,type:"u16",View:Uint16Array},mat2x2f:{numElements:4,align:8,size:16,type:"f32",View:Float32Array},mat2x2h:{numElements:4,align:4,size:8,type:"u16",View:Uint16Array},mat3x2f:{numElements:6,align:8,size:24,type:"f32",View:Float32Array},mat3x2h:{numElements:6,align:4,size:12,type:"u16",View:Uint16Array},mat4x2f:{numElements:8,align:8,size:32,type:"f32",View:Float32Array},mat4x2h:{numElements:8,align:4,size:16,type:"u16",View:Uint16Array},mat2x3f:{numElements:8,align:16,size:32,pad:[3,1],type:"f32",View:Float32Array},mat2x3h:{numElements:8,align:8,size:16,pad:[3,1],type:"u16",View:Uint16Array},mat3x3f:{numElements:12,align:16,size:48,pad:[3,1],type:"f32",View:Float32Array},mat3x3h:{numElements:12,align:8,size:24,pad:[3,1],type:"u16",View:Uint16Array},mat4x3f:{numElements:16,align:16,size:64,pad:[3,1],type:"f32",View:Float32Array},mat4x3h:{numElements:16,align:8,size:32,pad:[3,1],type:"u16",View:Uint16Array},mat2x4f:{numElements:8,align:16,size:32,type:"f32",View:Float32Array},mat2x4h:{numElements:8,align:8,size:16,type:"u16",View:Uint16Array},mat3x4f:{numElements:12,align:16,size:48,pad:[3,1],type:"f32",View:Float32Array},mat3x4h:{numElements:12,align:8,size:24,pad:[3,1],type:"u16",View:Uint16Array},mat4x4f:{numElements:16,align:16,size:64,type:"f32",View:Float32Array},mat4x4h:{numElements:16,align:8,size:32,type:"u16",View:Uint16Array}},Ws=n=>Rn[n],zt=n=>(()=>{switch(n.bindingType){case"storage":return`var<${n.bindingType}, ${n.options.access}>`;case"uniform":default:return"var<uniform>"}})(),zn=n=>n.bindingType==="externalTexture"?`var ${n.name}: texture_external;`:n.bindingType==="storage"?`var ${n.name}: texture_storage_${n.options.viewDimension.replace("-","_")}<${n.options.format}, ${n.options.access}>;`:n.bindingType==="depth"?`var ${n.name}: texture_depth${n.options.multisampled?"_multisampled":""}_${n.options.viewDimension.replace("-","_")};`:`var ${n.name}: texture${n.options.multisampled?"_multisampled":""}_${n.options.viewDimension.replace("-","_")}<f32>;`,js=n=>n.bindingType==="storage"&&n.options.access==="read_write"?"storage":n.bindingType==="storage"?"read-only-storage":"uniform",En=n=>(()=>{switch(n.bindingType){case"externalTexture":return{externalTexture:{}};case"storage":return{storageTexture:{format:n.options.format,viewDimension:n.options.viewDimension}};case"texture":return{texture:{multisampled:n.options.multisampled,viewDimension:n.options.viewDimension,sampleType:n.options.multisampled?"unfilterable-float":"float"}};case"depth":return{texture:{multisampled:n.options.multisampled,viewDimension:n.options.viewDimension,sampleType:"depth"}};default:return null}})(),Ln=n=>(()=>{switch(n.bindingType){case"externalTexture":return`externalTexture,${n.visibility},`;case"storage":return`storageTexture,${n.options.format},${n.options.viewDimension},${n.visibility},`;case"texture":return`texture,${n.options.multisampled},${n.options.viewDimension},${n.options.multisampled?"unfilterable-float":"float"},${n.visibility},`;case"depth":return`depthTexture,${n.options.format},${n.options.viewDimension},${n.visibility},`;default:return`${n.visibility},`}})();class Et{constructor({label:e="Uniform",name:t="uniform",bindingType:i="uniform",visibility:s=["vertex","fragment","compute"]}){this.label=e,this.name=st(t),this.bindingType=i,this.visibility=Tn(s),this.options={label:e,name:t,bindingType:i,visibility:s},this.shouldResetBindGroup=!1,this.shouldResetBindGroupLayout=!1,this.cacheKey=`${i},${this.visibility},`}}class _{constructor(e=0,t=e){this.type="Vec2",this._x=e,this._y=t}get x(){return this._x}set x(e){const t=e!==this._x;this._x=e,t&&this._onChangeCallback&&this._onChangeCallback()}get y(){return this._y}set y(e){const t=e!==this._y;this._y=e,t&&this._onChangeCallback&&this._onChangeCallback()}onChange(e){return e&&(this._onChangeCallback=e),this}set(e=0,t=e){return this.x=e,this.y=t,this}add(e=new _){return this.x+=e.x,this.y+=e.y,this}addScalar(e=0){return this.x+=e,this.y+=e,this}sub(e=new _){return this.x-=e.x,this.y-=e.y,this}subScalar(e=0){return this.x-=e,this.y-=e,this}multiply(e=new _(1)){return this.x*=e.x,this.y*=e.y,this}multiplyScalar(e=1){return this.x*=e,this.y*=e,this}divide(e=new _(1)){return this.x/=e.x,this.y/=e.y,this}divideScalar(e=1){return this.x/=e,this.y/=e,this}copy(e=new _){return this.x=e.x,this.y=e.y,this}clone(){return new _(this.x,this.y)}max(e=new _){return this.x=Math.max(this.x,e.x),this.y=Math.max(this.y,e.y),this}min(e=new _){return this.x=Math.min(this.x,e.x),this.y=Math.min(this.y,e.y),this}clamp(e=new _,t=new _){return this.x=Math.max(e.x,Math.min(t.x,this.x)),this.y=Math.max(e.y,Math.min(t.y,this.y)),this}equals(e=new _){return this.x===e.x&&this.y===e.y}lengthSq(){return this.x*this.x+this.y*this.y}length(){return Math.sqrt(this.lengthSq())}normalize(){let e=this.x*this.x+this.y*this.y;return e>0&&(e=1/Math.sqrt(e)),this.x*=e,this.y*=e,this}dot(e=new _){return this.x*e.x+this.y*e.y}lerp(e=new _,t=1){return this.x+=(e.x-this.x)*t,this.y+=(e.y-this.y)*t,this}}class ce{constructor(e=new Float32Array([0,0,0,1]),t="XYZ"){this.type="Quat",this.elements=e,this.axisOrder=t}setFromArray(e=new Float32Array([0,0,0,1])){return this.elements[0]=e[0],this.elements[1]=e[1],this.elements[2]=e[2],this.elements[3]=e[3],this}setAxisOrder(e="XYZ"){switch(e=e.toUpperCase(),e){case"XYZ":case"YXZ":case"ZXY":case"ZYX":case"YZX":case"XZY":this.axisOrder=e;break;default:this.axisOrder="XYZ"}return this}copy(e=new ce){return this.elements=e.elements,this.axisOrder=e.axisOrder,this}clone(){return new ce().copy(this)}equals(e=new ce){return this.elements[0]===e.elements[0]&&this.elements[1]===e.elements[1]&&this.elements[2]===e.elements[2]&&this.elements[3]===e.elements[3]&&this.axisOrder===e.axisOrder}setFromVec3(e){const t=e.x*.5,i=e.y*.5,s=e.z*.5,r=Math.cos(t),o=Math.cos(i),a=Math.cos(s),h=Math.sin(t),l=Math.sin(i),u=Math.sin(s);return this.axisOrder==="XYZ"?(this.elements[0]=h*o*a+r*l*u,this.elements[1]=r*l*a-h*o*u,this.elements[2]=r*o*u+h*l*a,this.elements[3]=r*o*a-h*l*u):this.axisOrder==="YXZ"?(this.elements[0]=h*o*a+r*l*u,this.elements[1]=r*l*a-h*o*u,this.elements[2]=r*o*u-h*l*a,this.elements[3]=r*o*a+h*l*u):this.axisOrder==="ZXY"?(this.elements[0]=h*o*a-r*l*u,this.elements[1]=r*l*a+h*o*u,this.elements[2]=r*o*u+h*l*a,this.elements[3]=r*o*a-h*l*u):this.axisOrder==="ZYX"?(this.elements[0]=h*o*a-r*l*u,this.elements[1]=r*l*a+h*o*u,this.elements[2]=r*o*u-h*l*a,this.elements[3]=r*o*a+h*l*u):this.axisOrder==="YZX"?(this.elements[0]=h*o*a+r*l*u,this.elements[1]=r*l*a+h*o*u,this.elements[2]=r*o*u-h*l*a,this.elements[3]=r*o*a-h*l*u):this.axisOrder==="XZY"&&(this.elements[0]=h*o*a-r*l*u,this.elements[1]=r*l*a-h*o*u,this.elements[2]=r*o*u+h*l*a,this.elements[3]=r*o*a+h*l*u),this}setFromAxisAngle(e,t=0){const i=t/2,s=Math.sin(i);return this.elements[0]=e.x*s,this.elements[1]=e.y*s,this.elements[2]=e.z*s,this.elements[3]=Math.cos(i),this}setFromRotationMatrix(e){const t=e.elements,i=t[0],s=t[4],r=t[8],o=t[1],a=t[5],h=t[9],l=t[2],u=t[6],c=t[10],p=i+a+c;if(p>0){const d=.5/Math.sqrt(p+1);this.elements[3]=.25/d,this.elements[0]=(u-h)*d,this.elements[1]=(r-l)*d,this.elements[2]=(o-s)*d}else if(i>a&&i>c){const d=2*Math.sqrt(1+i-a-c);this.elements[3]=(u-h)/d,this.elements[0]=.25*d,this.elements[1]=(s+o)/d,this.elements[2]=(r+l)/d}else if(a>c){const d=2*Math.sqrt(1+a-i-c);this.elements[3]=(r-l)/d,this.elements[0]=(s+o)/d,this.elements[1]=.25*d,this.elements[2]=(h+u)/d}else{const d=2*Math.sqrt(1+c-i-a);this.elements[3]=(o-s)/d,this.elements[0]=(r+l)/d,this.elements[1]=(h+u)/d,this.elements[2]=.25*d}return this}}class m{constructor(e=0,t=e,i=e){this.type="Vec3",this._x=e,this._y=t,this._z=i}get x(){return this._x}set x(e){const t=e!==this._x;this._x=e,t&&this._onChangeCallback&&this._onChangeCallback()}get y(){return this._y}set y(e){const t=e!==this._y;this._y=e,t&&this._onChangeCallback&&this._onChangeCallback()}get z(){return this._z}set z(e){const t=e!==this._z;this._z=e,t&&this._onChangeCallback&&this._onChangeCallback()}onChange(e){return e&&(this._onChangeCallback=e),this}set(e=0,t=e,i=e){return this.x=e,this.y=t,this.z=i,this}add(e=new m){return this.x+=e.x,this.y+=e.y,this.z+=e.z,this}addScalar(e=0){return this.x+=e,this.y+=e,this.z+=e,this}sub(e=new m){return this.x-=e.x,this.y-=e.y,this.z-=e.z,this}subScalar(e=0){return this.x-=e,this.y-=e,this.z-=e,this}multiply(e=new m(1)){return this.x*=e.x,this.y*=e.y,this.z*=e.z,this}multiplyScalar(e=1){return this.x*=e,this.y*=e,this.z*=e,this}divide(e=new m(1)){return this.x/=e.x,this.y/=e.y,this.z/=e.z,this}divideScalar(e=1){return this.x/=e,this.y/=e,this.z/=e,this}copy(e=new m){return this.x=e.x,this.y=e.y,this.z=e.z,this}clone(){return new m(this.x,this.y,this.z)}max(e=new m){return this.x=Math.max(this.x,e.x),this.y=Math.max(this.y,e.y),this.z=Math.max(this.z,e.z),this}min(e=new m){return this.x=Math.min(this.x,e.x),this.y=Math.min(this.y,e.y),this.z=Math.min(this.z,e.z),this}clamp(e=new m,t=new m){return this.x=Math.max(e.x,Math.min(t.x,this.x)),this.y=Math.max(e.y,Math.min(t.y,this.y)),this.z=Math.max(e.z,Math.min(t.z,this.z)),this}equals(e=new m){return this.x===e.x&&this.y===e.y&&this.z===e.z}lengthSq(){return this.x*this.x+this.y*this.y+this.z*this.z}length(){return Math.sqrt(this.lengthSq())}distance(e=new m){return Math.hypot(e.x-this.x,e.y-this.y,e.z-this.z)}normalize(){let e=this.lengthSq();return e>0&&(e=1/Math.sqrt(e)),this.x*=e,this.y*=e,this.z*=e,this}dot(e=new m){return this.x*e.x+this.y*e.y+this.z*e.z}cross(e=new m){return this.crossVectors(this,e)}crossVectors(e=new m,t=new m){const i=e.x,s=e.y,r=e.z,o=t.x,a=t.y,h=t.z;return this.x=s*h-r*a,this.y=r*o-i*h,this.z=i*a-s*o,this}lerp(e=new m,t=1){return this.x+=(e.x-this.x)*t,this.y+=(e.y-this.y)*t,this.z+=(e.z-this.z)*t,this}applyMat4(e){const t=this._x,i=this._y,s=this._z,r=e.elements;let o=r[3]*t+r[7]*i+r[11]*s+r[15];return o=o||1,this.x=(r[0]*t+r[4]*i+r[8]*s+r[12])/o,this.y=(r[1]*t+r[5]*i+r[9]*s+r[13])/o,this.z=(r[2]*t+r[6]*i+r[10]*s+r[14])/o,this}setFromMatrixPosition(e){const t=e.elements;return this.x=t[12],this.y=t[13],this.z=t[14],this}applyQuat(e=new ce){const t=this.x,i=this.y,s=this.z,r=e.elements[0],o=e.elements[1],a=e.elements[2],h=e.elements[3],l=h*t+o*s-a*i,u=h*i+a*t-r*s,c=h*s+r*i-o*t,p=-r*t-o*i-a*s;return this.x=l*h+p*-r+u*-a-c*-o,this.y=u*h+p*-o+c*-r-l*-a,this.z=c*h+p*-a+l*-o-u*-r,this}applyAxisAngle(e=new m,t=0,i=new ce){return this.applyQuat(i.setFromAxisAngle(e,t))}transformDirection(e){const t=this.x,i=this.y,s=this.z,r=e.elements;return this.x=r[0]*t+r[4]*i+r[8]*s,this.y=r[1]*t+r[5]*i+r[9]*s,this.z=r[2]*t+r[6]*i+r[10]*s,this.normalize()}project(e){return this.applyMat4(e.viewMatrix).applyMat4(e.projectionMatrix),this}unproject(e){return this.applyMat4(e.projectionMatrix.getInverse()).applyMat4(e.modelMatrix),this}}const _n=4,Lt=4,K=_n*Lt;class Ai{constructor({name:e,key:t,type:i="f32"}){this.name=e,this.key=t,this.type=i,this.bufferLayout=Ws(this.type.replace("array","").replace("<","").replace(">","")),this.alignment={start:{row:0,byte:0},end:{row:0,byte:0}},this.setValue=null}get rowCount(){return this.alignment.end.row-this.alignment.start.row+1}get byteCount(){return Math.abs(this.endOffset-this.startOffset)+1}get paddedByteCount(){return(this.alignment.end.row+1)*K}get startOffset(){return this.getByteCountAtPosition(this.alignment.start)}get startOffsetToIndex(){return this.startOffset/Lt}get endOffset(){return this.getByteCountAtPosition(this.alignment.end)}get endOffsetToIndex(){return Math.floor(this.endOffset/Lt)}getPositionAtOffset(e=0){return{row:Math.floor(e/K),byte:e%K}}getByteCountAtPosition(e={row:0,byte:0}){return e.row*K+e.byte}applyOverflowToPosition(e={row:0,byte:0}){if(e.byte>K-1){const t=e.byte%K;e.row+=Math.floor(e.byte/K),e.byte=t}return e}getByteCountBetweenPositions(e={row:0,byte:0},t={row:0,byte:0}){return Math.abs(this.getByteCountAtPosition(t)-this.getByteCountAtPosition(e))}getElementAlignment(e={row:0,byte:0}){const t={start:e,end:e},{size:i,align:s}=this.bufferLayout;return e.byte%s!==0&&(e.byte+=e.byte%s),(i<=K&&e.byte+i>K||i>K&&(e.byte>K||e.byte>0))&&(e.row+=1,e.byte=0),t.end={row:e.row+Math.ceil(i/K)-1,byte:e.byte+(i%K===0?K-1:i%K-1)},t.end=this.applyOverflowToPosition(t.end),t}setAlignmentFromPosition(e={row:0,byte:0}){this.alignment=this.getElementAlignment(e)}setAlignment(e=0){this.setAlignmentFromPosition(this.getPositionAtOffset(e))}setView(e,t){this.view=new this.bufferLayout.View(e,this.startOffset,this.byteCount/this.bufferLayout.View.BYTES_PER_ELEMENT)}setValueFromFloat(e){this.view[0]=e}setValueFromVec2(e){this.view[0]=e.x??e[0]??0,this.view[1]=e.y??e[1]??0}setValueFromVec3(e){this.view[0]=e.x??e[0]??0,this.view[1]=e.y??e[1]??0,this.view[2]=e.z??e[2]??0}setValueFromMat4OrQuat(e){this.view.set(e.elements)}setValueFromMat3(e){this.setValueFromArrayWithPad(e.elements)}setValueFromArray(e){this.view.set(e)}setValueFromArrayWithPad(e){for(let t=0,i=0;t<this.view.length;t+=this.bufferLayout.pad[0]+this.bufferLayout.pad[1],i++)for(let s=0;s<this.bufferLayout.pad[0];s++)this.view[t+s]=e[t+s-i]}update(e){this.setValue||(this.setValue=(t=>{if(this.type==="f32"||this.type==="u32"||this.type==="i32")return this.setValueFromFloat;if(this.type==="vec2f")return this.setValueFromVec2;if(this.type==="vec3f")return this.setValueFromVec3;if(this.type==="mat3x3f")return t.elements?this.setValueFromMat3:this.setValueFromArrayWithPad;if(t.elements)return this.setValueFromMat4OrQuat;if(ArrayBuffer.isView(t)||Array.isArray(t))return this.bufferLayout.pad?this.setValueFromArrayWithPad:this.setValueFromArray;L(`${this.constructor.name}: value passed to ${this.name} cannot be used: ${t}`)})(e)),this.setValue(e)}extractDataFromBufferResult(e){return e.slice(this.startOffsetToIndex,this.endOffsetToIndex)}}class qs extends Ai{constructor({name:e,key:t,type:i="f32",arrayLength:s=1}){super({name:e,key:t,type:i}),this.arrayLength=s,this.numElements=Math.ceil(this.arrayLength/this.bufferLayout.numElements)}get arrayStrideToIndex(){return this.arrayStride/Lt}setAlignment(e=0){super.setAlignment(e);const t=this.getElementAlignment(this.getPositionAtOffset(this.endOffset+1));this.arrayStride=this.getByteCountBetweenPositions(this.alignment.end,t.end),this.alignment.end=this.getPositionAtOffset(this.endOffset+this.arrayStride*(this.numElements-1))}setValueFromArray(e){let t=0;const i=this.byteCount/this.bufferLayout.View.BYTES_PER_ELEMENT,s=Math.ceil(i/this.numElements);for(let r=0;r<this.numElements;r++)for(let o=0;o<this.bufferLayout.numElements;o++)this.view[o+r*s]=e[t],t++}}class Oi extends qs{constructor({name:e,key:t,type:i="f32",arrayLength:s=1}){super({name:e,key:t,type:i,arrayLength:s}),this.arrayStride=1,this.arrayLength=s,this.numElements=Math.ceil(this.arrayLength/this.bufferLayout.numElements)}get byteCount(){return this.bufferLayout.size*this.numElements}setAlignment(e=0,t=0){this.alignment=this.getElementAlignment(this.getPositionAtOffset(e)),this.arrayStride=t,this.alignment.end=this.getPositionAtOffset(this.endOffset+t*(this.numElements-1))}setView(e,t){this.view=new this.bufferLayout.View(this.bufferLayout.numElements*this.numElements),this.viewSetFunction=(i=>{switch(this.bufferLayout.View){case Int32Array:return i.setInt32.bind(i);case Uint16Array:return i.setUint16.bind(i);case Uint32Array:return i.setUint32.bind(i);case Float32Array:default:return i.setFloat32.bind(i)}})(t)}update(e){super.update(e);for(let t=0;t<this.numElements;t++){const i=this.view.subarray(t*this.bufferLayout.numElements,t*this.bufferLayout.numElements+this.bufferLayout.numElements),s=this.startOffset+t*this.arrayStride;i.forEach((r,o)=>{this.viewSetFunction(s+o*this.bufferLayout.View.BYTES_PER_ELEMENT,r,!0)})}}extractDataFromBufferResult(e){const t=new Float32Array(this.arrayLength);for(let i=0;i<this.numElements;i++){const s=this.startOffsetToIndex+i*this.arrayStrideToIndex;for(let r=0;r<this.bufferLayout.numElements;r++)t[i*this.bufferLayout.numElements+r]=e[s+r]}return t}}const An=new Map([["copySrc",xe.COPY_SRC],["copyDst",xe.COPY_DST],["index",xe.INDEX],["indirect",xe.INDIRECT],["mapRead",xe.MAP_READ],["mapWrite",xe.MAP_WRITE],["queryResolve",xe.QUERY_RESOLVE],["storage",xe.STORAGE],["uniform",xe.UNIFORM],["vertex",xe.VERTEX]]),Ys=(n=[])=>n.reduce((e,t)=>e|An.get(t),0);class Ve{constructor({label:e="Buffer",size:t=0,usage:i=["copySrc","copyDst"],mappedAtCreation:s=!1}={}){this.type="Buffer",this.reset(),this.uuid=Y(),this.consumers=new Set,this.options={label:e,size:t,usage:Ys(i),mappedAtCreation:s}}reset(){this.GPUBuffer=null}set size(e){this.options.size=e}createBuffer(e,t={}){const{usage:i,...s}=t;this.options={...this.options,...s,...i!==void 0&&{usage:Ys(i)}},this.setBuffer(e.createBuffer(this))}setBuffer(e){this.GPUBuffer=e}copy(e,t=!1){t&&this.destroy(),this.options=e.options,this.GPUBuffer=e.GPUBuffer,this.consumers=new Set([...this.consumers,...e.consumers])}async mapBufferAsync(){if(!this.GPUBuffer||this.GPUBuffer.mapState!=="unmapped")return new Float32Array(0);await this.GPUBuffer.mapAsync(GPUMapMode.READ);const e=new Float32Array(this.GPUBuffer.getMappedRange().slice(0));return this.GPUBuffer.unmap(),e}destroy(){this.GPUBuffer?.destroy(),this.reset(),this.consumers.clear()}}var Xs=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},On=(n,e,t)=>(Xs(n,e,"read from private field"),t?t.call(n):e.get(n)),Gn=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},Dn=(n,e,t,i)=>(Xs(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),_t;const Fn=class Ti extends Et{constructor({label:e="Uniform",name:t="uniform",bindingType:i,visibility:s,useStruct:r=!0,access:o="read",usage:a=[],struct:h={},childrenBindings:l=[],parent:u=null,minOffset:c=256,offset:p=0}){if(i=i??"uniform",super({label:e,name:t,bindingType:i,visibility:s}),Gn(this,_t,void 0),this.options={...this.options,useStruct:r,access:o,usage:a,struct:h,childrenBindings:l,parent:u,minOffset:c,offset:p},this.cacheKey+=`${r},${o},`,this.arrayBufferSize=0,this.shouldUpdate=!1,this.useStruct=r,this.bufferElements=[],this.inputs={},this.buffer=new Ve,Object.keys(h).length&&(this.setBindings(h),this.setInputsAlignment()),this.childrenBindings=[],l&&l.length){const d=[];l.sort((f,g)=>{const y=f.count?Math.max(f.count):f.forceArray?1:0,v=g.count?Math.max(g.count):g.forceArray?1:0;return y-v}).forEach(f=>{(f.count&&f.count>1||f.forceArray)&&d.push(f.binding)}),d.length>1&&(d.shift(),L(`BufferBinding: "${this.label}" contains multiple children bindings arrays. These children bindings cannot be added to the BufferBinding: "${d.map(f=>f.label).join(", ")}"`),d.forEach(f=>{l=l.filter(g=>g.binding.name!==f.name)})),this.options.childrenBindings=l,l.forEach(f=>{const g=f.count?Math.max(1,f.count):1;this.cacheKey+=`child(count:${g}):${f.binding.cacheKey}`,g<=1?this.childrenBindings=[...this.childrenBindings,f.binding]:this.childrenBindings=[...this.childrenBindings,Array.from(Array(Math.max(1,f.count||1)).keys()).map(y=>f.binding.clone({...f.binding.options,struct:Ti.cloneStruct(f.binding.options.struct)}))].flat()})}(Object.keys(h).length||this.childrenBindings.length)&&(this.setBufferAttributes(),this.setWGSLFragment()),this.parent=u}static cloneStruct(e){return Object.keys(e).reduce((t,i)=>{const s=e[i];let r;return Array.isArray(s.value)||ArrayBuffer.isView(s.value)?r=new s.value.constructor(s.value.length):typeof s.value=="number"?r=0:r=new s.value.constructor,{...t,[i]:{type:s.type,value:r}}},{})}get parent(){return On(this,_t)}set parent(e){e?(this.parentView=new DataView(e.arrayBuffer,this.offset,this.getMinOffsetSize(this.arrayBufferSize)),this.viewSetFunctions=this.bufferElements.map(t=>{switch(t.bufferLayout.View){case Int32Array:return this.parentView.setInt32.bind(this.parentView);case Uint16Array:return this.parentView.setUint16.bind(this.parentView);case Uint32Array:return this.parentView.setUint32.bind(this.parentView);case Float32Array:default:return this.parentView.setFloat32.bind(this.parentView)}}),!this.parent&&this.buffer.GPUBuffer&&this.buffer.destroy()):(this.parentView=null,this.viewSetFunctions=null),Dn(this,_t,e)}getMinOffsetSize(e){return Math.ceil(e/this.options.minOffset)*this.options.minOffset}get offset(){return this.getMinOffsetSize(this.options.offset*this.getMinOffsetSize(this.arrayBufferSize))}get resourceLayout(){return{buffer:{type:js(this)},...this.parent&&{offset:this.offset,size:this.arrayBufferSize}}}get resourceLayoutCacheKey(){return`buffer,${js(this)},${this.visibility},`}get resource(){return{buffer:this.parent?this.parent.buffer.GPUBuffer:this.buffer.GPUBuffer,...this.parent&&{offset:this.offset,size:this.arrayBufferSize}}}clone(e={}){let{struct:t,childrenBindings:i,parent:s,...r}=e;const{label:o,name:a,bindingType:h,visibility:l,useStruct:u,access:c,usage:p}=this.options;r={label:o,name:a,bindingType:h,visibility:l,useStruct:u,access:c,usage:p,...r};const d=new this.constructor(r);return t=t||Ti.cloneStruct(this.options.struct),d.options.struct=t,d.setBindings(t),d.arrayBufferSize=this.arrayBufferSize,d.arrayBuffer=new ArrayBuffer(d.arrayBufferSize),d.arrayView=new DataView(d.arrayBuffer,0,d.arrayBuffer.byteLength),d.buffer.size=d.arrayBuffer.byteLength,this.bufferElements.forEach(f=>{const g=new f.constructor({name:f.name,key:f.key,type:f.type,...f.arrayLength&&{arrayLength:f.arrayLength}});g.alignment=JSON.parse(JSON.stringify(f.alignment)),f.arrayStride&&(g.arrayStride=f.arrayStride),g.setView(d.arrayBuffer,d.arrayView),d.bufferElements.push(g)}),this.options.childrenBindings&&(d.options.childrenBindings=this.options.childrenBindings,d.options.childrenBindings.forEach(f=>{const g=f.count?Math.max(1,f.count):1;d.cacheKey+=`child(count:${g}):${f.binding.cacheKey}`}),d.options.childrenBindings.forEach(f=>{d.childrenBindings=[...d.childrenBindings,Array.from(Array(Math.max(1,f.count||1)).keys()).map(g=>f.binding.clone({...f.binding.options,struct:Ti.cloneStruct(f.binding.options.struct)}))].flat()}),d.childrenBindings.forEach((f,g)=>{let y=this.arrayView.byteLength;for(let v=0;v<g;v++)y+=this.childrenBindings[v].arrayBuffer.byteLength;f.bufferElements.forEach((v,M)=>{v.alignment.start.row=this.childrenBindings[g].bufferElements[M].alignment.start.row,v.alignment.end.row=this.childrenBindings[g].bufferElements[M].alignment.end.row}),f.arrayView=new DataView(d.arrayBuffer,y,f.arrayBuffer.byteLength);for(const v of f.bufferElements)v.setView(d.arrayBuffer,f.arrayView)})),this.name===d.name&&this.label===d.label?(d.wgslStructFragment=this.wgslStructFragment,d.wgslGroupFragment=this.wgslGroupFragment):d.setWGSLFragment(),s&&(d.parent=s),d.shouldUpdate=d.arrayBufferSize>0,d}setBindings(e){for(const t of Object.keys(e)){const i={};for(const s in e[t])s!=="value"&&(i[s]=e[t][s]);if(i.name=t,Object.defineProperty(i,"value",{get(){return i._value},set(s){i._value=s,i.shouldUpdate=!0}}),i.value=e[t].value,i.value instanceof _||i.value instanceof m){const s=i.value._onChangeCallback;i.value._onChangeCallback=()=>{s&&s(),i.shouldUpdate=!0}}this.inputs[t]=i,this.cacheKey+=`${t},${e[t].type},`}}setInputsAlignment(){let e=Object.keys(this.inputs);const t=e.filter(i=>this.inputs[i].type.includes("array"));t.length&&(e.sort((i,s)=>{const r=Math.min(0,this.inputs[i].type.indexOf("array")),o=Math.min(0,this.inputs[s].type.indexOf("array"));return r-o}),t.length>1&&(e=e.filter(i=>!t.includes(i))));for(const i of e){const s=this.inputs[i],r={name:st(s.name??i),key:i,type:s.type},o=s.type.includes("array")&&(Array.isArray(s.value)||ArrayBuffer.isView(s.value));this.bufferElements.push(o?new qs({...r,arrayLength:s.value.length}):new Ai(r))}if(this.bufferElements.forEach((i,s)=>{const r=s===0?0:this.bufferElements[s-1].endOffset+1;i.setAlignment(r)}),t.length>1)if(t.map(r=>{const o=this.inputs[r],a=Ws(o.type.replace("array","").replace("<","").replace(">",""));return Math.ceil(o.value.length/a.numElements)}).every((r,o,a)=>r===a[0])){const r=t.map(h=>{const l=this.inputs[h];return new Oi({name:st(l.name??h),key:h,type:l.type,arrayLength:l.value.length})}),o=t.map(h=>{const l=this.inputs[h];return new Ai({name:st(l.name??h),key:h,type:l.type.replace("array","").replace("<","").replace(">","")})});o.forEach((h,l)=>{l===0?this.bufferElements.length?h.setAlignmentFromPosition({row:this.bufferElements[this.bufferElements.length-1].alignment.end.row+1,byte:0}):h.setAlignment(0):h.setAlignment(o[l-1].endOffset+1)});const a=o[o.length-1].endOffset+1-o[0].startOffset;r.forEach((h,l)=>{h.setAlignment(o[l].startOffset,Math.ceil(a/K)*K)}),this.bufferElements=[...this.bufferElements,...r]}else L(`BufferBinding: "${this.label}" contains multiple array inputs that should use an interleaved array, but their sizes do not match. These inputs cannot be added to the BufferBinding: "${t.join(", ")}"`)}setBufferAttributes(){const e=this.bufferElements.length?this.bufferElements[this.bufferElements.length-1].paddedByteCount:0;this.arrayBufferSize=e,this.childrenBindings.forEach(t=>{this.arrayBufferSize+=t.arrayBufferSize}),this.arrayBuffer=new ArrayBuffer(this.arrayBufferSize),this.arrayView=new DataView(this.arrayBuffer,0,e),this.childrenBindings.forEach((t,i)=>{let s=e;for(let a=0;a<i;a++)s+=this.childrenBindings[a].arrayBuffer.byteLength;const r=this.bufferElements.length?this.bufferElements[this.bufferElements.length-1].alignment.end.row+1:0,o=i>0&&this.childrenBindings[i-1].bufferElements.length?this.childrenBindings[i-1].bufferElements[this.childrenBindings[i-1].bufferElements.length-1].alignment.end.row+1:0;t.bufferElements.forEach(a=>{const h=i===0?r+o:o;a.alignment.start.row+=h,a.alignment.end.row+=h}),t.arrayView=new DataView(this.arrayBuffer,s,t.arrayBuffer.byteLength);for(const a of t.bufferElements)a.setView(this.arrayBuffer,t.arrayView)}),this.buffer.size=this.arrayBuffer.byteLength;for(const t of this.bufferElements)t.setView(this.arrayBuffer,this.arrayView);this.shouldUpdate=this.arrayBufferSize>0}setWGSLFragment(){if(!this.bufferElements.length&&!this.childrenBindings.length)return;const e=rt(this.label);if(this.useStruct){const t={};t[e]={};const i=this.bufferElements.filter(o=>!(o instanceof Oi)),s=this.bufferElements.filter(o=>o instanceof Oi);if(s.length){const o=this.bindingType==="uniform"?`, ${s[0].numElements}`:"";if(i.length){t[`${e}Element`]={},s.forEach(l=>{t[`${e}Element`][l.name]=l.type.replace("array","").replace("<","").replace(">","")}),i.forEach(l=>{t[e][l.name]=l.type});const a=this.bufferElements.find(l=>l.name==="elements")?`${this.name}Elements`:"elements";t[e][a]=`array<${e}Element${o}>`;const h=zt(this);this.wgslGroupFragment=[`${h} ${this.name}: ${e};`]}else{this.bufferElements.forEach(h=>{t[e][h.name]=h.type.replace("array","").replace("<","").replace(">","")});const a=zt(this);this.wgslGroupFragment=[`${a} ${this.name}: array<${e}${o}>;`]}}else{i.forEach(a=>{const h=this.bindingType==="uniform"&&"numElements"in a?`array<${a.type.replace("array","").replace("<","").replace(">","")}, ${a.numElements}>`:a.type;t[e][a.name]=h});const o=zt(this);this.wgslGroupFragment=[`${o} ${this.name}: ${e};`]}this.childrenBindings.length&&this.options.childrenBindings.forEach(o=>{t[e][o.binding.name]=o.count&&o.count>1||o.forceArray?`array<${rt(o.binding.label)}>`:rt(o.binding.label)});const r=this.childrenBindings.length?this.options.childrenBindings.map(o=>o.binding.wgslStructFragment).join(`
...
`;const $e={vertex:{get_uv_cover:pr},fragment:{get_uv_cover:pr,get_vertex_to_uv_coords:io}},Ue={vertex:{get_output_position:eo,get_normals:to},fragment:{}};class je extends Ni{constructor(e){let{renderer:t,...i}=e;const{label:s,attributes:r,bindGroups:o,cacheKey:a,...h}=i,l="RenderPipelineEntry";N(t,s?s+" "+l:l),super(e),this.type=l,this.shaders={vertex:{head:"",code:"",module:null},fragment:{head:"",code:"",module:null},full:{head:"",code:"",module:null}},this.descriptor=null,this.options={...this.options,attributes:r,bindGroups:o,cacheKey:a,...h},this.setPipelineEntryProperties({attributes:r,bindGroups:o})}setPipelineEntryProperties(e){const{attributes:t,bindGroups:i}=e;this.attributes=t,this.setPipelineEntryBindGroups(i)}patchShaders(){this.shaders.vertex.head="",this.shaders.vertex.code="",this.shaders.fragment.head="",this.shaders.fragment.code="",this.shaders.full.head="",this.shaders.full.code="";for(const t in $e.vertex)this.shaders.vertex.head=`${$e.vertex[t]}
${this.shaders.vertex.head}`,this.shaders.full.head=`${$e.vertex[t]}
${this.shaders.full.head}`;if(this.options.shaders.fragment)for(const t in $e.fragment)this.shaders.fragment.head=`${$e.fragment[t]}
${this.shaders.fragment.head}`,this.shaders.full.head.indexOf($e.fragment[t])===-1&&(this.shaders.full.head=`${$e.fragment[t]}
${this.shaders.full.head}`);if(this.options.rendering.useProjection){for(const t in Ue.vertex)this.shaders.vertex.head=`${Ue.vertex[t]}
...
`,xr=n=>{const e=n.shadowCastingLights.filter(i=>i.type==="directionalLights"),t=Math.max(n.lightsBindingParams.directionalLights.max,1);return`
...
fn getPCFPointShadowContribution(index: i32, shadowPosition: vec4f, depthCubeTexture: texture_depth_cube) -> f32 {
  ...
  return visibility;
}`,Br=n=>{const e=n.shadowCastingLights.filter(i=>i.type==="pointLights"),t=Math.max(n.lightsBindingParams.pointLights.max,1);return`
...
`;var Xi=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},W=(n,e,t)=>(Xi(n,e,"read from private field"),t?t.call(n):e.get(n)),we=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},ne=(n,e,t,i)=>(Xi(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),Mr=(n,e,t)=>(Xi(n,e,"access private method"),t),Xt,Ht,Zt,Kt,Jt,ct,qe,oe,Re,Qt,Hi;const Cr={isActive:{type:"i32",value:0},pcfSamples:{type:"i32",value:0},bias:{type:"f32",value:0},normalBias:{type:"f32",value:0},intensity:{type:"f32",value:0}};class Sr{constructor(e,{light:t,intensity:i=1,bias:s=0,normalBias:r=0,pcfSamples:o=1,depthTextureSize:a=new _(512),depthTextureFormat:h="depth24plus",autoRender:l=!0}={}){we(this,Qt),we(this,Xt,void 0),we(this,Ht,void 0),we(this,Zt,void 0),we(this,Kt,void 0),we(this,Jt,void 0),we(this,ct,void 0),we(this,qe,void 0),we(this,oe,void 0),we(this,Re,void 0),this.setRenderer(e),this.light=t,this.index=this.light.index,this.options={light:t,intensity:i,bias:s,normalBias:r,pcfSamples:o,depthTextureSize:a,depthTextureFormat:h},this.sampleCount=1,this.meshes=new Map,ne(this,qe,new Map),ne(this,oe,new Map),ne(this,Re,null),Mr(this,Qt,Hi).call(this,{intensity:i,bias:s,normalBias:r,pcfSamples:o,depthTextureSize:a,depthTextureFormat:h,autoRender:l}),this.isActive=!1}setRenderer(e){e=Oe(e,this.constructor.name),this.renderer=e,this.setRendererBinding(),W(this,oe)?.forEach(t=>{t.setRenderer(this.renderer)})}setRendererBinding(){this.rendererBinding=null}cast({intensity:e,bias:t,normalBias:i,pcfSamples:s,depthTextureSize:r,depthTextureFormat:o,autoRender:a}={}){Mr(this,Qt,Hi).call(this,{intensity:e,bias:t,normalBias:i,pcfSamples:s,depthTextureSize:r,depthTextureFormat:o,autoRender:a}),this.isActive=!0}reset(){this.onPropertyChanged("isActive",this.isActive?1:0),this.onPropertyChanged("intensity",this.intensity),this.onPropertyChanged("bias",this.bias),this.onPropertyChanged("normalBias",this.normalBias),this.onPropertyChanged("pcfSamples",this.pcfSamples)}get isActive(){return W(this,Jt)}set isActive(e){!e&&this.isActive?this.destroy():e&&!this.isActive&&this.init(),ne(this,Jt,e)}get intensity(){return W(this,Xt)}set intensity(e){ne(this,Xt,e),this.onPropertyChanged("intensity",this.intensity)}get bias(){return W(this,Ht)}set bias(e){ne(this,Ht,e),this.onPropertyChanged("bias",this.bias)}get normalBias(){return W(this,Zt)}set normalBias(e){ne(this,Zt,e),this.onPropertyChanged("normalBias",this.normalBias)}get pcfSamples(){return W(this,Kt)}set pcfSamples(e){ne(this,Kt,Math.max(1,Math.ceil(e))),this.onPropertyChanged("pcfSamples",this.pcfSamples)}init(){if(!this.depthComparisonSampler){const e=this.renderer.samplers.find(t=>t.name==="depthComparisonSampler");this.depthComparisonSampler=e||new Ne(this.renderer,{label:"Depth comparison sampler",name:"depthComparisonSampler",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",compare:"less",minFilter:"linear",magFilter:"linear",type:"comparison"})}this.setDepthTexture(),this.depthPassTarget||this.createDepthPassTarget(),W(this,Re)===null&&W(this,ct)&&(this.setDepthPass(),this.onPropertyChanged("isActive",1))}onDepthTextureSizeChanged(){this.setDepthTexture()}setDepthTexture(){this.depthTexture&&(this.depthTexture.size.width!==this.depthTextureSize.x||this.depthTexture.size.height!==this.depthTextureSize.y)?(this.depthTexture.options.fixedSize.width=this.depthTextureSize.x,this.depthTexture.options.fixedSize.height=this.depthTextureSize.y,this.depthTexture.size.width=this.depthTextureSize.x,this.depthTexture.size.height=this.depthTextureSize.y,this.depthTexture.createTexture(),this.depthPassTarget&&this.depthPassTarget.resize()):this.depthTexture||this.createDepthTexture()}createDepthTexture(){this.depthTexture=new re(this.renderer,{label:`${this.constructor.name} (index: ${this.light.index}) depth texture`,name:"shadowDepthTexture"+this.index,type:"depth",format:this.depthTextureFormat,sampleCount:this.sampleCount,fixedSize:{width:this.depthTextureSize.x,height:this.depthTextureSize.y},autoDestroy:!1})}createDepthPassTarget(){this.depthPassTarget=new Vi(this.renderer,{label:"Depth pass render target for "+this.constructor.name+" "+this.index,useColorAttachments:!1,depthTexture:this.depthTexture,sampleCount:this.sampleCount})}onPropertyChanged(e,t){if(this.rendererBinding){if(t instanceof G){for(let i=0;i<t.elements.length;i++)this.rendererBinding.childrenBindings[this.index].inputs[e].value[i]=t.elements[i];this.rendererBinding.childrenBindings[this.index].inputs[e].shouldUpdate=!0}else this.rendererBinding.childrenBindings[this.index].inputs[e].value=t;this.renderer.shouldUpdateCameraLightsBindGroup()}}setDepthPass(){ne(this,Re,this.render())}removeDepthPass(e){this.renderer.onBeforeRenderScene.remove(e)}render(e=!1){return this.renderer.onBeforeRenderScene.add(t=>{this.meshes.size&&(this.useDepthMaterials(),this.renderDepthPass(t),this.useOriginalMaterials(),this.renderer.pipelineManager.resetCurrentPipeline())},{once:e,order:this.index})}async renderOnce(){W(this,ct)||(this.onPropertyChanged("isActive",1),this.useDepthMaterials(),this.meshes.forEach(e=>{e.setGeometry()}),await Promise.all([...W(this,oe).values()].map(async e=>{await e.compileMaterial()})),this.render(!0))}renderDepthPass(e){const t=new Map;this.meshes.forEach(s=>{s.options.renderBundle&&t.set(s.options.renderBundle.uuid,s.options.renderBundle)}),t.forEach(s=>{s.updateBinding()}),t.clear(),this.renderer.pipelineManager.resetCurrentPipeline();const i=e.beginRenderPass(this.depthPassTarget.renderPass.descriptor);this.renderer.production||i.pushDebugGroup(`${this.constructor.name} (index: ${this.index}): depth pass`),this.meshes.forEach(s=>{s.render(i)}),this.renderer.production||i.popDebugGroup(),i.end()}getDefaultShadowDepthVs(e=!1){return{code:gr(this.index,e)}}getDefaultShadowDepthFs(){return!1}patchShadowCastingMeshParams(e,t={}){t={...e.material.options.rendering,...t},t.targets=[],t.sampleCount=this.sampleCount,t.depthFormat=this.depthTextureFormat,t.bindings?t.bindings=[e.material.getBufferBindingByName("matrices"),...t.bindings]:t.bindings=[e.material.getBufferBindingByName("matrices")];const i=e.material.inputsBindings.get("instances")&&e.geometry.instancesCount>1;return t.shaders||(t.shaders={vertex:this.getDefaultShadowDepthVs(i),fragment:this.getDefaultShadowDepthFs()}),t}addShadowCastingMesh(e,t={}){this.meshes.get(e.uuid)||(e.options.castShadows=!0,W(this,qe).set(e.uuid,e.material),t=this.patchShadowCastingMeshParams(e,t),W(this,oe).get(e.uuid)&&(W(this,oe).get(e.uuid).destroy(),W(this,oe).delete(e.uuid)),W(this,oe).set(e.uuid,new Yi(this.renderer,{label:`${this.constructor.name} (index: ${this.index}) ${e.options.label} depth render material`,...t})),this.meshes.set(e.uuid,e))}useDepthMaterials(){this.meshes.forEach(e=>{e.useMaterial(W(this,oe).get(e.uuid))})}useOriginalMaterials(){this.meshes.forEach(e=>{e.useMaterial(W(this,qe).get(e.uuid))})}removeMesh(e){const t=W(this,oe).get(e.uuid);t&&(t.destroy(),W(this,oe).delete(e.uuid)),this.meshes.delete(e.uuid)}destroy(){this.onPropertyChanged("isActive",0),W(this,Re)!==null&&(this.removeDepthPass(W(this,Re)),ne(this,Re,null)),this.meshes.forEach(e=>this.removeMesh(e)),ne(this,qe,new Map),ne(this,oe,new Map),this.meshes=new Map,this.depthPassTarget?.destroy(),this.depthTexture?.destroy()}}Xt=new WeakMap,Ht=new WeakMap,Zt=new WeakMap,Kt=new WeakMap,Jt=new WeakMap,ct=new WeakMap,qe=new WeakMap,oe=new WeakMap,Re=new WeakMap,Qt=new WeakSet,Hi=function({intensity:n=1,bias:e=0,normalBias:t=0,pcfSamples:i=1,depthTextureSize:s=new _(512),depthTextureFormat:r="depth24plus",autoRender:o=!0}={}){this.intensity=n,this.bias=e,this.normalBias=t,this.pcfSamples=i,this.depthTextureSize=s,this.depthTextureSize.onChange(()=>this.onDepthTextureSizeChanged()),this.depthTextureFormat=r,ne(this,ct,o)};const so={...Cr,viewMatrix:{type:"mat4x4f",value:new Float32Array(16)},projectionMatrix:{type:"mat4x4f",value:new Float32Array(16)}};class ro extends Sr{constructor(e,{light:t,intensity:i,bias:s,normalBias:r,pcfSamples:o,depthTextureSize:a,depthTextureFormat:h,autoRender:l,camera:u={left:-10,right:10,bottom:-10,top:10,near:.1,far:50}}={}){super(e,{light:t,intensity:i,bias:s,normalBias:r,pcfSamples:o,depthTextureSize:a,depthTextureFormat:h,autoRender:l}),this.options={...this.options,camera:u},this.camera={projectionMatrix:new G,viewMatrix:new G,up:new m(0,1,0),_left:u.left,_right:u.right,_bottom:u.bottom,_top:u.top,_near:u.near,_far:u.far};const c=this;["left","right","bottom","top","near","far"].forEach(d=>{Object.defineProperty(c.camera,d,{get(){return c.camera["_"+d]},set(f){c.camera["_"+d]=f,c.updateProjectionMatrix()}})})}setRendererBinding(){this.rendererBinding=this.renderer.bindings.directionalShadows}cast({intensity:e,bias:t,normalBias:i,pcfSamples:s,depthTextureSize:r,depthTextureFormat:o,autoRender:a,camera:h}={}){h&&(this.camera.left=h.left??-10,this.camera.right=h.right??10,this.camera.bottom=h.bottom??-10,this.camera.top=h.right??10,this.camera.near=h.near??.1,this.camera.far=h.far??50),super.cast({intensity:e,bias:t,normalBias:i,pcfSamples:s,depthTextureSize:r,depthTextureFormat:o,autoRender:a})}init(){super.init(),this.updateProjectionMatrix()}reset(){this.setRendererBinding(),super.reset(),this.onPropertyChanged("projectionMatrix",this.camera.projectionMatrix),this.onPropertyChanged("viewMatrix",this.camera.viewMatrix)}updateProjectionMatrix(){this.camera.projectionMatrix.identity().makeOrthographic({left:this.camera.left,right:this.camera.right,bottom:this.camera.bottom,top:this.camera.top,near:this.camera.near,far:this.camera.far}),this.onPropertyChanged("projectionMatrix",this.camera.projectionMatrix)}updateViewMatrix(e=new m,t=new m){e.x===0&&e.z===0?this.camera.up.set(0,0,1):this.camera.up.set(0,1,0),this.camera.viewMatrix.makeView(e,t,this.camera.up),this.onPropertyChanged("viewMatrix",this.camera.viewMatrix)}}var Pr=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},ei=(n,e,t)=>(Pr(n,e,"read from private field"),t?t.call(n):e.get(n)),Tr=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},Rr=(n,e,t,i)=>(Pr(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),pt,ft;class no extends Ii{constructor(e,{color:t=new m(1),intensity:i=1,position:s=new m(1),target:r=new m,shadow:o=null}={}){super(e,{color:t,intensity:i,type:"directionalLights"}),Tr(this,pt,void 0),Tr(this,ft,void 0),this.options={...this.options,position:s,target:r,shadow:o},Rr(this,ft,new m),Rr(this,pt,new m),this.target=r,this.target.onChange(()=>this.setDirection()),this.position.copy(s),this.parent=this.renderer.scene,this.shadow=new ro(this.renderer,{autoRender:!1,light:this}),o&&this.shadow.cast(o)}setRenderer(e){this.shadow?.setRenderer(e),super.setRenderer(e)}reset(){super.reset(),this.setDirection(),this.shadow?.reset()}setDirection(){ei(this,ft).copy(this.target).sub(this.worldMatrix.getTranslation(ei(this,pt))),this.onPropertyChanged("direction",ei(this,ft)),this.shadow?.updateViewMatrix(ei(this,pt),this.target)}applyScale(){}applyTransformOrigin(){}updateMatrixStack(){super.updateMatrixStack(),this.matricesNeedUpdate&&this.setDirection()}onMaxLightOverflow(e){super.onMaxLightOverflow(e),this.shadow?.setRendererBinding()}destroy(){super.destroy(),this.shadow.destroy()}}pt=new WeakMap,ft=new WeakMap;var zr=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},Er=(n,e,t)=>(zr(n,e,"read from private field"),t?t.call(n):e.get(n)),oo=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},ao=(n,e,t,i)=>(zr(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),mt;const ho={face:{type:"i32",value:0},...Cr,cameraNear:{type:"f32",value:0},cameraFar:{type:"f32",value:0},projectionMatrix:{type:"mat4x4f",value:new Float32Array(16)},viewMatrices:{type:"array<mat4x4f>",value:new Float32Array(16*6)}};class lo extends Sr{constructor(e,{light:t,intensity:i,bias:s,normalBias:r,pcfSamples:o,depthTextureSize:a,depthTextureFormat:h,autoRender:l,camera:u={near:.1,far:150}}={}){super(e,{light:t,intensity:i,bias:s,normalBias:r,pcfSamples:o,depthTextureSize:a,depthTextureFormat:h,autoRender:l}),oo(this,mt,void 0),this.options={...this.options,camera:u},this.cubeDirections=[new m(-1,0,0),new m(1,0,0),new m(0,-1,0),new m(0,1,0),new m(0,0,-1),new m(0,0,1)],ao(this,mt,new m),this.cubeUps=[new m(0,-1,0),new m(0,-1,0),new m(0,0,1),new m(0,0,-1),new m(0,-1,0),new m(0,-1,0)],u.far<=0&&(u.far=150),this.camera={projectionMatrix:new G,viewMatrices:[],_near:u.near,_far:u.far};for(let d=0;d<6;d++)this.camera.viewMatrices.push(new G);const c=this;["near","far"].forEach(d=>{Object.defineProperty(c.camera,d,{get(){return c.camera["_"+d]},set(f){c.camera["_"+d]=f,c.updateProjectionMatrix()}})})}setRendererBinding(){this.rendererBinding=this.renderer.bindings.pointShadows}cast({intensity:e,bias:t,normalBias:i,pcfSamples:s,depthTextureSize:r,depthTextureFormat:o,autoRender:a,camera:h}={}){h&&(this.camera.near=h.near??.1,this.camera.far=h.far!==void 0?h.far:this.light.range>0?this.light.range:150),super.cast({intensity:e,bias:t,normalBias:i,pcfSamples:s,depthTextureSize:r,depthTextureFormat:o,autoRender:a})}init(){super.init(),this.updateProjectionMatrix()}reset(){this.setRendererBinding(),super.reset(),this.updateProjectionMatrix()}updateProjectionMatrix(){this.camera.projectionMatrix.identity().makePerspective({near:this.camera.near,far:this.camera.far,fov:90,aspect:1}),this.onPropertyChanged("projectionMatrix",this.camera.projectionMatrix),this.onPropertyChanged("cameraNear",this.camera.near),this.onPropertyChanged("cameraFar",this.camera.far)}updateViewMatrices(e=new m){for(let t=0;t<6;t++){Er(this,mt).copy(this.cubeDirections[t]).add(e),this.camera.viewMatrices[t].makeView(e,Er(this,mt),this.cubeUps[t]);for(let i=0;i<16;i++)this.rendererBinding.childrenBindings[this.index].inputs.viewMatrices.value[t*16+i]=this.camera.viewMatrices[t].elements[i]}this.rendererBinding.childrenBindings[this.index].inputs.viewMatrices.shouldUpdate=!0}setDepthTexture(){if(this.depthTexture&&(this.depthTexture.size.width!==this.depthTextureSize.x||this.depthTexture.size.height!==this.depthTextureSize.y)){const e=Math.max(this.depthTextureSize.x,this.depthTextureSize.y);this.depthTexture.options.fixedSize.width=e,this.depthTexture.options.fixedSize.height=e,this.depthTexture.size.width=e,this.depthTexture.size.height=e,this.depthTexture.createTexture(),this.depthPassTarget&&this.depthPassTarget.resize()}else this.depthTexture||this.createDepthTexture()}createDepthTexture(){const e=Math.max(this.depthTextureSize.x,this.depthTextureSize.y);this.depthTexture=new re(this.renderer,{label:`${this.constructor.name} (index: ${this.index}) depth texture`,name:"pointShadowCubeDepthTexture"+this.index,type:"depth",format:this.depthTextureFormat,viewDimension:"cube",sampleCount:this.sampleCount,fixedSize:{width:e,height:e},autoDestroy:!1})}removeDepthPass(e){this.renderer.onBeforeCommandEncoderCreation.remove(e)}render(e=!1){return this.renderer.onBeforeCommandEncoderCreation.add(()=>{if(this.meshes.size){this.renderer.setCameraBindGroup(),this.useDepthMaterials();for(let t=0;t<6;t++){const i=this.renderer.device.createCommandEncoder();this.renderer.production||i.pushDebugGroup(`${this.constructor.name} (index: ${this.index}): depth pass command encoder for face ${t}`),this.depthPassTarget.renderPass.setRenderPassDescriptor(this.depthTexture.texture.createView({label:this.depthTexture.texture.label+" cube face view "+t,dimension:"2d",arrayLayerCount:1,baseArrayLayer:t})),this.rendererBinding.childrenBindings[this.index].inputs.face.value=t,this.renderer.cameraLightsBindGroup.update(),this.renderDepthPass(i),this.renderer.production||i.popDebugGroup();const s=i.finish();this.renderer.device.queue.submit([s])}this.useOriginalMaterials(),this.renderer.pipelineManager.resetCurrentPipeline()}},{once:e,order:this.index})}getDefaultShadowDepthVs(e=!1){return{code:vr(this.index,e)}}getDefaultShadowDepthFs(){return{code:br(this.index)}}}mt=new WeakMap;var Lr=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},Zi=(n,e,t)=>(Lr(n,e,"read from private field"),t?t.call(n):e.get(n)),_r=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},Ar=(n,e,t,i)=>(Lr(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),ti,gt;class uo extends Ii{constructor(e,{color:t=new m(1),intensity:i=1,position:s=new m,range:r=0,shadow:o=null}={}){super(e,{color:t,intensity:i,type:"pointLights"}),_r(this,ti,void 0),_r(this,gt,void 0),this.options={...this.options,position:s,range:r,shadow:o},Ar(this,gt,new m),this.position.copy(s),this.range=r,this.parent=this.renderer.scene,this.shadow=new lo(this.renderer,{autoRender:!1,light:this}),o&&this.shadow.cast(o)}setRenderer(e){this.shadow&&this.shadow.setRenderer(e),super.setRenderer(e)}reset(){super.reset(),this.onPropertyChanged("range",this.range),this.setPosition(),this.shadow?.reset()}get range(){return Zi(this,ti)}set range(e){Ar(this,ti,e),this.onPropertyChanged("range",this.range)}setPosition(){this.onPropertyChanged("position",this.worldMatrix.getTranslation(Zi(this,gt))),this.shadow?.updateViewMatrices(Zi(this,gt))}applyScale(){}applyTransformOrigin(){}updateMatrixStack(){super.updateMatrixStack(),this.matricesNeedUpdate&&this.setPosition()}onMaxLightOverflow(e){super.onMaxLightOverflow(e),this.shadow?.setRendererBinding()}destroy(){super.destroy(),this.shadow.destroy()}}ti=new WeakMap,gt=new WeakMap;var Or=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},Ki=(n,e,t)=>(Or(n,e,"read from private field"),t?t.call(n):e.get(n)),co=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},po=(n,e,t,i)=>(Or(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t);let fo=0;const Gr={autoRender:!0,useProjection:!1,useAsyncPipeline:!0,cullMode:"back",depth:!0,depthWriteEnabled:!0,depthCompare:"less",depthFormat:"depth24plus",transparent:!1,visible:!0,renderOrder:0,texturesOptions:{},renderBundle:null};function Dr(n){var e,t;return t=class extends n{constructor(...i){super(i[0],i[1],{...Gr,...i[2]}),co(this,e,!0),this._onReadyCallback=()=>{},this._onBeforeRenderCallback=()=>{},this._onRenderCallback=()=>{},this._onAfterRenderCallback=()=>{},this._onAfterResizeCallback=()=>{};let s=i[0];const r={...Gr,...i[2]};this.type="MeshBase",this.uuid=Y(),Object.defineProperty(this,"index",{value:fo++}),s=N(s,r.label?r.label+" "+this.type:this.type),this.renderer=s;const{label:o,shaders:a,geometry:h,visible:l,renderOrder:u,outputTarget:c,renderBundle:p,texturesOptions:d,autoRender:f,...g}=r;this.outputTarget=c??null,this.renderBundle=p??null,g.sampleCount=g.sampleCount?g.sampleCount:this.outputTarget?this.outputTarget.renderPass.options.sampleCount:this.renderer&&this.renderer.renderPass?this.renderer.renderPass.options.sampleCount:1,this.options={...this.options??{},label:o??"Mesh "+this.renderer.meshes.length,...a!==void 0?{shaders:a}:{},...c!==void 0&&{outputTarget:c},...p!==void 0&&{renderBundle:p},texturesOptions:d,...f!==void 0&&{autoRender:f},...g},f!==void 0&&po(this,e,f),this.visible=l,this.renderOrder=u,this.ready=!1,this.userData={},h&&this.useGeometry(h),this.setMaterial({...this.cleanupRenderMaterialParameters({...this.options}),...h&&{verticesOrder:h.verticesOrder,topology:h.topology}}),this.addToScene(!0)}get autoRender(){return Ki(this,e)}get ready(){return this._ready}set ready(i){i&&!this._ready&&this._onReadyCallback&&this._onReadyCallback(),this._ready=i}addToScene(i=!1){i&&this.renderer.meshes.push(this),this.setRenderingOptionsForRenderPass(this.outputTarget?this.outputTarget.renderPass:this.renderer.renderPass),Ki(this,e)&&this.renderer.scene.addMesh(this)}removeFromScene(i=!1){Ki(this,e)&&this.renderer.scene.removeMesh(this),i&&(this.renderer.meshes=this.renderer.meshes.filter(s=>s.uuid!==this.uuid))}setRenderer(i){if(i=i&&i.renderer||i,!i||!(i.type==="GPURenderer"||i.type==="GPUCameraRenderer"||i.type==="GPUCurtainsRenderer")){L(`${this.options.label}: Cannot set ${i} as a renderer because it is not of a valid Renderer type.`);return}this.material?.setRenderer(i);const s=this.renderer;this.removeFromScene(!0),this.renderer=i,this.addToScene(!0),s.meshes.length||s.onBeforeRenderScene.add(r=>{s.forceClear(r)},{once:!0})}setOutputTarget(i){if(i&&i.type!=="RenderTarget"){L(`${this.options.label??this.type}: outputTarget is not a RenderTarget: ${i.type}`);return}this.removeFromScene(),this.outputTarget=i,this.addToScene()}setRenderBundle(i,s=!0){s?(this.removeFromScene(),this.renderBundle=i,this.addToScene()):this.renderBundle=i}loseContext(){this.ready=!1,this.geometry.loseContext(),this.material.loseContext()}restoreContext(){this.geometry.restoreContext(this.renderer),this.material.restoreContext()}setShaders(){const{shaders:i}=this.options;i?((!i.vertex||!i.vertex.code)&&(i.vertex={code:ji,entryPoint:"main"}),(i.fragment===void 0||i.fragment&&!i.fragment.code)&&(i.fragment={code:qi,entryPoint:"main"})):this.options.shaders={vertex:{code:ji,entryPoint:"main"},fragment:{code:qi,entryPoint:"main"}}}useGeometry(i){if(this.geometry&&(i.shouldCompute&&i.computeGeometry(),this.geometry.layoutCacheKey!==i.layoutCacheKey&&(L(`${this.options.label} (${this.type}): the current and new geometries do not have the same vertexBuffers layout, causing a probable pipeline recompilation. This should be avoided.
...
`,en=({addUtils:n=!0,receiveShadows:e=!1,toneMapping:t="linear",useOcclusion:i=!1}={})=>`
${n?hi:""}
${Qr}
${t?vt:""}
...
`,sn=({addUtils:n=!0,receiveShadows:e=!1,toneMapping:t="linear",useOcclusion:i=!1}={})=>`
${n?hi:""}
${tn}
${t?vt:""}
...
`,rn=({addUtils:n=!0,receiveShadows:e=!1,toneMapping:t="linear",useOcclusion:i=!1}={})=>`
${n?fs:""}
${ms}
${t?vt:""}
...
`;var an=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},Ce=(n,e,t)=>(an(n,e,"read from private field"),t?t.call(n):e.get(n)),gs=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},Ao=(n,e,t,i)=>(an(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),bt,ke,li;class hn extends Qi{constructor(e,t,i={}){super(e),gs(this,bt,new m),gs(this,ke,new m(1)),gs(this,li,1),this.boundingBox=new be(new m(-1),new m(1)),this._onAfterDOMElementResizeCallback=()=>{},e=Ei(e,"DOM3DObject"),this.renderer=e,this.size={shouldUpdate:!0,normalizedWorld:{size:new _(1),position:new _},cameraWorld:{size:new _(1)},scaledWorld:{size:new m(1),position:new m}},this.watchScroll=i.watchScroll,this.camera=this.renderer.camera,this.boundingBox.min.onChange(()=>this.shouldUpdateComputedSizes()),this.boundingBox.max.onChange(()=>this.shouldUpdateComputedSizes()),this.setDOMElement(t),this.renderer.domObjects.push(this)}setDOMElement(e){this.domElement=new ts({element:e,onSizeChanged:t=>this.resize(t),onPositionChanged:()=>this.onPositionChanged()}),this.updateSizeAndPosition()}onPositionChanged(){this.watchScroll&&this.shouldUpdateComputedSizes()}resetDOMElement(e){this.domElement&&this.domElement.destroy(),this.setDOMElement(e)}resize(e=null){!e&&(!this.domElement||this.domElement?.isResizing)||(this.updateSizeAndPosition(),this._onAfterDOMElementResizeCallback&&this._onAfterDOMElementResizeCallback())}get boundingRect(){return this.domElement?.boundingRect??{width:1,height:1,top:0,right:0,bottom:0,left:0,x:0,y:0}}setTransforms(){super.setTransforms(),this.transforms.origin.model.set(.5,.5,0),this.transforms.origin.world=new m,this.transforms.position.document=new m,this.documentPosition.onChange(()=>this.applyPosition()),this.transformOrigin.onChange(()=>this.setWorldTransformOrigin())}get documentPosition(){return this.transforms.position.document}set documentPosition(e){this.transforms.position.document=e,this.applyPosition()}get DOMObjectWorldScale(){return Ce(this,ke).clone()}get worldScale(){return this.DOMObjectWorldScale.multiply(this.scale)}get worldPosition(){return Ce(this,bt).clone()}get transformOrigin(){return this.transforms.origin.model}set transformOrigin(e){this.transforms.origin.model=e,this.setWorldTransformOrigin()}get worldTransformOrigin(){return this.transforms.origin.world}set worldTransformOrigin(e){this.transforms.origin.world=e}shouldUpdateMatrices(){super.shouldUpdateMatrices(),(this.matricesNeedUpdate||this.size.shouldUpdate)&&(this.updateSizeAndPosition(),this.matricesNeedUpdate=!0),this.size.shouldUpdate=!1}shouldUpdateComputedSizes(){this.size.shouldUpdate=!0}updateSizeAndPosition(){this.setWorldSizes(),this.applyDocumentPosition(),this.shouldUpdateModelMatrix()}applyDocumentPosition(){let e=new m(0,0,0);this.documentPosition.equals(e)||(e=this.documentToWorldSpace(this.documentPosition)),Ce(this,bt).set(this.position.x+this.size.scaledWorld.position.x+e.x,this.position.y+this.size.scaledWorld.position.y+e.y,this.position.z+this.size.scaledWorld.position.z+this.documentPosition.z/this.camera.CSSPerspective)}applyTransformOrigin(){this.size&&(this.setWorldTransformOrigin(),super.applyTransformOrigin())}updateModelMatrix(){this.modelMatrix.composeFromOrigin(Ce(this,bt),this.quaternion,this.scale,this.worldTransformOrigin),this.modelMatrix.scale(this.DOMObjectWorldScale),this.shouldUpdateWorldMatrix()}documentToWorldSpace(e=new m){return new m(e.x*this.renderer.pixelRatio/this.renderer.boundingRect.width*this.camera.visibleSize.width,-(e.y*this.renderer.pixelRatio/this.renderer.boundingRect.height)*this.camera.visibleSize.height,e.z)}computeWorldSizes(){const e=this.renderer.boundingRect,t={x:this.boundingRect.width/2+this.boundingRect.left,y:this.boundingRect.height/2+this.boundingRect.top},i={x:e.width/2+e.left,y:e.height/2+e.top},{size:s,center:r}=this.boundingBox;s.x!==0&&s.y!==0&&s.z!==0&&r.divide(s),this.size.normalizedWorld.size.set(this.boundingRect.width/e.width,this.boundingRect.height/e.height),this.size.normalizedWorld.position.set((t.x-i.x)/e.width,(i.y-t.y)/e.height),this.size.cameraWorld.size.set(this.size.normalizedWorld.size.x*this.camera.visibleSize.width,this.size.normalizedWorld.size.y*this.camera.visibleSize.height),this.size.scaledWorld.size.set(this.size.cameraWorld.size.x/s.x,this.size.cameraWorld.size.y/s.y,1),this.size.scaledWorld.size.z=this.size.scaledWorld.size.y*(s.x/s.y/(this.boundingRect.width/this.boundingRect.height)),this.size.scaledWorld.position.set(this.size.normalizedWorld.position.x*this.camera.visibleSize.width,this.size.normalizedWorld.position.y*this.camera.visibleSize.height,0)}setWorldSizes(){this.computeWorldSizes(),this.setWorldScale(),this.setWorldTransformOrigin()}setWorldScale(){Ce(this,ke).set(this.size.scaledWorld.size.x,this.size.scaledWorld.size.y,this.size.scaledWorld.size.z*Ce(this,li)),this.shouldUpdateMatrixStack()}set DOMObjectDepthScaleRatio(e){Ao(this,li,e),this.setWorldScale()}setWorldTransformOrigin(){this.transforms.origin.world=new m((this.transformOrigin.x*2-1)*Ce(this,ke).x,-(this.transformOrigin.y*2-1)*Ce(this,ke).y,this.transformOrigin.z*Ce(this,ke).z),this.shouldUpdateMatrixStack()}updateScrollPosition(e={x:0,y:0}){(e.x||e.y)&&this.domElement.updateScrollPosition(e)}onAfterDOMElementResize(e){return e&&(this._onAfterDOMElementResizeCallback=e),this}destroy(){super.destroy(),this.domElement?.destroy()}}bt=new WeakMap,ke=new WeakMap,li=new WeakMap;const ln={autoloadSources:!0,watchScroll:!0};class un extends Ur(hn){constructor(e,t,i){super(e,t,{...ln,...i}),this._onLoadingCallback=r=>{},i={...ln,...i},Ei(e,i.label?i.label+" DOMMesh":"DOMMesh"),this.type="DOMMesh";const{autoloadSources:s}=i;this.autoloadSources=s,this.sourcesReady=!1,this.setInitSources()}get ready(){return this._ready}set ready(e){e&&!this._ready&&this.sourcesReady&&this._onReadyCallback&&this._onReadyCallback(),this._ready=e}get sourcesReady(){return this._sourcesReady}set sourcesReady(e){e&&!this._sourcesReady&&this.ready&&this._onReadyCallback&&this._onReadyCallback(),this._sourcesReady=e}addToScene(e=!1){super.addToScene(e),e&&this.renderer.domMeshes.push(this)}removeFromScene(e=!1){super.removeFromScene(e),e&&(this.renderer.domMeshes=this.renderer.domMeshes.filter(t=>t.uuid!==this.uuid))}setInitSources(){let e=0,t=0;if(this.autoloadSources){const i=this.domElement.element.querySelectorAll("img"),s=this.domElement.element.querySelectorAll("video"),r=this.domElement.element.querySelectorAll("canvas");e=i.length+s.length+r.length;const o=a=>{t++,this._onLoadingCallback&&this._onLoadingCallback(a),t===e&&(this.sourcesReady=!0)};e||(this.sourcesReady=!0),i.length&&i.forEach(a=>{const h=this.createDOMTexture({name:a.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>o(h)).loadImage(a.src)}),s.length&&s.forEach(a=>{const h=this.createDOMTexture({name:a.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>o(h)).loadVideo(a)}),r.length&&r.forEach(a=>{const h=this.createDOMTexture({name:a.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>o(h)).loadCanvas(a)})}else this.sourcesReady=!0}resetDOMElement(e){e?super.resetDOMElement(e):!e&&!this.renderer.production&&L(`${this.options.label}: You are trying to reset a ${this.type} with a HTML element that does not exist. The old HTML element will be kept instead.`)}get pixelRatioBoundingRect(){const e=window.devicePixelRatio??1,t=this.renderer.pixelRatio/e;return Object.keys(this.domElement.boundingRect).reduce((i,s)=>({...i,[s]:this.domElement.boundingRect[s]*t}),{x:0,y:0,width:0,height:0,top:0,right:0,bottom:0,left:0})}computeGeometry(){super.computeGeometry(),this.boundingBox.copy(this.geometry.boundingBox)}onLoading(e){return e&&(this._onLoadingCallback=e),this}}const Oo={label:"Plane",instancesCount:1,vertexBuffers:[]};class dn extends un{constructor(e,t,i={}){e=Ei(e,i.label?i.label+" Plane":"Plane");const s={...Oo,...i};let{geometry:r,widthSegments:o,heightSegments:a,...h}=s;const{instancesCount:l,vertexBuffers:u,...c}=h;if(!r||r.type!=="PlaneGeometry"){o=o??1,a=a??1;const p=o*a+o;u.length||(r=ii.getPlaneGeometryByID(p)),r?r.instancesCount=l:(r=new ki({widthSegments:o,heightSegments:a,instancesCount:l,vertexBuffers:u}),ii.addPlaneGeometry(r))}super(e,t,{geometry:r,...c}),this.type="Plane"}}class ui extends os{constructor({deviceManager:e,label:t,container:i,pixelRatio:s=1,autoResize:r=!0,preferredFormat:o,alphaMode:a="premultiplied",renderPass:h,camera:l,lights:u}){super({deviceManager:e,label:t,container:i,pixelRatio:s,autoResize:r,preferredFormat:o,alphaMode:a,renderPass:h,camera:l,lights:u}),this.type="GPUCurtainsRenderer"}setRendererObjects(){super.setRendererObjects(),this.domMeshes=[],this.domObjects=[]}onCameraMatricesChanged(){super.onCameraMatricesChanged(),this.domObjects.forEach(e=>{e.updateSizeAndPosition()})}resizeMeshes(){this.meshes.forEach(e=>{"domElement"in e||e.resize(this.boundingRect)}),this.domObjects.forEach(e=>{e.domElement.isResizing||e.domElement.setSize()})}}class Go{constructor({scroll:e={x:0,y:0},delta:t={x:0,y:0},shouldWatch:i=!0,onScroll:s=(r={x:0,y:0})=>{}}={}){this.scroll=e,this.delta=t,this.shouldWatch=i,this.onScroll=s,this.shouldWatch&&window.addEventListener("scroll",this.setScroll.bind(this),{passive:!0})}setScroll(){this.updateScrollValues({x:window.pageXOffset,y:window.pageYOffset})}updateScrollValues({x:e,y:t}){const i=this.scroll;this.scroll={x:e,y:t},this.delta={x:i.x-this.scroll.x,y:i.y-this.scroll.y},this.onScroll&&this.onScroll(this.delta)}destroy(){this.shouldWatch&&window.removeEventListener("scroll",this.setScroll.bind(this),{passive:!0})}}class Do{constructor({container:e,label:t,pixelRatio:i=window.devicePixelRatio??1,preferredFormat:s,alphaMode:r="premultiplied",production:o=!1,adapterOptions:a={},renderPass:h,camera:l,lights:u,autoRender:c=!0,autoResize:p=!0,watchScroll:d=!0}={}){this._onRenderCallback=()=>{},this._onScrollCallback=()=>{},this._onErrorCallback=()=>{},this._onContextLostCallback=()=>{},this.type="CurtainsGPU",this.options={container:e,label:t,pixelRatio:i,camera:l,lights:u,production:o,adapterOptions:a,preferredFormat:s,alphaMode:r,renderPass:h,autoRender:c,autoResize:p,watchScroll:d},this.setDeviceManager(),e&&this.setContainer(e),this.initEvents(),this.options.autoRender&&this.animate()}setContainer(e){if(e)if(typeof e=="string")if(e=document.querySelector(e),e)this.options.container=e;else{const t=document.createElement("div");t.setAttribute("id","curtains-gpu-canvas"),document.body.appendChild(t),this.options.container=t}else e instanceof Element&&(this.options.container=e);else{const t=document.createElement("div");t.setAttribute("id","curtains-gpu-canvas"),document.body.appendChild(t),this.options.container=t}this.container=this.options.container,this.setMainRenderer()}setMainRenderer(){this.createCurtainsRenderer({deviceManager:this.deviceManager,label:this.options.label||"GPUCurtains main GPUCurtainsRenderer",container:this.options.container,pixelRatio:this.options.pixelRatio,autoResize:this.options.autoResize,preferredFormat:this.options.preferredFormat,alphaMode:this.options.alphaMode,renderPass:this.options.renderPass,camera:this.options.camera,lights:this.options.lights})}patchRendererOptions(e){return e.pixelRatio===void 0&&(e.pixelRatio=this.options.pixelRatio),e.autoResize===void 0&&(e.autoResize=this.options.autoResize),e}createRenderer(e){return e=this.patchRendererOptions(e),new rs({...e,deviceManager:this.deviceManager})}createCameraRenderer(e){return e=this.patchRendererOptions(e),new os({...e,deviceManager:this.deviceManager})}createCurtainsRenderer(e){return e=this.patchRendererOptions(e),new ui({...e,deviceManager:this.deviceManager})}setDeviceManager(){this.deviceManager=new Yr({label:"GPUCurtains default device",production:this.options.production,adapterOptions:this.options.adapterOptions,onError:()=>setTimeout(()=>{this._onErrorCallback&&this._onErrorCallback()},0),onDeviceLost:e=>this._onContextLostCallback&&this._onContextLostCallback(e)})}get renderers(){return this.deviceManager.renderers}get renderer(){return this.renderers[0]}async setDevice({adapter:e=null,device:t=null}={}){await this.deviceManager.init({adapter:e,device:t})}async restoreContext(){await this.deviceManager.restoreDevice()}get pingPongPlanes(){return this.renderers?.map(e=>e.pingPongPlanes).flat()}get shaderPasses(){return this.renderers?.map(e=>e.shaderPasses).flat()}get meshes(){return this.renderers?.map(e=>e.meshes).flat()}get domMeshes(){return this.renderers?.filter(e=>e instanceof ui).map(e=>e.domMeshes).flat()}get domObjects(){return this.renderers?.filter(e=>e instanceof ui).map(e=>e.domObjects).flat()}get planes(){return this.domMeshes.filter(e=>e instanceof dn)}get computePasses(){return this.renderers?.map(e=>e.computePasses).flat()}get boundingRect(){return this.renderer?.boundingRect}initScroll(){this.scrollManager=new Go({scroll:{x:window.pageXOffset,y:window.pageYOffset},delta:{x:0,y:0},shouldWatch:this.options.watchScroll,onScroll:e=>this.updateScroll(e)})}updateScroll(e={x:0,y:0}){this.domObjects.forEach(t=>{t.domElement&&t.watchScroll&&t.updateScrollPosition(e)}),this._onScrollCallback&&this._onScrollCallback()}updateScrollValues(e={x:0,y:0}){this.scrollManager.updateScrollValues(e)}get scrollDelta(){return this.scrollManager.delta}get scrollValues(){return this.scrollManager.scroll}initEvents(){es.useObserver(this.options.autoResize),this.initScroll()}onRender(e){return e&&(this._onRenderCallback=e),this}onScroll(e){return e&&(this._onScrollCallback=e),this}onError(e){return e&&(this._onErrorCallback=e),this}onContextLost(e){return e&&(this._onContextLostCallback=e),this}animate(){this.render(),this.animationFrameID=window.requestAnimationFrame(this.animate.bind(this))}render(){this._onRenderCallback&&this._onRenderCallback(),this.deviceManager.render()}destroy(){this.animationFrameID&&window.cancelAnimationFrame(this.animationFrameID),this.deviceManager.destroy(),this.scrollManager?.destroy(),es.destroy()}}var ys=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},B=(n,e,t)=>(ys(n,e,"read from private field"),t?t.call(n):e.get(n)),k=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},Le=(n,e,t,i)=>(ys(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),A=(n,e,t)=>(ys(n,e,"access private method"),t),V,ae,_e,U,Xe,He,wt,Ze,di,xs,vs,cn,bs,pn,ci,ws,pi,Bs,fi,Ms,mi,Cs,gi,Ss,yi,Ps,xi,Ts,vi,Rs,Ie,Ke,bi,zs,Es,fn,Ls,mn;const Je=new _,Qe=new _,Ae=new m;class Fo{constructor({camera:e,element:t=null,target:i=new m,enableZoom:s=!0,minZoom:r=0,maxZoom:o=1/0,zoomSpeed:a=1,enableRotate:h=!0,minPolarAngle:l=0,maxPolarAngle:u=Math.PI,minAzimuthAngle:c=-1/0,maxAzimuthAngle:p=1/0,rotateSpeed:d=1,enablePan:f=!0,panSpeed:g=1}){if(k(this,di),k(this,vs),k(this,bs),k(this,ci),k(this,pi),k(this,fi),k(this,mi),k(this,gi),k(this,yi),k(this,xi),k(this,vi),k(this,Ie),k(this,bi),k(this,Es),k(this,Ls),k(this,V,null),k(this,ae,new m),k(this,_e,!1),k(this,U,{radius:1,phi:0,theta:0}),k(this,Xe,new _),k(this,He,!1),k(this,wt,new _),k(this,Ze,new m),!e){L("OrbitControls: cannot initialize without a camera.");return}A(this,di,xs).call(this,{target:i,enableZoom:s,minZoom:r,maxZoom:o,zoomSpeed:a,enableRotate:h,minPolarAngle:l,maxPolarAngle:u,minAzimuthAngle:c,maxAzimuthAngle:p,rotateSpeed:d,enablePan:f,panSpeed:g}),this.element=t??(typeof window<"u"?window:null),this.useCamera(e)}useCamera(e){this.camera=e,this.camera.position.onChange(()=>{this.camera.lookAt(this.target)}),B(this,ae).copy(this.camera.position).sub(this.target),B(this,U).radius=B(this,ae).length(),B(this,U).theta=Math.atan2(B(this,ae).x,B(this,ae).z),B(this,U).phi=Math.acos(Math.min(Math.max(B(this,ae).y/B(this,U).radius,-1),1)),A(this,Ie,Ke).call(this)}reset({position:e,target:t,enableZoom:i=this.enableZoom,minZoom:s=this.minZoom,maxZoom:r=this.maxZoom,zoomSpeed:o=this.zoomSpeed,enableRotate:a=this.enableRotate,minPolarAngle:h=this.minPolarAngle,maxPolarAngle:l=this.maxPolarAngle,minAzimuthAngle:u=this.minAzimuthAngle,maxAzimuthAngle:c=this.maxAzimuthAngle,rotateSpeed:p=this.rotateSpeed,enablePan:d=this.enablePan,panSpeed:f=this.panSpeed}={}){A(this,di,xs).call(this,{target:t,enableZoom:i,minZoom:s,maxZoom:r,zoomSpeed:o,enableRotate:a,minPolarAngle:h,maxPolarAngle:l,minAzimuthAngle:u,maxAzimuthAngle:c,rotateSpeed:p,enablePan:d,panSpeed:f}),e&&this.updatePosition(e)}updatePosition(e=new m){e.sub(this.target),B(this,U).radius=e.length(),B(this,U).theta=Math.atan2(e.x,e.z),B(this,U).phi=Math.acos(Math.min(Math.max(e.y/B(this,U).radius,-1),1)),A(this,Ie,Ke).call(this)}set element(e){B(this,V)&&(!e||B(this,V)!==e)&&A(this,bs,pn).call(this),Le(this,V,e),e&&A(this,vs,cn).call(this)}get element(){return B(this,V)}destroy(){this.element=null}}V=new WeakMap,ae=new WeakMap,_e=new WeakMap,U=new WeakMap,Xe=new WeakMap,He=new WeakMap,wt=new WeakMap,Ze=new WeakMap,di=new WeakSet,xs=function({target:n,enableZoom:e=this.enableZoom,minZoom:t=this.minZoom,maxZoom:i=this.maxZoom,zoomSpeed:s=this.zoomSpeed,enableRotate:r=this.enableRotate,minPolarAngle:o=this.minPolarAngle,maxPolarAngle:a=this.maxPolarAngle,minAzimuthAngle:h=this.minAzimuthAngle,maxAzimuthAngle:l=this.maxAzimuthAngle,rotateSpeed:u=this.rotateSpeed,enablePan:c=this.enablePan,panSpeed:p=this.panSpeed}={}){n&&(this.target=n),this.enableZoom=e,this.minZoom=t,this.maxZoom=i,this.zoomSpeed=s,this.enableRotate=r,this.minPolarAngle=o,this.maxPolarAngle=a,this.minAzimuthAngle=h,this.maxAzimuthAngle=l,this.rotateSpeed=u,this.enablePan=c,this.panSpeed=p},vs=new WeakSet,cn=function(){B(this,V).addEventListener("contextmenu",A(this,vi,Rs).bind(this),!1),B(this,V).addEventListener("mousedown",A(this,ci,ws).bind(this),!1),B(this,V).addEventListener("mousemove",A(this,fi,Ms).bind(this),!1),B(this,V).addEventListener("mouseup",A(this,gi,Ss).bind(this),!1),B(this,V).addEventListener("touchstart",A(this,pi,Bs).bind(this),{passive:!1}),B(this,V).addEventListener("touchmove",A(this,mi,Cs).bind(this),{passive:!1}),B(this,V).addEventListener("touchend",A(this,yi,Ps).bind(this),!1),B(this,V).addEventListener("wheel",A(this,xi,Ts).bind(this),{passive:!1})},bs=new WeakSet,pn=function(){B(this,V).removeEventListener("contextmenu",A(this,vi,Rs).bind(this),!1),B(this,V).removeEventListener("mousedown",A(this,ci,ws).bind(this),!1),B(this,V).removeEventListener("mousemove",A(this,fi,Ms).bind(this),!1),B(this,V).removeEventListener("mouseup",A(this,gi,Ss).bind(this),!1),B(this,V).removeEventListener("touchstart",A(this,pi,Bs).bind(this),{passive:!1}),B(this,V).removeEventListener("touchmove",A(this,mi,Cs).bind(this),{passive:!1}),B(this,V).removeEventListener("touchend",A(this,yi,Ps).bind(this),!1),B(this,V).removeEventListener("wheel",A(this,xi,Ts).bind(this),{passive:!1})},ci=new WeakSet,ws=function(n){n.button===0&&this.enableRotate?(Le(this,_e,!0),B(this,Xe).set(n.clientX,n.clientY)):n.button===2&&this.enablePan&&(Le(this,He,!0),B(this,wt).set(n.clientX,n.clientY)),n.stopPropagation(),n.preventDefault()},pi=new WeakSet,Bs=function(n){n.touches.length===1&&this.enableRotate&&(Le(this,_e,!0),B(this,Xe).set(n.touches[0].pageX,n.touches[0].pageY))},fi=new WeakSet,Ms=function(n){B(this,_e)&&this.enableRotate?A(this,bi,zs).call(this,n.clientX,n.clientY):B(this,He)&&this.enablePan&&A(this,Es,fn).call(this,n.clientX,n.clientY)},mi=new WeakSet,Cs=function(n){B(this,_e)&&this.enableRotate&&A(this,bi,zs).call(this,n.touches[0].pageX,n.touches[0].pageY)},gi=new WeakSet,Ss=function(n){Le(this,_e,!1),Le(this,He,!1)},yi=new WeakSet,Ps=function(n){Le(this,_e,!1),Le(this,He,!1)},xi=new WeakSet,Ts=function(n){this.enableZoom&&(A(this,Ls,mn).call(this,n.deltaY),n.preventDefault())},vi=new WeakSet,Rs=function(n){n.preventDefault()},Ie=new WeakSet,Ke=function(){const n=B(this,U).radius*Math.sin(Math.max(1e-6,B(this,U).phi));B(this,ae).x=n*Math.sin(B(this,U).theta),B(this,ae).y=B(this,U).radius*Math.cos(B(this,U).phi),B(this,ae).z=n*Math.cos(B(this,U).theta),this.camera.position.copy(this.target).add(B(this,ae))},bi=new WeakSet,zs=function(n,e){Je.set(n,e),Qe.copy(Je).sub(B(this,Xe)).multiplyScalar(this.rotateSpeed),B(this,U).theta-=2*Math.PI*Qe.x/this.camera.size.height,B(this,U).phi-=2*Math.PI*Qe.y/this.camera.size.height,B(this,U).theta=Math.min(this.maxAzimuthAngle,Math.max(this.minAzimuthAngle,B(this,U).theta)),B(this,U).phi=Math.min(this.maxPolarAngle,Math.max(this.minPolarAngle,B(this,U).phi)),B(this,Xe).copy(Je),A(this,Ie,Ke).call(this)},Es=new WeakSet,fn=function(n,e){Je.set(n,e),Qe.copy(Je).sub(B(this,wt)).multiplyScalar(this.panSpeed),B(this,Ze).set(0),Ae.copy(this.camera.position).sub(this.target);let t=Ae.length();t*=Math.tan(this.camera.fov/2*Math.PI/180),Ae.set(this.camera.modelMatrix.elements[0],this.camera.modelMatrix.elements[1],this.camera.modelMatrix.elements[2]),Ae.multiplyScalar(-(2*Qe.x*t)/this.camera.size.height),B(this,Ze).add(Ae),Ae.set(this.camera.modelMatrix.elements[4],this.camera.modelMatrix.elements[5],this.camera.modelMatrix.elements[6]),Ae.multiplyScalar(2*Qe.y*t/this.camera.size.height),B(this,Ze).add(Ae),B(this,wt).copy(Je),this.target.add(B(this,Ze)),B(this,ae).copy(this.camera.position).sub(this.target),B(this,U).radius=B(this,ae).length(),A(this,Ie,Ke).call(this)},Ls=new WeakSet,mn=function(n){B(this,U).radius=Math.min(this.maxZoom,Math.max(this.minZoom+1e-6,B(this,U).radius+n*this.zoomSpeed/100)),A(this,Ie,Ke).call(this)};class $o extends at{constructor({instancesCount:e=1,vertexBuffers:t=[],topology:i,mapBuffersAtCreation:s=!0,widthSegments:r=1,heightSegments:o=1,depthSegments:a=1}={}){super({verticesOrder:"ccw",topology:i,instancesCount:e,vertexBuffers:t,mapBuffersAtCreation:s}),this.type="BoxGeometry",r=Math.floor(r),o=Math.floor(o),a=Math.floor(a);const h=[],l=[],u=[],c=[];let p=0;const d=(f,g,y,v,M,T,w,S,C,b)=>{const R=T/C,E=w/b,z=T/2,$=w/2,D=S/2,J=C+1,Q=b+1;let H=0;const O=new m;for(let q=0;q<Q;q++){const j=q*E-$;for(let Z=0;Z<J;Z++){const te=Z*R-z;O[f]=te*v,O[g]=j*M,O[y]=D,h.push(O.x,O.y,O.z),O[f]=0,O[g]=0,O[y]=S>0?1:-1,u.push(O.x,O.y,O.z),l.push(Z/C),l.push(q/b),H+=1}}for(let q=0;q<b;q++)for(let j=0;j<C;j++){const Z=p+j+J*q,te=p+j+J*(q+1),Be=p+(j+1)+J*(q+1),Pi=p+(j+1)+J*q;c.push(Z,te,Pi),c.push(te,Be,Pi),p+=H}};d("z","y","x",-1,-1,2,2,2,a,o),d("z","y","x",1,-1,2,2,-2,a,o),d("x","z","y",1,1,2,2,2,r,a),d("x","z","y",1,-1,2,2,-2,r,a),d("x","y","z",1,-1,2,2,2,r,o),d("x","y","z",-1,-1,2,2,-2,r,o),this.setAttribute({name:"position",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(h)}),this.setAttribute({name:"uv",type:"vec2f",bufferFormat:"float32x2",size:2,array:new Float32Array(l)}),this.setAttribute({name:"normal",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(u)}),this.setIndexBuffer({array:this.useUint16IndexArray?new Uint16Array(c):new Uint32Array(c),bufferFormat:this.useUint16IndexArray?"uint16":"uint32"})}}class Uo extends at{constructor({topology:e,instancesCount:t=1,vertexBuffers:i=[],mapBuffersAtCreation:s=!0,widthSegments:r=32,heightSegments:o=16,phiStart:a=0,phiLength:h=Math.PI*2,thetaStart:l=0,thetaLength:u=Math.PI}={}){super({verticesOrder:"ccw",topology:e,instancesCount:t,vertexBuffers:i,mapBuffersAtCreation:s}),this.type="SphereGeometry",r=Math.max(3,Math.floor(r)),o=Math.max(2,Math.floor(o));const c=1,p=Math.min(l+u,Math.PI);let d=0;const f=[],g=new m,y=new m,v=[],M=[],T=[],w=[];for(let S=0;S<=o;S++){const C=[],b=S/o;let R=0;S===0&&l===0?R=.5/r:S===o&&p===Math.PI&&(R=-.5/r);for(let E=0;E<=r;E++){const z=E/r;g.x=-c*Math.cos(a+z*h)*Math.sin(l+b*u),g.y=c*Math.cos(l+b*u),g.z=c*Math.sin(a+z*h)*Math.sin(l+b*u),M.push(g.x,g.y,g.z),y.copy(g).normalize(),T.push(y.x,y.y,y.z),w.push(z+R,b),C.push(d++)}f.push(C)}for(let S=0;S<o;S++)for(let C=0;C<r;C++){const b=f[S][C+1],R=f[S][C],E=f[S+1][C],z=f[S+1][C+1];(S!==0||l>0)&&v.push(b,R,z),(S!==o-1||p<Math.PI)&&v.push(R,E,z)}this.setAttribute({name:"position",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(M)}),this.setAttribute({name:"uv",type:"vec2f",bufferFormat:"float32x2",size:2,array:new Float32Array(w)}),this.setAttribute({name:"normal",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(T)}),this.setIndexBuffer({array:this.useUint16IndexArray?new Uint16Array(v):new Uint32Array(v),bufferFormat:this.useUint16IndexArray?"uint16":"uint32"})}}class ko extends Ji{constructor(e,t={}){e=N(e,t.label?t.label+" PingPongPlane":"PingPongPlane");const i=t.targets&&t.targets.length&&t.targets.map(s=>({targetFormat:s.format}));t.outputTarget=new Vi(e,{label:t.label?t.label+" render target":"Ping Pong render target",useDepth:!1,...i&&{colorAttachments:i}}),t.transparent=!1,t.depth=!1,t.label=t.label??"PingPongPlane "+e.pingPongPlanes?.length,super(e,t),this.type="PingPongPlane",this.createTexture({label:t.label?`${t.label} render texture`:"PingPongPlane render texture",name:"renderTexture",...t.targets&&t.targets.length&&{format:t.targets[0].format},usage:["copyDst","textureBinding"]})}get renderTexture(){return this.textures.find(e=>e.options.name==="renderTexture")}addToScene(e=!1){e&&this.renderer.pingPongPlanes.push(this),this.autoRender&&this.renderer.scene.addPingPongPlane(this)}removeFromScene(e=!1){this.outputTarget&&this.outputTarget.destroy(),this.autoRender&&this.renderer.scene.removePingPongPlane(this),e&&(this.renderer.pingPongPlanes=this.renderer.pingPongPlanes.filter(t=>t.uuid!==this.uuid))}}var _s=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},P=(n,e,t)=>(_s(n,e,"read from private field"),t?t.call(n):e.get(n)),he=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},de=(n,e,t,i)=>(_s(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),Io=(n,e,t)=>(_s(n,e,"access private method"),t),me,Se,et,tt,ge,ye,Bt,Mt,Ct,St,Pt,Tt,As,gn;class Vo{constructor(e){he(this,As),he(this,me,void 0),he(this,Se,void 0),he(this,et,void 0),he(this,tt,void 0),he(this,ge,void 0),he(this,ye,void 0),he(this,Bt,void 0),he(this,Mt,void 0),he(this,Ct,void 0),he(this,St,void 0),he(this,Pt,void 0),he(this,Tt,void 0),this.type="Raycaster",e=Oe(e,this.type),this.renderer=e,this.camera=this.renderer.camera,this.pointer=new _(1/0),this.ray={origin:new m,direction:new m},de(this,me,{origin:this.ray.origin.clone(),direction:this.ray.direction.clone()}),de(this,Se,new m),de(this,et,new m),de(this,tt,new m),de(this,ge,new m),de(this,ye,new m),de(this,Bt,new _),de(this,Mt,new _),de(this,Ct,new _),de(this,St,new m),de(this,Pt,new m),de(this,Tt,new m)}setFromMouse(e){const{clientX:t,clientY:i}=e.targetTouches&&e.targetTouches.length?e.targetTouches[0]:e;this.setFromNDCCoords((t-this.renderer.boundingRect.left)/this.renderer.boundingRect.width*2-1,-((i-this.renderer.boundingRect.top)/this.renderer.boundingRect.height)*2+1)}setFromNDCCoords(e=0,t=0){this.pointer.set(e,t),this.setRay()}setRay(){this.camera.worldMatrix.getTranslation(this.ray.origin),this.ray.direction.set(this.pointer.x,this.pointer.y,-1).unproject(this.camera).sub(this.ray.origin).normalize()}rayIntersectsTriangle(e){const i=new m,s=new m;i.crossVectors(P(this,me).direction,P(this,ye));const r=P(this,ge).dot(i);if(Math.abs(r)<1e-6)return!1;const o=1/r,a=P(this,me).origin.clone().sub(P(this,Se)),h=o*a.dot(i);if(h<0||h>1)return!1;s.crossVectors(a,P(this,ge));const l=o*P(this,me).direction.dot(s);if(l<0||h+l>1)return!1;const u=o*P(this,ye).dot(s);return u>1e-6?(e.copy(P(this,me).origin).add(P(this,me).direction.clone().multiplyScalar(u)),!0):!1}getBarycentricCoordinates(e){const t=e.clone().sub(P(this,Se)),i=P(this,ge).dot(P(this,ge)),s=P(this,ge).dot(P(this,ye)),r=P(this,ye).dot(P(this,ye)),o=t.dot(P(this,ge)),a=t.dot(P(this,ye)),h=i*r-s*s,l=new m(0,(r*o-s*a)/h,(i*a-s*o)/h);return l.x=1-l.y-l.z,l}getTriangleNormal(){return new m().crossVectors(P(this,ge),P(this,ye)).normalize()}setAttributeVectorAtIndex(e,t,i,s,r){const o=i?i[e*3+t]:e*3+t;r.x=s.array[o*s.size],r.y=s.array[o*s.size+1],"z"in r&&(r.z=s.array[o*s.size+2])}intersectObject(e,t=!0,i=[]){if(!(e instanceof ve))return this.renderer.production||L(`${this.type}: object to test intersection again is not of type Object3D`),i;const s=Sn(e);return s&&Io(this,As,gn).call(this,s,i),t&&e.children.forEach(r=>{this.intersectObject(r,t,i)}),i.length&&i.sort((r,o)=>this.ray.origin.distance(r.point)-this.ray.origin.distance(o.point)),i}intersectObjects(e,t=!0,i=[]){return e.forEach(s=>{this.intersectObject(s,t,i)}),i.length&&i.sort((s,r)=>this.ray.origin.distance(s.point)-this.ray.origin.distance(r.point)),i}}me=new WeakMap,Se=new WeakMap,et=new WeakMap,tt=new WeakMap,ge=new WeakMap,ye=new WeakMap,Bt=new WeakMap,Mt=new WeakMap,Ct=new WeakMap,St=new WeakMap,Pt=new WeakMap,Tt=new WeakMap,As=new WeakSet,gn=function(n,e=[]){if(!n.geometry)return e;const t=n.geometry.getAttributeByName("position");if(!t)return this.renderer.production||L(`Raycaster: can't raycast on a mesh that has no position attribute: ${n.options.label}`),e;if(!t.array)return this.renderer.production||L(`Raycaster: can't raycast on a mesh that has no position attribute array: ${n.options.label}`),e;if(n.frustumCulling&&n.domFrustum){const{clipSpaceBoundingRect:h}=n.domFrustum;if(n.domFrustum.isIntersecting){if(this.pointer.x>h.left+h.width||this.pointer.x<h.left||this.pointer.y>h.top||this.pointer.y<h.top-h.height)return e}else return e}const i=n.worldMatrix.getInverse();P(this,me).origin.copy(this.ray.origin).applyMat4(i),P(this,me).direction.copy(this.ray.direction).transformDirection(i);const s=n.geometry.getAttributeByName("uv"),r=n.geometry.getAttributeByName("normal"),o=n.geometry.indexBuffer?.array,a=o?o.length/3:t.array.length/9;for(let h=0;h<a;h++){if(this.setAttributeVectorAtIndex(h,0,o,t,P(this,Se)),this.setAttributeVectorAtIndex(h,1,o,t,P(this,et)),this.setAttributeVectorAtIndex(h,2,o,t,P(this,tt)),P(this,ge).copy(P(this,et)).sub(P(this,Se)),P(this,ye).copy(P(this,tt)).sub(P(this,Se)),n.material.options.rendering.cullMode!=="none"){const p=this.getTriangleNormal().dot(P(this,me).direction);if(p>0&&n.material.options.rendering.cullMode==="back")continue;if(p<0&&n.material.options.rendering.cullMode==="front")continue}const l=new m;if(this.rayIntersectsTriangle(l)){const c=this.getBarycentricCoordinates(l),p=l.clone().applyMat4(n.worldMatrix),d=this.ray.origin.distance(p),f={object:n,distance:d,localPoint:l,point:p,triangle:[P(this,Se).clone(),P(this,et).clone(),P(this,tt).clone()],triangleIndex:h};s&&s.array&&s.array.length&&(this.setAttributeVectorAtIndex(h,0,o,s,P(this,Bt)),this.setAttributeVectorAtIndex(h,1,o,s,P(this,Mt)),this.setAttributeVectorAtIndex(h,2,o,s,P(this,Ct)),f.uv=P(this,Bt).clone().multiplyScalar(c.x).add(P(this,Mt).clone().multiplyScalar(c.y)).add(P(this,Ct).clone().multiplyScalar(c.z))),r&&r.array&&r.array.length&&(this.setAttributeVectorAtIndex(h,0,o,r,P(this,St)),this.setAttributeVectorAtIndex(h,1,o,r,P(this,Pt)),this.setAttributeVectorAtIndex(h,2,o,r,P(this,Tt)),f.normal=P(this,St).clone().multiplyScalar(c.x).add(P(this,Pt).clone().multiplyScalar(c.y)).add(P(this,Tt).clone().multiplyScalar(c.z))),e.push(f)}}return e};var yn=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},Os=(n,e,t)=>(yn(n,e,"read from private field"),t?t.call(n):e.get(n)),No=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},Wo=(n,e,t,i)=>(yn(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),it;const X=WebGLRenderingContext,wi=new G,jo=class Te{constructor({renderer:e,gltf:t}){No(this,it,void 0),e=Oe(e,"GLTFScenesManager"),this.renderer=e,this.gltf=t,Wo(this,it,new Map);const i=s=>[s.node,...s.children?.map(r=>[...i(r)]).flat()].flat();this.scenesManager={node:new ve,boundingBox:new be,samplers:[],materialsTextures:[],scenes:[],meshes:[],meshesDescriptors:[],getScenesNodes:()=>this.scenesManager.scenes.map(s=>i(s)).flat()},this.createSamplers(),this.createMaterialTextures(),this.createScenes()}static getVertexAttributeParamsFromType(e){switch(e){case"VEC2":return{type:"vec2f",bufferFormat:"float32x2",size:2};case"VEC3":return{type:"vec3f",bufferFormat:"float32x3",size:3};case"VEC4":return{type:"vec4f",bufferFormat:"float32x4",size:4};case"SCALAR":default:return{type:"f32",bufferFormat:"float32",size:1}}}static getTypedArrayConstructorFromComponentType(e){switch(e){case X.BYTE:return Int8Array;case X.UNSIGNED_BYTE:return Uint8Array;case X.SHORT:return Int16Array;case X.UNSIGNED_SHORT:return Uint16Array;case X.UNSIGNED_INT:return Uint32Array;case X.FLOAT:default:return Float32Array}}static gpuPrimitiveTopologyForMode(e){switch(e){case X.TRIANGLES:return"triangle-list";case X.TRIANGLE_STRIP:return"triangle-strip";case X.LINES:return"line-list";case X.LINE_STRIP:return"line-strip";case X.POINTS:return"point-list"}}static gpuAddressModeForWrap(e){switch(e){case X.CLAMP_TO_EDGE:return"clamp-to-edge";case X.MIRRORED_REPEAT:return"mirror-repeat";default:return"repeat"}}createSamplers(){if(this.gltf.samplers)for(const[e,t]of Object.entries(this.gltf.samplers)){const i={label:"glTF sampler "+e,name:"gltfSampler"+e,addressModeU:Te.gpuAddressModeForWrap(t.wrapS),addressModeV:Te.gpuAddressModeForWrap(t.wrapT)};switch((!t.magFilter||t.magFilter===X.LINEAR)&&(i.magFilter="linear"),t.minFilter){case X.NEAREST:break;case X.LINEAR:case X.LINEAR_MIPMAP_NEAREST:i.minFilter="linear";break;case X.NEAREST_MIPMAP_LINEAR:i.mipmapFilter="linear";break;case X.LINEAR_MIPMAP_LINEAR:default:i.minFilter="linear",i.mipmapFilter="linear";break}this.scenesManager.samplers.push(new Ne(this.renderer,i))}else this.scenesManager.samplers.push(new Ne(this.renderer,{label:"Default sampler",name:"defaultSampler",magFilter:"linear",minFilter:"linear",mipmapFilter:"linear"}))}createTexture(e,t,i){const s=(()=>{switch(i){case"baseColorTexture":case"emissiveTexture":return"bgra8unorm-srgb";case"occlusionTexture":return"r8unorm";default:return"bgra8unorm"}})(),r=new re(this.renderer,{label:e.name?e.name+": "+i:i,name:i,format:s,visibility:["fragment"],generateMips:!0,fixedSize:{width:t.width,height:t.height}});return r.uploadSource({source:t}),r}createMaterialTextures(){if(this.scenesManager.materialsTextures=[],this.gltf.materials)for(const[e,t]of Object.entries(this.gltf.materials)){const i={material:e,texturesDescriptors:[]},s=r=>r.texCoord&&r.texCoord!==0?"uv"+r.texCoord:"uv";if(this.scenesManager.materialsTextures[e]=i,t.pbrMetallicRoughness){if(t.pbrMetallicRoughness.baseColorTexture&&t.pbrMetallicRoughness.baseColorTexture.index!==void 0){const r=t.pbrMetallicRoughness.baseColorTexture.index,o=this.gltf.imagesBitmaps[this.gltf.textures[r].source],a=this.createTexture(t,o,"baseColorTexture"),h=this.gltf.textures.find(l=>l.source===r)?.sampler;i.texturesDescriptors.push({texture:a,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.pbrMetallicRoughness.baseColorTexture)})}if(t.pbrMetallicRoughness.metallicRoughnessTexture&&t.pbrMetallicRoughness.metallicRoughnessTexture.index!==void 0){const r=t.pbrMetallicRoughness.metallicRoughnessTexture.index,o=this.gltf.imagesBitmaps[this.gltf.textures[r].source],a=this.createTexture(t,o,"metallicRoughnessTexture"),h=this.gltf.textures.find(l=>l.source===r)?.sampler;i.texturesDescriptors.push({texture:a,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.pbrMetallicRoughness.metallicRoughnessTexture)})}}if(t.normalTexture&&t.normalTexture.index!==void 0){const r=t.normalTexture.index,o=this.gltf.imagesBitmaps[this.gltf.textures[r].source],a=this.createTexture(t,o,"normalTexture"),h=this.gltf.textures.find(l=>l.source===r)?.sampler;i.texturesDescriptors.push({texture:a,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.normalTexture)})}if(t.occlusionTexture&&t.occlusionTexture.index!==void 0){const r=t.occlusionTexture.index,o=this.gltf.imagesBitmaps[this.gltf.textures[r].source],a=this.createTexture(t,o,"occlusionTexture"),h=this.gltf.textures.find(l=>l.source===r)?.sampler;i.texturesDescriptors.push({texture:a,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.occlusionTexture)})}if(t.emissiveTexture&&t.emissiveTexture.index!==void 0){const r=t.emissiveTexture.index,o=this.gltf.imagesBitmaps[this.gltf.textures[r].source],a=this.createTexture(t,o,"emissiveTexture"),h=this.gltf.textures.find(l=>l.source===r)?.sampler;i.texturesDescriptors.push({texture:a,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.emissiveTexture)})}}}createNode(e,t){if(t.camera!==void 0)return;const i={name:t.name,node:new ve,children:[]};e.children.push(i),i.node.parent=e.node,t.matrix?(i.node.modelMatrix.setFromArray(new Float32Array(t.matrix)),i.node.matrices.model.shouldUpdate=!1):(t.translation&&i.node.position.set(t.translation[0],t.translation[1],t.translation[2]),t.scale&&i.node.scale.set(t.scale[0],t.scale[1],t.scale[2]),t.rotation&&i.node.quaternion.setFromArray(new Float32Array(t.rotation)));const s=this.gltf.meshes[t.mesh];t.children&&t.children.forEach(r=>{const o=this.gltf.nodes[r];this.createNode(i,o)}),s&&s.primitives.forEach((r,o)=>{const a={parent:i.node,attributes:[],textures:[],parameters:{label:s.name?s.name+" "+o:"glTF mesh "+o},nodes:[]};let h=Os(this,it).get(r);h||(h={instances:[],nodes:[],meshDescriptor:a},Os(this,it).set(r,h)),h.instances.push(t),h.nodes.push(i.node)})}createScenes(){this.scenesManager.node.parent=this.renderer.scene,this.gltf.scenes.forEach(e=>{const t={name:e.name,children:[],node:new ve};t.node.parent=this.scenesManager.node,this.scenesManager.scenes.push(t),e.nodes.forEach(i=>{const s=this.gltf.nodes[i];this.createNode(t,s)})}),this.scenesManager.node.updateMatrixStack();for(const[e,t]of Os(this,it)){const{instances:i,nodes:s,meshDescriptor:r}=t,o=i.length;r.nodes=s,this.scenesManager.meshesDescriptors.push(r);const a=new be,h=[];let l=null,u=null,c=0;for(const[M,T]of Object.entries(e.attributes)){const w=this.gltf.accessors[T],S=Te.getTypedArrayConstructorFromComponentType(w.componentType),C=this.gltf.bufferViews[w.bufferView],b=M==="TEXCOORD_0"?"uv":M.replace("_","").replace("TEXCOORD","uv").toLowerCase(),R=C.byteStride||0,E=w.byteOffset||0;R&&E&&E<R?c=Math.max(E,c):c=0,b==="position"&&(a.min.min(new m(w.min[0],w.min[1],w.min[2])),a.max.max(new m(w.max[0],w.max[1],w.max[2])),u=C);const z=Te.getVertexAttributeParamsFromType(w.type),$={name:b,...z,array:new S(this.gltf.arrayBuffers[C.buffer],w.byteOffset+C.byteOffset,w.count*z.size)};h.push($),r.attributes.push({name:$.name,type:$.type})}if(c>0){const M=Object.values(e.attributes).map(T=>this.gltf.accessors[T].bufferView);if(M.every(T=>T===M[0]))l=new Float32Array(this.gltf.arrayBuffers[u.buffer],u.byteOffset,Math.ceil(u.byteLength/4)*4/Float32Array.BYTES_PER_ELEMENT);else{let T=0;const w={},S=Object.values(e.attributes).reduce((C,b)=>{const R=this.gltf.accessors[b],E=Te.getVertexAttributeParamsFromType(R.type).size;return w[R.bufferView]||(w[R.bufferView]=0),w[R.bufferView]=Math.max(w[R.bufferView],R.byteOffset+E*Float32Array.BYTES_PER_ELEMENT),T+=E*Float32Array.BYTES_PER_ELEMENT,C+R.count*E},0);l=new Float32Array(Math.ceil(S/4)*4),Object.values(e.attributes).forEach(C=>{const b=this.gltf.accessors[C],R=this.gltf.bufferViews[b.bufferView],E=Te.getVertexAttributeParamsFromType(b.type).size;for(let z=0;z<b.count;z++){const $=b.byteOffset/Float32Array.BYTES_PER_ELEMENT+z*T/Float32Array.BYTES_PER_ELEMENT;l.subarray($,$+E).set(new Float32Array(this.gltf.arrayBuffers[R.buffer],R.byteOffset+b.byteOffset+z*w[b.bufferView],E))}})}}else{const M=["position","uv","normal"];h.sort((T,w)=>{let S=M.findIndex(b=>b===T.name);S=S===-1?1/0:S;let C=M.findIndex(b=>b===w.name);return C=C===-1?1/0:C,S-C})}const p={instancesCount:o,topology:Te.gpuPrimitiveTopologyForMode(e.mode),vertexBuffers:[{name:"attributes",stepMode:"vertex",attributes:h,...l&&{array:l}}]},d="indices"in e,f=d?at:Ui;if(r.parameters.geometry=new f(p),r.parameters.geometry.boundingBox=a,d){const M=this.gltf.accessors[e.indices],T=this.gltf.bufferViews[M.bufferView],w=Te.getTypedArrayConstructorFromComponentType(M.componentType),S=M.byteOffset+T.byteOffset,C=this.gltf.arrayBuffers[T.buffer],b=Math.min((C.byteLength-S)/w.BYTES_PER_ELEMENT,Math.ceil(M.count/4)*4),R=w.name==="Uint8Array"?Uint16Array.from(new w(C,S,b)):new w(C,S,b);r.parameters.geometry.setIndexBuffer({bufferFormat:w.name==="Uint32Array"?"uint32":"uint16",array:R})}const g=this.scenesManager.materialsTextures[e.material];r.parameters.samplers=[],r.parameters.textures=[],g?.texturesDescriptors.forEach(M=>{r.textures.push({texture:M.texture.options.name,sampler:M.sampler.name,texCoordAttributeName:M.texCoordAttributeName}),r.parameters.samplers.find(w=>w.uuid===M.sampler.uuid)||r.parameters.samplers.push(M.sampler),r.parameters.textures.push(M.texture)});const y=this.gltf.materials&&this.gltf.materials[e.material]||{};r.parameters.cullMode=y.doubleSided?"none":"back",(y.alphaMode==="BLEND"||y.extensions&&y.extensions.KHR_materials_transmission)&&(r.parameters.transparent=!0,r.parameters.targets=[{blend:{color:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha"},alpha:{srcFactor:"one",dstFactor:"one"}}}]);const v={baseColorFactor:{type:"vec4f",value:y.pbrMetallicRoughness?.baseColorFactor||[1,1,1,1]},alphaCutoff:{type:"f32",value:y.alphaCutoff!==void 0?y.alphaCutoff:y.alphaMode==="MASK"?.5:0},metallicFactor:{type:"f32",value:y.pbrMetallicRoughness?.metallicFactor===void 0?1:y.pbrMetallicRoughness.metallicFactor},roughnessFactor:{type:"f32",value:y.pbrMetallicRoughness?.roughnessFactor===void 0?1:y.pbrMetallicRoughness.roughnessFactor},normalMapScale:{type:"f32",value:y.normalTexture?.scale===void 0?1:y.normalTexture.scale},occlusionStrength:{type:"f32",value:y.occlusionTexture?.strength===void 0?1:y.occlusionTexture.strength},emissiveFactor:{type:"vec3f",value:y.emissiveFactor!==void 0?y.emissiveFactor:[1,1,1]}};if(Object.keys(v).length&&(r.parameters.uniforms={material:{visibility:["vertex","fragment"],struct:v}}),o>1){const M=new Float32Array(o*16),T=new Float32Array(o*16);for(let w=0;w<o;++w)M.set(s[w].worldMatrix.elements,w*16),wi.copy(s[w].worldMatrix).invert().transpose(),T.set(wi.elements,w*16);r.parameters.storages={instances:{visibility:["vertex","fragment"],struct:{modelMatrix:{type:"array<mat4x4f>",value:M},normalMatrix:{type:"array<mat4x4f>",value:T}}}}}for(let M=0;M<s.length;M++){const w=a.clone().applyMat4(r.nodes[M].worldMatrix);this.scenesManager.boundingBox.min.min(w.min),this.scenesManager.boundingBox.max.max(w.max)}}}addMeshes(e=t=>{}){return this.scenesManager.node.updateMatrixStack(),this.scenesManager.meshesDescriptors.map(t=>{if(t.parameters.geometry){e(t);const i=t.parameters.geometry.instancesCount>1&&t.parameters.castShadows;i&&(t.parameters.castShadows=!1);const s=new kr(this.renderer,{...t.parameters});if(t.nodes.length>1){const r=s.updateWorldMatrix.bind(s);s.updateWorldMatrix=()=>{r(),t.nodes.forEach((o,a)=>{s.storages.instances.modelMatrix.value.set(o.worldMatrix.elements,a*16),wi.copy(o.worldMatrix).invert().transpose(),s.storages.instances.normalMatrix.value.set(wi.elements,a*16)}),s.storages.instances.modelMatrix.shouldUpdate=!0,s.storages.instances.normalMatrix.shouldUpdate=!0}}if(i){const r=s.material.inputsBindings.get("instances");this.renderer.shadowCastingLights.forEach(o=>{o.shadow.isActive&&o.shadow.addShadowCastingMesh(s,{bindings:[r]})})}return s.parent=t.parent,this.scenesManager.meshes.push(s),s}})}destroy(){this.scenesManager.meshes.forEach(t=>t.remove()),this.scenesManager.meshes=[],this.scenesManager.getScenesNodes().forEach(t=>{t.destroy()}),this.scenesManager.node.destroy()}};it=new WeakMap;let qo=jo;const Yo=(n,e={})=>{const t=n.textures.find(F=>F.texture==="baseColorTexture"),i=n.textures.find(F=>F.texture==="normalTexture"),s=n.textures.find(F=>F.texture==="emissiveTexture"),r=n.textures.find(F=>F.texture==="occlusionTexture"),o=n.textures.find(F=>F.texture==="metallicRoughnessTexture"),a=n.attributes.filter(F=>F.name!=="position"),h=a.map((F,na)=>`@location(${na}) ${F.name}: ${F.type},`).join(`
	`);let l=`
  ...
  `,u=a.find(F=>F.name==="normal")?"vsOutput.normal = getWorldNormal(attributes.normal);":"";n.parameters.storages&&n.parameters.storages.instances&&(l=`
      ...
      vsOutput.viewDirection = camera.position - vsOutput.worldPosition;
      `,u="vsOutput.normal = normalize((instances[attributes.instanceIndex].normalMatrix * vec4(attributes.normal, 0.0)).xyz);");const c=a.filter(F=>F.name!=="normal").map(F=>`vsOutput.${F.name} = attributes.${F.name};`).join(`
	`);let p=`
      @builtin(position) position: vec4f,
      @location(${a.length}) viewDirection: vec3f,
      @location(${a.length+1}) worldPosition: vec3f,
      ${h}
  `,d="";const f=a.find(F=>F.name==="tangent"),g=!!(i&&f);g&&(p+=`
  ...
  `,S=n.attributes.find(F=>F.name==="color0");let C=S?S.type==="vec3f"?"var baseColor: vec4f = vec4(fsInput.color0, 1.0) * material.baseColorFactor;":"var baseColor: vec4f = fsInput.color0 * material.baseColorFactor;":"var baseColor: vec4f = material.baseColorFactor;";t&&(C=`
    ...
    `),C+=`
      color = baseColor;
  `;let b=n.attributes.find(F=>F.name==="normal")?`
  ...
  `;let{shadingModel:$}=e;$||($="PBR");let{chunks:D}=e||{};const{iblParameters:J}=e||{},{lutTexture:Q,envDiffuseTexture:H,envSpecularTexture:O}=J||{};H&&H.texture&&O&&O.texture&&Q&&Q.texture&&$==="IBL"?(n.parameters.uniforms={...n.parameters.uniforms,ibl:{struct:{diffuseStrength:{type:"f32",value:J?.diffuseStrength??.5},specularStrength:{type:"f32",value:J?.specularStrength??.5}}}},n.parameters.textures=[...n.parameters.textures,Q.texture,H.texture,O.texture],Q.samplerName=Q.samplerName||"defaultSampler",H.samplerName=H.samplerName||"defaultSampler",O.samplerName=O.samplerName||"defaultSampler"):$==="IBL"&&(L("IBL shading requested but one of the LUT, environment specular or diffuse texture is missing. Defaulting to PBR shading."),$="PBR");const j={toneMapping:"khronos",receiveShadows:!!n.parameters.receiveShadows,useOcclusion:!0},Z=(()=>{switch($){case"Lambert":default:return en(j);case"Phong":return sn(j);case"PBR":return rn(j);case"IBL":return on(j)}})(),te="",Be="";D?(D.additionalFragmentHead?D.additionalFragmentHead=Z+D.additionalFragmentHead:D.additionalFragmentHead=Z,D.preliminaryColorContribution?D.preliminaryColorContribution=te+D.preliminaryColorContribution:D.preliminaryColorContribution=te,D.additionalColorContribution?D.additionalColorContribution=Be+D.additionalColorContribution:D.additionalColorContribution=Be):D={additionalFragmentHead:Z,preliminaryColorContribution:te,additionalColorContribution:Be};const Pi=(()=>{switch($){case"Lambert":default:return`
      color = vec4(
        getLambert(
          normal,
          worldPosition,
  ...
  `;return{vertex:{code:M,entryPoint:"main"},fragment:{code:ra,entryPoint:"main"}}},Xo=async(n,e,t)=>{if(t.options.viewDimension!=="cube"){L("Could not compute the diffuse texture because the specular texture is not a cube map:"+t.options.viewDimension);return}const i=`    
  ...
  `;let s=new re(n,{label:"Diffuse storage cubemap",name:"diffuseEnvMap",format:"rgba32float",visibility:["compute"],usage:["copySrc","storageBinding"],type:"storage",fixedSize:{width:t.size.width,height:t.size.height,depth:6},viewDimension:"2d-array"});const r=new Ne(n,{label:"Compute diffuse sampler",name:"specularSampler",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",minFilter:"linear",magFilter:"linear"});let o=new nr(n,{autoRender:!1,dispatchSize:[Math.ceil(t.size.width/8),Math.ceil(t.size.height/8),6],shaders:{compute:{code:i}},uniforms:{params:{struct:{faceSize:{type:"u32",value:t.size.width},maxMipLevel:{type:"u32",value:t.texture.mipLevelCount},sampleCount:{type:"u32",value:2048}}}},samplers:[r],textures:[t,s]});await o.material.compileMaterial(),n.onBeforeRenderScene.add(a=>{n.renderSingleComputePass(a,o),a.copyTextureToTexture({texture:s.texture},{texture:e.texture},[e.texture.width,e.texture.height,e.texture.depthOrArrayLayers])},{once:!0}),n.onAfterCommandEncoderSubmission.add(()=>{o.destroy(),s.destroy(),s=null,o=null},{once:!0})},xn=WebGLRenderingContext,Ho=1179937895,Gs={JSON:1313821514,BIN:5130562},Zo=[0,0,0],Ko=[0,0,0,1],Jo=[1,1,1],Qo=typeof window<"u"&&new RegExp(`^${window.location.protocol}`,"i")||RegExp("^(http|https):","i"),ea=/^data:/;class Bi{constructor(){this.gltf=null}static resolveUri(e,t){return e.match(Qo)||e.match(ea)?e:t+e}async loadFromUrl(e){const t=e.lastIndexOf("/"),i=t!==0?e.substring(0,t+1):"",s=await fetch(e);if(e.endsWith(".gltf"))return this.loadFromJson(await s.json(),i);if(e.endsWith(".glb"))return this.loadFromBinary(await s.arrayBuffer(),i);throw new Error("Unrecognized file extension")}async loadFromJsonBase(e,t,i=null){if(!t)throw new Error("baseUrl must be specified.");if(!e.asset)throw new Error("Missing asset description.");if(e.asset.minVersion!=="2.0"&&e.asset.version!=="2.0")throw new Error("Incompatible asset version.");for(const o of e.accessors)o.byteOffset=o.byteOffset??0,o.normalized=o.normalized??!1;for(const o of e.bufferViews)o.byteOffset=o.byteOffset??0;for(const o of e.nodes)o.matrix||(o.rotation=o.rotation??Ko,o.scale=o.scale??Jo,o.translation=o.translation??Zo);if(e.samplers)for(const o of e.samplers)o.wrapS=o.wrapS??xn.REPEAT,o.wrapT=o.wrapT??xn.REPEAT;const s=[];if(i)s.push(Promise.resolve(i));else for(const o in e.buffers){const a=e.buffers[o],h=Bi.resolveUri(a.uri,t);s[o]=fetch(h).then(l=>l.arrayBuffer())}const r=[];for(let o=0;o<e.images?.length;++o){const a=e.images[o];if(a.uri)r[o]=fetch(Bi.resolveUri(a.uri,t)).then(async h=>createImageBitmap(await h.blob()));else{const h=e.bufferViews[a.bufferView];r[o]=s[h.buffer].then(l=>{const u=new Blob([new Uint8Array(l,h.byteOffset,h.byteLength)],{type:a.mimeType});return createImageBitmap(u)})}}return{...e,arrayBuffers:await Promise.all(s),imagesBitmaps:await Promise.all(r)}}async loadFromBinary(e,t){const i=new DataView(e,0,12),s=i.getUint32(0,!0),r=i.getUint32(4,!0),o=i.getUint32(8,!0);if(s!==Ho)throw new Error("Invalid magic string in binary header.");if(r!==2)throw new Error("Incompatible version in binary header.");const a={};let h=12;for(;h<o;){const c=new DataView(e,h,8),p=c.getUint32(0,!0),d=c.getUint32(4,!0);a[d]=e.slice(h+8,h+8+p),h+=p+8}if(!a[Gs.JSON])throw new Error("File contained no json chunk.");const u=new TextDecoder("utf-8").decode(a[Gs.JSON]);return this.loadFromJson(JSON.parse(u),t,a[Gs.BIN])}async loadFromJson(e,t,i=null){return this.gltf=await this.loadFromJsonBase(e,t,i),this.gltf}}var ta=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},Pe=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},le=(n,e,t)=>(ta(n,e,"access private method"),t),Ds,vn,Fs,bn,Mi,$s,Rt,Ci,Us,wn,ks,Bn,Si,Is,Vs,Mn,Ns,Cn;class ia{constructor(){Pe(this,Ds),Pe(this,Fs),Pe(this,Mi),Pe(this,Rt),Pe(this,Us),Pe(this,ks),Pe(this,Si),Pe(this,Vs),Pe(this,Ns)}async loadFromUrl(e){const t=await(await fetch(e)).arrayBuffer();return le(this,Ds,vn).call(this,new DataView(t))}equirectangularToCubeMap(e){const t=Math.max(e.width/4,e.height/2),i={posX:new Float32Array(t*t*4),negX:new Float32Array(t*t*4),posY:new Float32Array(t*t*4),negY:new Float32Array(t*t*4),posZ:new Float32Array(t*t*4),negZ:new Float32Array(t*t*4)};function s(l,u){const c=Math.floor(l*e.width),d=(Math.floor(u*e.height)*e.width+c)*4;return[e.data[d],e.data[d+1],e.data[d+2],e.data[d+3]]}function r(l,u,c,p){const d=(c*t+u)*4;i[l][d]=p[0],i[l][d+1]=p[1],i[l][d+2]=p[2],i[l][d+3]=p[3]}function o(l,u,c){const p=2*(u+.5)/t-1,d=2*(c+.5)/t-1;switch(l){case"posX":return[p,-1,-d];case"negX":return[-p,1,-d];case"posY":return[-d,-p,1];case"negY":return[d,-p,-1];case"posZ":return[-1,-p,-d];case"negZ":return[1,p,-d]}}function a(l){const[u,c,p]=l,d=Math.sqrt(u*u+c*c),f=Math.atan2(c,u),g=Math.atan2(p,d),y=(f+Math.PI)/(2*Math.PI),v=(g+Math.PI/2)/Math.PI;return[y,v]}for(const l in i)for(let u=0;u<t;u++)for(let c=0;c<t;c++){const p=o(l,c,u),[d,f]=a(p),g=s(d,f);r(l,c,u,g)}return[i.posX,i.negX,i.posY,i.negY,i.posZ,i.negZ].map(l=>({data:l,width:t,height:t,exposure:e.exposure,gamma:e.gamma}))}}Ds=new WeakSet,vn=function(n){const e={data:n,offset:0},t=le(this,Fs,bn).call(this,e);return{width:t.width,height:t.height,exposure:t.exposure,gamma:t.gamma,data:le(this,Us,wn).call(this,e,t)}},Fs=new WeakSet,bn=function(n){let e=le(this,Rt,Ci).call(this,n);const t={colorCorr:[1,1,1],exposure:1,gamma:1,width:0,height:0,flipX:!1,flipY:!1};if(e!=="#?RADIANCE"&&e!=="#?RGBE")throw new Error("Incorrect file format!");for(;e!=="";){e=le(this,Rt,Ci).call(this,n);const s=e.split("=");switch(s[0]){case"GAMMA":t.gamma=parseFloat(s[1]);break;case"FORMAT":if(s[1]!=="32-bit_rle_rgbe"&&s[1]!=="32-bit_rle_xyze")throw new Error("Incorrect encoding format!");break;case"EXPOSURE":t.exposure=parseFloat(s[1]);break;case"COLORCORR":t.colorCorr=s[1].replace(/^\s+|\s+$/g,"").split(" ").map(r=>parseFloat(r));break}}e=le(this,Rt,Ci).call(this,n);const i=e.split(" ");return le(this,Mi,$s).call(this,i[0],parseInt(i[1]),t),le(this,Mi,$s).call(this,i[2],parseInt(i[3]),t),t},Mi=new WeakSet,$s=function(n,e,t){switch(n){case"+X":t.width=e;break;case"-X":t.width=e,t.flipX=!0,console.warn("Flipping horizontal orientation not currently supported");break;case"-Y":t.height=e,t.flipY=!0;break;case"+Y":t.height=e;break}},Rt=new WeakSet,Ci=function(n){let e,t="";for(;(e=n.data.getUint8(n.offset++))!==10;)t+=String.fromCharCode(e);return t},Us=new WeakSet,wn=function(n,e){const t=n.data.getUint16(n.offset);let i;if(t===514)i=le(this,ks,Bn).call(this,n,e),e.flipX&&le(this,Vs,Mn).call(this,i,e),e.flipY&&le(this,Ns,Cn).call(this,i,e);else throw new Error("Obsolete HDR file version!");return i},ks=new WeakSet,Bn=function(n,e){const{width:t,height:i,colorCorr:s}=e,r=new Float32Array(t*i*4);let o=0,{offset:a,data:h}=n;for(let l=0;l<i;++l){if(h.getUint16(a)!==514)throw new Error("Incorrect scanline start hash");if(h.getUint16(a+2)!==t)throw new Error("Scanline doesn't match picture dimension!");a+=4;const u=t*4,c=[];let p=0;for(;p<u;){let d=h.getUint8(a++);if(d>128){const f=d-128;d=h.getUint8(a++);for(let g=0;g<f;++g)c[p++]=d}else for(let f=0;f<d;++f)c[p++]=h.getUint8(a++)}for(p=0;p<t;++p){const d=c[p],f=c[p+t],g=c[p+t*2];let y=c[p+t*3];y=y?Math.pow(2,y-136):0,r[o++]=d*y*s[0],r[o++]=f*y*s[1],r[o++]=g*y*s[2],r[o++]=y}}return r},Si=new WeakSet,Is=function(n,e,t){e*=4,t*=4;for(let i=0;i<4;++i){const s=n[e+i];n[e+i]=n[t+i],n[t+i]=s}},Vs=new WeakSet,Mn=function(n,e){const{width:t,height:i}=e,s=t>>1;for(let r=0;r<i;++r){const o=r*t;for(let a=0;a<s;++a){const h=o+a,l=o+t-1-a;le(this,Si,Is).call(this,n,h,l)}}},Ns=new WeakSet,Cn=function(n,e){const{width:t,height:i}=e,s=i>>1;for(let r=0;r<s;++r){const o=r*t,a=(i-1-r)*t;for(let h=0;h<t;++h)le(this,Si,Is).call(this,n,o+h,a+h)}};const sa=n=>{const{scene:e}=n;if(!e)return;const t=[];e.computePassEntries.forEach(i=>{t.push({command:"Render ComputePass",content:i.options.label}),i.material.bindGroups.forEach(s=>{s.bufferBindings.forEach(r=>{r.shouldCopyResult&&t.push({command:"Copy buffer to buffer",source:`${r.name} buffer`,destination:`${r.name} result buffer`})})})});for(const i in e.renderPassEntries){let s=0;e.renderPassEntries[i].forEach(r=>{if(!e.getRenderPassEntryLength(r))return;const o=r.renderPass.options.useColorAttachments?r.renderPass.options.colorAttachments.length===0&&r.renderPass.options.useDepth?`${r.renderTexture.options.label} depth pass`:r.renderPass.options.colorAttachments.length>1?`${r.renderTexture.options.label} multiple targets`:r.renderTexture?`${r.renderTexture.options.label}`:"Context current texture":void 0;let a=r.renderPass.options.label;const h={loadOp:r.renderPass.options.useColorAttachments?i==="screen"&&s>0?"load":r.renderPass.options.loadOp:void 0,depthLoadOp:void 0,sampleCount:r.renderPass.options.sampleCount,...r.renderPass.options.qualityRatio!==1&&{qualityRatio:r.renderPass.options.qualityRatio}};if(r.renderPass.options.useDepth&&(h.depthLoadOp=r.renderPass.options.depthLoadOp),s++,r.element)r.element.type==="ShaderPass"&&!(r.element.inputTarget||r.element.outputTarget)&&(t.push({command:"Copy texture to texture",source:o,destination:`${r.element.options.label} renderTexture`}),h.loadOp="clear"),a+=" "+JSON.stringify(h),t.push({command:`Render ${r.element.type}`,source:r.element.options.label,destination:o,descriptor:a}),r.element.type==="ShaderPass"&&!r.element.outputTarget&&r.element.options.copyOutputToRenderTexture?t.push({command:"Copy texture to texture",source:o,destination:`${r.element.options.label} renderTexture`}):r.element.type==="PingPongPlane"&&t.push({command:"Copy texture to texture",source:o,destination:`${r.element.renderTexture.options.label}`});else if(r.stack){a+=" "+JSON.stringify(h);for(const l in r.stack)for(const u in r.stack[l])r.stack[l][u].length&&t.push({command:`Render stack (${l} ${u} objects)`,source:r.stack[l][u],destination:o,descriptor:a})}})}console.table(t)};x.AmbientLight=Zn,x.BindGroup=At,x.Binding=Et,x.Box3=be,x.BoxGeometry=$o,x.Buffer=Ve,x.BufferBinding=pe,x.Camera=Qs,x.ComputeMaterial=ir,x.ComputePass=nr,x.ComputePipelineEntry=Ir,x.DOMElement=ts,x.DOMFrustum=ar,x.DOMMesh=un,x.DOMObject3D=hn,x.DOMTexture=Fe,x.DirectionalLight=no,x.FullscreenPlane=Ji,x.GLTFLoader=Bi,x.GLTFScenesManager=qo,x.GPUCameraRenderer=os,x.GPUCurtains=Do,x.GPUCurtainsRenderer=ui,x.GPUDeviceManager=Yr,x.GPURenderer=rs,x.Geometry=Ui,x.HDRLoader=ia,x.IndexedGeometry=at,x.Mat3=Me,x.Mat4=G,x.Material=$i,x.Mesh=kr,x.Object3D=ve,x.OrbitControls=Fo,x.PingPongPlane=ko,x.PipelineEntry=Ni,x.PipelineManager=Vr,x.Plane=dn,x.PlaneGeometry=ki,x.PointLight=uo,x.ProjectedObject3D=Qi,x.Quat=ce,x.Raycaster=Vo,x.RenderBundle=So,x.RenderMaterial=Yi,x.RenderPass=Yt,x.RenderPipelineEntry=je,x.RenderTarget=Vi,x.Sampler=Ne,x.SamplerBinding=Ks,x.Scene=Nr,x.ShaderPass=To,x.SphereGeometry=Uo,x.Texture=re,x.TextureBindGroup=Fi,x.TextureBinding=Di,x.Vec2=_,x.Vec3=m,x.WritableBufferBinding=Gi,x.applyDirectionalShadows=ut,x.applyPointShadows=dt,x.buildShaders=Yo,x.computeDiffuseFromSpecular=Xo,x.getDefaultPointShadowDepthFs=br,x.getDefaultPointShadowDepthVs=vr,x.getDefaultShadowDepthVs=gr,x.getIBL=on,x.getIBLIndirect=nn,x.getLambert=en,x.getLambertDirect=Qr,x.getPBR=rn,x.getPBRDirect=ms,x.getPCFDirectionalShadows=xr,x.getPCFPointShadowContribution=wr,x.getPCFPointShadows=Br,x.getPCFShadowContribution=yr,x.getPCFShadows=lt,x.getPhong=sn,x.getPhongDirect=tn,x.lambertUtils=hi,x.logSceneCommands=sa,x.pbrUtils=fs,x.toneMappingUtils=vt});
