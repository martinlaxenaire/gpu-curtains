...
`;const se={vertex:{get_uv_cover:zt},fragment:{get_uv_cover:zt,get_vertex_to_uv_coords:ms}},ie={vertex:{get_output_position:fs},fragment:{}};class Je extends Qe{constructor(e){let{renderer:t,...s}=e;const{label:i,...r}=s;t=t&&t.renderer||t;const n="RenderPipelineEntry";z(t,i?i+" "+n:n),super(e),this.type=n,this.shaders={vertex:{head:"",code:"",module:null},fragment:{head:"",code:"",module:null},full:{head:"",code:"",module:null}},this.descriptor=null,this.options={...this.options,...r}}setPipelineEntryBindGroups(e){this.bindGroups="cameraBindGroup"in this.renderer&&this.options.rendering.useProjection?[this.renderer.cameraBindGroup,...e]:e}setPipelineEntryProperties(e){const{attributes:t,bindGroups:s}=e;this.attributes=t,this.setPipelineEntryBindGroups(s)}patchShaders(){this.shaders.vertex.head="",this.shaders.vertex.code="",this.shaders.fragment.head="",this.shaders.fragment.code="",this.shaders.full.head="",this.shaders.full.code="";for(const t in se.vertex)this.shaders.vertex.head=`${se.vertex[t]}
