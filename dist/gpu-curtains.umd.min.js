(function(x,X){typeof exports=="object"&&typeof module<"u"?X(exports):typeof define=="function"&&define.amd?define(["exports"],X):(x=typeof globalThis<"u"?globalThis:x||self,X(x.window=x.window||{}))})(this,function(x){"use strict";const X=()=>"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,n=>{const e=Math.random()*16|0;return(n==="x"?e:e&3|8).toString(16).toUpperCase()}),Qe=n=>n.replace(/(?:^\w|[A-Z]|\b\w)/g,(e,t)=>t===0?e.toLowerCase():e.toUpperCase()).replace(/\s+/g,""),et=n=>{const e=Qe(n);return e.charAt(0).toUpperCase()+e.slice(1)};let gi=0;const $=n=>{gi>100||(console.warn(gi===100?"GPUCurtains: too many warnings thrown, stop logging.":n),gi++)},ie=n=>{throw new Error(n)},yi=(n,e="GPURenderer",t)=>{const i=t?`Unable to create ${t} because the ${e} is not defined: ${n}`:`The ${e} is not defined: ${n}`;ie(i)},q=(n,e)=>(n=n&&n.renderer||n,n&&(n.type==="GPURenderer"||n.type==="GPUCameraRenderer"||n.type==="GPUCurtainsRenderer")||yi(n,"GPURenderer",e),n),Le=(n,e)=>(n=n&&n.renderer||n,n&&(n.type==="GPUCameraRenderer"||n.type==="GPUCurtainsRenderer")||yi(n,"GPUCameraRenderer",e),n),xi=(n,e)=>(n=n&&n.renderer||n,n&&n.type==="GPUCurtainsRenderer"||yi(n,"GPUCurtainsRenderer",e),n),Qr=n=>n.constructor.name==="Mesh"||n.constructor.name==="DOMMesh"||n.constructor.name==="Plane"?n:!1,vi=(()=>{let n,e;const t={};return function(s,r){e||(e=s.createShaderModule({label:"textured quad shaders for mip level generation",code:`
            struct VSOutput {
...
`,Ks=n=>{const e=n.shadowCastingLights.filter(t=>t.type==="directionalLights");return`
...
fn getPCFPointShadowContribution(index: i32, shadowPosition: vec4f, depthCubeTexture: texture_depth_cube) -> f32 {
  ...
  return visibility;
}`,tr=n=>{const e=n.shadowCastingLights.filter(t=>t.type==="pointLights");return`
...
`;var Oi=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},W=(n,e,t)=>(Oi(n,e,"read from private field"),t?t.call(n):e.get(n)),ve=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},ne=(n,e,t,i)=>(Oi(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),ir=(n,e,t)=>(Oi(n,e,"access private method"),t),kt,It,Vt,Nt,Wt,at,Ve,ue,Te,jt,Gi;const sr={isActive:{type:"i32",value:0},pcfSamples:{type:"i32",value:0},bias:{type:"f32",value:0},normalBias:{type:"f32",value:0},intensity:{type:"f32",value:0}};class rr{constructor(e,{light:t,intensity:i=1,bias:s=0,normalBias:r=0,pcfSamples:o=1,depthTextureSize:a=new L(512),depthTextureFormat:h="depth24plus",autoRender:l=!0}={}){ve(this,jt),ve(this,kt,void 0),ve(this,It,void 0),ve(this,Vt,void 0),ve(this,Nt,void 0),ve(this,Wt,void 0),ve(this,at,void 0),ve(this,Ve,void 0),ve(this,ue,void 0),ve(this,Te,void 0),e=Le(e,this.constructor.name),this.renderer=e,this.rendererBinding=null,this.light=t,this.index=this.light.index,this.options={light:t,intensity:i,bias:s,normalBias:r,pcfSamples:o,depthTextureSize:a,depthTextureFormat:h},this.sampleCount=1,this.meshes=new Map,ne(this,Ve,new Map),ne(this,ue,new Map),ne(this,Te,null),ir(this,jt,Gi).call(this,{intensity:i,bias:s,normalBias:r,pcfSamples:o,depthTextureSize:a,depthTextureFormat:h,autoRender:l}),this.isActive=!1}cast({intensity:e,bias:t,normalBias:i,pcfSamples:s,depthTextureSize:r,depthTextureFormat:o,autoRender:a}={}){ir(this,jt,Gi).call(this,{intensity:e,bias:t,normalBias:i,pcfSamples:s,depthTextureSize:r,depthTextureFormat:o,autoRender:a}),this.isActive=!0}setRendererBinding(){}reset(){this.isActive&&(this.onPropertyChanged("isActive",1),this.onPropertyChanged("intensity",this.intensity),this.onPropertyChanged("bias",this.bias),this.onPropertyChanged("normalBias",this.normalBias),this.onPropertyChanged("pcfSamples",this.pcfSamples))}get isActive(){return W(this,Wt)}set isActive(e){!e&&this.isActive?this.destroy():e&&!this.isActive&&this.init(),ne(this,Wt,e)}get intensity(){return W(this,kt)}set intensity(e){ne(this,kt,e),this.onPropertyChanged("intensity",this.intensity)}get bias(){return W(this,It)}set bias(e){ne(this,It,e),this.onPropertyChanged("bias",this.bias)}get normalBias(){return W(this,Vt)}set normalBias(e){ne(this,Vt,e),this.onPropertyChanged("normalBias",this.normalBias)}get pcfSamples(){return W(this,Nt)}set pcfSamples(e){ne(this,Nt,Math.max(1,Math.ceil(e))),this.onPropertyChanged("pcfSamples",this.pcfSamples)}init(){if(!this.depthComparisonSampler){const e=this.renderer.samplers.find(t=>t.name==="depthComparisonSampler");this.depthComparisonSampler=e||new ke(this.renderer,{label:"Depth comparison sampler",name:"depthComparisonSampler",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",compare:"less",minFilter:"linear",magFilter:"linear",type:"comparison"})}this.setDepthTexture(),this.depthPassTarget||this.createDepthPassTarget(),W(this,Te)===null&&W(this,at)&&(this.setDepthPass(),this.onPropertyChanged("isActive",1))}onDepthTextureSizeChanged(){this.setDepthTexture()}setDepthTexture(){this.depthTexture&&(this.depthTexture.size.width!==this.depthTextureSize.x||this.depthTexture.size.height!==this.depthTextureSize.y)?(this.depthTexture.options.fixedSize.width=this.depthTextureSize.x,this.depthTexture.options.fixedSize.height=this.depthTextureSize.y,this.depthTexture.size.width=this.depthTextureSize.x,this.depthTexture.size.height=this.depthTextureSize.y,this.depthTexture.createTexture(),this.depthPassTarget&&this.depthPassTarget.resize()):this.depthTexture||this.createDepthTexture()}createDepthTexture(){this.depthTexture=new re(this.renderer,{label:"Shadow depth texture "+this.index,name:"shadowDepthTexture"+this.index,type:"depth",format:this.depthTextureFormat,sampleCount:this.sampleCount,fixedSize:{width:this.depthTextureSize.x,height:this.depthTextureSize.y},autoDestroy:!1})}createDepthPassTarget(){this.depthPassTarget=new zi(this.renderer,{label:"Depth pass render target for "+this.constructor.name+" "+this.index,useColorAttachments:!1,depthTexture:this.depthTexture,sampleCount:this.sampleCount})}onPropertyChanged(e,t){if(this.rendererBinding){if(t instanceof O){for(let i=0;i<t.elements.length;i++)this.rendererBinding.options.bindings[this.index].inputs[e].value[i]=t.elements[i];this.rendererBinding.options.bindings[this.index].inputs[e].shouldUpdate=!0}else this.rendererBinding.options.bindings[this.index].inputs[e].value=t;this.renderer.shouldUpdateCameraLightsBindGroup()}}setDepthPass(){ne(this,Te,this.render())}removeDepthPass(e){this.renderer.onBeforeRenderScene.remove(e)}render(e=!1){return this.renderer.onBeforeRenderScene.add(t=>{this.meshes.size&&(this.useDepthMaterials(),this.renderDepthPass(t),this.useOriginalMaterials(),this.renderer.pipelineManager.resetCurrentPipeline())},{once:e,order:this.index})}async renderOnce(){W(this,at)||(this.onPropertyChanged("isActive",1),this.useDepthMaterials(),this.meshes.forEach(e=>{e.setGeometry()}),await Promise.all([...W(this,ue).values()].map(async e=>{await e.compileMaterial()})),this.render(!0))}renderDepthPass(e){this.renderer.pipelineManager.resetCurrentPipeline();const t=e.beginRenderPass(this.depthPassTarget.renderPass.descriptor);this.meshes.forEach(i=>{i.render(t)}),t.end()}getDefaultShadowDepthVs(e=!1){return{code:Hs(this.index,e)}}getDefaultShadowDepthFs(){return!1}patchShadowCastingMeshParams(e,t={}){t={...e.material.options.rendering,...t},t.targets=[],t.sampleCount=this.sampleCount,t.depthFormat=this.depthTextureFormat,t.bindings?t.bindings=[e.material.getBufferBindingByName("matrices"),...t.bindings]:t.bindings=[e.material.getBufferBindingByName("matrices")];const i=e.material.inputsBindings.get("instances")&&e.geometry.instancesCount>1;return t.shaders||(t.shaders={vertex:this.getDefaultShadowDepthVs(i),fragment:this.getDefaultShadowDepthFs()}),t}addShadowCastingMesh(e,t={}){e.options.castShadows=!0,W(this,Ve).set(e.uuid,e.material),t=this.patchShadowCastingMeshParams(e,t),W(this,ue).get(e.uuid)&&(W(this,ue).get(e.uuid).destroy(),W(this,ue).delete(e.uuid)),W(this,ue).set(e.uuid,new Ai(this.renderer,{label:e.options.label+" depth render material",...t})),this.meshes.set(e.uuid,e)}useDepthMaterials(){this.meshes.forEach(e=>{e.useMaterial(W(this,ue).get(e.uuid))})}useOriginalMaterials(){this.meshes.forEach(e=>{e.useMaterial(W(this,Ve).get(e.uuid))})}removeMesh(e){const t=W(this,ue).get(e.uuid);t&&(t.destroy(),W(this,ue).delete(e.uuid)),this.meshes.delete(e.uuid)}destroy(){this.onPropertyChanged("isActive",0),W(this,Te)!==null&&(this.removeDepthPass(W(this,Te)),ne(this,Te,null)),this.meshes.forEach(e=>this.removeMesh(e)),ne(this,Ve,new Map),ne(this,ue,new Map),this.meshes=new Map,this.depthPassTarget?.destroy(),this.depthTexture?.destroy()}}kt=new WeakMap,It=new WeakMap,Vt=new WeakMap,Nt=new WeakMap,Wt=new WeakMap,at=new WeakMap,Ve=new WeakMap,ue=new WeakMap,Te=new WeakMap,jt=new WeakSet,Gi=function({intensity:n=1,bias:e=0,normalBias:t=0,pcfSamples:i=1,depthTextureSize:s=new L(512),depthTextureFormat:r="depth24plus",autoRender:o=!0}={}){this.intensity=n,this.bias=e,this.normalBias=t,this.pcfSamples=i,this.depthTextureSize=s,this.depthTextureSize.onChange(()=>this.onDepthTextureSizeChanged()),this.depthTextureFormat=r,ne(this,at,o)};const Bn={...sr,viewMatrix:{type:"mat4x4f",value:new Float32Array(16)},projectionMatrix:{type:"mat4x4f",value:new Float32Array(16)}};class Sn extends rr{constructor(e,{light:t,intensity:i,bias:s,normalBias:r,pcfSamples:o,depthTextureSize:a,depthTextureFormat:h,autoRender:l,camera:u={left:-10,right:10,bottom:-10,top:10,near:.1,far:50}}={}){super(e,{light:t,intensity:i,bias:s,normalBias:r,pcfSamples:o,depthTextureSize:a,depthTextureFormat:h,autoRender:l}),this.options={...this.options,camera:u},this.setRendererBinding(),this.camera={projectionMatrix:new O,viewMatrix:new O,up:new f(0,1,0),_left:u.left,_right:u.right,_bottom:u.bottom,_top:u.top,_near:u.near,_far:u.far};const d=this;["left","right","bottom","top","near","far"].forEach(p=>{Object.defineProperty(d.camera,p,{get(){return d.camera["_"+p]},set(m){d.camera["_"+p]=m,d.updateProjectionMatrix()}})})}setRendererBinding(){this.rendererBinding=this.renderer.bindings.directionalShadows}cast({intensity:e,bias:t,normalBias:i,pcfSamples:s,depthTextureSize:r,depthTextureFormat:o,autoRender:a,camera:h}={}){h&&(this.camera.left=h.left??-10,this.camera.right=h.right??10,this.camera.bottom=h.bottom??-10,this.camera.top=h.right??10,this.camera.near=h.near??.1,this.camera.far=h.far??50),super.cast({intensity:e,bias:t,normalBias:i,pcfSamples:s,depthTextureSize:r,depthTextureFormat:o,autoRender:a})}init(){super.init(),this.updateProjectionMatrix()}reset(){this.setRendererBinding(),super.reset(),this.onPropertyChanged("projectionMatrix",this.camera.projectionMatrix),this.onPropertyChanged("viewMatrix",this.camera.viewMatrix)}updateProjectionMatrix(){this.camera.projectionMatrix.identity().makeOrthographic({left:this.camera.left,right:this.camera.right,bottom:this.camera.bottom,top:this.camera.top,near:this.camera.near,far:this.camera.far}),this.onPropertyChanged("projectionMatrix",this.camera.projectionMatrix)}updateViewMatrix(e=new f,t=new f){e.x===0&&e.z===0?this.camera.up.set(0,0,1):this.camera.up.set(0,1,0),this.camera.viewMatrix.makeView(e,t,this.camera.up),this.onPropertyChanged("viewMatrix",this.camera.viewMatrix)}}var nr=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},qt=(n,e,t)=>(nr(n,e,"read from private field"),t?t.call(n):e.get(n)),or=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},ar=(n,e,t,i)=>(nr(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),ht,lt;class Pn extends Ri{constructor(e,{color:t=new f(1),intensity:i=1,position:s=new f(1),target:r=new f,shadow:o=null}={}){const a="directionalLights",h=e.lights.filter(l=>l.type===a).length;super(e,{color:t,intensity:i,index:h,type:a}),or(this,ht,void 0),or(this,lt,void 0),this.options={...this.options,position:s,target:r,shadow:o},ar(this,lt,new f),ar(this,ht,new f),this.target=r,this.target.onChange(()=>this.setDirection()),this.position.copy(s),this.parent=this.renderer.scene,this.index+1>this.renderer.lightsBindingParams[this.type].max&&this.onMaxLightOverflow(this.type),this.rendererBinding.inputs.count.value=this.index+1,this.rendererBinding.inputs.count.shouldUpdate=!0,this.shadow=new Sn(this.renderer,{autoRender:!1,light:this}),o&&this.shadow.cast(o)}reset(){super.reset(),this.setDirection(),this.shadow?.reset()}setDirection(){qt(this,lt).copy(this.target).sub(this.worldMatrix.getTranslation(qt(this,ht))),this.onPropertyChanged("direction",qt(this,lt)),this.shadow?.updateViewMatrix(qt(this,ht),this.target)}applyScale(){}applyTransformOrigin(){}updateMatrixStack(){super.updateMatrixStack(),this.matricesNeedUpdate&&this.setDirection()}onMaxLightOverflow(e){super.onMaxLightOverflow(e),this.shadow?.setRendererBinding()}destroy(){super.destroy(),this.shadow.destroy()}}ht=new WeakMap,lt=new WeakMap;var hr=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},lr=(n,e,t)=>(hr(n,e,"read from private field"),t?t.call(n):e.get(n)),Tn=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},Rn=(n,e,t,i)=>(hr(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),ut;const zn={face:{type:"i32",value:0},...sr,cameraNear:{type:"f32",value:0},cameraFar:{type:"f32",value:0},projectionMatrix:{type:"mat4x4f",value:new Float32Array(16)},viewMatrices:{type:"array<mat4x4f>",value:new Float32Array(16*6)}};class En extends rr{constructor(e,{light:t,intensity:i,bias:s,normalBias:r,pcfSamples:o,depthTextureSize:a,depthTextureFormat:h,autoRender:l,camera:u={near:.1,far:150}}={}){super(e,{light:t,intensity:i,bias:s,normalBias:r,pcfSamples:o,depthTextureSize:a,depthTextureFormat:h,autoRender:l}),Tn(this,ut,void 0),this.options={...this.options,camera:u},this.setRendererBinding(),this.cubeDirections=[new f(-1,0,0),new f(1,0,0),new f(0,-1,0),new f(0,1,0),new f(0,0,-1),new f(0,0,1)],Rn(this,ut,new f),this.cubeUps=[new f(0,-1,0),new f(0,-1,0),new f(0,0,1),new f(0,0,-1),new f(0,-1,0),new f(0,-1,0)],u.far<=0&&(u.far=150),this.camera={projectionMatrix:new O,viewMatrices:[],_near:u.near,_far:u.far};for(let p=0;p<6;p++)this.camera.viewMatrices.push(new O);const d=this;["near","far"].forEach(p=>{Object.defineProperty(d.camera,p,{get(){return d.camera["_"+p]},set(m){d.camera["_"+p]=m,d.updateProjectionMatrix()}})})}setRendererBinding(){this.rendererBinding=this.renderer.bindings.pointShadows}cast({intensity:e,bias:t,normalBias:i,pcfSamples:s,depthTextureSize:r,depthTextureFormat:o,autoRender:a,camera:h}={}){h&&(this.camera.near=h.near??.1,this.camera.far=h.far!==void 0?h.far:this.light.range>0?this.light.range:150),super.cast({intensity:e,bias:t,normalBias:i,pcfSamples:s,depthTextureSize:r,depthTextureFormat:o,autoRender:a})}init(){super.init(),this.updateProjectionMatrix()}reset(){this.setRendererBinding(),super.reset(),this.onPropertyChanged("cameraNear",this.camera.near),this.onPropertyChanged("cameraFar",this.camera.far),this.onPropertyChanged("projectionMatrix",this.camera.projectionMatrix),this.updateViewMatrices()}updateProjectionMatrix(){this.camera.projectionMatrix.identity().makePerspective({near:this.camera.near,far:this.camera.far,fov:90,aspect:1}),this.onPropertyChanged("projectionMatrix",this.camera.projectionMatrix),this.onPropertyChanged("cameraNear",this.camera.near),this.onPropertyChanged("cameraFar",this.camera.far)}updateViewMatrices(e=new f){for(let t=0;t<6;t++){lr(this,ut).copy(this.cubeDirections[t]).add(e),this.camera.viewMatrices[t].makeView(e,lr(this,ut),this.cubeUps[t]);for(let i=0;i<16;i++)this.rendererBinding.options.bindings[this.index].inputs.viewMatrices.value[t*16+i]=this.camera.viewMatrices[t].elements[i]}this.rendererBinding.options.bindings[this.index].inputs.viewMatrices.shouldUpdate=!0}setDepthTexture(){if(this.depthTexture&&(this.depthTexture.size.width!==this.depthTextureSize.x||this.depthTexture.size.height!==this.depthTextureSize.y)){const e=Math.max(this.depthTextureSize.x,this.depthTextureSize.y);this.depthTexture.options.fixedSize.width=e,this.depthTexture.options.fixedSize.height=e,this.depthTexture.size.width=e,this.depthTexture.size.height=e,this.depthTexture.createTexture(),this.depthPassTarget&&this.depthPassTarget.resize()}else this.depthTexture||this.createDepthTexture()}createDepthTexture(){const e=Math.max(this.depthTextureSize.x,this.depthTextureSize.y);this.depthTexture=new re(this.renderer,{label:"Point shadow cube depth texture "+this.index,name:"pointShadowCubeDepthTexture"+this.index,type:"depth",format:this.depthTextureFormat,viewDimension:"cube",sampleCount:this.sampleCount,fixedSize:{width:e,height:e},autoDestroy:!1})}removeDepthPass(e){this.renderer.onBeforeCommandEncoderCreation.remove(e)}render(e=!1){return this.renderer.onBeforeCommandEncoderCreation.add(()=>{if(this.meshes.size){this.useDepthMaterials();for(let t=0;t<6;t++){const i=this.renderer.device.createCommandEncoder();this.depthPassTarget.renderPass.setRenderPassDescriptor(this.depthTexture.texture.createView({label:this.depthTexture.texture.label+" cube face view "+t,dimension:"2d",arrayLayerCount:1,baseArrayLayer:t})),this.rendererBinding.options.bindings[this.index].inputs.face.value=t,this.renderer.cameraLightsBindGroup.update(),this.renderDepthPass(i);const s=i.finish();this.renderer.device.queue.submit([s])}this.useOriginalMaterials(),this.renderer.pipelineManager.resetCurrentPipeline()}},{once:e,order:this.index})}getDefaultShadowDepthVs(e=!1){return{code:Js(this.index,e)}}getDefaultShadowDepthFs(){return{code:Qs(this.index)}}}ut=new WeakMap;var ur=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},Di=(n,e,t)=>(ur(n,e,"read from private field"),t?t.call(n):e.get(n)),dr=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},cr=(n,e,t,i)=>(ur(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),Yt,dt;class Ln extends Ri{constructor(e,{color:t=new f(1),intensity:i=1,position:s=new f,range:r=0,shadow:o=null}={}){const a="pointLights",h=e.lights.filter(l=>l.type===a).length;super(e,{color:t,intensity:i,index:h,type:a}),dr(this,Yt,void 0),dr(this,dt,void 0),this.options={...this.options,position:s,range:r,shadow:o},cr(this,dt,new f),this.position.copy(s),this.range=r,this.parent=this.renderer.scene,this.index+1>this.renderer.lightsBindingParams[this.type].max&&this.onMaxLightOverflow(this.type),this.rendererBinding.inputs.count.value=this.index+1,this.rendererBinding.inputs.count.shouldUpdate=!0,this.shadow=new En(this.renderer,{autoRender:!1,light:this}),o&&this.shadow.cast(o)}reset(){super.reset(),this.onPropertyChanged("range",this.range),this.setPosition(),this.shadow?.reset()}get range(){return Di(this,Yt)}set range(e){cr(this,Yt,e),this.onPropertyChanged("range",this.range)}setPosition(){this.onPropertyChanged("position",this.worldMatrix.getTranslation(Di(this,dt))),this.shadow?.updateViewMatrices(Di(this,dt))}applyScale(){}applyTransformOrigin(){}updateMatrixStack(){super.updateMatrixStack(),this.matricesNeedUpdate&&this.setPosition()}onMaxLightOverflow(e){super.onMaxLightOverflow(e),this.shadow?.setRendererBinding()}destroy(){super.destroy(),this.shadow.destroy()}}Yt=new WeakMap,dt=new WeakMap;var pr=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},Fi=(n,e,t)=>(pr(n,e,"read from private field"),t?t.call(n):e.get(n)),_n=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},An=(n,e,t,i)=>(pr(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t);let On=0;const fr={autoRender:!0,useProjection:!1,useAsyncPipeline:!0,cullMode:"back",depth:!0,depthWriteEnabled:!0,depthCompare:"less",depthFormat:"depth24plus",transparent:!1,visible:!0,renderOrder:0,texturesOptions:{}};function mr(n){var e,t;return t=class extends n{constructor(...i){super(i[0],i[1],{...fr,...i[2]}),_n(this,e,!0),this._onReadyCallback=()=>{},this._onBeforeRenderCallback=()=>{},this._onRenderCallback=()=>{},this._onAfterRenderCallback=()=>{},this._onAfterResizeCallback=()=>{};let s=i[0];const r={...fr,...i[2]};this.type="MeshBase",this.uuid=X(),Object.defineProperty(this,"index",{value:On++}),s=q(s,r.label?r.label+" "+this.type:this.type),this.renderer=s;const{label:o,shaders:a,geometry:h,visible:l,renderOrder:u,outputTarget:d,texturesOptions:c,autoRender:p,...m}=r;this.outputTarget=d??null,m.sampleCount=m.sampleCount?m.sampleCount:this.outputTarget?this.outputTarget.renderPass.options.sampleCount:this.renderer&&this.renderer.renderPass?this.renderer.renderPass.options.sampleCount:1,this.options={...this.options??{},label:o??"Mesh "+this.renderer.meshes.length,...a!==void 0?{shaders:a}:{},...d!==void 0&&{outputTarget:d},texturesOptions:c,...p!==void 0&&{autoRender:p},...m},p!==void 0&&An(this,e,p),this.visible=l,this.renderOrder=u,this.ready=!1,this.userData={},h&&this.useGeometry(h),this.setMaterial({...this.cleanupRenderMaterialParameters({...this.options}),...h&&{verticesOrder:h.verticesOrder,topology:h.topology}}),this.addToScene(!0)}get autoRender(){return Fi(this,e)}get ready(){return this._ready}set ready(i){i&&!this._ready&&this._onReadyCallback&&this._onReadyCallback(),this._ready=i}addToScene(i=!1){i&&this.renderer.meshes.push(this),this.setRenderingOptionsForRenderPass(this.outputTarget?this.outputTarget.renderPass:this.renderer.renderPass),Fi(this,e)&&this.renderer.scene.addMesh(this)}removeFromScene(i=!1){Fi(this,e)&&this.renderer.scene.removeMesh(this),i&&(this.renderer.meshes=this.renderer.meshes.filter(s=>s.uuid!==this.uuid))}setRenderer(i){if(i=i&&i.renderer||i,!i||!(i.type==="GPURenderer"||i.type==="GPUCameraRenderer"||i.type==="GPUCurtainsRenderer")){$(`${this.options.label}: Cannot set ${i} as a renderer because it is not of a valid Renderer type.`);return}const s=this.renderer;this.removeFromScene(!0),this.renderer=i,this.addToScene(!0),s.meshes.length||s.onBeforeRenderScene.add(r=>{s.forceClear(r)},{once:!0})}setOutputTarget(i){if(i&&i.type!=="RenderTarget"){$(`${this.options.label??this.type}: outputTarget is not a RenderTarget: ${i}`);return}this.removeFromScene(),this.outputTarget=i,this.addToScene()}loseContext(){this.ready=!1,this.geometry.loseContext(),this.material.loseContext()}restoreContext(){this.geometry.restoreContext(this.renderer),this.material.restoreContext()}setShaders(){const{shaders:i}=this.options;i?((!i.vertex||!i.vertex.code)&&(i.vertex={code:Li,entryPoint:"main"}),(i.fragment===void 0||i.fragment&&!i.fragment.code)&&(i.fragment={code:_i,entryPoint:"main"})):this.options.shaders={vertex:{code:Li,entryPoint:"main"},fragment:{code:_i,entryPoint:"main"}}}useGeometry(i){if(this.geometry&&(i.shouldCompute&&i.computeGeometry(),this.geometry.layoutCacheKey!==i.layoutCacheKey&&($(`${this.options.label} (${this.type}): the current and new geometries do not have the same vertexBuffers layout, causing a probable pipeline recompilation. This should be avoided.
...
}`;const yr={frustumCulling:"OBB",DOMFrustumMargins:{top:0,right:0,bottom:0,left:0},receiveShadows:!1,castShadows:!1};function xr(n){return class extends mr(n){constructor(...t){super(t[0],t[1],{...yr,...t[2],useProjection:!0}),this._onReEnterViewCallback=()=>{},this._onLeaveViewCallback=()=>{};let i=t[0];const s={...yr,...t[2],useProjection:!0};this.type="MeshTransformed",i=Le(i,s.label?s.label+" "+this.type:this.type),this.renderer=i;const{frustumCulling:r,DOMFrustumMargins:o,receiveShadows:a,castShadows:h}=s;this.options={...this.options??{},frustumCulling:r,DOMFrustumMargins:o,receiveShadows:a,castShadows:h},this.options.castShadows&&this.renderer.shadowCastingLights.forEach(l=>{l.shadow.isActive&&l.shadow.addShadowCastingMesh(this)}),this.setDOMFrustum()}setShaders(){const{shaders:t}=this.options;t?((!t.vertex||!t.vertex.code)&&(t.vertex={code:Ei,entryPoint:"main"}),(t.fragment===void 0||t.fragment&&!t.fragment.code)&&(t.fragment={code:gr,entryPoint:"main"})):this.options.shaders={vertex:{code:Ei,entryPoint:"main"},fragment:{code:gr,entryPoint:"main"}}}useGeometry(t){super.useGeometry(t),this.domFrustum&&(this.domFrustum.boundingBox=this.geometry.boundingBox),this.shouldUpdateMatrixStack()}setDOMFrustum(){this.domFrustum=new Is({boundingBox:this.geometry?.boundingBox,modelViewProjectionMatrix:this.modelViewProjectionMatrix,containerBoundingRect:this.renderer.boundingRect,DOMFrustumMargins:this.options.DOMFrustumMargins,onReEnterView:()=>{this._onReEnterViewCallback&&this._onReEnterViewCallback()},onLeaveView:()=>{this._onLeaveViewCallback&&this._onLeaveViewCallback()}}),this.DOMFrustumMargins=this.domFrustum.DOMFrustumMargins,this.frustumCulling=this.options.frustumCulling}cleanupRenderMaterialParameters(t){if(delete t.frustumCulling,delete t.DOMFrustumMargins,this.options.receiveShadows){const i=[];let s=[];this.renderer.shadowCastingLights.forEach(o=>{o.shadow.isActive&&(i.push(o.shadow.depthTexture),s.push(o.shadow.depthComparisonSampler))}),this.renderer.shadowCastingLights.find(o=>o.shadow.isActive)&&t.shaders.fragment&&typeof t.shaders.fragment=="object"&&(t.shaders.fragment.code=Ks(this.renderer)+Zs+tr(this.renderer)+er+t.shaders.fragment.code),s=s.filter((o,a,h)=>h.findIndex(l=>l.uuid===o.uuid)===a),t.textures?t.textures=[...t.textures,...i]:t.textures=i,t.samplers?t.samplers=[...t.samplers,...s]:t.samplers=s}return super.cleanupRenderMaterialParameters(t)}setMaterial(t){const i={label:"Matrices",visibility:["vertex"],struct:{model:{type:"mat4x4f",value:this.worldMatrix},modelView:{type:"mat4x4f",value:this.modelViewMatrix},normal:{type:"mat3x3f",value:this.normalMatrix}}};t.uniforms||(t.uniforms={}),t.uniforms={matrices:i,...t.uniforms},super.setMaterial(t)}get visible(){return this._visible}set visible(t){this.shouldUpdateMatrixStack(),this._visible=t}resize(t){this.domFrustum&&this.domFrustum.setContainerBoundingRect(this.renderer.boundingRect),super.resize(t)}applyScale(){super.applyScale();for(const t of this.domTextures)t.resize()}get projectedBoundingRect(){return this.domFrustum?.projectedBoundingRect}onReEnterView(t){return t&&(this._onReEnterViewCallback=t),this}onLeaveView(t){return t&&(this._onLeaveViewCallback=t),this}get clipSpaceBoundingSphere(){const{center:t,radius:i,min:s,max:r}=this.geometry.boundingBox,o=this.worldMatrix.getTranslation(),a=i*this.worldMatrix.getMaxScaleOnAxis(),h=t.clone().add(o);h.z+=s.z;const l=t.clone().add(o);l.z+=r.z;const u=h.clone();u.y+=a;const d=l.clone();d.y+=a,h.applyMat4(this.camera.viewProjectionMatrix),l.applyMat4(this.camera.viewProjectionMatrix),u.applyMat4(this.camera.viewProjectionMatrix),d.applyMat4(this.camera.viewProjectionMatrix);const c=h.distance(u),p=l.distance(d),m={xMin:h.x-c,xMax:h.x+c,yMin:h.y-c,yMax:h.y+c},g={xMin:l.x-p,xMax:l.x+p,yMin:l.y-p,yMax:l.y+p},y={xMin:Math.min(m.xMin,g.xMin),yMin:Math.min(m.yMin,g.yMin),xMax:Math.max(m.xMax,g.xMax),yMax:Math.max(m.yMax,g.yMax)},v=l.add(h).multiplyScalar(.5).clone();v.x=(y.xMax+y.xMin)/2,v.y=(y.yMax+y.yMin)/2;const C=Math.max(y.xMax-y.xMin,y.yMax-y.yMin)*.5;return{center:v,radius:C}}checkFrustumCulling(){this.matricesNeedUpdate&&this.domFrustum&&this.frustumCulling&&(this.frustumCulling==="sphere"?this.domFrustum.setDocumentCoordsFromClipSpaceSphere(this.clipSpaceBoundingSphere):this.domFrustum.setDocumentCoordsFromClipSpaceOBB(),this.domFrustum.intersectsContainer())}onBeforeRenderPass(){this.material&&this.matricesNeedUpdate&&this.material.shouldUpdateInputsBindings("matrices"),super.onBeforeRenderPass()}onRenderPass(t){this.ready&&(this._onRenderCallback&&this._onRenderCallback(),(this.domFrustum&&this.domFrustum.isIntersecting||!this.frustumCulling)&&(this.material.render(t),this.geometry.render(t)))}destroy(){this.options.castShadows&&this.renderer.shadowCastingLights.forEach(t=>{t.shadow.isActive&&t.shadow.removeMesh(this)}),super.destroy()}}}class vr extends xr($i){constructor(e,t={}){e=Le(e,t.label?t.label+" Mesh":"Mesh"),super(e,null,t),this.type="Mesh"}}let Dn=0;class ki{constructor(e){this.type="PipelineEntry";let{renderer:t}=e;const{label:i,shaders:s,useAsync:r}=e;t=q(t,i?i+" "+this.type:this.type),this.renderer=t,Object.defineProperty(this,"index",{value:Dn++}),this.layout=null,this.pipeline=null,this.status={compiling:!1,compiled:!1,error:null},this.options={label:i,shaders:s,useAsync:r!==void 0?r:!0}}get ready(){return!this.status.compiling&&this.status.compiled&&!this.status.error}get canCompile(){return!this.status.compiling&&!this.status.compiled&&!this.status.error}setPipelineEntryBindGroups(e){this.bindGroups=e}createShaderModule({code:e="",type:t="vertex"}){const i=this.renderer.createShaderModule({label:this.options.label+": "+t+" shader module",code:e});return"getCompilationInfo"in i&&!this.renderer.production&&i.getCompilationInfo().then(s=>{for(const r of s.messages){let o="";switch(r.lineNum&&(o+=`Line ${r.lineNum}:${r.linePos} - ${e.substring(r.offset,r.offset+r.length)}
...
`;const Ge={vertex:{get_uv_cover:wr},fragment:{get_uv_cover:wr,get_vertex_to_uv_coords:$n}},De={vertex:{get_output_position:Fn,get_normals:Un},fragment:{}};class Ii extends ki{constructor(e){let{renderer:t,...i}=e;const{label:s,attributes:r,bindGroups:o,cacheKey:a,...h}=i,l="RenderPipelineEntry";q(t,s?s+" "+l:l),super(e),this.type=l,this.shaders={vertex:{head:"",code:"",module:null},fragment:{head:"",code:"",module:null},full:{head:"",code:"",module:null}},this.descriptor=null,this.options={...this.options,attributes:r,bindGroups:o,cacheKey:a,...h},this.setPipelineEntryProperties({attributes:r,bindGroups:o})}setPipelineEntryProperties(e){const{attributes:t,bindGroups:i}=e;this.attributes=t,this.setPipelineEntryBindGroups(i)}patchShaders(){this.shaders.vertex.head="",this.shaders.vertex.code="",this.shaders.fragment.head="",this.shaders.fragment.code="",this.shaders.full.head="",this.shaders.full.code="";for(const t in Ge.vertex)this.shaders.vertex.head=`${Ge.vertex[t]}
...
`,Lr=({addUtils:n=!0,receiveShadows:e=!1,toneMapping:t="linear",useOcclusion:i=!1}={})=>`
${n?Kt:""}
${Er}
${t?ct:""}
...
`,_r=({addUtils:n=!0,receiveShadows:e=!1,toneMapping:t="linear",useOcclusion:i=!1}={})=>`
${n?Hi:""}
${Zi}
${t?ct:""}
...
`,Or=({addUtils:n=!0,receiveShadows:e=!1,toneMapping:t="linear",useOcclusion:i=!1}={})=>`
${n?Hi:""}
${Zi}
${Ar}
${t?ct:""}
...
`;var Gr=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},Ce=(n,e,t)=>(Gr(n,e,"read from private field"),t?t.call(n):e.get(n)),Ki=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},to=(n,e,t,i)=>(Gr(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),pt,Fe,Jt;class Dr extends $i{constructor(e,t,i={}){super(e),Ki(this,pt,new f),Ki(this,Fe,new f(1)),Ki(this,Jt,1),this.boundingBox=new xe(new f(-1),new f(1)),this._onAfterDOMElementResizeCallback=()=>{},e=xi(e,"DOM3DObject"),this.renderer=e,this.size={shouldUpdate:!0,normalizedWorld:{size:new L(1),position:new L},cameraWorld:{size:new L(1)},scaledWorld:{size:new f(1),position:new f}},this.watchScroll=i.watchScroll,this.camera=this.renderer.camera,this.boundingBox.min.onChange(()=>this.shouldUpdateComputedSizes()),this.boundingBox.max.onChange(()=>this.shouldUpdateComputedSizes()),this.setDOMElement(t),this.renderer.domObjects.push(this)}setDOMElement(e){this.domElement=new Ni({element:e,onSizeChanged:t=>this.resize(t),onPositionChanged:()=>this.onPositionChanged()}),this.updateSizeAndPosition()}onPositionChanged(){this.watchScroll&&this.shouldUpdateComputedSizes()}resetDOMElement(e){this.domElement&&this.domElement.destroy(),this.setDOMElement(e)}resize(e=null){!e&&(!this.domElement||this.domElement?.isResizing)||(this.updateSizeAndPosition(),this._onAfterDOMElementResizeCallback&&this._onAfterDOMElementResizeCallback())}get boundingRect(){return this.domElement?.boundingRect??{width:1,height:1,top:0,right:0,bottom:0,left:0,x:0,y:0}}setTransforms(){super.setTransforms(),this.transforms.origin.model.set(.5,.5,0),this.transforms.origin.world=new f,this.transforms.position.document=new f,this.documentPosition.onChange(()=>this.applyPosition()),this.transformOrigin.onChange(()=>this.setWorldTransformOrigin())}get documentPosition(){return this.transforms.position.document}set documentPosition(e){this.transforms.position.document=e,this.applyPosition()}get DOMObjectWorldScale(){return Ce(this,Fe).clone()}get worldScale(){return this.DOMObjectWorldScale.multiply(this.scale)}get worldPosition(){return Ce(this,pt).clone()}get transformOrigin(){return this.transforms.origin.model}set transformOrigin(e){this.transforms.origin.model=e,this.setWorldTransformOrigin()}get worldTransformOrigin(){return this.transforms.origin.world}set worldTransformOrigin(e){this.transforms.origin.world=e}shouldUpdateMatrices(){super.shouldUpdateMatrices(),(this.matricesNeedUpdate||this.size.shouldUpdate)&&(this.updateSizeAndPosition(),this.matricesNeedUpdate=!0),this.size.shouldUpdate=!1}shouldUpdateComputedSizes(){this.size.shouldUpdate=!0}updateSizeAndPosition(){this.setWorldSizes(),this.applyDocumentPosition(),this.shouldUpdateModelMatrix()}applyDocumentPosition(){let e=new f(0,0,0);this.documentPosition.equals(e)||(e=this.documentToWorldSpace(this.documentPosition)),Ce(this,pt).set(this.position.x+this.size.scaledWorld.position.x+e.x,this.position.y+this.size.scaledWorld.position.y+e.y,this.position.z+this.size.scaledWorld.position.z+this.documentPosition.z/this.camera.CSSPerspective)}applyTransformOrigin(){this.size&&(this.setWorldTransformOrigin(),super.applyTransformOrigin())}updateModelMatrix(){this.modelMatrix.composeFromOrigin(Ce(this,pt),this.quaternion,this.scale,this.worldTransformOrigin),this.modelMatrix.scale(this.DOMObjectWorldScale),this.shouldUpdateWorldMatrix()}documentToWorldSpace(e=new f){return new f(e.x*this.renderer.pixelRatio/this.renderer.boundingRect.width*this.camera.visibleSize.width,-(e.y*this.renderer.pixelRatio/this.renderer.boundingRect.height)*this.camera.visibleSize.height,e.z)}computeWorldSizes(){const e=this.renderer.boundingRect,t={x:this.boundingRect.width/2+this.boundingRect.left,y:this.boundingRect.height/2+this.boundingRect.top},i={x:e.width/2+e.left,y:e.height/2+e.top},{size:s,center:r}=this.boundingBox;s.x!==0&&s.y!==0&&s.z!==0&&r.divide(s),this.size.normalizedWorld.size.set(this.boundingRect.width/e.width,this.boundingRect.height/e.height),this.size.normalizedWorld.position.set((t.x-i.x)/e.width,(i.y-t.y)/e.height),this.size.cameraWorld.size.set(this.size.normalizedWorld.size.x*this.camera.visibleSize.width,this.size.normalizedWorld.size.y*this.camera.visibleSize.height),this.size.scaledWorld.size.set(this.size.cameraWorld.size.x/s.x,this.size.cameraWorld.size.y/s.y,1),this.size.scaledWorld.size.z=this.size.scaledWorld.size.y*(s.x/s.y/(this.boundingRect.width/this.boundingRect.height)),this.size.scaledWorld.position.set(this.size.normalizedWorld.position.x*this.camera.visibleSize.width,this.size.normalizedWorld.position.y*this.camera.visibleSize.height,0)}setWorldSizes(){this.computeWorldSizes(),this.setWorldScale(),this.setWorldTransformOrigin()}setWorldScale(){Ce(this,Fe).set(this.size.scaledWorld.size.x,this.size.scaledWorld.size.y,this.size.scaledWorld.size.z*Ce(this,Jt)),this.shouldUpdateMatrixStack()}set DOMObjectDepthScaleRatio(e){to(this,Jt,e),this.setWorldScale()}setWorldTransformOrigin(){this.transforms.origin.world=new f((this.transformOrigin.x*2-1)*Ce(this,Fe).x,-(this.transformOrigin.y*2-1)*Ce(this,Fe).y,this.transformOrigin.z*Ce(this,Fe).z),this.shouldUpdateMatrixStack()}updateScrollPosition(e={x:0,y:0}){(e.x||e.y)&&this.domElement.updateScrollPosition(e)}onAfterDOMElementResize(e){return e&&(this._onAfterDOMElementResizeCallback=e),this}destroy(){super.destroy(),this.domElement?.destroy()}}pt=new WeakMap,Fe=new WeakMap,Jt=new WeakMap;const Fr={autoloadSources:!0,watchScroll:!0};class Ur extends xr(Dr){constructor(e,t,i){super(e,t,{...Fr,...i}),this._onLoadingCallback=r=>{},i={...Fr,...i},xi(e,i.label?i.label+" DOMMesh":"DOMMesh"),this.type="DOMMesh";const{autoloadSources:s}=i;this.autoloadSources=s,this.sourcesReady=!1,this.setInitSources()}get ready(){return this._ready}set ready(e){e&&!this._ready&&this.sourcesReady&&this._onReadyCallback&&this._onReadyCallback(),this._ready=e}get sourcesReady(){return this._sourcesReady}set sourcesReady(e){e&&!this._sourcesReady&&this.ready&&this._onReadyCallback&&this._onReadyCallback(),this._sourcesReady=e}addToScene(e=!1){super.addToScene(e),e&&this.renderer.domMeshes.push(this)}removeFromScene(e=!1){super.removeFromScene(e),e&&(this.renderer.domMeshes=this.renderer.domMeshes.filter(t=>t.uuid!==this.uuid))}setInitSources(){let e=0,t=0;if(this.autoloadSources){const i=this.domElement.element.querySelectorAll("img"),s=this.domElement.element.querySelectorAll("video"),r=this.domElement.element.querySelectorAll("canvas");e=i.length+s.length+r.length;const o=a=>{t++,this._onLoadingCallback&&this._onLoadingCallback(a),t===e&&(this.sourcesReady=!0)};e||(this.sourcesReady=!0),i.length&&i.forEach(a=>{const h=this.createDOMTexture({name:a.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>o(h)).loadImage(a.src)}),s.length&&s.forEach(a=>{const h=this.createDOMTexture({name:a.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>o(h)).loadVideo(a)}),r.length&&r.forEach(a=>{const h=this.createDOMTexture({name:a.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>o(h)).loadCanvas(a)})}else this.sourcesReady=!0}resetDOMElement(e){e?super.resetDOMElement(e):!e&&!this.renderer.production&&$(`${this.options.label}: You are trying to reset a ${this.type} with a HTML element that does not exist. The old HTML element will be kept instead.`)}get pixelRatioBoundingRect(){const e=window.devicePixelRatio??1,t=this.renderer.pixelRatio/e;return Object.keys(this.domElement.boundingRect).reduce((i,s)=>({...i,[s]:this.domElement.boundingRect[s]*t}),{x:0,y:0,width:0,height:0,top:0,right:0,bottom:0,left:0})}computeGeometry(){super.computeGeometry(),this.boundingBox.copy(this.geometry.boundingBox)}onLoading(e){return e&&(this._onLoadingCallback=e),this}}const io={label:"Plane",instancesCount:1,vertexBuffers:[]};class $r extends Ur{constructor(e,t,i={}){e=xi(e,i.label?i.label+" Plane":"Plane");const s={...io,...i};let{geometry:r,widthSegments:o,heightSegments:a,...h}=s;const{instancesCount:l,vertexBuffers:u,...d}=h;if(!r||r.type!=="PlaneGeometry"){o=o??1,a=a??1;const c=o*a+o;u.length||(r=Xt.getPlaneGeometryByID(c)),r?r.instancesCount=l:(r=new Ti({widthSegments:o,heightSegments:a,instancesCount:l,vertexBuffers:u}),Xt.addPlaneGeometry(r))}super(e,t,{geometry:r,...d}),this.type="Plane"}}class Qt extends Xi{constructor({deviceManager:e,label:t,container:i,pixelRatio:s=1,autoResize:r=!0,preferredFormat:o,alphaMode:a="premultiplied",renderPass:h,camera:l,lights:u}){super({deviceManager:e,label:t,container:i,pixelRatio:s,autoResize:r,preferredFormat:o,alphaMode:a,renderPass:h,camera:l,lights:u}),this.type="GPUCurtainsRenderer"}setRendererObjects(){super.setRendererObjects(),this.domMeshes=[],this.domObjects=[]}onCameraMatricesChanged(){super.onCameraMatricesChanged(),this.domObjects.forEach(e=>{e.updateSizeAndPosition()})}resizeMeshes(){this.meshes.forEach(e=>{"domElement"in e||e.resize(this.boundingRect)}),this.domObjects.forEach(e=>{e.domElement.isResizing||e.domElement.setSize()})}}class so{constructor({scroll:e={x:0,y:0},delta:t={x:0,y:0},shouldWatch:i=!0,onScroll:s=(r={x:0,y:0})=>{}}={}){this.scroll=e,this.delta=t,this.shouldWatch=i,this.onScroll=s,this.shouldWatch&&window.addEventListener("scroll",this.setScroll.bind(this),{passive:!0})}setScroll(){this.updateScrollValues({x:window.pageXOffset,y:window.pageYOffset})}updateScrollValues({x:e,y:t}){const i=this.scroll;this.scroll={x:e,y:t},this.delta={x:i.x-this.scroll.x,y:i.y-this.scroll.y},this.onScroll&&this.onScroll(this.delta)}destroy(){this.shouldWatch&&window.removeEventListener("scroll",this.setScroll.bind(this),{passive:!0})}}class ro{constructor({container:e,label:t,pixelRatio:i=window.devicePixelRatio??1,preferredFormat:s,alphaMode:r="premultiplied",production:o=!1,adapterOptions:a={},renderPass:h,camera:l,lights:u,autoRender:d=!0,autoResize:c=!0,watchScroll:p=!0}={}){this._onRenderCallback=()=>{},this._onScrollCallback=()=>{},this._onErrorCallback=()=>{},this._onContextLostCallback=()=>{},this.type="CurtainsGPU",this.options={container:e,label:t,pixelRatio:i,camera:l,lights:u,production:o,adapterOptions:a,preferredFormat:s,alphaMode:r,renderPass:h,autoRender:d,autoResize:c,watchScroll:p},this.setDeviceManager(),e&&this.setContainer(e),this.initEvents(),this.options.autoRender&&this.animate()}setContainer(e){if(e)if(typeof e=="string")if(e=document.querySelector(e),e)this.options.container=e;else{const t=document.createElement("div");t.setAttribute("id","curtains-gpu-canvas"),document.body.appendChild(t),this.options.container=t}else e instanceof Element&&(this.options.container=e);else{const t=document.createElement("div");t.setAttribute("id","curtains-gpu-canvas"),document.body.appendChild(t),this.options.container=t}this.container=this.options.container,this.setMainRenderer()}setMainRenderer(){this.createCurtainsRenderer({deviceManager:this.deviceManager,label:this.options.label,container:this.options.container,pixelRatio:this.options.pixelRatio,autoResize:this.options.autoResize,preferredFormat:this.options.preferredFormat,alphaMode:this.options.alphaMode,renderPass:this.options.renderPass,camera:this.options.camera,lights:this.options.lights})}patchRendererOptions(e){return e.pixelRatio===void 0&&(e.pixelRatio=this.options.pixelRatio),e.autoResize===void 0&&(e.autoResize=this.options.autoResize),e}createRenderer(e){return e=this.patchRendererOptions(e),new qi({...e,deviceManager:this.deviceManager})}createCameraRenderer(e){return e=this.patchRendererOptions(e),new Xi({...e,deviceManager:this.deviceManager})}createCurtainsRenderer(e){return e=this.patchRendererOptions(e),new Qt({...e,deviceManager:this.deviceManager})}setDeviceManager(){this.deviceManager=new Tr({label:"GPUCurtains default device",production:this.options.production,adapterOptions:this.options.adapterOptions,onError:()=>setTimeout(()=>{this._onErrorCallback&&this._onErrorCallback()},0),onDeviceLost:e=>this._onContextLostCallback&&this._onContextLostCallback(e)})}get renderers(){return this.deviceManager.renderers}get renderer(){return this.renderers[0]}async setDevice({adapter:e=null,device:t=null}={}){await this.deviceManager.init({adapter:e,device:t})}async restoreContext(){await this.deviceManager.restoreDevice()}get pingPongPlanes(){return this.renderers?.map(e=>e.pingPongPlanes).flat()}get shaderPasses(){return this.renderers?.map(e=>e.shaderPasses).flat()}get meshes(){return this.renderers?.map(e=>e.meshes).flat()}get domMeshes(){return this.renderers?.filter(e=>e instanceof Qt).map(e=>e.domMeshes).flat()}get domObjects(){return this.renderers?.filter(e=>e instanceof Qt).map(e=>e.domObjects).flat()}get planes(){return this.domMeshes.filter(e=>e instanceof $r)}get computePasses(){return this.renderers?.map(e=>e.computePasses).flat()}get boundingRect(){return this.renderer?.boundingRect}initScroll(){this.scrollManager=new so({scroll:{x:window.pageXOffset,y:window.pageYOffset},delta:{x:0,y:0},shouldWatch:this.options.watchScroll,onScroll:e=>this.updateScroll(e)})}updateScroll(e={x:0,y:0}){this.domObjects.forEach(t=>{t.domElement&&t.watchScroll&&t.updateScrollPosition(e)}),this._onScrollCallback&&this._onScrollCallback()}updateScrollValues(e={x:0,y:0}){this.scrollManager.updateScrollValues(e)}get scrollDelta(){return this.scrollManager.delta}get scrollValues(){return this.scrollManager.scroll}initEvents(){Vi.useObserver(this.options.autoResize),this.initScroll()}onRender(e){return e&&(this._onRenderCallback=e),this}onScroll(e){return e&&(this._onScrollCallback=e),this}onError(e){return e&&(this._onErrorCallback=e),this}onContextLost(e){return e&&(this._onContextLostCallback=e),this}animate(){this.render(),this.animationFrameID=window.requestAnimationFrame(this.animate.bind(this))}render(){this._onRenderCallback&&this._onRenderCallback(),this.deviceManager.render()}destroy(){this.animationFrameID&&window.cancelAnimationFrame(this.animationFrameID),this.deviceManager.destroy(),this.scrollManager?.destroy(),Vi.destroy()}}var Ji=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},M=(n,e,t)=>(Ji(n,e,"read from private field"),t?t.call(n):e.get(n)),k=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},Re=(n,e,t,i)=>(Ji(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),_=(n,e,t)=>(Ji(n,e,"access private method"),t),V,oe,ze,U,We,je,ft,qe,ei,Qi,es,kr,ts,Ir,ti,is,ii,ss,si,rs,ri,ns,ni,os,oi,as,ai,hs,hi,ls,Ue,Ye,li,us,ds,Vr,cs,Nr;const Xe=new L,He=new L,Ee=new f;class no{constructor({camera:e,element:t=null,target:i=new f,enableZoom:s=!0,minZoom:r=0,maxZoom:o=1/0,zoomSpeed:a=1,enableRotate:h=!0,minPolarAngle:l=0,maxPolarAngle:u=Math.PI,minAzimuthAngle:d=-1/0,maxAzimuthAngle:c=1/0,rotateSpeed:p=1,enablePan:m=!0,panSpeed:g=1}){if(k(this,ei),k(this,es),k(this,ts),k(this,ti),k(this,ii),k(this,si),k(this,ri),k(this,ni),k(this,oi),k(this,ai),k(this,hi),k(this,Ue),k(this,li),k(this,ds),k(this,cs),k(this,V,null),k(this,oe,new f),k(this,ze,!1),k(this,U,{radius:1,phi:0,theta:0}),k(this,We,new L),k(this,je,!1),k(this,ft,new L),k(this,qe,new f),!e){$("OrbitControls: cannot initialize without a camera.");return}this.camera=e,_(this,ei,Qi).call(this,{target:i,enableZoom:s,minZoom:r,maxZoom:o,zoomSpeed:a,enableRotate:h,minPolarAngle:l,maxPolarAngle:u,minAzimuthAngle:d,maxAzimuthAngle:c,rotateSpeed:p,enablePan:m,panSpeed:g}),M(this,oe).copy(this.camera.position).sub(this.target),M(this,U).radius=M(this,oe).length(),M(this,U).theta=Math.atan2(M(this,oe).x,M(this,oe).z),M(this,U).phi=Math.acos(Math.min(Math.max(M(this,oe).y/M(this,U).radius,-1),1)),this.camera.position.onChange(()=>{this.camera.lookAt(this.target)}),this.element=t??(typeof window<"u"?window:null),_(this,Ue,Ye).call(this)}reset({position:e,target:t,enableZoom:i=this.enableZoom,minZoom:s=this.minZoom,maxZoom:r=this.maxZoom,zoomSpeed:o=this.zoomSpeed,enableRotate:a=this.enableRotate,minPolarAngle:h=this.minPolarAngle,maxPolarAngle:l=this.maxPolarAngle,minAzimuthAngle:u=this.minAzimuthAngle,maxAzimuthAngle:d=this.maxAzimuthAngle,rotateSpeed:c=this.rotateSpeed,enablePan:p=this.enablePan,panSpeed:m=this.panSpeed}={}){_(this,ei,Qi).call(this,{target:t,enableZoom:i,minZoom:s,maxZoom:r,zoomSpeed:o,enableRotate:a,minPolarAngle:h,maxPolarAngle:l,minAzimuthAngle:u,maxAzimuthAngle:d,rotateSpeed:c,enablePan:p,panSpeed:m}),e&&this.updatePosition(e)}updatePosition(e=new f){e.sub(this.target),M(this,U).radius=e.length(),M(this,U).theta=Math.atan2(e.x,e.z),M(this,U).phi=Math.acos(Math.min(Math.max(e.y/M(this,U).radius,-1),1)),_(this,Ue,Ye).call(this)}set element(e){M(this,V)&&(!e||M(this,V)!==e)&&_(this,ts,Ir).call(this),Re(this,V,e),e&&_(this,es,kr).call(this)}get element(){return M(this,V)}destroy(){this.element=null}}V=new WeakMap,oe=new WeakMap,ze=new WeakMap,U=new WeakMap,We=new WeakMap,je=new WeakMap,ft=new WeakMap,qe=new WeakMap,ei=new WeakSet,Qi=function({target:n,enableZoom:e=this.enableZoom,minZoom:t=this.minZoom,maxZoom:i=this.maxZoom,zoomSpeed:s=this.zoomSpeed,enableRotate:r=this.enableRotate,minPolarAngle:o=this.minPolarAngle,maxPolarAngle:a=this.maxPolarAngle,minAzimuthAngle:h=this.minAzimuthAngle,maxAzimuthAngle:l=this.maxAzimuthAngle,rotateSpeed:u=this.rotateSpeed,enablePan:d=this.enablePan,panSpeed:c=this.panSpeed}={}){n&&(this.target=n),this.enableZoom=e,this.minZoom=t,this.maxZoom=i,this.zoomSpeed=s,this.enableRotate=r,this.minPolarAngle=o,this.maxPolarAngle=a,this.minAzimuthAngle=h,this.maxAzimuthAngle=l,this.rotateSpeed=u,this.enablePan=d,this.panSpeed=c},es=new WeakSet,kr=function(){M(this,V).addEventListener("contextmenu",_(this,hi,ls).bind(this),!1),M(this,V).addEventListener("mousedown",_(this,ti,is).bind(this),!1),M(this,V).addEventListener("mousemove",_(this,si,rs).bind(this),!1),M(this,V).addEventListener("mouseup",_(this,ni,os).bind(this),!1),M(this,V).addEventListener("touchstart",_(this,ii,ss).bind(this),{passive:!1}),M(this,V).addEventListener("touchmove",_(this,ri,ns).bind(this),{passive:!1}),M(this,V).addEventListener("touchend",_(this,oi,as).bind(this),!1),M(this,V).addEventListener("wheel",_(this,ai,hs).bind(this),{passive:!1})},ts=new WeakSet,Ir=function(){M(this,V).removeEventListener("contextmenu",_(this,hi,ls).bind(this),!1),M(this,V).removeEventListener("mousedown",_(this,ti,is).bind(this),!1),M(this,V).removeEventListener("mousemove",_(this,si,rs).bind(this),!1),M(this,V).removeEventListener("mouseup",_(this,ni,os).bind(this),!1),M(this,V).removeEventListener("touchstart",_(this,ii,ss).bind(this),{passive:!1}),M(this,V).removeEventListener("touchmove",_(this,ri,ns).bind(this),{passive:!1}),M(this,V).removeEventListener("touchend",_(this,oi,as).bind(this),!1),M(this,V).removeEventListener("wheel",_(this,ai,hs).bind(this),{passive:!1})},ti=new WeakSet,is=function(n){n.button===0&&this.enableRotate?(Re(this,ze,!0),M(this,We).set(n.clientX,n.clientY)):n.button===2&&this.enablePan&&(Re(this,je,!0),M(this,ft).set(n.clientX,n.clientY)),n.stopPropagation(),n.preventDefault()},ii=new WeakSet,ss=function(n){n.touches.length===1&&this.enableRotate&&(Re(this,ze,!0),M(this,We).set(n.touches[0].pageX,n.touches[0].pageY))},si=new WeakSet,rs=function(n){M(this,ze)&&this.enableRotate?_(this,li,us).call(this,n.clientX,n.clientY):M(this,je)&&this.enablePan&&_(this,ds,Vr).call(this,n.clientX,n.clientY)},ri=new WeakSet,ns=function(n){M(this,ze)&&this.enableRotate&&_(this,li,us).call(this,n.touches[0].pageX,n.touches[0].pageY)},ni=new WeakSet,os=function(n){Re(this,ze,!1),Re(this,je,!1)},oi=new WeakSet,as=function(n){Re(this,ze,!1),Re(this,je,!1)},ai=new WeakSet,hs=function(n){this.enableZoom&&(_(this,cs,Nr).call(this,n.deltaY),n.preventDefault())},hi=new WeakSet,ls=function(n){n.preventDefault()},Ue=new WeakSet,Ye=function(){const n=M(this,U).radius*Math.sin(Math.max(1e-6,M(this,U).phi));M(this,oe).x=n*Math.sin(M(this,U).theta),M(this,oe).y=M(this,U).radius*Math.cos(M(this,U).phi),M(this,oe).z=n*Math.cos(M(this,U).theta),this.camera.position.copy(this.target).add(M(this,oe))},li=new WeakSet,us=function(n,e){Xe.set(n,e),He.copy(Xe).sub(M(this,We)).multiplyScalar(this.rotateSpeed),M(this,U).theta-=2*Math.PI*He.x/this.camera.size.height,M(this,U).phi-=2*Math.PI*He.y/this.camera.size.height,M(this,U).theta=Math.min(this.maxAzimuthAngle,Math.max(this.minAzimuthAngle,M(this,U).theta)),M(this,U).phi=Math.min(this.maxPolarAngle,Math.max(this.minPolarAngle,M(this,U).phi)),M(this,We).copy(Xe),_(this,Ue,Ye).call(this)},ds=new WeakSet,Vr=function(n,e){Xe.set(n,e),He.copy(Xe).sub(M(this,ft)).multiplyScalar(this.panSpeed),M(this,qe).set(0),Ee.copy(this.camera.position).sub(this.target);let t=Ee.length();t*=Math.tan(this.camera.fov/2*Math.PI/180),Ee.set(this.camera.modelMatrix.elements[0],this.camera.modelMatrix.elements[1],this.camera.modelMatrix.elements[2]),Ee.multiplyScalar(-(2*He.x*t)/this.camera.size.height),M(this,qe).add(Ee),Ee.set(this.camera.modelMatrix.elements[4],this.camera.modelMatrix.elements[5],this.camera.modelMatrix.elements[6]),Ee.multiplyScalar(2*He.y*t/this.camera.size.height),M(this,qe).add(Ee),M(this,ft).copy(Xe),this.target.add(M(this,qe)),M(this,oe).copy(this.camera.position).sub(this.target),M(this,U).radius=M(this,oe).length(),_(this,Ue,Ye).call(this)},cs=new WeakSet,Nr=function(n){M(this,U).radius=Math.min(this.maxZoom,Math.max(this.minZoom+1e-6,M(this,U).radius+n*this.zoomSpeed/100)),_(this,Ue,Ye).call(this)};class oo extends it{constructor({instancesCount:e=1,vertexBuffers:t=[],topology:i,mapBuffersAtCreation:s=!0,widthSegments:r=1,heightSegments:o=1,depthSegments:a=1}={}){super({verticesOrder:"ccw",topology:i,instancesCount:e,vertexBuffers:t,mapBuffersAtCreation:s}),this.type="BoxGeometry",r=Math.floor(r),o=Math.floor(o),a=Math.floor(a);const h=[],l=[],u=[],d=[];let c=0;const p=(m,g,y,v,C,T,b,S,B,w)=>{const R=T/B,E=b/w,z=T/2,F=b/2,G=S/2,J=B+1,Q=w+1;let H=0;const A=new f;for(let j=0;j<Q;j++){const N=j*E-F;for(let Z=0;Z<J;Z++){const te=Z*R-z;A[m]=te*v,A[g]=N*C,A[y]=G,h.push(A.x,A.y,A.z),A[m]=0,A[g]=0,A[y]=S>0?1:-1,u.push(A.x,A.y,A.z),l.push(Z/B),l.push(j/w),H+=1}}for(let j=0;j<w;j++)for(let N=0;N<B;N++){const Z=c+N+J*j,te=c+N+J*(j+1),we=c+(N+1)+J*(j+1),mi=c+(N+1)+J*j;d.push(Z,te,mi),d.push(te,we,mi),c+=H}};p("z","y","x",-1,-1,2,2,2,a,o),p("z","y","x",1,-1,2,2,-2,a,o),p("x","z","y",1,1,2,2,2,r,a),p("x","z","y",1,-1,2,2,-2,r,a),p("x","y","z",1,-1,2,2,2,r,o),p("x","y","z",-1,-1,2,2,-2,r,o),this.setAttribute({name:"position",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(h)}),this.setAttribute({name:"uv",type:"vec2f",bufferFormat:"float32x2",size:2,array:new Float32Array(l)}),this.setAttribute({name:"normal",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(u)}),this.setIndexBuffer({array:this.useUint16IndexArray?new Uint16Array(d):new Uint32Array(d),bufferFormat:this.useUint16IndexArray?"uint16":"uint32"})}}class ao extends it{constructor({topology:e,instancesCount:t=1,vertexBuffers:i=[],mapBuffersAtCreation:s=!0,widthSegments:r=32,heightSegments:o=16,phiStart:a=0,phiLength:h=Math.PI*2,thetaStart:l=0,thetaLength:u=Math.PI}={}){super({verticesOrder:"ccw",topology:e,instancesCount:t,vertexBuffers:i,mapBuffersAtCreation:s}),this.type="SphereGeometry",r=Math.max(3,Math.floor(r)),o=Math.max(2,Math.floor(o));const d=1,c=Math.min(l+u,Math.PI);let p=0;const m=[],g=new f,y=new f,v=[],C=[],T=[],b=[];for(let S=0;S<=o;S++){const B=[],w=S/o;let R=0;S===0&&l===0?R=.5/r:S===o&&c===Math.PI&&(R=-.5/r);for(let E=0;E<=r;E++){const z=E/r;g.x=-d*Math.cos(a+z*h)*Math.sin(l+w*u),g.y=d*Math.cos(l+w*u),g.z=d*Math.sin(a+z*h)*Math.sin(l+w*u),C.push(g.x,g.y,g.z),y.copy(g).normalize(),T.push(y.x,y.y,y.z),b.push(z+R,w),B.push(p++)}m.push(B)}for(let S=0;S<o;S++)for(let B=0;B<r;B++){const w=m[S][B+1],R=m[S][B],E=m[S+1][B],z=m[S+1][B+1];(S!==0||l>0)&&v.push(w,R,z),(S!==o-1||c<Math.PI)&&v.push(R,E,z)}this.setAttribute({name:"position",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(C)}),this.setAttribute({name:"uv",type:"vec2f",bufferFormat:"float32x2",size:2,array:new Float32Array(b)}),this.setAttribute({name:"normal",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(T)}),this.setIndexBuffer({array:this.useUint16IndexArray?new Uint16Array(v):new Uint32Array(v),bufferFormat:this.useUint16IndexArray?"uint16":"uint32"})}}class ho extends Ui{constructor(e,t={}){e=q(e,t.label?t.label+" PingPongPlane":"PingPongPlane");const i=t.targets&&t.targets.length&&t.targets.map(s=>({targetFormat:s.format}));t.outputTarget=new zi(e,{label:t.label?t.label+" render target":"Ping Pong render target",useDepth:!1,...i&&{colorAttachments:i}}),t.transparent=!1,t.depth=!1,t.label=t.label??"PingPongPlane "+e.pingPongPlanes?.length,super(e,t),this.type="PingPongPlane",this.createTexture({label:t.label?`${t.label} render texture`:"PingPongPlane render texture",name:"renderTexture",...t.targets&&t.targets.length&&{format:t.targets[0].format},usage:["copyDst","textureBinding"]})}get renderTexture(){return this.textures.find(e=>e.options.name==="renderTexture")}addToScene(e=!1){e&&this.renderer.pingPongPlanes.push(this),this.autoRender&&this.renderer.scene.addPingPongPlane(this)}removeFromScene(e=!1){this.outputTarget&&this.outputTarget.destroy(),this.autoRender&&this.renderer.scene.removePingPongPlane(this),e&&(this.renderer.pingPongPlanes=this.renderer.pingPongPlanes.filter(t=>t.uuid!==this.uuid))}}var ps=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},P=(n,e,t)=>(ps(n,e,"read from private field"),t?t.call(n):e.get(n)),ae=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},de=(n,e,t,i)=>(ps(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),lo=(n,e,t)=>(ps(n,e,"access private method"),t),fe,Be,Ze,Ke,me,ge,mt,gt,yt,xt,vt,wt,fs,Wr;class uo{constructor(e){ae(this,fs),ae(this,fe,void 0),ae(this,Be,void 0),ae(this,Ze,void 0),ae(this,Ke,void 0),ae(this,me,void 0),ae(this,ge,void 0),ae(this,mt,void 0),ae(this,gt,void 0),ae(this,yt,void 0),ae(this,xt,void 0),ae(this,vt,void 0),ae(this,wt,void 0),this.type="Raycaster",e=Le(e,this.type),this.renderer=e,this.camera=this.renderer.camera,this.pointer=new L(1/0),this.ray={origin:new f,direction:new f},de(this,fe,{origin:this.ray.origin.clone(),direction:this.ray.direction.clone()}),de(this,Be,new f),de(this,Ze,new f),de(this,Ke,new f),de(this,me,new f),de(this,ge,new f),de(this,mt,new L),de(this,gt,new L),de(this,yt,new L),de(this,xt,new f),de(this,vt,new f),de(this,wt,new f)}setFromMouse(e){const{clientX:t,clientY:i}=e.targetTouches&&e.targetTouches.length?e.targetTouches[0]:e;this.setFromNDCCoords((t-this.renderer.boundingRect.left)/this.renderer.boundingRect.width*2-1,-((i-this.renderer.boundingRect.top)/this.renderer.boundingRect.height)*2+1)}setFromNDCCoords(e=0,t=0){this.pointer.set(e,t),this.setRay()}setRay(){this.camera.worldMatrix.getTranslation(this.ray.origin),this.ray.direction.set(this.pointer.x,this.pointer.y,-1).unproject(this.camera).sub(this.ray.origin).normalize()}rayIntersectsTriangle(e){const i=new f,s=new f;i.crossVectors(P(this,fe).direction,P(this,ge));const r=P(this,me).dot(i);if(Math.abs(r)<1e-6)return!1;const o=1/r,a=P(this,fe).origin.clone().sub(P(this,Be)),h=o*a.dot(i);if(h<0||h>1)return!1;s.crossVectors(a,P(this,me));const l=o*P(this,fe).direction.dot(s);if(l<0||h+l>1)return!1;const u=o*P(this,ge).dot(s);return u>1e-6?(e.copy(P(this,fe).origin).add(P(this,fe).direction.clone().multiplyScalar(u)),!0):!1}getBarycentricCoordinates(e){const t=e.clone().sub(P(this,Be)),i=P(this,me).dot(P(this,me)),s=P(this,me).dot(P(this,ge)),r=P(this,ge).dot(P(this,ge)),o=t.dot(P(this,me)),a=t.dot(P(this,ge)),h=i*r-s*s,l=new f(0,(r*o-s*a)/h,(i*a-s*o)/h);return l.x=1-l.y-l.z,l}getTriangleNormal(){return new f().crossVectors(P(this,me),P(this,ge)).normalize()}setAttributeVectorAtIndex(e,t,i,s,r){const o=i?i[e*3+t]:e*3+t;r.x=s.array[o*s.size],r.y=s.array[o*s.size+1],"z"in r&&(r.z=s.array[o*s.size+2])}intersectObject(e,t=!0,i=[]){if(!(e instanceof ye))return $(`${this.type}: object to test intersection again is not of type Object3D`),i;const s=Qr(e);return s&&lo(this,fs,Wr).call(this,s,i),t&&e.children.forEach(r=>{this.intersectObject(r,t,i)}),i.length&&i.sort((r,o)=>this.ray.origin.distance(r.point)-this.ray.origin.distance(o.point)),i}intersectObjects(e,t=!0,i=[]){return e.forEach(s=>{this.intersectObject(s,t,i)}),i.length&&i.sort((s,r)=>this.ray.origin.distance(s.point)-this.ray.origin.distance(r.point)),i}}fe=new WeakMap,Be=new WeakMap,Ze=new WeakMap,Ke=new WeakMap,me=new WeakMap,ge=new WeakMap,mt=new WeakMap,gt=new WeakMap,yt=new WeakMap,xt=new WeakMap,vt=new WeakMap,wt=new WeakMap,fs=new WeakSet,Wr=function(n,e=[]){if(!n.geometry)return e;const t=n.geometry.getAttributeByName("position");if(!t)return $(`Raycaster: can't raycast on a mesh that has no position attribute: ${n.options.label}`),e;if(!t.array)return $(`Raycaster: can't raycast on a mesh that has no position attribute array: ${n.options.label}`),e;if(n.frustumCulling&&n.domFrustum){const{clipSpaceBoundingRect:h}=n.domFrustum;if(n.domFrustum.isIntersecting){if(this.pointer.x>h.left+h.width||this.pointer.x<h.left||this.pointer.y>h.top||this.pointer.y<h.top-h.height)return e}else return e}const i=n.worldMatrix.getInverse();P(this,fe).origin.copy(this.ray.origin).applyMat4(i),P(this,fe).direction.copy(this.ray.direction).transformDirection(i);const s=n.geometry.getAttributeByName("uv"),r=n.geometry.getAttributeByName("normal"),o=n.geometry.indexBuffer?.array,a=o?o.length/3:t.array.length/9;for(let h=0;h<a;h++){if(this.setAttributeVectorAtIndex(h,0,o,t,P(this,Be)),this.setAttributeVectorAtIndex(h,1,o,t,P(this,Ze)),this.setAttributeVectorAtIndex(h,2,o,t,P(this,Ke)),P(this,me).copy(P(this,Ze)).sub(P(this,Be)),P(this,ge).copy(P(this,Ke)).sub(P(this,Be)),n.material.options.rendering.cullMode!=="none"){const c=this.getTriangleNormal().dot(P(this,fe).direction);if(c>0&&n.material.options.rendering.cullMode==="back")continue;if(c<0&&n.material.options.rendering.cullMode==="front")continue}const l=new f;if(this.rayIntersectsTriangle(l)){const d=this.getBarycentricCoordinates(l),c=l.clone().applyMat4(n.worldMatrix),p=this.ray.origin.distance(c),m={object:n,distance:p,localPoint:l,point:c,triangle:[P(this,Be).clone(),P(this,Ze).clone(),P(this,Ke).clone()],triangleIndex:h};s&&s.array&&s.array.length&&(this.setAttributeVectorAtIndex(h,0,o,s,P(this,mt)),this.setAttributeVectorAtIndex(h,1,o,s,P(this,gt)),this.setAttributeVectorAtIndex(h,2,o,s,P(this,yt)),m.uv=P(this,mt).clone().multiplyScalar(d.x).add(P(this,gt).clone().multiplyScalar(d.y)).add(P(this,yt).clone().multiplyScalar(d.z))),r&&r.array&&r.array.length&&(this.setAttributeVectorAtIndex(h,0,o,r,P(this,xt)),this.setAttributeVectorAtIndex(h,1,o,r,P(this,vt)),this.setAttributeVectorAtIndex(h,2,o,r,P(this,wt)),m.normal=P(this,xt).clone().multiplyScalar(d.x).add(P(this,vt).clone().multiplyScalar(d.y)).add(P(this,wt).clone().multiplyScalar(d.z))),e.push(m)}}return e};var jr=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},ms=(n,e,t)=>(jr(n,e,"read from private field"),t?t.call(n):e.get(n)),co=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},po=(n,e,t,i)=>(jr(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),Je;const Y=WebGLRenderingContext,ui=new O,fo=class Pe{constructor({renderer:e,gltf:t}){co(this,Je,void 0),e=Le(e,"GLTFScenesManager"),this.renderer=e,this.gltf=t,po(this,Je,new Map);const i=s=>[s.node,...s.children?.map(r=>[...i(r)]).flat()].flat();this.scenesManager={node:new ye,boundingBox:new xe,samplers:[],materialsTextures:[],scenes:[],meshes:[],meshesDescriptors:[],getScenesNodes:()=>this.scenesManager.scenes.map(s=>i(s)).flat()},this.createSamplers(),this.createMaterialTextures(),this.createScenes()}static getVertexAttributeParamsFromType(e){switch(e){case"VEC2":return{type:"vec2f",bufferFormat:"float32x2",size:2};case"VEC3":return{type:"vec3f",bufferFormat:"float32x3",size:3};case"VEC4":return{type:"vec4f",bufferFormat:"float32x4",size:4};case"SCALAR":default:return{type:"f32",bufferFormat:"float32",size:1}}}static getTypedArrayConstructorFromComponentType(e){switch(e){case Y.BYTE:return Int8Array;case Y.UNSIGNED_BYTE:return Uint8Array;case Y.SHORT:return Int16Array;case Y.UNSIGNED_SHORT:return Uint16Array;case Y.UNSIGNED_INT:return Uint32Array;case Y.FLOAT:default:return Float32Array}}static gpuPrimitiveTopologyForMode(e){switch(e){case Y.TRIANGLES:return"triangle-list";case Y.TRIANGLE_STRIP:return"triangle-strip";case Y.LINES:return"line-list";case Y.LINE_STRIP:return"line-strip";case Y.POINTS:return"point-list"}}static gpuAddressModeForWrap(e){switch(e){case Y.CLAMP_TO_EDGE:return"clamp-to-edge";case Y.MIRRORED_REPEAT:return"mirror-repeat";default:return"repeat"}}createSamplers(){if(this.gltf.samplers)for(const[e,t]of Object.entries(this.gltf.samplers)){const i={label:"glTF sampler "+e,name:"gltfSampler"+e,addressModeU:Pe.gpuAddressModeForWrap(t.wrapS),addressModeV:Pe.gpuAddressModeForWrap(t.wrapT)};switch((!t.magFilter||t.magFilter===Y.LINEAR)&&(i.magFilter="linear"),t.minFilter){case Y.NEAREST:break;case Y.LINEAR:case Y.LINEAR_MIPMAP_NEAREST:i.minFilter="linear";break;case Y.NEAREST_MIPMAP_LINEAR:i.mipmapFilter="linear";break;case Y.LINEAR_MIPMAP_LINEAR:default:i.minFilter="linear",i.mipmapFilter="linear";break}this.scenesManager.samplers.push(new ke(this.renderer,i))}else this.scenesManager.samplers.push(new ke(this.renderer,{label:"Default sampler",name:"defaultSampler",magFilter:"linear",minFilter:"linear",mipmapFilter:"linear"}))}createTexture(e,t,i){const s=(()=>{switch(i){case"baseColorTexture":case"emissiveTexture":return"bgra8unorm-srgb";case"occlusionTexture":return"r8unorm";default:return"bgra8unorm"}})(),r=new re(this.renderer,{label:e.name?e.name+": "+i:i,name:i,format:s,visibility:["fragment"],generateMips:!0,fixedSize:{width:t.width,height:t.height}});return r.uploadSource({source:t}),r}createMaterialTextures(){if(this.scenesManager.materialsTextures=[],this.gltf.materials)for(const[e,t]of Object.entries(this.gltf.materials)){const i={material:e,texturesDescriptors:[]},s=r=>r.texCoord&&r.texCoord!==0?"uv"+r.texCoord:"uv";if(this.scenesManager.materialsTextures[e]=i,t.pbrMetallicRoughness){if(t.pbrMetallicRoughness.baseColorTexture&&t.pbrMetallicRoughness.baseColorTexture.index!==void 0){const r=t.pbrMetallicRoughness.baseColorTexture.index,o=this.gltf.imagesBitmaps[this.gltf.textures[r].source],a=this.createTexture(t,o,"baseColorTexture"),h=this.gltf.textures.find(l=>l.source===r)?.sampler;i.texturesDescriptors.push({texture:a,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.pbrMetallicRoughness.baseColorTexture)})}if(t.pbrMetallicRoughness.metallicRoughnessTexture&&t.pbrMetallicRoughness.metallicRoughnessTexture.index!==void 0){const r=t.pbrMetallicRoughness.metallicRoughnessTexture.index,o=this.gltf.imagesBitmaps[this.gltf.textures[r].source],a=this.createTexture(t,o,"metallicRoughnessTexture"),h=this.gltf.textures.find(l=>l.source===r)?.sampler;i.texturesDescriptors.push({texture:a,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.pbrMetallicRoughness.metallicRoughnessTexture)})}}if(t.normalTexture&&t.normalTexture.index!==void 0){const r=t.normalTexture.index,o=this.gltf.imagesBitmaps[this.gltf.textures[r].source],a=this.createTexture(t,o,"normalTexture"),h=this.gltf.textures.find(l=>l.source===r)?.sampler;i.texturesDescriptors.push({texture:a,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.normalTexture)})}if(t.occlusionTexture&&t.occlusionTexture.index!==void 0){const r=t.occlusionTexture.index,o=this.gltf.imagesBitmaps[this.gltf.textures[r].source],a=this.createTexture(t,o,"occlusionTexture"),h=this.gltf.textures.find(l=>l.source===r)?.sampler;i.texturesDescriptors.push({texture:a,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.occlusionTexture)})}if(t.emissiveTexture&&t.emissiveTexture.index!==void 0){const r=t.emissiveTexture.index,o=this.gltf.imagesBitmaps[this.gltf.textures[r].source],a=this.createTexture(t,o,"emissiveTexture"),h=this.gltf.textures.find(l=>l.source===r)?.sampler;i.texturesDescriptors.push({texture:a,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.emissiveTexture)})}}}createNode(e,t){if(t.camera!==void 0)return;const i={name:t.name,node:new ye,children:[]};e.children.push(i),i.node.parent=e.node,t.matrix?(i.node.modelMatrix.setFromArray(new Float32Array(t.matrix)),i.node.matrices.model.shouldUpdate=!1):(t.translation&&i.node.position.set(t.translation[0],t.translation[1],t.translation[2]),t.scale&&i.node.scale.set(t.scale[0],t.scale[1],t.scale[2]),t.rotation&&i.node.quaternion.setFromArray(new Float32Array(t.rotation)));const s=this.gltf.meshes[t.mesh];t.children&&t.children.forEach(r=>{const o=this.gltf.nodes[r];this.createNode(i,o)}),s&&s.primitives.forEach((r,o)=>{const a={parent:i.node,attributes:[],textures:[],parameters:{label:s.name?s.name+" "+o:"glTF mesh "+o},nodes:[]};let h=ms(this,Je).get(r);h||(h={instances:[],nodes:[],meshDescriptor:a},ms(this,Je).set(r,h)),h.instances.push(t),h.nodes.push(i.node)})}createScenes(){this.scenesManager.node.parent=this.renderer.scene,this.gltf.scenes.forEach(e=>{const t={name:e.name,children:[],node:new ye};t.node.parent=this.scenesManager.node,this.scenesManager.scenes.push(t),e.nodes.forEach(i=>{const s=this.gltf.nodes[i];this.createNode(t,s)})}),this.scenesManager.node.updateMatrixStack();for(const[e,t]of ms(this,Je)){const{instances:i,nodes:s,meshDescriptor:r}=t,o=i.length;r.nodes=s,this.scenesManager.meshesDescriptors.push(r);const a=new xe,h=[];let l=null,u=null,d=0;for(const[C,T]of Object.entries(e.attributes)){const b=this.gltf.accessors[T],S=Pe.getTypedArrayConstructorFromComponentType(b.componentType),B=this.gltf.bufferViews[b.bufferView],w=C==="TEXCOORD_0"?"uv":C.replace("_","").replace("TEXCOORD","uv").toLowerCase(),R=B.byteStride||0,E=b.byteOffset||0;R&&E&&E<R?d=Math.max(E,d):d=0,w==="position"&&(a.min.min(new f(b.min[0],b.min[1],b.min[2])),a.max.max(new f(b.max[0],b.max[1],b.max[2])),u=B);const z=Pe.getVertexAttributeParamsFromType(b.type),F={name:w,...z,array:new S(this.gltf.arrayBuffers[B.buffer],b.byteOffset+B.byteOffset,b.count*z.size)};h.push(F),r.attributes.push({name:F.name,type:F.type})}if(d>0){const C=Object.values(e.attributes).map(T=>this.gltf.accessors[T].bufferView);if(C.every(T=>T===C[0]))l=new Float32Array(this.gltf.arrayBuffers[u.buffer],u.byteOffset,Math.ceil(u.byteLength/4)*4/Float32Array.BYTES_PER_ELEMENT);else{let T=0;const b={},S=Object.values(e.attributes).reduce((B,w)=>{const R=this.gltf.accessors[w],E=Pe.getVertexAttributeParamsFromType(R.type).size;return b[R.bufferView]||(b[R.bufferView]=0),b[R.bufferView]=Math.max(b[R.bufferView],R.byteOffset+E*Float32Array.BYTES_PER_ELEMENT),T+=E*Float32Array.BYTES_PER_ELEMENT,B+R.count*E},0);l=new Float32Array(Math.ceil(S/4)*4),Object.values(e.attributes).forEach(B=>{const w=this.gltf.accessors[B],R=this.gltf.bufferViews[w.bufferView],E=Pe.getVertexAttributeParamsFromType(w.type).size;for(let z=0;z<w.count;z++){const F=w.byteOffset/Float32Array.BYTES_PER_ELEMENT+z*T/Float32Array.BYTES_PER_ELEMENT;l.subarray(F,F+E).set(new Float32Array(this.gltf.arrayBuffers[R.buffer],R.byteOffset+w.byteOffset+z*b[w.bufferView],E))}})}}else{const C=["position","uv","normal"];h.sort((T,b)=>{let S=C.findIndex(w=>w===T.name);S=S===-1?1/0:S;let B=C.findIndex(w=>w===b.name);return B=B===-1?1/0:B,S-B})}const c={instancesCount:o,topology:Pe.gpuPrimitiveTopologyForMode(e.mode),vertexBuffers:[{name:"attributes",stepMode:"vertex",attributes:h,...l&&{array:l}}]},p="indices"in e,m=p?it:Pi;if(r.parameters.geometry=new m(c),r.parameters.geometry.boundingBox=a,p){const C=this.gltf.accessors[e.indices],T=this.gltf.bufferViews[C.bufferView],b=Pe.getTypedArrayConstructorFromComponentType(C.componentType),S=C.byteOffset+T.byteOffset,B=this.gltf.arrayBuffers[T.buffer],w=Math.min((B.byteLength-S)/b.BYTES_PER_ELEMENT,Math.ceil(C.count/4)*4),R=b.name==="Uint8Array"?Uint16Array.from(new b(B,S,w)):new b(B,S,w);r.parameters.geometry.setIndexBuffer({bufferFormat:b.name==="Uint32Array"?"uint32":"uint16",array:R})}const g=this.scenesManager.materialsTextures[e.material];r.parameters.samplers=[],r.parameters.textures=[],g?.texturesDescriptors.forEach(C=>{r.textures.push({texture:C.texture.options.name,sampler:C.sampler.name,texCoordAttributeName:C.texCoordAttributeName}),r.parameters.samplers.find(b=>b.uuid===C.sampler.uuid)||r.parameters.samplers.push(C.sampler),r.parameters.textures.push(C.texture)});const y=this.gltf.materials&&this.gltf.materials[e.material]||{};r.parameters.cullMode=y.doubleSided?"none":"back",(y.alphaMode==="BLEND"||y.extensions&&y.extensions.KHR_materials_transmission)&&(r.parameters.transparent=!0,r.parameters.targets=[{blend:{color:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha"},alpha:{srcFactor:"one",dstFactor:"one"}}}]);const v={baseColorFactor:{type:"vec4f",value:y.pbrMetallicRoughness?.baseColorFactor||[1,1,1,1]},alphaCutoff:{type:"f32",value:y.alphaCutoff!==void 0?y.alphaCutoff:y.alphaMode==="MASK"?.5:0},metallicFactor:{type:"f32",value:y.pbrMetallicRoughness?.metallicFactor===void 0?1:y.pbrMetallicRoughness.metallicFactor},roughnessFactor:{type:"f32",value:y.pbrMetallicRoughness?.roughnessFactor===void 0?1:y.pbrMetallicRoughness.roughnessFactor},normalMapScale:{type:"f32",value:y.normalTexture?.scale===void 0?1:y.normalTexture.scale},occlusionStrength:{type:"f32",value:y.occlusionTexture?.strength===void 0?1:y.occlusionTexture.strength},emissiveFactor:{type:"vec3f",value:y.emissiveFactor!==void 0?y.emissiveFactor:[1,1,1]}};if(Object.keys(v).length&&(r.parameters.uniforms={material:{visibility:["vertex","fragment"],struct:v}}),o>1){const C=new Float32Array(o*16),T=new Float32Array(o*16);for(let b=0;b<o;++b)C.set(s[b].worldMatrix.elements,b*16),ui.copy(s[b].worldMatrix).invert().transpose(),T.set(ui.elements,b*16);r.parameters.storages={instances:{visibility:["vertex","fragment"],struct:{modelMatrix:{type:"array<mat4x4f>",value:C},normalMatrix:{type:"array<mat4x4f>",value:T}}}}}for(let C=0;C<s.length;C++){const b=a.clone().applyMat4(r.nodes[C].worldMatrix);this.scenesManager.boundingBox.min.min(b.min),this.scenesManager.boundingBox.max.max(b.max)}}}addMeshes(e=t=>{}){return this.scenesManager.node.updateMatrixStack(),this.scenesManager.meshesDescriptors.map(t=>{if(t.parameters.geometry){e(t);const i=t.parameters.geometry.instancesCount>1&&t.parameters.castShadows;i&&(t.parameters.castShadows=!1);const s=new vr(this.renderer,{...t.parameters});if(t.nodes.length>1){const r=s.updateWorldMatrix.bind(s);s.updateWorldMatrix=()=>{r(),t.nodes.forEach((o,a)=>{s.storages.instances.modelMatrix.value.set(o.worldMatrix.elements,a*16),ui.copy(o.worldMatrix).invert().transpose(),s.storages.instances.normalMatrix.value.set(ui.elements,a*16)}),s.storages.instances.modelMatrix.shouldUpdate=!0,s.storages.instances.normalMatrix.shouldUpdate=!0}}if(i){const r=s.material.inputsBindings.get("instances");this.renderer.shadowCastingLights.forEach(o=>{o.shadow.isActive&&o.shadow.addShadowCastingMesh(s,{bindings:[r]})})}return s.parent=t.parent,this.scenesManager.meshes.push(s),s}})}destroy(){this.scenesManager.meshes.forEach(t=>t.remove()),this.scenesManager.meshes=[],this.scenesManager.getScenesNodes().forEach(t=>{t.destroy()}),this.scenesManager.node.destroy()}};Je=new WeakMap;let mo=fo;const go=(n,e={})=>{const t=n.textures.find(D=>D.texture==="baseColorTexture"),i=n.textures.find(D=>D.texture==="normalTexture"),s=n.textures.find(D=>D.texture==="emissiveTexture"),r=n.textures.find(D=>D.texture==="occlusionTexture"),o=n.textures.find(D=>D.texture==="metallicRoughnessTexture"),a=n.attributes.filter(D=>D.name!=="position"),h=a.map((D,Ro)=>`@location(${Ro}) ${D.name}: ${D.type},`).join(`
	`);let l=`
  ...
  `,u=a.find(D=>D.name==="normal")?"vsOutput.normal = getWorldNormal(attributes.normal);":"";n.parameters.storages&&n.parameters.storages.instances&&(l=`
      ...
      vsOutput.viewDirection = camera.position - vsOutput.worldPosition;
      `,u="vsOutput.normal = normalize((instances[attributes.instanceIndex].normalMatrix * vec4(attributes.normal, 0.0)).xyz);");const d=a.filter(D=>D.name!=="normal").map(D=>`vsOutput.${D.name} = attributes.${D.name};`).join(`
	`);let c=`
      @builtin(position) position: vec4f,
      @location(${a.length}) viewDirection: vec3f,
      @location(${a.length+1}) worldPosition: vec3f,
      ${h}
  `,p="";const m=a.find(D=>D.name==="tangent"),g=!!(i&&m);g&&(c+=`
  ...
  `,T="var color: vec4f = vec4();",b=`
      return color;
  `,S=n.attributes.find(D=>D.name==="color0");let B=S?S.type==="vec3f"?"var baseColor: vec4f = vec4(fsInput.color0, 1.0) * material.baseColorFactor;":"var baseColor: vec4f = fsInput.color0 * material.baseColorFactor;":"var baseColor: vec4f = material.baseColorFactor;";t&&(B=`
    ...
    `),B+=`
      color = baseColor;
  `;let w=n.attributes.find(D=>D.name==="normal")?`
      let faceDirection = select(-1.0, 1.0, fsInput.frontFacing);
      let geometryNormal: vec3f = normalize(faceDirection * fsInput.normal);
    `:"let geometryNormal: vec3f = normalize(vec3(0.0, 0.0, 1.0));";g?w+=`
  ...
  `;let{shadingModel:F}=e;F||(F="PBR");let{chunks:G}=e||{};const{iblParameters:J}=e||{},{lutTexture:Q,envDiffuseTexture:H,envSpecularTexture:A}=J||{};H&&H.texture&&A&&A.texture&&Q&&Q.texture&&F==="IBL"?(n.parameters.uniforms={...n.parameters.uniforms,ibl:{struct:{diffuseStrength:{type:"f32",value:J?.diffuseStrength??.5},specularStrength:{type:"f32",value:J?.specularStrength??.5}}}},n.parameters.textures=[...n.parameters.textures,Q.texture,H.texture,A.texture],Q.samplerName=Q.samplerName||"defaultSampler",H.samplerName=H.samplerName||"defaultSampler",A.samplerName=A.samplerName||"defaultSampler"):F==="IBL"&&($("IBL shading requested but one of the LUT, environment specular or diffuse texture is missing. Defaulting to PBR shading."),F="PBR");const N={toneMapping:"khronos",receiveShadows:!!n.parameters.receiveShadows,useOcclusion:!0},Z=(()=>{switch(F){case"Lambert":default:return zr(N);case"Phong":return Lr(N);case"PBR":return _r(N);case"IBL":return Or(N)}})(),te="",we="";G?(G.additionalFragmentHead?G.additionalFragmentHead=Z+G.additionalFragmentHead:G.additionalFragmentHead=Z,G.preliminaryColorContribution?G.preliminaryColorContribution=te+G.preliminaryColorContribution:G.preliminaryColorContribution=te,G.additionalColorContribution?G.additionalColorContribution=we+G.additionalColorContribution:G.additionalColorContribution=we):G={additionalFragmentHead:Z,preliminaryColorContribution:te,additionalColorContribution:we};const mi=(()=>{switch(F){case"Lambert":default:return`
      color = vec4(
        getLambert(
          normal,
          worldPosition,
    ...
    @fragment fn main(fsInput: VSOutput) -> @location(0) vec4f {       
      ...
      ${G.preliminaryColorContribution}
  ...
  `;return{vertex:{code:C,entryPoint:"main"},fragment:{code:To,entryPoint:"main"}}},yo=async(n,e,t)=>{if(t.options.viewDimension!=="cube"){$("Could not compute the diffuse texture because the specular texture is not a cube map:"+t.options.viewDimension);return}const i=`    
  ...
  `;let s=new re(n,{label:"Diffuse storage cubemap",name:"diffuseEnvMap",format:"rgba32float",visibility:["compute"],usage:["copySrc","storageBinding"],type:"storage",fixedSize:{width:t.size.width,height:t.size.height,depth:6},viewDimension:"2d-array"});const r=new ke(n,{label:"Compute diffuse sampler",name:"specularSampler",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",minFilter:"linear",magFilter:"linear"});let o=new $s(n,{autoRender:!1,dispatchSize:[Math.ceil(t.size.width/8),Math.ceil(t.size.height/8),6],shaders:{compute:{code:i}},uniforms:{params:{struct:{faceSize:{type:"u32",value:t.size.width},maxMipLevel:{type:"u32",value:t.texture.mipLevelCount},sampleCount:{type:"u32",value:2048}}}},samplers:[r],textures:[t,s]});await o.material.compileMaterial(),n.onBeforeRenderScene.add(a=>{n.renderSingleComputePass(a,o),a.copyTextureToTexture({texture:s.texture},{texture:e.texture},[e.texture.width,e.texture.height,e.texture.depthOrArrayLayers])},{once:!0}),n.onAfterCommandEncoderSubmission.add(()=>{o.destroy(),s.destroy(),s=null,o=null},{once:!0})},qr=WebGLRenderingContext,xo=1179937895,gs={JSON:1313821514,BIN:5130562},vo=[0,0,0],wo=[0,0,0,1],bo=[1,1,1],Mo=typeof window<"u"&&new RegExp(`^${window.location.protocol}`,"i")||RegExp("^(http|https):","i"),Co=/^data:/;class di{constructor(){this.gltf=null}static resolveUri(e,t){return e.match(Mo)||e.match(Co)?e:t+e}async loadFromUrl(e){const t=e.lastIndexOf("/"),i=t!==0?e.substring(0,t+1):"",s=await fetch(e);if(e.endsWith(".gltf"))return this.loadFromJson(await s.json(),i);if(e.endsWith(".glb"))return this.loadFromBinary(await s.arrayBuffer(),i);throw new Error("Unrecognized file extension")}async loadFromJsonBase(e,t,i=null){if(!t)throw new Error("baseUrl must be specified.");if(!e.asset)throw new Error("Missing asset description.");if(e.asset.minVersion!=="2.0"&&e.asset.version!=="2.0")throw new Error("Incompatible asset version.");for(const o of e.accessors)o.byteOffset=o.byteOffset??0,o.normalized=o.normalized??!1;for(const o of e.bufferViews)o.byteOffset=o.byteOffset??0;for(const o of e.nodes)o.matrix||(o.rotation=o.rotation??wo,o.scale=o.scale??bo,o.translation=o.translation??vo);if(e.samplers)for(const o of e.samplers)o.wrapS=o.wrapS??qr.REPEAT,o.wrapT=o.wrapT??qr.REPEAT;const s=[];if(i)s.push(Promise.resolve(i));else for(const o in e.buffers){const a=e.buffers[o],h=di.resolveUri(a.uri,t);s[o]=fetch(h).then(l=>l.arrayBuffer())}const r=[];for(let o=0;o<e.images?.length;++o){const a=e.images[o];if(a.uri)r[o]=fetch(di.resolveUri(a.uri,t)).then(async h=>createImageBitmap(await h.blob()));else{const h=e.bufferViews[a.bufferView];r[o]=s[h.buffer].then(l=>{const u=new Blob([new Uint8Array(l,h.byteOffset,h.byteLength)],{type:a.mimeType});return createImageBitmap(u)})}}return{...e,arrayBuffers:await Promise.all(s),imagesBitmaps:await Promise.all(r)}}async loadFromBinary(e,t){const i=new DataView(e,0,12),s=i.getUint32(0,!0),r=i.getUint32(4,!0),o=i.getUint32(8,!0);if(s!==xo)throw new Error("Invalid magic string in binary header.");if(r!==2)throw new Error("Incompatible version in binary header.");const a={};let h=12;for(;h<o;){const d=new DataView(e,h,8),c=d.getUint32(0,!0),p=d.getUint32(4,!0);a[p]=e.slice(h+8,h+8+c),h+=c+8}if(!a[gs.JSON])throw new Error("File contained no json chunk.");const u=new TextDecoder("utf-8").decode(a[gs.JSON]);return this.loadFromJson(JSON.parse(u),t,a[gs.BIN])}async loadFromJson(e,t,i=null){return this.gltf=await this.loadFromJsonBase(e,t,i),this.gltf}}var Bo=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},Se=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},he=(n,e,t)=>(Bo(n,e,"access private method"),t),ys,Yr,xs,Xr,ci,vs,bt,pi,ws,Hr,bs,Zr,fi,Ms,Cs,Kr,Bs,Jr;class So{constructor(){Se(this,ys),Se(this,xs),Se(this,ci),Se(this,bt),Se(this,ws),Se(this,bs),Se(this,fi),Se(this,Cs),Se(this,Bs)}async loadFromUrl(e){const t=await(await fetch(e)).arrayBuffer();return he(this,ys,Yr).call(this,new DataView(t))}equirectangularToCubeMap(e){const t=Math.max(e.width/4,e.height/2),i={posX:new Float32Array(t*t*4),negX:new Float32Array(t*t*4),posY:new Float32Array(t*t*4),negY:new Float32Array(t*t*4),posZ:new Float32Array(t*t*4),negZ:new Float32Array(t*t*4)};function s(l,u){const d=Math.floor(l*e.width),p=(Math.floor(u*e.height)*e.width+d)*4;return[e.data[p],e.data[p+1],e.data[p+2],e.data[p+3]]}function r(l,u,d,c){const p=(d*t+u)*4;i[l][p]=c[0],i[l][p+1]=c[1],i[l][p+2]=c[2],i[l][p+3]=c[3]}function o(l,u,d){const c=2*(u+.5)/t-1,p=2*(d+.5)/t-1;switch(l){case"posX":return[c,-1,-p];case"negX":return[-c,1,-p];case"posY":return[-p,-c,1];case"negY":return[p,-c,-1];case"posZ":return[-1,-c,-p];case"negZ":return[1,c,-p]}}function a(l){const[u,d,c]=l,p=Math.sqrt(u*u+d*d),m=Math.atan2(d,u),g=Math.atan2(c,p),y=(m+Math.PI)/(2*Math.PI),v=(g+Math.PI/2)/Math.PI;return[y,v]}for(const l in i)for(let u=0;u<t;u++)for(let d=0;d<t;d++){const c=o(l,d,u),[p,m]=a(c),g=s(p,m);r(l,d,u,g)}return[i.posX,i.negX,i.posY,i.negY,i.posZ,i.negZ].map(l=>({data:l,width:t,height:t,exposure:e.exposure,gamma:e.gamma}))}}ys=new WeakSet,Yr=function(n){const e={data:n,offset:0},t=he(this,xs,Xr).call(this,e);return{width:t.width,height:t.height,exposure:t.exposure,gamma:t.gamma,data:he(this,ws,Hr).call(this,e,t)}},xs=new WeakSet,Xr=function(n){let e=he(this,bt,pi).call(this,n);const t={colorCorr:[1,1,1],exposure:1,gamma:1,width:0,height:0,flipX:!1,flipY:!1};if(e!=="#?RADIANCE"&&e!=="#?RGBE")throw new Error("Incorrect file format!");for(;e!=="";){e=he(this,bt,pi).call(this,n);const s=e.split("=");switch(s[0]){case"GAMMA":t.gamma=parseFloat(s[1]);break;case"FORMAT":if(s[1]!=="32-bit_rle_rgbe"&&s[1]!=="32-bit_rle_xyze")throw new Error("Incorrect encoding format!");break;case"EXPOSURE":t.exposure=parseFloat(s[1]);break;case"COLORCORR":t.colorCorr=s[1].replace(/^\s+|\s+$/g,"").split(" ").map(r=>parseFloat(r));break}}e=he(this,bt,pi).call(this,n);const i=e.split(" ");return he(this,ci,vs).call(this,i[0],parseInt(i[1]),t),he(this,ci,vs).call(this,i[2],parseInt(i[3]),t),t},ci=new WeakSet,vs=function(n,e,t){switch(n){case"+X":t.width=e;break;case"-X":t.width=e,t.flipX=!0,console.warn("Flipping horizontal orientation not currently supported");break;case"-Y":t.height=e,t.flipY=!0;break;case"+Y":t.height=e;break}},bt=new WeakSet,pi=function(n){let e,t="";for(;(e=n.data.getUint8(n.offset++))!==10;)t+=String.fromCharCode(e);return t},ws=new WeakSet,Hr=function(n,e){const t=n.data.getUint16(n.offset);let i;if(t===514)i=he(this,bs,Zr).call(this,n,e),e.flipX&&he(this,Cs,Kr).call(this,i,e),e.flipY&&he(this,Bs,Jr).call(this,i,e);else throw new Error("Obsolete HDR file version!");return i},bs=new WeakSet,Zr=function(n,e){const{width:t,height:i,colorCorr:s}=e,r=new Float32Array(t*i*4);let o=0,{offset:a,data:h}=n;for(let l=0;l<i;++l){if(h.getUint16(a)!==514)throw new Error("Incorrect scanline start hash");if(h.getUint16(a+2)!==t)throw new Error("Scanline doesn't match picture dimension!");a+=4;const u=t*4,d=[];let c=0;for(;c<u;){let p=h.getUint8(a++);if(p>128){const m=p-128;p=h.getUint8(a++);for(let g=0;g<m;++g)d[c++]=p}else for(let m=0;m<p;++m)d[c++]=h.getUint8(a++)}for(c=0;c<t;++c){const p=d[c],m=d[c+t],g=d[c+t*2];let y=d[c+t*3];y=y?Math.pow(2,y-136):0,r[o++]=p*y*s[0],r[o++]=m*y*s[1],r[o++]=g*y*s[2],r[o++]=y}}return r},fi=new WeakSet,Ms=function(n,e,t){e*=4,t*=4;for(let i=0;i<4;++i){const s=n[e+i];n[e+i]=n[t+i],n[t+i]=s}},Cs=new WeakSet,Kr=function(n,e){const{width:t,height:i}=e,s=t>>1;for(let r=0;r<i;++r){const o=r*t;for(let a=0;a<s;++a){const h=o+a,l=o+t-1-a;he(this,fi,Ms).call(this,n,h,l)}}},Bs=new WeakSet,Jr=function(n,e){const{width:t,height:i}=e,s=i>>1;for(let r=0;r<s;++r){const o=r*t,a=(i-1-r)*t;for(let h=0;h<t;++h)he(this,fi,Ms).call(this,n,o+h,a+h)}};const Po=n=>{const{scene:e}=n;if(!e)return;const t=[];e.computePassEntries.forEach(i=>{t.push({command:"Render ComputePass",content:i.options.label}),i.material.bindGroups.forEach(s=>{s.bufferBindings.forEach(r=>{r.shouldCopyResult&&t.push({command:"Copy buffer to buffer",source:`${r.name} buffer`,destination:`${r.name} result buffer`})})})});for(const i in e.renderPassEntries){let s=0;e.renderPassEntries[i].forEach(r=>{if(!e.getRenderPassEntryLength(r))return;const o=r.renderPass.options.useColorAttachments?r.renderPass.options.colorAttachments.length===0&&r.renderPass.options.useDepth?`${r.renderTexture.options.label} depth pass`:r.renderPass.options.colorAttachments.length>1?`${r.renderTexture.options.label} multiple targets`:r.renderTexture?`${r.renderTexture.options.label}`:"Context current texture":void 0;let a=r.renderPass.options.label;const h={loadOp:r.renderPass.options.useColorAttachments?i==="screen"&&s>0?"load":r.renderPass.options.loadOp:void 0,depthLoadOp:void 0,sampleCount:r.renderPass.options.sampleCount,...r.renderPass.options.qualityRatio!==1&&{qualityRatio:r.renderPass.options.qualityRatio}};if(r.renderPass.options.useDepth&&(h.depthLoadOp=r.renderPass.options.depthLoadOp),s++,r.element)r.element.type==="ShaderPass"&&!(r.element.inputTarget||r.element.outputTarget)&&(t.push({command:"Copy texture to texture",source:o,destination:`${r.element.options.label} renderTexture`}),h.loadOp="clear"),a+=" "+JSON.stringify(h),t.push({command:`Render ${r.element.type}`,source:r.element.options.label,destination:o,descriptor:a}),r.element.type==="ShaderPass"&&!r.element.outputTarget&&r.element.options.copyOutputToRenderTexture?t.push({command:"Copy texture to texture",source:o,destination:`${r.element.options.label} renderTexture`}):r.element.type==="PingPongPlane"&&t.push({command:"Copy texture to texture",source:o,destination:`${r.element.renderTexture.options.label}`});else if(r.stack){a+=" "+JSON.stringify(h);for(const l in r.stack)for(const u in r.stack[l])r.stack[l][u].length&&t.push({command:`Render stack (${l} ${u} objects)`,source:r.stack[l][u],destination:o,descriptor:a})}})}console.table(t)};x.AmbientLight=bn,x.BindGroup=St,x.Binding=Ct,x.Box3=xe,x.BoxGeometry=oo,x.Buffer=$e,x.BufferBinding=be,x.Camera=As,x.ComputeMaterial=Ds,x.ComputePass=$s,x.ComputePipelineEntry=br,x.DOMElement=Ni,x.DOMFrustum=Is,x.DOMMesh=Ur,x.DOMObject3D=Dr,x.DOMTexture=Oe,x.DirectionalLight=Pn,x.FullscreenPlane=Ui,x.GLTFLoader=di,x.GLTFScenesManager=mo,x.GPUCameraRenderer=Xi,x.GPUCurtains=ro,x.GPUCurtainsRenderer=Qt,x.GPUDeviceManager=Tr,x.GPURenderer=qi,x.Geometry=Pi,x.HDRLoader=So,x.IndexedGeometry=it,x.Mat3=Me,x.Mat4=O,x.Material=Si,x.Mesh=vr,x.Object3D=ye,x.OrbitControls=no,x.PingPongPlane=ho,x.PipelineEntry=ki,x.PipelineManager=Mr,x.Plane=$r,x.PlaneGeometry=Ti,x.PointLight=Ln,x.ProjectedObject3D=$i,x.Quat=ce,x.Raycaster=uo,x.RenderMaterial=Ai,x.RenderPass=$t,x.RenderPipelineEntry=Ii,x.RenderTarget=zi,x.Sampler=ke,x.SamplerBinding=Ls,x.Scene=Cr,x.ShaderPass=Hn,x.SphereGeometry=ao,x.Texture=re,x.TextureBindGroup=Bi,x.TextureBinding=Ci,x.Vec2=L,x.Vec3=f,x.WritableBufferBinding=Mi,x.applyDirectionalShadows=nt,x.applyPointShadows=ot,x.buildShaders=go,x.computeDiffuseFromSpecular=yo,x.getDefaultPointShadowDepthFs=Qs,x.getDefaultPointShadowDepthVs=Js,x.getDefaultShadowDepthVs=Hs,x.getIBL=Or,x.getIBLIndirect=Ar,x.getLambert=zr,x.getLambertDirect=Rr,x.getPBR=_r,x.getPBRDirect=Zi,x.getPCFDirectionalShadows=Ks,x.getPCFPointShadowContribution=er,x.getPCFPointShadows=tr,x.getPCFShadowContribution=Zs,x.getPCFShadows=rt,x.getPhong=Lr,x.getPhongDirect=Er,x.lambertUtils=Kt,x.logSceneCommands=Po,x.pbrUtils=Hi,x.toneMappingUtils=ct});
