(function(y,Y){typeof exports=="object"&&typeof module<"u"?Y(exports):typeof define=="function"&&define.amd?define(["exports"],Y):(y=typeof globalThis<"u"?globalThis:y||self,Y(y.window=y.window||{}))})(this,function(y){"use strict";const Y=()=>"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,n=>{const e=Math.random()*16|0;return(n==="x"?e:e&3|8).toString(16).toUpperCase()}),We=n=>n.replace(/(?:^\w|[A-Z]|\b\w)/g,(e,t)=>t===0?e.toLowerCase():e.toUpperCase()).replace(/\s+/g,""),je=n=>{const e=We(n);return e.charAt(0).toUpperCase()+e.slice(1)};let ti=0;const k=n=>{ti>100||(console.warn(ti===100?"GPUCurtains: too many warnings thrown, stop logging.":n),ti++)},ee=n=>{throw new Error(n)},ii=(n,e="GPURenderer",t)=>{const i=t?`Unable to create ${t} because the ${e} is not defined: ${n}`:`The ${e} is not defined: ${n}`;ee(i)},j=(n,e)=>(n=n&&n.renderer||n,n&&(n.type==="GPURenderer"||n.type==="GPUCameraRenderer"||n.type==="GPUCurtainsRenderer")||ii(n,"GPURenderer",e),n),Le=(n,e)=>(n=n&&n.renderer||n,n&&(n.type==="GPUCameraRenderer"||n.type==="GPUCurtainsRenderer")||ii(n,"GPUCameraRenderer",e),n),si=(n,e)=>(n=n&&n.renderer||n,n&&n.type==="GPUCurtainsRenderer"||ii(n,"GPUCurtainsRenderer",e),n),ri=(()=>{let n,e;const t={};return function(s,r){e||(e=s.createShaderModule({label:"textured quad shaders for mip level generation",code:`
            struct VSOutput {
...
`,Os=n=>{const e=n.shadowCastingLights.filter(t=>t.type==="directionalLights");return`
...
fn getPCFPointShadowContribution(index: i32, shadowPosition: vec4f, depthCubeTexture: texture_depth_cube) -> f32 {
  ...
  return visibility;
}`,$s=n=>{const e=n.shadowCastingLights.filter(t=>t.type==="pointLights");return`
...
`;const Te={vertex:{get_uv_cover:hr},fragment:{get_uv_cover:hr,get_vertex_to_uv_coords:Cn}},Re={vertex:{get_output_position:bn,get_normals:Mn},fragment:{}};class Si extends Pi{constructor(e){let{renderer:t,...i}=e;const{label:s,attributes:r,bindGroups:o,cacheKey:a,...h}=i,l="RenderPipelineEntry";j(t,s?s+" "+l:l),super(e),this.type=l,this.shaders={vertex:{head:"",code:"",module:null},fragment:{head:"",code:"",module:null},full:{head:"",code:"",module:null}},this.descriptor=null,this.options={...this.options,attributes:r,bindGroups:o,cacheKey:a,...h},this.setPipelineEntryProperties({attributes:r,bindGroups:o})}setPipelineEntryProperties(e){const{attributes:t,bindGroups:i}=e;this.attributes=t,this.setPipelineEntryBindGroups(i)}patchShaders(){this.shaders.vertex.head="",this.shaders.vertex.code="",this.shaders.fragment.head="",this.shaders.fragment.code="",this.shaders.full.head="",this.shaders.full.code="";for(const t in Te.vertex)this.shaders.vertex.head=`${Te.vertex[t]}
${this.shaders.vertex.head}`,this.shaders.full.head=`${Te.vertex[t]}
${this.shaders.full.head}`;if(this.options.shaders.fragment)for(const t in Te.fragment)this.shaders.fragment.head=`${Te.fragment[t]}
${this.shaders.fragment.head}`,this.shaders.full.head.indexOf(Te.fragment[t])===-1&&(this.shaders.full.head=`${Te.fragment[t]}
${this.shaders.full.head}`);if(this.options.rendering.useProjection){for(const t in Re.vertex)this.shaders.vertex.head=`${Re.vertex[t]}
...
`,vr=({addUtils:n=!0,receiveShadows:e=!1,toneMapping:t="linear",useOcclusion:i=!1}={})=>`
${n?Dt:""}
${yr}
${t?st:""}
...
`,wr=({addUtils:n=!0,receiveShadows:e=!1,toneMapping:t="linear",useOcclusion:i=!1}={})=>`
${n?Gi:""}
${Oi}
${t?st:""}
...
`;var Cr=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},ge=(n,e,t)=>(Cr(n,e,"read from private field"),t?t.call(n):e.get(n)),Di=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},$n=(n,e,t,i)=>(Cr(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),rt,ze,Ft;class Br extends Bi{constructor(e,t,i={}){super(e),Di(this,rt,new f),Di(this,ze,new f(1)),Di(this,Ft,1),this.boundingBox=new de(new f(-1),new f(1)),this._onAfterDOMElementResizeCallback=()=>{},e=si(e,"DOM3DObject"),this.renderer=e,this.size={shouldUpdate:!0,normalizedWorld:{size:new E(1),position:new E},cameraWorld:{size:new E(1)},scaledWorld:{size:new f(1),position:new f}},this.watchScroll=i.watchScroll,this.camera=this.renderer.camera,this.boundingBox.min.onChange(()=>this.shouldUpdateComputedSizes()),this.boundingBox.max.onChange(()=>this.shouldUpdateComputedSizes()),this.setDOMElement(t),this.renderer.domObjects.push(this)}setDOMElement(e){this.domElement=new Ri({element:e,onSizeChanged:t=>this.resize(t),onPositionChanged:()=>this.onPositionChanged()}),this.updateSizeAndPosition()}onPositionChanged(){this.watchScroll&&this.shouldUpdateComputedSizes()}resetDOMElement(e){this.domElement&&this.domElement.destroy(),this.setDOMElement(e)}resize(e=null){!e&&(!this.domElement||this.domElement?.isResizing)||(this.updateSizeAndPosition(),this._onAfterDOMElementResizeCallback&&this._onAfterDOMElementResizeCallback())}get boundingRect(){return this.domElement?.boundingRect??{width:1,height:1,top:0,right:0,bottom:0,left:0,x:0,y:0}}setTransforms(){super.setTransforms(),this.transforms.origin.model.set(.5,.5,0),this.transforms.origin.world=new f,this.transforms.position.document=new f,this.documentPosition.onChange(()=>this.applyPosition()),this.transformOrigin.onChange(()=>this.setWorldTransformOrigin())}get documentPosition(){return this.transforms.position.document}set documentPosition(e){this.transforms.position.document=e,this.applyPosition()}get DOMObjectWorldScale(){return ge(this,ze).clone()}get worldScale(){return this.DOMObjectWorldScale.multiply(this.scale)}get worldPosition(){return ge(this,rt).clone()}get transformOrigin(){return this.transforms.origin.model}set transformOrigin(e){this.transforms.origin.model=e,this.setWorldTransformOrigin()}get worldTransformOrigin(){return this.transforms.origin.world}set worldTransformOrigin(e){this.transforms.origin.world=e}shouldUpdateMatrices(){super.shouldUpdateMatrices(),(this.matricesNeedUpdate||this.size.shouldUpdate)&&this.updateSizeAndPosition(),this.size.shouldUpdate=!1}shouldUpdateComputedSizes(){this.size.shouldUpdate=!0}updateSizeAndPosition(){this.setWorldSizes(),this.applyDocumentPosition()}applyDocumentPosition(){let e=new f(0,0,0);this.documentPosition.equals(e)||(e=this.documentToWorldSpace(this.documentPosition)),ge(this,rt).set(this.position.x+this.size.scaledWorld.position.x+e.x,this.position.y+this.size.scaledWorld.position.y+e.y,this.position.z+this.size.scaledWorld.position.z+this.documentPosition.z/this.camera.CSSPerspective)}applyTransformOrigin(){this.size&&(this.setWorldTransformOrigin(),super.applyTransformOrigin())}updateModelMatrix(){this.modelMatrix.composeFromOrigin(ge(this,rt),this.quaternion,this.scale,this.worldTransformOrigin),this.modelMatrix.scale(this.DOMObjectWorldScale),this.shouldUpdateWorldMatrix()}documentToWorldSpace(e=new f){return new f(e.x*this.renderer.pixelRatio/this.renderer.boundingRect.width*this.camera.visibleSize.width,-(e.y*this.renderer.pixelRatio/this.renderer.boundingRect.height)*this.camera.visibleSize.height,e.z)}computeWorldSizes(){const e=this.renderer.boundingRect,t={x:this.boundingRect.width/2+this.boundingRect.left,y:this.boundingRect.height/2+this.boundingRect.top},i={x:e.width/2+e.left,y:e.height/2+e.top},{size:s,center:r}=this.boundingBox;s.x!==0&&s.y!==0&&s.z!==0&&r.divide(s),this.size.normalizedWorld.size.set(this.boundingRect.width/e.width,this.boundingRect.height/e.height),this.size.normalizedWorld.position.set((t.x-i.x)/e.width,(i.y-t.y)/e.height),this.size.cameraWorld.size.set(this.size.normalizedWorld.size.x*this.camera.visibleSize.width,this.size.normalizedWorld.size.y*this.camera.visibleSize.height),this.size.scaledWorld.size.set(this.size.cameraWorld.size.x/s.x,this.size.cameraWorld.size.y/s.y,1),this.size.scaledWorld.size.z=this.size.scaledWorld.size.y*(s.x/s.y/(this.boundingRect.width/this.boundingRect.height)),this.size.scaledWorld.position.set(this.size.normalizedWorld.position.x*this.camera.visibleSize.width,this.size.normalizedWorld.position.y*this.camera.visibleSize.height,0)}setWorldSizes(){this.computeWorldSizes(),this.setWorldScale(),this.setWorldTransformOrigin()}setWorldScale(){ge(this,ze).set(this.size.scaledWorld.size.x,this.size.scaledWorld.size.y,this.size.scaledWorld.size.z*ge(this,Ft)),this.shouldUpdateMatrixStack()}set DOMObjectDepthScaleRatio(e){$n(this,Ft,e),this.setWorldScale()}setWorldTransformOrigin(){this.transforms.origin.world=new f((this.transformOrigin.x*2-1)*ge(this,ze).x,-(this.transformOrigin.y*2-1)*ge(this,ze).y,this.transformOrigin.z*ge(this,ze).z),this.shouldUpdateMatrixStack()}updateScrollPosition(e={x:0,y:0}){(e.x||e.y)&&this.domElement.updateScrollPosition(e)}onAfterDOMElementResize(e){return e&&(this._onAfterDOMElementResizeCallback=e),this}destroy(){super.destroy(),this.domElement?.destroy()}}rt=new WeakMap,ze=new WeakMap,Ft=new WeakMap;const Pr={autoloadSources:!0,watchScroll:!0};class Sr extends or(Br){constructor(e,t,i){super(e,t,{...Pr,...i}),this._onLoadingCallback=r=>{},i={...Pr,...i},si(e,i.label?i.label+" DOMMesh":"DOMMesh"),this.type="DOMMesh";const{autoloadSources:s}=i;this.autoloadSources=s,this.sourcesReady=!1,this.setInitSources()}get ready(){return this._ready}set ready(e){e&&!this._ready&&this.sourcesReady&&this._onReadyCallback&&this._onReadyCallback(),this._ready=e}get sourcesReady(){return this._sourcesReady}set sourcesReady(e){e&&!this._sourcesReady&&this.ready&&this._onReadyCallback&&this._onReadyCallback(),this._sourcesReady=e}addToScene(e=!1){super.addToScene(e),e&&this.renderer.domMeshes.push(this)}removeFromScene(e=!1){super.removeFromScene(e),e&&(this.renderer.domMeshes=this.renderer.domMeshes.filter(t=>t.uuid!==this.uuid))}setInitSources(){let e=0,t=0;if(this.autoloadSources){const i=this.domElement.element.querySelectorAll("img"),s=this.domElement.element.querySelectorAll("video"),r=this.domElement.element.querySelectorAll("canvas");e=i.length+s.length+r.length;const o=a=>{t++,this._onLoadingCallback&&this._onLoadingCallback(a),t===e&&(this.sourcesReady=!0)};e||(this.sourcesReady=!0),i.length&&i.forEach(a=>{const h=this.createDOMTexture({name:a.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>o(h)).loadImage(a.src)}),s.length&&s.forEach(a=>{const h=this.createDOMTexture({name:a.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>o(h)).loadVideo(a)}),r.length&&r.forEach(a=>{const h=this.createDOMTexture({name:a.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>o(h)).loadCanvas(a)})}else this.sourcesReady=!0}resetDOMElement(e){e?super.resetDOMElement(e):!e&&!this.renderer.production&&k(`${this.options.label}: You are trying to reset a ${this.type} with a HTML element that does not exist. The old HTML element will be kept instead.`)}get pixelRatioBoundingRect(){const e=window.devicePixelRatio??1,t=this.renderer.pixelRatio/e;return Object.keys(this.domElement.boundingRect).reduce((i,s)=>({...i,[s]:this.domElement.boundingRect[s]*t}),{x:0,y:0,width:0,height:0,top:0,right:0,bottom:0,left:0})}computeGeometry(){super.computeGeometry(),this.boundingBox.copy(this.geometry.boundingBox)}onLoading(e){return e&&(this._onLoadingCallback=e),this}}const kn={label:"Plane",instancesCount:1,vertexBuffers:[]};class Tr extends Sr{constructor(e,t,i={}){e=si(e,i.label?i.label+" Plane":"Plane");const s={...kn,...i};let{geometry:r,widthSegments:o,heightSegments:a,...h}=s;const{instancesCount:l,vertexBuffers:u,...d}=h;if(!r||r.type!=="PlaneGeometry"){o=o??1,a=a??1;const c=o*a+o;u.length||(r=At.getPlaneGeometryByID(c)),r?r.instancesCount=l:(r=new ci({widthSegments:o,heightSegments:a,instancesCount:l,vertexBuffers:u}),At.addPlaneGeometry(r))}super(e,t,{geometry:r,...d}),this.type="Plane"}mouseToPlaneCoords(e=new E){const t={x:2*(e.x/this.renderer.boundingRect.width)-1,y:2*(1-e.y/this.renderer.boundingRect.height)-1},i=this.camera.position.clone(),s=new f(t.x,t.y,-.5);s.unproject(this.camera),s.sub(i).normalize();const r=new f(0,0,1);r.applyQuat(this.quaternion).normalize();const o=new f(0,0,0),a=r.dot(s);if(Math.abs(a)>=1e-4){const h=this.worldMatrix.getInverse().premultiply(this.camera.viewMatrix),l=this.worldTransformOrigin.clone().add(this.worldPosition),u=new f(this.worldPosition.x-l.x,this.worldPosition.y-l.y,this.worldPosition.z-l.z);u.applyQuat(this.quaternion),l.add(u);const d=r.dot(l.clone().sub(i))/a;o.copy(i.add(s.multiplyScalar(d))),o.applyMat4(h)}else o.set(1/0,1/0,1/0);return new E(o.x,o.y)}}class Ut extends Ai{constructor({deviceManager:e,label:t,container:i,pixelRatio:s=1,autoResize:r=!0,preferredFormat:o,alphaMode:a="premultiplied",renderPass:h,camera:l,lights:u}){super({deviceManager:e,label:t,container:i,pixelRatio:s,autoResize:r,preferredFormat:o,alphaMode:a,renderPass:h,camera:l,lights:u}),this.type="GPUCurtainsRenderer"}setRendererObjects(){super.setRendererObjects(),this.domMeshes=[],this.domObjects=[]}onCameraMatricesChanged(){super.onCameraMatricesChanged(),this.domObjects.forEach(e=>{e.updateSizeAndPosition()})}resizeMeshes(){this.meshes.forEach(e=>{"domElement"in e||e.resize(this.boundingRect)}),this.domObjects.forEach(e=>{e.domElement.isResizing||e.domElement.setSize()})}}class In{constructor({scroll:e={x:0,y:0},delta:t={x:0,y:0},shouldWatch:i=!0,onScroll:s=(r={x:0,y:0})=>{}}={}){this.scroll=e,this.delta=t,this.shouldWatch=i,this.onScroll=s,this.shouldWatch&&window.addEventListener("scroll",this.setScroll.bind(this),{passive:!0})}setScroll(){this.updateScrollValues({x:window.pageXOffset,y:window.pageYOffset})}updateScrollValues({x:e,y:t}){const i=this.scroll;this.scroll={x:e,y:t},this.delta={x:i.x-this.scroll.x,y:i.y-this.scroll.y},this.onScroll&&this.onScroll(this.delta)}destroy(){this.shouldWatch&&window.removeEventListener("scroll",this.setScroll.bind(this),{passive:!0})}}class Vn{constructor({container:e,label:t,pixelRatio:i=window.devicePixelRatio??1,preferredFormat:s,alphaMode:r="premultiplied",production:o=!1,adapterOptions:a={},renderPass:h,camera:l,lights:u,autoRender:d=!0,autoResize:c=!0,watchScroll:p=!0}={}){this._onRenderCallback=()=>{},this._onScrollCallback=()=>{},this._onErrorCallback=()=>{},this._onContextLostCallback=()=>{},this.type="CurtainsGPU",this.options={container:e,label:t,pixelRatio:i,camera:l,lights:u,production:o,adapterOptions:a,preferredFormat:s,alphaMode:r,renderPass:h,autoRender:d,autoResize:c,watchScroll:p},this.setDeviceManager(),e&&this.setContainer(e),this.initEvents(),this.options.autoRender&&this.animate()}setContainer(e){if(e)if(typeof e=="string")if(e=document.querySelector(e),e)this.options.container=e;else{const t=document.createElement("div");t.setAttribute("id","curtains-gpu-canvas"),document.body.appendChild(t),this.options.container=t}else e instanceof Element&&(this.options.container=e);else{const t=document.createElement("div");t.setAttribute("id","curtains-gpu-canvas"),document.body.appendChild(t),this.options.container=t}this.container=this.options.container,this.setMainRenderer()}setMainRenderer(){this.createCurtainsRenderer({deviceManager:this.deviceManager,label:this.options.label,container:this.options.container,pixelRatio:this.options.pixelRatio,autoResize:this.options.autoResize,preferredFormat:this.options.preferredFormat,alphaMode:this.options.alphaMode,renderPass:this.options.renderPass,camera:this.options.camera,lights:this.options.lights})}patchRendererOptions(e){return e.pixelRatio===void 0&&(e.pixelRatio=this.options.pixelRatio),e.autoResize===void 0&&(e.autoResize=this.options.autoResize),e}createRenderer(e){return e=this.patchRendererOptions(e),new Li({...e,deviceManager:this.deviceManager})}createCameraRenderer(e){return e=this.patchRendererOptions(e),new Ai({...e,deviceManager:this.deviceManager})}createCurtainsRenderer(e){return e=this.patchRendererOptions(e),new Ut({...e,deviceManager:this.deviceManager})}setDeviceManager(){this.deviceManager=new mr({label:"GPUCurtains default device",production:this.options.production,adapterOptions:this.options.adapterOptions,onError:()=>setTimeout(()=>{this._onErrorCallback&&this._onErrorCallback()},0),onDeviceLost:e=>this._onContextLostCallback&&this._onContextLostCallback(e)})}get renderers(){return this.deviceManager.renderers}get renderer(){return this.renderers[0]}async setDevice({adapter:e=null,device:t=null}={}){await this.deviceManager.init({adapter:e,device:t})}async restoreContext(){await this.deviceManager.restoreDevice()}get pingPongPlanes(){return this.renderers?.map(e=>e.pingPongPlanes).flat()}get shaderPasses(){return this.renderers?.map(e=>e.shaderPasses).flat()}get meshes(){return this.renderers?.map(e=>e.meshes).flat()}get domMeshes(){return this.renderers?.filter(e=>e instanceof Ut).map(e=>e.domMeshes).flat()}get domObjects(){return this.renderers?.filter(e=>e instanceof Ut).map(e=>e.domObjects).flat()}get planes(){return this.domMeshes.filter(e=>e instanceof Tr)}get computePasses(){return this.renderers?.map(e=>e.computePasses).flat()}get boundingRect(){return this.renderer?.boundingRect}initScroll(){this.scrollManager=new In({scroll:{x:window.pageXOffset,y:window.pageYOffset},delta:{x:0,y:0},shouldWatch:this.options.watchScroll,onScroll:e=>this.updateScroll(e)})}updateScroll(e={x:0,y:0}){this.domObjects.forEach(t=>{t.domElement&&t.watchScroll&&t.updateScrollPosition(e)}),this._onScrollCallback&&this._onScrollCallback()}updateScrollValues(e={x:0,y:0}){this.scrollManager.updateScrollValues(e)}get scrollDelta(){return this.scrollManager.delta}get scrollValues(){return this.scrollManager.scroll}initEvents(){Ti.useObserver(this.options.autoResize),this.initScroll()}onRender(e){return e&&(this._onRenderCallback=e),this}onScroll(e){return e&&(this._onScrollCallback=e),this}onError(e){return e&&(this._onErrorCallback=e),this}onContextLost(e){return e&&(this._onContextLostCallback=e),this}animate(){this.render(),this.animationFrameID=window.requestAnimationFrame(this.animate.bind(this))}render(){this._onRenderCallback&&this._onRenderCallback(),this.deviceManager.render()}destroy(){this.animationFrameID&&window.cancelAnimationFrame(this.animationFrameID),this.deviceManager.destroy(),this.scrollManager?.destroy(),Ti.destroy()}}var Fi=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},M=(n,e,t)=>(Fi(n,e,"read from private field"),t?t.call(n):e.get(n)),F=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},be=(n,e,t,i)=>(Fi(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),L=(n,e,t)=>(Fi(n,e,"access private method"),t),$,ne,Me,D,Fe,Ue,nt,$e,$t,Ui,$i,Rr,ki,zr,kt,Ii,It,Vi,Vt,Ni,Nt,Wi,Wt,ji,jt,qi,qt,Yi,Yt,Xi,Ee,ke,Xt,Hi,Zi,Er,Ki,Lr;const Ie=new E,Ve=new E,Ce=new f;class Nn{constructor({camera:e,element:t=null,target:i=new f,enableZoom:s=!0,minZoom:r=0,maxZoom:o=1/0,zoomSpeed:a=1,enableRotate:h=!0,minPolarAngle:l=0,maxPolarAngle:u=Math.PI,minAzimuthAngle:d=-1/0,maxAzimuthAngle:c=1/0,rotateSpeed:p=1,enablePan:g=!0,panSpeed:m=1}){if(F(this,$t),F(this,$i),F(this,ki),F(this,kt),F(this,It),F(this,Vt),F(this,Nt),F(this,Wt),F(this,jt),F(this,qt),F(this,Yt),F(this,Ee),F(this,Xt),F(this,Zi),F(this,Ki),F(this,$,null),F(this,ne,new f),F(this,Me,!1),F(this,D,{radius:1,phi:0,theta:0}),F(this,Fe,new E),F(this,Ue,!1),F(this,nt,new E),F(this,$e,new f),!e){k("OrbitControls: cannot initialize without a camera.");return}this.camera=e,L(this,$t,Ui).call(this,{target:i,enableZoom:s,minZoom:r,maxZoom:o,zoomSpeed:a,enableRotate:h,minPolarAngle:l,maxPolarAngle:u,minAzimuthAngle:d,maxAzimuthAngle:c,rotateSpeed:p,enablePan:g,panSpeed:m}),M(this,ne).copy(this.camera.position).sub(this.target),M(this,D).radius=M(this,ne).length(),M(this,D).theta=Math.atan2(M(this,ne).x,M(this,ne).z),M(this,D).phi=Math.acos(Math.min(Math.max(M(this,ne).y/M(this,D).radius,-1),1)),this.camera.position.onChange(()=>{this.camera.lookAt(this.target)}),this.element=t??(typeof window<"u"?window:null),L(this,Ee,ke).call(this)}reset({position:e,target:t,enableZoom:i=this.enableZoom,minZoom:s=this.minZoom,maxZoom:r=this.maxZoom,zoomSpeed:o=this.zoomSpeed,enableRotate:a=this.enableRotate,minPolarAngle:h=this.minPolarAngle,maxPolarAngle:l=this.maxPolarAngle,minAzimuthAngle:u=this.minAzimuthAngle,maxAzimuthAngle:d=this.maxAzimuthAngle,rotateSpeed:c=this.rotateSpeed,enablePan:p=this.enablePan,panSpeed:g=this.panSpeed}={}){L(this,$t,Ui).call(this,{target:t,enableZoom:i,minZoom:s,maxZoom:r,zoomSpeed:o,enableRotate:a,minPolarAngle:h,maxPolarAngle:l,minAzimuthAngle:u,maxAzimuthAngle:d,rotateSpeed:c,enablePan:p,panSpeed:g}),e&&this.updatePosition(e)}updatePosition(e=new f){e.sub(this.target),M(this,D).radius=e.length(),M(this,D).theta=Math.atan2(e.x,e.z),M(this,D).phi=Math.acos(Math.min(Math.max(e.y/M(this,D).radius,-1),1)),L(this,Ee,ke).call(this)}set element(e){M(this,$)&&(!e||M(this,$)!==e)&&L(this,ki,zr).call(this),be(this,$,e),e&&L(this,$i,Rr).call(this)}get element(){return M(this,$)}destroy(){this.element=null}}$=new WeakMap,ne=new WeakMap,Me=new WeakMap,D=new WeakMap,Fe=new WeakMap,Ue=new WeakMap,nt=new WeakMap,$e=new WeakMap,$t=new WeakSet,Ui=function({target:n,enableZoom:e=this.enableZoom,minZoom:t=this.minZoom,maxZoom:i=this.maxZoom,zoomSpeed:s=this.zoomSpeed,enableRotate:r=this.enableRotate,minPolarAngle:o=this.minPolarAngle,maxPolarAngle:a=this.maxPolarAngle,minAzimuthAngle:h=this.minAzimuthAngle,maxAzimuthAngle:l=this.maxAzimuthAngle,rotateSpeed:u=this.rotateSpeed,enablePan:d=this.enablePan,panSpeed:c=this.panSpeed}={}){n&&(this.target=n),this.enableZoom=e,this.minZoom=t,this.maxZoom=i,this.zoomSpeed=s,this.enableRotate=r,this.minPolarAngle=o,this.maxPolarAngle=a,this.minAzimuthAngle=h,this.maxAzimuthAngle=l,this.rotateSpeed=u,this.enablePan=d,this.panSpeed=c},$i=new WeakSet,Rr=function(){M(this,$).addEventListener("contextmenu",L(this,Yt,Xi).bind(this),!1),M(this,$).addEventListener("mousedown",L(this,kt,Ii).bind(this),!1),M(this,$).addEventListener("mousemove",L(this,Vt,Ni).bind(this),!1),M(this,$).addEventListener("mouseup",L(this,Wt,ji).bind(this),!1),M(this,$).addEventListener("touchstart",L(this,It,Vi).bind(this),{passive:!1}),M(this,$).addEventListener("touchmove",L(this,Nt,Wi).bind(this),{passive:!1}),M(this,$).addEventListener("touchend",L(this,jt,qi).bind(this),!1),M(this,$).addEventListener("wheel",L(this,qt,Yi).bind(this),{passive:!1})},ki=new WeakSet,zr=function(){M(this,$).removeEventListener("contextmenu",L(this,Yt,Xi).bind(this),!1),M(this,$).removeEventListener("mousedown",L(this,kt,Ii).bind(this),!1),M(this,$).removeEventListener("mousemove",L(this,Vt,Ni).bind(this),!1),M(this,$).removeEventListener("mouseup",L(this,Wt,ji).bind(this),!1),M(this,$).removeEventListener("touchstart",L(this,It,Vi).bind(this),{passive:!1}),M(this,$).removeEventListener("touchmove",L(this,Nt,Wi).bind(this),{passive:!1}),M(this,$).removeEventListener("touchend",L(this,jt,qi).bind(this),!1),M(this,$).removeEventListener("wheel",L(this,qt,Yi).bind(this),{passive:!1})},kt=new WeakSet,Ii=function(n){n.button===0&&this.enableRotate?(be(this,Me,!0),M(this,Fe).set(n.clientX,n.clientY)):n.button===2&&this.enablePan&&(be(this,Ue,!0),M(this,nt).set(n.clientX,n.clientY)),n.stopPropagation(),n.preventDefault()},It=new WeakSet,Vi=function(n){n.touches.length===1&&this.enableRotate&&(be(this,Me,!0),M(this,Fe).set(n.touches[0].pageX,n.touches[0].pageY))},Vt=new WeakSet,Ni=function(n){M(this,Me)&&this.enableRotate?L(this,Xt,Hi).call(this,n.clientX,n.clientY):M(this,Ue)&&this.enablePan&&L(this,Zi,Er).call(this,n.clientX,n.clientY)},Nt=new WeakSet,Wi=function(n){M(this,Me)&&this.enableRotate&&L(this,Xt,Hi).call(this,n.touches[0].pageX,n.touches[0].pageY)},Wt=new WeakSet,ji=function(n){be(this,Me,!1),be(this,Ue,!1)},jt=new WeakSet,qi=function(n){be(this,Me,!1),be(this,Ue,!1)},qt=new WeakSet,Yi=function(n){this.enableZoom&&(L(this,Ki,Lr).call(this,n.deltaY),n.preventDefault())},Yt=new WeakSet,Xi=function(n){n.preventDefault()},Ee=new WeakSet,ke=function(){const n=M(this,D).radius*Math.sin(Math.max(1e-6,M(this,D).phi));M(this,ne).x=n*Math.sin(M(this,D).theta),M(this,ne).y=M(this,D).radius*Math.cos(M(this,D).phi),M(this,ne).z=n*Math.cos(M(this,D).theta),this.camera.position.copy(this.target).add(M(this,ne))},Xt=new WeakSet,Hi=function(n,e){Ie.set(n,e),Ve.copy(Ie).sub(M(this,Fe)).multiplyScalar(this.rotateSpeed),M(this,D).theta-=2*Math.PI*Ve.x/this.camera.size.height,M(this,D).phi-=2*Math.PI*Ve.y/this.camera.size.height,M(this,D).theta=Math.min(this.maxAzimuthAngle,Math.max(this.minAzimuthAngle,M(this,D).theta)),M(this,D).phi=Math.min(this.maxPolarAngle,Math.max(this.minPolarAngle,M(this,D).phi)),M(this,Fe).copy(Ie),L(this,Ee,ke).call(this)},Zi=new WeakSet,Er=function(n,e){Ie.set(n,e),Ve.copy(Ie).sub(M(this,nt)).multiplyScalar(this.panSpeed),M(this,$e).set(0),Ce.copy(this.camera.position).sub(this.target);let t=Ce.length();t*=Math.tan(this.camera.fov/2*Math.PI/180),Ce.set(this.camera.modelMatrix.elements[0],this.camera.modelMatrix.elements[1],this.camera.modelMatrix.elements[2]),Ce.multiplyScalar(-(2*Ve.x*t)/this.camera.size.height),M(this,$e).add(Ce),Ce.set(this.camera.modelMatrix.elements[4],this.camera.modelMatrix.elements[5],this.camera.modelMatrix.elements[6]),Ce.multiplyScalar(2*Ve.y*t/this.camera.size.height),M(this,$e).add(Ce),M(this,nt).copy(Ie),this.target.add(M(this,$e)),M(this,ne).copy(this.camera.position).sub(this.target),M(this,D).radius=M(this,ne).length(),L(this,Ee,ke).call(this)},Ki=new WeakSet,Lr=function(n){M(this,D).radius=Math.min(this.maxZoom,Math.max(this.minZoom+1e-6,M(this,D).radius+n*this.zoomSpeed/100)),L(this,Ee,ke).call(this)};class Wn extends Ye{constructor({instancesCount:e=1,vertexBuffers:t=[],topology:i,mapBuffersAtCreation:s=!0,widthSegments:r=1,heightSegments:o=1,depthSegments:a=1}={}){super({verticesOrder:"ccw",topology:i,instancesCount:e,vertexBuffers:t,mapBuffersAtCreation:s}),this.type="BoxGeometry",r=Math.floor(r),o=Math.floor(o),a=Math.floor(a);const h=[],l=[],u=[],d=[];let c=0;const p=(g,m,x,v,C,S,b,P,B,w)=>{const T=S/B,z=b/w,R=S/2,O=b/2,I=P/2,Z=B+1,K=w+1;let X=0;const _=new f;for(let W=0;W<K;W++){const V=W*z-O;for(let Q=0;Q<Z;Q++){const te=Q*T-R;_[g]=te*v,_[m]=V*C,_[x]=I,h.push(_.x,_.y,_.z),_[g]=0,_[m]=0,_[x]=P>0?1:-1,u.push(_.x,_.y,_.z),l.push(Q/B),l.push(W/w),X+=1}}for(let W=0;W<w;W++)for(let V=0;V<B;V++){const Q=c+V+Z*W,te=c+V+Z*(W+1),ye=c+(V+1)+Z*(W+1),ei=c+(V+1)+Z*W;d.push(Q,te,ei),d.push(te,ye,ei),c+=X}};p("z","y","x",-1,-1,2,2,2,a,o),p("z","y","x",1,-1,2,2,-2,a,o),p("x","z","y",1,1,2,2,2,r,a),p("x","z","y",1,-1,2,2,-2,r,a),p("x","y","z",1,-1,2,2,2,r,o),p("x","y","z",-1,-1,2,2,-2,r,o),this.setAttribute({name:"position",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(h)}),this.setAttribute({name:"uv",type:"vec2f",bufferFormat:"float32x2",size:2,array:new Float32Array(l)}),this.setAttribute({name:"normal",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(u)}),this.setIndexBuffer({array:this.useUint16IndexArray?new Uint16Array(d):new Uint32Array(d),bufferFormat:this.useUint16IndexArray?"uint16":"uint32"})}}class jn extends Ye{constructor({topology:e,instancesCount:t=1,vertexBuffers:i=[],mapBuffersAtCreation:s=!0,widthSegments:r=32,heightSegments:o=16,phiStart:a=0,phiLength:h=Math.PI*2,thetaStart:l=0,thetaLength:u=Math.PI}={}){super({verticesOrder:"ccw",topology:e,instancesCount:t,vertexBuffers:i,mapBuffersAtCreation:s}),this.type="SphereGeometry",r=Math.max(3,Math.floor(r)),o=Math.max(2,Math.floor(o));const d=1,c=Math.min(l+u,Math.PI);let p=0;const g=[],m=new f,x=new f,v=[],C=[],S=[],b=[];for(let P=0;P<=o;P++){const B=[],w=P/o;let T=0;P===0&&l===0?T=.5/r:P===o&&c===Math.PI&&(T=-.5/r);for(let z=0;z<=r;z++){const R=z/r;m.x=-d*Math.cos(a+R*h)*Math.sin(l+w*u),m.y=d*Math.cos(l+w*u),m.z=d*Math.sin(a+R*h)*Math.sin(l+w*u),C.push(m.x,m.y,m.z),x.copy(m).normalize(),S.push(x.x,x.y,x.z),b.push(R+T,w),B.push(p++)}g.push(B)}for(let P=0;P<o;P++)for(let B=0;B<r;B++){const w=g[P][B+1],T=g[P][B],z=g[P+1][B],R=g[P+1][B+1];(P!==0||l>0)&&v.push(w,T,R),(P!==o-1||c<Math.PI)&&v.push(T,z,R)}this.setAttribute({name:"position",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(C)}),this.setAttribute({name:"uv",type:"vec2f",bufferFormat:"float32x2",size:2,array:new Float32Array(b)}),this.setAttribute({name:"normal",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(S)}),this.setIndexBuffer({array:this.useUint16IndexArray?new Uint16Array(v):new Uint32Array(v),bufferFormat:this.useUint16IndexArray?"uint16":"uint32"})}}class qn extends Ci{constructor(e,t={}){e=j(e,t.label?t.label+" PingPongPlane":"PingPongPlane");const i=t.targets&&t.targets.length&&t.targets.map(s=>({targetFormat:s.format}));t.outputTarget=new fi(e,{label:t.label?t.label+" render target":"Ping Pong render target",useDepth:!1,...i&&{colorAttachments:i}}),t.transparent=!1,t.depth=!1,t.label=t.label??"PingPongPlane "+e.pingPongPlanes?.length,super(e,t),this.type="PingPongPlane",this.createTexture({label:t.label?`${t.label} render texture`:"PingPongPlane render texture",name:"renderTexture",...t.targets&&t.targets.length&&{format:t.targets[0].format},usage:["copyDst","textureBinding"]})}get renderTexture(){return this.textures.find(e=>e.options.name==="renderTexture")}addToScene(e=!1){e&&this.renderer.pingPongPlanes.push(this),this.autoRender&&this.renderer.scene.addPingPongPlane(this)}removeFromScene(e=!1){this.outputTarget&&this.outputTarget.destroy(),this.autoRender&&this.renderer.scene.removePingPongPlane(this),e&&(this.renderer.pingPongPlanes=this.renderer.pingPongPlanes.filter(t=>t.uuid!==this.uuid))}}var _r=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},Qi=(n,e,t)=>(_r(n,e,"read from private field"),t?t.call(n):e.get(n)),Yn=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},Xn=(n,e,t,i)=>(_r(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),Ne;const q=WebGLRenderingContext,Ht=new A,Hn=class ve{constructor({renderer:e,gltf:t}){Yn(this,Ne,void 0),e=Le(e,"GLTFScenesManager"),this.renderer=e,this.gltf=t,Xn(this,Ne,new Map);const i=s=>[s.node,...s.children?.map(r=>[...i(r)]).flat()].flat();this.scenesManager={node:new fe,boundingBox:new de,samplers:[],materialsTextures:[],scenes:[],meshes:[],meshesDescriptors:[],getScenesNodes:()=>this.scenesManager.scenes.map(s=>i(s)).flat()},this.createSamplers(),this.createMaterialTextures(),this.createScenes()}static getVertexAttributeParamsFromType(e){switch(e){case"VEC2":return{type:"vec2f",bufferFormat:"float32x2",size:2};case"VEC3":return{type:"vec3f",bufferFormat:"float32x3",size:3};case"VEC4":return{type:"vec4f",bufferFormat:"float32x4",size:4};case"SCALAR":default:return{type:"f32",bufferFormat:"float32",size:1}}}static getTypedArrayConstructorFromComponentType(e){switch(e){case q.BYTE:return Int8Array;case q.UNSIGNED_BYTE:return Uint8Array;case q.SHORT:return Int16Array;case q.UNSIGNED_SHORT:return Uint16Array;case q.UNSIGNED_INT:return Uint32Array;case q.FLOAT:default:return Float32Array}}static gpuPrimitiveTopologyForMode(e){switch(e){case q.TRIANGLES:return"triangle-list";case q.TRIANGLE_STRIP:return"triangle-strip";case q.LINES:return"line-list";case q.LINE_STRIP:return"line-strip";case q.POINTS:return"point-list"}}static gpuAddressModeForWrap(e){switch(e){case q.CLAMP_TO_EDGE:return"clamp-to-edge";case q.MIRRORED_REPEAT:return"mirror-repeat";default:return"repeat"}}createSamplers(){if(this.gltf.samplers)for(const[e,t]of Object.entries(this.gltf.samplers)){const i={label:"glTF sampler "+e,name:"gltfSampler"+e,addressModeU:ve.gpuAddressModeForWrap(t.wrapS),addressModeV:ve.gpuAddressModeForWrap(t.wrapT)};switch((!t.magFilter||t.magFilter===q.LINEAR)&&(i.magFilter="linear"),t.minFilter){case q.NEAREST:break;case q.LINEAR:case q.LINEAR_MIPMAP_NEAREST:i.minFilter="linear";break;case q.NEAREST_MIPMAP_LINEAR:i.mipmapFilter="linear";break;case q.LINEAR_MIPMAP_LINEAR:default:i.minFilter="linear",i.mipmapFilter="linear";break}this.scenesManager.samplers.push(new Ae(this.renderer,i))}else this.scenesManager.samplers.push(new Ae(this.renderer,{label:"Default sampler",name:"defaultSampler",magFilter:"linear",minFilter:"linear",mipmapFilter:"linear"}))}createTexture(e,t,i){const s=(()=>{switch(i){case"baseColorTexture":case"emissiveTexture":return"bgra8unorm-srgb";case"occlusionTexture":return"r8unorm";default:return"bgra8unorm"}})(),r=new se(this.renderer,{label:e.name?e.name+": "+i:i,name:i,format:s,visibility:["fragment"],generateMips:!0,fixedSize:{width:t.width,height:t.height}});return r.uploadSource({source:t}),r}createMaterialTextures(){if(this.scenesManager.materialsTextures=[],this.gltf.materials)for(const[e,t]of Object.entries(this.gltf.materials)){const i={material:e,texturesDescriptors:[]},s=r=>r.texCoord&&r.texCoord!==0?"uv"+r.texCoord:"uv";if(this.scenesManager.materialsTextures[e]=i,t.pbrMetallicRoughness){if(t.pbrMetallicRoughness.baseColorTexture&&t.pbrMetallicRoughness.baseColorTexture.index!==void 0){const r=t.pbrMetallicRoughness.baseColorTexture.index,o=this.gltf.imagesBitmaps[this.gltf.textures[r].source],a=this.createTexture(t,o,"baseColorTexture"),h=this.gltf.textures.find(l=>l.source===r)?.sampler;i.texturesDescriptors.push({texture:a,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.pbrMetallicRoughness.baseColorTexture)})}if(t.pbrMetallicRoughness.metallicRoughnessTexture&&t.pbrMetallicRoughness.metallicRoughnessTexture.index!==void 0){const r=t.pbrMetallicRoughness.metallicRoughnessTexture.index,o=this.gltf.imagesBitmaps[this.gltf.textures[r].source],a=this.createTexture(t,o,"metallicRoughnessTexture"),h=this.gltf.textures.find(l=>l.source===r)?.sampler;i.texturesDescriptors.push({texture:a,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.pbrMetallicRoughness.metallicRoughnessTexture)})}}if(t.normalTexture&&t.normalTexture.index!==void 0){const r=t.normalTexture.index,o=this.gltf.imagesBitmaps[this.gltf.textures[r].source],a=this.createTexture(t,o,"normalTexture"),h=this.gltf.textures.find(l=>l.source===r)?.sampler;i.texturesDescriptors.push({texture:a,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.normalTexture)})}if(t.occlusionTexture&&t.occlusionTexture.index!==void 0){const r=t.occlusionTexture.index,o=this.gltf.imagesBitmaps[this.gltf.textures[r].source],a=this.createTexture(t,o,"occlusionTexture"),h=this.gltf.textures.find(l=>l.source===r)?.sampler;i.texturesDescriptors.push({texture:a,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.occlusionTexture)})}if(t.emissiveTexture&&t.emissiveTexture.index!==void 0){const r=t.emissiveTexture.index,o=this.gltf.imagesBitmaps[this.gltf.textures[r].source],a=this.createTexture(t,o,"emissiveTexture"),h=this.gltf.textures.find(l=>l.source===r)?.sampler;i.texturesDescriptors.push({texture:a,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.emissiveTexture)})}}}createNode(e,t){if(t.camera!==void 0)return;const i={name:t.name,node:new fe,children:[]};e.children.push(i),i.node.parent=e.node,t.matrix?(i.node.modelMatrix.setFromArray(new Float32Array(t.matrix)),i.node.matrices.model.shouldUpdate=!1):(t.translation&&i.node.position.set(t.translation[0],t.translation[1],t.translation[2]),t.scale&&i.node.scale.set(t.scale[0],t.scale[1],t.scale[2]),t.rotation&&i.node.quaternion.setFromArray(new Float32Array(t.rotation)));const s=this.gltf.meshes[t.mesh];t.children&&t.children.forEach(r=>{const o=this.gltf.nodes[r];this.createNode(i,o)}),s&&s.primitives.forEach((r,o)=>{const a={parent:i.node,attributes:[],textures:[],parameters:{label:s.name?s.name+" "+o:"glTF mesh "+o},nodes:[]};let h=Qi(this,Ne).get(r);h||(h={instances:[],nodes:[],meshDescriptor:a},Qi(this,Ne).set(r,h)),h.instances.push(t),h.nodes.push(i.node)})}createScenes(){this.scenesManager.node.parent=this.renderer.scene,this.gltf.scenes.forEach(e=>{const t={name:e.name,children:[],node:new fe};t.node.parent=this.scenesManager.node,this.scenesManager.scenes.push(t),e.nodes.forEach(i=>{const s=this.gltf.nodes[i];this.createNode(t,s)})}),this.scenesManager.node.updateMatrixStack();for(const[e,t]of Qi(this,Ne)){const{instances:i,nodes:s,meshDescriptor:r}=t,o=i.length;r.nodes=s,this.scenesManager.meshesDescriptors.push(r);const a=new de,h=[];let l=null,u=null,d=0;for(const[C,S]of Object.entries(e.attributes)){const b=this.gltf.accessors[S],P=ve.getTypedArrayConstructorFromComponentType(b.componentType),B=this.gltf.bufferViews[b.bufferView],w=C==="TEXCOORD_0"?"uv":C.replace("_","").replace("TEXCOORD","uv").toLowerCase(),T=B.byteStride||0,z=b.byteOffset||0;T&&z&&z<T?d=Math.max(z,d):d=0,w==="position"&&(a.min.min(new f(b.min[0],b.min[1],b.min[2])),a.max.max(new f(b.max[0],b.max[1],b.max[2])),u=B);const R=ve.getVertexAttributeParamsFromType(b.type),O={name:w,...R,array:new P(this.gltf.arrayBuffers[B.buffer],b.byteOffset+B.byteOffset,b.count*R.size)};h.push(O),r.attributes.push({name:O.name,type:O.type})}if(d>0){const C=Object.values(e.attributes).map(S=>this.gltf.accessors[S].bufferView);if(C.every(S=>S===C[0]))l=new Float32Array(this.gltf.arrayBuffers[u.buffer],u.byteOffset,Math.ceil(u.byteLength/4)*4/Float32Array.BYTES_PER_ELEMENT);else{let S=0;const b={},P=Object.values(e.attributes).reduce((B,w)=>{const T=this.gltf.accessors[w],z=ve.getVertexAttributeParamsFromType(T.type).size;return b[T.bufferView]||(b[T.bufferView]=0),b[T.bufferView]=Math.max(b[T.bufferView],T.byteOffset+z*Float32Array.BYTES_PER_ELEMENT),S+=z*Float32Array.BYTES_PER_ELEMENT,B+T.count*z},0);l=new Float32Array(Math.ceil(P/4)*4),Object.values(e.attributes).forEach(B=>{const w=this.gltf.accessors[B],T=this.gltf.bufferViews[w.bufferView],z=ve.getVertexAttributeParamsFromType(w.type).size;for(let R=0;R<w.count;R++){const O=w.byteOffset/Float32Array.BYTES_PER_ELEMENT+R*S/Float32Array.BYTES_PER_ELEMENT;l.subarray(O,O+z).set(new Float32Array(this.gltf.arrayBuffers[T.buffer],T.byteOffset+w.byteOffset+R*b[w.bufferView],z))}})}}else{const C=["position","uv","normal"];h.sort((S,b)=>{let P=C.findIndex(w=>w===S.name);P=P===-1?1/0:P;let B=C.findIndex(w=>w===b.name);return B=B===-1?1/0:B,P-B})}const c={instancesCount:o,topology:ve.gpuPrimitiveTopologyForMode(e.mode),vertexBuffers:[{name:"attributes",stepMode:"vertex",attributes:h,...l&&{array:l}}]},p="indices"in e,g=p?Ye:di;if(r.parameters.geometry=new g(c),r.parameters.geometry.boundingBox=a,p){const C=this.gltf.accessors[e.indices],S=this.gltf.bufferViews[C.bufferView],b=ve.getTypedArrayConstructorFromComponentType(C.componentType),P=C.byteOffset+S.byteOffset,B=this.gltf.arrayBuffers[S.buffer],w=Math.min((B.byteLength-P)/b.BYTES_PER_ELEMENT,Math.ceil(C.count/4)*4),T=b.name==="Uint8Array"?Uint16Array.from(new b(B,P,w)):new b(B,P,w);r.parameters.geometry.setIndexBuffer({bufferFormat:b.name==="Uint32Array"?"uint32":"uint16",array:T})}const m=this.scenesManager.materialsTextures[e.material];r.parameters.samplers=[],r.parameters.textures=[],m?.texturesDescriptors.forEach(C=>{r.textures.push({texture:C.texture.options.name,sampler:C.sampler.name,texCoordAttributeName:C.texCoordAttributeName}),r.parameters.samplers.find(b=>b.uuid===C.sampler.uuid)||r.parameters.samplers.push(C.sampler),r.parameters.textures.push(C.texture)});const x=this.gltf.materials&&this.gltf.materials[e.material]||{};r.parameters.cullMode=x.doubleSided?"none":"back",(x.alphaMode==="BLEND"||x.extensions&&x.extensions.KHR_materials_transmission)&&(r.parameters.transparent=!0,r.parameters.targets=[{blend:{color:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha"},alpha:{srcFactor:"one",dstFactor:"one"}}}]);const v={baseColorFactor:{type:"vec4f",value:x.pbrMetallicRoughness?.baseColorFactor||[1,1,1,1]},alphaCutoff:{type:"f32",value:x.alphaCutoff!==void 0?x.alphaCutoff:x.alphaMode==="MASK"?.5:0},metallicFactor:{type:"f32",value:x.pbrMetallicRoughness?.metallicFactor===void 0?1:x.pbrMetallicRoughness.metallicFactor},roughnessFactor:{type:"f32",value:x.pbrMetallicRoughness?.roughnessFactor===void 0?1:x.pbrMetallicRoughness.roughnessFactor},normalMapScale:{type:"f32",value:x.normalTexture?.scale===void 0?1:x.normalTexture.scale},occlusionStrength:{type:"f32",value:x.occlusionTexture?.strength===void 0?1:x.occlusionTexture.strength},emissiveFactor:{type:"vec3f",value:x.emissiveFactor!==void 0?x.emissiveFactor:[1,1,1]}};if(Object.keys(v).length&&(r.parameters.uniforms={material:{visibility:["vertex","fragment"],struct:v}}),o>1){const C=new Float32Array(o*16),S=new Float32Array(o*16);for(let b=0;b<o;++b)C.set(s[b].worldMatrix.elements,b*16),Ht.copy(s[b].worldMatrix).invert().transpose(),S.set(Ht.elements,b*16);r.parameters.storages={instances:{visibility:["vertex","fragment"],struct:{modelMatrix:{type:"array<mat4x4f>",value:C},normalMatrix:{type:"array<mat4x4f>",value:S}}}}}for(let C=0;C<s.length;C++){const b=a.clone().applyMat4(r.nodes[C].worldMatrix);this.scenesManager.boundingBox.min.min(b.min),this.scenesManager.boundingBox.max.max(b.max)}}}addMeshes(e=t=>{}){return this.scenesManager.node.updateMatrixStack(),this.scenesManager.meshesDescriptors.map(t=>{if(t.parameters.geometry){e(t);const i=t.parameters.geometry.instancesCount>1&&t.parameters.castShadows;i&&(t.parameters.castShadows=!1);const s=new ar(this.renderer,{...t.parameters});if(t.nodes.length>1){const r=s.updateWorldMatrix.bind(s);s.updateWorldMatrix=()=>{r(),t.nodes.forEach((o,a)=>{s.storages.instances.modelMatrix.value.set(o.worldMatrix.elements,a*16),Ht.copy(o.worldMatrix).invert().transpose(),s.storages.instances.normalMatrix.value.set(Ht.elements,a*16)}),s.storages.instances.modelMatrix.shouldUpdate=!0,s.storages.instances.normalMatrix.shouldUpdate=!0}}if(i){const r=s.material.inputsBindings.get("instances");this.renderer.shadowCastingLights.forEach(o=>{o.shadow.isActive&&o.shadow.addShadowCastingMesh(s,{bindings:[r]})})}return s.parent=t.parent,this.scenesManager.meshes.push(s),s}})}destroy(){this.scenesManager.meshes.forEach(t=>t.remove()),this.scenesManager.meshes=[],this.scenesManager.getScenesNodes().forEach(t=>{t.destroy()}),this.scenesManager.node.destroy()}};Ne=new WeakMap;let Zn=Hn;const Kn=(n,e={})=>{const t=n.textures.find(G=>G.texture==="baseColorTexture"),i=n.textures.find(G=>G.texture==="normalTexture"),s=n.textures.find(G=>G.texture==="emissiveTexture"),r=n.textures.find(G=>G.texture==="occlusionTexture"),o=n.textures.find(G=>G.texture==="metallicRoughnessTexture"),a=n.attributes.filter(G=>G.name!=="position"),h=a.map((G,lo)=>`@location(${lo}) ${G.name}: ${G.type},`).join(`
  ...
  `,u=a.find(G=>G.name==="normal")?"vsOutput.normal = getWorldNormal(attributes.normal);":"";n.parameters.storages&&n.parameters.storages.instances&&(l=`
      ...
      vsOutput.viewDirection = camera.position - vsOutput.worldPosition;
      `,u="vsOutput.normal = normalize((instances[attributes.instanceIndex].normalMatrix * vec4(attributes.normal, 0.0)).xyz);");const d=a.filter(G=>G.name!=="normal").map(G=>`vsOutput.${G.name} = attributes.${G.name};`).join(`
	`);let c=`
      @builtin(position) position: vec4f,
      @location(${a.length}) viewDirection: vec3f,
      @location(${a.length+1}) worldPosition: vec3f,
      ${h}
  `,p="";const g=a.find(G=>G.name==="tangent"),m=!!(i&&g);m&&(c+=`
  ...
  `,S="var color: vec4f = vec4();",b=`
      return color;
  `,P=n.attributes.find(G=>G.name==="color0");let B=P?P.type==="vec3f"?"var baseColor: vec4f = vec4(fsInput.color0, 1.0) * material.baseColorFactor;":"var baseColor: vec4f = fsInput.color0 * material.baseColorFactor;":"var baseColor: vec4f = material.baseColorFactor;";t&&(B=`
    ...
    `),B+=`
      color = baseColor;
  `;let w=n.attributes.find(G=>G.name==="normal")?`
  ...
  `;let{shadingModel:O}=e;O||(O="PBR");let{chunks:I}=e||{};const{iblParameters:Z}=e||{},{lutTexture:K,envDiffuseTexture:X,envSpecularTexture:_}=Z||{};X&&X.texture&&_&&_.texture&&K&&K.texture&&O==="IBL"?(n.parameters.uniforms={...n.parameters.uniforms,ibl:{struct:{diffuseStrength:{type:"f32",value:Z?.diffuseStrength??.5},specularStrength:{type:"f32",value:Z?.specularStrength??.5}}}},n.parameters.textures=[...n.parameters.textures,K.texture,X.texture,_.texture],K.samplerName=K.samplerName||"defaultSampler",X.samplerName=X.samplerName||"defaultSampler",_.samplerName=_.samplerName||"defaultSampler"):O==="IBL"&&(k("IBL shading requested but one of the LUT, environment specular or diffuse texture is missing. Defaulting to PBR shading."),O="PBR");const V={toneMapping:"khronos",receiveShadows:!!n.parameters.receiveShadows,useOcclusion:!0},Q=(()=>{switch(O){case"Lambert":default:return xr(V);case"Phong":return vr(V);case"PBR":return wr(V);case"IBL":return Mr(V)}})(),te="",ye="";I?(I.additionalFragmentHead||(I.additionalFragmentHead=Q),I.preliminaryColorContribution||(I.preliminaryColorContribution=te),I.additionalColorContribution||(I.additionalColorContribution=ye)):I={additionalFragmentHead:Q,preliminaryColorContribution:te,additionalColorContribution:ye};const ei=(()=>{switch(O){case"Lambert":default:return`
      color = vec4(
        getLambert(
          normal,
          worldPosition,
      ...
      color = vec4(
        getIBL(
          ...
          metallic,
          roughness,
          ${K.texture.options.name},
          ${K.samplerName},
          ${_.texture.options.name},
          ${_.samplerName},
          ${X.texture.options.name},
          ${X.samplerName},
          occlusion
        ),
        color.a
      );`}})(),ho=`  
    ${I.additionalFragmentHead}
    ...
    color = vec4(color.rgb + emissive, color.a);
      ...
      ${I.additionalColorContribution}
      
      ${b}
    }
  `;return{vertex:{code:C,entryPoint:"main"},fragment:{code:ho,entryPoint:"main"}}},Qn=async(n,e,t)=>{if(t.options.viewDimension!=="cube"){k("Could not compute the diffuse texture because the specular texture is not a cube map:"+t.options.viewDimension);return}const i=`    
