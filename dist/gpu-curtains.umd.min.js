(function(x,F){typeof exports=="object"&&typeof module<"u"?F(exports):typeof define=="function"&&define.amd?define(["exports"],F):(x=typeof globalThis<"u"?globalThis:x||self,F(x.window=x.window||{}))})(this,function(x){"use strict";const F=()=>"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,o=>{const e=Math.random()*16|0;return(o==="x"?e:e&3|8).toString(16).toUpperCase()}),fe=o=>o.replace(/(?:^\w|[A-Z]|\b\w)/g,(e,t)=>t===0?e.toLowerCase():e.toUpperCase()).replace(/\s+/g,""),Ie=o=>{const e=fe(o);return e.charAt(0).toUpperCase()+e.slice(1)};let We=0;const _=o=>{We>100||(console.warn(We===100?"GPUCurtains: too many warnings thrown, stop logging.":o),We++)},V=o=>{throw new Error(o)},je=(o,e="GPURenderer",t)=>{const s=t?`Unable to create ${t} because the ${e} is not defined: ${o}`:`The ${e} is not defined: ${o}`;V(s)},A=(o,e)=>{const t=o&&(o.type==="GPURenderer"||o.type==="GPUCameraRenderer"||o.type==="GPUCurtainsRenderer");return t||je(o,"GPURenderer",e),t},qe=(o,e)=>{const t=o&&(o.type==="GPUCameraRenderer"||o.type==="GPUCurtainsRenderer");return t||je(o,"GPUCameraRenderer",e),t},Ne=(o,e)=>{const t=o&&o.type==="GPUCurtainsRenderer";return t||je(o,"GPUCurtainsRenderer",e),t},mt=(()=>{let o,e;const t={};return function(i,r){e||(e=i.createShaderModule({label:"textured quad shaders for mip level generation",code:`
            struct VSOutput {
...
${this.shaders.full.head}`);if(this.options.rendering.useProjection){for(const t in ae.vertex)this.shaders.vertex.head=`${ae.vertex[t]}
${this.shaders.vertex.head}`,this.shaders.full.head=`${ae.vertex[t]}
${this.shaders.full.head}`;if(this.options.shaders.fragment)for(const t in ae.fragment)this.shaders.fragment.head=`${ae.fragment[t]}
${this.shaders.fragment.head}`,this.shaders.full.head.indexOf(ae.fragment[t])===-1&&(this.shaders.full.head=`${ae.fragment[t]}
...
}`;class Is extends rt{constructor(e,t={}){e=e&&e.renderer||e,A(e,t.label?t.label+" ShaderPass":"ShaderPass"),t.depth=!1,t.transparent=!0,t.label=t.label??"ShaderPass "+e.shaderPasses?.length,t.sampleCount=t.sampleCount?t.sampleCount:e&&e.postProcessingPass?e&&e.postProcessingPass.options.sampleCount:1,t.shaders||(t.shaders={}),t.shaders.fragment||(t.shaders.fragment={code:Vs,entryPoint:"main"}),t.depth=!1,super(e,t),t.inputTarget&&this.setInputTarget(t.inputTarget),this.outputTarget&&this.setRenderingOptionsForRenderPass(this.outputTarget.renderPass),this.type="ShaderPass",this.createTexture({label:t.label?`${t.label} render texture`:"Shader pass render texture",name:"renderTexture",fromTexture:this.inputTarget?this.inputTarget.renderTexture:null,usage:["copySrc","copyDst","textureBinding"],...this.outputTarget&&this.outputTarget.options.qualityRatio&&{qualityRatio:this.outputTarget.options.qualityRatio}})}cleanupRenderMaterialParameters(e){return delete e.copyOutputToRenderTexture,delete e.inputTarget,super.cleanupRenderMaterialParameters(e),e}get renderTexture(){return this.textures.find(e=>e.options.name==="renderTexture")}setInputTarget(e){if(e&&e.type!=="RenderTarget"){_(`${this.options.label??this.type}: inputTarget is not a RenderTarget: ${e}`);return}this.removeFromScene(),this.inputTarget=e,this.addToScene(),this.renderTexture&&(e?this.renderTexture.copy(this.inputTarget.renderTexture):(this.renderTexture.options.fromTexture=null,this.renderTexture.createTexture()))}addToScene(e=!1){e&&this.renderer.shaderPasses.push(this),this.setRenderingOptionsForRenderPass(this.outputTarget?this.outputTarget.renderPass:this.renderer.postProcessingPass),this.autoRender&&this.renderer.scene.addShaderPass(this)}removeFromScene(e=!1){this.outputTarget&&this.outputTarget.destroy(),this.autoRender&&this.renderer.scene.removeShaderPass(this),e&&(this.renderer.shaderPasses=this.renderer.shaderPasses.filter(t=>t.uuid!==this.uuid))}}var Ht=(o,e,t)=>{if(!e.has(o))throw TypeError("Cannot "+t)},le=(o,e,t)=>(Ht(o,e,"read from private field"),t?t.call(o):e.get(o)),ct=(o,e,t)=>{if(e.has(o))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(o):e.set(o,t)},Ws=(o,e,t,s)=>(Ht(o,e,"write to private field"),s?s.call(o,t):e.set(o,t),t),ye,ke,Le;class Jt extends nt{constructor(e,t,s){super(e),ct(this,ye,new f),ct(this,ke,new f(1)),ct(this,Le,1),this.boundingBox=new ne(new f(-1),new f(1)),this._onAfterDOMElementResizeCallback=()=>{},e=e&&e.renderer||e,Ne(e,"DOM3DObject"),this.renderer=e,this.size={document:{width:0,height:0,top:0,left:0},normalizedWorld:{size:new P(1),position:new P},cameraWorld:{size:new P(1),position:new P},scaledWorld:{size:new f(1),position:new f}},this.watchScroll=s.watchScroll,this.camera=this.renderer.camera,this.boundingBox.min.onChange(()=>this.updateSizeAndPosition()),this.boundingBox.max.onChange(()=>this.updateSizeAndPosition()),this.setDOMElement(t),this.renderer.domObjects.push(this)}setDOMElement(e){this.domElement=new ut({element:e,onSizeChanged:t=>this.resize(t),onPositionChanged:t=>this.onPositionChanged(t)})}onPositionChanged(e){this.watchScroll&&(this.size.document=e??this.domElement.element.getBoundingClientRect(),this.updateSizeAndPosition())}resetDOMElement(e){this.domElement&&this.domElement.destroy(),this.setDOMElement(e)}updateSizeAndPosition(){this.setWorldSizes(),this.applyPosition()}resize(e=null){!e&&(!this.domElement||this.domElement?.isResizing)||(this.size.document=e??this.domElement.element.getBoundingClientRect(),this.updateSizeAndPosition(),this._onAfterDOMElementResizeCallback&&this._onAfterDOMElementResizeCallback())}get boundingRect(){return this.domElement.boundingRect}setTransforms(){super.setTransforms(),this.transforms.origin.model.set(.5,.5,0),this.transforms.origin.world=new f,this.transforms.position.document=new f,this.documentPosition.onChange(()=>this.applyPosition()),this.transformOrigin.onChange(()=>this.setWorldTransformOrigin())}get documentPosition(){return this.transforms.position.document}set documentPosition(e){this.transforms.position.document=e,this.applyPosition()}get DOMObjectWorldScale(){return le(this,ke).clone()}get worldScale(){return this.DOMObjectWorldScale.multiply(this.scale)}get worldPosition(){return le(this,ye).clone()}get transformOrigin(){return this.transforms.origin.model}set transformOrigin(e){this.transforms.origin.model=e,this.setWorldTransformOrigin()}get worldTransformOrigin(){return this.transforms.origin.world}set worldTransformOrigin(e){this.transforms.origin.world=e}applyPosition(){this.applyDocumentPosition(),super.applyPosition()}applyDocumentPosition(){let e=new f(0,0,0);this.documentPosition.equals(e)||(e=this.documentToWorldSpace(this.documentPosition)),le(this,ye).set(this.position.x+this.size.scaledWorld.position.x+e.x,this.position.y+this.size.scaledWorld.position.y+e.y,this.position.z+this.size.scaledWorld.position.z+this.documentPosition.z/this.camera.CSSPerspective)}applyTransformOrigin(){this.size&&(this.setWorldTransformOrigin(),super.applyTransformOrigin())}updateModelMatrix(){this.modelMatrix.composeFromOrigin(le(this,ye),this.quaternion,this.scale,this.worldTransformOrigin),this.modelMatrix.scale(this.DOMObjectWorldScale),this.shouldUpdateWorldMatrix()}documentToWorldSpace(e=new f){return new f(e.x*this.renderer.pixelRatio/this.renderer.boundingRect.width*this.camera.screenRatio.width,-(e.y*this.renderer.pixelRatio/this.renderer.boundingRect.height)*this.camera.screenRatio.height,e.z)}computeWorldSizes(){const e=this.renderer.boundingRect,t={x:this.size.document.width/2+this.size.document.left,y:this.size.document.height/2+this.size.document.top},s={x:e.width/2+e.left,y:e.height/2+e.top},{size:i,center:r}=this.boundingBox;i.x!==0&&i.y!==0&&i.z!==0&&r.divide(i),this.size.normalizedWorld.size.set(this.size.document.width/e.width,this.size.document.height/e.height),this.size.normalizedWorld.position.set((t.x-s.x)/e.width,(s.y-t.y)/e.height),this.size.cameraWorld.size.set(this.size.normalizedWorld.size.x*this.camera.screenRatio.width,this.size.normalizedWorld.size.y*this.camera.screenRatio.height),this.size.cameraWorld.position.set(this.size.normalizedWorld.position.x*this.camera.screenRatio.width,this.size.normalizedWorld.position.y*this.camera.screenRatio.height),this.size.scaledWorld.size.set(this.size.cameraWorld.size.x/i.x,this.size.cameraWorld.size.y/i.y,1),this.size.scaledWorld.size.z=this.size.scaledWorld.size.y*(i.x/i.y/(this.size.document.width/this.size.document.height)),this.size.scaledWorld.position.set(this.size.cameraWorld.position.x-r.x*this.size.scaledWorld.size.x*i.x,this.size.cameraWorld.position.y-r.y*this.size.scaledWorld.size.y*i.y,-r.z)}setWorldSizes(){this.computeWorldSizes(),this.setWorldScale(),this.setWorldTransformOrigin()}setWorldScale(){le(this,ke).set(this.size.scaledWorld.size.x,this.size.scaledWorld.size.y,this.size.scaledWorld.size.z*le(this,Le)),this.shouldUpdateMatrixStack()}set DOMObjectDepthScaleRatio(e){Ws(this,Le,e),this.setWorldScale()}setWorldTransformOrigin(){this.transforms.origin.world=new f((this.transformOrigin.x*2-1)*this.size.scaledWorld.size.x,-(this.transformOrigin.y*2-1)*this.size.scaledWorld.size.y,this.transformOrigin.z*this.size.scaledWorld.size.z),this.shouldUpdateMatrixStack()}updateScrollPosition(e={x:0,y:0}){(e.x||e.y)&&this.domElement.updateScrollPosition(e)}onAfterDOMElementResize(e){return e&&(this._onAfterDOMElementResizeCallback=e),this}destroy(){super.destroy(),this.domElement?.destroy()}}ye=new WeakMap,ke=new WeakMap,Le=new WeakMap;const es={autoloadSources:!0,watchScroll:!0};class ts extends Vt(Jt){constructor(e,t,s){super(e,t,{...es,...s}),this._onLoadingCallback=r=>{},s={...es,...s},e=e&&e.renderer||e,Ne(e,s.label?s.label+" DOMMesh":"DOMMesh"),this.type="DOMMesh";const{autoloadSources:i}=s;this.autoloadSources=i,this.sourcesReady=!1,this.setInitSources()}get ready(){return this._ready}set ready(e){e&&!this._ready&&this.sourcesReady&&this._onReadyCallback&&this._onReadyCallback(),this._ready=e}get sourcesReady(){return this._sourcesReady}set sourcesReady(e){e&&!this._sourcesReady&&this.ready&&this._onReadyCallback&&this._onReadyCallback(),this._sourcesReady=e}addToScene(e=!1){super.addToScene(e),e&&this.renderer.domMeshes.push(this)}removeFromScene(e=!1){super.removeFromScene(e),e&&(this.renderer.domMeshes=this.renderer.domMeshes.filter(t=>t.uuid!==this.uuid))}setInitSources(){let e=0,t=0;if(this.autoloadSources){const s=this.domElement.element.querySelectorAll("img"),i=this.domElement.element.querySelectorAll("video"),r=this.domElement.element.querySelectorAll("canvas");e=s.length+i.length+r.length;const n=a=>{t++,this._onLoadingCallback&&this._onLoadingCallback(a),t===e&&(this.sourcesReady=!0)};e||(this.sourcesReady=!0),s.length&&s.forEach(a=>{const h=this.createDOMTexture({name:a.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>n(h)).loadImage(a.src)}),i.length&&i.forEach(a=>{const h=this.createDOMTexture({name:a.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>n(h)).loadVideo(a)}),r.length&&r.forEach(a=>{const h=this.createDOMTexture({name:a.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>n(h)).loadCanvas(a)})}else this.sourcesReady=!0}resetDOMElement(e){e?super.resetDOMElement(e):!e&&!this.renderer.production&&_(`${this.options.label}: You are trying to reset a ${this.type} with a HTML element that does not exist. The old HTML element will be kept instead.`)}get pixelRatioBoundingRect(){const e=window.devicePixelRatio??1,t=this.renderer.pixelRatio/e;return Object.keys(this.domElement.boundingRect).reduce((s,i)=>({...s,[i]:this.domElement.boundingRect[i]*t}),{x:0,y:0,width:0,height:0,top:0,right:0,bottom:0,left:0})}computeGeometry(){super.computeGeometry(),this.boundingBox.copy(this.geometry.boundingBox)}onLoading(e){return e&&(this._onLoadingCallback=e),this}}class js extends rt{constructor(e,t={}){e=e&&e.renderer||e,A(e,t.label?t.label+" PingPongPlane":"PingPongPlane");const s=t.targets&&t.targets.length&&t.targets.map(i=>({targetFormat:i.format}));t.outputTarget=new Qt(e,{label:t.label?t.label+" render target":"Ping Pong render target",useDepth:!1,...s&&{colorAttachments:s}}),t.transparent=!1,t.depth=!1,t.label=t.label??"PingPongPlane "+e.pingPongPlanes?.length,super(e,t),this.type="PingPongPlane",this.createTexture({label:t.label?`${t.label} render texture`:"PingPongPlane render texture",name:"renderTexture",...t.targets&&t.targets.length&&{format:t.targets[0].format},usage:["copyDst","textureBinding"]})}get renderTexture(){return this.textures.find(e=>e.options.name==="renderTexture")}addToScene(e=!1){e&&this.renderer.pingPongPlanes.push(this),this.autoRender&&this.renderer.scene.addPingPongPlane(this)}removeFromScene(e=!1){this.outputTarget&&this.outputTarget.destroy(),this.autoRender&&this.renderer.scene.removePingPongPlane(this),e&&(this.renderer.pingPongPlanes=this.renderer.pingPongPlanes.filter(t=>t.uuid!==this.uuid))}}const qs={label:"Plane",instancesCount:1,vertexBuffers:[]};class ss extends ts{constructor(e,t,s={}){e=e&&e.renderer||e,Ne(e,s.label?s.label+" Plane":"Plane");const i={...qs,...s};let{geometry:r,widthSegments:n,heightSegments:a,...h}=i;const{instancesCount:u,vertexBuffers:d,...l}=h;if(!r||r.type!=="PlaneGeometry"){n=n??1,a=a??1;const c=n*a+n;d.length||(r=_e.getPlaneGeometryByID(c)),r?r.instancesCount=u:(r=new Je({widthSegments:n,heightSegments:a,instancesCount:u,vertexBuffers:d}),_e.addPlaneGeometry(r))}super(e,t,{geometry:r,...l}),this.type="Plane"}mouseToPlaneCoords(e=new P){const t={x:2*(e.x/this.renderer.boundingRect.width)-1,y:2*(1-e.y/this.renderer.boundingRect.height)-1},s=this.camera.position.clone(),i=new f(t.x,t.y,-.5);i.unproject(this.camera),i.sub(s).normalize();const r=new f(0,0,1);r.applyQuat(this.quaternion).normalize();const n=new f(0,0,0),a=r.dot(i);if(Math.abs(a)>=1e-4){const h=this.worldMatrix.getInverse().premultiply(this.camera.viewMatrix),u=this.worldTransformOrigin.clone().add(this.worldPosition),d=new f(this.worldPosition.x-u.x,this.worldPosition.y-u.y,this.worldPosition.z-u.z);d.applyQuat(this.quaternion),u.add(d);const l=r.dot(u.clone().sub(s))/a;n.copy(s.add(i.multiplyScalar(l))),n.applyMat4(h)}else n.set(1/0,1/0,1/0);return new P(n.x,n.y)}}class Ve extends lt{constructor({deviceManager:e,label:t,container:s,pixelRatio:i=1,autoResize:r=!0,preferredFormat:n,alphaMode:a="premultiplied",renderPass:h,camera:u}){super({deviceManager:e,label:t,container:s,pixelRatio:i,autoResize:r,preferredFormat:n,alphaMode:a,renderPass:h,camera:u}),this.type="GPUCurtainsRenderer"}setRendererObjects(){super.setRendererObjects(),this.domMeshes=[],this.domObjects=[]}onCameraMatricesChanged(){super.onCameraMatricesChanged(),this.domObjects.forEach(e=>{e.updateSizeAndPosition()})}resizeMeshes(){this.meshes.forEach(e=>{"domElement"in e||e.resize(this.boundingRect)}),this.domObjects.forEach(e=>{this.onBeforeCommandEncoderCreation.add(()=>{e.domElement.isResizing||e.domElement.setSize()},{once:!0})})}}class Ns{constructor({scroll:e={x:0,y:0},delta:t={x:0,y:0},shouldWatch:s=!0,onScroll:i=(r={x:0,y:0})=>{}}={}){this.scroll=e,this.delta=t,this.shouldWatch=s,this.onScroll=i,this.shouldWatch&&window.addEventListener("scroll",this.setScroll.bind(this),{passive:!0})}setScroll(){this.updateScrollValues({x:window.pageXOffset,y:window.pageYOffset})}updateScrollValues({x:e,y:t}){const s=this.scroll;this.scroll={x:e,y:t},this.delta={x:s.x-this.scroll.x,y:s.y-this.scroll.y},this.onScroll&&this.onScroll(this.delta)}destroy(){this.shouldWatch&&window.removeEventListener("scroll",this.setScroll.bind(this),{passive:!0})}}class Ys{constructor({container:e,label:t,pixelRatio:s=window.devicePixelRatio??1,preferredFormat:i,alphaMode:r="premultiplied",production:n=!1,adapterOptions:a={},renderPass:h,camera:u,autoRender:d=!0,autoResize:l=!0,watchScroll:c=!0}={}){this._onRenderCallback=()=>{},this._onScrollCallback=()=>{},this._onErrorCallback=()=>{},this._onContextLostCallback=()=>{},this.type="CurtainsGPU",this.options={container:e,label:t,pixelRatio:s,camera:u,production:n,adapterOptions:a,preferredFormat:i,alphaMode:r,renderPass:h,autoRender:d,autoResize:l,watchScroll:c},this.setDeviceManager(),e&&this.setContainer(e)}setContainer(e){if(e)if(typeof e=="string")if(e=document.querySelector(e),e)this.options.container=e;else{const t=document.createElement("div");t.setAttribute("id","curtains-gpu-canvas"),document.body.appendChild(t),this.options.container=t}else e instanceof Element&&(this.options.container=e);else{const t=document.createElement("div");t.setAttribute("id","curtains-gpu-canvas"),document.body.appendChild(t),this.options.container=t}this.container=this.options.container,this.setCurtains()}setMainRenderer(){this.createCurtainsRenderer({deviceManager:this.deviceManager,label:this.options.label,container:this.options.container,pixelRatio:this.options.pixelRatio,autoResize:this.options.autoResize,preferredFormat:this.options.preferredFormat,alphaMode:this.options.alphaMode,renderPass:this.options.renderPass,camera:this.options.camera})}patchRendererOptions(e){return e.pixelRatio===void 0&&(e.pixelRatio=this.options.pixelRatio),e.autoResize===void 0&&(e.autoResize=this.options.autoResize),e}createRenderer(e){return e=this.patchRendererOptions(e),new dt({...e,deviceManager:this.deviceManager})}createCameraRenderer(e){return e=this.patchRendererOptions(e),new lt({...e,deviceManager:this.deviceManager})}createCurtainsRenderer(e){return e=this.patchRendererOptions(e),new Ve({...e,deviceManager:this.deviceManager})}setDeviceManager(){this.deviceManager=new Xt({label:"GPUCurtains default device",production:this.options.production,adapterOptions:this.options.adapterOptions,onError:()=>setTimeout(()=>{this._onErrorCallback&&this._onErrorCallback()},0),onDeviceLost:e=>this._onContextLostCallback&&this._onContextLostCallback(e)})}get renderers(){return this.deviceManager.renderers}get renderer(){return this.renderers[0]}async setDevice({adapter:e=null,device:t=null}={}){await this.deviceManager.init({adapter:e,device:t})}async restoreContext(){await this.deviceManager.restoreDevice()}setCurtains(){this.initEvents(),this.setMainRenderer(),this.options.autoRender&&this.animate()}get pingPongPlanes(){return this.renderers?.map(e=>e.pingPongPlanes).flat()}get shaderPasses(){return this.renderers?.map(e=>e.shaderPasses).flat()}get meshes(){return this.renderers?.map(e=>e.meshes).flat()}get domMeshes(){return this.renderers?.filter(e=>e instanceof Ve).map(e=>e.domMeshes).flat()}get domObjects(){return this.renderers?.filter(e=>e instanceof Ve).map(e=>e.domObjects).flat()}get planes(){return this.domMeshes.filter(e=>e instanceof ss)}get computePasses(){return this.renderers?.map(e=>e.computePasses).flat()}get camera(){return this.renderer?.camera}setPerspective({fov:e=50,near:t=.01,far:s=50}={}){this.renderer?.setPerspective({fov:e,near:t,far:s})}setCameraPosition(e=new f(0,0,1)){this.renderer?.setCameraPosition(e)}get boundingRect(){return this.renderer?.boundingRect}initScroll(){this.scrollManager=new Ns({scroll:{x:window.pageXOffset,y:window.pageYOffset},delta:{x:0,y:0},shouldWatch:this.options.watchScroll,onScroll:e=>this.updateScroll(e)})}updateScroll(e={x:0,y:0}){this.domObjects.forEach(t=>{t.domElement&&t.updateScrollPosition(e)}),this._onScrollCallback&&this._onScrollCallback()}updateScrollValues(e={x:0,y:0}){this.scrollManager.updateScrollValues(e)}get scrollDelta(){return this.scrollManager.delta}get scrollValues(){return this.scrollManager.scroll}initEvents(){ht.useObserver(this.options.autoResize),this.initScroll()}onRender(e){return e&&(this._onRenderCallback=e),this}onScroll(e){return e&&(this._onScrollCallback=e),this}onError(e){return e&&(this._onErrorCallback=e),this}onContextLost(e){return e&&(this._onContextLostCallback=e),this}animate(){this.render(),this.animationFrameID=window.requestAnimationFrame(this.animate.bind(this))}render(){this._onRenderCallback&&this._onRenderCallback(),this.deviceManager.render()}destroy(){this.animationFrameID&&window.cancelAnimationFrame(this.animationFrameID),this.deviceManager.destroy(),this.scrollManager?.destroy(),ht.destroy()}}var is=(o,e,t)=>{if(!e.has(o))throw TypeError("Cannot "+t)},D=(o,e,t)=>(is(o,e,"read from private field"),t?t.call(o):e.get(o)),pt=(o,e,t)=>{if(e.has(o))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(o):e.set(o,t)},ft=(o,e,t,s)=>(is(o,e,"write to private field"),s?s.call(o,t):e.set(o,t),t),ce,xe,W;class Xs extends de{constructor(e,{camera:t=null,element:s=null}={}){super(),pt(this,ce,new P),pt(this,xe,!1),this.constrainXOrbit=!0,this.constrainYOrbit=!1,this.minOrbit=new P(-Math.PI*.5,-Math.PI),this.maxOrbit=new P(Math.PI*.5,Math.PI),this.orbitStep=new P(.025),this.constrainZoom=!0,this.minZoom=0,this.maxZoom=20,this.zoomStep=.005,pt(this,W,null),this.renderer=e,this.parent=this.renderer.scene,this.quaternion.setAxisOrder("YXZ"),this.camera=t||this.renderer.camera,this.camera.parent=this,this.element=s??this.renderer.domElement.element}set element(e){D(this,W)&&(!e||D(this,W)!==e)&&this.removeEvents(),ft(this,W,e),e&&this.addEvents()}get element(){return D(this,W)}addEvents(){D(this,W).addEventListener("pointerdown",this.onPointerDown.bind(this)),D(this,W).addEventListener("pointermove",this.onPointerMove.bind(this)),D(this,W).addEventListener("pointerup",this.onPointerUp.bind(this)),D(this,W).addEventListener("wheel",this.onMouseWheel.bind(this))}removeEvents(){D(this,W).removeEventListener("pointerdown",this.onPointerDown.bind(this)),D(this,W).removeEventListener("pointermove",this.onPointerMove.bind(this)),D(this,W).removeEventListener("pointerup",this.onPointerUp.bind(this)),D(this,W).removeEventListener("wheel",this.onMouseWheel.bind(this))}onPointerDown(e){e.isPrimary&&ft(this,xe,!0),D(this,ce).set(e.pageX,e.pageY)}onPointerMove(e){let t,s;document.pointerLockElement?(t=e.movementX,s=e.movementY,this.orbit(t*this.orbitStep.x,s*this.orbitStep.y)):D(this,xe)&&(t=e.pageX-D(this,ce).x,s=e.pageY-D(this,ce).y,D(this,ce).set(e.pageX,e.pageY),this.orbit(t*this.orbitStep.x,s*this.orbitStep.y))}onPointerUp(e){e.isPrimary&&ft(this,xe,!1)}onMouseWheel(e){this.zoom(this.position.z+e.deltaY*this.zoomStep),e.preventDefault()}reset(){this.position.set(0),this.rotation.set(0)}orbit(e,t){if(e||t){if(this.rotation.y-=e,this.constrainYOrbit)this.rotation.y=Math.min(Math.max(this.rotation.y,this.minOrbit.y),this.maxOrbit.y);else{for(;this.rotation.y<-Math.PI;)this.rotation.y+=Math.PI*2;for(;this.rotation.y>=Math.PI;)this.rotation.y-=Math.PI*2}if(this.rotation.x-=t,this.constrainXOrbit)this.rotation.x=Math.min(Math.max(this.rotation.x,this.minOrbit.x),this.maxOrbit.x);else{for(;this.rotation.x<-Math.PI;)this.rotation.x+=Math.PI*2;for(;this.rotation.x>=Math.PI;)this.rotation.x-=Math.PI*2}}}zoom(e){this.position.z=e,this.constrainZoom&&(this.position.z=Math.min(Math.max(this.position.z,this.minZoom),this.maxZoom))}updateModelMatrix(){this.modelMatrix.identity().rotateFromQuaternion(this.quaternion).translate(this.position),this.shouldUpdateWorldMatrix()}destroy(){this.camera.parent=this.renderer.scene,this.parent=null,this.element=null}}ce=new WeakMap,xe=new WeakMap,W=new WeakMap;class Ks extends Ue{constructor({instancesCount:e=1,vertexBuffers:t=[],topology:s,mapBuffersAtCreation:i=!0,widthSegments:r=1,heightSegments:n=1,depthSegments:a=1}={}){super({verticesOrder:"ccw",topology:s,instancesCount:e,vertexBuffers:t,mapBuffersAtCreation:i}),this.type="BoxGeometry",r=Math.floor(r),n=Math.floor(n),a=Math.floor(a);const h=[],u=[],d=[],l=[];let c=0;const p=(g,m,b,y,M,C,T,v,B,w)=>{const S=C/B,G=T/w,R=C/2,Z=T/2,ee=v/2,q=B+1,te=w+1;let Q=0;const O=new f;for(let U=0;U<te;U++){const k=U*G-Z;for(let j=0;j<q;j++){const Y=j*S-R;O[g]=Y*y,O[m]=k*M,O[b]=ee,h.push(O.x,O.y,O.z),O[g]=0,O[m]=0,O[b]=v>0?1:-1,d.push(O.x,O.y,O.z),u.push(j/B),u.push(U/w),Q+=1}}for(let U=0;U<w;U++)for(let k=0;k<B;k++){const j=c+k+q*U,Y=c+k+q*(U+1),pe=c+(k+1)+q*(U+1),rs=c+(k+1)+q*U;l.push(j,Y,rs),l.push(Y,pe,rs),c+=Q}};p("z","y","x",-1,-1,2,2,2,a,n),p("z","y","x",1,-1,2,2,-2,a,n),p("x","z","y",1,1,2,2,2,r,a),p("x","z","y",1,-1,2,2,-2,r,a),p("x","y","z",1,-1,2,2,2,r,n),p("x","y","z",-1,-1,2,2,-2,r,n),this.setAttribute({name:"position",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(h)}),this.setAttribute({name:"uv",type:"vec2f",bufferFormat:"float32x2",size:2,array:new Float32Array(u)}),this.setAttribute({name:"normal",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(d)}),this.setIndexBuffer({array:this.useUint16IndexArray?new Uint16Array(l):new Uint32Array(l),bufferFormat:this.useUint16IndexArray?"uint16":"uint32"})}}class Zs extends Ue{constructor({topology:e,instancesCount:t=1,vertexBuffers:s=[],mapBuffersAtCreation:i=!0,widthSegments:r=32,heightSegments:n=16,phiStart:a=0,phiLength:h=Math.PI*2,thetaStart:u=0,thetaLength:d=Math.PI}={}){super({verticesOrder:"ccw",topology:e,instancesCount:t,vertexBuffers:s,mapBuffersAtCreation:i}),this.type="SphereGeometry",r=Math.max(3,Math.floor(r)),n=Math.max(2,Math.floor(n));const l=1,c=Math.min(u+d,Math.PI);let p=0;const g=[],m=new f,b=new f,y=[],M=[],C=[],T=[];for(let v=0;v<=n;v++){const B=[],w=v/n;let S=0;v===0&&u===0?S=.5/r:v===n&&c===Math.PI&&(S=-.5/r);for(let G=0;G<=r;G++){const R=G/r;m.x=-l*Math.cos(a+R*h)*Math.sin(u+w*d),m.y=l*Math.cos(u+w*d),m.z=l*Math.sin(a+R*h)*Math.sin(u+w*d),M.push(m.x,m.y,m.z),b.copy(m).normalize(),C.push(b.x,b.y,b.z),T.push(R+S,w),B.push(p++)}g.push(B)}for(let v=0;v<n;v++)for(let B=0;B<r;B++){const w=g[v][B+1],S=g[v][B],G=g[v+1][B],R=g[v+1][B+1];(v!==0||u>0)&&y.push(w,S,R),(v!==n-1||c<Math.PI)&&y.push(S,G,R)}this.setAttribute({name:"position",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(M)}),this.setAttribute({name:"uv",type:"vec2f",bufferFormat:"float32x2",size:2,array:new Float32Array(T)}),this.setAttribute({name:"normal",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(C)}),this.setIndexBuffer({array:this.useUint16IndexArray?new Uint16Array(y):new Uint32Array(y),bufferFormat:this.useUint16IndexArray?"uint16":"uint32"})}}const Qs=o=>{const{scene:e}=o;if(!e)return;const t=[];e.computePassEntries.forEach(s=>{t.push({command:"Render ComputePass",content:s.options.label}),s.material.bindGroups.forEach(i=>{i.bufferBindings.forEach(r=>{r.shouldCopyResult&&t.push({command:"Copy buffer to buffer",source:`${r.name} buffer`,destination:`${r.name} result buffer`})})})});for(const s in e.renderPassEntries){let i=0;e.renderPassEntries[s].forEach(r=>{if(!e.getRenderPassEntryLength(r))return;const n=r.renderPass.options.useColorAttachments?r.renderPass.options.colorAttachments.length===0&&r.renderPass.options.useDepth?`${r.renderTexture.options.label} depth pass`:r.renderPass.options.colorAttachments.length>1?`${r.renderTexture.options.label} multiple targets`:r.renderTexture?`${r.renderTexture.options.label}`:"Context current texture":void 0;let a=r.renderPass.options.label;const h={loadOp:r.renderPass.options.useColorAttachments?s==="screen"&&i>0?"load":r.renderPass.options.loadOp:void 0,depthLoadOp:void 0,sampleCount:r.renderPass.options.sampleCount,...r.renderPass.options.qualityRatio!==1&&{qualityRatio:r.renderPass.options.qualityRatio}};if(r.renderPass.options.useDepth&&(h.depthLoadOp=r.renderPass.options.depthLoadOp),i++,r.element)r.element.type==="ShaderPass"&&!(r.element.inputTarget||r.element.outputTarget)&&(t.push({command:"Copy texture to texture",source:n,destination:`${r.element.options.label} renderTexture`}),h.loadOp="clear"),a+=" "+JSON.stringify(h),t.push({command:`Render ${r.element.type}`,source:r.element.options.label,destination:n,descriptor:a}),r.element.type==="ShaderPass"&&!r.element.outputTarget&&r.element.options.copyOutputToRenderTexture?t.push({command:"Copy texture to texture",source:n,destination:`${r.element.options.label} renderTexture`}):r.element.type==="PingPongPlane"&&t.push({command:"Copy texture to texture",source:n,destination:`${r.element.renderTexture.options.label}`});else if(r.stack){a+=" "+JSON.stringify(h);for(const u in r.stack)for(const d in r.stack[u])r.stack[u][d].length&&t.push({command:`Render stack (${u} ${d} objects)`,source:r.stack[u][d],destination:n,descriptor:a})}})}console.table(t)};x.BindGroup=Be,x.Binding=we,x.Box3=ne,x.BoxGeometry=Ks,x.Buffer=he,x.BufferBinding=ue,x.Camera=Pt,x.ComputeMaterial=zt,x.ComputePass=Cs,x.ComputePipelineEntry=Wt,x.DOMElement=ut,x.DOMFrustum=Ot,x.DOMMesh=ts,x.DOMObject3D=Jt,x.DOMTexture=re,x.FullscreenPlane=rt,x.GPUCameraRenderer=lt,x.GPUCurtains=Ys,x.GPUCurtainsRenderer=Ve,x.GPUDeviceManager=Xt,x.GPURenderer=dt,x.Geometry=At,x.IndexedGeometry=Ue,x.Mat3=J,x.Mat4=E,x.Material=He,x.Mesh=Gs,x.Object3D=de,x.OrbitControls=Xs,x.PingPongPlane=js,x.PipelineEntry=ot,x.PipelineManager=jt,x.Plane=ss,x.PlaneGeometry=Je,x.ProjectedObject3D=nt,x.Quat=X,x.RenderMaterial=_t,x.RenderPass=Fe,x.RenderPipelineEntry=at,x.RenderTarget=Qt,x.Sampler=Ct,x.SamplerBinding=Bt,x.Scene=qt,x.ShaderPass=Is,x.SphereGeometry=Zs,x.Texture=H,x.TextureBindGroup=Qe,x.TextureBinding=Ze,x.Vec2=P,x.Vec3=f,x.WritableBufferBinding=Ke,x.logSceneCommands=Qs});
