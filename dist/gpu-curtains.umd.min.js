(function(y,V){typeof exports=="object"&&typeof module<"u"?V(exports):typeof define=="function"&&define.amd?define(["exports"],V):(y=typeof globalThis<"u"?globalThis:y||self,V(y.window=y.window||{}))})(this,function(y){"use strict";const V=()=>"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,n=>{const e=Math.random()*16|0;return(n==="x"?e:e&3|8).toString(16).toUpperCase()}),Le=n=>n.replace(/(?:^\w|[A-Z]|\b\w)/g,(e,t)=>t===0?e.toLowerCase():e.toUpperCase()).replace(/\s+/g,""),Oe=n=>{const e=Le(n);return e.charAt(0).toUpperCase()+e.slice(1)};let Ot=0;const F=n=>{Ot>100||(console.warn(Ot===100?"GPUCurtains: too many warnings thrown, stop logging.":n),Ot++)},Z=n=>{throw new Error(n)},Gt=(n,e="GPURenderer",t)=>{const i=t?`Unable to create ${t} because the ${e} is not defined: ${n}`:`The ${e} is not defined: ${n}`;Z(i)},I=(n,e)=>(n=n&&n.renderer||n,n&&(n.type==="GPURenderer"||n.type==="GPUCameraRenderer"||n.type==="GPUCurtainsRenderer")||Gt(n,"GPURenderer",e),n),Ce=(n,e)=>(n=n&&n.renderer||n,n&&(n.type==="GPUCameraRenderer"||n.type==="GPUCurtainsRenderer")||Gt(n,"GPUCameraRenderer",e),n),_t=(n,e)=>(n=n&&n.renderer||n,n&&n.type==="GPUCurtainsRenderer"||Gt(n,"GPUCurtainsRenderer",e),n),At=(()=>{let n,e;const t={};return function(s,r){e||(e=s.createShaderModule({label:"textured quad shaders for mip level generation",code:`
            struct VSOutput {
...
`,Ji=n=>{const e=n.shadowCastingLights.filter(t=>t.type==="directionalLights");return`
...
fn getPCFPointShadowContribution(index: i32, shadowPosition: vec4f, depthCubeTexture: texture_depth_cube) -> f32 {
  ...
  return visibility;
}`,ss=n=>{const e=n.shadowCastingLights.filter(t=>t.type==="pointLights");return`
...
`;var Zt=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},U=(n,e,t)=>(Zt(n,e,"read from private field"),t?t.call(n):e.get(n)),le=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},te=(n,e,t,i)=>(Zt(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),rs=(n,e,t)=>(Zt(n,e,"access private method"),t),ct,pt,ft,mt,gt,$e,Te,re,ge,xt,Kt;const ns={isActive:{type:"i32",value:0},pcfSamples:{type:"i32",value:0},bias:{type:"f32",value:0},normalBias:{type:"f32",value:0},intensity:{type:"f32",value:0}};class os{constructor(e,{light:t,intensity:i=1,bias:s=0,normalBias:r=0,pcfSamples:o=1,depthTextureSize:a=new z(512),depthTextureFormat:h="depth24plus",autoRender:l=!0}={}){le(this,xt),le(this,ct,void 0),le(this,pt,void 0),le(this,ft,void 0),le(this,mt,void 0),le(this,gt,void 0),le(this,$e,void 0),le(this,Te,void 0),le(this,re,void 0),le(this,ge,void 0),e=Ce(e,this.constructor.name),this.renderer=e,this.rendererBinding=null,this.light=t,this.index=this.light.index,this.options={light:t,intensity:i,bias:s,normalBias:r,pcfSamples:o,depthTextureSize:a,depthTextureFormat:h},this.sampleCount=1,this.meshes=new Map,te(this,Te,new Map),te(this,re,new Map),te(this,ge,null),rs(this,xt,Kt).call(this,{intensity:i,bias:s,normalBias:r,pcfSamples:o,depthTextureSize:a,depthTextureFormat:h,autoRender:l}),this.isActive=!1}cast({intensity:e,bias:t,normalBias:i,pcfSamples:s,depthTextureSize:r,depthTextureFormat:o,autoRender:a}={}){rs(this,xt,Kt).call(this,{intensity:e,bias:t,normalBias:i,pcfSamples:s,depthTextureSize:r,depthTextureFormat:o,autoRender:a}),this.isActive=!0}setRendererBinding(){}reset(){this.isActive&&(this.onPropertyChanged("isActive",1),this.onPropertyChanged("intensity",this.intensity),this.onPropertyChanged("bias",this.bias),this.onPropertyChanged("normalBias",this.normalBias),this.onPropertyChanged("pcfSamples",this.pcfSamples))}get isActive(){return U(this,gt)}set isActive(e){!e&&this.isActive?this.destroy():e&&!this.isActive&&this.init(),te(this,gt,e)}get intensity(){return U(this,ct)}set intensity(e){te(this,ct,e),this.onPropertyChanged("intensity",this.intensity)}get bias(){return U(this,pt)}set bias(e){te(this,pt,e),this.onPropertyChanged("bias",this.bias)}get normalBias(){return U(this,ft)}set normalBias(e){te(this,ft,e),this.onPropertyChanged("normalBias",this.normalBias)}get pcfSamples(){return U(this,mt)}set pcfSamples(e){te(this,mt,Math.max(1,Math.ceil(e))),this.onPropertyChanged("pcfSamples",this.pcfSamples)}init(){if(!this.depthComparisonSampler){const e=this.renderer.samplers.find(t=>t.name==="depthComparisonSampler");this.depthComparisonSampler=e||new Pe(this.renderer,{label:"Depth comparison sampler",name:"depthComparisonSampler",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",compare:"less",minFilter:"linear",magFilter:"linear",type:"comparison"})}this.setDepthTexture(),this.depthPassTarget||this.createDepthPassTarget(),U(this,ge)===null&&U(this,$e)&&(this.setDepthPass(),this.onPropertyChanged("isActive",1))}onDepthTextureSizeChanged(){this.setDepthTexture()}setDepthTexture(){this.depthTexture&&(this.depthTexture.size.width!==this.depthTextureSize.x||this.depthTexture.size.height!==this.depthTextureSize.y)?(this.depthTexture.options.fixedSize.width=this.depthTextureSize.x,this.depthTexture.options.fixedSize.height=this.depthTextureSize.y,this.depthTexture.size.width=this.depthTextureSize.x,this.depthTexture.size.height=this.depthTextureSize.y,this.depthTexture.createTexture(),this.depthPassTarget&&this.depthPassTarget.resize()):this.depthTexture||this.createDepthTexture()}createDepthTexture(){this.depthTexture=new ee(this.renderer,{label:"Shadow depth texture "+this.index,name:"shadowDepthTexture"+this.index,type:"depth",format:this.depthTextureFormat,sampleCount:this.sampleCount,fixedSize:{width:this.depthTextureSize.x,height:this.depthTextureSize.y},autoDestroy:!1})}createDepthPassTarget(){this.depthPassTarget=new jt(this.renderer,{label:"Depth pass render target for "+this.constructor.name+" "+this.index,useColorAttachments:!1,depthTexture:this.depthTexture,sampleCount:this.sampleCount})}onPropertyChanged(e,t){if(this.rendererBinding){if(t instanceof L){for(let i=0;i<t.elements.length;i++)this.rendererBinding.bindings[this.index].inputs[e].value[i]=t.elements[i];this.rendererBinding.bindings[this.index].inputs[e].shouldUpdate=!0}else this.rendererBinding.bindings[this.index].inputs[e].value=t;this.renderer.shouldUpdateCameraLightsBindGroup()}}setDepthPass(){te(this,ge,this.render())}removeDepthPass(e){this.renderer.onBeforeRenderScene.remove(e)}render(e=!1){return this.renderer.onBeforeRenderScene.add(t=>{this.meshes.size&&(this.useDepthMaterials(),this.renderDepthPass(t),this.useOriginalMaterials(),this.renderer.pipelineManager.resetCurrentPipeline())},{once:e,order:this.index})}async renderOnce(){U(this,$e)||(this.onPropertyChanged("isActive",1),this.useDepthMaterials(),this.meshes.forEach(e=>{e.setGeometry()}),await Promise.all([...U(this,re).values()].map(async e=>{await e.compileMaterial()})),this.render(!0))}renderDepthPass(e){this.renderer.pipelineManager.resetCurrentPipeline();const t=e.beginRenderPass(this.depthPassTarget.renderPass.descriptor);this.meshes.forEach(i=>{i.render(t)}),t.end()}getDefaultShadowDepthVs(e=!1){return Ki(this.index,e)}getDefaultShadowDepthFs(){return!1}patchShadowCastingMeshParams(e,t={}){t={...e.material.options.rendering,...t},t.targets=[],t.sampleCount=this.sampleCount,t.depthFormat=this.depthTextureFormat,t.bindings?t.bindings=[e.material.getBufferBindingByName("matrices"),...t.bindings]:t.bindings=[e.material.getBufferBindingByName("matrices")];const i=e.material.inputsBindings.get("instances")&&e.geometry.instancesCount>1;return t.shaders||(t.shaders={vertex:{code:this.getDefaultShadowDepthVs(i)},fragment:this.getDefaultShadowDepthFs()}),t}addShadowCastingMesh(e,t={}){e.options.castShadows=!0,U(this,Te).set(e.uuid,e.material),t=this.patchShadowCastingMeshParams(e,t),U(this,re).get(e.uuid)&&(U(this,re).get(e.uuid).destroy(),U(this,re).delete(e.uuid)),U(this,re).set(e.uuid,new Ht(this.renderer,{label:e.options.label+" depth render material",...t})),this.meshes.set(e.uuid,e)}useDepthMaterials(){this.meshes.forEach(e=>{e.useMaterial(U(this,re).get(e.uuid))})}useOriginalMaterials(){this.meshes.forEach(e=>{e.useMaterial(U(this,Te).get(e.uuid))})}removeMesh(e){const t=U(this,re).get(e.uuid);t&&(t.destroy(),U(this,re).delete(e.uuid)),this.meshes.delete(e.uuid)}destroy(){this.onPropertyChanged("isActive",0),U(this,ge)!==null&&(this.removeDepthPass(U(this,ge)),te(this,ge,null)),this.meshes.forEach(e=>this.removeMesh(e)),te(this,Te,new Map),te(this,re,new Map),this.meshes=new Map,this.depthPassTarget?.destroy(),this.depthTexture?.destroy()}}ct=new WeakMap,pt=new WeakMap,ft=new WeakMap,mt=new WeakMap,gt=new WeakMap,$e=new WeakMap,Te=new WeakMap,re=new WeakMap,ge=new WeakMap,xt=new WeakSet,Kt=function({intensity:n=1,bias:e=0,normalBias:t=0,pcfSamples:i=1,depthTextureSize:s=new z(512),depthTextureFormat:r="depth24plus",autoRender:o=!0}={}){this.intensity=n,this.bias=e,this.normalBias=t,this.pcfSamples=i,this.depthTextureSize=s,this.depthTextureSize.onChange(()=>this.onDepthTextureSizeChanged()),this.depthTextureFormat=r,te(this,$e,o)};const Br={...ns,viewMatrix:{type:"mat4x4f",value:new Float32Array(16)},projectionMatrix:{type:"mat4x4f",value:new Float32Array(16)}};class Pr extends os{constructor(e,{light:t,intensity:i,bias:s,normalBias:r,pcfSamples:o,depthTextureSize:a,depthTextureFormat:h,autoRender:l,camera:u={left:-10,right:10,bottom:-10,top:10,near:.1,far:50}}={}){super(e,{light:t,intensity:i,bias:s,normalBias:r,pcfSamples:o,depthTextureSize:a,depthTextureFormat:h,autoRender:l}),this.options={...this.options,camera:u},this.setRendererBinding(),this.camera={projectionMatrix:new L,viewMatrix:new L,up:new f(0,1,0),_left:u.left,_right:u.right,_bottom:u.bottom,_top:u.top,_near:u.near,_far:u.far};const d=this;["left","right","bottom","top","near","far"].forEach(p=>{Object.defineProperty(d.camera,p,{get(){return d.camera["_"+p]},set(g){d.camera["_"+p]=g,d.updateProjectionMatrix()}})})}setRendererBinding(){this.rendererBinding=this.renderer.bindings.directionalShadows}cast({intensity:e,bias:t,normalBias:i,pcfSamples:s,depthTextureSize:r,depthTextureFormat:o,autoRender:a,camera:h}={}){h&&(this.camera.left=h.left??-10,this.camera.right=h.right??10,this.camera.bottom=h.bottom??-10,this.camera.top=h.right??10,this.camera.near=h.near??.1,this.camera.far=h.far??50),super.cast({intensity:e,bias:t,normalBias:i,pcfSamples:s,depthTextureSize:r,depthTextureFormat:o,autoRender:a})}init(){super.init(),this.updateProjectionMatrix()}reset(){this.setRendererBinding(),super.reset(),this.onPropertyChanged("projectionMatrix",this.camera.projectionMatrix),this.onPropertyChanged("viewMatrix",this.camera.viewMatrix)}updateProjectionMatrix(){this.camera.projectionMatrix.identity().makeOrthographic({left:this.camera.left,right:this.camera.right,bottom:this.camera.bottom,top:this.camera.top,near:this.camera.near,far:this.camera.far}),this.onPropertyChanged("projectionMatrix",this.camera.projectionMatrix)}updateViewMatrix(e=new f,t=new f){this.camera.viewMatrix.makeView(e,t,this.camera.up),this.onPropertyChanged("viewMatrix",this.camera.viewMatrix)}}var as=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},yt=(n,e,t)=>(as(n,e,"read from private field"),t?t.call(n):e.get(n)),hs=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},ls=(n,e,t,i)=>(as(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),Ie,ke;let us=0;class ds extends Wt{constructor(e,{color:t=new f(1),intensity:i=1,position:s=new f(1),target:r=new f,shadow:o=null}={}){super(e,{color:t,intensity:i,index:us++,type:"directionalLights"}),hs(this,Ie,void 0),hs(this,ke,void 0),this.options={...this.options,position:s,target:r,shadow:o},ls(this,ke,new f),ls(this,Ie,new f),this.target=r,this.target.onChange(()=>this.setDirection()),this.position.copy(s),this.parent=this.renderer.scene,this.index+1>this.renderer.lightsBindingParams[this.type].max&&this.onMaxLightOverflow(this.type),this.rendererBinding.inputs.count.value=us,this.rendererBinding.inputs.count.shouldUpdate=!0,this.shadow=new Pr(this.renderer,{autoRender:!1,light:this}),o&&this.shadow.cast(o)}reset(){super.reset(),this.setDirection(),this.shadow?.reset()}setDirection(){yt(this,ke).copy(this.target).sub(this.worldMatrix.getTranslation(yt(this,Ie))),this.onPropertyChanged("direction",yt(this,ke)),this.shadow?.updateViewMatrix(yt(this,Ie),this.target)}applyScale(){}applyTransformOrigin(){}updateMatrixStack(){super.updateMatrixStack(),this.matricesNeedUpdate&&this.setDirection()}onMaxLightOverflow(e){super.onMaxLightOverflow(e),this.shadow?.setRendererBinding()}destroy(){super.destroy(),this.shadow.destroy()}}Ie=new WeakMap,ke=new WeakMap;var cs=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},ps=(n,e,t)=>(cs(n,e,"read from private field"),t?t.call(n):e.get(n)),Sr=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},Tr=(n,e,t,i)=>(cs(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),Ve;const Rr={face:{type:"i32",value:0},...ns,cameraNear:{type:"f32",value:0},cameraFar:{type:"f32",value:0},projectionMatrix:{type:"mat4x4f",value:new Float32Array(16)},viewMatrices:{type:"array<mat4x4f>",value:new Float32Array(16*6)}};class zr extends os{constructor(e,{light:t,intensity:i,bias:s,normalBias:r,pcfSamples:o,depthTextureSize:a,depthTextureFormat:h,autoRender:l,camera:u={near:.1,far:t.range||150}}={}){super(e,{light:t,intensity:i,bias:s,normalBias:r,pcfSamples:o,depthTextureSize:a,depthTextureFormat:h,autoRender:l}),Sr(this,Ve,void 0),this.options={...this.options,camera:u},this.setRendererBinding(),this.cubeDirections=[new f(-1,0,0),new f(1,0,0),new f(0,-1,0),new f(0,1,0),new f(0,0,-1),new f(0,0,1)],Tr(this,Ve,new f),this.cubeUps=[new f(0,-1,0),new f(0,-1,0),new f(0,0,1),new f(0,0,-1),new f(0,-1,0),new f(0,-1,0)],this.camera={projectionMatrix:new L,viewMatrices:[],_near:u.near,_far:u.far};for(let p=0;p<6;p++)this.camera.viewMatrices.push(new L);const d=this;["near","far"].forEach(p=>{Object.defineProperty(d.camera,p,{get(){return d.camera["_"+p]},set(g){d.camera["_"+p]=g,d.updateProjectionMatrix()}})})}setRendererBinding(){this.rendererBinding=this.renderer.bindings.pointShadows}cast({intensity:e,bias:t,normalBias:i,pcfSamples:s,depthTextureSize:r,depthTextureFormat:o,autoRender:a,camera:h}={}){h&&(this.camera.near=h.near??.1,this.camera.far=h.far??this.light.range),super.cast({intensity:e,bias:t,normalBias:i,pcfSamples:s,depthTextureSize:r,depthTextureFormat:o,autoRender:a})}init(){super.init(),this.updateProjectionMatrix()}reset(){this.setRendererBinding(),super.reset(),this.onPropertyChanged("cameraNear",this.camera.near),this.onPropertyChanged("cameraFar",this.camera.far),this.onPropertyChanged("projectionMatrix",this.camera.projectionMatrix),this.updateViewMatrices()}updateProjectionMatrix(){this.camera.projectionMatrix.identity().makePerspective({near:this.camera.near,far:this.camera.far,fov:90,aspect:1}),this.onPropertyChanged("projectionMatrix",this.camera.projectionMatrix),this.onPropertyChanged("cameraNear",this.camera.near),this.onPropertyChanged("cameraFar",this.camera.far)}updateViewMatrices(e=new f){for(let t=0;t<6;t++){ps(this,Ve).copy(this.cubeDirections[t]).add(e),this.camera.viewMatrices[t].makeView(e,ps(this,Ve),this.cubeUps[t]);for(let i=0;i<16;i++)this.rendererBinding.bindings[this.index].inputs.viewMatrices.value[t*16+i]=this.camera.viewMatrices[t].elements[i]}this.rendererBinding.bindings[this.index].inputs.viewMatrices.shouldUpdate=!0}setDepthTexture(){if(this.depthTexture&&(this.depthTexture.size.width!==this.depthTextureSize.x||this.depthTexture.size.height!==this.depthTextureSize.y)){const e=Math.max(this.depthTextureSize.x,this.depthTextureSize.y);this.depthTexture.options.fixedSize.width=e,this.depthTexture.options.fixedSize.height=e,this.depthTexture.size.width=e,this.depthTexture.size.height=e,this.depthTexture.createTexture(),this.depthPassTarget&&this.depthPassTarget.resize()}else this.depthTexture||this.createDepthTexture()}createDepthTexture(){const e=Math.max(this.depthTextureSize.x,this.depthTextureSize.y);this.depthTexture=new ee(this.renderer,{label:"Point shadow cube depth texture "+this.index,name:"pointShadowCubeDepthTexture"+this.index,type:"depth",format:this.depthTextureFormat,viewDimension:"cube",sampleCount:this.sampleCount,fixedSize:{width:e,height:e},autoDestroy:!1})}removeDepthPass(e){this.renderer.onBeforeCommandEncoderCreation.remove(e)}render(e=!1){return this.renderer.onBeforeCommandEncoderCreation.add(()=>{if(this.meshes.size){this.useDepthMaterials();for(let t=0;t<6;t++){const i=this.renderer.device.createCommandEncoder();this.depthPassTarget.renderPass.setRenderPassDescriptor(this.depthTexture.texture.createView({label:this.depthTexture.texture.label+" cube face view "+t,dimension:"2d",arrayLayerCount:1,baseArrayLayer:t})),this.rendererBinding.bindings[this.index].inputs.face.value=t,this.renderer.cameraLightsBindGroup.update(),this.renderDepthPass(i);const s=i.finish();this.renderer.device.queue.submit([s])}this.useOriginalMaterials(),this.renderer.pipelineManager.resetCurrentPipeline()}},{once:e,order:this.index})}getDefaultShadowDepthVs(e=!1){return es(this.index,e)}getDefaultShadowDepthFs(){return{code:ts(this.index)}}}Ve=new WeakMap;var fs=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},Qt=(n,e,t)=>(fs(n,e,"read from private field"),t?t.call(n):e.get(n)),ms=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},gs=(n,e,t,i)=>(fs(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),vt,Ne;let xs=0;class ys extends Wt{constructor(e,{color:t=new f(1),intensity:i=1,position:s=new f,range:r=0,shadow:o=null}={}){super(e,{color:t,intensity:i,index:xs++,type:"pointLights"}),ms(this,vt,void 0),ms(this,Ne,void 0),this.options={...this.options,position:s,range:r,shadow:o},gs(this,Ne,new f),this.position.copy(s),this.range=r,this.parent=this.renderer.scene,this.index+1>this.renderer.lightsBindingParams[this.type].max&&this.onMaxLightOverflow(this.type),this.rendererBinding.inputs.count.value=xs,this.rendererBinding.inputs.count.shouldUpdate=!0,this.shadow=new zr(this.renderer,{autoRender:!1,light:this}),o&&this.shadow.cast(o)}reset(){super.reset(),this.onPropertyChanged("range",this.range),this.setPosition(),this.shadow?.reset()}get range(){return Qt(this,vt)}set range(e){gs(this,vt,e),this.onPropertyChanged("range",this.range)}setPosition(){this.onPropertyChanged("position",this.worldMatrix.getTranslation(Qt(this,Ne))),this.shadow?.updateViewMatrices(Qt(this,Ne))}applyScale(){}applyTransformOrigin(){}updateMatrixStack(){super.updateMatrixStack(),this.matricesNeedUpdate&&this.setPosition()}onMaxLightOverflow(e){super.onMaxLightOverflow(e),this.shadow?.setRendererBinding()}destroy(){super.destroy(),this.shadow.destroy()}}vt=new WeakMap,Ne=new WeakMap;var vs=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},Jt=(n,e,t)=>(vs(n,e,"read from private field"),t?t.call(n):e.get(n)),Er=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},Lr=(n,e,t,i)=>(vs(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t);let Or=0;const ws={autoRender:!0,useProjection:!1,useAsyncPipeline:!0,cullMode:"back",depth:!0,depthWriteEnabled:!0,depthCompare:"less",depthFormat:"depth24plus",transparent:!1,visible:!0,renderOrder:0,texturesOptions:{}};function bs(n){var e,t;return t=class extends n{constructor(...i){super(i[0],i[1],{...ws,...i[2]}),Er(this,e,!0),this._onReadyCallback=()=>{},this._onBeforeRenderCallback=()=>{},this._onRenderCallback=()=>{},this._onAfterRenderCallback=()=>{},this._onAfterResizeCallback=()=>{};let s=i[0];const r={...ws,...i[2]};this.type="MeshBase",this.uuid=V(),Object.defineProperty(this,"index",{value:Or++}),s=I(s,r.label?r.label+" "+this.type:this.type),this.renderer=s;const{label:o,shaders:a,geometry:h,visible:l,renderOrder:u,outputTarget:d,texturesOptions:c,autoRender:p,...g}=r;this.outputTarget=d??null,g.sampleCount=g.sampleCount?g.sampleCount:this.outputTarget?this.outputTarget.renderPass.options.sampleCount:this.renderer&&this.renderer.renderPass?this.renderer.renderPass.options.sampleCount:1,this.options={...this.options??{},label:o??"Mesh "+this.renderer.meshes.length,...a!==void 0?{shaders:a}:{},...d!==void 0&&{outputTarget:d},texturesOptions:c,...p!==void 0&&{autoRender:p},...g},p!==void 0&&Lr(this,e,p),this.visible=l,this.renderOrder=u,this.ready=!1,this.userData={},h&&this.useGeometry(h),this.setMaterial({...this.cleanupRenderMaterialParameters({...this.options}),...h&&{verticesOrder:h.verticesOrder,topology:h.topology}}),this.addToScene(!0)}get autoRender(){return Jt(this,e)}get ready(){return this._ready}set ready(i){i&&!this._ready&&this._onReadyCallback&&this._onReadyCallback(),this._ready=i}addToScene(i=!1){i&&this.renderer.meshes.push(this),this.setRenderingOptionsForRenderPass(this.outputTarget?this.outputTarget.renderPass:this.renderer.renderPass),Jt(this,e)&&this.renderer.scene.addMesh(this)}removeFromScene(i=!1){Jt(this,e)&&this.renderer.scene.removeMesh(this),i&&(this.renderer.meshes=this.renderer.meshes.filter(s=>s.uuid!==this.uuid))}setRenderer(i){if(i=i&&i.renderer||i,!i||!(i.type==="GPURenderer"||i.type==="GPUCameraRenderer"||i.type==="GPUCurtainsRenderer")){F(`${this.options.label}: Cannot set ${i} as a renderer because it is not of a valid Renderer type.`);return}const s=this.renderer;this.removeFromScene(!0),this.renderer=i,this.addToScene(!0),s.meshes.length||s.onBeforeRenderScene.add(r=>{s.forceClear(r)},{once:!0})}setOutputTarget(i){if(i&&i.type!=="RenderTarget"){F(`${this.options.label??this.type}: outputTarget is not a RenderTarget: ${i}`);return}this.removeFromScene(),this.outputTarget=i,this.addToScene()}loseContext(){this.ready=!1,this.geometry.loseContext(),this.material.loseContext()}restoreContext(){this.geometry.restoreContext(this.renderer),this.material.restoreContext()}setShaders(){const{shaders:i}=this.options;i?((!i.vertex||!i.vertex.code)&&(i.vertex={code:Yt,entryPoint:"main"}),(i.fragment===void 0||i.fragment&&!i.fragment.code)&&(i.fragment={code:Xt,entryPoint:"main"})):this.options.shaders={vertex:{code:Yt,entryPoint:"main"},fragment:{code:Xt,entryPoint:"main"}}}useGeometry(i){if(this.geometry&&(i.shouldCompute&&i.computeGeometry(),this.geometry.layoutCacheKey!==i.layoutCacheKey&&(F(`${this.options.label} (${this.type}): the current and new geometries do not have the same vertexBuffers layout, causing a probable pipeline recompilation. This should be avoided.
...
`;const we={vertex:{get_uv_cover:Ss},fragment:{get_uv_cover:Ss,get_vertex_to_uv_coords:Fr}},be={vertex:{get_output_position:Ar,get_normals:Dr},fragment:{}};class si extends ii{constructor(e){let{renderer:t,...i}=e;const{label:s,attributes:r,bindGroups:o,cacheKey:a,...h}=i,l="RenderPipelineEntry";I(t,s?s+" "+l:l),super(e),this.type=l,this.shaders={vertex:{head:"",code:"",module:null},fragment:{head:"",code:"",module:null},full:{head:"",code:"",module:null}},this.descriptor=null,this.options={...this.options,attributes:r,bindGroups:o,cacheKey:a,...h},this.setPipelineEntryProperties({attributes:r,bindGroups:o})}setPipelineEntryProperties(e){const{attributes:t,bindGroups:i}=e;this.attributes=t,this.setPipelineEntryBindGroups(i)}patchShaders(){this.shaders.vertex.head="",this.shaders.vertex.code="",this.shaders.fragment.head="",this.shaders.fragment.code="",this.shaders.full.head="",this.shaders.full.code="";for(const t in we.vertex)this.shaders.vertex.head=`${we.vertex[t]}
${this.shaders.vertex.head}`,this.shaders.full.head=`${we.vertex[t]}
${this.shaders.full.head}`;if(this.options.shaders.fragment)for(const t in we.fragment)this.shaders.fragment.head=`${we.fragment[t]}
${this.shaders.fragment.head}`,this.shaders.full.head.indexOf(we.fragment[t])===-1&&(this.shaders.full.head=`${we.fragment[t]}
${this.shaders.full.head}`);if(this.options.rendering.useProjection){for(const t in be.vertex)this.shaders.vertex.head=`${be.vertex[t]}
...
`,As=({addUtils:n=!0,receiveShadows:e=!1,toneMapping:t="linear",useOcclusion:i=!1}={})=>`
${n?Ct:""}
${_s}
${t?We:""}
...
`,Fs=({addUtils:n=!0,receiveShadows:e=!1,toneMapping:t="linear",useOcclusion:i=!1}={})=>`
${n?Ct:""}
${Ds}
${t?We:""}
...
`,Us=({addUtils:n=!0,receiveShadows:e=!1,toneMapping:t="linear",useOcclusion:i=!1}={})=>`
${n?di:""}
${ci}
${t?We:""}
...
`,Is=({addUtils:n=!0,receiveShadows:e=!1,toneMapping:t="linear",useOcclusion:i=!1}={})=>`
${n?di:""}
${ci}
${$s}
${t?We:""}
...
`;var ks=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},ce=(n,e,t)=>(ks(n,e,"read from private field"),t?t.call(n):e.get(n)),pi=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},Jr=(n,e,t,i)=>(ks(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),je,Me,Bt;class Vs extends ti{constructor(e,t,i={}){super(e),pi(this,je,new f),pi(this,Me,new f(1)),pi(this,Bt,1),this.boundingBox=new he(new f(-1),new f(1)),this._onAfterDOMElementResizeCallback=()=>{},e=_t(e,"DOM3DObject"),this.renderer=e,this.size={shouldUpdate:!0,normalizedWorld:{size:new z(1),position:new z},cameraWorld:{size:new z(1)},scaledWorld:{size:new f(1),position:new f}},this.watchScroll=i.watchScroll,this.camera=this.renderer.camera,this.boundingBox.min.onChange(()=>this.shouldUpdateComputedSizes()),this.boundingBox.max.onChange(()=>this.shouldUpdateComputedSizes()),this.setDOMElement(t),this.renderer.domObjects.push(this)}setDOMElement(e){this.domElement=new ni({element:e,onSizeChanged:t=>this.resize(t),onPositionChanged:()=>this.onPositionChanged()}),this.updateSizeAndPosition()}onPositionChanged(){this.watchScroll&&this.shouldUpdateComputedSizes()}resetDOMElement(e){this.domElement&&this.domElement.destroy(),this.setDOMElement(e)}resize(e=null){!e&&(!this.domElement||this.domElement?.isResizing)||(this.updateSizeAndPosition(),this._onAfterDOMElementResizeCallback&&this._onAfterDOMElementResizeCallback())}get boundingRect(){return this.domElement?.boundingRect??{width:1,height:1,top:0,right:0,bottom:0,left:0,x:0,y:0}}setTransforms(){super.setTransforms(),this.transforms.origin.model.set(.5,.5,0),this.transforms.origin.world=new f,this.transforms.position.document=new f,this.documentPosition.onChange(()=>this.applyPosition()),this.transformOrigin.onChange(()=>this.setWorldTransformOrigin())}get documentPosition(){return this.transforms.position.document}set documentPosition(e){this.transforms.position.document=e,this.applyPosition()}get DOMObjectWorldScale(){return ce(this,Me).clone()}get worldScale(){return this.DOMObjectWorldScale.multiply(this.scale)}get worldPosition(){return ce(this,je).clone()}get transformOrigin(){return this.transforms.origin.model}set transformOrigin(e){this.transforms.origin.model=e,this.setWorldTransformOrigin()}get worldTransformOrigin(){return this.transforms.origin.world}set worldTransformOrigin(e){this.transforms.origin.world=e}shouldUpdateMatrices(){super.shouldUpdateMatrices(),(this.matricesNeedUpdate||this.size.shouldUpdate)&&this.updateSizeAndPosition(),this.size.shouldUpdate=!1}shouldUpdateComputedSizes(){this.size.shouldUpdate=!0}updateSizeAndPosition(){this.setWorldSizes(),this.applyDocumentPosition()}applyDocumentPosition(){let e=new f(0,0,0);this.documentPosition.equals(e)||(e=this.documentToWorldSpace(this.documentPosition)),ce(this,je).set(this.position.x+this.size.scaledWorld.position.x+e.x,this.position.y+this.size.scaledWorld.position.y+e.y,this.position.z+this.size.scaledWorld.position.z+this.documentPosition.z/this.camera.CSSPerspective)}applyTransformOrigin(){this.size&&(this.setWorldTransformOrigin(),super.applyTransformOrigin())}updateModelMatrix(){this.modelMatrix.composeFromOrigin(ce(this,je),this.quaternion,this.scale,this.worldTransformOrigin),this.modelMatrix.scale(this.DOMObjectWorldScale),this.shouldUpdateWorldMatrix()}documentToWorldSpace(e=new f){return new f(e.x*this.renderer.pixelRatio/this.renderer.boundingRect.width*this.camera.visibleSize.width,-(e.y*this.renderer.pixelRatio/this.renderer.boundingRect.height)*this.camera.visibleSize.height,e.z)}computeWorldSizes(){const e=this.renderer.boundingRect,t={x:this.boundingRect.width/2+this.boundingRect.left,y:this.boundingRect.height/2+this.boundingRect.top},i={x:e.width/2+e.left,y:e.height/2+e.top},{size:s,center:r}=this.boundingBox;s.x!==0&&s.y!==0&&s.z!==0&&r.divide(s),this.size.normalizedWorld.size.set(this.boundingRect.width/e.width,this.boundingRect.height/e.height),this.size.normalizedWorld.position.set((t.x-i.x)/e.width,(i.y-t.y)/e.height),this.size.cameraWorld.size.set(this.size.normalizedWorld.size.x*this.camera.visibleSize.width,this.size.normalizedWorld.size.y*this.camera.visibleSize.height),this.size.scaledWorld.size.set(this.size.cameraWorld.size.x/s.x,this.size.cameraWorld.size.y/s.y,1),this.size.scaledWorld.size.z=this.size.scaledWorld.size.y*(s.x/s.y/(this.boundingRect.width/this.boundingRect.height)),this.size.scaledWorld.position.set(this.size.normalizedWorld.position.x*this.camera.visibleSize.width,this.size.normalizedWorld.position.y*this.camera.visibleSize.height,0)}setWorldSizes(){this.computeWorldSizes(),this.setWorldScale(),this.setWorldTransformOrigin()}setWorldScale(){ce(this,Me).set(this.size.scaledWorld.size.x,this.size.scaledWorld.size.y,this.size.scaledWorld.size.z*ce(this,Bt)),this.shouldUpdateMatrixStack()}set DOMObjectDepthScaleRatio(e){Jr(this,Bt,e),this.setWorldScale()}setWorldTransformOrigin(){this.transforms.origin.world=new f((this.transformOrigin.x*2-1)*ce(this,Me).x,-(this.transformOrigin.y*2-1)*ce(this,Me).y,this.transformOrigin.z*ce(this,Me).z),this.shouldUpdateMatrixStack()}updateScrollPosition(e={x:0,y:0}){(e.x||e.y)&&this.domElement.updateScrollPosition(e)}onAfterDOMElementResize(e){return e&&(this._onAfterDOMElementResizeCallback=e),this}destroy(){super.destroy(),this.domElement?.destroy()}}je=new WeakMap,Me=new WeakMap,Bt=new WeakMap;const Ns={autoloadSources:!0,watchScroll:!0};class Ws extends Bs(Vs){constructor(e,t,i){super(e,t,{...Ns,...i}),this._onLoadingCallback=r=>{},i={...Ns,...i},_t(e,i.label?i.label+" DOMMesh":"DOMMesh"),this.type="DOMMesh";const{autoloadSources:s}=i;this.autoloadSources=s,this.sourcesReady=!1,this.setInitSources()}get ready(){return this._ready}set ready(e){e&&!this._ready&&this.sourcesReady&&this._onReadyCallback&&this._onReadyCallback(),this._ready=e}get sourcesReady(){return this._sourcesReady}set sourcesReady(e){e&&!this._sourcesReady&&this.ready&&this._onReadyCallback&&this._onReadyCallback(),this._sourcesReady=e}addToScene(e=!1){super.addToScene(e),e&&this.renderer.domMeshes.push(this)}removeFromScene(e=!1){super.removeFromScene(e),e&&(this.renderer.domMeshes=this.renderer.domMeshes.filter(t=>t.uuid!==this.uuid))}setInitSources(){let e=0,t=0;if(this.autoloadSources){const i=this.domElement.element.querySelectorAll("img"),s=this.domElement.element.querySelectorAll("video"),r=this.domElement.element.querySelectorAll("canvas");e=i.length+s.length+r.length;const o=a=>{t++,this._onLoadingCallback&&this._onLoadingCallback(a),t===e&&(this.sourcesReady=!0)};e||(this.sourcesReady=!0),i.length&&i.forEach(a=>{const h=this.createDOMTexture({name:a.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>o(h)).loadImage(a.src)}),s.length&&s.forEach(a=>{const h=this.createDOMTexture({name:a.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>o(h)).loadVideo(a)}),r.length&&r.forEach(a=>{const h=this.createDOMTexture({name:a.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>o(h)).loadCanvas(a)})}else this.sourcesReady=!0}resetDOMElement(e){e?super.resetDOMElement(e):!e&&!this.renderer.production&&F(`${this.options.label}: You are trying to reset a ${this.type} with a HTML element that does not exist. The old HTML element will be kept instead.`)}get pixelRatioBoundingRect(){const e=window.devicePixelRatio??1,t=this.renderer.pixelRatio/e;return Object.keys(this.domElement.boundingRect).reduce((i,s)=>({...i,[s]:this.domElement.boundingRect[s]*t}),{x:0,y:0,width:0,height:0,top:0,right:0,bottom:0,left:0})}computeGeometry(){super.computeGeometry(),this.boundingBox.copy(this.geometry.boundingBox)}onLoading(e){return e&&(this._onLoadingCallback=e),this}}const en={label:"Plane",instancesCount:1,vertexBuffers:[]};class js extends Ws{constructor(e,t,i={}){e=_t(e,i.label?i.label+" Plane":"Plane");const s={...en,...i};let{geometry:r,widthSegments:o,heightSegments:a,...h}=s;const{instancesCount:l,vertexBuffers:u,...d}=h;if(!r||r.type!=="PlaneGeometry"){o=o??1,a=a??1;const c=o*a+o;u.length||(r=wt.getPlaneGeometryByID(c)),r?r.instancesCount=l:(r=new Nt({widthSegments:o,heightSegments:a,instancesCount:l,vertexBuffers:u}),wt.addPlaneGeometry(r))}super(e,t,{geometry:r,...d}),this.type="Plane"}mouseToPlaneCoords(e=new z){const t={x:2*(e.x/this.renderer.boundingRect.width)-1,y:2*(1-e.y/this.renderer.boundingRect.height)-1},i=this.camera.position.clone(),s=new f(t.x,t.y,-.5);s.unproject(this.camera),s.sub(i).normalize();const r=new f(0,0,1);r.applyQuat(this.quaternion).normalize();const o=new f(0,0,0),a=r.dot(s);if(Math.abs(a)>=1e-4){const h=this.worldMatrix.getInverse().premultiply(this.camera.viewMatrix),l=this.worldTransformOrigin.clone().add(this.worldPosition),u=new f(this.worldPosition.x-l.x,this.worldPosition.y-l.y,this.worldPosition.z-l.z);u.applyQuat(this.quaternion),l.add(u);const d=r.dot(l.clone().sub(i))/a;o.copy(i.add(s.multiplyScalar(d))),o.applyMat4(h)}else o.set(1/0,1/0,1/0);return new z(o.x,o.y)}}class Pt extends ui{constructor({deviceManager:e,label:t,container:i,pixelRatio:s=1,autoResize:r=!0,preferredFormat:o,alphaMode:a="premultiplied",renderPass:h,camera:l,lights:u}){super({deviceManager:e,label:t,container:i,pixelRatio:s,autoResize:r,preferredFormat:o,alphaMode:a,renderPass:h,camera:l,lights:u}),this.type="GPUCurtainsRenderer"}setRendererObjects(){super.setRendererObjects(),this.domMeshes=[],this.domObjects=[]}onCameraMatricesChanged(){super.onCameraMatricesChanged(),this.domObjects.forEach(e=>{e.updateSizeAndPosition()})}resizeMeshes(){this.meshes.forEach(e=>{"domElement"in e||e.resize(this.boundingRect)}),this.domObjects.forEach(e=>{e.domElement.isResizing||e.domElement.setSize()})}}class tn{constructor({scroll:e={x:0,y:0},delta:t={x:0,y:0},shouldWatch:i=!0,onScroll:s=(r={x:0,y:0})=>{}}={}){this.scroll=e,this.delta=t,this.shouldWatch=i,this.onScroll=s,this.shouldWatch&&window.addEventListener("scroll",this.setScroll.bind(this),{passive:!0})}setScroll(){this.updateScrollValues({x:window.pageXOffset,y:window.pageYOffset})}updateScrollValues({x:e,y:t}){const i=this.scroll;this.scroll={x:e,y:t},this.delta={x:i.x-this.scroll.x,y:i.y-this.scroll.y},this.onScroll&&this.onScroll(this.delta)}destroy(){this.shouldWatch&&window.removeEventListener("scroll",this.setScroll.bind(this),{passive:!0})}}class sn{constructor({container:e,label:t,pixelRatio:i=window.devicePixelRatio??1,preferredFormat:s,alphaMode:r="premultiplied",production:o=!1,adapterOptions:a={},renderPass:h,camera:l,lights:u,autoRender:d=!0,autoResize:c=!0,watchScroll:p=!0}={}){this._onRenderCallback=()=>{},this._onScrollCallback=()=>{},this._onErrorCallback=()=>{},this._onContextLostCallback=()=>{},this.type="CurtainsGPU",this.options={container:e,label:t,pixelRatio:i,camera:l,lights:u,production:o,adapterOptions:a,preferredFormat:s,alphaMode:r,renderPass:h,autoRender:d,autoResize:c,watchScroll:p},this.setDeviceManager(),e&&this.setContainer(e),this.initEvents(),this.options.autoRender&&this.animate()}setContainer(e){if(e)if(typeof e=="string")if(e=document.querySelector(e),e)this.options.container=e;else{const t=document.createElement("div");t.setAttribute("id","curtains-gpu-canvas"),document.body.appendChild(t),this.options.container=t}else e instanceof Element&&(this.options.container=e);else{const t=document.createElement("div");t.setAttribute("id","curtains-gpu-canvas"),document.body.appendChild(t),this.options.container=t}this.container=this.options.container,this.setMainRenderer()}setMainRenderer(){this.createCurtainsRenderer({deviceManager:this.deviceManager,label:this.options.label,container:this.options.container,pixelRatio:this.options.pixelRatio,autoResize:this.options.autoResize,preferredFormat:this.options.preferredFormat,alphaMode:this.options.alphaMode,renderPass:this.options.renderPass,camera:this.options.camera,lights:this.options.lights})}patchRendererOptions(e){return e.pixelRatio===void 0&&(e.pixelRatio=this.options.pixelRatio),e.autoResize===void 0&&(e.autoResize=this.options.autoResize),e}createRenderer(e){return e=this.patchRendererOptions(e),new hi({...e,deviceManager:this.deviceManager})}createCameraRenderer(e){return e=this.patchRendererOptions(e),new ui({...e,deviceManager:this.deviceManager})}createCurtainsRenderer(e){return e=this.patchRendererOptions(e),new Pt({...e,deviceManager:this.deviceManager})}setDeviceManager(){this.deviceManager=new Gs({label:"GPUCurtains default device",production:this.options.production,adapterOptions:this.options.adapterOptions,onError:()=>setTimeout(()=>{this._onErrorCallback&&this._onErrorCallback()},0),onDeviceLost:e=>this._onContextLostCallback&&this._onContextLostCallback(e)})}get renderers(){return this.deviceManager.renderers}get renderer(){return this.renderers[0]}async setDevice({adapter:e=null,device:t=null}={}){await this.deviceManager.init({adapter:e,device:t})}async restoreContext(){await this.deviceManager.restoreDevice()}get pingPongPlanes(){return this.renderers?.map(e=>e.pingPongPlanes).flat()}get shaderPasses(){return this.renderers?.map(e=>e.shaderPasses).flat()}get meshes(){return this.renderers?.map(e=>e.meshes).flat()}get domMeshes(){return this.renderers?.filter(e=>e instanceof Pt).map(e=>e.domMeshes).flat()}get domObjects(){return this.renderers?.filter(e=>e instanceof Pt).map(e=>e.domObjects).flat()}get planes(){return this.domMeshes.filter(e=>e instanceof js)}get computePasses(){return this.renderers?.map(e=>e.computePasses).flat()}get boundingRect(){return this.renderer?.boundingRect}initScroll(){this.scrollManager=new tn({scroll:{x:window.pageXOffset,y:window.pageYOffset},delta:{x:0,y:0},shouldWatch:this.options.watchScroll,onScroll:e=>this.updateScroll(e)})}updateScroll(e={x:0,y:0}){this.domObjects.forEach(t=>{t.domElement&&t.watchScroll&&t.updateScrollPosition(e)}),this._onScrollCallback&&this._onScrollCallback()}updateScrollValues(e={x:0,y:0}){this.scrollManager.updateScrollValues(e)}get scrollDelta(){return this.scrollManager.delta}get scrollValues(){return this.scrollManager.scroll}initEvents(){ri.useObserver(this.options.autoResize),this.initScroll()}onRender(e){return e&&(this._onRenderCallback=e),this}onScroll(e){return e&&(this._onScrollCallback=e),this}onError(e){return e&&(this._onErrorCallback=e),this}onContextLost(e){return e&&(this._onContextLostCallback=e),this}animate(){this.render(),this.animationFrameID=window.requestAnimationFrame(this.animate.bind(this))}render(){this._onRenderCallback&&this._onRenderCallback(),this.deviceManager.render()}destroy(){this.animationFrameID&&window.cancelAnimationFrame(this.animationFrameID),this.deviceManager.destroy(),this.scrollManager?.destroy(),ri.destroy()}}var qs=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},H=(n,e,t)=>(qs(n,e,"read from private field"),t?t.call(n):e.get(n)),fi=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},mi=(n,e,t,i)=>(qs(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),ze,qe,J;class rn extends ae{constructor(e,{camera:t=null,element:i=null}={}){super(),fi(this,ze,new z),fi(this,qe,!1),this.constrainXOrbit=!0,this.constrainYOrbit=!1,this.minOrbit=new z(-Math.PI*.5,-Math.PI),this.maxOrbit=new z(Math.PI*.5,Math.PI),this.orbitStep=new z(.025),this.constrainZoom=!0,this.minZoom=0,this.maxZoom=20,this.zoomStep=.005,fi(this,J,null),this.renderer=e,this.parent=this.renderer.scene,this.quaternion.setAxisOrder("YXZ"),this.camera=t||this.renderer.camera,this.camera.parent=this,this.element=i??this.renderer.domElement.element}set element(e){H(this,J)&&(!e||H(this,J)!==e)&&this.removeEvents(),mi(this,J,e),e&&this.addEvents()}get element(){return H(this,J)}addEvents(){H(this,J).addEventListener("pointerdown",this.onPointerDown.bind(this)),H(this,J).addEventListener("pointermove",this.onPointerMove.bind(this)),H(this,J).addEventListener("pointerup",this.onPointerUp.bind(this)),H(this,J).addEventListener("wheel",this.onMouseWheel.bind(this))}removeEvents(){H(this,J).removeEventListener("pointerdown",this.onPointerDown.bind(this)),H(this,J).removeEventListener("pointermove",this.onPointerMove.bind(this)),H(this,J).removeEventListener("pointerup",this.onPointerUp.bind(this)),H(this,J).removeEventListener("wheel",this.onMouseWheel.bind(this))}onPointerDown(e){e.isPrimary&&mi(this,qe,!0),H(this,ze).set(e.pageX,e.pageY)}onPointerMove(e){let t,i;document.pointerLockElement?(t=e.movementX,i=e.movementY,this.orbit(t*this.orbitStep.x,i*this.orbitStep.y)):H(this,qe)&&(t=e.pageX-H(this,ze).x,i=e.pageY-H(this,ze).y,H(this,ze).set(e.pageX,e.pageY),this.orbit(t*this.orbitStep.x,i*this.orbitStep.y))}onPointerUp(e){e.isPrimary&&mi(this,qe,!1)}onMouseWheel(e){this.zoom(this.position.z+e.deltaY*this.zoomStep),e.preventDefault()}reset(){this.position.set(0),this.rotation.set(0)}orbit(e,t){if(e||t){if(this.rotation.y-=e,this.constrainYOrbit)this.rotation.y=Math.min(Math.max(this.rotation.y,this.minOrbit.y),this.maxOrbit.y);else{for(;this.rotation.y<-Math.PI;)this.rotation.y+=Math.PI*2;for(;this.rotation.y>=Math.PI;)this.rotation.y-=Math.PI*2}if(this.rotation.x-=t,this.constrainXOrbit)this.rotation.x=Math.min(Math.max(this.rotation.x,this.minOrbit.x),this.maxOrbit.x);else{for(;this.rotation.x<-Math.PI;)this.rotation.x+=Math.PI*2;for(;this.rotation.x>=Math.PI;)this.rotation.x-=Math.PI*2}}}zoom(e){this.position.z=e,this.constrainZoom&&(this.position.z=Math.min(Math.max(this.position.z,this.minZoom),this.maxZoom))}updateModelMatrix(){this.modelMatrix.identity().rotateFromQuaternion(this.quaternion).translate(this.position),this.shouldUpdateWorldMatrix()}destroy(){this.camera.parent=this.renderer.scene,this.parent=null,this.element=null}}ze=new WeakMap,qe=new WeakMap,J=new WeakMap;class nn extends _e{constructor({instancesCount:e=1,vertexBuffers:t=[],topology:i,mapBuffersAtCreation:s=!0,widthSegments:r=1,heightSegments:o=1,depthSegments:a=1}={}){super({verticesOrder:"ccw",topology:i,instancesCount:e,vertexBuffers:t,mapBuffersAtCreation:s}),this.type="BoxGeometry",r=Math.floor(r),o=Math.floor(o),a=Math.floor(a);const h=[],l=[],u=[],d=[];let c=0;const p=(g,m,x,v,M,P,b,B,C,w)=>{const S=P/C,R=b/w,T=P/2,G=b/2,A=B/2,j=C+1,q=w+1;let N=0;const E=new f;for(let $=0;$<q;$++){const D=$*R-G;for(let Y=0;Y<j;Y++){const K=Y*S-T;E[g]=K*v,E[m]=D*M,E[x]=A,h.push(E.x,E.y,E.z),E[g]=0,E[m]=0,E[x]=B>0?1:-1,u.push(E.x,E.y,E.z),l.push(Y/C),l.push($/w),N+=1}}for(let $=0;$<w;$++)for(let D=0;D<C;D++){const Y=c+D+j*$,K=c+D+j*($+1),fe=c+(D+1)+j*($+1),Lt=c+(D+1)+j*$;d.push(Y,K,Lt),d.push(K,fe,Lt),c+=N}};p("z","y","x",-1,-1,2,2,2,a,o),p("z","y","x",1,-1,2,2,-2,a,o),p("x","z","y",1,1,2,2,2,r,a),p("x","z","y",1,-1,2,2,-2,r,a),p("x","y","z",1,-1,2,2,2,r,o),p("x","y","z",-1,-1,2,2,-2,r,o),this.setAttribute({name:"position",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(h)}),this.setAttribute({name:"uv",type:"vec2f",bufferFormat:"float32x2",size:2,array:new Float32Array(l)}),this.setAttribute({name:"normal",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(u)}),this.setIndexBuffer({array:this.useUint16IndexArray?new Uint16Array(d):new Uint32Array(d),bufferFormat:this.useUint16IndexArray?"uint16":"uint32"})}}class on extends _e{constructor({topology:e,instancesCount:t=1,vertexBuffers:i=[],mapBuffersAtCreation:s=!0,widthSegments:r=32,heightSegments:o=16,phiStart:a=0,phiLength:h=Math.PI*2,thetaStart:l=0,thetaLength:u=Math.PI}={}){super({verticesOrder:"ccw",topology:e,instancesCount:t,vertexBuffers:i,mapBuffersAtCreation:s}),this.type="SphereGeometry",r=Math.max(3,Math.floor(r)),o=Math.max(2,Math.floor(o));const d=1,c=Math.min(l+u,Math.PI);let p=0;const g=[],m=new f,x=new f,v=[],M=[],P=[],b=[];for(let B=0;B<=o;B++){const C=[],w=B/o;let S=0;B===0&&l===0?S=.5/r:B===o&&c===Math.PI&&(S=-.5/r);for(let R=0;R<=r;R++){const T=R/r;m.x=-d*Math.cos(a+T*h)*Math.sin(l+w*u),m.y=d*Math.cos(l+w*u),m.z=d*Math.sin(a+T*h)*Math.sin(l+w*u),M.push(m.x,m.y,m.z),x.copy(m).normalize(),P.push(x.x,x.y,x.z),b.push(T+S,w),C.push(p++)}g.push(C)}for(let B=0;B<o;B++)for(let C=0;C<r;C++){const w=g[B][C+1],S=g[B][C],R=g[B+1][C],T=g[B+1][C+1];(B!==0||l>0)&&v.push(w,S,T),(B!==o-1||c<Math.PI)&&v.push(S,R,T)}this.setAttribute({name:"position",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(M)}),this.setAttribute({name:"uv",type:"vec2f",bufferFormat:"float32x2",size:2,array:new Float32Array(b)}),this.setAttribute({name:"normal",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(P)}),this.setIndexBuffer({array:this.useUint16IndexArray?new Uint16Array(v):new Uint32Array(v),bufferFormat:this.useUint16IndexArray?"uint16":"uint32"})}}class an extends ei{constructor(e,t={}){e=I(e,t.label?t.label+" PingPongPlane":"PingPongPlane");const i=t.targets&&t.targets.length&&t.targets.map(s=>({targetFormat:s.format}));t.outputTarget=new jt(e,{label:t.label?t.label+" render target":"Ping Pong render target",useDepth:!1,...i&&{colorAttachments:i}}),t.transparent=!1,t.depth=!1,t.label=t.label??"PingPongPlane "+e.pingPongPlanes?.length,super(e,t),this.type="PingPongPlane",this.createTexture({label:t.label?`${t.label} render texture`:"PingPongPlane render texture",name:"renderTexture",...t.targets&&t.targets.length&&{format:t.targets[0].format},usage:["copyDst","textureBinding"]})}get renderTexture(){return this.textures.find(e=>e.options.name==="renderTexture")}addToScene(e=!1){e&&this.renderer.pingPongPlanes.push(this),this.autoRender&&this.renderer.scene.addPingPongPlane(this)}removeFromScene(e=!1){this.outputTarget&&this.outputTarget.destroy(),this.autoRender&&this.renderer.scene.removePingPongPlane(this),e&&(this.renderer.pingPongPlanes=this.renderer.pingPongPlanes.filter(t=>t.uuid!==this.uuid))}}const Ys=WebGLRenderingContext,hn=1179937895,gi={JSON:1313821514,BIN:5130562},ln=[0,0,0],un=[0,0,0,1],dn=[1,1,1],cn=typeof window<"u"&&new RegExp(`^${window.location.protocol}`,"i")||RegExp("^(http|https):","i"),pn=/^data:/;class St{constructor(){this.gltf=null}static resolveUri(e,t){return e.match(cn)||e.match(pn)?e:t+e}async loadFromUrl(e){const t=e.lastIndexOf("/"),i=t!==0?e.substring(0,t+1):"",s=await fetch(e);if(e.endsWith(".gltf"))return this.loadFromJson(await s.json(),i);if(e.endsWith(".glb"))return this.loadFromBinary(await s.arrayBuffer(),i);throw new Error("Unrecognized file extension")}async loadFromJsonBase(e,t,i=null){if(!t)throw new Error("baseUrl must be specified.");if(!e.asset)throw new Error("Missing asset description.");if(e.asset.minVersion!=="2.0"&&e.asset.version!=="2.0")throw new Error("Incompatible asset version.");for(const o of e.accessors)o.byteOffset=o.byteOffset??0,o.normalized=o.normalized??!1;for(const o of e.bufferViews)o.byteOffset=o.byteOffset??0;for(const o of e.nodes)o.matrix||(o.rotation=o.rotation??un,o.scale=o.scale??dn,o.translation=o.translation??ln);if(e.samplers)for(const o of e.samplers)o.wrapS=o.wrapS??Ys.REPEAT,o.wrapT=o.wrapT??Ys.REPEAT;const s=[];if(i)s.push(Promise.resolve(i));else for(const o in e.buffers){const a=e.buffers[o],h=St.resolveUri(a.uri,t);s[o]=fetch(h).then(l=>l.arrayBuffer())}const r=[];for(let o=0;o<e.images?.length;++o){const a=e.images[o];if(a.uri)r[o]=fetch(St.resolveUri(a.uri,t)).then(async h=>createImageBitmap(await h.blob()));else{const h=e.bufferViews[a.bufferView];r[o]=s[h.buffer].then(l=>{const u=new Blob([new Uint8Array(l,h.byteOffset,h.byteLength)],{type:a.mimeType});return createImageBitmap(u)})}}return{...e,arrayBuffers:await Promise.all(s),imagesBitmaps:await Promise.all(r)}}async loadFromBinary(e,t){const i=new DataView(e,0,12),s=i.getUint32(0,!0),r=i.getUint32(4,!0),o=i.getUint32(8,!0);if(s!==hn)throw new Error("Invalid magic string in binary header.");if(r!==2)throw new Error("Incompatible version in binary header.");const a={};let h=12;for(;h<o;){const d=new DataView(e,h,8),c=d.getUint32(0,!0),p=d.getUint32(4,!0);a[p]=e.slice(h+8,h+8+c),h+=c+8}if(!a[gi.JSON])throw new Error("File contained no json chunk.");const u=new TextDecoder("utf-8").decode(a[gi.JSON]);return this.loadFromJson(JSON.parse(u),t,a[gi.BIN])}async loadFromJson(e,t,i=null){return this.gltf=await this.loadFromJsonBase(e,t,i),this.gltf}}var Xs=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},xi=(n,e,t)=>(Xs(n,e,"read from private field"),t?t.call(n):e.get(n)),fn=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},mn=(n,e,t,i)=>(Xs(n,e,"write to private field"),i?i.call(n,t):e.set(n,t),t),Ee;const k=WebGLRenderingContext,Tt=new L,gn=class me{constructor({renderer:e,gltf:t}){fn(this,Ee,void 0),e=Ce(e,"GLTFScenesManager"),this.renderer=e,this.gltf=t,mn(this,Ee,new Map);const i=s=>[s.node,...s.children?.map(r=>[...i(r)]).flat()].flat();this.scenesManager={node:new ae,boundingBox:new he,samplers:[],materialsTextures:[],scenes:[],meshes:[],meshesDescriptors:[],getScenesNodes:()=>this.scenesManager.scenes.map(s=>i(s)).flat()},this.createSamplers(),this.createMaterialTextures(),this.createScenes()}static getVertexAttributeParamsFromType(e){switch(e){case"VEC2":return{type:"vec2f",bufferFormat:"float32x2",size:2};case"VEC3":return{type:"vec3f",bufferFormat:"float32x3",size:3};case"VEC4":return{type:"vec4f",bufferFormat:"float32x4",size:4};case"SCALAR":default:return{type:"f32",bufferFormat:"float32",size:1}}}static getTypedArrayConstructorFromComponentType(e){switch(e){case k.BYTE:return Int8Array;case k.UNSIGNED_BYTE:return Uint8Array;case k.SHORT:return Int16Array;case k.UNSIGNED_SHORT:return Uint16Array;case k.UNSIGNED_INT:return Uint32Array;case k.FLOAT:default:return Float32Array}}static gpuPrimitiveTopologyForMode(e){switch(e){case k.TRIANGLES:return"triangle-list";case k.TRIANGLE_STRIP:return"triangle-strip";case k.LINES:return"line-list";case k.LINE_STRIP:return"line-strip";case k.POINTS:return"point-list"}}static gpuAddressModeForWrap(e){switch(e){case k.CLAMP_TO_EDGE:return"clamp-to-edge";case k.MIRRORED_REPEAT:return"mirror-repeat";default:return"repeat"}}createSamplers(){if(this.gltf.samplers)for(const[e,t]of Object.entries(this.gltf.samplers)){const i={label:"glTF sampler "+e,name:"gltfSampler"+e,addressModeU:me.gpuAddressModeForWrap(t.wrapS),addressModeV:me.gpuAddressModeForWrap(t.wrapT)};switch((!t.magFilter||t.magFilter===k.LINEAR)&&(i.magFilter="linear"),t.minFilter){case k.NEAREST:break;case k.LINEAR:case k.LINEAR_MIPMAP_NEAREST:i.minFilter="linear";break;case k.NEAREST_MIPMAP_LINEAR:i.mipmapFilter="linear";break;case k.LINEAR_MIPMAP_LINEAR:default:i.minFilter="linear",i.mipmapFilter="linear";break}this.scenesManager.samplers.push(new Pe(this.renderer,i))}else this.scenesManager.samplers.push(new Pe(this.renderer,{label:"Default sampler",name:"defaultSampler",magFilter:"linear",minFilter:"linear",mipmapFilter:"linear"}))}createTexture(e,t,i){const s=(()=>{switch(i){case"baseColorTexture":case"emissiveTexture":return"bgra8unorm-srgb";case"occlusionTexture":return"r8unorm";default:return"bgra8unorm"}})(),r=new ee(this.renderer,{label:e.name?e.name+": "+i:i,name:i,format:s,visibility:["fragment"],generateMips:!0,fixedSize:{width:t.width,height:t.height}});return r.uploadSource({source:t}),r}createMaterialTextures(){if(this.scenesManager.materialsTextures=[],this.gltf.materials)for(const[e,t]of Object.entries(this.gltf.materials)){const i={material:e,texturesDescriptors:[]},s=r=>r.texCoord&&r.texCoord!==0?"uv"+r.texCoord:"uv";if(this.scenesManager.materialsTextures[e]=i,t.pbrMetallicRoughness){if(t.pbrMetallicRoughness.baseColorTexture&&t.pbrMetallicRoughness.baseColorTexture.index!==void 0){const r=t.pbrMetallicRoughness.baseColorTexture.index,o=this.gltf.imagesBitmaps[this.gltf.textures[r].source],a=this.createTexture(t,o,"baseColorTexture"),h=this.gltf.textures.find(l=>l.source===r)?.sampler;i.texturesDescriptors.push({texture:a,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.pbrMetallicRoughness.baseColorTexture)})}if(t.pbrMetallicRoughness.metallicRoughnessTexture&&t.pbrMetallicRoughness.metallicRoughnessTexture.index!==void 0){const r=t.pbrMetallicRoughness.metallicRoughnessTexture.index,o=this.gltf.imagesBitmaps[this.gltf.textures[r].source],a=this.createTexture(t,o,"metallicRoughnessTexture"),h=this.gltf.textures.find(l=>l.source===r)?.sampler;i.texturesDescriptors.push({texture:a,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.pbrMetallicRoughness.metallicRoughnessTexture)})}}if(t.normalTexture&&t.normalTexture.index!==void 0){const r=t.normalTexture.index,o=this.gltf.imagesBitmaps[this.gltf.textures[r].source],a=this.createTexture(t,o,"normalTexture"),h=this.gltf.textures.find(l=>l.source===r)?.sampler;i.texturesDescriptors.push({texture:a,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.normalTexture)})}if(t.occlusionTexture&&t.occlusionTexture.index!==void 0){const r=t.occlusionTexture.index,o=this.gltf.imagesBitmaps[this.gltf.textures[r].source],a=this.createTexture(t,o,"occlusionTexture"),h=this.gltf.textures.find(l=>l.source===r)?.sampler;i.texturesDescriptors.push({texture:a,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.occlusionTexture)})}if(t.emissiveTexture&&t.emissiveTexture.index!==void 0){const r=t.emissiveTexture.index,o=this.gltf.imagesBitmaps[this.gltf.textures[r].source],a=this.createTexture(t,o,"emissiveTexture"),h=this.gltf.textures.find(l=>l.source===r)?.sampler;i.texturesDescriptors.push({texture:a,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.emissiveTexture)})}}}createNode(e,t){if(t.camera!==void 0)return;const i={name:t.name,node:new ae,children:[]};e.children.push(i),i.node.parent=e.node,t.matrix?(i.node.modelMatrix.setFromArray(new Float32Array(t.matrix)),i.node.matrices.model.shouldUpdate=!1):(t.translation&&i.node.position.set(t.translation[0],t.translation[1],t.translation[2]),t.scale&&i.node.scale.set(t.scale[0],t.scale[1],t.scale[2]),t.rotation&&i.node.quaternion.setFromArray(new Float32Array(t.rotation)));const s=this.gltf.meshes[t.mesh];t.children&&t.children.forEach(r=>{const o=this.gltf.nodes[r];this.createNode(i,o)}),s&&s.primitives.forEach((r,o)=>{const a={parent:i.node,attributes:[],textures:[],parameters:{label:s.name?s.name+" "+o:"glTF mesh "+o},nodes:[]};let h=xi(this,Ee).get(r);h||(h={instances:[],nodes:[],meshDescriptor:a},xi(this,Ee).set(r,h)),h.instances.push(t),h.nodes.push(i.node)})}createScenes(){this.scenesManager.node.parent=this.renderer.scene,this.gltf.scenes.forEach(e=>{const t={name:e.name,children:[],node:new ae};t.node.parent=this.scenesManager.node,this.scenesManager.scenes.push(t),e.nodes.forEach(i=>{const s=this.gltf.nodes[i];this.createNode(t,s)})}),this.scenesManager.scenes.forEach(e=>{e.node.shouldUpdateModelMatrix(),e.node.updateMatrixStack()});for(const[e,t]of xi(this,Ee)){const{instances:i,nodes:s,meshDescriptor:r}=t,o=i.length;r.nodes=s,this.scenesManager.meshesDescriptors.push(r);const a=new he,h=[];let l=null,u=null,d=0;for(const[M,P]of Object.entries(e.attributes)){const b=this.gltf.accessors[P],B=me.getTypedArrayConstructorFromComponentType(b.componentType),C=this.gltf.bufferViews[b.bufferView],w=M==="TEXCOORD_0"?"uv":M.replace("_","").replace("TEXCOORD","uv").toLowerCase(),S=C.byteStride||0,R=b.byteOffset||0;S&&R&&R<S?d=Math.max(R,d):d=0,w==="position"&&(a.min.min(new f(b.min[0],b.min[1],b.min[2])),a.max.max(new f(b.max[0],b.max[1],b.max[2])),u=C);const T=me.getVertexAttributeParamsFromType(b.type),G={name:w,...T,array:new B(this.gltf.arrayBuffers[C.buffer],b.byteOffset+C.byteOffset,b.count*T.size)};h.push(G),r.attributes.push({name:G.name,type:G.type})}if(d>0){const M=Object.values(e.attributes).map(P=>this.gltf.accessors[P].bufferView);if(M.every(P=>P===M[0]))l=new Float32Array(this.gltf.arrayBuffers[u.buffer],u.byteOffset,Math.ceil(u.byteLength/4)*4/Float32Array.BYTES_PER_ELEMENT);else{let P=0;const b={},B=Object.values(e.attributes).reduce((C,w)=>{const S=this.gltf.accessors[w],R=me.getVertexAttributeParamsFromType(S.type).size;return b[S.bufferView]||(b[S.bufferView]=0),b[S.bufferView]=Math.max(b[S.bufferView],S.byteOffset+R*Float32Array.BYTES_PER_ELEMENT),P+=R*Float32Array.BYTES_PER_ELEMENT,C+S.count*R},0);l=new Float32Array(Math.ceil(B/4)*4),Object.values(e.attributes).forEach(C=>{const w=this.gltf.accessors[C],S=this.gltf.bufferViews[w.bufferView],R=me.getVertexAttributeParamsFromType(w.type).size;for(let T=0;T<w.count;T++){const G=w.byteOffset/Float32Array.BYTES_PER_ELEMENT+T*P/Float32Array.BYTES_PER_ELEMENT;l.subarray(G,G+R).set(new Float32Array(this.gltf.arrayBuffers[S.buffer],S.byteOffset+w.byteOffset+T*b[w.bufferView],R))}})}}else{const M=["position","uv","normal"];h.sort((P,b)=>{let B=M.findIndex(w=>w===P.name);B=B===-1?1/0:B;let C=M.findIndex(w=>w===b.name);return C=C===-1?1/0:C,B-C})}const c={instancesCount:o,topology:me.gpuPrimitiveTopologyForMode(e.mode),vertexBuffers:[{name:"attributes",stepMode:"vertex",attributes:h,...l&&{array:l}}]},p="indices"in e,g=p?_e:Vt;if(r.parameters.geometry=new g(c),r.parameters.geometry.boundingBox=a,p){const M=this.gltf.accessors[e.indices],P=this.gltf.bufferViews[M.bufferView],b=me.getTypedArrayConstructorFromComponentType(M.componentType),B=M.byteOffset+P.byteOffset,C=this.gltf.arrayBuffers[P.buffer],w=Math.min((C.byteLength-B)/b.BYTES_PER_ELEMENT,Math.ceil(M.count/4)*4),S=b.name==="Uint8Array"?Uint16Array.from(new b(C,B,w)):new b(C,B,w);r.parameters.geometry.setIndexBuffer({bufferFormat:b.name==="Uint32Array"?"uint32":"uint16",array:S})}const m=this.scenesManager.materialsTextures[e.material];r.parameters.samplers=[],r.parameters.textures=[],m?.texturesDescriptors.forEach(M=>{r.textures.push({texture:M.texture.options.name,sampler:M.sampler.name,texCoordAttributeName:M.texCoordAttributeName}),r.parameters.samplers.find(b=>b.uuid===M.sampler.uuid)||r.parameters.samplers.push(M.sampler),r.parameters.textures.push(M.texture)});const x=this.gltf.materials&&this.gltf.materials[e.material]||{};r.parameters.cullMode=x.doubleSided?"none":"back",(x.alphaMode==="BLEND"||x.extensions&&x.extensions.KHR_materials_transmission)&&(r.parameters.transparent=!0,r.parameters.targets=[{blend:{color:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha"},alpha:{srcFactor:"one",dstFactor:"one"}}}]);const v={baseColorFactor:{type:"vec4f",value:x.pbrMetallicRoughness?.baseColorFactor||[1,1,1,1]},alphaCutoff:{type:"f32",value:x.alphaCutoff!==void 0?x.alphaCutoff:x.alphaMode==="MASK"?.5:0},metallicFactor:{type:"f32",value:x.pbrMetallicRoughness?.metallicFactor===void 0?1:x.pbrMetallicRoughness.metallicFactor},roughnessFactor:{type:"f32",value:x.pbrMetallicRoughness?.roughnessFactor===void 0?1:x.pbrMetallicRoughness.roughnessFactor},normalMapScale:{type:"f32",value:x.normalTexture?.scale===void 0?1:x.normalTexture.scale},occlusionStrength:{type:"f32",value:x.occlusionTexture?.strength===void 0?1:x.occlusionTexture.strength},emissiveFactor:{type:"vec3f",value:x.emissiveFactor!==void 0?x.emissiveFactor:[1,1,1]}};if(Object.keys(v).length&&(r.parameters.uniforms={material:{visibility:["vertex","fragment"],struct:v}}),o>1){const M=new Float32Array(o*16),P=new Float32Array(o*16);for(let b=0;b<o;++b)M.set(s[b].worldMatrix.elements,b*16),Tt.copy(s[b].worldMatrix).invert().transpose(),P.set(Tt.elements,b*16);r.parameters.storages={instances:{visibility:["vertex","fragment"],struct:{modelMatrix:{type:"array<mat4x4f>",value:M},normalMatrix:{type:"array<mat4x4f>",value:P}}}}}for(let M=0;M<s.length;M++){const b=a.clone().applyMat4(r.nodes[M].worldMatrix);this.scenesManager.boundingBox.min.min(b.min),this.scenesManager.boundingBox.max.max(b.max)}}}addMeshes(e=t=>{}){return this.scenesManager.meshesDescriptors.map(t=>{if(t.parameters.geometry){e(t);const i=t.parameters.geometry.instancesCount>1&&t.parameters.castShadows;i&&(t.parameters.castShadows=!1);const s=new Ps(this.renderer,{...t.parameters});if(t.nodes.length>1){const r=s.updateWorldMatrix.bind(s);s.updateWorldMatrix=()=>{r(),t.nodes.forEach((o,a)=>{s.storages.instances.modelMatrix.value.set(o.worldMatrix.elements,a*16),Tt.copy(o.worldMatrix).invert().transpose(),s.storages.instances.normalMatrix.value.set(Tt.elements,a*16)}),s.storages.instances.modelMatrix.shouldUpdate=!0,s.storages.instances.normalMatrix.shouldUpdate=!0},this.renderer.onAfterRenderScene.add(()=>{s.shouldUpdateModelMatrix()},{once:!0})}if(i){const r=s.material.inputsBindings.get("instances");this.renderer.shadowCastingLights.forEach(o=>{o.shadow.isActive&&o.shadow.addShadowCastingMesh(s,{bindings:[r]})})}return s.parent=t.parent,this.scenesManager.meshes.push(s),s}})}destroy(){this.scenesManager.meshes.forEach(t=>t.remove()),this.scenesManager.meshes=[],this.scenesManager.getScenesNodes().forEach(t=>{t.destroy()}),this.scenesManager.node.destroy()}};Ee=new WeakMap;let xn=gn;const yn=(n,e={})=>{const t=n.textures.find(O=>O.texture==="baseColorTexture"),i=n.textures.find(O=>O.texture==="normalTexture"),s=n.textures.find(O=>O.texture==="emissiveTexture"),r=n.textures.find(O=>O.texture==="occlusionTexture"),o=n.textures.find(O=>O.texture==="metallicRoughnessTexture"),a=n.attributes.filter(O=>O.name!=="position"),h=a.map((O,Bn)=>`@location(${Bn}) ${O.name}: ${O.type},`).join(`
	`);let l=`
  ...
  `,u=a.find(O=>O.name==="normal")?"vsOutput.normal = getWorldNormal(attributes.normal);":"";n.parameters.storages&&n.parameters.storages.instances&&(l=`
      ...
      vsOutput.viewDirection = camera.position - vsOutput.worldPosition;
      `,u="vsOutput.normal = normalize((instances[attributes.instanceIndex].normalMatrix * vec4(attributes.normal, 0.0)).xyz);");const d=a.filter(O=>O.name!=="normal").map(O=>`vsOutput.${O.name} = attributes.${O.name};`).join(`
	`);let c=`
      @builtin(position) position: vec4f,
      @location(${a.length}) viewDirection: vec3f,
      @location(${a.length+1}) worldPosition: vec3f,
      ${h}
  `,p="";const g=a.find(O=>O.name==="tangent"),m=!!(i&&g);m&&(c+=`
  ...
  `,P="var color: vec4f = vec4();",b=`
      return color;
  `,B=n.attributes.find(O=>O.name==="color0");let C=B?B.type==="vec3f"?"var baseColor: vec4f = vec4(fsInput.color0, 1.0) * material.baseColorFactor;":"var baseColor: vec4f = fsInput.color0 * material.baseColorFactor;":"var baseColor: vec4f = material.baseColorFactor;";t&&(C=`
    ...
    `),C+=`
      color = baseColor;
  `;let w=n.attributes.find(O=>O.name==="normal")?`
  ...
  `;let{shadingModel:G}=e;G||(G="PBR");let{chunks:A}=e||{};const{iblParameters:j}=e||{},{lutTexture:q,envDiffuseTexture:N,envSpecularTexture:E}=j||{};N&&N.texture&&E&&E.texture&&q&&q.texture&&G==="IBL"?(n.parameters.uniforms={...n.parameters.uniforms,ibl:{struct:{diffuseStrength:{type:"f32",value:j?.diffuseStrength??.5},specularStrength:{type:"f32",value:j?.specularStrength??.5}}}},n.parameters.textures=[...n.parameters.textures,q.texture,N.texture,E.texture],q.samplerName=q.samplerName||"defaultSampler",N.samplerName=N.samplerName||"defaultSampler",E.samplerName=E.samplerName||"defaultSampler"):G==="IBL"&&(F("IBL shading requested but one of the LUT, environment specular or diffuse texture is missing. Defaulting to PBR shading."),G="PBR");const D={toneMapping:"khronos",receiveShadows:!!n.parameters.receiveShadows,useOcclusion:!0},Y=(()=>{switch(G){case"Lambert":default:return As(D);case"Phong":return Fs(D);case"PBR":return Us(D);case"IBL":return Is(D)}})(),K="",fe="";A?(A.additionalFragmentHead||(A.additionalFragmentHead=Y),A.preliminaryColorContribution||(A.preliminaryColorContribution=K),A.additionalColorContribution||(A.additionalColorContribution=fe)):A={additionalFragmentHead:Y,preliminaryColorContribution:K,additionalColorContribution:fe};const Lt=(()=>{switch(G){case"Lambert":default:return`
      color = vec4(
        getLambert(
          normal,
          worldPosition,
    ...
    color = vec4(color.rgb + emissive, color.a);
      ...
      ${A.additionalColorContribution}
      
      ${b}
    }
  `;return{vertex:{code:M,entryPoint:"main"},fragment:{code:Cn,entryPoint:"main"}}},vn=async(n,e,t)=>{if(t.options.viewDimension!=="cube"){F("Could not compute the diffuse texture because the specular texture is not a cube map:"+t.options.viewDimension);return}const i=`    
  ...
  `;let s=new ee(n,{label:"Diffuse storage cubemap",name:"diffuseEnvMap",format:"rgba32float",visibility:["compute"],usage:["copySrc","storageBinding"],type:"storage",fixedSize:{width:t.size.width,height:t.size.height,depth:6},viewDimension:"2d-array"});const r=new Pe(n,{label:"Compute diffuse sampler",name:"specularSampler",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",minFilter:"linear",magFilter:"linear"});let o=new Ii(n,{autoRender:!1,dispatchSize:[Math.ceil(t.size.width/8),Math.ceil(t.size.height/8),6],shaders:{compute:{code:i}},uniforms:{params:{struct:{faceSize:{type:"u32",value:t.size.width},maxMipLevel:{type:"u32",value:t.texture.mipLevelCount},sampleCount:{type:"u32",value:2048}}}},samplers:[r],textures:[t,s]});await o.material.compileMaterial(),n.onBeforeRenderScene.add(a=>{n.renderSingleComputePass(a,o),a.copyTextureToTexture({texture:s.texture},{texture:e.texture},[e.texture.width,e.texture.height,e.texture.depthOrArrayLayers])},{once:!0}),n.onAfterCommandEncoderSubmission.add(()=>{o.destroy(),s.destroy(),s=null,o=null},{once:!0})};var wn=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},pe=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},ie=(n,e,t)=>(wn(n,e,"access private method"),t),yi,Hs,vi,Zs,Rt,wi,Ye,zt,bi,Ks,Mi,Qs,Et,Ci,Bi,Js,Pi,er;class bn{constructor(){pe(this,yi),pe(this,vi),pe(this,Rt),pe(this,Ye),pe(this,bi),pe(this,Mi),pe(this,Et),pe(this,Bi),pe(this,Pi)}async loadFromUrl(e){const t=await(await fetch(e)).arrayBuffer();return ie(this,yi,Hs).call(this,new DataView(t))}equirectangularToCubeMap(e){const t=Math.max(e.width/4,e.height/2),i={posX:new Float32Array(t*t*4),negX:new Float32Array(t*t*4),posY:new Float32Array(t*t*4),negY:new Float32Array(t*t*4),posZ:new Float32Array(t*t*4),negZ:new Float32Array(t*t*4)};function s(l,u){const d=Math.floor(l*e.width),p=(Math.floor(u*e.height)*e.width+d)*4;return[e.data[p],e.data[p+1],e.data[p+2],e.data[p+3]]}function r(l,u,d,c){const p=(d*t+u)*4;i[l][p]=c[0],i[l][p+1]=c[1],i[l][p+2]=c[2],i[l][p+3]=c[3]}function o(l,u,d){const c=2*(u+.5)/t-1,p=2*(d+.5)/t-1;switch(l){case"posX":return[c,-1,-p];case"negX":return[-c,1,-p];case"posY":return[-p,-c,1];case"negY":return[p,-c,-1];case"posZ":return[-1,-c,-p];case"negZ":return[1,c,-p]}}function a(l){const[u,d,c]=l,p=Math.sqrt(u*u+d*d),g=Math.atan2(d,u),m=Math.atan2(c,p),x=(g+Math.PI)/(2*Math.PI),v=(m+Math.PI/2)/Math.PI;return[x,v]}for(const l in i)for(let u=0;u<t;u++)for(let d=0;d<t;d++){const c=o(l,d,u),[p,g]=a(c),m=s(p,g);r(l,d,u,m)}return[i.posX,i.negX,i.posY,i.negY,i.posZ,i.negZ].map(l=>({data:l,width:t,height:t,exposure:e.exposure,gamma:e.gamma}))}}yi=new WeakSet,Hs=function(n){const e={data:n,offset:0},t=ie(this,vi,Zs).call(this,e);return{width:t.width,height:t.height,exposure:t.exposure,gamma:t.gamma,data:ie(this,bi,Ks).call(this,e,t)}},vi=new WeakSet,Zs=function(n){let e=ie(this,Ye,zt).call(this,n);const t={colorCorr:[1,1,1],exposure:1,gamma:1,width:0,height:0,flipX:!1,flipY:!1};if(e!=="#?RADIANCE"&&e!=="#?RGBE")throw new Error("Incorrect file format!");for(;e!=="";){e=ie(this,Ye,zt).call(this,n);const s=e.split("=");switch(s[0]){case"GAMMA":t.gamma=parseFloat(s[1]);break;case"FORMAT":if(s[1]!=="32-bit_rle_rgbe"&&s[1]!=="32-bit_rle_xyze")throw new Error("Incorrect encoding format!");break;case"EXPOSURE":t.exposure=parseFloat(s[1]);break;case"COLORCORR":t.colorCorr=s[1].replace(/^\s+|\s+$/g,"").split(" ").map(r=>parseFloat(r));break}}e=ie(this,Ye,zt).call(this,n);const i=e.split(" ");return ie(this,Rt,wi).call(this,i[0],parseInt(i[1]),t),ie(this,Rt,wi).call(this,i[2],parseInt(i[3]),t),t},Rt=new WeakSet,wi=function(n,e,t){switch(n){case"+X":t.width=e;break;case"-X":t.width=e,t.flipX=!0,console.warn("Flipping horizontal orientation not currently supported");break;case"-Y":t.height=e,t.flipY=!0;break;case"+Y":t.height=e;break}},Ye=new WeakSet,zt=function(n){let e,t="";for(;(e=n.data.getUint8(n.offset++))!==10;)t+=String.fromCharCode(e);return t},bi=new WeakSet,Ks=function(n,e){const t=n.data.getUint16(n.offset);let i;if(t===514)i=ie(this,Mi,Qs).call(this,n,e),e.flipX&&ie(this,Bi,Js).call(this,i,e),e.flipY&&ie(this,Pi,er).call(this,i,e);else throw new Error("Obsolete HDR file version!");return i},Mi=new WeakSet,Qs=function(n,e){const{width:t,height:i,colorCorr:s}=e,r=new Float32Array(t*i*4);let o=0,{offset:a,data:h}=n;for(let l=0;l<i;++l){if(h.getUint16(a)!==514)throw new Error("Incorrect scanline start hash");if(h.getUint16(a+2)!==t)throw new Error("Scanline doesn't match picture dimension!");a+=4;const u=t*4,d=[];let c=0;for(;c<u;){let p=h.getUint8(a++);if(p>128){const g=p-128;p=h.getUint8(a++);for(let m=0;m<g;++m)d[c++]=p}else for(let g=0;g<p;++g)d[c++]=h.getUint8(a++)}for(c=0;c<t;++c){const p=d[c],g=d[c+t],m=d[c+t*2];let x=d[c+t*3];x=x?Math.pow(2,x-136):0,r[o++]=p*x*s[0],r[o++]=g*x*s[1],r[o++]=m*x*s[2],r[o++]=x}}return r},Et=new WeakSet,Ci=function(n,e,t){e*=4,t*=4;for(let i=0;i<4;++i){const s=n[e+i];n[e+i]=n[t+i],n[t+i]=s}},Bi=new WeakSet,Js=function(n,e){const{width:t,height:i}=e,s=t>>1;for(let r=0;r<i;++r){const o=r*t;for(let a=0;a<s;++a){const h=o+a,l=o+t-1-a;ie(this,Et,Ci).call(this,n,h,l)}}},Pi=new WeakSet,er=function(n,e){const{width:t,height:i}=e,s=i>>1;for(let r=0;r<s;++r){const o=r*t,a=(i-1-r)*t;for(let h=0;h<t;++h)ie(this,Et,Ci).call(this,n,o+h,a+h)}};const Mn=n=>{const{scene:e}=n;if(!e)return;const t=[];e.computePassEntries.forEach(i=>{t.push({command:"Render ComputePass",content:i.options.label}),i.material.bindGroups.forEach(s=>{s.bufferBindings.forEach(r=>{r.shouldCopyResult&&t.push({command:"Copy buffer to buffer",source:`${r.name} buffer`,destination:`${r.name} result buffer`})})})});for(const i in e.renderPassEntries){let s=0;e.renderPassEntries[i].forEach(r=>{if(!e.getRenderPassEntryLength(r))return;const o=r.renderPass.options.useColorAttachments?r.renderPass.options.colorAttachments.length===0&&r.renderPass.options.useDepth?`${r.renderTexture.options.label} depth pass`:r.renderPass.options.colorAttachments.length>1?`${r.renderTexture.options.label} multiple targets`:r.renderTexture?`${r.renderTexture.options.label}`:"Context current texture":void 0;let a=r.renderPass.options.label;const h={loadOp:r.renderPass.options.useColorAttachments?i==="screen"&&s>0?"load":r.renderPass.options.loadOp:void 0,depthLoadOp:void 0,sampleCount:r.renderPass.options.sampleCount,...r.renderPass.options.qualityRatio!==1&&{qualityRatio:r.renderPass.options.qualityRatio}};if(r.renderPass.options.useDepth&&(h.depthLoadOp=r.renderPass.options.depthLoadOp),s++,r.element)r.element.type==="ShaderPass"&&!(r.element.inputTarget||r.element.outputTarget)&&(t.push({command:"Copy texture to texture",source:o,destination:`${r.element.options.label} renderTexture`}),h.loadOp="clear"),a+=" "+JSON.stringify(h),t.push({command:`Render ${r.element.type}`,source:r.element.options.label,destination:o,descriptor:a}),r.element.type==="ShaderPass"&&!r.element.outputTarget&&r.element.options.copyOutputToRenderTexture?t.push({command:"Copy texture to texture",source:o,destination:`${r.element.options.label} renderTexture`}):r.element.type==="PingPongPlane"&&t.push({command:"Copy texture to texture",source:o,destination:`${r.element.renderTexture.options.label}`});else if(r.stack){a+=" "+JSON.stringify(h);for(const l in r.stack)for(const u in r.stack[l])r.stack[l][u].length&&t.push({command:`Render stack (${l} ${u} objects)`,source:r.stack[l][u],destination:o,descriptor:a})}})}console.table(t)};y.AmbientLight=br,y.BindGroup=Ke,y.Binding=He,y.Box3=he,y.BoxGeometry=nn,y.Buffer=Be,y.BufferBinding=ue,y.Camera=_i,y.ComputeMaterial=Fi,y.ComputePass=Ii,y.ComputePipelineEntry=Ts,y.DOMElement=ni,y.DOMFrustum=Vi,y.DOMMesh=Ws,y.DOMObject3D=Vs,y.DOMTexture=ve,y.DirectionalLight=ds,y.FullscreenPlane=ei,y.GLTFLoader=St,y.GLTFScenesManager=xn,y.GPUCameraRenderer=ui,y.GPUCurtains=sn,y.GPUCurtainsRenderer=Pt,y.GPUDeviceManager=Gs,y.GPURenderer=hi,y.Geometry=Vt,y.HDRLoader=bn,y.IndexedGeometry=_e,y.Mat3=de,y.Mat4=L,y.Material=kt,y.Mesh=Ps,y.Object3D=ae,y.OrbitControls=rn,y.PingPongPlane=an,y.PipelineEntry=ii,y.PipelineManager=Rs,y.Plane=js,y.PlaneGeometry=Nt,y.PointLight=ys,y.ProjectedObject3D=ti,y.Quat=ne,y.RenderMaterial=Ht,y.RenderPass=dt,y.RenderPipelineEntry=si,y.RenderTarget=jt,y.Sampler=Pe,y.SamplerBinding=Oi,y.Scene=zs,y.ShaderPass=Yr,y.SphereGeometry=on,y.Texture=ee,y.TextureBindGroup=It,y.TextureBinding=$t,y.Vec2=z,y.Vec3=f,y.WritableBufferBinding=Ut,y.applyDirectionalShadows=Ue,y.applyPointShadows=Fe,y.buildShaders=yn,y.computeDiffuseFromSpecular=vn,y.getDefaultPointShadowDepthFs=ts,y.getDefaultPointShadowDepthVs=es,y.getDefaultShadowDepthVs=Ki,y.getIBL=Is,y.getIBLIndirect=$s,y.getLambert=As,y.getLambertDirect=_s,y.getPBR=Us,y.getPBRDirect=ci,y.getPCFDirectionalShadows=Ji,y.getPCFPointShadowContribution=is,y.getPCFPointShadows=ss,y.getPCFShadowContribution=Qi,y.getPCFShadows=De,y.getPhong=Fs,y.getPhongDirect=Ds,y.lambertUtils=Ct,y.logSceneCommands=Mn,y.pbrUtils=di,y.toneMappingUtils=We});
