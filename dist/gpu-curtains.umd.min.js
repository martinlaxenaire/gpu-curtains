var vo=Object.defineProperty;var l=(v,W)=>vo(v,"name",{value:W,configurable:!0});(function(v,W){typeof exports=="object"&&typeof module<"u"?W(exports):typeof define=="function"&&define.amd?define(["exports"],W):(v=typeof globalThis<"u"?globalThis:v||self,W(v.window=v.window||{}))})(this,function(v){"use strict";const W=l(()=>"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,n=>{const e=Math.random()*16|0;return(n==="x"?e:e&3|8).toString(16).toUpperCase()}),"generateUUID"),nt=l(n=>n.replace(/(?:^\w|[A-Z]|\b\w)/g,(e,t)=>t===0?e.toLowerCase():e.toUpperCase()).replace(/\s+/g,""),"toCamelCase"),at=l(n=>{const e=nt(n);return e.charAt(0).toUpperCase()+e.slice(1)},"toKebabCase");let Gi=0;const L=l(n=>{Gi>100||(console.warn(Gi===100?"GPUCurtains: too many warnings thrown, stop logging.":n),Gi++)},"throwWarning"),ie=l(n=>{throw new Error(n)},"throwError"),Ai=l((n,e="GPURenderer",t)=>{const i=t?`Unable to create ${t} because the ${e} is not defined: ${n}`:`The ${e} is not defined: ${n}`;ie(i)},"formatRendererError"),I=l((n,e)=>(n=n&&n.renderer||n,n&&(n.type==="GPURenderer"||n.type==="GPUCameraRenderer"||n.type==="GPUCurtainsRenderer")||Ai(n,"GPURenderer",e),n),"isRenderer"),Oe=l((n,e)=>(n=n&&n.renderer||n,n&&(n.type==="GPUCameraRenderer"||n.type==="GPUCurtainsRenderer")||Ai(n,"GPUCameraRenderer",e),n),"isCameraRenderer"),Di=l((n,e)=>(n=n&&n.renderer||n,n&&n.type==="GPUCurtainsRenderer"||Ai(n,"GPUCurtainsRenderer",e),n),"isCurtainsRenderer"),Ln=l(n=>n.constructor.name==="Mesh"||n.constructor.name==="DOMMesh"||n.constructor.name==="Plane"?n:!1,"isProjectedMesh"),Lt=(()=>{let n,e;const t={};return l(function(s,r){e||(e=s.createShaderModule({label:"textured quad shaders for mip level generation",code:`
            struct VSOutput {
...
}`,"getDefaultPointShadowDepthFs"),Pr=`
fn getPCFPointShadowContribution(index: i32, shadowPosition: vec4f, depthCubeTexture: texture_depth_cube) -> f32 {
  ...
  return visibility;
}`,Tr=l(n=>{const e=n.shadowCastingLights.filter(i=>i.type==="pointLights"),t=Math.max(n.lightsBindingParams.pointLights.max,1);return`
...
`,on=l(({addUtils:n=!0,receiveShadows:e=!1,toneMapping:t="linear",useOcclusion:i=!1}={})=>`
${n?fi:""}
${an}
${t?wt:""}
...
`,"getIBL");var fn=l((n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},"__accessCheck$5"),Se=l((n,e,t)=>(fn(n,e,"read from private field"),t?t.call(n):e.get(n)),"__privateGet$3"),ws=l((n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},"__privateAdd$5"),Na=l((n,e,t,i)=>(fn(n,e,"write to private field"),e.set(n,t),t),"__privateSet$3"),Bt,Ne,pi;class pn extends is{static{l(this,"DOMObject3D")}constructor(e,t,i={}){super(e),ws(this,Bt,new m),ws(this,Ne,new m(1)),ws(this,pi,1),this.boundingBox=new Be(new m(-1),new m(1)),this._onAfterDOMElementResizeCallback=()=>{},e=Di(e,"DOM3DObject"),this.renderer=e,this.size={shouldUpdate:!0,normalizedWorld:{size:new G(1),position:new G},cameraWorld:{size:new G(1)},scaledWorld:{size:new m(1),position:new m}},this.watchScroll=i.watchScroll,this.camera=this.renderer.camera,this.boundingBox.min.onChange(()=>this.shouldUpdateComputedSizes()),this.boundingBox.max.onChange(()=>this.shouldUpdateComputedSizes()),this.setDOMElement(t),this.renderer.domObjects.push(this)}setDOMElement(e){this.domElement=new ns({element:e,onSizeChanged:t=>this.resize(t),onPositionChanged:()=>this.onPositionChanged()}),this.updateSizeAndPosition()}onPositionChanged(){this.watchScroll&&this.shouldUpdateComputedSizes()}resetDOMElement(e){this.domElement&&this.domElement.destroy(),this.setDOMElement(e)}resize(e=null){!e&&(!this.domElement||this.domElement?.isResizing)||(this.updateSizeAndPosition(),this._onAfterDOMElementResizeCallback&&this._onAfterDOMElementResizeCallback())}get boundingRect(){return this.domElement?.boundingRect??{width:1,height:1,top:0,right:0,bottom:0,left:0,x:0,y:0}}setTransforms(){super.setTransforms(),this.transforms.origin.model.set(.5,.5,0),this.transforms.origin.world=new m,this.transforms.position.document=new m,this.documentPosition.onChange(()=>this.applyPosition()),this.transformOrigin.onChange(()=>this.setWorldTransformOrigin())}get documentPosition(){return this.transforms.position.document}set documentPosition(e){this.transforms.position.document=e,this.applyPosition()}get DOMObjectWorldScale(){return Se(this,Ne).clone()}get worldScale(){return this.DOMObjectWorldScale.multiply(this.scale)}get worldPosition(){return Se(this,Bt).clone()}get transformOrigin(){return this.transforms.origin.model}set transformOrigin(e){this.transforms.origin.model=e,this.setWorldTransformOrigin()}get worldTransformOrigin(){return this.transforms.origin.world}set worldTransformOrigin(e){this.transforms.origin.world=e}shouldUpdateMatrices(){super.shouldUpdateMatrices(),(this.matricesNeedUpdate||this.size.shouldUpdate)&&(this.updateSizeAndPosition(),this.matricesNeedUpdate=!0),this.size.shouldUpdate=!1}shouldUpdateComputedSizes(){this.size.shouldUpdate=!0}updateSizeAndPosition(){this.setWorldSizes(),this.applyDocumentPosition(),this.shouldUpdateModelMatrix()}applyDocumentPosition(){let e=new m(0,0,0);this.documentPosition.equals(e)||(e=this.documentToWorldSpace(this.documentPosition)),Se(this,Bt).set(this.position.x+this.size.scaledWorld.position.x+e.x,this.position.y+this.size.scaledWorld.position.y+e.y,this.position.z+this.size.scaledWorld.position.z+this.documentPosition.z/this.camera.CSSPerspective)}applyTransformOrigin(){this.size&&(this.setWorldTransformOrigin(),super.applyTransformOrigin())}updateModelMatrix(){this.modelMatrix.composeFromOrigin(Se(this,Bt),this.quaternion,this.scale,this.worldTransformOrigin),this.modelMatrix.scale(this.DOMObjectWorldScale),this.shouldUpdateWorldMatrix()}documentToWorldSpace(e=new m){return new m(e.x*this.renderer.pixelRatio/this.renderer.boundingRect.width*this.camera.visibleSize.width,-(e.y*this.renderer.pixelRatio/this.renderer.boundingRect.height)*this.camera.visibleSize.height,e.z)}computeWorldSizes(){const e=this.renderer.boundingRect,t={x:this.boundingRect.width/2+this.boundingRect.left,y:this.boundingRect.height/2+this.boundingRect.top},i={x:e.width/2+e.left,y:e.height/2+e.top},{size:s,center:r}=this.boundingBox;s.x!==0&&s.y!==0&&s.z!==0&&r.divide(s),this.size.normalizedWorld.size.set(this.boundingRect.width/e.width,this.boundingRect.height/e.height),this.size.normalizedWorld.position.set((t.x-i.x)/e.width,(i.y-t.y)/e.height),this.size.cameraWorld.size.set(this.size.normalizedWorld.size.x*this.camera.visibleSize.width,this.size.normalizedWorld.size.y*this.camera.visibleSize.height),this.size.scaledWorld.size.set(this.size.cameraWorld.size.x/s.x,this.size.cameraWorld.size.y/s.y,1),this.size.scaledWorld.size.z=this.size.scaledWorld.size.y*(s.x/s.y/(this.boundingRect.width/this.boundingRect.height)),this.size.scaledWorld.position.set(this.size.normalizedWorld.position.x*this.camera.visibleSize.width,this.size.normalizedWorld.position.y*this.camera.visibleSize.height,0)}setWorldSizes(){this.computeWorldSizes(),this.setWorldScale(),this.setWorldTransformOrigin()}setWorldScale(){Se(this,Ne).set(this.size.scaledWorld.size.x,this.size.scaledWorld.size.y,this.size.scaledWorld.size.z*Se(this,pi)),this.shouldUpdateMatrixStack()}set DOMObjectDepthScaleRatio(e){Na(this,pi,e),this.setWorldScale()}setWorldTransformOrigin(){this.transforms.origin.world=new m((this.transformOrigin.x*2-1)*Se(this,Ne).x,-(this.transformOrigin.y*2-1)*Se(this,Ne).y,this.transformOrigin.z*Se(this,Ne).z),this.shouldUpdateMatrixStack()}updateScrollPosition(e={x:0,y:0}){(e.x||e.y)&&this.domElement.updateScrollPosition(e)}onAfterDOMElementResize(e){return e&&(this._onAfterDOMElementResizeCallback=e),this}destroy(){super.destroy(),this.domElement?.destroy()}}Bt=new WeakMap,Ne=new WeakMap,pi=new WeakMap;const mn={autoloadSources:!0,watchScroll:!0};class gn extends Wr(pn){static{l(this,"DOMMesh")}constructor(e,t,i){super(e,t,{...mn,...i}),this._onLoadingCallback=r=>{},i={...mn,...i},Di(e,i.label?i.label+" DOMMesh":"DOMMesh"),this.type="DOMMesh";const{autoloadSources:s}=i;this.autoloadSources=s,this.sourcesReady=!1,this.setInitSources()}get ready(){return this._ready}set ready(e){e&&!this._ready&&this.sourcesReady&&this._onReadyCallback&&this._onReadyCallback(),this._ready=e}get sourcesReady(){return this._sourcesReady}set sourcesReady(e){e&&!this._sourcesReady&&this.ready&&this._onReadyCallback&&this._onReadyCallback(),this._sourcesReady=e}addToScene(e=!1){super.addToScene(e),e&&this.renderer.domMeshes.push(this)}removeFromScene(e=!1){super.removeFromScene(e),e&&(this.renderer.domMeshes=this.renderer.domMeshes.filter(t=>t.uuid!==this.uuid))}setInitSources(){let e=0,t=0;if(this.autoloadSources){const i=this.domElement.element.querySelectorAll("img"),s=this.domElement.element.querySelectorAll("video"),r=this.domElement.element.querySelectorAll("canvas");e=i.length+s.length+r.length;const a=l(o=>{t++,this._onLoadingCallback&&this._onLoadingCallback(o),t===e&&(this.sourcesReady=!0)},"onSourceUploaded");e||(this.sourcesReady=!0),i.length&&i.forEach(o=>{const h=this.createDOMTexture({name:o.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>a(h)).loadImage(o.src)}),s.length&&s.forEach(o=>{const h=this.createDOMTexture({name:o.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>a(h)).loadVideo(o)}),r.length&&r.forEach(o=>{const h=this.createDOMTexture({name:o.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>a(h)).loadCanvas(o)})}else this.sourcesReady=!0}resetDOMElement(e){e?super.resetDOMElement(e):!e&&!this.renderer.production&&L(`${this.options.label}: You are trying to reset a ${this.type} with a HTML element that does not exist. The old HTML element will be kept instead.`)}get pixelRatioBoundingRect(){const e=window.devicePixelRatio??1,t=this.renderer.pixelRatio/e;return Object.keys(this.domElement.boundingRect).reduce((i,s)=>({...i,[s]:this.domElement.boundingRect[s]*t}),{x:0,y:0,width:0,height:0,top:0,right:0,bottom:0,left:0})}computeGeometry(){super.computeGeometry(),this.boundingBox.copy(this.geometry.boundingBox)}onLoading(e){return e&&(this._onLoadingCallback=e),this}}const Wa={label:"Plane",instancesCount:1,vertexBuffers:[]};class yn extends gn{static{l(this,"Plane")}constructor(e,t,i={}){e=Di(e,i.label?i.label+" Plane":"Plane");const s={...Wa,...i};let{geometry:r,widthSegments:a,heightSegments:o,...h}=s;const{instancesCount:u,vertexBuffers:d,...c}=h;if(!r||r.type!=="PlaneGeometry"){a=a??1,o=o??1;const p=a*o+a;d.length||(r=oi.getPlaneGeometryByID(p)),r?r.instancesCount=u:(r=new Ni({widthSegments:a,heightSegments:o,instancesCount:u,vertexBuffers:d}),oi.addPlaneGeometry(r))}super(e,t,{geometry:r,...c}),this.type="Plane"}}class mi extends ls{static{l(this,"GPUCurtainsRenderer")}constructor({deviceManager:e,label:t,container:i,pixelRatio:s=1,autoResize:r=!0,context:a={},renderPass:o,camera:h,lights:u}){super({deviceManager:e,label:t,container:i,pixelRatio:s,autoResize:r,context:a,renderPass:o,camera:h,lights:u}),this.type="GPUCurtainsRenderer"}setRendererObjects(){super.setRendererObjects(),this.domMeshes=[],this.domObjects=[]}onCameraMatricesChanged(){super.onCameraMatricesChanged(),this.domObjects.forEach(e=>{e.updateSizeAndPosition()})}resizeMeshes(){this.meshes.forEach(e=>{"domElement"in e||e.resize(this.boundingRect)}),this.domObjects.forEach(e=>{e.domElement.isResizing||e.domElement.setSize()})}}class ja{static{l(this,"ScrollManager")}constructor({scroll:e={x:0,y:0},delta:t={x:0,y:0},shouldWatch:i=!0,onScroll:s=l((r={x:0,y:0})=>{},"onScroll")}={}){this.scroll=e,this.delta=t,this.shouldWatch=i,this.onScroll=s,this.shouldWatch&&window.addEventListener("scroll",this.setScroll.bind(this),{passive:!0})}setScroll(){this.updateScrollValues({x:window.pageXOffset,y:window.pageYOffset})}updateScrollValues({x:e,y:t}){const i=this.scroll;this.scroll={x:e,y:t},this.delta={x:i.x-this.scroll.x,y:i.y-this.scroll.y},this.onScroll&&this.onScroll(this.delta)}destroy(){this.shouldWatch&&window.removeEventListener("scroll",this.setScroll.bind(this),{passive:!0})}}class qa{static{l(this,"GPUCurtains")}constructor({container:e,label:t,pixelRatio:i=window.devicePixelRatio??1,context:s={},production:r=!1,adapterOptions:a={},renderPass:o,camera:h,lights:u,autoRender:d=!0,autoResize:c=!0,watchScroll:p=!0}={}){this._onScrollCallback=()=>{},this._onErrorCallback=()=>{},this._onContextLostCallback=()=>{},this._onContextDestroyedCallback=()=>{},this.type="CurtainsGPU",this.options={container:e,label:t,pixelRatio:i,camera:h,lights:u,production:r,adapterOptions:a,context:s,renderPass:o,autoRender:d,autoResize:c,watchScroll:p},this.setDeviceManager(),e&&this.setContainer(e),this.initEvents()}setContainer(e){if(e)if(typeof e=="string")if(e=document.querySelector(e),e)this.options.container=e;else{const t=document.createElement("div");t.setAttribute("id","curtains-gpu-canvas"),document.body.appendChild(t),this.options.container=t}else e instanceof Element&&(this.options.container=e);else{const t=document.createElement("div");t.setAttribute("id","curtains-gpu-canvas"),document.body.appendChild(t),this.options.container=t}this.container=this.options.container,this.setMainRenderer()}setMainRenderer(){this.createCurtainsRenderer({deviceManager:this.deviceManager,label:this.options.label||"GPUCurtains main GPUCurtainsRenderer",container:this.options.container,pixelRatio:this.options.pixelRatio,autoResize:this.options.autoResize,context:this.options.context,renderPass:this.options.renderPass,camera:this.options.camera,lights:this.options.lights})}patchRendererOptions(e){return e.pixelRatio===void 0&&(e.pixelRatio=this.options.pixelRatio),e.autoResize===void 0&&(e.autoResize=this.options.autoResize),e}createRenderer(e){return e=this.patchRendererOptions(e),new hs({...e,deviceManager:this.deviceManager})}createCameraRenderer(e){return e=this.patchRendererOptions(e),new ls({...e,deviceManager:this.deviceManager})}createCurtainsRenderer(e){return e=this.patchRendererOptions(e),new mi({...e,deviceManager:this.deviceManager})}setDeviceManager(){this.deviceManager=new Zr({label:"GPUCurtains default device",production:this.options.production,adapterOptions:this.options.adapterOptions,autoRender:this.options.autoRender,onError:()=>setTimeout(()=>{this._onErrorCallback&&this._onErrorCallback()},0),onDeviceLost:e=>this._onContextLostCallback&&this._onContextLostCallback(e),onDeviceDestroyed:e=>this._onContextDestroyedCallback&&this._onContextDestroyedCallback(e)})}get renderers(){return this.deviceManager.renderers}get renderer(){return this.renderers[0]}async setDevice({adapter:e=null,device:t=null}={}){await this.deviceManager.init({adapter:e,device:t})}async restoreContext(){await this.deviceManager.restoreDevice()}get pingPongPlanes(){return this.renderers?.map(e=>e.pingPongPlanes).flat()}get shaderPasses(){return this.renderers?.map(e=>e.shaderPasses).flat()}get meshes(){return this.renderers?.map(e=>e.meshes).flat()}get domMeshes(){return this.renderers?.filter(e=>e instanceof mi).map(e=>e.domMeshes).flat()}get domObjects(){return this.renderers?.filter(e=>e instanceof mi).map(e=>e.domObjects).flat()}get planes(){return this.domMeshes.filter(e=>e instanceof yn)}get computePasses(){return this.renderers?.map(e=>e.computePasses).flat()}get boundingRect(){return this.renderer?.boundingRect}initScroll(){this.scrollManager=new ja({scroll:{x:window.pageXOffset,y:window.pageYOffset},delta:{x:0,y:0},shouldWatch:this.options.watchScroll,onScroll:e=>this.updateScroll(e)})}updateScroll(e={x:0,y:0}){this.domObjects.forEach(t=>{t.domElement&&t.watchScroll&&t.updateScrollPosition(e)}),this._onScrollCallback&&this._onScrollCallback()}updateScrollValues(e={x:0,y:0}){this.scrollManager.updateScrollValues(e)}get scrollDelta(){return this.scrollManager.delta}get scrollValues(){return this.scrollManager.scroll}initEvents(){rs.useObserver(this.options.autoResize),this.initScroll()}onBeforeRender(e){return this.deviceManager.onBeforeRender(e),this}onAfterRender(e){return this.deviceManager.onAfterRender(e),this}onScroll(e){return e&&(this._onScrollCallback=e),this}onError(e){return e&&(this._onErrorCallback=e),this}onContextLost(e){return e&&(this._onContextLostCallback=e),this}onContextDestroyed(e){return e&&(this._onContextDestroyedCallback=e),this}render(){this.deviceManager.render()}destroy(){this.deviceManager.destroy(),this.scrollManager?.destroy(),rs.destroy()}}var Bs=l((n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},"__accessCheck$4"),M=l((n,e,t)=>(Bs(n,e,"read from private field"),t?t.call(n):e.get(n)),"__privateGet$2"),V=l((n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},"__privateAdd$4"),Le=l((n,e,t,i)=>(Bs(n,e,"write to private field"),e.set(n,t),t),"__privateSet$2"),D=l((n,e,t)=>(Bs(n,e,"access private method"),t),"__privateMethod$3"),q,oe,Ge,U,Ke,Ze,Mt,Je,gi,Ms,Cs,xn,Ss,vn,yi,Ps,xi,Ts,vi,Rs,bi,zs,wi,Es,Bi,_s,Mi,Ls,Ci,Gs,We,Qe,Si,As,Ds,bn,Os,wn;const et=new G,tt=new G,Ae=new m;class Ya{static{l(this,"OrbitControls")}constructor({camera:e,element:t=null,target:i=new m,enableZoom:s=!0,minZoom:r=0,maxZoom:a=1/0,zoomSpeed:o=1,enableRotate:h=!0,minPolarAngle:u=0,maxPolarAngle:d=Math.PI,minAzimuthAngle:c=-1/0,maxAzimuthAngle:p=1/0,rotateSpeed:f=1,enablePan:g=!0,panSpeed:y=1}){if(V(this,gi),V(this,Cs),V(this,Ss),V(this,yi),V(this,xi),V(this,vi),V(this,bi),V(this,wi),V(this,Bi),V(this,Mi),V(this,Ci),V(this,We),V(this,Si),V(this,Ds),V(this,Os),V(this,q,null),V(this,oe,new m),V(this,Ge,!1),V(this,U,{radius:1,phi:0,theta:0}),V(this,Ke,new G),V(this,Ze,!1),V(this,Mt,new G),V(this,Je,new m),!e){L("OrbitControls: cannot initialize without a camera.");return}D(this,gi,Ms).call(this,{target:i,enableZoom:s,minZoom:r,maxZoom:a,zoomSpeed:o,enableRotate:h,minPolarAngle:u,maxPolarAngle:d,minAzimuthAngle:c,maxAzimuthAngle:p,rotateSpeed:f,enablePan:g,panSpeed:y}),this.element=t??(typeof window<"u"?window:null),this.useCamera(e)}useCamera(e){this.camera=e,this.camera.position.onChange(()=>{this.camera.lookAt(this.target)}),M(this,oe).copy(this.camera.position).sub(this.target),M(this,U).radius=M(this,oe).length(),M(this,U).theta=Math.atan2(M(this,oe).x,M(this,oe).z),M(this,U).phi=Math.acos(Math.min(Math.max(M(this,oe).y/M(this,U).radius,-1),1)),D(this,We,Qe).call(this)}reset({position:e,target:t,enableZoom:i=this.enableZoom,minZoom:s=this.minZoom,maxZoom:r=this.maxZoom,zoomSpeed:a=this.zoomSpeed,enableRotate:o=this.enableRotate,minPolarAngle:h=this.minPolarAngle,maxPolarAngle:u=this.maxPolarAngle,minAzimuthAngle:d=this.minAzimuthAngle,maxAzimuthAngle:c=this.maxAzimuthAngle,rotateSpeed:p=this.rotateSpeed,enablePan:f=this.enablePan,panSpeed:g=this.panSpeed}={}){D(this,gi,Ms).call(this,{target:t,enableZoom:i,minZoom:s,maxZoom:r,zoomSpeed:a,enableRotate:o,minPolarAngle:h,maxPolarAngle:u,minAzimuthAngle:d,maxAzimuthAngle:c,rotateSpeed:p,enablePan:f,panSpeed:g}),e&&this.updatePosition(e)}updatePosition(e=new m){e.sub(this.target),M(this,U).radius=e.length(),M(this,U).theta=Math.atan2(e.x,e.z),M(this,U).phi=Math.acos(Math.min(Math.max(e.y/M(this,U).radius,-1),1)),D(this,We,Qe).call(this)}set element(e){M(this,q)&&(!e||M(this,q)!==e)&&D(this,Ss,vn).call(this),Le(this,q,e),e&&D(this,Cs,xn).call(this)}get element(){return M(this,q)}destroy(){this.element=null}}q=new WeakMap,oe=new WeakMap,Ge=new WeakMap,U=new WeakMap,Ke=new WeakMap,Ze=new WeakMap,Mt=new WeakMap,Je=new WeakMap,gi=new WeakSet,Ms=l(function({target:n,enableZoom:e=this.enableZoom,minZoom:t=this.minZoom,maxZoom:i=this.maxZoom,zoomSpeed:s=this.zoomSpeed,enableRotate:r=this.enableRotate,minPolarAngle:a=this.minPolarAngle,maxPolarAngle:o=this.maxPolarAngle,minAzimuthAngle:h=this.minAzimuthAngle,maxAzimuthAngle:u=this.maxAzimuthAngle,rotateSpeed:d=this.rotateSpeed,enablePan:c=this.enablePan,panSpeed:p=this.panSpeed}={}){n&&(this.target=n),this.enableZoom=e,this.minZoom=t,this.maxZoom=i,this.zoomSpeed=s,this.enableRotate=r,this.minPolarAngle=a,this.maxPolarAngle=o,this.minAzimuthAngle=h,this.maxAzimuthAngle=u,this.rotateSpeed=d,this.enablePan=c,this.panSpeed=p},"setBaseParams_fn"),Cs=new WeakSet,xn=l(function(){M(this,q).addEventListener("contextmenu",D(this,Ci,Gs).bind(this),!1),M(this,q).addEventListener("mousedown",D(this,yi,Ps).bind(this),!1),M(this,q).addEventListener("mousemove",D(this,vi,Rs).bind(this),!1),M(this,q).addEventListener("mouseup",D(this,wi,Es).bind(this),!1),M(this,q).addEventListener("touchstart",D(this,xi,Ts).bind(this),{passive:!1}),M(this,q).addEventListener("touchmove",D(this,bi,zs).bind(this),{passive:!1}),M(this,q).addEventListener("touchend",D(this,Bi,_s).bind(this),!1),M(this,q).addEventListener("wheel",D(this,Mi,Ls).bind(this),{passive:!1})},"addEvents_fn"),Ss=new WeakSet,vn=l(function(){M(this,q).removeEventListener("contextmenu",D(this,Ci,Gs).bind(this),!1),M(this,q).removeEventListener("mousedown",D(this,yi,Ps).bind(this),!1),M(this,q).removeEventListener("mousemove",D(this,vi,Rs).bind(this),!1),M(this,q).removeEventListener("mouseup",D(this,wi,Es).bind(this),!1),M(this,q).removeEventListener("touchstart",D(this,xi,Ts).bind(this),{passive:!1}),M(this,q).removeEventListener("touchmove",D(this,bi,zs).bind(this),{passive:!1}),M(this,q).removeEventListener("touchend",D(this,Bi,_s).bind(this),!1),M(this,q).removeEventListener("wheel",D(this,Mi,Ls).bind(this),{passive:!1})},"removeEvents_fn"),yi=new WeakSet,Ps=l(function(n){n.button===0&&this.enableRotate?(Le(this,Ge,!0),M(this,Ke).set(n.clientX,n.clientY)):n.button===2&&this.enablePan&&(Le(this,Ze,!0),M(this,Mt).set(n.clientX,n.clientY)),n.stopPropagation(),n.preventDefault()},"onMouseDown_fn"),xi=new WeakSet,Ts=l(function(n){n.touches.length===1&&this.enableRotate&&(Le(this,Ge,!0),M(this,Ke).set(n.touches[0].pageX,n.touches[0].pageY))},"onTouchStart_fn"),vi=new WeakSet,Rs=l(function(n){M(this,Ge)&&this.enableRotate?D(this,Si,As).call(this,n.clientX,n.clientY):M(this,Ze)&&this.enablePan&&D(this,Ds,bn).call(this,n.clientX,n.clientY)},"onMouseMove_fn"),bi=new WeakSet,zs=l(function(n){M(this,Ge)&&this.enableRotate&&D(this,Si,As).call(this,n.touches[0].pageX,n.touches[0].pageY)},"onTouchMove_fn"),wi=new WeakSet,Es=l(function(n){Le(this,Ge,!1),Le(this,Ze,!1)},"onMouseUp_fn"),Bi=new WeakSet,_s=l(function(n){Le(this,Ge,!1),Le(this,Ze,!1)},"onTouchEnd_fn"),Mi=new WeakSet,Ls=l(function(n){this.enableZoom&&(D(this,Os,wn).call(this,n.deltaY),n.preventDefault())},"onMouseWheel_fn"),Ci=new WeakSet,Gs=l(function(n){n.preventDefault()},"onContextMenu_fn"),We=new WeakSet,Qe=l(function(){const n=M(this,U).radius*Math.sin(Math.max(1e-6,M(this,U).phi));M(this,oe).x=n*Math.sin(M(this,U).theta),M(this,oe).y=M(this,U).radius*Math.cos(M(this,U).phi),M(this,oe).z=n*Math.cos(M(this,U).theta),this.camera.position.copy(this.target).add(M(this,oe))},"update_fn"),Si=new WeakSet,As=l(function(n,e){et.set(n,e),tt.copy(et).sub(M(this,Ke)).multiplyScalar(this.rotateSpeed),M(this,U).theta-=2*Math.PI*tt.x/this.camera.size.height,M(this,U).phi-=2*Math.PI*tt.y/this.camera.size.height,M(this,U).theta=Math.min(this.maxAzimuthAngle,Math.max(this.minAzimuthAngle,M(this,U).theta)),M(this,U).phi=Math.min(this.maxPolarAngle,Math.max(this.minPolarAngle,M(this,U).phi)),M(this,Ke).copy(et),D(this,We,Qe).call(this)},"rotate_fn"),Ds=new WeakSet,bn=l(function(n,e){et.set(n,e),tt.copy(et).sub(M(this,Mt)).multiplyScalar(this.panSpeed),M(this,Je).set(0),Ae.copy(this.camera.position).sub(this.target);let t=Ae.length();t*=Math.tan(this.camera.fov/2*Math.PI/180),Ae.set(this.camera.modelMatrix.elements[0],this.camera.modelMatrix.elements[1],this.camera.modelMatrix.elements[2]),Ae.multiplyScalar(-(2*tt.x*t)/this.camera.size.height),M(this,Je).add(Ae),Ae.set(this.camera.modelMatrix.elements[4],this.camera.modelMatrix.elements[5],this.camera.modelMatrix.elements[6]),Ae.multiplyScalar(2*tt.y*t/this.camera.size.height),M(this,Je).add(Ae),M(this,Mt).copy(et),this.target.add(M(this,Je)),M(this,oe).copy(this.camera.position).sub(this.target),M(this,U).radius=M(this,oe).length(),D(this,We,Qe).call(this)},"pan_fn"),Os=new WeakSet,wn=l(function(n){M(this,U).radius=Math.min(this.maxZoom,Math.max(this.minZoom+1e-6,M(this,U).radius+n*this.zoomSpeed/100)),D(this,We,Qe).call(this)},"zoom_fn");var Ha=l((n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},"__accessCheck$3"),Pe=l((n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},"__privateAdd$3"),he=l((n,e,t)=>(Ha(n,e,"access private method"),t),"__privateMethod$2"),Fs,Bn,$s,Mn,Pi,Us,Ct,Ti,ks,Cn,Is,Sn,Ri,Vs,Ns,Pn,Ws,Tn;class Rn{static{l(this,"HDRLoader")}constructor(){Pe(this,Fs),Pe(this,$s),Pe(this,Pi),Pe(this,Ct),Pe(this,ks),Pe(this,Is),Pe(this,Ri),Pe(this,Ns),Pe(this,Ws)}async loadFromUrl(e){const t=await(await fetch(e)).arrayBuffer();return he(this,Fs,Bn).call(this,new DataView(t))}}Fs=new WeakSet,Bn=l(function(n){const e={data:n,offset:0},t=he(this,$s,Mn).call(this,e);return{width:t.width,height:t.height,exposure:t.exposure,gamma:t.gamma,data:he(this,ks,Cn).call(this,e,t)}},"decodeRGBE_fn"),$s=new WeakSet,Mn=l(function(n){let e=he(this,Ct,Ti).call(this,n);const t={colorCorr:[1,1,1],exposure:1,gamma:1,width:0,height:0,flipX:!1,flipY:!1};if(e!=="#?RADIANCE"&&e!=="#?RGBE")throw new Error("Incorrect file format!");for(;e!=="";){e=he(this,Ct,Ti).call(this,n);const s=e.split("=");switch(s[0]){case"GAMMA":t.gamma=parseFloat(s[1]);break;case"FORMAT":if(s[1]!=="32-bit_rle_rgbe"&&s[1]!=="32-bit_rle_xyze")throw new Error("Incorrect encoding format!");break;case"EXPOSURE":t.exposure=parseFloat(s[1]);break;case"COLORCORR":t.colorCorr=s[1].replace(/^\s+|\s+$/g,"").split(" ").map(r=>parseFloat(r));break}}e=he(this,Ct,Ti).call(this,n);const i=e.split(" ");return he(this,Pi,Us).call(this,i[0],parseInt(i[1]),t),he(this,Pi,Us).call(this,i[2],parseInt(i[3]),t),t},"parseHeader_fn"),Pi=new WeakSet,Us=l(function(n,e,t){switch(n){case"+X":t.width=e;break;case"-X":t.width=e,t.flipX=!0,console.warn("Flipping horizontal orientation not currently supported");break;case"-Y":t.height=e,t.flipY=!0;break;case"+Y":t.height=e;break}},"parseSize_fn"),Ct=new WeakSet,Ti=l(function(n){let e,t="";for(;(e=n.data.getUint8(n.offset++))!==10;)t+=String.fromCharCode(e);return t},"readLine_fn"),ks=new WeakSet,Cn=l(function(n,e){const t=n.data.getUint16(n.offset);let i;if(t===514)i=he(this,Is,Sn).call(this,n,e),e.flipX&&he(this,Ns,Pn).call(this,i,e),e.flipY&&he(this,Ws,Tn).call(this,i,e);else throw new Error("Obsolete HDR file version!");return i},"parseData_fn"),Is=new WeakSet,Sn=l(function(n,e){const{width:t,height:i,colorCorr:s}=e,r=new Float32Array(t*i*4);let a=0,{offset:o,data:h}=n;for(let u=0;u<i;++u){if(h.getUint16(o)!==514)throw new Error("Incorrect scanline start hash");if(h.getUint16(o+2)!==t)throw new Error("Scanline doesn't match picture dimension!");o+=4;const d=t*4,c=[];let p=0;for(;p<d;){let f=h.getUint8(o++);if(f>128){const g=f-128;f=h.getUint8(o++);for(let y=0;y<g;++y)c[p++]=f}else for(let g=0;g<f;++g)c[p++]=h.getUint8(o++)}for(p=0;p<t;++p){const f=c[p],g=c[p+t],y=c[p+t*2];let x=c[p+t*3];x=x?Math.pow(2,x-136):0,r[a++]=f*x*s[0],r[a++]=g*x*s[1],r[a++]=y*x*s[2],r[a++]=x}}return r},"parseNewRLE_fn"),Ri=new WeakSet,Vs=l(function(n,e,t){e*=4,t*=4;for(let i=0;i<4;++i){const s=n[e+i];n[e+i]=n[t+i],n[t+i]=s}},"swap_fn"),Ns=new WeakSet,Pn=l(function(n,e){const{width:t,height:i}=e,s=t>>1;for(let r=0;r<i;++r){const a=r*t;for(let o=0;o<s;++o){const h=a+o,u=a+t-1-o;he(this,Ri,Vs).call(this,n,h,u)}}},"flipX_fn"),Ws=new WeakSet,Tn=l(function(n,e){const{width:t,height:i}=e,s=i>>1;for(let r=0;r<s;++r){const a=r*t,o=(i-1-r)*t;for(let h=0;h<t;++h)he(this,Ri,Vs).call(this,n,a+h,o+h)}},"flipY_fn");var Xa=`
...
`,"computeDiffuseFromSpecularCubemap");var Ja=l((n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},"__accessCheck$2"),Qa=l((n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},"__privateAdd$2"),js=l((n,e,t)=>(Ja(n,e,"access private method"),t),"__privateMethod$1"),St,zi;class eo{static{l(this,"EnvironmentMap")}constructor(e,t={lutTextureParams:{size:256,computeSampleCount:1024,label:"Environment LUT texture",name:"lutTexture",format:"rgba32float"},diffuseTextureParams:{size:128,computeSampleCount:2048,label:"Environment diffuse texture",name:"diffuseTexture",format:"rgba16float"},specularTextureParams:{label:"Environment specular texture",name:"specularTexture",format:"rgba16float",generateMips:!0}}){Qa(this,St),e=I(e,"EnvironmentMap"),this.renderer=e,this.options=t,this.sampler=new je(this.renderer,{label:"Clamp sampler",name:"clampSampler",magFilter:"linear",minFilter:"linear",mipmapFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),this.rotation=new Ce(new Float32Array([0,0,1,0,1,0,-1,0,0])),this.hdrLoader=new Rn,this.computeBRDFLUTTexture()}async computeBRDFLUTTexture(){const{size:e,computeSampleCount:t,...i}=this.options.lutTextureParams;this.lutTexture=new Z(this.renderer,{...i,visibility:["fragment"],fixedSize:{width:e,height:e},autoDestroy:!1});let s=new Z(this.renderer,{label:"LUT storage texture",name:"lutStorageTexture",format:this.lutTexture.options.format,visibility:["compute"],usage:["copySrc","storageBinding"],type:"storage",fixedSize:{width:this.lutTexture.size.width,height:this.lutTexture.size.height}}),r=new Xt(this.renderer,{label:"Compute LUT texture",autoRender:!1,dispatchSize:[Math.ceil(s.size.width/16),Math.ceil(s.size.height/16),1],shaders:{compute:{code:Xa}},uniforms:{params:{struct:{sampleCount:{type:"u32",value:t}}}},textures:[s]});await r.material.compileMaterial(),this.renderer.onBeforeRenderScene.add(a=>{this.renderer.renderSingleComputePass(a,r),js(this,St,zi).call(this,a,s,this.lutTexture)},{once:!0}),this.renderer.onAfterCommandEncoderSubmission.add(()=>{r.destroy(),s.destroy(),s=null,r=null},{once:!0})}async computeSpecularCubemapFromHDRData(e){let t=new Z(this.renderer,{label:"Specular storage cubemap",name:"specularStorageCubemap",format:this.specularTexture.options.format,visibility:["compute"],usage:["copySrc","storageBinding"],type:"storage",fixedSize:{width:this.specularTexture.size.width,height:this.specularTexture.size.height,depth:6},viewDimension:"2d-array"}),i=new Xt(this.renderer,{label:"Compute specular cubemap from equirectangular",autoRender:!1,dispatchSize:[Math.ceil(this.specularTexture.size.width/8),Math.ceil(this.specularTexture.size.height/8),6],shaders:{compute:{code:Ka}},storages:{params:{struct:{hdrImageData:{type:"array<vec4f>",value:e.data},imageSize:{type:"vec2f",value:new G(e.width,e.height)},faceSize:{type:"u32",value:this.specularTexture.size.width}}}},textures:[t]});await i.material.compileMaterial();const s=this.renderer.device?.createCommandEncoder({label:"Render once command encoder"});this.renderer.production||s.pushDebugGroup("Render once command encoder"),this.renderer.renderSingleComputePass(s,i),js(this,St,zi).call(this,s,t,this.specularTexture),this.renderer.production||s.popDebugGroup();const r=s.finish();this.renderer.device?.queue.submit([r]),this.specularTexture.texture.mipLevelCount>1&&Lt(this.renderer.device,this.specularTexture.texture),i.destroy(),t.destroy(),t=null,i=null}async computeDiffuseFromSpecular(){if(this.specularTexture.options.viewDimension!=="cube"){L("Could not compute the diffuse texture because the specular texture is not a cube map:"+this.specularTexture.options.viewDimension);return}let e=new Z(this.renderer,{label:"Diffuse storage cubemap",name:"diffuseEnvMap",format:this.diffuseTexture.options.format,visibility:["compute"],usage:["copySrc","storageBinding"],type:"storage",fixedSize:{width:this.diffuseTexture.size.width,height:this.diffuseTexture.size.height,depth:6},viewDimension:"2d-array"}),t=new Xt(this.renderer,{label:"Compute diffuse map from specular map",autoRender:!1,dispatchSize:[Math.ceil(this.diffuseTexture.size.width/8),Math.ceil(this.diffuseTexture.size.height/8),6],shaders:{compute:{code:Za(this.specularTexture)}},uniforms:{params:{struct:{faceSize:{type:"u32",value:this.diffuseTexture.size.width},maxMipLevel:{type:"u32",value:this.specularTexture.texture.mipLevelCount},sampleCount:{type:"u32",value:this.options.diffuseTextureParams.computeSampleCount}}}},samplers:[this.sampler],textures:[this.specularTexture,e]});await t.material.compileMaterial(),this.renderer.onBeforeRenderScene.add(i=>{this.renderer.renderSingleComputePass(i,t),js(this,St,zi).call(this,i,e,this.diffuseTexture)},{once:!0}),this.renderer.onAfterCommandEncoderSubmission.add(()=>{t.destroy(),e.destroy(),e=null,t=null},{once:!0})}async loadAndComputeFromHDR(e){const t=await this.hdrLoader.loadFromUrl(e),{width:i,height:s}=t||{width:1024,height:512},r=Math.max(i/4,s/2),a={viewDimension:"cube",autoDestroy:!1};this.specularTexture?(this.specularTexture.size.width!==r||this.specularTexture.size.height!==r)&&(this.specularTexture.options.fixedSize.width=r,this.specularTexture.options.fixedSize.height=r,this.specularTexture.size.width=r,this.specularTexture.size.height=r,this.specularTexture.createTexture()):this.specularTexture=new Z(this.renderer,{...this.options.specularTextureParams,visibility:["fragment","compute"],fixedSize:{width:r,height:r},...a});const{size:o,computeSampleCount:h,...u}=this.options.diffuseTextureParams,d=Math.min(o,r);this.diffuseTexture?(this.diffuseTexture.size.width!==d||this.diffuseTexture.size.height!==d)&&(this.diffuseTexture.options.fixedSize.width=d,this.diffuseTexture.options.fixedSize.height=d,this.diffuseTexture.size.width=d,this.diffuseTexture.size.height=d,this.diffuseTexture.createTexture()):this.diffuseTexture=new Z(this.renderer,{...u,visibility:["fragment"],fixedSize:{width:d,height:d},...a}),t&&this.computeSpecularCubemapFromHDRData(t).then(()=>{this.computeDiffuseFromSpecular()})}destroy(){this.lutTexture?.destroy(),this.diffuseTexture?.destroy(),this.specularTexture?.destroy()}}St=new WeakSet,zi=l(function(n,e,t){n.copyTextureToTexture({texture:e.texture},{texture:t.texture},[t.texture.width,t.texture.height,t.texture.depthOrArrayLayers])},"copyComputeStorageTextureToTexture_fn");class to extends ut{static{l(this,"BoxGeometry")}constructor({instancesCount:e=1,vertexBuffers:t=[],topology:i,mapBuffersAtCreation:s=!0,widthSegments:r=1,heightSegments:a=1,depthSegments:o=1}={}){super({verticesOrder:"ccw",topology:i,instancesCount:e,vertexBuffers:t,mapBuffersAtCreation:s}),this.type="BoxGeometry",r=Math.floor(r),a=Math.floor(a),o=Math.floor(o);const h=[],u=[],d=[],c=[];let p=0;const f=l((g,y,x,b,C,R,B,P,S,w)=>{const z=R/S,_=B/w,E=R/2,$=B/2,F=P/2,Q=S+1,H=w+1;let se=0;const k=new m;for(let N=0;N<H;N++){const X=N*_-$;for(let te=0;te<Q;te++){const le=te*z-E;k[g]=le*b,k[y]=X*C,k[x]=F,h.push(k.x,k.y,k.z),k[g]=0,k[y]=0,k[x]=P>0?1:-1,d.push(k.x,k.y,k.z),u.push(te/S),u.push(N/w),se+=1}}for(let N=0;N<w;N++)for(let X=0;X<S;X++){const te=p+X+Q*N,le=p+X+Q*(N+1),De=p+(X+1)+Q*(N+1),A=p+(X+1)+Q*N;c.push(te,le,A),c.push(le,De,A),p+=se}},"buildPlane");f("z","y","x",-1,-1,2,2,2,o,a),f("z","y","x",1,-1,2,2,-2,o,a),f("x","z","y",1,1,2,2,2,r,o),f("x","z","y",1,-1,2,2,-2,r,o),f("x","y","z",1,-1,2,2,2,r,a),f("x","y","z",-1,-1,2,2,-2,r,a),this.setAttribute({name:"position",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(h)}),this.setAttribute({name:"uv",type:"vec2f",bufferFormat:"float32x2",size:2,array:new Float32Array(u)}),this.setAttribute({name:"normal",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(d)}),this.setIndexBuffer({array:this.useUint16IndexArray?new Uint16Array(c):new Uint32Array(c),bufferFormat:this.useUint16IndexArray?"uint16":"uint32"})}}class io extends ut{static{l(this,"SphereGeometry")}constructor({topology:e,instancesCount:t=1,vertexBuffers:i=[],mapBuffersAtCreation:s=!0,widthSegments:r=32,heightSegments:a=16,phiStart:o=0,phiLength:h=Math.PI*2,thetaStart:u=0,thetaLength:d=Math.PI}={}){super({verticesOrder:"ccw",topology:e,instancesCount:t,vertexBuffers:i,mapBuffersAtCreation:s}),this.type="SphereGeometry",r=Math.max(3,Math.floor(r)),a=Math.max(2,Math.floor(a));const c=1,p=Math.min(u+d,Math.PI);let f=0;const g=[],y=new m,x=new m,b=[],C=[],R=[],B=[];for(let P=0;P<=a;P++){const S=[],w=P/a;let z=0;P===0&&u===0?z=.5/r:P===a&&p===Math.PI&&(z=-.5/r);for(let _=0;_<=r;_++){const E=_/r;y.x=-c*Math.cos(o+E*h)*Math.sin(u+w*d),y.y=c*Math.cos(u+w*d),y.z=c*Math.sin(o+E*h)*Math.sin(u+w*d),C.push(y.x,y.y,y.z),x.copy(y).normalize(),R.push(x.x,x.y,x.z),B.push(E+z,w),S.push(f++)}g.push(S)}for(let P=0;P<a;P++)for(let S=0;S<r;S++){const w=g[P][S+1],z=g[P][S],_=g[P+1][S],E=g[P+1][S+1];(P!==0||u>0)&&b.push(w,z,E),(P!==a-1||p<Math.PI)&&b.push(z,_,E)}this.setAttribute({name:"position",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(C)}),this.setAttribute({name:"uv",type:"vec2f",bufferFormat:"float32x2",size:2,array:new Float32Array(B)}),this.setAttribute({name:"normal",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(R)}),this.setIndexBuffer({array:this.useUint16IndexArray?new Uint16Array(b):new Uint32Array(b),bufferFormat:this.useUint16IndexArray?"uint16":"uint32"})}}class so extends ts{static{l(this,"PingPongPlane")}constructor(e,t={}){e=I(e,t.label?t.label+" PingPongPlane":"PingPongPlane");const i=t.targets&&t.targets.length&&t.targets.map(s=>({targetFormat:s.format}));t.outputTarget=new ji(e,{label:t.label?t.label+" render target":"Ping Pong render target",useDepth:!1,...i&&{colorAttachments:i}}),t.transparent=!1,t.depth=!1,t.label=t.label??"PingPongPlane "+e.pingPongPlanes?.length,super(e,t),this.type="PingPongPlane",this.createTexture({label:t.label?`${t.label} render texture`:"PingPongPlane render texture",name:"renderTexture",...t.targets&&t.targets.length&&{format:t.targets[0].format},usage:["copyDst","textureBinding"]})}get renderTexture(){return this.textures.find(e=>e.options.name==="renderTexture")}addToScene(e=!1){e&&this.renderer.pingPongPlanes.push(this),this.autoRender&&this.renderer.scene.addPingPongPlane(this)}removeFromScene(e=!1){this.outputTarget&&this.outputTarget.destroy(),this.autoRender&&this.renderer.scene.removePingPongPlane(this),e&&(this.renderer.pingPongPlanes=this.renderer.pingPongPlanes.filter(t=>t.uuid!==this.uuid))}}var qs=l((n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},"__accessCheck$1"),T=l((n,e,t)=>(qs(n,e,"read from private field"),t?t.call(n):e.get(n)),"__privateGet$1"),ue=l((n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},"__privateAdd$1"),ce=l((n,e,t,i)=>(qs(n,e,"write to private field"),e.set(n,t),t),"__privateSet$1"),ro=l((n,e,t)=>(qs(n,e,"access private method"),t),"__privateMethod"),ye,Te,it,st,xe,ve,Pt,Tt,Rt,zt,Et,_t,Ys,zn;class no{static{l(this,"Raycaster")}constructor(e){ue(this,Ys),ue(this,ye,void 0),ue(this,Te,void 0),ue(this,it,void 0),ue(this,st,void 0),ue(this,xe,void 0),ue(this,ve,void 0),ue(this,Pt,void 0),ue(this,Tt,void 0),ue(this,Rt,void 0),ue(this,zt,void 0),ue(this,Et,void 0),ue(this,_t,void 0),this.type="Raycaster",e=Oe(e,this.type),this.renderer=e,this.camera=this.renderer.camera,this.pointer=new G(1/0),this.ray={origin:new m,direction:new m},ce(this,ye,{origin:this.ray.origin.clone(),direction:this.ray.direction.clone()}),ce(this,Te,new m),ce(this,it,new m),ce(this,st,new m),ce(this,xe,new m),ce(this,ve,new m),ce(this,Pt,new G),ce(this,Tt,new G),ce(this,Rt,new G),ce(this,zt,new m),ce(this,Et,new m),ce(this,_t,new m)}setFromMouse(e){const{clientX:t,clientY:i}=e.targetTouches&&e.targetTouches.length?e.targetTouches[0]:e;this.setFromNDCCoords((t-this.renderer.boundingRect.left)/this.renderer.boundingRect.width*2-1,-((i-this.renderer.boundingRect.top)/this.renderer.boundingRect.height)*2+1)}setFromNDCCoords(e=0,t=0){this.pointer.set(e,t),this.setRay()}setRay(){this.camera.worldMatrix.getTranslation(this.ray.origin),this.ray.direction.set(this.pointer.x,this.pointer.y,-1).unproject(this.camera).sub(this.ray.origin).normalize()}rayIntersectsTriangle(e){const i=new m,s=new m;i.crossVectors(T(this,ye).direction,T(this,ve));const r=T(this,xe).dot(i);if(Math.abs(r)<1e-6)return!1;const a=1/r,o=T(this,ye).origin.clone().sub(T(this,Te)),h=a*o.dot(i);if(h<0||h>1)return!1;s.crossVectors(o,T(this,xe));const u=a*T(this,ye).direction.dot(s);if(u<0||h+u>1)return!1;const d=a*T(this,ve).dot(s);return d>1e-6?(e.copy(T(this,ye).origin).add(T(this,ye).direction.clone().multiplyScalar(d)),!0):!1}getBarycentricCoordinates(e){const t=e.clone().sub(T(this,Te)),i=T(this,xe).dot(T(this,xe)),s=T(this,xe).dot(T(this,ve)),r=T(this,ve).dot(T(this,ve)),a=t.dot(T(this,xe)),o=t.dot(T(this,ve)),h=i*r-s*s,u=new m(0,(r*a-s*o)/h,(i*o-s*a)/h);return u.x=1-u.y-u.z,u}getTriangleNormal(){return new m().crossVectors(T(this,xe),T(this,ve)).normalize()}setAttributeVectorAtIndex(e,t,i,s,r){const a=i?i[e*3+t]:e*3+t;r.x=s.array[a*s.size],r.y=s.array[a*s.size+1],"z"in r&&(r.z=s.array[a*s.size+2])}intersectObject(e,t=!0,i=[]){if(!(e instanceof we))return this.renderer.production||L(`${this.type}: object to test intersection again is not of type Object3D`),i;const s=Ln(e);return s&&ro(this,Ys,zn).call(this,s,i),t&&e.children.forEach(r=>{this.intersectObject(r,t,i)}),i.length&&i.sort((r,a)=>this.ray.origin.distance(r.point)-this.ray.origin.distance(a.point)),i}intersectObjects(e,t=!0,i=[]){return e.forEach(s=>{this.intersectObject(s,t,i)}),i.length&&i.sort((s,r)=>this.ray.origin.distance(s.point)-this.ray.origin.distance(r.point)),i}}ye=new WeakMap,Te=new WeakMap,it=new WeakMap,st=new WeakMap,xe=new WeakMap,ve=new WeakMap,Pt=new WeakMap,Tt=new WeakMap,Rt=new WeakMap,zt=new WeakMap,Et=new WeakMap,_t=new WeakMap,Ys=new WeakSet,zn=l(function(n,e=[]){if(!n.geometry)return e;const t=n.geometry.getAttributeByName("position");if(!t)return this.renderer.production||L(`Raycaster: can't raycast on a mesh that has no position attribute: ${n.options.label}`),e;if(!t.array)return this.renderer.production||L(`Raycaster: can't raycast on a mesh that has no position attribute array: ${n.options.label}`),e;if(n.frustumCulling&&n.domFrustum){const{clipSpaceBoundingRect:h}=n.domFrustum;if(n.domFrustum.isIntersecting){if(this.pointer.x>h.left+h.width||this.pointer.x<h.left||this.pointer.y>h.top||this.pointer.y<h.top-h.height)return e}else return e}const i=n.worldMatrix.getInverse();T(this,ye).origin.copy(this.ray.origin).applyMat4(i),T(this,ye).direction.copy(this.ray.direction).transformDirection(i);const s=n.geometry.getAttributeByName("uv"),r=n.geometry.getAttributeByName("normal"),a=n.geometry.indexBuffer?.array,o=a?a.length/3:t.array.length/9;for(let h=0;h<o;h++){if(this.setAttributeVectorAtIndex(h,0,a,t,T(this,Te)),this.setAttributeVectorAtIndex(h,1,a,t,T(this,it)),this.setAttributeVectorAtIndex(h,2,a,t,T(this,st)),T(this,xe).copy(T(this,it)).sub(T(this,Te)),T(this,ve).copy(T(this,st)).sub(T(this,Te)),n.material.options.rendering.cullMode!=="none"){const p=this.getTriangleNormal().dot(T(this,ye).direction);if(p>0&&n.material.options.rendering.cullMode==="back")continue;if(p<0&&n.material.options.rendering.cullMode==="front")continue}const u=new m;if(this.rayIntersectsTriangle(u)){const c=this.getBarycentricCoordinates(u),p=u.clone().applyMat4(n.worldMatrix),f=this.ray.origin.distance(p),g={object:n,distance:f,localPoint:u,point:p,triangle:[T(this,Te).clone(),T(this,it).clone(),T(this,st).clone()],triangleIndex:h};s&&s.array&&s.array.length&&(this.setAttributeVectorAtIndex(h,0,a,s,T(this,Pt)),this.setAttributeVectorAtIndex(h,1,a,s,T(this,Tt)),this.setAttributeVectorAtIndex(h,2,a,s,T(this,Rt)),g.uv=T(this,Pt).clone().multiplyScalar(c.x).add(T(this,Tt).clone().multiplyScalar(c.y)).add(T(this,Rt).clone().multiplyScalar(c.z))),r&&r.array&&r.array.length&&(this.setAttributeVectorAtIndex(h,0,a,r,T(this,zt)),this.setAttributeVectorAtIndex(h,1,a,r,T(this,Et)),this.setAttributeVectorAtIndex(h,2,a,r,T(this,_t)),g.normal=T(this,zt).clone().multiplyScalar(c.x).add(T(this,Et).clone().multiplyScalar(c.y)).add(T(this,_t).clone().multiplyScalar(c.z))),e.push(g)}}return e},"intersectMesh_fn");var En=l((n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},"__accessCheck"),Hs=l((n,e,t)=>(En(n,e,"read from private field"),t?t.call(n):e.get(n)),"__privateGet"),ao=l((n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},"__privateAdd"),oo=l((n,e,t,i)=>(En(n,e,"write to private field"),e.set(n,t),t),"__privateSet"),rt;const K=WebGLRenderingContext,Ei=new O,ho=class Re{static{l(this,"_GLTFScenesManager")}constructor({renderer:e,gltf:t}){ao(this,rt,void 0),e=Oe(e,"GLTFScenesManager"),this.renderer=e,this.gltf=t,oo(this,rt,new Map);const i=l(s=>[s.node,...s.children?.map(r=>[...i(r)]).flat()].flat(),"traverseChildren");this.scenesManager={node:new we,boundingBox:new Be,samplers:[],materialsTextures:[],scenes:[],meshes:[],meshesDescriptors:[],getScenesNodes:()=>this.scenesManager.scenes.map(s=>i(s)).flat()},this.createSamplers(),this.createMaterialTextures(),this.createScenes()}static getVertexAttributeParamsFromType(e){switch(e){case"VEC2":return{type:"vec2f",bufferFormat:"float32x2",size:2};case"VEC3":return{type:"vec3f",bufferFormat:"float32x3",size:3};case"VEC4":return{type:"vec4f",bufferFormat:"float32x4",size:4};case"SCALAR":default:return{type:"f32",bufferFormat:"float32",size:1}}}static getTypedArrayConstructorFromComponentType(e){switch(e){case K.BYTE:return Int8Array;case K.UNSIGNED_BYTE:return Uint8Array;case K.SHORT:return Int16Array;case K.UNSIGNED_SHORT:return Uint16Array;case K.UNSIGNED_INT:return Uint32Array;case K.FLOAT:default:return Float32Array}}static gpuPrimitiveTopologyForMode(e){switch(e){case K.TRIANGLES:return"triangle-list";case K.TRIANGLE_STRIP:return"triangle-strip";case K.LINES:return"line-list";case K.LINE_STRIP:return"line-strip";case K.POINTS:return"point-list"}}static gpuAddressModeForWrap(e){switch(e){case K.CLAMP_TO_EDGE:return"clamp-to-edge";case K.MIRRORED_REPEAT:return"mirror-repeat";default:return"repeat"}}createSamplers(){if(this.gltf.samplers)for(const[e,t]of Object.entries(this.gltf.samplers)){const i={label:"glTF sampler "+e,name:"gltfSampler"+e,addressModeU:Re.gpuAddressModeForWrap(t.wrapS),addressModeV:Re.gpuAddressModeForWrap(t.wrapT)};switch((!t.magFilter||t.magFilter===K.LINEAR)&&(i.magFilter="linear"),t.minFilter){case K.NEAREST:break;case K.LINEAR:case K.LINEAR_MIPMAP_NEAREST:i.minFilter="linear";break;case K.NEAREST_MIPMAP_LINEAR:i.mipmapFilter="linear";break;case K.LINEAR_MIPMAP_LINEAR:default:i.minFilter="linear",i.mipmapFilter="linear";break}this.scenesManager.samplers.push(new je(this.renderer,i))}else this.scenesManager.samplers.push(new je(this.renderer,{label:"Default sampler",name:"defaultSampler",magFilter:"linear",minFilter:"linear",mipmapFilter:"linear"}))}createTexture(e,t,i){const s=(()=>{switch(i){case"baseColorTexture":case"emissiveTexture":return"bgra8unorm-srgb";case"occlusionTexture":return"r8unorm";default:return"bgra8unorm"}})(),r=new Z(this.renderer,{label:e.name?e.name+": "+i:i,name:i,format:s,visibility:["fragment"],generateMips:!0,fixedSize:{width:t.width,height:t.height}});return r.uploadSource({source:t}),r}createMaterialTextures(){if(this.scenesManager.materialsTextures=[],this.gltf.materials)for(const[e,t]of Object.entries(this.gltf.materials)){const i={material:e,texturesDescriptors:[]},s=l(r=>r.texCoord&&r.texCoord!==0?"uv"+r.texCoord:"uv","getUVAttributeName");if(this.scenesManager.materialsTextures[e]=i,t.pbrMetallicRoughness){if(t.pbrMetallicRoughness.baseColorTexture&&t.pbrMetallicRoughness.baseColorTexture.index!==void 0){const r=t.pbrMetallicRoughness.baseColorTexture.index,a=this.gltf.imagesBitmaps[this.gltf.textures[r].source],o=this.createTexture(t,a,"baseColorTexture"),h=this.gltf.textures.find(u=>u.source===r)?.sampler;i.texturesDescriptors.push({texture:o,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.pbrMetallicRoughness.baseColorTexture)})}if(t.pbrMetallicRoughness.metallicRoughnessTexture&&t.pbrMetallicRoughness.metallicRoughnessTexture.index!==void 0){const r=t.pbrMetallicRoughness.metallicRoughnessTexture.index,a=this.gltf.imagesBitmaps[this.gltf.textures[r].source],o=this.createTexture(t,a,"metallicRoughnessTexture"),h=this.gltf.textures.find(u=>u.source===r)?.sampler;i.texturesDescriptors.push({texture:o,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.pbrMetallicRoughness.metallicRoughnessTexture)})}}if(t.normalTexture&&t.normalTexture.index!==void 0){const r=t.normalTexture.index,a=this.gltf.imagesBitmaps[this.gltf.textures[r].source],o=this.createTexture(t,a,"normalTexture"),h=this.gltf.textures.find(u=>u.source===r)?.sampler;i.texturesDescriptors.push({texture:o,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.normalTexture)})}if(t.occlusionTexture&&t.occlusionTexture.index!==void 0){const r=t.occlusionTexture.index,a=this.gltf.imagesBitmaps[this.gltf.textures[r].source],o=this.createTexture(t,a,"occlusionTexture"),h=this.gltf.textures.find(u=>u.source===r)?.sampler;i.texturesDescriptors.push({texture:o,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.occlusionTexture)})}if(t.emissiveTexture&&t.emissiveTexture.index!==void 0){const r=t.emissiveTexture.index,a=this.gltf.imagesBitmaps[this.gltf.textures[r].source],o=this.createTexture(t,a,"emissiveTexture"),h=this.gltf.textures.find(u=>u.source===r)?.sampler;i.texturesDescriptors.push({texture:o,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.emissiveTexture)})}}}createNode(e,t){if(t.camera!==void 0)return;const i={name:t.name,node:new we,children:[]};e.children.push(i),i.node.parent=e.node,t.matrix?(i.node.modelMatrix.setFromArray(new Float32Array(t.matrix)),i.node.matrices.model.shouldUpdate=!1):(t.translation&&i.node.position.set(t.translation[0],t.translation[1],t.translation[2]),t.scale&&i.node.scale.set(t.scale[0],t.scale[1],t.scale[2]),t.rotation&&i.node.quaternion.setFromArray(new Float32Array(t.rotation)));const s=this.gltf.meshes[t.mesh];t.children&&t.children.forEach(r=>{const a=this.gltf.nodes[r];this.createNode(i,a)}),s&&s.primitives.forEach((r,a)=>{const o={parent:i.node,attributes:[],textures:[],parameters:{label:s.name?s.name+" "+a:"glTF mesh "+a},nodes:[]};let h=Hs(this,rt).get(r);h||(h={instances:[],nodes:[],meshDescriptor:o},Hs(this,rt).set(r,h)),h.instances.push(t),h.nodes.push(i.node)})}createScenes(){this.scenesManager.node.parent=this.renderer.scene,this.gltf.scenes.forEach(e=>{const t={name:e.name,children:[],node:new we};t.node.parent=this.scenesManager.node,this.scenesManager.scenes.push(t),e.nodes.forEach(i=>{const s=this.gltf.nodes[i];this.createNode(t,s)})}),this.scenesManager.node.updateMatrixStack();for(const[e,t]of Hs(this,rt)){const{instances:i,nodes:s,meshDescriptor:r}=t,a=i.length;r.nodes=s,this.scenesManager.meshesDescriptors.push(r);const o=new Be,h=[];let u=null,d=null,c=0;for(const[C,R]of Object.entries(e.attributes)){const B=this.gltf.accessors[R],P=Re.getTypedArrayConstructorFromComponentType(B.componentType),S=this.gltf.bufferViews[B.bufferView],w=C==="TEXCOORD_0"?"uv":C.replace("_","").replace("TEXCOORD","uv").toLowerCase(),z=S.byteStride||0,_=B.byteOffset||0;z&&_&&_<z?c=Math.max(_,c):c=0,w==="position"&&(o.min.min(new m(B.min[0],B.min[1],B.min[2])),o.max.max(new m(B.max[0],B.max[1],B.max[2])),d=S);const E=Re.getVertexAttributeParamsFromType(B.type),$={name:w,...E,array:new P(this.gltf.arrayBuffers[S.buffer],B.byteOffset+S.byteOffset,B.count*E.size)};h.push($),r.attributes.push({name:$.name,type:$.type})}if(c>0){const C=Object.values(e.attributes).map(R=>this.gltf.accessors[R].bufferView);if(C.every(R=>R===C[0]))u=new Float32Array(this.gltf.arrayBuffers[d.buffer],d.byteOffset,Math.ceil(d.byteLength/4)*4/Float32Array.BYTES_PER_ELEMENT);else{let R=0;const B={},P=Object.values(e.attributes).reduce((S,w)=>{const z=this.gltf.accessors[w],_=Re.getVertexAttributeParamsFromType(z.type).size;return B[z.bufferView]||(B[z.bufferView]=0),B[z.bufferView]=Math.max(B[z.bufferView],z.byteOffset+_*Float32Array.BYTES_PER_ELEMENT),R+=_*Float32Array.BYTES_PER_ELEMENT,S+z.count*_},0);u=new Float32Array(Math.ceil(P/4)*4),Object.values(e.attributes).forEach(S=>{const w=this.gltf.accessors[S],z=this.gltf.bufferViews[w.bufferView],_=Re.getVertexAttributeParamsFromType(w.type).size;for(let E=0;E<w.count;E++){const $=w.byteOffset/Float32Array.BYTES_PER_ELEMENT+E*R/Float32Array.BYTES_PER_ELEMENT;u.subarray($,$+_).set(new Float32Array(this.gltf.arrayBuffers[z.buffer],z.byteOffset+w.byteOffset+E*B[w.bufferView],_))}})}}else{const C=["position","uv","normal"];h.sort((R,B)=>{let P=C.findIndex(w=>w===R.name);P=P===-1?1/0:P;let S=C.findIndex(w=>w===B.name);return S=S===-1?1/0:S,P-S})}const p={instancesCount:a,topology:Re.gpuPrimitiveTopologyForMode(e.mode),vertexBuffers:[{name:"attributes",stepMode:"vertex",attributes:h,...u&&{array:u}}]},f="indices"in e,g=f?ut:Vi;if(r.parameters.geometry=new g(p),r.parameters.geometry.boundingBox=o,f){const C=this.gltf.accessors[e.indices],R=this.gltf.bufferViews[C.bufferView],B=Re.getTypedArrayConstructorFromComponentType(C.componentType),P=C.byteOffset+R.byteOffset,S=this.gltf.arrayBuffers[R.buffer],w=Math.min((S.byteLength-P)/B.BYTES_PER_ELEMENT,Math.ceil(C.count/4)*4),z=B.name==="Uint8Array"?Uint16Array.from(new B(S,P,w)):new B(S,P,w);r.parameters.geometry.setIndexBuffer({bufferFormat:B.name==="Uint32Array"?"uint32":"uint16",array:z})}const y=this.scenesManager.materialsTextures[e.material];r.parameters.samplers=[],r.parameters.textures=[],y?.texturesDescriptors.forEach(C=>{r.textures.push({texture:C.texture.options.name,sampler:C.sampler.name,texCoordAttributeName:C.texCoordAttributeName}),r.parameters.samplers.find(B=>B.uuid===C.sampler.uuid)||r.parameters.samplers.push(C.sampler),r.parameters.textures.push(C.texture)});const x=this.gltf.materials&&this.gltf.materials[e.material]||{};r.parameters.cullMode=x.doubleSided?"none":"back",(x.alphaMode==="BLEND"||x.extensions&&x.extensions.KHR_materials_transmission)&&(r.parameters.transparent=!0,r.parameters.targets=[{blend:{color:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha"},alpha:{srcFactor:"one",dstFactor:"one"}}}]);const b={baseColorFactor:{type:"vec4f",value:x.pbrMetallicRoughness?.baseColorFactor||[1,1,1,1]},alphaCutoff:{type:"f32",value:x.alphaCutoff!==void 0?x.alphaCutoff:x.alphaMode==="MASK"?.5:0},metallicFactor:{type:"f32",value:x.pbrMetallicRoughness?.metallicFactor===void 0?1:x.pbrMetallicRoughness.metallicFactor},roughnessFactor:{type:"f32",value:x.pbrMetallicRoughness?.roughnessFactor===void 0?1:x.pbrMetallicRoughness.roughnessFactor},normalMapScale:{type:"f32",value:x.normalTexture?.scale===void 0?1:x.normalTexture.scale},occlusionStrength:{type:"f32",value:x.occlusionTexture?.strength===void 0?1:x.occlusionTexture.strength},emissiveFactor:{type:"vec3f",value:x.emissiveFactor!==void 0?x.emissiveFactor:[1,1,1]}};if(Object.keys(b).length&&(r.parameters.uniforms={material:{visibility:["vertex","fragment"],struct:b}}),a>1){const C=new Float32Array(a*16),R=new Float32Array(a*16);for(let B=0;B<a;++B)C.set(s[B].worldMatrix.elements,B*16),Ei.copy(s[B].worldMatrix).invert().transpose(),R.set(Ei.elements,B*16);r.parameters.storages={instances:{visibility:["vertex","fragment"],struct:{modelMatrix:{type:"array<mat4x4f>",value:C},normalMatrix:{type:"array<mat4x4f>",value:R}}}}}for(let C=0;C<s.length;C++){const B=o.clone().applyMat4(r.nodes[C].worldMatrix);this.scenesManager.boundingBox.min.min(B.min),this.scenesManager.boundingBox.max.max(B.max)}}}addMeshes(e=t=>{}){return this.scenesManager.node.updateMatrixStack(),this.scenesManager.meshesDescriptors.map(t=>{if(t.parameters.geometry){e(t);const i=t.parameters.geometry.instancesCount>1&&t.parameters.castShadows;i&&(t.parameters.castShadows=!1);const s=new jr(this.renderer,{...t.parameters});if(t.nodes.length>1){const r=s.updateWorldMatrix.bind(s);s.updateWorldMatrix=()=>{r(),t.nodes.forEach((a,o)=>{s.storages.instances.modelMatrix.value.set(a.worldMatrix.elements,o*16),Ei.copy(a.worldMatrix).invert().transpose(),s.storages.instances.normalMatrix.value.set(Ei.elements,o*16)}),s.storages.instances.modelMatrix.shouldUpdate=!0,s.storages.instances.normalMatrix.shouldUpdate=!0}}if(i){const r=s.material.inputsBindings.get("instances");this.renderer.shadowCastingLights.forEach(a=>{a.shadow.isActive&&a.shadow.addShadowCastingMesh(s,{bindings:[r]})})}return s.parent=t.parent,this.scenesManager.meshes.push(s),s}})}destroy(){this.scenesManager.meshes.forEach(t=>t.remove()),this.scenesManager.meshes=[],this.scenesManager.getScenesNodes().forEach(t=>{t.destroy()}),this.scenesManager.node.destroy()}};rt=new WeakMap;let uo=ho;const lo=l((n,e={})=>{const t=n.textures.find(A=>A.texture==="baseColorTexture"),i=n.textures.find(A=>A.texture==="normalTexture"),s=n.textures.find(A=>A.texture==="emissiveTexture"),r=n.textures.find(A=>A.texture==="occlusionTexture"),a=n.textures.find(A=>A.texture==="metallicRoughnessTexture"),o=n.attributes.filter(A=>A.name!=="position"),h=o.map((A,xo)=>`@location(${xo}) ${A.name}: ${A.type},`).join(`
	`);let u=`
  ...
  `,d=o.find(A=>A.name==="normal")?"vsOutput.normal = getWorldNormal(attributes.normal);":"";n.parameters.storages&&n.parameters.storages.instances&&(u=`
      ...
      vsOutput.viewDirection = camera.position - vsOutput.worldPosition;
      `,d="vsOutput.normal = normalize((instances[attributes.instanceIndex].normalMatrix * vec4(attributes.normal, 0.0)).xyz);");const c=o.filter(A=>A.name!=="normal").map(A=>`vsOutput.${A.name} = attributes.${A.name};`).join(`
	`);let p=`
      @builtin(position) position: vec4f,
      @location(${o.length}) viewDirection: vec3f,
      @location(${o.length+1}) worldPosition: vec3f,
      ${h}
  `,f="";const g=o.find(A=>A.name==="tangent"),y=!!(i&&g);y&&(p+=`
  ...
  `,R="var color: vec4f = vec4();",B=`
      return color;
  `,P=n.attributes.find(A=>A.name==="color0");let S=P?P.type==="vec3f"?"var baseColor: vec4f = vec4(fsInput.color0, 1.0) * material.baseColorFactor;":"var baseColor: vec4f = fsInput.color0 * material.baseColorFactor;":"var baseColor: vec4f = material.baseColorFactor;";t&&(S=`
  ...
  `;return{vertex:{code:C,entryPoint:"main"},fragment:{code:De,entryPoint:"main"}}},"buildShaders"),_n=WebGLRenderingContext,co=1179937895,Xs={JSON:1313821514,BIN:5130562},fo=[0,0,0],po=[0,0,0,1],mo=[1,1,1],go=typeof window<"u"&&new RegExp(`^${window.location.protocol}`,"i")||RegExp("^(http|https):","i"),yo=/^data:/;class _i{static{l(this,"GLTFLoader")}constructor(){this.gltf=null}static resolveUri(e,t){return e.match(go)||e.match(yo)?e:t+e}async loadFromUrl(e){const t=e.lastIndexOf("/"),i=t!==0?e.substring(0,t+1):"",s=await fetch(e);if(e.endsWith(".gltf"))return this.loadFromJson(await s.json(),i);if(e.endsWith(".glb"))return this.loadFromBinary(await s.arrayBuffer(),i);throw new Error("Unrecognized file extension")}async loadFromJsonBase(e,t,i=null){if(!t)throw new Error("baseUrl must be specified.");if(!e.asset)throw new Error("Missing asset description.");if(e.asset.minVersion!=="2.0"&&e.asset.version!=="2.0")throw new Error("Incompatible asset version.");for(const a of e.accessors)a.byteOffset=a.byteOffset??0,a.normalized=a.normalized??!1;for(const a of e.bufferViews)a.byteOffset=a.byteOffset??0;for(const a of e.nodes)a.matrix||(a.rotation=a.rotation??po,a.scale=a.scale??mo,a.translation=a.translation??fo);if(e.samplers)for(const a of e.samplers)a.wrapS=a.wrapS??_n.REPEAT,a.wrapT=a.wrapT??_n.REPEAT;const s=[];if(i)s.push(Promise.resolve(i));else for(const a in e.buffers){const o=e.buffers[a],h=_i.resolveUri(o.uri,t);s[a]=fetch(h).then(u=>u.arrayBuffer())}const r=[];for(let a=0;a<e.images?.length;++a){const o=e.images[a];if(o.uri)r[a]=fetch(_i.resolveUri(o.uri,t)).then(async h=>createImageBitmap(await h.blob()));else{const h=e.bufferViews[o.bufferView];r[a]=s[h.buffer].then(u=>{const d=new Blob([new Uint8Array(u,h.byteOffset,h.byteLength)],{type:o.mimeType});return createImageBitmap(d)})}}return{...e,arrayBuffers:await Promise.all(s),imagesBitmaps:await Promise.all(r)}}async loadFromBinary(e,t){const i=new DataView(e,0,12),s=i.getUint32(0,!0),r=i.getUint32(4,!0),a=i.getUint32(8,!0);if(s!==co)throw new Error("Invalid magic string in binary header.");if(r!==2)throw new Error("Incompatible version in binary header.");const o={};let h=12;for(;h<a;){const c=new DataView(e,h,8),p=c.getUint32(0,!0),f=c.getUint32(4,!0);o[f]=e.slice(h+8,h+8+p),h+=p+8}if(!o[Xs.JSON])throw new Error("File contained no json chunk.");const d=new TextDecoder("utf-8").decode(o[Xs.JSON]);return this.loadFromJson(JSON.parse(d),t,o[Xs.BIN])}async loadFromJson(e,t,i=null){return this.gltf=await this.loadFromJsonBase(e,t,i),this.gltf}}v.AmbientLight=sa,v.BindGroup=Ft,v.Binding=At,v.Box3=Be,v.BoxGeometry=to,v.Buffer=Fe,v.BufferBinding=me,v.Camera=nr,v.ComputeMaterial=hr,v.ComputePass=Xt,v.ComputePipelineEntry=ss,v.DOMElement=ns,v.DOMFrustum=cr,v.DOMMesh=gn,v.DOMObject3D=pn,v.DOMTexture=ke,v.DirectionalLight=ca,v.EnvironmentMap=eo,v.FullscreenPlane=ts,v.GLTFLoader=_i,v.GLTFScenesManager=uo,v.GPUCameraRenderer=ls,v.GPUCurtains=qa,v.GPUCurtainsRenderer=mi,v.GPUDeviceManager=Zr,v.GPURenderer=hs,v.Geometry=Vi,v.HDRLoader=Rn,v.IndexedGeometry=ut,v.IndirectBuffer=Qr,v.Mat3=Ce,v.Mat4=O,v.Material=Ii,v.Mesh=jr,v.Object3D=we,v.OrbitControls=Ya,v.PingPongPlane=so,v.PipelineEntry=qi,v.PipelineManager=qr,v.Plane=yn,v.PlaneGeometry=Ni,v.PointLight=ya,v.ProjectedObject3D=is,v.Quat=fe,v.Raycaster=no,v.RenderBundle=Da,v.RenderMaterial=Ki,v.RenderPass=Jt,v.RenderPipelineEntry=Ye,v.RenderTarget=ji,v.Sampler=je,v.SamplerBinding=sr,v.Scene=Yr,v.ShaderPass=Fa,v.SphereGeometry=io,v.Texture=Z,v.TextureBindGroup=ki,v.TextureBinding=Ui,v.Vec2=G,v.Vec3=m,v.WritableBufferBinding=$i,v.applyDirectionalShadows=ct,v.applyPointShadows=ft,v.buildShaders=lo,v.getDefaultPointShadowDepthFs=Sr,v.getDefaultPointShadowDepthVs=Cr,v.getDefaultShadowDepthVs=wr,v.getIBL=cn,v.getIBLIndirect=dn,v.getLambert=on,v.getLambertDirect=an,v.getPBR=ln,v.getPBRDirect=bs,v.getPCFDirectionalShadows=Mr,v.getPCFPointShadowContribution=Pr,v.getPCFPointShadows=Tr,v.getPCFShadowContribution=Br,v.getPCFShadows=dt,v.getPhong=un,v.getPhongDirect=hn,v.lambertUtils=fi,v.pbrUtils=vs,v.toneMappingUtils=wt});
