(function(w,L){typeof exports=="object"&&typeof module<"u"?L(exports):typeof define=="function"&&define.amd?define(["exports"],L):(w=typeof globalThis<"u"?globalThis:w||self,L(w.window=w.window||{}))})(this,function(w){"use strict";const L=()=>"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,a=>{const e=Math.random()*16|0;return(a==="x"?e:e&3|8).toString(16).toUpperCase()}),ye=a=>a.replace(/(?:^\w|[A-Z]|\b\w)/g,(e,t)=>t===0?e.toLowerCase():e.toUpperCase()).replace(/\s+/g,""),Ke=a=>{const e=ye(a);return e.charAt(0).toUpperCase()+e.slice(1)};let He=0;const D=a=>{He>100||(console.warn(He===100?"GPUCurtains: too many warnings thrown, stop logging.":a),He++)},N=a=>{throw new Error(a)},Ze=(a,e="GPURenderer",t)=>{const s=t?`Unable to create ${t} because the ${e} is not defined: ${a}`:`The ${e} is not defined: ${a}`;N(s)},F=(a,e)=>{const t=a&&(a.type==="GPURenderer"||a.type==="GPUCameraRenderer"||a.type==="GPUCurtainsRenderer");return t||Ze(a,"GPURenderer",e),t},Be=(a,e)=>{const t=a&&(a.type==="GPUCameraRenderer"||a.type==="GPUCurtainsRenderer");return t||Ze(a,"GPUCameraRenderer",e),t},Qe=(a,e)=>{const t=a&&a.type==="GPUCurtainsRenderer";return t||Ze(a,"GPUCurtainsRenderer",e),t},Tt=(()=>{let a,e;const t={};return function(i,r){e||(e=i.createShaderModule({label:"textured quad shaders for mip level generation",code:`
            struct VSOutput {
          ...
          `}),a=i.createSampler({minFilter:"linear"})),t[r.format]||(t[r.format]=i.createRenderPipeline({label:"mip level generator pipeline",layout:"auto",vertex:{module:e,entryPoint:"vs"},fragment:{module:e,entryPoint:"fs",targets:[{format:r.format}]}}));const n=t[r.format],o=i.createCommandEncoder({label:"mip gen encoder"});let h=r.width,u=r.height,l=0;for(;h>1||u>1;){h=Math.max(1,h/2|0),u=Math.max(1,u/2|0);const c=i.createBindGroup({layout:n.getBindGroupLayout(0),entries:[{binding:0,resource:a},{binding:1,resource:r.createView({baseMipLevel:l,mipLevelCount:1})}]});++l;const p={label:"our basic canvas renderPass",colorAttachments:[{view:r.createView({baseMipLevel:l,mipLevelCount:1}),loadOp:"clear",storeOp:"store"}]},g=o.beginRenderPass(p);g.setPipeline(n),g.setBindGroup(0,c),g.draw(6),g.end()}const d=o.finish();i.queue.submit([d])}})(),gs=new Map([["vertex",GPUShaderStage.VERTEX],["fragment",GPUShaderStage.FRAGMENT],["compute",GPUShaderStage.COMPUTE]]),ys=(a=[])=>a.reduce((e,t)=>e|gs.get(t),0),xs={i32:{numElements:1,align:4,size:4,type:"i32",View:Int32Array},u32:{numElements:1,align:4,size:4,type:"u32",View:Uint32Array},f32:{numElements:1,align:4,size:4,type:"f32",View:Float32Array},f16:{numElements:1,align:2,size:2,type:"u16",View:Uint16Array},vec2f:{numElements:2,align:8,size:8,type:"f32",View:Float32Array},vec2i:{numElements:2,align:8,size:8,type:"i32",View:Int32Array},vec2u:{numElements:2,align:8,size:8,type:"u32",View:Uint32Array},vec2h:{numElements:2,align:4,size:4,type:"u16",View:Uint16Array},vec3i:{numElements:3,align:16,size:12,type:"i32",View:Int32Array},vec3u:{numElements:3,align:16,size:12,type:"u32",View:Uint32Array},vec3f:{numElements:3,align:16,size:12,type:"f32",View:Float32Array},vec3h:{numElements:3,align:8,size:6,type:"u16",View:Uint16Array},vec4i:{numElements:4,align:16,size:16,type:"i32",View:Int32Array},vec4u:{numElements:4,align:16,size:16,type:"u32",View:Uint32Array},vec4f:{numElements:4,align:16,size:16,type:"f32",View:Float32Array},vec4h:{numElements:4,align:8,size:8,type:"u16",View:Uint16Array},mat2x2f:{numElements:4,align:8,size:16,type:"f32",View:Float32Array},mat2x2h:{numElements:4,align:4,size:8,type:"u16",View:Uint16Array},mat3x2f:{numElements:6,align:8,size:24,type:"f32",View:Float32Array},mat3x2h:{numElements:6,align:4,size:12,type:"u16",View:Uint16Array},mat4x2f:{numElements:8,align:8,size:32,type:"f32",View:Float32Array},mat4x2h:{numElements:8,align:4,size:16,type:"u16",View:Uint16Array},mat2x3f:{numElements:8,align:16,size:32,pad:[3,1],type:"f32",View:Float32Array},mat2x3h:{numElements:8,align:8,size:16,pad:[3,1],type:"u16",View:Uint16Array},mat3x3f:{numElements:12,align:16,size:48,pad:[3,1],type:"f32",View:Float32Array},mat3x3h:{numElements:12,align:8,size:24,pad:[3,1],type:"u16",View:Uint16Array},mat4x3f:{numElements:16,align:16,size:64,pad:[3,1],type:"f32",View:Float32Array},mat4x3h:{numElements:16,align:8,size:32,pad:[3,1],type:"u16",View:Uint16Array},mat2x4f:{numElements:8,align:16,size:32,type:"f32",View:Float32Array},mat2x4h:{numElements:8,align:8,size:16,type:"u16",View:Uint16Array},mat3x4f:{numElements:12,align:16,size:48,pad:[3,1],type:"f32",View:Float32Array},mat3x4h:{numElements:12,align:8,size:24,pad:[3,1],type:"u16",View:Uint16Array},mat4x4f:{numElements:16,align:16,size:64,type:"f32",View:Float32Array},mat4x4h:{numElements:16,align:8,size:32,type:"u16",View:Uint16Array}},Pt=a=>xs[a],Te=a=>(()=>{switch(a.bindingType){case"storage":return`var<${a.bindingType}, ${a.options.access}>`;case"uniform":default:return"var<uniform>"}})(),bs=a=>a.bindingType==="externalTexture"?`var ${a.name}: texture_external;`:a.bindingType==="storage"?`var ${a.name}: texture_storage_${a.options.viewDimension}<${a.options.format}, ${a.options.access}>;`:a.bindingType==="depth"?`var ${a.name}: texture_depth${a.options.multisampled?"_multisampled":""}_${a.options.viewDimension};`:`var ${a.name}: texture${a.options.multisampled?"_multisampled":""}_${a.options.viewDimension}<f32>;`,Ct=a=>a.bindingType==="storage"&&a.options.access==="read_write"?"storage":a.bindingType==="storage"?"read-only-storage":"uniform",vs=a=>(()=>{switch(a.bindingType){case"externalTexture":return{externalTexture:{}};case"storage":return{storageTexture:{format:a.options.format,viewDimension:a.options.viewDimension}};case"texture":return{texture:{multisampled:a.options.multisampled,viewDimension:a.options.viewDimension,sampleType:a.options.multisampled?"unfilterable-float":"float"}};case"depth":return{texture:{multisampled:a.options.multisampled,viewDimension:a.options.viewDimension,sampleType:"depth"}};default:return null}})(),ws=a=>(()=>{switch(a.bindingType){case"externalTexture":return`externalTexture,${a.visibility},`;case"storage":return`storageTexture,${a.options.format},${a.options.viewDimension},${a.visibility},`;case"texture":return`texture,${a.options.multisampled},${a.options.viewDimension},${a.options.multisampled?"unfilterable-float":"float"},${a.visibility},`;case"depth":return`depthTexture,${a.options.format},${a.options.viewDimension},${a.visibility},`;default:return`${a.visibility},`}})();class Pe{constructor({label:e="Uniform",name:t="uniform",bindingType:s="uniform",visibility:i=["vertex","fragment","compute"]}){this.label=e,this.name=ye(t),this.bindingType=s,this.visibility=ys(i),this.options={label:e,name:t,bindingType:s,visibility:i},this.shouldResetBindGroup=!1,this.shouldResetBindGroupLayout=!1,this.cacheKey=`${s},${this.visibility},`}}class E{constructor(e=0,t=e){this.type="Vec2",this._x=e,this._y=t}get x(){return this._x}set x(e){const t=e!==this._x;this._x=e,t&&this._onChangeCallback&&this._onChangeCallback()}get y(){return this._y}set y(e){const t=e!==this._y;this._y=e,t&&this._onChangeCallback&&this._onChangeCallback()}onChange(e){return e&&(this._onChangeCallback=e),this}set(e=0,t=e){return this.x=e,this.y=t,this}add(e=new E){return this.x+=e.x,this.y+=e.y,this}addScalar(e=0){return this.x+=e,this.y+=e,this}sub(e=new E){return this.x-=e.x,this.y-=e.y,this}subScalar(e=0){return this.x-=e,this.y-=e,this}multiply(e=new E(1)){return this.x*=e.x,this.y*=e.y,this}multiplyScalar(e=1){return this.x*=e,this.y*=e,this}divide(e=new E(1)){return this.x/=e.x,this.y/=e.y,this}divideScalar(e=1){return this.x/=e,this.y/=e,this}copy(e=new E){return this.x=e.x,this.y=e.y,this}clone(){return new E(this.x,this.y)}max(e=new E){return this.x=Math.max(this.x,e.x),this.y=Math.max(this.y,e.y),this}min(e=new E){return this.x=Math.min(this.x,e.x),this.y=Math.min(this.y,e.y),this}clamp(e=new E,t=new E){return this.x=Math.max(e.x,Math.min(t.x,this.x)),this.y=Math.max(e.y,Math.min(t.y,this.y)),this}equals(e=new E){return this.x===e.x&&this.y===e.y}lengthSq(){return this.x*this.x+this.y*this.y}length(){return Math.sqrt(this.lengthSq())}normalize(){let e=this.x*this.x+this.y*this.y;return e>0&&(e=1/Math.sqrt(e)),this.x*=e,this.y*=e,this}dot(e=new E){return this.x*e.x+this.y*e.y}lerp(e=new E,t=1){return this.x+=(e.x-this.x)*t,this.y+=(e.y-this.y)*t,this}}class Q{constructor(e=new Float32Array([0,0,0,1]),t="XYZ"){this.type="Quat",this.elements=e,this.axisOrder=t}setFromArray(e=new Float32Array([0,0,0,1])){return this.elements[0]=e[0],this.elements[1]=e[1],this.elements[2]=e[2],this.elements[3]=e[3],this}setAxisOrder(e="XYZ"){switch(e=e.toUpperCase(),e){case"XYZ":case"YXZ":case"ZXY":case"ZYX":case"YZX":case"XZY":this.axisOrder=e;break;default:this.axisOrder="XYZ"}return this}copy(e=new Q){return this.elements=e.elements,this.axisOrder=e.axisOrder,this}clone(){return new Q().copy(this)}equals(e=new Q){return this.elements[0]===e.elements[0]&&this.elements[1]===e.elements[1]&&this.elements[2]===e.elements[2]&&this.elements[3]===e.elements[3]&&this.axisOrder===e.axisOrder}setFromVec3(e){const t=e.x*.5,s=e.y*.5,i=e.z*.5,r=Math.cos(t),n=Math.cos(s),o=Math.cos(i),h=Math.sin(t),u=Math.sin(s),l=Math.sin(i);return this.axisOrder==="XYZ"?(this.elements[0]=h*n*o+r*u*l,this.elements[1]=r*u*o-h*n*l,this.elements[2]=r*n*l+h*u*o,this.elements[3]=r*n*o-h*u*l):this.axisOrder==="YXZ"?(this.elements[0]=h*n*o+r*u*l,this.elements[1]=r*u*o-h*n*l,this.elements[2]=r*n*l-h*u*o,this.elements[3]=r*n*o+h*u*l):this.axisOrder==="ZXY"?(this.elements[0]=h*n*o-r*u*l,this.elements[1]=r*u*o+h*n*l,this.elements[2]=r*n*l+h*u*o,this.elements[3]=r*n*o-h*u*l):this.axisOrder==="ZYX"?(this.elements[0]=h*n*o-r*u*l,this.elements[1]=r*u*o+h*n*l,this.elements[2]=r*n*l-h*u*o,this.elements[3]=r*n*o+h*u*l):this.axisOrder==="YZX"?(this.elements[0]=h*n*o+r*u*l,this.elements[1]=r*u*o+h*n*l,this.elements[2]=r*n*l-h*u*o,this.elements[3]=r*n*o-h*u*l):this.axisOrder==="XZY"&&(this.elements[0]=h*n*o-r*u*l,this.elements[1]=r*u*o-h*n*l,this.elements[2]=r*n*l+h*u*o,this.elements[3]=r*n*o+h*u*l),this}setFromAxisAngle(e,t=0){const s=t/2,i=Math.sin(s);return this.elements[0]=e.x*i,this.elements[1]=e.y*i,this.elements[2]=e.z*i,this.elements[3]=Math.cos(s),this}setFromRotationMatrix(e){const t=e.elements,s=t[0],i=t[4],r=t[8],n=t[1],o=t[5],h=t[9],u=t[2],l=t[6],d=t[10],c=s+o+d;if(c>0){const p=.5/Math.sqrt(c+1);this.elements[3]=.25/p,this.elements[0]=(l-h)*p,this.elements[1]=(r-u)*p,this.elements[2]=(n-i)*p}else if(s>o&&s>d){const p=2*Math.sqrt(1+s-o-d);this.elements[3]=(l-h)/p,this.elements[0]=.25*p,this.elements[1]=(i+n)/p,this.elements[2]=(r+u)/p}else if(o>d){const p=2*Math.sqrt(1+o-s-d);this.elements[3]=(r-u)/p,this.elements[0]=(i+n)/p,this.elements[1]=.25*p,this.elements[2]=(h+l)/p}else{const p=2*Math.sqrt(1+d-s-o);this.elements[3]=(n-i)/p,this.elements[0]=(r+u)/p,this.elements[1]=(h+l)/p,this.elements[2]=.25*p}return this}}class f{constructor(e=0,t=e,s=e){this.type="Vec3",this._x=e,this._y=t,this._z=s}get x(){return this._x}set x(e){const t=e!==this._x;this._x=e,t&&this._onChangeCallback&&this._onChangeCallback()}get y(){return this._y}set y(e){const t=e!==this._y;this._y=e,t&&this._onChangeCallback&&this._onChangeCallback()}get z(){return this._z}set z(e){const t=e!==this._z;this._z=e,t&&this._onChangeCallback&&this._onChangeCallback()}onChange(e){return e&&(this._onChangeCallback=e),this}set(e=0,t=e,s=e){return this.x=e,this.y=t,this.z=s,this}add(e=new f){return this.x+=e.x,this.y+=e.y,this.z+=e.z,this}addScalar(e=0){return this.x+=e,this.y+=e,this.z+=e,this}sub(e=new f){return this.x-=e.x,this.y-=e.y,this.z-=e.z,this}subScalar(e=0){return this.x-=e,this.y-=e,this.z-=e,this}multiply(e=new f(1)){return this.x*=e.x,this.y*=e.y,this.z*=e.z,this}multiplyScalar(e=1){return this.x*=e,this.y*=e,this.z*=e,this}divide(e=new f(1)){return this.x/=e.x,this.y/=e.y,this.z/=e.z,this}divideScalar(e=1){return this.x/=e,this.y/=e,this.z/=e,this}copy(e=new f){return this.x=e.x,this.y=e.y,this.z=e.z,this}clone(){return new f(this.x,this.y,this.z)}max(e=new f){return this.x=Math.max(this.x,e.x),this.y=Math.max(this.y,e.y),this.z=Math.max(this.z,e.z),this}min(e=new f){return this.x=Math.min(this.x,e.x),this.y=Math.min(this.y,e.y),this.z=Math.min(this.z,e.z),this}clamp(e=new f,t=new f){return this.x=Math.max(e.x,Math.min(t.x,this.x)),this.y=Math.max(e.y,Math.min(t.y,this.y)),this.z=Math.max(e.z,Math.min(t.z,this.z)),this}equals(e=new f){return this.x===e.x&&this.y===e.y&&this.z===e.z}lengthSq(){return this.x*this.x+this.y*this.y+this.z*this.z}length(){return Math.sqrt(this.lengthSq())}distance(e=new f){return Math.hypot(e.x-this.x,e.y-this.y,e.z-this.z)}normalize(){let e=this.lengthSq();return e>0&&(e=1/Math.sqrt(e)),this.x*=e,this.y*=e,this.z*=e,this}dot(e=new f){return this.x*e.x+this.y*e.y+this.z*e.z}cross(e=new f){return this.crossVectors(this,e)}crossVectors(e=new f,t=new f){const s=e.x,i=e.y,r=e.z,n=t.x,o=t.y,h=t.z;return this.x=i*h-r*o,this.y=r*n-s*h,this.z=s*o-i*n,this}lerp(e=new f,t=1){return this.x+=(e.x-this.x)*t,this.y+=(e.y-this.y)*t,this.z+=(e.z-this.z)*t,this}applyMat4(e){const t=this._x,s=this._y,i=this._z,r=e.elements;let n=r[3]*t+r[7]*s+r[11]*i+r[15];return n=n||1,this.x=(r[0]*t+r[4]*s+r[8]*i+r[12])/n,this.y=(r[1]*t+r[5]*s+r[9]*i+r[13])/n,this.z=(r[2]*t+r[6]*s+r[10]*i+r[14])/n,this}setFromMatrixPosition(e){const t=e.elements;return this.x=t[12],this.y=t[13],this.z=t[14],this}applyQuat(e=new Q){const t=this.x,s=this.y,i=this.z,r=e.elements[0],n=e.elements[1],o=e.elements[2],h=e.elements[3],u=h*t+n*i-o*s,l=h*s+o*t-r*i,d=h*i+r*s-n*t,c=-r*t-n*s-o*i;return this.x=u*h+c*-r+l*-o-d*-n,this.y=l*h+c*-n+d*-r-u*-o,this.z=d*h+c*-o+u*-n-l*-r,this}applyAxisAngle(e=new f,t=0,s=new Q){return this.applyQuat(s.setFromAxisAngle(e,t))}project(e){return this.applyMat4(e.viewMatrix).applyMat4(e.projectionMatrix),this}unproject(e){return this.applyMat4(e.projectionMatrix.getInverse()).applyMat4(e.modelMatrix),this}}const Ms=4,Ce=4,W=Ms*Ce;class Je{constructor({name:e,key:t,type:s="f32"}){this.name=e,this.key=t,this.type=s,this.bufferLayout=Pt(this.type.replace("array","").replace("<","").replace(">","")),this.alignment={start:{row:0,byte:0},end:{row:0,byte:0}},this.setValue=null}get rowCount(){return this.alignment.end.row-this.alignment.start.row+1}get byteCount(){return Math.abs(this.endOffset-this.startOffset)+1}get paddedByteCount(){return(this.alignment.end.row+1)*W}get startOffset(){return this.getByteCountAtPosition(this.alignment.start)}get startOffsetToIndex(){return this.startOffset/Ce}get endOffset(){return this.getByteCountAtPosition(this.alignment.end)}get endOffsetToIndex(){return Math.floor(this.endOffset/Ce)}getPositionAtOffset(e=0){return{row:Math.floor(e/W),byte:e%W}}getByteCountAtPosition(e={row:0,byte:0}){return e.row*W+e.byte}applyOverflowToPosition(e={row:0,byte:0}){if(e.byte>W-1){const t=e.byte%W;e.row+=Math.floor(e.byte/W),e.byte=t}return e}getByteCountBetweenPositions(e={row:0,byte:0},t={row:0,byte:0}){return Math.abs(this.getByteCountAtPosition(t)-this.getByteCountAtPosition(e))}getElementAlignment(e={row:0,byte:0}){const t={start:e,end:e},{size:s,align:i}=this.bufferLayout;return e.byte%i!==0&&(e.byte+=e.byte%i),(s<=W&&e.byte+s>W||s>W&&e.byte>W)&&(e.row+=1,e.byte=0),t.end={row:e.row+Math.ceil(s/W)-1,byte:e.byte+(s%W===0?W-1:s%W-1)},t.end=this.applyOverflowToPosition(t.end),t}setAlignmentFromPosition(e={row:0,byte:0}){this.alignment=this.getElementAlignment(e)}setAlignment(e=0){this.setAlignmentFromPosition(this.getPositionAtOffset(e))}setView(e,t){this.view=new this.bufferLayout.View(e,this.startOffset,this.byteCount/this.bufferLayout.View.BYTES_PER_ELEMENT)}setValueFromFloat(e){this.view[0]=e}setValueFromVec2(e){this.view[0]=e.x??e[0]??0,this.view[1]=e.y??e[1]??0}setValueFromVec3(e){this.view[0]=e.x??e[0]??0,this.view[1]=e.y??e[1]??0,this.view[2]=e.z??e[2]??0}setValueFromMat4OrQuat(e){this.view.set(e.elements)}setValueFromMat3(e){this.setValueFromArrayWithPad(e.elements)}setValueFromArray(e){this.view.set(e)}setValueFromArrayWithPad(e){for(let t=0,s=0;t<this.view.length;t+=this.bufferLayout.pad[0]+this.bufferLayout.pad[1],s++)for(let i=0;i<this.bufferLayout.pad[0];i++)this.view[t+i]=e[t+i-s]}update(e){this.setValue||(this.setValue=(t=>{if(this.type==="f32"||this.type==="u32"||this.type==="i32")return this.setValueFromFloat;if(this.type==="vec2f")return this.setValueFromVec2;if(this.type==="vec3f")return this.setValueFromVec3;if(this.type==="mat3x3f")return t.elements?this.setValueFromMat3:this.setValueFromArrayWithPad;if(t.elements)return this.setValueFromMat4OrQuat;if(ArrayBuffer.isView(t)||Array.isArray(t))return this.bufferLayout.pad?this.setValueFromArrayWithPad:this.setValueFromArray;D(`${this.constructor.name}: value passed to ${this.name} cannot be used: ${t}`)})(e)),this.setValue(e)}extractDataFromBufferResult(e){return e.slice(this.startOffsetToIndex,this.endOffsetToIndex)}}class Rt extends Je{constructor({name:e,key:t,type:s="f32",arrayLength:i=1}){super({name:e,key:t,type:s}),this.arrayLength=i,this.numElements=Math.ceil(this.arrayLength/this.bufferLayout.numElements)}get arrayStrideToIndex(){return this.arrayStride/Ce}setAlignment(e=0){super.setAlignment(e);const t=this.getElementAlignment(this.getPositionAtOffset(this.endOffset+1));this.arrayStride=this.getByteCountBetweenPositions(this.alignment.end,t.end),this.alignment.end=this.getPositionAtOffset(this.endOffset+this.arrayStride*(this.numElements-1))}setValueFromArray(e){let t=0;const s=this.byteCount/this.bufferLayout.View.BYTES_PER_ELEMENT,i=Math.ceil(s/this.numElements);for(let r=0;r<this.numElements;r++)for(let n=0;n<this.bufferLayout.numElements;n++)this.view[n+r*i]=e[t],t++}}class et extends Rt{constructor({name:e,key:t,type:s="f32",arrayLength:i=1}){super({name:e,key:t,type:s,arrayLength:i}),this.arrayStride=1,this.arrayLength=i,this.numElements=Math.ceil(this.arrayLength/this.bufferLayout.numElements)}get byteCount(){return this.bufferLayout.size*this.numElements}setAlignment(e=0,t=0){this.alignment=this.getElementAlignment(this.getPositionAtOffset(e)),this.arrayStride=t,this.alignment.end=this.getPositionAtOffset(this.endOffset+t*(this.numElements-1))}setView(e,t){this.view=new this.bufferLayout.View(this.bufferLayout.numElements*this.numElements),this.viewSetFunction=(s=>{switch(this.bufferLayout.View){case Int32Array:return s.setInt32.bind(s);case Uint16Array:return s.setUint16.bind(s);case Uint32Array:return s.setUint32.bind(s);case Float32Array:default:return s.setFloat32.bind(s)}})(t)}update(e){super.update(e);for(let t=0;t<this.numElements;t++){const s=this.view.subarray(t*this.bufferLayout.numElements,t*this.bufferLayout.numElements+this.bufferLayout.numElements),i=this.startOffset+t*this.arrayStride;s.forEach((r,n)=>{this.viewSetFunction(i+n*this.bufferLayout.View.BYTES_PER_ELEMENT,r,!0)})}}extractDataFromBufferResult(e){const t=new Float32Array(this.arrayLength);for(let s=0;s<this.numElements;s++){const i=this.startOffsetToIndex+s*this.arrayStrideToIndex;for(let r=0;r<this.bufferLayout.numElements;r++)t[s*this.bufferLayout.numElements+r]=e[i+r]}return t}}const Bs=new Map([["copySrc",GPUBufferUsage.COPY_SRC],["copyDst",GPUBufferUsage.COPY_DST],["index",GPUBufferUsage.INDEX],["indirect",GPUBufferUsage.INDIRECT],["mapRead",GPUBufferUsage.MAP_READ],["mapWrite",GPUBufferUsage.MAP_WRITE],["queryResolve",GPUBufferUsage.QUERY_RESOLVE],["storage",GPUBufferUsage.STORAGE],["uniform",GPUBufferUsage.UNIFORM],["vertex",GPUBufferUsage.VERTEX]]),St=(a=[])=>a.reduce((e,t)=>e|Bs.get(t),0);class de{constructor({label:e="Buffer",size:t=0,usage:s=["copySrc","copyDst"],mappedAtCreation:i=!1}={}){this.type="Buffer",this.reset(),this.uuid=L(),this.consumers=new Set,this.options={label:e,size:t,usage:St(s),mappedAtCreation:i}}reset(){this.GPUBuffer=null}set size(e){this.options.size=e}createBuffer(e,t={}){const{usage:s,...i}=t;this.options={...this.options,...i,...s!==void 0&&{usage:St(s)}},this.setBuffer(e.createBuffer(this))}setBuffer(e){this.GPUBuffer=e}copy(e,t=!1){t&&this.destroy(),this.options=e.options,this.GPUBuffer=e.GPUBuffer,this.consumers=new Set([...this.consumers,...e.consumers])}async mapBufferAsync(){if(!this.GPUBuffer||this.GPUBuffer.mapState!=="unmapped")return new Float32Array(0);await this.GPUBuffer.mapAsync(GPUMapMode.READ);const e=new Float32Array(this.GPUBuffer.getMappedRange().slice(0));return this.GPUBuffer.unmap(),e}destroy(){this.GPUBuffer?.destroy(),this.reset(),this.consumers.clear()}}class ce extends Pe{constructor({label:e="Uniform",name:t="uniform",bindingType:s,visibility:i,useStruct:r=!0,access:n="read",usage:o=[],struct:h={}}){s=s??"uniform",super({label:e,name:t,bindingType:s,visibility:i}),this.options={...this.options,useStruct:r,access:n,usage:o,struct:h},this.cacheKey+=`${r},${n},`,this.arrayBufferSize=0,this.shouldUpdate=!1,this.useStruct=r,this.bufferElements=[],this.inputs={},this.buffer=new de,Object.keys(h).length&&(this.setBindings(h),this.setBufferAttributes(),this.setWGSLFragment())}get resourceLayout(){return{buffer:{type:Ct(this)}}}get resourceLayoutCacheKey(){return`buffer,${Ct(this)},${this.visibility},`}get resource(){return{buffer:this.buffer.GPUBuffer}}clone(e){const{struct:t,...s}=e,i=new this.constructor(s);return i.setBindings(t),i.options.struct=t,i.arrayBufferSize=this.arrayBufferSize,i.arrayBuffer=new ArrayBuffer(i.arrayBufferSize),i.arrayView=new DataView(i.arrayBuffer,0,i.arrayBuffer.byteLength),i.buffer.size=i.arrayBuffer.byteLength,this.bufferElements.forEach(r=>{const n=new r.constructor({name:r.name,key:r.key,type:r.type,...r.arrayLength&&{arrayLength:r.arrayLength}});n.alignment=r.alignment,r.arrayStride&&(n.arrayStride=r.arrayStride),n.setView(i.arrayBuffer,i.arrayView),i.bufferElements.push(n)}),this.name===i.name&&this.label===i.label?(i.wgslStructFragment=this.wgslStructFragment,i.wgslGroupFragment=this.wgslGroupFragment):i.setWGSLFragment(),i.shouldUpdate=i.arrayBufferSize>0,i}setBindings(e){for(const t of Object.keys(e)){const s={};for(const i in e[t])i!=="value"&&(s[i]=e[t][i]);s.name=t,Object.defineProperty(s,"value",{get(){return s._value},set(i){s._value=i,s.shouldUpdate=!0}}),s.value=e[t].value,(s.value instanceof E||s.value instanceof f)&&s.value.onChange(()=>s.shouldUpdate=!0),this.inputs[t]=s,this.cacheKey+=`${t},${e[t].type},`}}setBufferAttributes(){let e=Object.keys(this.inputs);const t=e.filter(s=>this.inputs[s].type.includes("array"));t.length&&(e.sort((s,i)=>{const r=Math.min(0,this.inputs[s].type.indexOf("array")),n=Math.min(0,this.inputs[i].type.indexOf("array"));return r-n}),t.length>1&&(e=e.filter(s=>!t.includes(s))));for(const s of e){const i=this.inputs[s],r={name:ye(i.name??s),key:s,type:i.type},n=i.type.includes("array")&&(Array.isArray(i.value)||ArrayBuffer.isView(i.value));this.bufferElements.push(n?new Rt({...r,arrayLength:i.value.length}):new Je(r))}if(this.bufferElements.forEach((s,i)=>{const r=i===0?0:this.bufferElements[i-1].endOffset+1;s.setAlignment(r)}),t.length>1)if(t.map(r=>{const n=this.inputs[r],o=Pt(n.type.replace("array","").replace("<","").replace(">",""));return Math.ceil(n.value.length/o.numElements)}).every((r,n,o)=>r===o[0])){const r=t.map(h=>{const u=this.inputs[h];return new et({name:ye(u.name??h),key:h,type:u.type,arrayLength:u.value.length})}),n=t.map(h=>{const u=this.inputs[h];return new Je({name:ye(u.name??h),key:h,type:u.type.replace("array","").replace("<","").replace(">","")})});n.forEach((h,u)=>{u===0?this.bufferElements.length?h.setAlignmentFromPosition({row:this.bufferElements[this.bufferElements.length-1].alignment.end.row+1,byte:0}):h.setAlignment(0):h.setAlignment(n[u-1].endOffset+1)});const o=n[n.length-1].endOffset+1-n[0].startOffset;r.forEach((h,u)=>{h.setAlignment(n[u].startOffset,o)}),this.bufferElements=[...this.bufferElements,...r]}else D(`BufferBinding: "${this.label}" contains multiple array inputs that should use an interleaved array, but their sizes do not match. These inputs cannot be added to the BufferBinding: "${t.join(", ")}"`);this.arrayBufferSize=this.bufferElements.length?this.bufferElements[this.bufferElements.length-1].paddedByteCount:0,this.arrayBuffer=new ArrayBuffer(this.arrayBufferSize),this.arrayView=new DataView(this.arrayBuffer,0,this.arrayBuffer.byteLength),this.buffer.size=this.arrayBuffer.byteLength;for(const s of this.bufferElements)s.setView(this.arrayBuffer,this.arrayView);this.shouldUpdate=this.arrayBufferSize>0}setWGSLFragment(){if(!this.bufferElements.length)return;const e=Ke(this.label);if(this.useStruct){const t=this.bufferElements.filter(i=>!(i instanceof et)),s=this.bufferElements.filter(i=>i instanceof et);if(s.length){const i=this.bindingType==="uniform"?`, ${s[0].numElements}`:"";if(t.length){this.wgslStructFragment=`struct ${e}Element {
...
`;const ue={vertex:{get_uv_cover:Ht},fragment:{get_uv_cover:Ht,get_vertex_to_uv_coords:Ns}},le={vertex:{get_output_position:Is,get_normals:Ws},fragment:{}};class ft extends pt{constructor(e){let{renderer:t,...s}=e;const{label:i,attributes:r,bindGroups:n,cacheKey:o,...h}=s;t=t&&t.renderer||t;const u="RenderPipelineEntry";F(t,i?i+" "+u:u),super(e),this.type=u,this.shaders={vertex:{head:"",code:"",module:null},fragment:{head:"",code:"",module:null},full:{head:"",code:"",module:null}},this.descriptor=null,this.options={...this.options,attributes:r,bindGroups:n,cacheKey:o,...h},this.setPipelineEntryProperties({attributes:r,bindGroups:n})}setPipelineEntryProperties(e){const{attributes:t,bindGroups:s}=e;this.attributes=t,this.setPipelineEntryBindGroups(s)}patchShaders(){this.shaders.vertex.head="",this.shaders.vertex.code="",this.shaders.fragment.head="",this.shaders.fragment.code="",this.shaders.full.head="",this.shaders.full.code="";for(const t in ue.vertex)this.shaders.vertex.head=`${ue.vertex[t]}
...
@fragment fn main(fsInput: VSOutput) -> @location(0) vec4f {
...
}`;class Qs extends dt{constructor(e,t={}){e=e&&e.renderer||e,F(e,t.label?t.label+" ShaderPass":"ShaderPass"),t.depth=!1,t.transparent=!0,t.label=t.label??"ShaderPass "+e.shaderPasses?.length,t.sampleCount=t.sampleCount?t.sampleCount:e&&e.postProcessingPass?e&&e.postProcessingPass.options.sampleCount:1,t.shaders||(t.shaders={}),t.shaders.fragment||(t.shaders.fragment={code:Zs,entryPoint:"main"}),t.depth=!1,super(e,t),t.inputTarget&&this.setInputTarget(t.inputTarget),this.outputTarget&&this.setRenderingOptionsForRenderPass(this.outputTarget.renderPass),this.type="ShaderPass",this.createTexture({label:t.label?`${t.label} render texture`:"Shader pass render texture",name:"renderTexture",fromTexture:this.inputTarget?this.inputTarget.renderTexture:null,usage:["copySrc","copyDst","textureBinding"],...this.outputTarget&&this.outputTarget.options.qualityRatio&&{qualityRatio:this.outputTarget.options.qualityRatio}})}cleanupRenderMaterialParameters(e){return delete e.copyOutputToRenderTexture,delete e.inputTarget,super.cleanupRenderMaterialParameters(e),e}get renderTexture(){return this.textures.find(e=>e.options.name==="renderTexture")}setInputTarget(e){if(e&&e.type!=="RenderTarget"){D(`${this.options.label??this.type}: inputTarget is not a RenderTarget: ${e}`);return}this.removeFromScene(),this.inputTarget=e,this.addToScene(),this.renderTexture&&(e?this.renderTexture.copy(this.inputTarget.renderTexture):(this.renderTexture.options.fromTexture=null,this.renderTexture.createTexture()))}addToScene(e=!1){e&&this.renderer.shaderPasses.push(this),this.setRenderingOptionsForRenderPass(this.outputTarget?this.outputTarget.renderPass:this.renderer.postProcessingPass),this.autoRender&&this.renderer.scene.addShaderPass(this)}removeFromScene(e=!1){this.outputTarget&&this.outputTarget.destroy(),this.autoRender&&this.renderer.scene.removeShaderPass(this),e&&(this.renderer.shaderPasses=this.renderer.shaderPasses.filter(t=>t.uuid!==this.uuid))}}var os=(a,e,t)=>{if(!e.has(a))throw TypeError("Cannot "+t)},pe=(a,e,t)=>(os(a,e,"read from private field"),t?t.call(a):e.get(a)),bt=(a,e,t)=>{if(e.has(a))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(a):e.set(a,t)},Js=(a,e,t,s)=>(os(a,e,"write to private field"),s?s.call(a,t):e.set(a,t),t),we,Ne,je;class as extends ct{constructor(e,t,s){super(e),bt(this,we,new f),bt(this,Ne,new f(1)),bt(this,je,1),this.boundingBox=new ie(new f(-1),new f(1)),this._onAfterDOMElementResizeCallback=()=>{},e=e&&e.renderer||e,Qe(e,"DOM3DObject"),this.renderer=e,this.size={document:{width:0,height:0,top:0,left:0},normalizedWorld:{size:new E(1),position:new E},cameraWorld:{size:new E(1),position:new E},scaledWorld:{size:new f(1),position:new f}},this.watchScroll=s.watchScroll,this.camera=this.renderer.camera,this.boundingBox.min.onChange(()=>this.updateSizeAndPosition()),this.boundingBox.max.onChange(()=>this.updateSizeAndPosition()),this.setDOMElement(t),this.renderer.domObjects.push(this)}setDOMElement(e){this.domElement=new gt({element:e,onSizeChanged:t=>this.resize(t),onPositionChanged:t=>this.onPositionChanged(t)})}onPositionChanged(e){this.watchScroll&&(this.size.document=e??this.domElement.element.getBoundingClientRect(),this.updateSizeAndPosition())}resetDOMElement(e){this.domElement&&this.domElement.destroy(),this.setDOMElement(e)}updateSizeAndPosition(){this.setWorldSizes(),this.applyPosition()}resize(e=null){!e&&(!this.domElement||this.domElement?.isResizing)||(this.size.document=e??this.domElement.element.getBoundingClientRect(),this.updateSizeAndPosition(),this._onAfterDOMElementResizeCallback&&this._onAfterDOMElementResizeCallback())}get boundingRect(){return this.domElement.boundingRect}setTransforms(){super.setTransforms(),this.transforms.origin.model.set(.5,.5,0),this.transforms.origin.world=new f,this.transforms.position.document=new f,this.documentPosition.onChange(()=>this.applyPosition()),this.transformOrigin.onChange(()=>this.setWorldTransformOrigin())}get documentPosition(){return this.transforms.position.document}set documentPosition(e){this.transforms.position.document=e,this.applyPosition()}get DOMObjectWorldScale(){return pe(this,Ne).clone()}get worldScale(){return this.DOMObjectWorldScale.multiply(this.scale)}get worldPosition(){return pe(this,we).clone()}get transformOrigin(){return this.transforms.origin.model}set transformOrigin(e){this.transforms.origin.model=e,this.setWorldTransformOrigin()}get worldTransformOrigin(){return this.transforms.origin.world}set worldTransformOrigin(e){this.transforms.origin.world=e}applyPosition(){this.applyDocumentPosition(),super.applyPosition()}applyDocumentPosition(){let e=new f(0,0,0);this.documentPosition.equals(e)||(e=this.documentToWorldSpace(this.documentPosition)),pe(this,we).set(this.position.x+this.size.scaledWorld.position.x+e.x,this.position.y+this.size.scaledWorld.position.y+e.y,this.position.z+this.size.scaledWorld.position.z+this.documentPosition.z/this.camera.CSSPerspective)}applyTransformOrigin(){this.size&&(this.setWorldTransformOrigin(),super.applyTransformOrigin())}updateModelMatrix(){this.modelMatrix.composeFromOrigin(pe(this,we),this.quaternion,this.scale,this.worldTransformOrigin),this.modelMatrix.scale(this.DOMObjectWorldScale),this.shouldUpdateWorldMatrix()}documentToWorldSpace(e=new f){return new f(e.x*this.renderer.pixelRatio/this.renderer.boundingRect.width*this.camera.screenRatio.width,-(e.y*this.renderer.pixelRatio/this.renderer.boundingRect.height)*this.camera.screenRatio.height,e.z)}computeWorldSizes(){const e=this.renderer.boundingRect,t={x:this.size.document.width/2+this.size.document.left,y:this.size.document.height/2+this.size.document.top},s={x:e.width/2+e.left,y:e.height/2+e.top},{size:i,center:r}=this.boundingBox;i.x!==0&&i.y!==0&&i.z!==0&&r.divide(i),this.size.normalizedWorld.size.set(this.size.document.width/e.width,this.size.document.height/e.height),this.size.normalizedWorld.position.set((t.x-s.x)/e.width,(s.y-t.y)/e.height),this.size.cameraWorld.size.set(this.size.normalizedWorld.size.x*this.camera.screenRatio.width,this.size.normalizedWorld.size.y*this.camera.screenRatio.height),this.size.cameraWorld.position.set(this.size.normalizedWorld.position.x*this.camera.screenRatio.width,this.size.normalizedWorld.position.y*this.camera.screenRatio.height),this.size.scaledWorld.size.set(this.size.cameraWorld.size.x/i.x,this.size.cameraWorld.size.y/i.y,1),this.size.scaledWorld.size.z=this.size.scaledWorld.size.y*(i.x/i.y/(this.size.document.width/this.size.document.height)),this.size.scaledWorld.position.set(this.size.cameraWorld.position.x-r.x*this.size.scaledWorld.size.x*i.x,this.size.cameraWorld.position.y-r.y*this.size.scaledWorld.size.y*i.y,-r.z)}setWorldSizes(){this.computeWorldSizes(),this.setWorldScale(),this.setWorldTransformOrigin()}setWorldScale(){pe(this,Ne).set(this.size.scaledWorld.size.x,this.size.scaledWorld.size.y,this.size.scaledWorld.size.z*pe(this,je)),this.shouldUpdateMatrixStack()}set DOMObjectDepthScaleRatio(e){Js(this,je,e),this.setWorldScale()}setWorldTransformOrigin(){this.transforms.origin.world=new f((this.transformOrigin.x*2-1)*this.size.scaledWorld.size.x,-(this.transformOrigin.y*2-1)*this.size.scaledWorld.size.y,this.transformOrigin.z*this.size.scaledWorld.size.z),this.shouldUpdateMatrixStack()}updateScrollPosition(e={x:0,y:0}){(e.x||e.y)&&this.domElement.updateScrollPosition(e)}onAfterDOMElementResize(e){return e&&(this._onAfterDOMElementResizeCallback=e),this}destroy(){super.destroy(),this.domElement?.destroy()}}we=new WeakMap,Ne=new WeakMap,je=new WeakMap;const hs={autoloadSources:!0,watchScroll:!0};class us extends Xt(as){constructor(e,t,s){super(e,t,{...hs,...s}),this._onLoadingCallback=r=>{},s={...hs,...s},e=e&&e.renderer||e,Qe(e,s.label?s.label+" DOMMesh":"DOMMesh"),this.type="DOMMesh";const{autoloadSources:i}=s;this.autoloadSources=i,this.sourcesReady=!1,this.setInitSources()}get ready(){return this._ready}set ready(e){e&&!this._ready&&this.sourcesReady&&this._onReadyCallback&&this._onReadyCallback(),this._ready=e}get sourcesReady(){return this._sourcesReady}set sourcesReady(e){e&&!this._sourcesReady&&this.ready&&this._onReadyCallback&&this._onReadyCallback(),this._sourcesReady=e}addToScene(e=!1){super.addToScene(e),e&&this.renderer.domMeshes.push(this)}removeFromScene(e=!1){super.removeFromScene(e),e&&(this.renderer.domMeshes=this.renderer.domMeshes.filter(t=>t.uuid!==this.uuid))}setInitSources(){let e=0,t=0;if(this.autoloadSources){const s=this.domElement.element.querySelectorAll("img"),i=this.domElement.element.querySelectorAll("video"),r=this.domElement.element.querySelectorAll("canvas");e=s.length+i.length+r.length;const n=o=>{t++,this._onLoadingCallback&&this._onLoadingCallback(o),t===e&&(this.sourcesReady=!0)};e||(this.sourcesReady=!0),s.length&&s.forEach(o=>{const h=this.createDOMTexture({name:o.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>n(h)).loadImage(o.src)}),i.length&&i.forEach(o=>{const h=this.createDOMTexture({name:o.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>n(h)).loadVideo(o)}),r.length&&r.forEach(o=>{const h=this.createDOMTexture({name:o.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>n(h)).loadCanvas(o)})}else this.sourcesReady=!0}resetDOMElement(e){e?super.resetDOMElement(e):!e&&!this.renderer.production&&D(`${this.options.label}: You are trying to reset a ${this.type} with a HTML element that does not exist. The old HTML element will be kept instead.`)}get pixelRatioBoundingRect(){const e=window.devicePixelRatio??1,t=this.renderer.pixelRatio/e;return Object.keys(this.domElement.boundingRect).reduce((s,i)=>({...s,[i]:this.domElement.boundingRect[i]*t}),{x:0,y:0,width:0,height:0,top:0,right:0,bottom:0,left:0})}computeGeometry(){super.computeGeometry(),this.boundingBox.copy(this.geometry.boundingBox)}onLoading(e){return e&&(this._onLoadingCallback=e),this}}class ei extends dt{constructor(e,t={}){e=e&&e.renderer||e,F(e,t.label?t.label+" PingPongPlane":"PingPongPlane");const s=t.targets&&t.targets.length&&t.targets.map(i=>({targetFormat:i.format}));t.outputTarget=new ns(e,{label:t.label?t.label+" render target":"Ping Pong render target",useDepth:!1,...s&&{colorAttachments:s}}),t.transparent=!1,t.depth=!1,t.label=t.label??"PingPongPlane "+e.pingPongPlanes?.length,super(e,t),this.type="PingPongPlane",this.createTexture({label:t.label?`${t.label} render texture`:"PingPongPlane render texture",name:"renderTexture",...t.targets&&t.targets.length&&{format:t.targets[0].format},usage:["copyDst","textureBinding"]})}get renderTexture(){return this.textures.find(e=>e.options.name==="renderTexture")}addToScene(e=!1){e&&this.renderer.pingPongPlanes.push(this),this.autoRender&&this.renderer.scene.addPingPongPlane(this)}removeFromScene(e=!1){this.outputTarget&&this.outputTarget.destroy(),this.autoRender&&this.renderer.scene.removePingPongPlane(this),e&&(this.renderer.pingPongPlanes=this.renderer.pingPongPlanes.filter(t=>t.uuid!==this.uuid))}}const ti={label:"Plane",instancesCount:1,vertexBuffers:[]};class ls extends us{constructor(e,t,s={}){e=e&&e.renderer||e,Qe(e,s.label?s.label+" Plane":"Plane");const i={...ti,...s};let{geometry:r,widthSegments:n,heightSegments:o,...h}=i;const{instancesCount:u,vertexBuffers:l,...d}=h;if(!r||r.type!=="PlaneGeometry"){n=n??1,o=o??1;const c=n*o+n;l.length||(r=ke.getPlaneGeometryByID(c)),r?r.instancesCount=u:(r=new ot({widthSegments:n,heightSegments:o,instancesCount:u,vertexBuffers:l}),ke.addPlaneGeometry(r))}super(e,t,{geometry:r,...d}),this.type="Plane"}mouseToPlaneCoords(e=new E){const t={x:2*(e.x/this.renderer.boundingRect.width)-1,y:2*(1-e.y/this.renderer.boundingRect.height)-1},s=this.camera.position.clone(),i=new f(t.x,t.y,-.5);i.unproject(this.camera),i.sub(s).normalize();const r=new f(0,0,1);r.applyQuat(this.quaternion).normalize();const n=new f(0,0,0),o=r.dot(i);if(Math.abs(o)>=1e-4){const h=this.worldMatrix.getInverse().premultiply(this.camera.viewMatrix),u=this.worldTransformOrigin.clone().add(this.worldPosition),l=new f(this.worldPosition.x-u.x,this.worldPosition.y-u.y,this.worldPosition.z-u.z);l.applyQuat(this.quaternion),u.add(l);const d=r.dot(u.clone().sub(s))/o;n.copy(s.add(i.multiplyScalar(d))),n.applyMat4(h)}else n.set(1/0,1/0,1/0);return new E(n.x,n.y)}}class qe extends xt{constructor({deviceManager:e,label:t,container:s,pixelRatio:i=1,autoResize:r=!0,preferredFormat:n,alphaMode:o="premultiplied",renderPass:h,camera:u}){super({deviceManager:e,label:t,container:s,pixelRatio:i,autoResize:r,preferredFormat:n,alphaMode:o,renderPass:h,camera:u}),this.type="GPUCurtainsRenderer"}setRendererObjects(){super.setRendererObjects(),this.domMeshes=[],this.domObjects=[]}onCameraMatricesChanged(){super.onCameraMatricesChanged(),this.domObjects.forEach(e=>{e.updateSizeAndPosition()})}resizeMeshes(){this.meshes.forEach(e=>{"domElement"in e||e.resize(this.boundingRect)}),this.domObjects.forEach(e=>{this.onBeforeCommandEncoderCreation.add(()=>{e.domElement.isResizing||e.domElement.setSize()},{once:!0})})}}class si{constructor({scroll:e={x:0,y:0},delta:t={x:0,y:0},shouldWatch:s=!0,onScroll:i=(r={x:0,y:0})=>{}}={}){this.scroll=e,this.delta=t,this.shouldWatch=s,this.onScroll=i,this.shouldWatch&&window.addEventListener("scroll",this.setScroll.bind(this),{passive:!0})}setScroll(){this.updateScrollValues({x:window.pageXOffset,y:window.pageYOffset})}updateScrollValues({x:e,y:t}){const s=this.scroll;this.scroll={x:e,y:t},this.delta={x:s.x-this.scroll.x,y:s.y-this.scroll.y},this.onScroll&&this.onScroll(this.delta)}destroy(){this.shouldWatch&&window.removeEventListener("scroll",this.setScroll.bind(this),{passive:!0})}}class ii{constructor({container:e,label:t,pixelRatio:s=window.devicePixelRatio??1,preferredFormat:i,alphaMode:r="premultiplied",production:n=!1,adapterOptions:o={},renderPass:h,camera:u,autoRender:l=!0,autoResize:d=!0,watchScroll:c=!0}={}){this._onRenderCallback=()=>{},this._onScrollCallback=()=>{},this._onErrorCallback=()=>{},this._onContextLostCallback=()=>{},this.type="CurtainsGPU",this.options={container:e,label:t,pixelRatio:s,camera:u,production:n,adapterOptions:o,preferredFormat:i,alphaMode:r,renderPass:h,autoRender:l,autoResize:d,watchScroll:c},this.setDeviceManager(),e&&this.setContainer(e)}setContainer(e){if(e)if(typeof e=="string")if(e=document.querySelector(e),e)this.options.container=e;else{const t=document.createElement("div");t.setAttribute("id","curtains-gpu-canvas"),document.body.appendChild(t),this.options.container=t}else e instanceof Element&&(this.options.container=e);else{const t=document.createElement("div");t.setAttribute("id","curtains-gpu-canvas"),document.body.appendChild(t),this.options.container=t}this.container=this.options.container,this.setCurtains()}setMainRenderer(){this.createCurtainsRenderer({deviceManager:this.deviceManager,label:this.options.label,container:this.options.container,pixelRatio:this.options.pixelRatio,autoResize:this.options.autoResize,preferredFormat:this.options.preferredFormat,alphaMode:this.options.alphaMode,renderPass:this.options.renderPass,camera:this.options.camera})}patchRendererOptions(e){return e.pixelRatio===void 0&&(e.pixelRatio=this.options.pixelRatio),e.autoResize===void 0&&(e.autoResize=this.options.autoResize),e}createRenderer(e){return e=this.patchRendererOptions(e),new yt({...e,deviceManager:this.deviceManager})}createCameraRenderer(e){return e=this.patchRendererOptions(e),new xt({...e,deviceManager:this.deviceManager})}createCurtainsRenderer(e){return e=this.patchRendererOptions(e),new qe({...e,deviceManager:this.deviceManager})}setDeviceManager(){this.deviceManager=new ss({label:"GPUCurtains default device",production:this.options.production,adapterOptions:this.options.adapterOptions,onError:()=>setTimeout(()=>{this._onErrorCallback&&this._onErrorCallback()},0),onDeviceLost:e=>this._onContextLostCallback&&this._onContextLostCallback(e)})}get renderers(){return this.deviceManager.renderers}get renderer(){return this.renderers[0]}async setDevice({adapter:e=null,device:t=null}={}){await this.deviceManager.init({adapter:e,device:t})}async restoreContext(){await this.deviceManager.restoreDevice()}setCurtains(){this.initEvents(),this.setMainRenderer(),this.options.autoRender&&this.animate()}get pingPongPlanes(){return this.renderers?.map(e=>e.pingPongPlanes).flat()}get shaderPasses(){return this.renderers?.map(e=>e.shaderPasses).flat()}get meshes(){return this.renderers?.map(e=>e.meshes).flat()}get domMeshes(){return this.renderers?.filter(e=>e instanceof qe).map(e=>e.domMeshes).flat()}get domObjects(){return this.renderers?.filter(e=>e instanceof qe).map(e=>e.domObjects).flat()}get planes(){return this.domMeshes.filter(e=>e instanceof ls)}get computePasses(){return this.renderers?.map(e=>e.computePasses).flat()}get camera(){return this.renderer?.camera}setPerspective({fov:e=50,near:t=.01,far:s=50}={}){this.renderer?.setPerspective({fov:e,near:t,far:s})}setCameraPosition(e=new f(0,0,1)){this.renderer?.setCameraPosition(e)}get boundingRect(){return this.renderer?.boundingRect}initScroll(){this.scrollManager=new si({scroll:{x:window.pageXOffset,y:window.pageYOffset},delta:{x:0,y:0},shouldWatch:this.options.watchScroll,onScroll:e=>this.updateScroll(e)})}updateScroll(e={x:0,y:0}){this.domObjects.forEach(t=>{t.domElement&&t.updateScrollPosition(e)}),this._onScrollCallback&&this._onScrollCallback()}updateScrollValues(e={x:0,y:0}){this.scrollManager.updateScrollValues(e)}get scrollDelta(){return this.scrollManager.delta}get scrollValues(){return this.scrollManager.scroll}initEvents(){mt.useObserver(this.options.autoResize),this.initScroll()}onRender(e){return e&&(this._onRenderCallback=e),this}onScroll(e){return e&&(this._onScrollCallback=e),this}onError(e){return e&&(this._onErrorCallback=e),this}onContextLost(e){return e&&(this._onContextLostCallback=e),this}animate(){this.render(),this.animationFrameID=window.requestAnimationFrame(this.animate.bind(this))}render(){this._onRenderCallback&&this._onRenderCallback(),this.deviceManager.render()}destroy(){this.animationFrameID&&window.cancelAnimationFrame(this.animationFrameID),this.deviceManager.destroy(),this.scrollManager?.destroy(),mt.destroy()}}var ds=(a,e,t)=>{if(!e.has(a))throw TypeError("Cannot "+t)},V=(a,e,t)=>(ds(a,e,"read from private field"),t?t.call(a):e.get(a)),vt=(a,e,t)=>{if(e.has(a))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(a):e.set(a,t)},wt=(a,e,t,s)=>(ds(a,e,"write to private field"),s?s.call(a,t):e.set(a,t),t),fe,Me,q;class ri extends se{constructor(e,{camera:t=null,element:s=null}={}){super(),vt(this,fe,new E),vt(this,Me,!1),this.constrainXOrbit=!0,this.constrainYOrbit=!1,this.minOrbit=new E(-Math.PI*.5,-Math.PI),this.maxOrbit=new E(Math.PI*.5,Math.PI),this.orbitStep=new E(.025),this.constrainZoom=!0,this.minZoom=0,this.maxZoom=20,this.zoomStep=.005,vt(this,q,null),this.renderer=e,this.parent=this.renderer.scene,this.quaternion.setAxisOrder("YXZ"),this.camera=t||this.renderer.camera,this.camera.parent=this,this.element=s??this.renderer.domElement.element}set element(e){V(this,q)&&(!e||V(this,q)!==e)&&this.removeEvents(),wt(this,q,e),e&&this.addEvents()}get element(){return V(this,q)}addEvents(){V(this,q).addEventListener("pointerdown",this.onPointerDown.bind(this)),V(this,q).addEventListener("pointermove",this.onPointerMove.bind(this)),V(this,q).addEventListener("pointerup",this.onPointerUp.bind(this)),V(this,q).addEventListener("wheel",this.onMouseWheel.bind(this))}removeEvents(){V(this,q).removeEventListener("pointerdown",this.onPointerDown.bind(this)),V(this,q).removeEventListener("pointermove",this.onPointerMove.bind(this)),V(this,q).removeEventListener("pointerup",this.onPointerUp.bind(this)),V(this,q).removeEventListener("wheel",this.onMouseWheel.bind(this))}onPointerDown(e){e.isPrimary&&wt(this,Me,!0),V(this,fe).set(e.pageX,e.pageY)}onPointerMove(e){let t,s;document.pointerLockElement?(t=e.movementX,s=e.movementY,this.orbit(t*this.orbitStep.x,s*this.orbitStep.y)):V(this,Me)&&(t=e.pageX-V(this,fe).x,s=e.pageY-V(this,fe).y,V(this,fe).set(e.pageX,e.pageY),this.orbit(t*this.orbitStep.x,s*this.orbitStep.y))}onPointerUp(e){e.isPrimary&&wt(this,Me,!1)}onMouseWheel(e){this.zoom(this.position.z+e.deltaY*this.zoomStep),e.preventDefault()}reset(){this.position.set(0),this.rotation.set(0)}orbit(e,t){if(e||t){if(this.rotation.y-=e,this.constrainYOrbit)this.rotation.y=Math.min(Math.max(this.rotation.y,this.minOrbit.y),this.maxOrbit.y);else{for(;this.rotation.y<-Math.PI;)this.rotation.y+=Math.PI*2;for(;this.rotation.y>=Math.PI;)this.rotation.y-=Math.PI*2}if(this.rotation.x-=t,this.constrainXOrbit)this.rotation.x=Math.min(Math.max(this.rotation.x,this.minOrbit.x),this.maxOrbit.x);else{for(;this.rotation.x<-Math.PI;)this.rotation.x+=Math.PI*2;for(;this.rotation.x>=Math.PI;)this.rotation.x-=Math.PI*2}}}zoom(e){this.position.z=e,this.constrainZoom&&(this.position.z=Math.min(Math.max(this.position.z,this.minZoom),this.maxZoom))}updateModelMatrix(){this.modelMatrix.identity().rotateFromQuaternion(this.quaternion).translate(this.position),this.shouldUpdateWorldMatrix()}destroy(){this.camera.parent=this.renderer.scene,this.parent=null,this.element=null}}fe=new WeakMap,Me=new WeakMap,q=new WeakMap;class ni extends be{constructor({instancesCount:e=1,vertexBuffers:t=[],topology:s,mapBuffersAtCreation:i=!0,widthSegments:r=1,heightSegments:n=1,depthSegments:o=1}={}){super({verticesOrder:"ccw",topology:s,instancesCount:e,vertexBuffers:t,mapBuffersAtCreation:i}),this.type="BoxGeometry",r=Math.floor(r),n=Math.floor(n),o=Math.floor(o);const h=[],u=[],l=[],d=[];let c=0;const p=(g,m,y,b,M,P,v,T,B,x)=>{const C=P/B,R=v/x,z=P/2,U=v/2,H=T/2,Y=B+1,ee=x+1;let S=0;const O=new f;for(let $=0;$<ee;$++){const I=$*R-U;for(let X=0;X<Y;X++){const Z=X*C-z;O[g]=Z*b,O[m]=I*M,O[y]=H,h.push(O.x,O.y,O.z),O[g]=0,O[m]=0,O[y]=T>0?1:-1,l.push(O.x,O.y,O.z),u.push(X/B),u.push($/x),S+=1}}for(let $=0;$<x;$++)for(let I=0;I<B;I++){const X=c+I+Y*$,Z=c+I+Y*($+1),ge=c+(I+1)+Y*($+1),ms=c+(I+1)+Y*$;d.push(X,Z,ms),d.push(Z,ge,ms),c+=S}};p("z","y","x",-1,-1,2,2,2,o,n),p("z","y","x",1,-1,2,2,-2,o,n),p("x","z","y",1,1,2,2,2,r,o),p("x","z","y",1,-1,2,2,-2,r,o),p("x","y","z",1,-1,2,2,2,r,n),p("x","y","z",-1,-1,2,2,-2,r,n),this.setAttribute({name:"position",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(h)}),this.setAttribute({name:"uv",type:"vec2f",bufferFormat:"float32x2",size:2,array:new Float32Array(u)}),this.setAttribute({name:"normal",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(l)}),this.setIndexBuffer({array:this.useUint16IndexArray?new Uint16Array(d):new Uint32Array(d),bufferFormat:this.useUint16IndexArray?"uint16":"uint32"})}}class oi extends be{constructor({topology:e,instancesCount:t=1,vertexBuffers:s=[],mapBuffersAtCreation:i=!0,widthSegments:r=32,heightSegments:n=16,phiStart:o=0,phiLength:h=Math.PI*2,thetaStart:u=0,thetaLength:l=Math.PI}={}){super({verticesOrder:"ccw",topology:e,instancesCount:t,vertexBuffers:s,mapBuffersAtCreation:i}),this.type="SphereGeometry",r=Math.max(3,Math.floor(r)),n=Math.max(2,Math.floor(n));const d=1,c=Math.min(u+l,Math.PI);let p=0;const g=[],m=new f,y=new f,b=[],M=[],P=[],v=[];for(let T=0;T<=n;T++){const B=[],x=T/n;let C=0;T===0&&u===0?C=.5/r:T===n&&c===Math.PI&&(C=-.5/r);for(let R=0;R<=r;R++){const z=R/r;m.x=-d*Math.cos(o+z*h)*Math.sin(u+x*l),m.y=d*Math.cos(u+x*l),m.z=d*Math.sin(o+z*h)*Math.sin(u+x*l),M.push(m.x,m.y,m.z),y.copy(m).normalize(),P.push(y.x,y.y,y.z),v.push(z+C,x),B.push(p++)}g.push(B)}for(let T=0;T<n;T++)for(let B=0;B<r;B++){const x=g[T][B+1],C=g[T][B],R=g[T+1][B],z=g[T+1][B+1];(T!==0||u>0)&&b.push(x,C,z),(T!==n-1||c<Math.PI)&&b.push(C,R,z)}this.setAttribute({name:"position",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(M)}),this.setAttribute({name:"uv",type:"vec2f",bufferFormat:"float32x2",size:2,array:new Float32Array(v)}),this.setAttribute({name:"normal",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(P)}),this.setIndexBuffer({array:this.useUint16IndexArray?new Uint16Array(b):new Uint32Array(b),bufferFormat:this.useUint16IndexArray?"uint16":"uint32"})}}const cs=WebGLRenderingContext,ai=1179937895,Mt={JSON:1313821514,BIN:5130562},hi=[0,0,0],ui=[0,0,0,1],li=[1,1,1],di=new RegExp(`^${window.location.protocol}`,"i"),ci=/^data:/;class Ye{constructor(){this.gltf=null}static resolveUri(e,t){return e.match(di)||e.match(ci)?e:t+e}async loadFromUrl(e){const t=e.lastIndexOf("/"),s=t!==0?e.substring(0,t+1):"",i=await fetch(e);if(e.endsWith(".gltf"))return this.loadFromJson(await i.json(),s);if(e.endsWith(".glb"))return this.loadFromBinary(await i.arrayBuffer(),s);throw new Error("Unrecognized file extension")}async loadFromJsonBase(e,t,s=null){if(!t)throw new Error("baseUrl must be specified.");if(!e.asset)throw new Error("Missing asset description.");if(e.asset.minVersion!=="2.0"&&e.asset.version!=="2.0")throw new Error("Incompatible asset version.");for(const n of e.accessors)n.byteOffset=n.byteOffset??0,n.normalized=n.normalized??!1;for(const n of e.bufferViews)n.byteOffset=n.byteOffset??0;for(const n of e.nodes)n.matrix||(n.rotation=n.rotation??ui,n.scale=n.scale??li,n.translation=n.translation??hi);if(e.samplers)for(const n of e.samplers)n.wrapS=n.wrapS??cs.REPEAT,n.wrapT=n.wrapT??cs.REPEAT;const i=[];if(s)i.push(Promise.resolve(s));else for(const n in e.buffers){const o=e.buffers[n],h=Ye.resolveUri(o.uri,t);i[n]=fetch(h).then(u=>u.arrayBuffer())}const r=[];for(let n=0;n<e.images?.length;++n){const o=e.images[n];if(o.uri)r[n]=fetch(Ye.resolveUri(o.uri,t)).then(async h=>createImageBitmap(await h.blob()));else{const h=e.bufferViews[o.bufferView];r[n]=i[h.buffer].then(u=>{const l=new Blob([new Uint8Array(u,h.byteOffset,h.byteLength)],{type:o.mimeType});return createImageBitmap(l)})}}return{...e,arrayBuffers:await Promise.all(i),imagesBitmaps:await Promise.all(r)}}async loadFromBinary(e,t){const s=new DataView(e,0,12),i=s.getUint32(0,!0),r=s.getUint32(4,!0),n=s.getUint32(8,!0);if(i!==ai)throw new Error("Invalid magic string in binary header.");if(r!==2)throw new Error("Incompatible version in binary header.");const o={};let h=12;for(;h<n;){const d=new DataView(e,h,8),c=d.getUint32(0,!0),p=d.getUint32(4,!0);o[p]=e.slice(h+8,h+8+c),h+=c+8}if(!o[Mt.JSON])throw new Error("File contained no json chunk.");const l=new TextDecoder("utf-8").decode(o[Mt.JSON]);return this.loadFromJson(JSON.parse(l),t,o[Mt.BIN])}async loadFromJson(e,t,s=null){return this.gltf=await this.loadFromJsonBase(e,t,s),this.gltf}}const ps=(a,e=null)=>{const t=a.textures.find(S=>S.texture==="baseColorTexture"),s=a.textures.find(S=>S.texture==="normalTexture"),i=a.textures.find(S=>S.texture==="emissiveTexture"),r=a.textures.find(S=>S.texture==="occlusionTexture"),n=a.textures.find(S=>S.texture==="metallicRoughnessTexture"),o=a.attributes.filter(S=>S.name!=="position"),h=o.map((S,O)=>`@location(${O}) ${S.name}: ${S.type},`).join(`
	`);let u=`
  ...
  `,l=o.find(S=>S.name==="normal")?"vsOutput.normal = getWorldNormal(attributes.normal);":"";a.parameters.storages&&a.parameters.storages.instances&&(u=`
      let worldPos: vec4f = instances[attributes.instanceIndex].modelMatrix * vec4f(attributes.position, 1.0);
      vsOutput.position = camera.projection * camera.view * worldPos;
      vsOutput.worldPosition = worldPos.xyz;
      vsOutput.viewDirection = camera.position - vsOutput.worldPosition;
      `,l="vsOutput.normal = normalize((instances[attributes.instanceIndex].normalMatrix * vec4(attributes.normal, 0.0)).xyz);");const d=o.filter(S=>S.name!=="normal").map(S=>`vsOutput.${S.name} = attributes.${S.name};`).join(`
	`);let c=`
      @builtin(position) position: vec4f,
      @location(${o.length}) viewDirection: vec3f,
      @location(${o.length+1}) worldPosition: vec3f,
      ${h}
  `,p="";const g=o.find(S=>S.name==="tangent"),m=!!(s&&g);m&&(c+=`
  ...
  `,M="var color: vec4f = vec4();",P="return color;",v=a.attributes.find(S=>S.name==="color0");let T=v?v.type==="vec3f"?"var baseColor: vec4f = vec4(fsInput.color0, 1.0) * material.baseColorFactor;":"var baseColor: vec4f = fsInput.color0 * material.baseColorFactor;":"var baseColor: vec4f = material.baseColorFactor;";t&&(T=`
    ...
    `);let B="let normal: vec3f = normalize(fsInput.normal);";m&&(B=`
  ...
  `;i&&(R+=`
      emissive = textureSample(emissiveTexture, ${i.sampler}, fsInput.${i.texCoordAttributeName}).rgb * material.emissiveFactor;
      `,r&&(R+=`
  ...
  `;e?(e.ambientContribution||(e.ambientContribution=U),e.lightContribution||(e.lightContribution=H)):e={ambientContribution:U,lightContribution:H};const ee=`
  ...
  `;return{shaders:{vertex:{code:b,entryPoint:"main"},fragment:{code:ee,entryPoint:"main"}}}};var fs=(a,e,t)=>{if(!e.has(a))throw TypeError("Cannot "+t)},Bt=(a,e,t)=>(fs(a,e,"read from private field"),t?t.call(a):e.get(a)),pi=(a,e,t)=>{if(e.has(a))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(a):e.set(a,t)},fi=(a,e,t,s)=>(fs(a,e,"write to private field"),s?s.call(a,t):e.set(a,t),t),me;const _=WebGLRenderingContext,Xe=new A,mi=class ne{constructor({renderer:e,gltf:t}){pi(this,me,void 0),e=e&&e.renderer||e,Be(e,"GLTFScenesManager"),this.renderer=e,this.gltf=t,fi(this,me,new Map);const s=i=>[i.node,...i.children?.map(r=>[...s(r)]).flat()].flat();this.scenesManager={node:new se,boundingBox:new ie,samplers:[],materialsTextures:[],scenes:[],meshes:[],meshesDescriptors:[],getScenesNodes:()=>this.scenesManager.scenes.map(i=>s(i)).flat()},this.createSamplers(),this.createMaterialTextures(),this.createScenes()}static getVertexAttributeParamsFromType(e){switch(e){case"VEC2":return{type:"vec2f",bufferFormat:"float32x2",size:2};case"VEC3":return{type:"vec3f",bufferFormat:"float32x3",size:3};case"VEC4":return{type:"vec4f",bufferFormat:"float32x4",size:4};case"SCALAR":default:return{type:"f32",bufferFormat:"float32",size:1}}}static getTypedArrayConstructorFromComponentType(e){switch(e){case _.BYTE:return Int8Array;case _.UNSIGNED_BYTE:return Uint8Array;case _.SHORT:return Int16Array;case _.UNSIGNED_SHORT:return Uint16Array;case _.UNSIGNED_INT:return Uint32Array;case _.FLOAT:default:return Float32Array}}static gpuPrimitiveTopologyForMode(e){switch(e){case _.TRIANGLES:return"triangle-list";case _.TRIANGLE_STRIP:return"triangle-strip";case _.LINES:return"line-list";case _.LINE_STRIP:return"line-strip";case _.POINTS:return"point-list"}}static gpuAddressModeForWrap(e){switch(e){case _.CLAMP_TO_EDGE:return"clamp-to-edge";case _.MIRRORED_REPEAT:return"mirror-repeat";default:return"repeat"}}createSamplers(){if(this.gltf.samplers)for(const[e,t]of Object.entries(this.gltf.samplers)){const s={name:"gltfSampler"+e,addressModeU:ne.gpuAddressModeForWrap(t.wrapS),addressModeV:ne.gpuAddressModeForWrap(t.wrapT)};switch((!t.magFilter||t.magFilter===_.LINEAR)&&(s.magFilter="linear"),t.minFilter){case _.NEAREST:break;case _.LINEAR:case _.LINEAR_MIPMAP_NEAREST:s.minFilter="linear";break;case _.NEAREST_MIPMAP_LINEAR:s.mipmapFilter="linear";break;case _.LINEAR_MIPMAP_LINEAR:default:s.minFilter="linear",s.mipmapFilter="linear";break}this.scenesManager.samplers.push(new De(this.renderer,s))}else this.scenesManager.samplers.push(new De(this.renderer,{name:"gtlfSampler0"}))}createTexture(e,t,s){const i=(()=>{switch(s){case"baseColorTexture":case"emissiveTexture":return"bgra8unorm-srgb";case"occlusionTexture":return"r8unorm";default:return"bgra8unorm"}})(),r=new te(this.renderer,{label:e.name?e.name+": "+s:s,name:s,format:i,generateMips:!0,fixedSize:{width:t.width,height:t.height}});return r.uploadSource({source:t}),r}createMaterialTextures(){if(this.scenesManager.materialsTextures=[],this.gltf.materials)for(const[e,t]of Object.entries(this.gltf.materials)){const s={material:e,texturesDescriptors:[]},i=r=>r.texCoord&&r.texCoord!==0?"uv"+r.texCoord:"uv";if(this.scenesManager.materialsTextures[e]=s,t.pbrMetallicRoughness){if(t.pbrMetallicRoughness.baseColorTexture&&t.pbrMetallicRoughness.baseColorTexture.index!==void 0){const r=t.pbrMetallicRoughness.baseColorTexture.index,n=this.gltf.imagesBitmaps[this.gltf.textures[r].source],o=this.createTexture(t,n,"baseColorTexture"),h=this.gltf.textures.find(u=>u.source===r)?.sampler;s.texturesDescriptors.push({texture:o,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:i(t.pbrMetallicRoughness.baseColorTexture)})}if(t.pbrMetallicRoughness.metallicRoughnessTexture&&t.pbrMetallicRoughness.metallicRoughnessTexture.index!==void 0){const r=t.pbrMetallicRoughness.metallicRoughnessTexture.index,n=this.gltf.imagesBitmaps[this.gltf.textures[r].source],o=this.createTexture(t,n,"metallicRoughnessTexture"),h=this.gltf.textures.find(u=>u.source===r)?.sampler;s.texturesDescriptors.push({texture:o,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:i(t.pbrMetallicRoughness.metallicRoughnessTexture)})}}if(t.normalTexture&&t.normalTexture.index!==void 0){const r=t.normalTexture.index,n=this.gltf.imagesBitmaps[this.gltf.textures[r].source],o=this.createTexture(t,n,"normalTexture"),h=this.gltf.textures.find(u=>u.source===r)?.sampler;s.texturesDescriptors.push({texture:o,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:i(t.normalTexture)})}if(t.occlusionTexture&&t.occlusionTexture.index!==void 0){const r=t.occlusionTexture.index,n=this.gltf.imagesBitmaps[this.gltf.textures[r].source],o=this.createTexture(t,n,"occlusionTexture"),h=this.gltf.textures.find(u=>u.source===r)?.sampler;s.texturesDescriptors.push({texture:o,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:i(t.occlusionTexture)})}if(t.emissiveTexture&&t.emissiveTexture.index!==void 0){const r=t.emissiveTexture.index,n=this.gltf.imagesBitmaps[this.gltf.textures[r].source],o=this.createTexture(t,n,"emissiveTexture"),h=this.gltf.textures.find(u=>u.source===r)?.sampler;s.texturesDescriptors.push({texture:o,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:i(t.emissiveTexture)})}}}createNode(e,t){const s={name:t.name,node:new se,children:[]};e.children.push(s),s.node.parent=e.node,t.matrix?(s.node.modelMatrix.setFromArray(new Float32Array(t.matrix)),s.node.matrices.model.shouldUpdate=!1):(t.translation&&s.node.position.set(t.translation[0],t.translation[1],t.translation[2]),t.scale&&s.node.scale.set(t.scale[0],t.scale[1],t.scale[2]),t.rotation&&s.node.quaternion.setFromArray(new Float32Array(t.rotation)));const i=this.gltf.meshes[t.mesh];t.children&&t.children.forEach(r=>{const n=this.gltf.nodes[r];this.createNode(s,n)}),i&&i.primitives.forEach((r,n)=>{const o={parent:s.node,attributes:[],textures:[],parameters:{label:i.name?i.name+" "+n:"glTF mesh "+n},nodes:[]};let h=Bt(this,me).get(r);h||(h={instances:[],nodes:[],meshDescriptor:o},Bt(this,me).set(r,h)),h.instances.push(t),h.nodes.push(s.node)})}createScenes(){this.scenesManager.node.parent=this.renderer.scene,this.gltf.scenes.forEach(e=>{const t={name:e.name,children:[],node:new se};t.node.parent=this.scenesManager.node,this.scenesManager.scenes.push(t),e.nodes.forEach(s=>{const i=this.gltf.nodes[s];this.createNode(t,i)})}),this.scenesManager.scenes.forEach(e=>{e.node.shouldUpdateModelMatrix(),e.node.updateMatrixStack()});for(const[e,t]of Bt(this,me)){const{instances:s,nodes:i,meshDescriptor:r}=t,n=s.length;r.nodes=i,this.scenesManager.meshesDescriptors.push(r);const o=new ie,h=[];let u=null,l=null,d=0;for(const[M,P]of Object.entries(e.attributes)){const v=this.gltf.accessors[P],T=ne.getTypedArrayConstructorFromComponentType(v.componentType),B=this.gltf.bufferViews[v.bufferView],x=M==="TEXCOORD_0"?"uv":M.replace("_","").replace("TEXCOORD","uv").toLowerCase(),C=B.byteStride||0,R=v.byteOffset||0;C&&R&&R<C?d=Math.max(R,d):d=0,x==="position"&&(o.min.min(new f(v.min[0],v.min[1],v.min[2])),o.max.max(new f(v.max[0],v.max[1],v.max[2])),l=B);const z=ne.getVertexAttributeParamsFromType(v.type),U={name:x,...z,array:new T(this.gltf.arrayBuffers[B.buffer],v.byteOffset+B.byteOffset,v.count*z.size)};h.push(U),r.attributes.push({name:U.name,type:U.type})}if(d>0){const M=Object.values(e.attributes).map(P=>this.gltf.accessors[P].bufferView);if(M.every(P=>P===M[0]))u=new Float32Array(this.gltf.arrayBuffers[l.buffer],l.byteOffset,Math.ceil(l.byteLength/4)*4/Float32Array.BYTES_PER_ELEMENT);else{let P=0;const v={},T=Object.values(e.attributes).reduce((B,x)=>{const C=this.gltf.accessors[x],R=ne.getVertexAttributeParamsFromType(C.type).size;return v[C.bufferView]||(v[C.bufferView]=0),v[C.bufferView]=Math.max(v[C.bufferView],C.byteOffset+R*Float32Array.BYTES_PER_ELEMENT),P+=R*Float32Array.BYTES_PER_ELEMENT,B+C.count*R},0);u=new Float32Array(Math.ceil(T/4)*4),Object.values(e.attributes).forEach(B=>{const x=this.gltf.accessors[B],C=this.gltf.bufferViews[x.bufferView],R=ne.getVertexAttributeParamsFromType(x.type).size;for(let z=0;z<x.count;z++){const U=x.byteOffset/Float32Array.BYTES_PER_ELEMENT+z*P/Float32Array.BYTES_PER_ELEMENT;u.subarray(U,U+R).set(new Float32Array(this.gltf.arrayBuffers[C.buffer],C.byteOffset+x.byteOffset+z*v[x.bufferView],R))}})}}else{const M=["position","uv","normal"];h.sort((P,v)=>{let T=M.findIndex(x=>x===P.name);T=T===-1?1/0:T;let B=M.findIndex(x=>x===v.name);return B=B===-1?1/0:B,T-B})}const c={instancesCount:n,topology:ne.gpuPrimitiveTopologyForMode(e.mode),vertexBuffers:[{name:"attributes",stepMode:"vertex",attributes:h,...u&&{array:u}}]},p="indices"in e,g=p?be:nt;if(r.parameters.geometry=new g(c),r.parameters.geometry.boundingBox=o,p){const M=this.gltf.accessors[e.indices],P=this.gltf.bufferViews[M.bufferView],v=ne.getTypedArrayConstructorFromComponentType(M.componentType),T=M.byteOffset+P.byteOffset,B=this.gltf.arrayBuffers[P.buffer],x=Math.min((B.byteLength-T)/v.BYTES_PER_ELEMENT,Math.ceil(M.count/4)*4),C=v.name==="Uint8Array"?Uint16Array.from(new v(B,T,x)):new v(B,T,x);r.parameters.geometry.setIndexBuffer({bufferFormat:v.name==="Uint32Array"?"uint32":"uint16",array:C})}const m=this.scenesManager.materialsTextures[e.material];r.parameters.samplers=[],r.parameters.textures=[],m?.texturesDescriptors.forEach(M=>{r.textures.push({texture:M.texture.options.name,sampler:M.sampler.name,texCoordAttributeName:M.texCoordAttributeName}),r.parameters.samplers.find(v=>v.uuid===M.sampler.uuid)||r.parameters.samplers.push(M.sampler),r.parameters.textures.push(M.texture)});const y=this.gltf.materials&&this.gltf.materials[e.material]||{};r.parameters.cullMode=y.doubleSided?"none":"back",(y.alphaMode==="BLEND"||y.extensions&&y.extensions.KHR_materials_transmission)&&(r.parameters.transparent=!0,r.parameters.targets=[{blend:{color:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha"},alpha:{srcFactor:"one",dstFactor:"one"}}}]);const b={baseColorFactor:{type:"vec4f",value:y.pbrMetallicRoughness?.baseColorFactor||[1,1,1,1]},alphaCutoff:{type:"f32",value:y.alphaCutoff!==void 0?y.alphaCutoff:y.alphaMode==="MASK"?.5:0},metallicFactor:{type:"f32",value:y.pbrMetallicRoughness?.metallicFactor||0},roughnessFactor:{type:"f32",value:y.pbrMetallicRoughness?.roughnessFactor||1},normalMapScale:{type:"f32",value:y.normalTexture?.scale||1},occlusionStrength:{type:"f32",value:y.occlusionTexture?.strength||1},emissiveFactor:{type:"vec3f",value:y.emissiveFactor!==void 0?y.emissiveFactor:[1,1,1]}};if(Object.keys(b).length&&(r.parameters.uniforms={material:{visibility:["vertex","fragment"],struct:b}}),n>1){const M=new Float32Array(n*16),P=new Float32Array(n*16);for(let v=0;v<n;++v)M.set(i[v].worldMatrix.elements,v*16),Xe.copy(i[v].worldMatrix).invert().transpose(),P.set(Xe.elements,v*16);r.parameters.storages={instances:{visibility:["vertex","fragment"],struct:{modelMatrix:{type:"array<mat4x4f>",value:M},normalMatrix:{type:"array<mat4x4f>",value:P}}}}}for(let M=0;M<i.length;M++){const v=o.clone().applyMat4(r.nodes[M].worldMatrix);this.scenesManager.boundingBox.min.min(v.min),this.scenesManager.boundingBox.max.max(v.max)}}}addMeshes({patchMeshParameters:e=s=>{},setCustomMeshShaders:t=(s,{ambientContribution:i,lightContribution:r}=null)=>ps(s,{ambientContribution:i,lightContribution:r})}={}){this.scenesManager.meshesDescriptors.forEach(s=>{if(s.parameters.geometry){e(s.parameters);const i=t(s),r=new Kt(this.renderer,{...s.parameters,...i});if(s.nodes.length>1){const n=r.updateWorldMatrix.bind(r);r.updateWorldMatrix=()=>{n(),s.nodes.forEach((o,h)=>{r.storages.instances.modelMatrix.value.set(o.worldMatrix.elements,h*16),Xe.copy(o.worldMatrix).invert().transpose(),r.storages.instances.normalMatrix.value.set(Xe.elements,h*16)}),r.storages.instances.modelMatrix.shouldUpdate=!0,r.storages.instances.normalMatrix.shouldUpdate=!0}}r.parent=s.parent,this.scenesManager.meshes.push(r)}})}destroy(){this.scenesManager.meshes.forEach(t=>t.remove()),this.scenesManager.meshes=[],this.scenesManager.getScenesNodes().forEach(t=>{t.destroy()}),this.scenesManager.node.destroy()}};me=new WeakMap;let gi=mi;const yi=a=>{const{scene:e}=a;if(!e)return;const t=[];e.computePassEntries.forEach(s=>{t.push({command:"Render ComputePass",content:s.options.label}),s.material.bindGroups.forEach(i=>{i.bufferBindings.forEach(r=>{r.shouldCopyResult&&t.push({command:"Copy buffer to buffer",source:`${r.name} buffer`,destination:`${r.name} result buffer`})})})});for(const s in e.renderPassEntries){let i=0;e.renderPassEntries[s].forEach(r=>{if(!e.getRenderPassEntryLength(r))return;const n=r.renderPass.options.useColorAttachments?r.renderPass.options.colorAttachments.length===0&&r.renderPass.options.useDepth?`${r.renderTexture.options.label} depth pass`:r.renderPass.options.colorAttachments.length>1?`${r.renderTexture.options.label} multiple targets`:r.renderTexture?`${r.renderTexture.options.label}`:"Context current texture":void 0;let o=r.renderPass.options.label;const h={loadOp:r.renderPass.options.useColorAttachments?s==="screen"&&i>0?"load":r.renderPass.options.loadOp:void 0,depthLoadOp:void 0,sampleCount:r.renderPass.options.sampleCount,...r.renderPass.options.qualityRatio!==1&&{qualityRatio:r.renderPass.options.qualityRatio}};if(r.renderPass.options.useDepth&&(h.depthLoadOp=r.renderPass.options.depthLoadOp),i++,r.element)r.element.type==="ShaderPass"&&!(r.element.inputTarget||r.element.outputTarget)&&(t.push({command:"Copy texture to texture",source:n,destination:`${r.element.options.label} renderTexture`}),h.loadOp="clear"),o+=" "+JSON.stringify(h),t.push({command:`Render ${r.element.type}`,source:r.element.options.label,destination:n,descriptor:o}),r.element.type==="ShaderPass"&&!r.element.outputTarget&&r.element.options.copyOutputToRenderTexture?t.push({command:"Copy texture to texture",source:n,destination:`${r.element.options.label} renderTexture`}):r.element.type==="PingPongPlane"&&t.push({command:"Copy texture to texture",source:n,destination:`${r.element.renderTexture.options.label}`});else if(r.stack){o+=" "+JSON.stringify(h);for(const u in r.stack)for(const l in r.stack[u])r.stack[u][l].length&&t.push({command:`Render stack (${u} ${l} objects)`,source:r.stack[u][l],destination:n,descriptor:o})}})}console.table(t)};w.BindGroup=Re,w.Binding=Pe,w.Box3=ie,w.BoxGeometry=ni,w.Buffer=de,w.BufferBinding=ce,w.Camera=At,w.ComputeMaterial=_t,w.ComputePass=_s,w.ComputePipelineEntry=Zt,w.DOMElement=gt,w.DOMFrustum=kt,w.DOMMesh=us,w.DOMObject3D=as,w.DOMTexture=he,w.FullscreenPlane=dt,w.GLTFLoader=Ye,w.GLTFScenesManager=gi,w.GPUCameraRenderer=xt,w.GPUCurtains=ii,w.GPUCurtainsRenderer=qe,w.GPUDeviceManager=ss,w.GPURenderer=yt,w.Geometry=nt,w.IndexedGeometry=be,w.Mat3=re,w.Mat4=A,w.Material=rt,w.Mesh=Kt,w.Object3D=se,w.OrbitControls=ri,w.PingPongPlane=ei,w.PipelineEntry=pt,w.PipelineManager=Qt,w.Plane=ls,w.PlaneGeometry=ot,w.ProjectedObject3D=ct,w.Quat=Q,w.RenderMaterial=It,w.RenderPass=Ve,w.RenderPipelineEntry=ft,w.RenderTarget=ns,w.Sampler=De,w.SamplerBinding=Gt,w.Scene=Jt,w.ShaderPass=Qs,w.SphereGeometry=oi,w.Texture=te,w.TextureBindGroup=it,w.TextureBinding=st,w.Vec2=E,w.Vec3=f,w.WritableBufferBinding=tt,w.buildShaders=ps,w.logSceneCommands=yi});
