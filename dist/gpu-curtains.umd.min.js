(function(x,q){typeof exports=="object"&&typeof module<"u"?q(exports):typeof define=="function"&&define.amd?define(["exports"],q):(x=typeof globalThis<"u"?globalThis:x||self,q(x.window=x.window||{}))})(this,function(x){"use strict";const q=()=>"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,n=>{const e=Math.random()*16|0;return(n==="x"?e:e&3|8).toString(16).toUpperCase()}),rt=n=>n.replace(/(?:^\w|[A-Z]|\b\w)/g,(e,t)=>t===0?e.toLowerCase():e.toUpperCase()).replace(/\s+/g,""),nt=n=>{const e=rt(n);return e.charAt(0).toUpperCase()+e.slice(1)};let _i=0;const L=n=>{_i>100||(console.warn(_i===100?"GPUCurtains: too many warnings thrown, stop logging.":n),_i++)},te=n=>{throw new Error(n)},Gi=(n,e="GPURenderer",t)=>{const i=t?`Unable to create ${t} because the ${e} is not defined: ${n}`:`The ${e} is not defined: ${n}`;te(i)},k=(n,e)=>(n=n&&n.renderer||n,n&&(n.type==="GPURenderer"||n.type==="GPUCameraRenderer"||n.type==="GPUCurtainsRenderer")||Gi(n,"GPURenderer",e),n),De=(n,e)=>(n=n&&n.renderer||n,n&&(n.type==="GPUCameraRenderer"||n.type==="GPUCurtainsRenderer")||Gi(n,"GPUCameraRenderer",e),n),Ai=(n,e)=>(n=n&&n.renderer||n,n&&n.type==="GPUCurtainsRenderer"||Gi(n,"GPUCurtainsRenderer",e),n),Ln=n=>n.constructor.name==="Mesh"||n.constructor.name==="DOMMesh"||n.constructor.name==="Plane"?n:!1,Lt=(()=>{let n,e;const t={};return function(s,r){e||(e=s.createShaderModule({label:"textured quad shaders for mip level generation",code:`
            struct VSOutput {
          ...
          `}),n=s.createSampler({minFilter:"linear",magFilter:"linear"})),t[r.format]||(t[r.format]=s.createRenderPipeline({label:"Mip level generator pipeline",layout:"auto",vertex:{module:e},fragment:{module:e,targets:[{format:r.format}]}}));const o=t[r.format],a=s.createCommandEncoder({label:"Mip gen encoder"});let h=r.width,u=r.height,l=0;for(;h>1||u>1;){h=Math.max(1,h/2|0),u=Math.max(1,u/2|0);for(let p=0;p<r.depthOrArrayLayers;++p){const c=s.createBindGroup({layout:o.getBindGroupLayout(0),entries:[{binding:0,resource:n},{binding:1,resource:r.createView({dimension:"2d",baseMipLevel:l,mipLevelCount:1,baseArrayLayer:p,arrayLayerCount:1})}]}),m={label:"Mip generation render pass",colorAttachments:[{view:r.createView({dimension:"2d",baseMipLevel:l+1,mipLevelCount:1,baseArrayLayer:p,arrayLayerCount:1}),loadOp:"clear",storeOp:"store"}]},g=a.beginRenderPass(m);g.setPipeline(o),g.setBindGroup(0,c),g.draw(6),g.end()}++l}const d=a.finish();s.queue.submit([d])}})(),Di=typeof GPUShaderStage<"u"?GPUShaderStage:{VERTEX:1,FRAGMENT:2,COMPUTE:4},ve=typeof GPUBufferUsage<"u"?GPUBufferUsage:{MAP_READ:1,MAP_WRITE:2,COPY_SRC:4,COPY_DST:8,INDEX:16,VERTEX:32,UNIFORM:64,STORAGE:128,INDIRECT:256,QUERY_RESOLVE:512},ot=typeof GPUTextureUsage<"u"?GPUTextureUsage:{COPY_SRC:1,COPY_DST:2,TEXTURE_BINDING:4,STORAGE_BINDING:8,RENDER_ATTACHMENT:16},_n=new Map([["vertex",Di.VERTEX],["fragment",Di.FRAGMENT],["compute",Di.COMPUTE]]),Gn=(n=[])=>n.reduce((e,t)=>e|_n.get(t),0),An={i32:{numElements:1,align:4,size:4,type:"i32",View:Int32Array},u32:{numElements:1,align:4,size:4,type:"u32",View:Uint32Array},f32:{numElements:1,align:4,size:4,type:"f32",View:Float32Array},f16:{numElements:1,align:2,size:2,type:"u16",View:Uint16Array},vec2f:{numElements:2,align:8,size:8,type:"f32",View:Float32Array},vec2i:{numElements:2,align:8,size:8,type:"i32",View:Int32Array},vec2u:{numElements:2,align:8,size:8,type:"u32",View:Uint32Array},vec2h:{numElements:2,align:4,size:4,type:"u16",View:Uint16Array},vec3i:{numElements:3,align:16,size:12,type:"i32",View:Int32Array},vec3u:{numElements:3,align:16,size:12,type:"u32",View:Uint32Array},vec3f:{numElements:3,align:16,size:12,type:"f32",View:Float32Array},vec3h:{numElements:3,align:8,size:6,type:"u16",View:Uint16Array},vec4i:{numElements:4,align:16,size:16,type:"i32",View:Int32Array},vec4u:{numElements:4,align:16,size:16,type:"u32",View:Uint32Array},vec4f:{numElements:4,align:16,size:16,type:"f32",View:Float32Array},vec4h:{numElements:4,align:8,size:8,type:"u16",View:Uint16Array},mat2x2f:{numElements:4,align:8,size:16,type:"f32",View:Float32Array},mat2x2h:{numElements:4,align:4,size:8,type:"u16",View:Uint16Array},mat3x2f:{numElements:6,align:8,size:24,type:"f32",View:Float32Array},mat3x2h:{numElements:6,align:4,size:12,type:"u16",View:Uint16Array},mat4x2f:{numElements:8,align:8,size:32,type:"f32",View:Float32Array},mat4x2h:{numElements:8,align:4,size:16,type:"u16",View:Uint16Array},mat2x3f:{numElements:8,align:16,size:32,pad:[3,1],type:"f32",View:Float32Array},mat2x3h:{numElements:8,align:8,size:16,pad:[3,1],type:"u16",View:Uint16Array},mat3x3f:{numElements:12,align:16,size:48,pad:[3,1],type:"f32",View:Float32Array},mat3x3h:{numElements:12,align:8,size:24,pad:[3,1],type:"u16",View:Uint16Array},mat4x3f:{numElements:16,align:16,size:64,pad:[3,1],type:"f32",View:Float32Array},mat4x3h:{numElements:16,align:8,size:32,pad:[3,1],type:"u16",View:Uint16Array},mat2x4f:{numElements:8,align:16,size:32,type:"f32",View:Float32Array},mat2x4h:{numElements:8,align:8,size:16,type:"u16",View:Uint16Array},mat3x4f:{numElements:12,align:16,size:48,pad:[3,1],type:"f32",View:Float32Array},mat3x4h:{numElements:12,align:8,size:24,pad:[3,1],type:"u16",View:Uint16Array},mat4x4f:{numElements:16,align:16,size:64,type:"f32",View:Float32Array},mat4x4h:{numElements:16,align:8,size:32,type:"u16",View:Uint16Array}},Xs=n=>An[n],_t=n=>(()=>{switch(n.bindingType){case"storage":return`var<${n.bindingType}, ${n.options.access}>`;case"uniform":default:return"var<uniform>"}})(),Dn=n=>n.bindingType==="externalTexture"?`var ${n.name}: texture_external;`:n.bindingType==="storage"?`var ${n.name}: texture_storage_${n.options.viewDimension.replace("-","_")}<${n.options.format}, ${n.options.access}>;`:n.bindingType==="depth"?`var ${n.name}: texture_depth${n.options.multisampled?"_multisampled":""}_${n.options.viewDimension.replace("-","_")};`:`var ${n.name}: texture${n.options.multisampled?"_multisampled":""}_${n.options.viewDimension.replace("-","_")}<f32>;`,Ks=n=>n.bindingType==="storage"&&n.options.access==="read_write"?"storage":n.bindingType==="storage"?"read-only-storage":"uniform",On=n=>(()=>{switch(n.bindingType){case"externalTexture":return{externalTexture:{}};case"storage":return{storageTexture:{format:n.options.format,viewDimension:n.options.viewDimension}};case"texture":return{texture:{multisampled:n.options.multisampled,viewDimension:n.options.viewDimension,sampleType:n.options.multisampled?"unfilterable-float":"float"}};case"depth":return{texture:{multisampled:n.options.multisampled,viewDimension:n.options.viewDimension,sampleType:"depth"}};default:return null}})(),Fn=n=>(()=>{switch(n.bindingType){case"externalTexture":return`externalTexture,${n.visibility},`;case"storage":return`storageTexture,${n.options.format},${n.options.viewDimension},${n.visibility},`;case"texture":return`texture,${n.options.multisampled},${n.options.viewDimension},${n.options.multisampled?"unfilterable-float":"float"},${n.visibility},`;case"depth":return`depthTexture,${n.options.format},${n.options.viewDimension},${n.visibility},`;default:return`${n.visibility},`}})();class Gt{constructor({label:e="Uniform",name:t="uniform",bindingType:i="uniform",visibility:s=["vertex","fragment","compute"]}){this.label=e,this.name=rt(t),this.bindingType=i,this.visibility=Gn(s),this.options={label:e,name:t,bindingType:i,visibility:s},this.shouldResetBindGroup=!1,this.shouldResetBindGroupLayout=!1,this.cacheKey=`${i},${this.visibility},`}}class _{constructor(e=0,t=e){this.type="Vec2",this._x=e,this._y=t}get x(){return this._x}set x(e){const t=e!==this._x;this._x=e,t&&this._onChangeCallback&&this._onChangeCallback()}get y(){return this._y}set y(e){const t=e!==this._y;this._y=e,t&&this._onChangeCallback&&this._onChangeCallback()}onChange(e){return e&&(this._onChangeCallback=e),this}set(e=0,t=e){return this.x=e,this.y=t,this}add(e=new _){return this.x+=e.x,this.y+=e.y,this}addScalar(e=0){return this.x+=e,this.y+=e,this}sub(e=new _){return this.x-=e.x,this.y-=e.y,this}subScalar(e=0){return this.x-=e,this.y-=e,this}multiply(e=new _(1)){return this.x*=e.x,this.y*=e.y,this}multiplyScalar(e=1){return this.x*=e,this.y*=e,this}divide(e=new _(1)){return this.x/=e.x,this.y/=e.y,this}divideScalar(e=1){return this.x/=e,this.y/=e,this}copy(e=new _){return this.x=e.x,this.y=e.y,this}clone(){return new _(this.x,this.y)}max(e=new _){return this.x=Math.max(this.x,e.x),this.y=Math.max(this.y,e.y),this}min(e=new _){return this.x=Math.min(this.x,e.x),this.y=Math.min(this.y,e.y),this}clamp(e=new _,t=new _){return this.x=Math.max(e.x,Math.min(t.x,this.x)),this.y=Math.max(e.y,Math.min(t.y,this.y)),this}equals(e=new _){return this.x===e.x&&this.y===e.y}lengthSq(){return this.x*this.x+this.y*this.y}length(){return Math.sqrt(this.lengthSq())}normalize(){let e=this.x*this.x+this.y*this.y;return e>0&&(e=1/Math.sqrt(e)),this.x*=e,this.y*=e,this}dot(e=new _){return this.x*e.x+this.y*e.y}lerp(e=new _,t=1){return this.x+=(e.x-this.x)*t,this.y+=(e.y-this.y)*t,this}}class ce{constructor(e=new Float32Array([0,0,0,1]),t="XYZ"){this.type="Quat",this.elements=e,this.axisOrder=t}setFromArray(e=new Float32Array([0,0,0,1])){return this.elements[0]=e[0],this.elements[1]=e[1],this.elements[2]=e[2],this.elements[3]=e[3],this}setAxisOrder(e="XYZ"){switch(e=e.toUpperCase(),e){case"XYZ":case"YXZ":case"ZXY":case"ZYX":case"YZX":case"XZY":this.axisOrder=e;break;default:this.axisOrder="XYZ"}return this}copy(e=new ce){return this.elements=e.elements,this.axisOrder=e.axisOrder,this}clone(){return new ce().copy(this)}equals(e=new ce){return this.elements[0]===e.elements[0]&&this.elements[1]===e.elements[1]&&this.elements[2]===e.elements[2]&&this.elements[3]===e.elements[3]&&this.axisOrder===e.axisOrder}setFromVec3(e){const t=e.x*.5,i=e.y*.5,s=e.z*.5,r=Math.cos(t),o=Math.cos(i),a=Math.cos(s),h=Math.sin(t),u=Math.sin(i),l=Math.sin(s);return this.axisOrder==="XYZ"?(this.elements[0]=h*o*a+r*u*l,this.elements[1]=r*u*a-h*o*l,this.elements[2]=r*o*l+h*u*a,this.elements[3]=r*o*a-h*u*l):this.axisOrder==="YXZ"?(this.elements[0]=h*o*a+r*u*l,this.elements[1]=r*u*a-h*o*l,this.elements[2]=r*o*l-h*u*a,this.elements[3]=r*o*a+h*u*l):this.axisOrder==="ZXY"?(this.elements[0]=h*o*a-r*u*l,this.elements[1]=r*u*a+h*o*l,this.elements[2]=r*o*l+h*u*a,this.elements[3]=r*o*a-h*u*l):this.axisOrder==="ZYX"?(this.elements[0]=h*o*a-r*u*l,this.elements[1]=r*u*a+h*o*l,this.elements[2]=r*o*l-h*u*a,this.elements[3]=r*o*a+h*u*l):this.axisOrder==="YZX"?(this.elements[0]=h*o*a+r*u*l,this.elements[1]=r*u*a+h*o*l,this.elements[2]=r*o*l-h*u*a,this.elements[3]=r*o*a-h*u*l):this.axisOrder==="XZY"&&(this.elements[0]=h*o*a-r*u*l,this.elements[1]=r*u*a-h*o*l,this.elements[2]=r*o*l+h*u*a,this.elements[3]=r*o*a+h*u*l),this}setFromAxisAngle(e,t=0){const i=t/2,s=Math.sin(i);return this.elements[0]=e.x*s,this.elements[1]=e.y*s,this.elements[2]=e.z*s,this.elements[3]=Math.cos(i),this}setFromRotationMatrix(e){const t=e.elements,i=t[0],s=t[4],r=t[8],o=t[1],a=t[5],h=t[9],u=t[2],l=t[6],d=t[10],p=i+a+d;if(p>0){const c=.5/Math.sqrt(p+1);this.elements[3]=.25/c,this.elements[0]=(l-h)*c,this.elements[1]=(r-u)*c,this.elements[2]=(o-s)*c}else if(i>a&&i>d){const c=2*Math.sqrt(1+i-a-d);this.elements[3]=(l-h)/c,this.elements[0]=.25*c,this.elements[1]=(s+o)/c,this.elements[2]=(r+u)/c}else if(a>d){const c=2*Math.sqrt(1+a-i-d);this.elements[3]=(r-u)/c,this.elements[0]=(s+o)/c,this.elements[1]=.25*c,this.elements[2]=(h+l)/c}else{const c=2*Math.sqrt(1+d-i-a);this.elements[3]=(o-s)/c,this.elements[0]=(r+u)/c,this.elements[1]=(h+l)/c,this.elements[2]=.25*c}return this}}class f{constructor(e=0,t=e,i=e){this.type="Vec3",this._x=e,this._y=t,this._z=i}get x(){return this._x}set x(e){const t=e!==this._x;this._x=e,t&&this._onChangeCallback&&this._onChangeCallback()}get y(){return this._y}set y(e){const t=e!==this._y;this._y=e,t&&this._onChangeCallback&&this._onChangeCallback()}get z(){return this._z}set z(e){const t=e!==this._z;this._z=e,t&&this._onChangeCallback&&this._onChangeCallback()}onChange(e){return e&&(this._onChangeCallback=e),this}set(e=0,t=e,i=e){return this.x=e,this.y=t,this.z=i,this}add(e=new f){return this.x+=e.x,this.y+=e.y,this.z+=e.z,this}addScalar(e=0){return this.x+=e,this.y+=e,this.z+=e,this}sub(e=new f){return this.x-=e.x,this.y-=e.y,this.z-=e.z,this}subScalar(e=0){return this.x-=e,this.y-=e,this.z-=e,this}multiply(e=new f(1)){return this.x*=e.x,this.y*=e.y,this.z*=e.z,this}multiplyScalar(e=1){return this.x*=e,this.y*=e,this.z*=e,this}divide(e=new f(1)){return this.x/=e.x,this.y/=e.y,this.z/=e.z,this}divideScalar(e=1){return this.x/=e,this.y/=e,this.z/=e,this}copy(e=new f){return this.x=e.x,this.y=e.y,this.z=e.z,this}clone(){return new f(this.x,this.y,this.z)}max(e=new f){return this.x=Math.max(this.x,e.x),this.y=Math.max(this.y,e.y),this.z=Math.max(this.z,e.z),this}min(e=new f){return this.x=Math.min(this.x,e.x),this.y=Math.min(this.y,e.y),this.z=Math.min(this.z,e.z),this}clamp(e=new f,t=new f){return this.x=Math.max(e.x,Math.min(t.x,this.x)),this.y=Math.max(e.y,Math.min(t.y,this.y)),this.z=Math.max(e.z,Math.min(t.z,this.z)),this}equals(e=new f){return this.x===e.x&&this.y===e.y&&this.z===e.z}lengthSq(){return this.x*this.x+this.y*this.y+this.z*this.z}length(){return Math.sqrt(this.lengthSq())}distance(e=new f){return Math.hypot(e.x-this.x,e.y-this.y,e.z-this.z)}normalize(){let e=this.lengthSq();return e>0&&(e=1/Math.sqrt(e)),this.x*=e,this.y*=e,this.z*=e,this}dot(e=new f){return this.x*e.x+this.y*e.y+this.z*e.z}cross(e=new f){return this.crossVectors(this,e)}crossVectors(e=new f,t=new f){const i=e.x,s=e.y,r=e.z,o=t.x,a=t.y,h=t.z;return this.x=s*h-r*a,this.y=r*o-i*h,this.z=i*a-s*o,this}lerp(e=new f,t=1){return this.x+=(e.x-this.x)*t,this.y+=(e.y-this.y)*t,this.z+=(e.z-this.z)*t,this}applyMat4(e){const t=this._x,i=this._y,s=this._z,r=e.elements;let o=r[3]*t+r[7]*i+r[11]*s+r[15];return o=o||1,this.x=(r[0]*t+r[4]*i+r[8]*s+r[12])/o,this.y=(r[1]*t+r[5]*i+r[9]*s+r[13])/o,this.z=(r[2]*t+r[6]*i+r[10]*s+r[14])/o,this}setFromMatrixPosition(e){const t=e.elements;return this.x=t[12],this.y=t[13],this.z=t[14],this}applyQuat(e=new ce){const t=this.x,i=this.y,s=this.z,r=e.elements[0],o=e.elements[1],a=e.elements[2],h=e.elements[3],u=h*t+o*s-a*i,l=h*i+a*t-r*s,d=h*s+r*i-o*t,p=-r*t-o*i-a*s;return this.x=u*h+p*-r+l*-a-d*-o,this.y=l*h+p*-o+d*-r-u*-a,this.z=d*h+p*-a+u*-o-l*-r,this}applyAxisAngle(e=new f,t=0,i=new ce){return this.applyQuat(i.setFromAxisAngle(e,t))}transformDirection(e){const t=this.x,i=this.y,s=this.z,r=e.elements;return this.x=r[0]*t+r[4]*i+r[8]*s,this.y=r[1]*t+r[5]*i+r[9]*s,this.z=r[2]*t+r[6]*i+r[10]*s,this.normalize()}project(e){return this.applyMat4(e.viewMatrix).applyMat4(e.projectionMatrix),this}unproject(e){return this.applyMat4(e.projectionMatrix.getInverse()).applyMat4(e.modelMatrix),this}}const $n=4,At=4,Z=$n*At;class pe{constructor({name:e,key:t,type:i="f32"}){this.name=e,this.key=t,this.type=i,this.baseType=pe.getBaseType(this.type),this.bufferLayout=Xs(this.baseType),this.alignment={start:{row:0,byte:0},end:{row:0,byte:0}},this.setValue=null}static getType(e){return e.replace("array","").replace("<","").replace(">","")}static getBaseType(e){return pe.getType(e.replace("atomic","").replace("array","").replaceAll("<","").replaceAll(">",""))}get rowCount(){return this.alignment.end.row-this.alignment.start.row+1}get byteCount(){return Math.abs(this.endOffset-this.startOffset)+1}get paddedByteCount(){return(this.alignment.end.row+1)*Z}get startOffset(){return this.getByteCountAtPosition(this.alignment.start)}get startOffsetToIndex(){return this.startOffset/At}get endOffset(){return this.getByteCountAtPosition(this.alignment.end)}get endOffsetToIndex(){return Math.floor(this.endOffset/At)}getPositionAtOffset(e=0){return{row:Math.floor(e/Z),byte:e%Z}}getByteCountAtPosition(e={row:0,byte:0}){return e.row*Z+e.byte}applyOverflowToPosition(e={row:0,byte:0}){if(e.byte>Z-1){const t=e.byte%Z;e.row+=Math.floor(e.byte/Z),e.byte=t}return e}getByteCountBetweenPositions(e={row:0,byte:0},t={row:0,byte:0}){return Math.abs(this.getByteCountAtPosition(t)-this.getByteCountAtPosition(e))}getElementAlignment(e={row:0,byte:0}){const t={start:e,end:e},{size:i,align:s}=this.bufferLayout;return e.byte%s!==0&&(e.byte+=e.byte%s),(i<=Z&&e.byte+i>Z||i>Z&&(e.byte>Z||e.byte>0))&&(e.row+=1,e.byte=0),t.end={row:e.row+Math.ceil(i/Z)-1,byte:e.byte+(i%Z===0?Z-1:i%Z-1)},t.end=this.applyOverflowToPosition(t.end),t}setAlignmentFromPosition(e={row:0,byte:0}){this.alignment=this.getElementAlignment(e)}setAlignment(e=0){this.setAlignmentFromPosition(this.getPositionAtOffset(e))}setView(e,t){this.view=new this.bufferLayout.View(e,this.startOffset,this.byteCount/this.bufferLayout.View.BYTES_PER_ELEMENT)}setValueFromFloat(e){this.view[0]=e}setValueFromVec2(e){this.view[0]=e.x??e[0]??0,this.view[1]=e.y??e[1]??0}setValueFromVec3(e){this.view[0]=e.x??e[0]??0,this.view[1]=e.y??e[1]??0,this.view[2]=e.z??e[2]??0}setValueFromMat4OrQuat(e){this.view.set(e.elements)}setValueFromMat3(e){this.setValueFromArrayWithPad(e.elements)}setValueFromArray(e){this.view.set(e)}setValueFromArrayWithPad(e){for(let t=0,i=0;t<this.view.length;t+=this.bufferLayout.pad[0]+this.bufferLayout.pad[1],i++)for(let s=0;s<this.bufferLayout.pad[0];s++)this.view[t+s]=e[t+s-i]}update(e){this.setValue||(this.setValue=(t=>{if(this.baseType==="f32"||this.baseType==="u32"||this.baseType==="i32")return this.setValueFromFloat;if(this.baseType==="vec2f")return this.setValueFromVec2;if(this.baseType==="vec3f")return this.setValueFromVec3;if(this.baseType==="mat3x3f")return t.elements?this.setValueFromMat3:this.setValueFromArrayWithPad;if(t.elements)return this.setValueFromMat4OrQuat;if(ArrayBuffer.isView(t)||Array.isArray(t))return this.bufferLayout.pad?this.setValueFromArrayWithPad:this.setValueFromArray;L(`${this.constructor.name}: value passed to ${this.name} cannot be used: ${t}`)})(e)),this.setValue(e)}extractDataFromBufferResult(e){return e.slice(this.startOffsetToIndex,this.endOffsetToIndex)}}class Zs extends pe{constructor({name:e,key:t,type:i="f32",arrayLength:s=1}){super({name:e,key:t,type:i}),this.arrayLength=s,this.numElements=Math.ceil(this.arrayLength/this.bufferLayout.numElements)}get arrayStrideToIndex(){return this.arrayStride/At}setAlignment(e=0){super.setAlignment(e);const t=this.getElementAlignment(this.getPositionAtOffset(this.endOffset+1));this.arrayStride=this.getByteCountBetweenPositions(this.alignment.end,t.end),this.alignment.end=this.getPositionAtOffset(this.endOffset+this.arrayStride*(this.numElements-1))}setValueFromArray(e){let t=0;const i=this.byteCount/this.bufferLayout.View.BYTES_PER_ELEMENT,s=Math.ceil(i/this.numElements);for(let r=0;r<this.numElements;r++)for(let o=0;o<this.bufferLayout.numElements;o++)this.view[o+r*s]=e[t],t++}}class Oi extends Zs{constructor({name:e,key:t,type:i="f32",arrayLength:s=1}){super({name:e,key:t,type:i,arrayLength:s}),this.arrayStride=1,this.arrayLength=s,this.numElements=Math.ceil(this.arrayLength/this.bufferLayout.numElements)}get byteCount(){return this.bufferLayout.size*this.numElements}setAlignment(e=0,t=0){this.alignment=this.getElementAlignment(this.getPositionAtOffset(e)),this.arrayStride=t,this.alignment.end=this.getPositionAtOffset(this.endOffset+t*(this.numElements-1))}setView(e,t){this.view=new this.bufferLayout.View(this.bufferLayout.numElements*this.numElements),this.viewSetFunction=(i=>{switch(this.bufferLayout.View){case Int32Array:return i.setInt32.bind(i);case Uint16Array:return i.setUint16.bind(i);case Uint32Array:return i.setUint32.bind(i);case Float32Array:default:return i.setFloat32.bind(i)}})(t)}update(e){super.update(e);for(let t=0;t<this.numElements;t++){const i=this.view.subarray(t*this.bufferLayout.numElements,t*this.bufferLayout.numElements+this.bufferLayout.numElements),s=this.startOffset+t*this.arrayStride;i.forEach((r,o)=>{this.viewSetFunction(s+o*this.bufferLayout.View.BYTES_PER_ELEMENT,r,!0)})}}extractDataFromBufferResult(e){const t=new Float32Array(this.arrayLength);for(let i=0;i<this.numElements;i++){const s=this.startOffsetToIndex+i*this.arrayStrideToIndex;for(let r=0;r<this.bufferLayout.numElements;r++)t[i*this.bufferLayout.numElements+r]=e[s+r]}return t}}const Un=new Map([["copySrc",ve.COPY_SRC],["copyDst",ve.COPY_DST],["index",ve.INDEX],["indirect",ve.INDIRECT],["mapRead",ve.MAP_READ],["mapWrite",ve.MAP_WRITE],["queryResolve",ve.QUERY_RESOLVE],["storage",ve.STORAGE],["uniform",ve.UNIFORM],["vertex",ve.VERTEX]]),Js=(n=[])=>n.reduce((e,t)=>e|Un.get(t),0);class Oe{constructor({label:e="Buffer",size:t=0,usage:i=["copySrc","copyDst"],mappedAtCreation:s=!1}={}){this.type="Buffer",this.reset(),this.uuid=q(),this.consumers=new Set,this.options={label:e,size:t,usage:Js(i),mappedAtCreation:s}}reset(){this.GPUBuffer=null}set size(e){this.options.size=e}createBuffer(e,t={}){const{usage:i,...s}=t;this.options={...this.options,...s,...i!==void 0&&{usage:Js(i)}},this.setBuffer(e.createBuffer(this))}setBuffer(e){this.GPUBuffer=e}copy(e,t=!1){t&&this.destroy(),this.options=e.options,this.GPUBuffer=e.GPUBuffer,this.consumers=new Set([...this.consumers,...e.consumers])}async mapBufferAsync(){if(!this.GPUBuffer||this.GPUBuffer.mapState!=="unmapped")return new Float32Array(0);await this.GPUBuffer.mapAsync(GPUMapMode.READ);const e=new Float32Array(this.GPUBuffer.getMappedRange().slice(0));return this.GPUBuffer.unmap(),e}destroy(){this.GPUBuffer?.destroy(),this.reset(),this.consumers.clear()}}var Qs=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},kn=(n,e,t)=>(Qs(n,e,"read from private field"),t?t.call(n):e.get(n)),In=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},Vn=(n,e,t,i)=>(Qs(n,e,"write to private field"),e.set(n,t),t),Dt;const Nn=class Li extends Gt{constructor({label:e="Uniform",name:t="uniform",bindingType:i,visibility:s,useStruct:r=!0,access:o="read",usage:a=[],struct:h={},childrenBindings:u=[],buffer:l=null,parent:d=null,minOffset:p=256,offset:c=0}){i=i??"uniform",super({label:e,name:t,bindingType:i,visibility:s}),In(this,Dt,void 0),this.options={...this.options,useStruct:r,access:o,usage:a,struct:h,childrenBindings:u,buffer:l,parent:d,minOffset:p,offset:c},this.cacheKey+=`${r},${o},`,this.arrayBufferSize=0,this.shouldUpdate=!1,this.useStruct=r,this.bufferElements=[],this.inputs={},this.buffer=this.options.buffer??new Oe,Object.keys(h).length&&(this.setBindings(h),this.setInputsAlignment()),this.setChildrenBindings(u),(Object.keys(h).length||this.childrenBindings.length)&&(this.setBufferAttributes(),this.setWGSLFragment()),this.parent=d}static cloneStruct(e){return Object.keys(e).reduce((t,i)=>{const s=e[i];let r;return Array.isArray(s.value)||ArrayBuffer.isView(s.value)?r=new s.value.constructor(s.value.length):typeof s.value=="number"?r=0:r=new s.value.constructor,{...t,[i]:{type:s.type,value:r}}},{})}get parent(){return kn(this,Dt)}set parent(e){if(e){this.parentView=new DataView(e.arrayBuffer,this.offset,this.getMinOffsetSize(this.arrayBufferSize));const t=s=>[...(o=>o.bufferElements)(s),s.childrenBindings.map(o=>t(o)).flat()].flat(),i=t(this);this.parentViewSetBufferEls=i.map(s=>{switch(s.bufferLayout.View){case Int32Array:return{bufferElement:s,viewSetFunction:this.parentView.setInt32.bind(this.parentView)};case Uint16Array:return{bufferElement:s,viewSetFunction:this.parentView.setUint16.bind(this.parentView)};case Uint32Array:return{bufferElement:s,viewSetFunction:this.parentView.setUint32.bind(this.parentView)};case Float32Array:default:return{bufferElement:s,viewSetFunction:this.parentView.setFloat32.bind(this.parentView)}}}),!this.parent&&this.buffer.GPUBuffer&&!this.options.buffer&&this.buffer.destroy()}else this.parentView=null,this.parentViewSetBufferEls=null;Vn(this,Dt,e)}getMinOffsetSize(e){return Math.ceil(e/this.options.minOffset)*this.options.minOffset}get offset(){return this.getMinOffsetSize(this.options.offset*this.getMinOffsetSize(this.arrayBufferSize))}get resourceLayout(){return{buffer:{type:Ks(this)},...this.parent&&{offset:this.offset,size:this.arrayBufferSize}}}get resourceLayoutCacheKey(){return`buffer,${Ks(this)},${this.visibility},`}get resource(){return{buffer:this.parent?this.parent.buffer.GPUBuffer:this.buffer.GPUBuffer,...this.parent&&{offset:this.offset,size:this.arrayBufferSize}}}clone(e={}){let{struct:t,childrenBindings:i,parent:s,...r}=e;const{label:o,name:a,bindingType:h,visibility:u,useStruct:l,access:d,usage:p}=this.options;r={label:o,name:a,bindingType:h,visibility:u,useStruct:l,access:d,usage:p,...r};const c=new this.constructor(r);return t=t||Li.cloneStruct(this.options.struct),c.options.struct=t,c.setBindings(t),c.arrayBufferSize=this.arrayBufferSize,c.arrayBuffer=new ArrayBuffer(c.arrayBufferSize),c.arrayView=new DataView(c.arrayBuffer,0,c.arrayBuffer.byteLength),c.options.buffer||(c.buffer.size=c.arrayBuffer.byteLength),this.bufferElements.forEach(m=>{const g=new m.constructor({name:m.name,key:m.key,type:m.type,...m.arrayLength&&{arrayLength:m.arrayLength}});g.alignment=JSON.parse(JSON.stringify(m.alignment)),m.arrayStride&&(g.arrayStride=m.arrayStride),g.setView(c.arrayBuffer,c.arrayView),c.bufferElements.push(g)}),this.options.childrenBindings&&(c.options.childrenBindings=this.options.childrenBindings,c.options.childrenBindings.forEach(m=>{const g=m.count?Math.max(1,m.count):1;c.cacheKey+=`child(count:${g}):${m.binding.cacheKey}`}),c.options.childrenBindings.forEach(m=>{c.childrenBindings=[...c.childrenBindings,Array.from(Array(Math.max(1,m.count||1)).keys()).map(g=>m.binding.clone({...m.binding.options,struct:Li.cloneStruct(m.binding.options.struct)}))].flat()}),c.childrenBindings.forEach((m,g)=>{let y=this.arrayView.byteLength;for(let v=0;v<g;v++)y+=this.childrenBindings[v].arrayBuffer.byteLength;m.bufferElements.forEach((v,M)=>{v.alignment.start.row=this.childrenBindings[g].bufferElements[M].alignment.start.row,v.alignment.end.row=this.childrenBindings[g].bufferElements[M].alignment.end.row}),m.arrayView=new DataView(c.arrayBuffer,y,m.arrayBuffer.byteLength);for(const v of m.bufferElements)v.setView(c.arrayBuffer,m.arrayView)})),c.setWGSLFragment(),s&&(c.parent=s),c.shouldUpdate=c.arrayBufferSize>0,c}setBindings(e){for(const t of Object.keys(e)){const i={};for(const s in e[t])s!=="value"&&(i[s]=e[t][s]);if(i.name=t,Object.defineProperty(i,"value",{get(){return i._value},set(s){i._value=s,i.shouldUpdate=!0}}),i.value=e[t].value,i.value instanceof _||i.value instanceof f){const s=i.value._onChangeCallback;i.value._onChangeCallback=()=>{s&&s(),i.shouldUpdate=!0}}this.inputs[t]=i,this.cacheKey+=`${t},${e[t].type},`}}setChildrenBindings(e){if(this.childrenBindings=[],e&&e.length){const t=[];e.sort((i,s)=>{const r=i.count?Math.max(i.count):i.forceArray?1:0,o=s.count?Math.max(s.count):s.forceArray?1:0;return r-o}).forEach(i=>{(i.count&&i.count>1||i.forceArray)&&t.push(i.binding)}),t.length>1&&(t.shift(),L(`BufferBinding: "${this.label}" contains multiple children bindings arrays. These children bindings cannot be added to the BufferBinding: "${t.map(i=>i.label).join(", ")}"`),t.forEach(i=>{e=e.filter(s=>s.binding.name!==i.name)})),this.options.childrenBindings=e,e.forEach(i=>{const s=i.count?Math.max(1,i.count):1;this.cacheKey+=`child(count:${s}):${i.binding.cacheKey}`,this.childrenBindings=[...this.childrenBindings,Array.from(Array(s).keys()).map(r=>i.binding.clone({...i.binding.options,struct:Li.cloneStruct(i.binding.options.struct)}))].flat()})}}setInputsAlignment(){let e=Object.keys(this.inputs);const t=e.filter(i=>this.inputs[i].type.includes("array"));t.length&&(e.sort((i,s)=>{const r=Math.min(0,this.inputs[i].type.indexOf("array")),o=Math.min(0,this.inputs[s].type.indexOf("array"));return r-o}),t.length>1&&(e=e.filter(i=>!t.includes(i))));for(const i of e){const s=this.inputs[i],r={name:rt(s.name??i),key:i,type:s.type},o=s.type.includes("array")&&(Array.isArray(s.value)||ArrayBuffer.isView(s.value));this.bufferElements.push(o?new Zs({...r,arrayLength:s.value.length}):new pe(r))}if(this.bufferElements.forEach((i,s)=>{const r=s===0?0:this.bufferElements[s-1].endOffset+1;i.setAlignment(r)}),t.length>1)if(t.map(r=>{const o=this.inputs[r],a=Xs(pe.getBaseType(o.type));return Math.ceil(o.value.length/a.numElements)}).every((r,o,a)=>r===a[0])){const r=t.map(h=>{const u=this.inputs[h];return new Oi({name:rt(u.name??h),key:h,type:u.type,arrayLength:u.value.length})}),o=t.map(h=>{const u=this.inputs[h];return new pe({name:rt(u.name??h),key:h,type:pe.getType(u.type)})});o.forEach((h,u)=>{u===0?this.bufferElements.length?h.setAlignmentFromPosition({row:this.bufferElements[this.bufferElements.length-1].alignment.end.row+1,byte:0}):h.setAlignment(0):h.setAlignment(o[u-1].endOffset+1)});const a=o[o.length-1].endOffset+1-o[0].startOffset;r.forEach((h,u)=>{h.setAlignment(o[u].startOffset,Math.ceil(a/Z)*Z)}),this.bufferElements=[...this.bufferElements,...r]}else L(`BufferBinding: "${this.label}" contains multiple array inputs that should use an interleaved array, but their sizes do not match. These inputs cannot be added to the BufferBinding: "${t.join(", ")}"`)}setBufferAttributes(){const e=this.bufferElements.length?this.bufferElements[this.bufferElements.length-1].paddedByteCount:0;this.arrayBufferSize=e,this.childrenBindings.forEach(t=>{this.arrayBufferSize+=t.arrayBufferSize}),this.arrayBuffer=new ArrayBuffer(this.arrayBufferSize),this.arrayView=new DataView(this.arrayBuffer,0,e),this.childrenBindings.forEach((t,i)=>{let s=e;for(let a=0;a<i;a++)s+=this.childrenBindings[a].arrayBuffer.byteLength;const r=this.bufferElements.length?this.bufferElements[this.bufferElements.length-1].alignment.end.row+1:0,o=i>0&&this.childrenBindings[i-1].bufferElements.length?this.childrenBindings[i-1].bufferElements[this.childrenBindings[i-1].bufferElements.length-1].alignment.end.row+1:0;t.bufferElements.forEach(a=>{const h=i===0?r+o:o;a.alignment.start.row+=h,a.alignment.end.row+=h}),t.arrayView=new DataView(this.arrayBuffer,s,t.arrayBuffer.byteLength);for(const a of t.bufferElements)a.setView(this.arrayBuffer,t.arrayView)}),this.options.buffer||(this.buffer.size=this.arrayBuffer.byteLength);for(const t of this.bufferElements)t.setView(this.arrayBuffer,this.arrayView);this.shouldUpdate=this.arrayBufferSize>0}setWGSLFragment(){if(!this.bufferElements.length&&!this.childrenBindings.length)return;const e=nt(this.label);if(this.useStruct){const t={};t[e]={};const i=this.bufferElements.filter(o=>!(o instanceof Oi)),s=this.bufferElements.filter(o=>o instanceof Oi);if(s.length){const o=this.bindingType==="uniform"?`, ${s[0].numElements}`:"";if(i.length){t[`${e}Element`]={},s.forEach(u=>{t[`${e}Element`][u.name]=pe.getType(u.type)}),i.forEach(u=>{t[e][u.name]=u.type});const a=this.bufferElements.find(u=>u.name==="elements")?`${this.name}Elements`:"elements";t[e][a]=`array<${e}Element${o}>`;const h=_t(this);this.wgslGroupFragment=[`${h} ${this.name}: ${e};`]}else{this.bufferElements.forEach(h=>{t[e][h.name]=pe.getType(h.type)});const a=_t(this);this.wgslGroupFragment=[`${a} ${this.name}: array<${e}${o}>;`]}}else{i.forEach(a=>{const h=this.bindingType==="uniform"&&"numElements"in a?`array<${pe.getType(a.type)}, ${a.numElements}>`:a.type;t[e][a.name]=h});const o=_t(this);this.wgslGroupFragment=[`${o} ${this.name}: ${e};`]}this.childrenBindings.length&&this.options.childrenBindings.forEach(o=>{t[e][o.binding.name]=o.count&&o.count>1||o.forceArray?`array<${nt(o.binding.label)}>`:nt(o.binding.label)});const r=this.childrenBindings.length?this.options.childrenBindings.map(o=>o.binding.wgslStructFragment).join(`
...
`;const ke={vertex:{get_uv_cover:yr},fragment:{get_uv_cover:yr,get_vertex_to_uv_coords:ho}},Ie={vertex:{get_output_position:oo,get_normals:ao},fragment:{}};class qe extends ji{constructor(e){let{renderer:t,...i}=e;const{label:s,attributes:r,bindGroups:o,cacheKey:a,...h}=i,u="RenderPipelineEntry";k(t,s?s+" "+u:u),super(e),this.type=u,this.shaders={vertex:{head:"",code:"",module:null},fragment:{head:"",code:"",module:null},full:{head:"",code:"",module:null}},this.descriptor=null,this.options={...this.options,attributes:r,...h},this.attributes=r}patchShaders(){this.shaders.vertex.head="",this.shaders.vertex.code="",this.shaders.fragment.head="",this.shaders.fragment.code="",this.shaders.full.head="",this.shaders.full.code="";for(const t in ke.vertex)this.shaders.vertex.head=`${ke.vertex[t]}
${this.shaders.vertex.head}`,this.shaders.full.head=`${ke.vertex[t]}
${this.shaders.full.head}`;if(this.options.shaders.fragment)for(const t in ke.fragment)this.shaders.fragment.head=`${ke.fragment[t]}
${this.shaders.fragment.head}`,this.shaders.full.head.indexOf(ke.fragment[t])===-1&&(this.shaders.full.head=`${ke.fragment[t]}
${this.shaders.full.head}`);if(this.options.rendering.useProjection){for(const t in Ie.vertex)this.shaders.vertex.head=`${Ie.vertex[t]}
...
`,Br=n=>{const e=n.shadowCastingLights.filter(i=>i.type==="directionalLights"),t=Math.max(n.lightsBindingParams.directionalLights.max,1);return`
...
fn getPCFPointShadowContribution(index: i32, shadowPosition: vec4f, depthCubeTexture: texture_depth_cube) -> f32 {
  ...
  return visibility;
}`,Tr=n=>{const e=n.shadowCastingLights.filter(i=>i.type==="pointLights"),t=Math.max(n.lightsBindingParams.pointLights.max,1);return`
...
`;var Ki=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},j=(n,e,t)=>(Ki(n,e,"read from private field"),t?t.call(n):e.get(n)),Be=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},re=(n,e,t,i)=>(Ki(n,e,"write to private field"),e.set(n,t),t),Pr=(n,e,t)=>(Ki(n,e,"access private method"),t),Jt,Qt,ei,ti,ii,pt,Ye,ne,Re,si,Zi;const Rr={isActive:{type:"i32",value:0},pcfSamples:{type:"i32",value:0},bias:{type:"f32",value:0},normalBias:{type:"f32",value:0},intensity:{type:"f32",value:0}};class zr{constructor(e,{light:t,intensity:i=1,bias:s=0,normalBias:r=0,pcfSamples:o=1,depthTextureSize:a=new _(512),depthTextureFormat:h="depth24plus",autoRender:u=!0}={}){Be(this,si),Be(this,Jt,void 0),Be(this,Qt,void 0),Be(this,ei,void 0),Be(this,ti,void 0),Be(this,ii,void 0),Be(this,pt,void 0),Be(this,Ye,void 0),Be(this,ne,void 0),Be(this,Re,void 0),this.setRenderer(e),this.light=t,this.index=this.light.index,this.options={light:t,intensity:i,bias:s,normalBias:r,pcfSamples:o,depthTextureSize:a,depthTextureFormat:h},this.sampleCount=1,this.meshes=new Map,re(this,Ye,new Map),re(this,ne,new Map),re(this,Re,null),Pr(this,si,Zi).call(this,{intensity:i,bias:s,normalBias:r,pcfSamples:o,depthTextureSize:a,depthTextureFormat:h,autoRender:u}),this.isActive=!1}setRenderer(e){e=De(e,this.constructor.name),this.renderer=e,this.setRendererBinding(),j(this,ne)?.forEach(t=>{t.setRenderer(this.renderer)})}setRendererBinding(){this.rendererBinding=null}cast({intensity:e,bias:t,normalBias:i,pcfSamples:s,depthTextureSize:r,depthTextureFormat:o,autoRender:a}={}){Pr(this,si,Zi).call(this,{intensity:e,bias:t,normalBias:i,pcfSamples:s,depthTextureSize:r,depthTextureFormat:o,autoRender:a}),this.isActive=!0}reset(){this.onPropertyChanged("isActive",this.isActive?1:0),this.onPropertyChanged("intensity",this.intensity),this.onPropertyChanged("bias",this.bias),this.onPropertyChanged("normalBias",this.normalBias),this.onPropertyChanged("pcfSamples",this.pcfSamples)}get isActive(){return j(this,ii)}set isActive(e){!e&&this.isActive?this.destroy():e&&!this.isActive&&this.init(),re(this,ii,e)}get intensity(){return j(this,Jt)}set intensity(e){re(this,Jt,e),this.onPropertyChanged("intensity",this.intensity)}get bias(){return j(this,Qt)}set bias(e){re(this,Qt,e),this.onPropertyChanged("bias",this.bias)}get normalBias(){return j(this,ei)}set normalBias(e){re(this,ei,e),this.onPropertyChanged("normalBias",this.normalBias)}get pcfSamples(){return j(this,ti)}set pcfSamples(e){re(this,ti,Math.max(1,Math.ceil(e))),this.onPropertyChanged("pcfSamples",this.pcfSamples)}init(){if(!this.depthComparisonSampler){const e=this.renderer.samplers.find(t=>t.name==="depthComparisonSampler");this.depthComparisonSampler=e||new We(this.renderer,{label:"Depth comparison sampler",name:"depthComparisonSampler",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge",compare:"less",minFilter:"linear",magFilter:"linear",type:"comparison"})}this.setDepthTexture(),this.depthPassTarget||this.createDepthPassTarget(),j(this,Re)===null&&j(this,pt)&&(this.setDepthPass(),this.onPropertyChanged("isActive",1))}onDepthTextureSizeChanged(){this.setDepthTexture()}setDepthTexture(){this.depthTexture&&(this.depthTexture.size.width!==this.depthTextureSize.x||this.depthTexture.size.height!==this.depthTextureSize.y)?(this.depthTexture.options.fixedSize.width=this.depthTextureSize.x,this.depthTexture.options.fixedSize.height=this.depthTextureSize.y,this.depthTexture.size.width=this.depthTextureSize.x,this.depthTexture.size.height=this.depthTextureSize.y,this.depthTexture.createTexture(),this.depthPassTarget&&this.depthPassTarget.resize()):this.depthTexture||this.createDepthTexture()}createDepthTexture(){this.depthTexture=new K(this.renderer,{label:`${this.constructor.name} (index: ${this.light.index}) depth texture`,name:"shadowDepthTexture"+this.index,type:"depth",format:this.depthTextureFormat,sampleCount:this.sampleCount,fixedSize:{width:this.depthTextureSize.x,height:this.depthTextureSize.y},autoDestroy:!1})}createDepthPassTarget(){this.depthPassTarget=new Wi(this.renderer,{label:"Depth pass render target for "+this.constructor.name+" "+this.index,useColorAttachments:!1,depthTexture:this.depthTexture,sampleCount:this.sampleCount})}onPropertyChanged(e,t){if(this.rendererBinding){if(t instanceof D){for(let i=0;i<t.elements.length;i++)this.rendererBinding.childrenBindings[this.index].inputs[e].value[i]=t.elements[i];this.rendererBinding.childrenBindings[this.index].inputs[e].shouldUpdate=!0}else this.rendererBinding.childrenBindings[this.index].inputs[e].value=t;this.renderer.shouldUpdateCameraLightsBindGroup()}}setDepthPass(){re(this,Re,this.render())}removeDepthPass(e){this.renderer.onBeforeRenderScene.remove(e)}render(e=!1){return this.renderer.onBeforeRenderScene.add(t=>{this.meshes.size&&(this.useDepthMaterials(),this.renderDepthPass(t),this.useOriginalMaterials(),this.renderer.pipelineManager.resetCurrentPipeline())},{once:e,order:this.index})}async renderOnce(){j(this,pt)||(this.onPropertyChanged("isActive",1),this.useDepthMaterials(),this.meshes.forEach(e=>{e.setGeometry()}),await Promise.all([...j(this,ne).values()].map(async e=>{await e.compileMaterial()})),this.render(!0))}renderDepthPass(e){const t=new Map;this.meshes.forEach(s=>{s.options.renderBundle&&t.set(s.options.renderBundle.uuid,s.options.renderBundle)}),t.forEach(s=>{s.updateBinding()}),t.clear(),this.renderer.pipelineManager.resetCurrentPipeline();const i=e.beginRenderPass(this.depthPassTarget.renderPass.descriptor);this.renderer.production||i.pushDebugGroup(`${this.constructor.name} (index: ${this.index}): depth pass`),this.meshes.forEach(s=>{s.render(i)}),this.renderer.production||i.popDebugGroup(),i.end()}getDefaultShadowDepthVs(e=!1){return{code:br(this.index,e)}}getDefaultShadowDepthFs(){return!1}patchShadowCastingMeshParams(e,t={}){t={...e.material.options.rendering,...t},t.targets=[],t.sampleCount=this.sampleCount,t.depthFormat=this.depthTextureFormat,t.bindings?t.bindings=[e.material.getBufferBindingByName("matrices"),...t.bindings]:t.bindings=[e.material.getBufferBindingByName("matrices")];const i=e.material.inputsBindings.get("instances")&&e.geometry.instancesCount>1;return t.shaders||(t.shaders={vertex:this.getDefaultShadowDepthVs(i),fragment:this.getDefaultShadowDepthFs()}),t}addShadowCastingMesh(e,t={}){this.meshes.get(e.uuid)||(e.options.castShadows=!0,j(this,Ye).set(e.uuid,e.material),t=this.patchShadowCastingMeshParams(e,t),j(this,ne).get(e.uuid)&&(j(this,ne).get(e.uuid).destroy(),j(this,ne).delete(e.uuid)),j(this,ne).set(e.uuid,new Xi(this.renderer,{label:`${this.constructor.name} (index: ${this.index}) ${e.options.label} depth render material`,...t})),this.meshes.set(e.uuid,e))}useDepthMaterials(){this.meshes.forEach(e=>{e.useMaterial(j(this,ne).get(e.uuid))})}useOriginalMaterials(){this.meshes.forEach(e=>{e.useMaterial(j(this,Ye).get(e.uuid))})}removeMesh(e){const t=j(this,ne).get(e.uuid);t&&(t.destroy(),j(this,ne).delete(e.uuid)),this.meshes.delete(e.uuid)}destroy(){this.onPropertyChanged("isActive",0),j(this,Re)!==null&&(this.removeDepthPass(j(this,Re)),re(this,Re,null)),this.meshes.forEach(e=>this.removeMesh(e)),re(this,Ye,new Map),re(this,ne,new Map),this.meshes=new Map,this.depthPassTarget?.destroy(),this.depthTexture?.destroy()}}Jt=new WeakMap,Qt=new WeakMap,ei=new WeakMap,ti=new WeakMap,ii=new WeakMap,pt=new WeakMap,Ye=new WeakMap,ne=new WeakMap,Re=new WeakMap,si=new WeakSet,Zi=function({intensity:n=1,bias:e=0,normalBias:t=0,pcfSamples:i=1,depthTextureSize:s=new _(512),depthTextureFormat:r="depth24plus",autoRender:o=!0}={}){this.intensity=n,this.bias=e,this.normalBias=t,this.pcfSamples=i,this.depthTextureSize=s,this.depthTextureSize.onChange(()=>this.onDepthTextureSizeChanged()),this.depthTextureFormat=r,re(this,pt,o)};const uo={...Rr,viewMatrix:{type:"mat4x4f",value:new Float32Array(16)},projectionMatrix:{type:"mat4x4f",value:new Float32Array(16)}};class lo extends zr{constructor(e,{light:t,intensity:i,bias:s,normalBias:r,pcfSamples:o,depthTextureSize:a,depthTextureFormat:h,autoRender:u,camera:l={left:-10,right:10,bottom:-10,top:10,near:.1,far:50}}={}){super(e,{light:t,intensity:i,bias:s,normalBias:r,pcfSamples:o,depthTextureSize:a,depthTextureFormat:h,autoRender:u}),this.options={...this.options,camera:l},this.camera={projectionMatrix:new D,viewMatrix:new D,up:new f(0,1,0),_left:l.left,_right:l.right,_bottom:l.bottom,_top:l.top,_near:l.near,_far:l.far};const d=this;["left","right","bottom","top","near","far"].forEach(c=>{Object.defineProperty(d.camera,c,{get(){return d.camera["_"+c]},set(m){d.camera["_"+c]=m,d.updateProjectionMatrix()}})})}setRendererBinding(){this.rendererBinding=this.renderer.bindings.directionalShadows}cast({intensity:e,bias:t,normalBias:i,pcfSamples:s,depthTextureSize:r,depthTextureFormat:o,autoRender:a,camera:h}={}){h&&(this.camera.left=h.left??-10,this.camera.right=h.right??10,this.camera.bottom=h.bottom??-10,this.camera.top=h.right??10,this.camera.near=h.near??.1,this.camera.far=h.far??50),super.cast({intensity:e,bias:t,normalBias:i,pcfSamples:s,depthTextureSize:r,depthTextureFormat:o,autoRender:a})}init(){super.init(),this.updateProjectionMatrix()}reset(){this.setRendererBinding(),super.reset(),this.onPropertyChanged("projectionMatrix",this.camera.projectionMatrix),this.onPropertyChanged("viewMatrix",this.camera.viewMatrix)}updateProjectionMatrix(){this.camera.projectionMatrix.identity().makeOrthographic({left:this.camera.left,right:this.camera.right,bottom:this.camera.bottom,top:this.camera.top,near:this.camera.near,far:this.camera.far}),this.onPropertyChanged("projectionMatrix",this.camera.projectionMatrix)}updateViewMatrix(e=new f,t=new f){e.x===0&&e.z===0?this.camera.up.set(0,0,1):this.camera.up.set(0,1,0),this.camera.viewMatrix.makeView(e,t,this.camera.up),this.onPropertyChanged("viewMatrix",this.camera.viewMatrix)}}var Er=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},ri=(n,e,t)=>(Er(n,e,"read from private field"),t?t.call(n):e.get(n)),Lr=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},_r=(n,e,t,i)=>(Er(n,e,"write to private field"),e.set(n,t),t),ft,mt;class co extends Ni{constructor(e,{color:t=new f(1),intensity:i=1,position:s=new f(1),target:r=new f,shadow:o=null}={}){super(e,{color:t,intensity:i,type:"directionalLights"}),Lr(this,ft,void 0),Lr(this,mt,void 0),this.options={...this.options,position:s,target:r,shadow:o},_r(this,mt,new f),_r(this,ft,new f),this.target=r,this.target.onChange(()=>this.setDirection()),this.position.copy(s),this.parent=this.renderer.scene,this.shadow=new lo(this.renderer,{autoRender:!1,light:this}),o&&this.shadow.cast(o)}setRenderer(e){this.shadow?.setRenderer(e),super.setRenderer(e)}reset(){super.reset(),this.setDirection(),this.shadow?.reset()}setDirection(){ri(this,mt).copy(this.target).sub(this.worldMatrix.getTranslation(ri(this,ft))),this.onPropertyChanged("direction",ri(this,mt)),this.shadow?.updateViewMatrix(ri(this,ft),this.target)}applyScale(){}applyTransformOrigin(){}updateMatrixStack(){super.updateMatrixStack(),this.matricesNeedUpdate&&this.setDirection()}onMaxLightOverflow(e){super.onMaxLightOverflow(e),this.shadow?.setRendererBinding()}destroy(){super.destroy(),this.shadow.destroy()}}ft=new WeakMap,mt=new WeakMap;var Gr=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},Ar=(n,e,t)=>(Gr(n,e,"read from private field"),t?t.call(n):e.get(n)),po=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},fo=(n,e,t,i)=>(Gr(n,e,"write to private field"),e.set(n,t),t),gt;const mo={face:{type:"i32",value:0},...Rr,cameraNear:{type:"f32",value:0},cameraFar:{type:"f32",value:0},projectionMatrix:{type:"mat4x4f",value:new Float32Array(16)},viewMatrices:{type:"array<mat4x4f>",value:new Float32Array(16*6)}};class go extends zr{constructor(e,{light:t,intensity:i,bias:s,normalBias:r,pcfSamples:o,depthTextureSize:a,depthTextureFormat:h,autoRender:u,camera:l={near:.1,far:150}}={}){super(e,{light:t,intensity:i,bias:s,normalBias:r,pcfSamples:o,depthTextureSize:a,depthTextureFormat:h,autoRender:u}),po(this,gt,void 0),this.options={...this.options,camera:l},this.cubeDirections=[new f(-1,0,0),new f(1,0,0),new f(0,-1,0),new f(0,1,0),new f(0,0,-1),new f(0,0,1)],fo(this,gt,new f),this.cubeUps=[new f(0,-1,0),new f(0,-1,0),new f(0,0,1),new f(0,0,-1),new f(0,-1,0),new f(0,-1,0)],l.far<=0&&(l.far=150),this.camera={projectionMatrix:new D,viewMatrices:[],_near:l.near,_far:l.far};for(let c=0;c<6;c++)this.camera.viewMatrices.push(new D);const d=this;["near","far"].forEach(c=>{Object.defineProperty(d.camera,c,{get(){return d.camera["_"+c]},set(m){d.camera["_"+c]=m,d.updateProjectionMatrix()}})})}setRendererBinding(){this.rendererBinding=this.renderer.bindings.pointShadows}cast({intensity:e,bias:t,normalBias:i,pcfSamples:s,depthTextureSize:r,depthTextureFormat:o,autoRender:a,camera:h}={}){h&&(this.camera.near=h.near??.1,this.camera.far=h.far!==void 0?h.far:this.light.range>0?this.light.range:150),super.cast({intensity:e,bias:t,normalBias:i,pcfSamples:s,depthTextureSize:r,depthTextureFormat:o,autoRender:a})}init(){super.init(),this.updateProjectionMatrix()}reset(){this.setRendererBinding(),super.reset(),this.updateProjectionMatrix()}updateProjectionMatrix(){this.camera.projectionMatrix.identity().makePerspective({near:this.camera.near,far:this.camera.far,fov:90,aspect:1}),this.onPropertyChanged("projectionMatrix",this.camera.projectionMatrix),this.onPropertyChanged("cameraNear",this.camera.near),this.onPropertyChanged("cameraFar",this.camera.far)}updateViewMatrices(e=new f){for(let t=0;t<6;t++){Ar(this,gt).copy(this.cubeDirections[t]).add(e),this.camera.viewMatrices[t].makeView(e,Ar(this,gt),this.cubeUps[t]);for(let i=0;i<16;i++)this.rendererBinding.childrenBindings[this.index].inputs.viewMatrices.value[t*16+i]=this.camera.viewMatrices[t].elements[i]}this.rendererBinding.childrenBindings[this.index].inputs.viewMatrices.shouldUpdate=!0}setDepthTexture(){if(this.depthTexture&&(this.depthTexture.size.width!==this.depthTextureSize.x||this.depthTexture.size.height!==this.depthTextureSize.y)){const e=Math.max(this.depthTextureSize.x,this.depthTextureSize.y);this.depthTexture.options.fixedSize.width=e,this.depthTexture.options.fixedSize.height=e,this.depthTexture.size.width=e,this.depthTexture.size.height=e,this.depthTexture.createTexture(),this.depthPassTarget&&this.depthPassTarget.resize()}else this.depthTexture||this.createDepthTexture()}createDepthTexture(){const e=Math.max(this.depthTextureSize.x,this.depthTextureSize.y);this.depthTexture=new K(this.renderer,{label:`${this.constructor.name} (index: ${this.index}) depth texture`,name:"pointShadowCubeDepthTexture"+this.index,type:"depth",format:this.depthTextureFormat,viewDimension:"cube",sampleCount:this.sampleCount,fixedSize:{width:e,height:e},autoDestroy:!1})}removeDepthPass(e){this.renderer.onBeforeCommandEncoderCreation.remove(e)}render(e=!1){return this.renderer.onBeforeCommandEncoderCreation.add(()=>{if(this.meshes.size){this.renderer.setCameraBindGroup(),this.useDepthMaterials();for(let t=0;t<6;t++){const i=this.renderer.device.createCommandEncoder();this.renderer.production||i.pushDebugGroup(`${this.constructor.name} (index: ${this.index}): depth pass command encoder for face ${t}`),this.depthPassTarget.renderPass.setRenderPassDescriptor(this.depthTexture.texture.createView({label:this.depthTexture.texture.label+" cube face view "+t,dimension:"2d",arrayLayerCount:1,baseArrayLayer:t})),this.rendererBinding.childrenBindings[this.index].inputs.face.value=t,this.renderer.shouldUpdateCameraLightsBindGroup(),this.renderer.updateCameraLightsBindGroup(),this.renderDepthPass(i),this.renderer.production||i.popDebugGroup();const s=i.finish();this.renderer.device.queue.submit([s])}this.useOriginalMaterials(),this.renderer.pipelineManager.resetCurrentPipeline()}},{once:e,order:this.index})}getDefaultShadowDepthVs(e=!1){return{code:Mr(this.index,e)}}getDefaultShadowDepthFs(){return{code:Cr(this.index)}}}gt=new WeakMap;var Dr=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},Ji=(n,e,t)=>(Dr(n,e,"read from private field"),t?t.call(n):e.get(n)),Or=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},Fr=(n,e,t,i)=>(Dr(n,e,"write to private field"),e.set(n,t),t),ni,yt;class yo extends Ni{constructor(e,{color:t=new f(1),intensity:i=1,position:s=new f,range:r=0,shadow:o=null}={}){super(e,{color:t,intensity:i,type:"pointLights"}),Or(this,ni,void 0),Or(this,yt,void 0),this.options={...this.options,position:s,range:r,shadow:o},Fr(this,yt,new f),this.position.copy(s),this.range=r,this.parent=this.renderer.scene,this.shadow=new go(this.renderer,{autoRender:!1,light:this}),o&&this.shadow.cast(o)}setRenderer(e){this.shadow&&this.shadow.setRenderer(e),super.setRenderer(e)}reset(){super.reset(),this.onPropertyChanged("range",this.range),this.setPosition(),this.shadow?.reset()}get range(){return Ji(this,ni)}set range(e){Fr(this,ni,e),this.onPropertyChanged("range",this.range)}setPosition(){this.onPropertyChanged("position",this.worldMatrix.getTranslation(Ji(this,yt))),this.shadow?.updateViewMatrices(Ji(this,yt))}applyScale(){}applyTransformOrigin(){}updateMatrixStack(){super.updateMatrixStack(),this.matricesNeedUpdate&&this.setPosition()}onMaxLightOverflow(e){super.onMaxLightOverflow(e),this.shadow?.setRendererBinding()}destroy(){super.destroy(),this.shadow.destroy()}}ni=new WeakMap,yt=new WeakMap;var $r=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},Qi=(n,e,t)=>($r(n,e,"read from private field"),t?t.call(n):e.get(n)),xo=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},vo=(n,e,t,i)=>($r(n,e,"write to private field"),e.set(n,t),t);let bo=0;const Ur={autoRender:!0,useProjection:!1,useAsyncPipeline:!0,cullMode:"back",depth:!0,depthWriteEnabled:!0,depthCompare:"less",depthFormat:"depth24plus",transparent:!1,visible:!0,renderOrder:0,texturesOptions:{},renderBundle:null};function kr(n){var e,t;return t=class extends n{constructor(...i){super(i[0],i[1],{...Ur,...i[2]}),xo(this,e,!0),this._onReadyCallback=()=>{},this._onBeforeRenderCallback=()=>{},this._onRenderCallback=()=>{},this._onAfterRenderCallback=()=>{},this._onAfterResizeCallback=()=>{};let s=i[0];const r={...Ur,...i[2]};this.type="MeshBase",this.uuid=q(),Object.defineProperty(this,"index",{value:bo++}),s=k(s,r.label?r.label+" "+this.type:this.type),this.renderer=s;const{label:o,shaders:a,geometry:h,visible:u,renderOrder:l,outputTarget:d,renderBundle:p,texturesOptions:c,autoRender:m,...g}=r;this.outputTarget=d??null,this.renderBundle=p??null,g.sampleCount=g.sampleCount?g.sampleCount:this.outputTarget?this.outputTarget.renderPass.options.sampleCount:this.renderer&&this.renderer.renderPass?this.renderer.renderPass.options.sampleCount:1,this.options={...this.options??{},label:o??"Mesh "+this.renderer.meshes.length,...a!==void 0?{shaders:a}:{},...d!==void 0&&{outputTarget:d},...p!==void 0&&{renderBundle:p},texturesOptions:c,...m!==void 0&&{autoRender:m},...g},m!==void 0&&vo(this,e,m),this.visible=u,this.renderOrder=l,this.ready=!1,this.userData={},h&&this.useGeometry(h),this.setMaterial({...this.cleanupRenderMaterialParameters({...this.options}),...h&&{verticesOrder:h.verticesOrder,topology:h.topology}}),this.addToScene(!0)}get autoRender(){return Qi(this,e)}get ready(){return this._ready}set ready(i){i&&!this._ready&&this._onReadyCallback&&this._onReadyCallback(),this._ready=i}addToScene(i=!1){i&&this.renderer.meshes.push(this),this.setRenderingOptionsForRenderPass(this.outputTarget?this.outputTarget.renderPass:this.renderer.renderPass),Qi(this,e)&&this.renderer.scene.addMesh(this)}removeFromScene(i=!1){Qi(this,e)&&this.renderer.scene.removeMesh(this),i&&(this.renderer.meshes=this.renderer.meshes.filter(s=>s.uuid!==this.uuid))}setRenderer(i){if(i=i&&i.renderer||i,!i||!(i.type==="GPURenderer"||i.type==="GPUCameraRenderer"||i.type==="GPUCurtainsRenderer")){L(`${this.options.label}: Cannot set ${i} as a renderer because it is not of a valid Renderer type.`);return}this.material?.setRenderer(i);const s=this.renderer;this.removeFromScene(!0),this.renderer=i,this.addToScene(!0),s.meshes.length||s.onBeforeRenderScene.add(r=>{s.forceClear(r)},{once:!0})}setOutputTarget(i){if(i&&i.type!=="RenderTarget"){L(`${this.options.label??this.type}: outputTarget is not a RenderTarget: ${i.type}`);return}this.removeFromScene(),this.outputTarget=i,this.addToScene()}setRenderBundle(i,s=!0){s?(this.removeFromScene(),this.renderBundle=i,this.addToScene()):this.renderBundle=i}loseContext(){this.ready=!1,this.geometry.loseContext(),this.material.loseContext()}restoreContext(){this.geometry.restoreContext(this.renderer),this.material.restoreContext()}setShaders(){const{shaders:i}=this.options;i?((!i.vertex||!i.vertex.code)&&(i.vertex={code:Yi,entryPoint:"main"}),(i.fragment===void 0||i.fragment&&!i.fragment.code)&&(i.fragment={code:Hi,entryPoint:"main"})):this.options.shaders={vertex:{code:Yi,entryPoint:"main"},fragment:{code:Hi,entryPoint:"main"}}}useGeometry(i){if(this.geometry&&(i.shouldCompute&&i.computeGeometry(),this.geometry.layoutCacheKey!==i.layoutCacheKey&&(L(`${this.options.label} (${this.type}): the current and new geometries do not have the same vertexBuffers layout, causing a probable pipeline recompilation. This should be avoided.
...
`,on=({addUtils:n=!0,receiveShadows:e=!1,toneMapping:t="linear",useOcclusion:i=!1}={})=>`
${n?ci:""}
${nn}
${t?bt:""}
...
`,hn=({addUtils:n=!0,receiveShadows:e=!1,toneMapping:t="linear",useOcclusion:i=!1}={})=>`
${n?ci:""}
${an}
${t?bt:""}
...
`,un=({addUtils:n=!0,receiveShadows:e=!1,toneMapping:t="linear",useOcclusion:i=!1}={})=>`
${n?xs:""}
${vs}
${t?bt:""}
...
`,dn=({addUtils:n=!0,receiveShadows:e=!1,toneMapping:t="linear",useOcclusion:i=!1}={})=>`
${n?xs:""}
${vs}
${ln}
${t?bt:""}
...
`;var cn=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},Ce=(n,e,t)=>(cn(n,e,"read from private field"),t?t.call(n):e.get(n)),bs=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},No=(n,e,t,i)=>(cn(n,e,"write to private field"),e.set(n,t),t),wt,Ve,pi;class pn extends ts{constructor(e,t,i={}){super(e),bs(this,wt,new f),bs(this,Ve,new f(1)),bs(this,pi,1),this.boundingBox=new we(new f(-1),new f(1)),this._onAfterDOMElementResizeCallback=()=>{},e=Ai(e,"DOM3DObject"),this.renderer=e,this.size={shouldUpdate:!0,normalizedWorld:{size:new _(1),position:new _},cameraWorld:{size:new _(1)},scaledWorld:{size:new f(1),position:new f}},this.watchScroll=i.watchScroll,this.camera=this.renderer.camera,this.boundingBox.min.onChange(()=>this.shouldUpdateComputedSizes()),this.boundingBox.max.onChange(()=>this.shouldUpdateComputedSizes()),this.setDOMElement(t),this.renderer.domObjects.push(this)}setDOMElement(e){this.domElement=new rs({element:e,onSizeChanged:t=>this.resize(t),onPositionChanged:()=>this.onPositionChanged()}),this.updateSizeAndPosition()}onPositionChanged(){this.watchScroll&&this.shouldUpdateComputedSizes()}resetDOMElement(e){this.domElement&&this.domElement.destroy(),this.setDOMElement(e)}resize(e=null){!e&&(!this.domElement||this.domElement?.isResizing)||(this.updateSizeAndPosition(),this._onAfterDOMElementResizeCallback&&this._onAfterDOMElementResizeCallback())}get boundingRect(){return this.domElement?.boundingRect??{width:1,height:1,top:0,right:0,bottom:0,left:0,x:0,y:0}}setTransforms(){super.setTransforms(),this.transforms.origin.model.set(.5,.5,0),this.transforms.origin.world=new f,this.transforms.position.document=new f,this.documentPosition.onChange(()=>this.applyPosition()),this.transformOrigin.onChange(()=>this.setWorldTransformOrigin())}get documentPosition(){return this.transforms.position.document}set documentPosition(e){this.transforms.position.document=e,this.applyPosition()}get DOMObjectWorldScale(){return Ce(this,Ve).clone()}get worldScale(){return this.DOMObjectWorldScale.multiply(this.scale)}get worldPosition(){return Ce(this,wt).clone()}get transformOrigin(){return this.transforms.origin.model}set transformOrigin(e){this.transforms.origin.model=e,this.setWorldTransformOrigin()}get worldTransformOrigin(){return this.transforms.origin.world}set worldTransformOrigin(e){this.transforms.origin.world=e}shouldUpdateMatrices(){super.shouldUpdateMatrices(),(this.matricesNeedUpdate||this.size.shouldUpdate)&&(this.updateSizeAndPosition(),this.matricesNeedUpdate=!0),this.size.shouldUpdate=!1}shouldUpdateComputedSizes(){this.size.shouldUpdate=!0}updateSizeAndPosition(){this.setWorldSizes(),this.applyDocumentPosition(),this.shouldUpdateModelMatrix()}applyDocumentPosition(){let e=new f(0,0,0);this.documentPosition.equals(e)||(e=this.documentToWorldSpace(this.documentPosition)),Ce(this,wt).set(this.position.x+this.size.scaledWorld.position.x+e.x,this.position.y+this.size.scaledWorld.position.y+e.y,this.position.z+this.size.scaledWorld.position.z+this.documentPosition.z/this.camera.CSSPerspective)}applyTransformOrigin(){this.size&&(this.setWorldTransformOrigin(),super.applyTransformOrigin())}updateModelMatrix(){this.modelMatrix.composeFromOrigin(Ce(this,wt),this.quaternion,this.scale,this.worldTransformOrigin),this.modelMatrix.scale(this.DOMObjectWorldScale),this.shouldUpdateWorldMatrix()}documentToWorldSpace(e=new f){return new f(e.x*this.renderer.pixelRatio/this.renderer.boundingRect.width*this.camera.visibleSize.width,-(e.y*this.renderer.pixelRatio/this.renderer.boundingRect.height)*this.camera.visibleSize.height,e.z)}computeWorldSizes(){const e=this.renderer.boundingRect,t={x:this.boundingRect.width/2+this.boundingRect.left,y:this.boundingRect.height/2+this.boundingRect.top},i={x:e.width/2+e.left,y:e.height/2+e.top},{size:s,center:r}=this.boundingBox;s.x!==0&&s.y!==0&&s.z!==0&&r.divide(s),this.size.normalizedWorld.size.set(this.boundingRect.width/e.width,this.boundingRect.height/e.height),this.size.normalizedWorld.position.set((t.x-i.x)/e.width,(i.y-t.y)/e.height),this.size.cameraWorld.size.set(this.size.normalizedWorld.size.x*this.camera.visibleSize.width,this.size.normalizedWorld.size.y*this.camera.visibleSize.height),this.size.scaledWorld.size.set(this.size.cameraWorld.size.x/s.x,this.size.cameraWorld.size.y/s.y,1),this.size.scaledWorld.size.z=this.size.scaledWorld.size.y*(s.x/s.y/(this.boundingRect.width/this.boundingRect.height)),this.size.scaledWorld.position.set(this.size.normalizedWorld.position.x*this.camera.visibleSize.width,this.size.normalizedWorld.position.y*this.camera.visibleSize.height,0)}setWorldSizes(){this.computeWorldSizes(),this.setWorldScale(),this.setWorldTransformOrigin()}setWorldScale(){Ce(this,Ve).set(this.size.scaledWorld.size.x,this.size.scaledWorld.size.y,this.size.scaledWorld.size.z*Ce(this,pi)),this.shouldUpdateMatrixStack()}set DOMObjectDepthScaleRatio(e){No(this,pi,e),this.setWorldScale()}setWorldTransformOrigin(){this.transforms.origin.world=new f((this.transformOrigin.x*2-1)*Ce(this,Ve).x,-(this.transformOrigin.y*2-1)*Ce(this,Ve).y,this.transformOrigin.z*Ce(this,Ve).z),this.shouldUpdateMatrixStack()}updateScrollPosition(e={x:0,y:0}){(e.x||e.y)&&this.domElement.updateScrollPosition(e)}onAfterDOMElementResize(e){return e&&(this._onAfterDOMElementResizeCallback=e),this}destroy(){super.destroy(),this.domElement?.destroy()}}wt=new WeakMap,Ve=new WeakMap,pi=new WeakMap;const fn={autoloadSources:!0,watchScroll:!0};class mn extends Nr(pn){constructor(e,t,i){super(e,t,{...fn,...i}),this._onLoadingCallback=r=>{},i={...fn,...i},Ai(e,i.label?i.label+" DOMMesh":"DOMMesh"),this.type="DOMMesh";const{autoloadSources:s}=i;this.autoloadSources=s,this.sourcesReady=!1,this.setInitSources()}get ready(){return this._ready}set ready(e){e&&!this._ready&&this.sourcesReady&&this._onReadyCallback&&this._onReadyCallback(),this._ready=e}get sourcesReady(){return this._sourcesReady}set sourcesReady(e){e&&!this._sourcesReady&&this.ready&&this._onReadyCallback&&this._onReadyCallback(),this._sourcesReady=e}addToScene(e=!1){super.addToScene(e),e&&this.renderer.domMeshes.push(this)}removeFromScene(e=!1){super.removeFromScene(e),e&&(this.renderer.domMeshes=this.renderer.domMeshes.filter(t=>t.uuid!==this.uuid))}setInitSources(){let e=0,t=0;if(this.autoloadSources){const i=this.domElement.element.querySelectorAll("img"),s=this.domElement.element.querySelectorAll("video"),r=this.domElement.element.querySelectorAll("canvas");e=i.length+s.length+r.length;const o=a=>{t++,this._onLoadingCallback&&this._onLoadingCallback(a),t===e&&(this.sourcesReady=!0)};e||(this.sourcesReady=!0),i.length&&i.forEach(a=>{const h=this.createDOMTexture({name:a.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>o(h)).loadImage(a.src)}),s.length&&s.forEach(a=>{const h=this.createDOMTexture({name:a.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>o(h)).loadVideo(a)}),r.length&&r.forEach(a=>{const h=this.createDOMTexture({name:a.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>o(h)).loadCanvas(a)})}else this.sourcesReady=!0}resetDOMElement(e){e?super.resetDOMElement(e):!e&&!this.renderer.production&&L(`${this.options.label}: You are trying to reset a ${this.type} with a HTML element that does not exist. The old HTML element will be kept instead.`)}get pixelRatioBoundingRect(){const e=window.devicePixelRatio??1,t=this.renderer.pixelRatio/e;return Object.keys(this.domElement.boundingRect).reduce((i,s)=>({...i,[s]:this.domElement.boundingRect[s]*t}),{x:0,y:0,width:0,height:0,top:0,right:0,bottom:0,left:0})}computeGeometry(){super.computeGeometry(),this.boundingBox.copy(this.geometry.boundingBox)}onLoading(e){return e&&(this._onLoadingCallback=e),this}}const Wo={label:"Plane",instancesCount:1,vertexBuffers:[]};class gn extends mn{constructor(e,t,i={}){e=Ai(e,i.label?i.label+" Plane":"Plane");const s={...Wo,...i};let{geometry:r,widthSegments:o,heightSegments:a,...h}=s;const{instancesCount:u,vertexBuffers:l,...d}=h;if(!r||r.type!=="PlaneGeometry"){o=o??1,a=a??1;const p=o*a+o;l.length||(r=oi.getPlaneGeometryByID(p)),r?r.instancesCount=u:(r=new Vi({widthSegments:o,heightSegments:a,instancesCount:u,vertexBuffers:l}),oi.addPlaneGeometry(r))}super(e,t,{geometry:r,...d}),this.type="Plane"}}class fi extends us{constructor({deviceManager:e,label:t,container:i,pixelRatio:s=1,autoResize:r=!0,context:o={},renderPass:a,camera:h,lights:u}){super({deviceManager:e,label:t,container:i,pixelRatio:s,autoResize:r,context:o,renderPass:a,camera:h,lights:u}),this.type="GPUCurtainsRenderer"}setRendererObjects(){super.setRendererObjects(),this.domMeshes=[],this.domObjects=[]}onCameraMatricesChanged(){super.onCameraMatricesChanged(),this.domObjects.forEach(e=>{e.updateSizeAndPosition()})}resizeMeshes(){this.meshes.forEach(e=>{"domElement"in e||e.resize(this.boundingRect)}),this.domObjects.forEach(e=>{e.domElement.isResizing||e.domElement.setSize()})}}class jo{constructor({scroll:e={x:0,y:0},delta:t={x:0,y:0},shouldWatch:i=!0,onScroll:s=(r={x:0,y:0})=>{}}={}){this.scroll=e,this.delta=t,this.shouldWatch=i,this.onScroll=s,this.shouldWatch&&window.addEventListener("scroll",this.setScroll.bind(this),{passive:!0})}setScroll(){this.updateScrollValues({x:window.pageXOffset,y:window.pageYOffset})}updateScrollValues({x:e,y:t}){const i=this.scroll;this.scroll={x:e,y:t},this.delta={x:i.x-this.scroll.x,y:i.y-this.scroll.y},this.onScroll&&this.onScroll(this.delta)}destroy(){this.shouldWatch&&window.removeEventListener("scroll",this.setScroll.bind(this),{passive:!0})}}class qo{constructor({container:e,label:t,pixelRatio:i=window.devicePixelRatio??1,context:s={},production:r=!1,adapterOptions:o={},renderPass:a,camera:h,lights:u,autoRender:l=!0,autoResize:d=!0,watchScroll:p=!0}={}){this._onRenderCallback=()=>{},this._onScrollCallback=()=>{},this._onErrorCallback=()=>{},this._onContextLostCallback=()=>{},this.type="CurtainsGPU",this.options={container:e,label:t,pixelRatio:i,camera:h,lights:u,production:r,adapterOptions:o,context:s,renderPass:a,autoRender:l,autoResize:d,watchScroll:p},this.setDeviceManager(),e&&this.setContainer(e),this.initEvents(),this.options.autoRender&&this.animate()}setContainer(e){if(e)if(typeof e=="string")if(e=document.querySelector(e),e)this.options.container=e;else{const t=document.createElement("div");t.setAttribute("id","curtains-gpu-canvas"),document.body.appendChild(t),this.options.container=t}else e instanceof Element&&(this.options.container=e);else{const t=document.createElement("div");t.setAttribute("id","curtains-gpu-canvas"),document.body.appendChild(t),this.options.container=t}this.container=this.options.container,this.setMainRenderer()}setMainRenderer(){this.createCurtainsRenderer({deviceManager:this.deviceManager,label:this.options.label||"GPUCurtains main GPUCurtainsRenderer",container:this.options.container,pixelRatio:this.options.pixelRatio,autoResize:this.options.autoResize,context:this.options.context,renderPass:this.options.renderPass,camera:this.options.camera,lights:this.options.lights})}patchRendererOptions(e){return e.pixelRatio===void 0&&(e.pixelRatio=this.options.pixelRatio),e.autoResize===void 0&&(e.autoResize=this.options.autoResize),e}createRenderer(e){return e=this.patchRendererOptions(e),new as({...e,deviceManager:this.deviceManager})}createCameraRenderer(e){return e=this.patchRendererOptions(e),new us({...e,deviceManager:this.deviceManager})}createCurtainsRenderer(e){return e=this.patchRendererOptions(e),new fi({...e,deviceManager:this.deviceManager})}setDeviceManager(){this.deviceManager=new Kr({label:"GPUCurtains default device",production:this.options.production,adapterOptions:this.options.adapterOptions,onError:()=>setTimeout(()=>{this._onErrorCallback&&this._onErrorCallback()},0),onDeviceLost:e=>this._onContextLostCallback&&this._onContextLostCallback(e)})}get renderers(){return this.deviceManager.renderers}get renderer(){return this.renderers[0]}async setDevice({adapter:e=null,device:t=null}={}){await this.deviceManager.init({adapter:e,device:t})}async restoreContext(){await this.deviceManager.restoreDevice()}get pingPongPlanes(){return this.renderers?.map(e=>e.pingPongPlanes).flat()}get shaderPasses(){return this.renderers?.map(e=>e.shaderPasses).flat()}get meshes(){return this.renderers?.map(e=>e.meshes).flat()}get domMeshes(){return this.renderers?.filter(e=>e instanceof fi).map(e=>e.domMeshes).flat()}get domObjects(){return this.renderers?.filter(e=>e instanceof fi).map(e=>e.domObjects).flat()}get planes(){return this.domMeshes.filter(e=>e instanceof gn)}get computePasses(){return this.renderers?.map(e=>e.computePasses).flat()}get boundingRect(){return this.renderer?.boundingRect}initScroll(){this.scrollManager=new jo({scroll:{x:window.pageXOffset,y:window.pageYOffset},delta:{x:0,y:0},shouldWatch:this.options.watchScroll,onScroll:e=>this.updateScroll(e)})}updateScroll(e={x:0,y:0}){this.domObjects.forEach(t=>{t.domElement&&t.watchScroll&&t.updateScrollPosition(e)}),this._onScrollCallback&&this._onScrollCallback()}updateScrollValues(e={x:0,y:0}){this.scrollManager.updateScrollValues(e)}get scrollDelta(){return this.scrollManager.delta}get scrollValues(){return this.scrollManager.scroll}initEvents(){ss.useObserver(this.options.autoResize),this.initScroll()}onRender(e){return e&&(this._onRenderCallback=e),this}onScroll(e){return e&&(this._onScrollCallback=e),this}onError(e){return e&&(this._onErrorCallback=e),this}onContextLost(e){return e&&(this._onContextLostCallback=e),this}animate(){this.render(),this.animationFrameID=window.requestAnimationFrame(this.animate.bind(this))}render(){this._onRenderCallback&&this._onRenderCallback(),this.deviceManager.render()}destroy(){this.animationFrameID&&window.cancelAnimationFrame(this.animationFrameID),this.deviceManager.destroy(),this.scrollManager?.destroy(),ss.destroy()}}var ws=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},B=(n,e,t)=>(ws(n,e,"read from private field"),t?t.call(n):e.get(n)),I=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},Le=(n,e,t,i)=>(ws(n,e,"write to private field"),e.set(n,t),t),A=(n,e,t)=>(ws(n,e,"access private method"),t),W,oe,_e,$,Xe,Ke,Bt,Ze,mi,Bs,Ms,yn,Cs,xn,gi,Ss,yi,Ts,xi,Ps,vi,Rs,bi,zs,wi,Es,Bi,Ls,Mi,_s,Ne,Je,Ci,Gs,As,vn,Ds,bn;const Qe=new _,et=new _,Ge=new f;class Yo{constructor({camera:e,element:t=null,target:i=new f,enableZoom:s=!0,minZoom:r=0,maxZoom:o=1/0,zoomSpeed:a=1,enableRotate:h=!0,minPolarAngle:u=0,maxPolarAngle:l=Math.PI,minAzimuthAngle:d=-1/0,maxAzimuthAngle:p=1/0,rotateSpeed:c=1,enablePan:m=!0,panSpeed:g=1}){if(I(this,mi),I(this,Ms),I(this,Cs),I(this,gi),I(this,yi),I(this,xi),I(this,vi),I(this,bi),I(this,wi),I(this,Bi),I(this,Mi),I(this,Ne),I(this,Ci),I(this,As),I(this,Ds),I(this,W,null),I(this,oe,new f),I(this,_e,!1),I(this,$,{radius:1,phi:0,theta:0}),I(this,Xe,new _),I(this,Ke,!1),I(this,Bt,new _),I(this,Ze,new f),!e){L("OrbitControls: cannot initialize without a camera.");return}A(this,mi,Bs).call(this,{target:i,enableZoom:s,minZoom:r,maxZoom:o,zoomSpeed:a,enableRotate:h,minPolarAngle:u,maxPolarAngle:l,minAzimuthAngle:d,maxAzimuthAngle:p,rotateSpeed:c,enablePan:m,panSpeed:g}),this.element=t??(typeof window<"u"?window:null),this.useCamera(e)}useCamera(e){this.camera=e,this.camera.position.onChange(()=>{this.camera.lookAt(this.target)}),B(this,oe).copy(this.camera.position).sub(this.target),B(this,$).radius=B(this,oe).length(),B(this,$).theta=Math.atan2(B(this,oe).x,B(this,oe).z),B(this,$).phi=Math.acos(Math.min(Math.max(B(this,oe).y/B(this,$).radius,-1),1)),A(this,Ne,Je).call(this)}reset({position:e,target:t,enableZoom:i=this.enableZoom,minZoom:s=this.minZoom,maxZoom:r=this.maxZoom,zoomSpeed:o=this.zoomSpeed,enableRotate:a=this.enableRotate,minPolarAngle:h=this.minPolarAngle,maxPolarAngle:u=this.maxPolarAngle,minAzimuthAngle:l=this.minAzimuthAngle,maxAzimuthAngle:d=this.maxAzimuthAngle,rotateSpeed:p=this.rotateSpeed,enablePan:c=this.enablePan,panSpeed:m=this.panSpeed}={}){A(this,mi,Bs).call(this,{target:t,enableZoom:i,minZoom:s,maxZoom:r,zoomSpeed:o,enableRotate:a,minPolarAngle:h,maxPolarAngle:u,minAzimuthAngle:l,maxAzimuthAngle:d,rotateSpeed:p,enablePan:c,panSpeed:m}),e&&this.updatePosition(e)}updatePosition(e=new f){e.sub(this.target),B(this,$).radius=e.length(),B(this,$).theta=Math.atan2(e.x,e.z),B(this,$).phi=Math.acos(Math.min(Math.max(e.y/B(this,$).radius,-1),1)),A(this,Ne,Je).call(this)}set element(e){B(this,W)&&(!e||B(this,W)!==e)&&A(this,Cs,xn).call(this),Le(this,W,e),e&&A(this,Ms,yn).call(this)}get element(){return B(this,W)}destroy(){this.element=null}}W=new WeakMap,oe=new WeakMap,_e=new WeakMap,$=new WeakMap,Xe=new WeakMap,Ke=new WeakMap,Bt=new WeakMap,Ze=new WeakMap,mi=new WeakSet,Bs=function({target:n,enableZoom:e=this.enableZoom,minZoom:t=this.minZoom,maxZoom:i=this.maxZoom,zoomSpeed:s=this.zoomSpeed,enableRotate:r=this.enableRotate,minPolarAngle:o=this.minPolarAngle,maxPolarAngle:a=this.maxPolarAngle,minAzimuthAngle:h=this.minAzimuthAngle,maxAzimuthAngle:u=this.maxAzimuthAngle,rotateSpeed:l=this.rotateSpeed,enablePan:d=this.enablePan,panSpeed:p=this.panSpeed}={}){n&&(this.target=n),this.enableZoom=e,this.minZoom=t,this.maxZoom=i,this.zoomSpeed=s,this.enableRotate=r,this.minPolarAngle=o,this.maxPolarAngle=a,this.minAzimuthAngle=h,this.maxAzimuthAngle=u,this.rotateSpeed=l,this.enablePan=d,this.panSpeed=p},Ms=new WeakSet,yn=function(){B(this,W).addEventListener("contextmenu",A(this,Mi,_s).bind(this),!1),B(this,W).addEventListener("mousedown",A(this,gi,Ss).bind(this),!1),B(this,W).addEventListener("mousemove",A(this,xi,Ps).bind(this),!1),B(this,W).addEventListener("mouseup",A(this,bi,zs).bind(this),!1),B(this,W).addEventListener("touchstart",A(this,yi,Ts).bind(this),{passive:!1}),B(this,W).addEventListener("touchmove",A(this,vi,Rs).bind(this),{passive:!1}),B(this,W).addEventListener("touchend",A(this,wi,Es).bind(this),!1),B(this,W).addEventListener("wheel",A(this,Bi,Ls).bind(this),{passive:!1})},Cs=new WeakSet,xn=function(){B(this,W).removeEventListener("contextmenu",A(this,Mi,_s).bind(this),!1),B(this,W).removeEventListener("mousedown",A(this,gi,Ss).bind(this),!1),B(this,W).removeEventListener("mousemove",A(this,xi,Ps).bind(this),!1),B(this,W).removeEventListener("mouseup",A(this,bi,zs).bind(this),!1),B(this,W).removeEventListener("touchstart",A(this,yi,Ts).bind(this),{passive:!1}),B(this,W).removeEventListener("touchmove",A(this,vi,Rs).bind(this),{passive:!1}),B(this,W).removeEventListener("touchend",A(this,wi,Es).bind(this),!1),B(this,W).removeEventListener("wheel",A(this,Bi,Ls).bind(this),{passive:!1})},gi=new WeakSet,Ss=function(n){n.button===0&&this.enableRotate?(Le(this,_e,!0),B(this,Xe).set(n.clientX,n.clientY)):n.button===2&&this.enablePan&&(Le(this,Ke,!0),B(this,Bt).set(n.clientX,n.clientY)),n.stopPropagation(),n.preventDefault()},yi=new WeakSet,Ts=function(n){n.touches.length===1&&this.enableRotate&&(Le(this,_e,!0),B(this,Xe).set(n.touches[0].pageX,n.touches[0].pageY))},xi=new WeakSet,Ps=function(n){B(this,_e)&&this.enableRotate?A(this,Ci,Gs).call(this,n.clientX,n.clientY):B(this,Ke)&&this.enablePan&&A(this,As,vn).call(this,n.clientX,n.clientY)},vi=new WeakSet,Rs=function(n){B(this,_e)&&this.enableRotate&&A(this,Ci,Gs).call(this,n.touches[0].pageX,n.touches[0].pageY)},bi=new WeakSet,zs=function(n){Le(this,_e,!1),Le(this,Ke,!1)},wi=new WeakSet,Es=function(n){Le(this,_e,!1),Le(this,Ke,!1)},Bi=new WeakSet,Ls=function(n){this.enableZoom&&(A(this,Ds,bn).call(this,n.deltaY),n.preventDefault())},Mi=new WeakSet,_s=function(n){n.preventDefault()},Ne=new WeakSet,Je=function(){const n=B(this,$).radius*Math.sin(Math.max(1e-6,B(this,$).phi));B(this,oe).x=n*Math.sin(B(this,$).theta),B(this,oe).y=B(this,$).radius*Math.cos(B(this,$).phi),B(this,oe).z=n*Math.cos(B(this,$).theta),this.camera.position.copy(this.target).add(B(this,oe))},Ci=new WeakSet,Gs=function(n,e){Qe.set(n,e),et.copy(Qe).sub(B(this,Xe)).multiplyScalar(this.rotateSpeed),B(this,$).theta-=2*Math.PI*et.x/this.camera.size.height,B(this,$).phi-=2*Math.PI*et.y/this.camera.size.height,B(this,$).theta=Math.min(this.maxAzimuthAngle,Math.max(this.minAzimuthAngle,B(this,$).theta)),B(this,$).phi=Math.min(this.maxPolarAngle,Math.max(this.minPolarAngle,B(this,$).phi)),B(this,Xe).copy(Qe),A(this,Ne,Je).call(this)},As=new WeakSet,vn=function(n,e){Qe.set(n,e),et.copy(Qe).sub(B(this,Bt)).multiplyScalar(this.panSpeed),B(this,Ze).set(0),Ge.copy(this.camera.position).sub(this.target);let t=Ge.length();t*=Math.tan(this.camera.fov/2*Math.PI/180),Ge.set(this.camera.modelMatrix.elements[0],this.camera.modelMatrix.elements[1],this.camera.modelMatrix.elements[2]),Ge.multiplyScalar(-(2*et.x*t)/this.camera.size.height),B(this,Ze).add(Ge),Ge.set(this.camera.modelMatrix.elements[4],this.camera.modelMatrix.elements[5],this.camera.modelMatrix.elements[6]),Ge.multiplyScalar(2*et.y*t/this.camera.size.height),B(this,Ze).add(Ge),B(this,Bt).copy(Qe),this.target.add(B(this,Ze)),B(this,oe).copy(this.camera.position).sub(this.target),B(this,$).radius=B(this,oe).length(),A(this,Ne,Je).call(this)},Ds=new WeakSet,bn=function(n){B(this,$).radius=Math.min(this.maxZoom,Math.max(this.minZoom+1e-6,B(this,$).radius+n*this.zoomSpeed/100)),A(this,Ne,Je).call(this)};var Ho=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},Se=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},ae=(n,e,t)=>(Ho(n,e,"access private method"),t),Os,wn,Fs,Bn,Si,$s,Mt,Ti,Us,Mn,ks,Cn,Pi,Is,Vs,Sn,Ns,Tn;class Pn{constructor(){Se(this,Os),Se(this,Fs),Se(this,Si),Se(this,Mt),Se(this,Us),Se(this,ks),Se(this,Pi),Se(this,Vs),Se(this,Ns)}async loadFromUrl(e){const t=await(await fetch(e)).arrayBuffer();return ae(this,Os,wn).call(this,new DataView(t))}}Os=new WeakSet,wn=function(n){const e={data:n,offset:0},t=ae(this,Fs,Bn).call(this,e);return{width:t.width,height:t.height,exposure:t.exposure,gamma:t.gamma,data:ae(this,Us,Mn).call(this,e,t)}},Fs=new WeakSet,Bn=function(n){let e=ae(this,Mt,Ti).call(this,n);const t={colorCorr:[1,1,1],exposure:1,gamma:1,width:0,height:0,flipX:!1,flipY:!1};if(e!=="#?RADIANCE"&&e!=="#?RGBE")throw new Error("Incorrect file format!");for(;e!=="";){e=ae(this,Mt,Ti).call(this,n);const s=e.split("=");switch(s[0]){case"GAMMA":t.gamma=parseFloat(s[1]);break;case"FORMAT":if(s[1]!=="32-bit_rle_rgbe"&&s[1]!=="32-bit_rle_xyze")throw new Error("Incorrect encoding format!");break;case"EXPOSURE":t.exposure=parseFloat(s[1]);break;case"COLORCORR":t.colorCorr=s[1].replace(/^\s+|\s+$/g,"").split(" ").map(r=>parseFloat(r));break}}e=ae(this,Mt,Ti).call(this,n);const i=e.split(" ");return ae(this,Si,$s).call(this,i[0],parseInt(i[1]),t),ae(this,Si,$s).call(this,i[2],parseInt(i[3]),t),t},Si=new WeakSet,$s=function(n,e,t){switch(n){case"+X":t.width=e;break;case"-X":t.width=e,t.flipX=!0,console.warn("Flipping horizontal orientation not currently supported");break;case"-Y":t.height=e,t.flipY=!0;break;case"+Y":t.height=e;break}},Mt=new WeakSet,Ti=function(n){let e,t="";for(;(e=n.data.getUint8(n.offset++))!==10;)t+=String.fromCharCode(e);return t},Us=new WeakSet,Mn=function(n,e){const t=n.data.getUint16(n.offset);let i;if(t===514)i=ae(this,ks,Cn).call(this,n,e),e.flipX&&ae(this,Vs,Sn).call(this,i,e),e.flipY&&ae(this,Ns,Tn).call(this,i,e);else throw new Error("Obsolete HDR file version!");return i},ks=new WeakSet,Cn=function(n,e){const{width:t,height:i,colorCorr:s}=e,r=new Float32Array(t*i*4);let o=0,{offset:a,data:h}=n;for(let u=0;u<i;++u){if(h.getUint16(a)!==514)throw new Error("Incorrect scanline start hash");if(h.getUint16(a+2)!==t)throw new Error("Scanline doesn't match picture dimension!");a+=4;const l=t*4,d=[];let p=0;for(;p<l;){let c=h.getUint8(a++);if(c>128){const m=c-128;c=h.getUint8(a++);for(let g=0;g<m;++g)d[p++]=c}else for(let m=0;m<c;++m)d[p++]=h.getUint8(a++)}for(p=0;p<t;++p){const c=d[p],m=d[p+t],g=d[p+t*2];let y=d[p+t*3];y=y?Math.pow(2,y-136):0,r[o++]=c*y*s[0],r[o++]=m*y*s[1],r[o++]=g*y*s[2],r[o++]=y}}return r},Pi=new WeakSet,Is=function(n,e,t){e*=4,t*=4;for(let i=0;i<4;++i){const s=n[e+i];n[e+i]=n[t+i],n[t+i]=s}},Vs=new WeakSet,Sn=function(n,e){const{width:t,height:i}=e,s=t>>1;for(let r=0;r<i;++r){const o=r*t;for(let a=0;a<s;++a){const h=o+a,u=o+t-1-a;ae(this,Pi,Is).call(this,n,h,u)}}},Ns=new WeakSet,Tn=function(n,e){const{width:t,height:i}=e,s=i>>1;for(let r=0;r<s;++r){const o=r*t,a=(i-1-r)*t;for(let h=0;h<t;++h)ae(this,Pi,Is).call(this,n,o+h,a+h)}};var Xo=`
...
`;var Jo=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},Qo=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},Ws=(n,e,t)=>(Jo(n,e,"access private method"),t),Ct,Ri;class ea{constructor(e,t={lutTextureParams:{size:256,computeSampleCount:1024,label:"Environment LUT texture",name:"lutTexture",format:"rgba32float"},diffuseTextureParams:{size:128,computeSampleCount:2048,label:"Environment diffuse texture",name:"diffuseTexture",format:"rgba16float"},specularTextureParams:{label:"Environment specular texture",name:"specularTexture",format:"rgba16float",generateMips:!0}}){Qo(this,Ct),e=k(e,"EnvironmentMap"),this.renderer=e,this.options=t,this.sampler=new We(this.renderer,{label:"Clamp sampler",name:"clampSampler",magFilter:"linear",minFilter:"linear",mipmapFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}),this.rotation=new Me(new Float32Array([0,0,1,0,1,0,-1,0,0])),this.hdrLoader=new Pn,this.computeBRDFLUTTexture()}async computeBRDFLUTTexture(){const{size:e,computeSampleCount:t,...i}=this.options.lutTextureParams;this.lutTexture=new K(this.renderer,{...i,visibility:["fragment"],fixedSize:{width:e,height:e},autoDestroy:!1});let s=new K(this.renderer,{label:"LUT storage texture",name:"lutStorageTexture",format:this.lutTexture.options.format,visibility:["compute"],usage:["copySrc","storageBinding"],type:"storage",fixedSize:{width:this.lutTexture.size.width,height:this.lutTexture.size.height}}),r=new Ht(this.renderer,{label:"Compute LUT texture",autoRender:!1,dispatchSize:[Math.ceil(s.size.width/16),Math.ceil(s.size.height/16),1],shaders:{compute:{code:Xo}},uniforms:{params:{struct:{sampleCount:{type:"u32",value:t}}}},textures:[s]});await r.material.compileMaterial(),this.renderer.onBeforeRenderScene.add(o=>{this.renderer.renderSingleComputePass(o,r),Ws(this,Ct,Ri).call(this,o,s,this.lutTexture)},{once:!0}),this.renderer.onAfterCommandEncoderSubmission.add(()=>{r.destroy(),s.destroy(),s=null,r=null},{once:!0})}async computeSpecularCubemapFromHDRData(e){let t=new K(this.renderer,{label:"Specular storage cubemap",name:"specularStorageCubemap",format:this.specularTexture.options.format,visibility:["compute"],usage:["copySrc","storageBinding"],type:"storage",fixedSize:{width:this.specularTexture.size.width,height:this.specularTexture.size.height,depth:6},viewDimension:"2d-array"}),i=new Ht(this.renderer,{label:"Compute specular cubemap from equirectangular",autoRender:!1,dispatchSize:[Math.ceil(this.specularTexture.size.width/8),Math.ceil(this.specularTexture.size.height/8),6],shaders:{compute:{code:Ko}},storages:{params:{struct:{hdrImageData:{type:"array<vec4f>",value:e.data},imageSize:{type:"vec2f",value:new _(e.width,e.height)},faceSize:{type:"u32",value:this.specularTexture.size.width}}}},textures:[t]});await i.material.compileMaterial();const s=this.renderer.device?.createCommandEncoder({label:"Render once command encoder"});this.renderer.production||s.pushDebugGroup("Render once command encoder"),this.renderer.renderSingleComputePass(s,i),Ws(this,Ct,Ri).call(this,s,t,this.specularTexture),this.renderer.production||s.popDebugGroup();const r=s.finish();this.renderer.device?.queue.submit([r]),this.specularTexture.texture.mipLevelCount>1&&Lt(this.renderer.device,this.specularTexture.texture),i.destroy(),t.destroy(),t=null,i=null}async computeDiffuseFromSpecular(){if(this.specularTexture.options.viewDimension!=="cube"){L("Could not compute the diffuse texture because the specular texture is not a cube map:"+this.specularTexture.options.viewDimension);return}let e=new K(this.renderer,{label:"Diffuse storage cubemap",name:"diffuseEnvMap",format:this.diffuseTexture.options.format,visibility:["compute"],usage:["copySrc","storageBinding"],type:"storage",fixedSize:{width:this.diffuseTexture.size.width,height:this.diffuseTexture.size.height,depth:6},viewDimension:"2d-array"}),t=new Ht(this.renderer,{label:"Compute diffuse map from specular map",autoRender:!1,dispatchSize:[Math.ceil(this.diffuseTexture.size.width/8),Math.ceil(this.diffuseTexture.size.height/8),6],shaders:{compute:{code:Zo(this.specularTexture)}},uniforms:{params:{struct:{faceSize:{type:"u32",value:this.diffuseTexture.size.width},maxMipLevel:{type:"u32",value:this.specularTexture.texture.mipLevelCount},sampleCount:{type:"u32",value:this.options.diffuseTextureParams.computeSampleCount}}}},samplers:[this.sampler],textures:[this.specularTexture,e]});await t.material.compileMaterial(),this.renderer.onBeforeRenderScene.add(i=>{this.renderer.renderSingleComputePass(i,t),Ws(this,Ct,Ri).call(this,i,e,this.diffuseTexture)},{once:!0}),this.renderer.onAfterCommandEncoderSubmission.add(()=>{t.destroy(),e.destroy(),e=null,t=null},{once:!0})}async loadAndComputeFromHDR(e){const t=await this.hdrLoader.loadFromUrl(e),{width:i,height:s}=t||{width:1024,height:512},r=Math.max(i/4,s/2),o={viewDimension:"cube",autoDestroy:!1};this.specularTexture?(this.specularTexture.size.width!==r||this.specularTexture.size.height!==r)&&(this.specularTexture.options.fixedSize.width=r,this.specularTexture.options.fixedSize.height=r,this.specularTexture.size.width=r,this.specularTexture.size.height=r,this.specularTexture.createTexture()):this.specularTexture=new K(this.renderer,{...this.options.specularTextureParams,visibility:["fragment","compute"],fixedSize:{width:r,height:r},...o});const{size:a,computeSampleCount:h,...u}=this.options.diffuseTextureParams,l=Math.min(a,r);this.diffuseTexture?(this.diffuseTexture.size.width!==l||this.diffuseTexture.size.height!==l)&&(this.diffuseTexture.options.fixedSize.width=l,this.diffuseTexture.options.fixedSize.height=l,this.diffuseTexture.size.width=l,this.diffuseTexture.size.height=l,this.diffuseTexture.createTexture()):this.diffuseTexture=new K(this.renderer,{...u,visibility:["fragment"],fixedSize:{width:l,height:l},...o}),t&&this.computeSpecularCubemapFromHDRData(t).then(()=>{this.computeDiffuseFromSpecular()})}destroy(){this.lutTexture?.destroy(),this.diffuseTexture?.destroy(),this.specularTexture?.destroy()}}Ct=new WeakSet,Ri=function(n,e,t){n.copyTextureToTexture({texture:e.texture},{texture:t.texture},[t.texture.width,t.texture.height,t.texture.depthOrArrayLayers])};class ta extends ht{constructor({instancesCount:e=1,vertexBuffers:t=[],topology:i,mapBuffersAtCreation:s=!0,widthSegments:r=1,heightSegments:o=1,depthSegments:a=1}={}){super({verticesOrder:"ccw",topology:i,instancesCount:e,vertexBuffers:t,mapBuffersAtCreation:s}),this.type="BoxGeometry",r=Math.floor(r),o=Math.floor(o),a=Math.floor(a);const h=[],u=[],l=[],d=[];let p=0;const c=(m,g,y,v,M,P,w,S,C,b)=>{const R=P/C,E=w/b,z=P/2,F=w/2,O=S/2,J=C+1,Y=b+1;let ie=0;const U=new f;for(let V=0;V<Y;V++){const H=V*E-F;for(let ee=0;ee<J;ee++){const ue=ee*R-z;U[m]=ue*v,U[g]=H*M,U[y]=O,h.push(U.x,U.y,U.z),U[m]=0,U[g]=0,U[y]=S>0?1:-1,l.push(U.x,U.y,U.z),u.push(ee/C),u.push(V/b),ie+=1}}for(let V=0;V<b;V++)for(let H=0;H<C;H++){const ee=p+H+J*V,ue=p+H+J*(V+1),Ae=p+(H+1)+J*(V+1),G=p+(H+1)+J*V;d.push(ee,ue,G),d.push(ue,Ae,G),p+=ie}};c("z","y","x",-1,-1,2,2,2,a,o),c("z","y","x",1,-1,2,2,-2,a,o),c("x","z","y",1,1,2,2,2,r,a),c("x","z","y",1,-1,2,2,-2,r,a),c("x","y","z",1,-1,2,2,2,r,o),c("x","y","z",-1,-1,2,2,-2,r,o),this.setAttribute({name:"position",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(h)}),this.setAttribute({name:"uv",type:"vec2f",bufferFormat:"float32x2",size:2,array:new Float32Array(u)}),this.setAttribute({name:"normal",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(l)}),this.setIndexBuffer({array:this.useUint16IndexArray?new Uint16Array(d):new Uint32Array(d),bufferFormat:this.useUint16IndexArray?"uint16":"uint32"})}}class ia extends ht{constructor({topology:e,instancesCount:t=1,vertexBuffers:i=[],mapBuffersAtCreation:s=!0,widthSegments:r=32,heightSegments:o=16,phiStart:a=0,phiLength:h=Math.PI*2,thetaStart:u=0,thetaLength:l=Math.PI}={}){super({verticesOrder:"ccw",topology:e,instancesCount:t,vertexBuffers:i,mapBuffersAtCreation:s}),this.type="SphereGeometry",r=Math.max(3,Math.floor(r)),o=Math.max(2,Math.floor(o));const d=1,p=Math.min(u+l,Math.PI);let c=0;const m=[],g=new f,y=new f,v=[],M=[],P=[],w=[];for(let S=0;S<=o;S++){const C=[],b=S/o;let R=0;S===0&&u===0?R=.5/r:S===o&&p===Math.PI&&(R=-.5/r);for(let E=0;E<=r;E++){const z=E/r;g.x=-d*Math.cos(a+z*h)*Math.sin(u+b*l),g.y=d*Math.cos(u+b*l),g.z=d*Math.sin(a+z*h)*Math.sin(u+b*l),M.push(g.x,g.y,g.z),y.copy(g).normalize(),P.push(y.x,y.y,y.z),w.push(z+R,b),C.push(c++)}m.push(C)}for(let S=0;S<o;S++)for(let C=0;C<r;C++){const b=m[S][C+1],R=m[S][C],E=m[S+1][C],z=m[S+1][C+1];(S!==0||u>0)&&v.push(b,R,z),(S!==o-1||p<Math.PI)&&v.push(R,E,z)}this.setAttribute({name:"position",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(M)}),this.setAttribute({name:"uv",type:"vec2f",bufferFormat:"float32x2",size:2,array:new Float32Array(w)}),this.setAttribute({name:"normal",type:"vec3f",bufferFormat:"float32x3",size:3,array:new Float32Array(P)}),this.setIndexBuffer({array:this.useUint16IndexArray?new Uint16Array(v):new Uint32Array(v),bufferFormat:this.useUint16IndexArray?"uint16":"uint32"})}}class sa extends es{constructor(e,t={}){e=k(e,t.label?t.label+" PingPongPlane":"PingPongPlane");const i=t.targets&&t.targets.length&&t.targets.map(s=>({targetFormat:s.format}));t.outputTarget=new Wi(e,{label:t.label?t.label+" render target":"Ping Pong render target",useDepth:!1,...i&&{colorAttachments:i}}),t.transparent=!1,t.depth=!1,t.label=t.label??"PingPongPlane "+e.pingPongPlanes?.length,super(e,t),this.type="PingPongPlane",this.createTexture({label:t.label?`${t.label} render texture`:"PingPongPlane render texture",name:"renderTexture",...t.targets&&t.targets.length&&{format:t.targets[0].format},usage:["copyDst","textureBinding"]})}get renderTexture(){return this.textures.find(e=>e.options.name==="renderTexture")}addToScene(e=!1){e&&this.renderer.pingPongPlanes.push(this),this.autoRender&&this.renderer.scene.addPingPongPlane(this)}removeFromScene(e=!1){this.outputTarget&&this.outputTarget.destroy(),this.autoRender&&this.renderer.scene.removePingPongPlane(this),e&&(this.renderer.pingPongPlanes=this.renderer.pingPongPlanes.filter(t=>t.uuid!==this.uuid))}}var js=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},T=(n,e,t)=>(js(n,e,"read from private field"),t?t.call(n):e.get(n)),he=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},de=(n,e,t,i)=>(js(n,e,"write to private field"),e.set(n,t),t),ra=(n,e,t)=>(js(n,e,"access private method"),t),ge,Te,tt,it,ye,xe,St,Tt,Pt,Rt,zt,Et,qs,Rn;class na{constructor(e){he(this,qs),he(this,ge,void 0),he(this,Te,void 0),he(this,tt,void 0),he(this,it,void 0),he(this,ye,void 0),he(this,xe,void 0),he(this,St,void 0),he(this,Tt,void 0),he(this,Pt,void 0),he(this,Rt,void 0),he(this,zt,void 0),he(this,Et,void 0),this.type="Raycaster",e=De(e,this.type),this.renderer=e,this.camera=this.renderer.camera,this.pointer=new _(1/0),this.ray={origin:new f,direction:new f},de(this,ge,{origin:this.ray.origin.clone(),direction:this.ray.direction.clone()}),de(this,Te,new f),de(this,tt,new f),de(this,it,new f),de(this,ye,new f),de(this,xe,new f),de(this,St,new _),de(this,Tt,new _),de(this,Pt,new _),de(this,Rt,new f),de(this,zt,new f),de(this,Et,new f)}setFromMouse(e){const{clientX:t,clientY:i}=e.targetTouches&&e.targetTouches.length?e.targetTouches[0]:e;this.setFromNDCCoords((t-this.renderer.boundingRect.left)/this.renderer.boundingRect.width*2-1,-((i-this.renderer.boundingRect.top)/this.renderer.boundingRect.height)*2+1)}setFromNDCCoords(e=0,t=0){this.pointer.set(e,t),this.setRay()}setRay(){this.camera.worldMatrix.getTranslation(this.ray.origin),this.ray.direction.set(this.pointer.x,this.pointer.y,-1).unproject(this.camera).sub(this.ray.origin).normalize()}rayIntersectsTriangle(e){const i=new f,s=new f;i.crossVectors(T(this,ge).direction,T(this,xe));const r=T(this,ye).dot(i);if(Math.abs(r)<1e-6)return!1;const o=1/r,a=T(this,ge).origin.clone().sub(T(this,Te)),h=o*a.dot(i);if(h<0||h>1)return!1;s.crossVectors(a,T(this,ye));const u=o*T(this,ge).direction.dot(s);if(u<0||h+u>1)return!1;const l=o*T(this,xe).dot(s);return l>1e-6?(e.copy(T(this,ge).origin).add(T(this,ge).direction.clone().multiplyScalar(l)),!0):!1}getBarycentricCoordinates(e){const t=e.clone().sub(T(this,Te)),i=T(this,ye).dot(T(this,ye)),s=T(this,ye).dot(T(this,xe)),r=T(this,xe).dot(T(this,xe)),o=t.dot(T(this,ye)),a=t.dot(T(this,xe)),h=i*r-s*s,u=new f(0,(r*o-s*a)/h,(i*a-s*o)/h);return u.x=1-u.y-u.z,u}getTriangleNormal(){return new f().crossVectors(T(this,ye),T(this,xe)).normalize()}setAttributeVectorAtIndex(e,t,i,s,r){const o=i?i[e*3+t]:e*3+t;r.x=s.array[o*s.size],r.y=s.array[o*s.size+1],"z"in r&&(r.z=s.array[o*s.size+2])}intersectObject(e,t=!0,i=[]){if(!(e instanceof be))return this.renderer.production||L(`${this.type}: object to test intersection again is not of type Object3D`),i;const s=Ln(e);return s&&ra(this,qs,Rn).call(this,s,i),t&&e.children.forEach(r=>{this.intersectObject(r,t,i)}),i.length&&i.sort((r,o)=>this.ray.origin.distance(r.point)-this.ray.origin.distance(o.point)),i}intersectObjects(e,t=!0,i=[]){return e.forEach(s=>{this.intersectObject(s,t,i)}),i.length&&i.sort((s,r)=>this.ray.origin.distance(s.point)-this.ray.origin.distance(r.point)),i}}ge=new WeakMap,Te=new WeakMap,tt=new WeakMap,it=new WeakMap,ye=new WeakMap,xe=new WeakMap,St=new WeakMap,Tt=new WeakMap,Pt=new WeakMap,Rt=new WeakMap,zt=new WeakMap,Et=new WeakMap,qs=new WeakSet,Rn=function(n,e=[]){if(!n.geometry)return e;const t=n.geometry.getAttributeByName("position");if(!t)return this.renderer.production||L(`Raycaster: can't raycast on a mesh that has no position attribute: ${n.options.label}`),e;if(!t.array)return this.renderer.production||L(`Raycaster: can't raycast on a mesh that has no position attribute array: ${n.options.label}`),e;if(n.frustumCulling&&n.domFrustum){const{clipSpaceBoundingRect:h}=n.domFrustum;if(n.domFrustum.isIntersecting){if(this.pointer.x>h.left+h.width||this.pointer.x<h.left||this.pointer.y>h.top||this.pointer.y<h.top-h.height)return e}else return e}const i=n.worldMatrix.getInverse();T(this,ge).origin.copy(this.ray.origin).applyMat4(i),T(this,ge).direction.copy(this.ray.direction).transformDirection(i);const s=n.geometry.getAttributeByName("uv"),r=n.geometry.getAttributeByName("normal"),o=n.geometry.indexBuffer?.array,a=o?o.length/3:t.array.length/9;for(let h=0;h<a;h++){if(this.setAttributeVectorAtIndex(h,0,o,t,T(this,Te)),this.setAttributeVectorAtIndex(h,1,o,t,T(this,tt)),this.setAttributeVectorAtIndex(h,2,o,t,T(this,it)),T(this,ye).copy(T(this,tt)).sub(T(this,Te)),T(this,xe).copy(T(this,it)).sub(T(this,Te)),n.material.options.rendering.cullMode!=="none"){const p=this.getTriangleNormal().dot(T(this,ge).direction);if(p>0&&n.material.options.rendering.cullMode==="back")continue;if(p<0&&n.material.options.rendering.cullMode==="front")continue}const u=new f;if(this.rayIntersectsTriangle(u)){const d=this.getBarycentricCoordinates(u),p=u.clone().applyMat4(n.worldMatrix),c=this.ray.origin.distance(p),m={object:n,distance:c,localPoint:u,point:p,triangle:[T(this,Te).clone(),T(this,tt).clone(),T(this,it).clone()],triangleIndex:h};s&&s.array&&s.array.length&&(this.setAttributeVectorAtIndex(h,0,o,s,T(this,St)),this.setAttributeVectorAtIndex(h,1,o,s,T(this,Tt)),this.setAttributeVectorAtIndex(h,2,o,s,T(this,Pt)),m.uv=T(this,St).clone().multiplyScalar(d.x).add(T(this,Tt).clone().multiplyScalar(d.y)).add(T(this,Pt).clone().multiplyScalar(d.z))),r&&r.array&&r.array.length&&(this.setAttributeVectorAtIndex(h,0,o,r,T(this,Rt)),this.setAttributeVectorAtIndex(h,1,o,r,T(this,zt)),this.setAttributeVectorAtIndex(h,2,o,r,T(this,Et)),m.normal=T(this,Rt).clone().multiplyScalar(d.x).add(T(this,zt).clone().multiplyScalar(d.y)).add(T(this,Et).clone().multiplyScalar(d.z))),e.push(m)}}return e};var zn=(n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},Ys=(n,e,t)=>(zn(n,e,"read from private field"),t?t.call(n):e.get(n)),oa=(n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},aa=(n,e,t,i)=>(zn(n,e,"write to private field"),e.set(n,t),t),st;const X=WebGLRenderingContext,zi=new D,ha=class Pe{constructor({renderer:e,gltf:t}){oa(this,st,void 0),e=De(e,"GLTFScenesManager"),this.renderer=e,this.gltf=t,aa(this,st,new Map);const i=s=>[s.node,...s.children?.map(r=>[...i(r)]).flat()].flat();this.scenesManager={node:new be,boundingBox:new we,samplers:[],materialsTextures:[],scenes:[],meshes:[],meshesDescriptors:[],getScenesNodes:()=>this.scenesManager.scenes.map(s=>i(s)).flat()},this.createSamplers(),this.createMaterialTextures(),this.createScenes()}static getVertexAttributeParamsFromType(e){switch(e){case"VEC2":return{type:"vec2f",bufferFormat:"float32x2",size:2};case"VEC3":return{type:"vec3f",bufferFormat:"float32x3",size:3};case"VEC4":return{type:"vec4f",bufferFormat:"float32x4",size:4};case"SCALAR":default:return{type:"f32",bufferFormat:"float32",size:1}}}static getTypedArrayConstructorFromComponentType(e){switch(e){case X.BYTE:return Int8Array;case X.UNSIGNED_BYTE:return Uint8Array;case X.SHORT:return Int16Array;case X.UNSIGNED_SHORT:return Uint16Array;case X.UNSIGNED_INT:return Uint32Array;case X.FLOAT:default:return Float32Array}}static gpuPrimitiveTopologyForMode(e){switch(e){case X.TRIANGLES:return"triangle-list";case X.TRIANGLE_STRIP:return"triangle-strip";case X.LINES:return"line-list";case X.LINE_STRIP:return"line-strip";case X.POINTS:return"point-list"}}static gpuAddressModeForWrap(e){switch(e){case X.CLAMP_TO_EDGE:return"clamp-to-edge";case X.MIRRORED_REPEAT:return"mirror-repeat";default:return"repeat"}}createSamplers(){if(this.gltf.samplers)for(const[e,t]of Object.entries(this.gltf.samplers)){const i={label:"glTF sampler "+e,name:"gltfSampler"+e,addressModeU:Pe.gpuAddressModeForWrap(t.wrapS),addressModeV:Pe.gpuAddressModeForWrap(t.wrapT)};switch((!t.magFilter||t.magFilter===X.LINEAR)&&(i.magFilter="linear"),t.minFilter){case X.NEAREST:break;case X.LINEAR:case X.LINEAR_MIPMAP_NEAREST:i.minFilter="linear";break;case X.NEAREST_MIPMAP_LINEAR:i.mipmapFilter="linear";break;case X.LINEAR_MIPMAP_LINEAR:default:i.minFilter="linear",i.mipmapFilter="linear";break}this.scenesManager.samplers.push(new We(this.renderer,i))}else this.scenesManager.samplers.push(new We(this.renderer,{label:"Default sampler",name:"defaultSampler",magFilter:"linear",minFilter:"linear",mipmapFilter:"linear"}))}createTexture(e,t,i){const s=(()=>{switch(i){case"baseColorTexture":case"emissiveTexture":return"bgra8unorm-srgb";case"occlusionTexture":return"r8unorm";default:return"bgra8unorm"}})(),r=new K(this.renderer,{label:e.name?e.name+": "+i:i,name:i,format:s,visibility:["fragment"],generateMips:!0,fixedSize:{width:t.width,height:t.height}});return r.uploadSource({source:t}),r}createMaterialTextures(){if(this.scenesManager.materialsTextures=[],this.gltf.materials)for(const[e,t]of Object.entries(this.gltf.materials)){const i={material:e,texturesDescriptors:[]},s=r=>r.texCoord&&r.texCoord!==0?"uv"+r.texCoord:"uv";if(this.scenesManager.materialsTextures[e]=i,t.pbrMetallicRoughness){if(t.pbrMetallicRoughness.baseColorTexture&&t.pbrMetallicRoughness.baseColorTexture.index!==void 0){const r=t.pbrMetallicRoughness.baseColorTexture.index,o=this.gltf.imagesBitmaps[this.gltf.textures[r].source],a=this.createTexture(t,o,"baseColorTexture"),h=this.gltf.textures.find(u=>u.source===r)?.sampler;i.texturesDescriptors.push({texture:a,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.pbrMetallicRoughness.baseColorTexture)})}if(t.pbrMetallicRoughness.metallicRoughnessTexture&&t.pbrMetallicRoughness.metallicRoughnessTexture.index!==void 0){const r=t.pbrMetallicRoughness.metallicRoughnessTexture.index,o=this.gltf.imagesBitmaps[this.gltf.textures[r].source],a=this.createTexture(t,o,"metallicRoughnessTexture"),h=this.gltf.textures.find(u=>u.source===r)?.sampler;i.texturesDescriptors.push({texture:a,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.pbrMetallicRoughness.metallicRoughnessTexture)})}}if(t.normalTexture&&t.normalTexture.index!==void 0){const r=t.normalTexture.index,o=this.gltf.imagesBitmaps[this.gltf.textures[r].source],a=this.createTexture(t,o,"normalTexture"),h=this.gltf.textures.find(u=>u.source===r)?.sampler;i.texturesDescriptors.push({texture:a,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.normalTexture)})}if(t.occlusionTexture&&t.occlusionTexture.index!==void 0){const r=t.occlusionTexture.index,o=this.gltf.imagesBitmaps[this.gltf.textures[r].source],a=this.createTexture(t,o,"occlusionTexture"),h=this.gltf.textures.find(u=>u.source===r)?.sampler;i.texturesDescriptors.push({texture:a,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.occlusionTexture)})}if(t.emissiveTexture&&t.emissiveTexture.index!==void 0){const r=t.emissiveTexture.index,o=this.gltf.imagesBitmaps[this.gltf.textures[r].source],a=this.createTexture(t,o,"emissiveTexture"),h=this.gltf.textures.find(u=>u.source===r)?.sampler;i.texturesDescriptors.push({texture:a,sampler:this.scenesManager.samplers[h??0],texCoordAttributeName:s(t.emissiveTexture)})}}}createNode(e,t){if(t.camera!==void 0)return;const i={name:t.name,node:new be,children:[]};e.children.push(i),i.node.parent=e.node,t.matrix?(i.node.modelMatrix.setFromArray(new Float32Array(t.matrix)),i.node.matrices.model.shouldUpdate=!1):(t.translation&&i.node.position.set(t.translation[0],t.translation[1],t.translation[2]),t.scale&&i.node.scale.set(t.scale[0],t.scale[1],t.scale[2]),t.rotation&&i.node.quaternion.setFromArray(new Float32Array(t.rotation)));const s=this.gltf.meshes[t.mesh];t.children&&t.children.forEach(r=>{const o=this.gltf.nodes[r];this.createNode(i,o)}),s&&s.primitives.forEach((r,o)=>{const a={parent:i.node,attributes:[],textures:[],parameters:{label:s.name?s.name+" "+o:"glTF mesh "+o},nodes:[]};let h=Ys(this,st).get(r);h||(h={instances:[],nodes:[],meshDescriptor:a},Ys(this,st).set(r,h)),h.instances.push(t),h.nodes.push(i.node)})}createScenes(){this.scenesManager.node.parent=this.renderer.scene,this.gltf.scenes.forEach(e=>{const t={name:e.name,children:[],node:new be};t.node.parent=this.scenesManager.node,this.scenesManager.scenes.push(t),e.nodes.forEach(i=>{const s=this.gltf.nodes[i];this.createNode(t,s)})}),this.scenesManager.node.updateMatrixStack();for(const[e,t]of Ys(this,st)){const{instances:i,nodes:s,meshDescriptor:r}=t,o=i.length;r.nodes=s,this.scenesManager.meshesDescriptors.push(r);const a=new we,h=[];let u=null,l=null,d=0;for(const[M,P]of Object.entries(e.attributes)){const w=this.gltf.accessors[P],S=Pe.getTypedArrayConstructorFromComponentType(w.componentType),C=this.gltf.bufferViews[w.bufferView],b=M==="TEXCOORD_0"?"uv":M.replace("_","").replace("TEXCOORD","uv").toLowerCase(),R=C.byteStride||0,E=w.byteOffset||0;R&&E&&E<R?d=Math.max(E,d):d=0,b==="position"&&(a.min.min(new f(w.min[0],w.min[1],w.min[2])),a.max.max(new f(w.max[0],w.max[1],w.max[2])),l=C);const z=Pe.getVertexAttributeParamsFromType(w.type),F={name:b,...z,array:new S(this.gltf.arrayBuffers[C.buffer],w.byteOffset+C.byteOffset,w.count*z.size)};h.push(F),r.attributes.push({name:F.name,type:F.type})}if(d>0){const M=Object.values(e.attributes).map(P=>this.gltf.accessors[P].bufferView);if(M.every(P=>P===M[0]))u=new Float32Array(this.gltf.arrayBuffers[l.buffer],l.byteOffset,Math.ceil(l.byteLength/4)*4/Float32Array.BYTES_PER_ELEMENT);else{let P=0;const w={},S=Object.values(e.attributes).reduce((C,b)=>{const R=this.gltf.accessors[b],E=Pe.getVertexAttributeParamsFromType(R.type).size;return w[R.bufferView]||(w[R.bufferView]=0),w[R.bufferView]=Math.max(w[R.bufferView],R.byteOffset+E*Float32Array.BYTES_PER_ELEMENT),P+=E*Float32Array.BYTES_PER_ELEMENT,C+R.count*E},0);u=new Float32Array(Math.ceil(S/4)*4),Object.values(e.attributes).forEach(C=>{const b=this.gltf.accessors[C],R=this.gltf.bufferViews[b.bufferView],E=Pe.getVertexAttributeParamsFromType(b.type).size;for(let z=0;z<b.count;z++){const F=b.byteOffset/Float32Array.BYTES_PER_ELEMENT+z*P/Float32Array.BYTES_PER_ELEMENT;u.subarray(F,F+E).set(new Float32Array(this.gltf.arrayBuffers[R.buffer],R.byteOffset+b.byteOffset+z*w[b.bufferView],E))}})}}else{const M=["position","uv","normal"];h.sort((P,w)=>{let S=M.findIndex(b=>b===P.name);S=S===-1?1/0:S;let C=M.findIndex(b=>b===w.name);return C=C===-1?1/0:C,S-C})}const p={instancesCount:o,topology:Pe.gpuPrimitiveTopologyForMode(e.mode),vertexBuffers:[{name:"attributes",stepMode:"vertex",attributes:h,...u&&{array:u}}]},c="indices"in e,m=c?ht:Ii;if(r.parameters.geometry=new m(p),r.parameters.geometry.boundingBox=a,c){const M=this.gltf.accessors[e.indices],P=this.gltf.bufferViews[M.bufferView],w=Pe.getTypedArrayConstructorFromComponentType(M.componentType),S=M.byteOffset+P.byteOffset,C=this.gltf.arrayBuffers[P.buffer],b=Math.min((C.byteLength-S)/w.BYTES_PER_ELEMENT,Math.ceil(M.count/4)*4),R=w.name==="Uint8Array"?Uint16Array.from(new w(C,S,b)):new w(C,S,b);r.parameters.geometry.setIndexBuffer({bufferFormat:w.name==="Uint32Array"?"uint32":"uint16",array:R})}const g=this.scenesManager.materialsTextures[e.material];r.parameters.samplers=[],r.parameters.textures=[],g?.texturesDescriptors.forEach(M=>{r.textures.push({texture:M.texture.options.name,sampler:M.sampler.name,texCoordAttributeName:M.texCoordAttributeName}),r.parameters.samplers.find(w=>w.uuid===M.sampler.uuid)||r.parameters.samplers.push(M.sampler),r.parameters.textures.push(M.texture)});const y=this.gltf.materials&&this.gltf.materials[e.material]||{};r.parameters.cullMode=y.doubleSided?"none":"back",(y.alphaMode==="BLEND"||y.extensions&&y.extensions.KHR_materials_transmission)&&(r.parameters.transparent=!0,r.parameters.targets=[{blend:{color:{srcFactor:"src-alpha",dstFactor:"one-minus-src-alpha"},alpha:{srcFactor:"one",dstFactor:"one"}}}]);const v={baseColorFactor:{type:"vec4f",value:y.pbrMetallicRoughness?.baseColorFactor||[1,1,1,1]},alphaCutoff:{type:"f32",value:y.alphaCutoff!==void 0?y.alphaCutoff:y.alphaMode==="MASK"?.5:0},metallicFactor:{type:"f32",value:y.pbrMetallicRoughness?.metallicFactor===void 0?1:y.pbrMetallicRoughness.metallicFactor},roughnessFactor:{type:"f32",value:y.pbrMetallicRoughness?.roughnessFactor===void 0?1:y.pbrMetallicRoughness.roughnessFactor},normalMapScale:{type:"f32",value:y.normalTexture?.scale===void 0?1:y.normalTexture.scale},occlusionStrength:{type:"f32",value:y.occlusionTexture?.strength===void 0?1:y.occlusionTexture.strength},emissiveFactor:{type:"vec3f",value:y.emissiveFactor!==void 0?y.emissiveFactor:[1,1,1]}};if(Object.keys(v).length&&(r.parameters.uniforms={material:{visibility:["vertex","fragment"],struct:v}}),o>1){const M=new Float32Array(o*16),P=new Float32Array(o*16);for(let w=0;w<o;++w)M.set(s[w].worldMatrix.elements,w*16),zi.copy(s[w].worldMatrix).invert().transpose(),P.set(zi.elements,w*16);r.parameters.storages={instances:{visibility:["vertex","fragment"],struct:{modelMatrix:{type:"array<mat4x4f>",value:M},normalMatrix:{type:"array<mat4x4f>",value:P}}}}}for(let M=0;M<s.length;M++){const w=a.clone().applyMat4(r.nodes[M].worldMatrix);this.scenesManager.boundingBox.min.min(w.min),this.scenesManager.boundingBox.max.max(w.max)}}}addMeshes(e=t=>{}){return this.scenesManager.node.updateMatrixStack(),this.scenesManager.meshesDescriptors.map(t=>{if(t.parameters.geometry){e(t);const i=t.parameters.geometry.instancesCount>1&&t.parameters.castShadows;i&&(t.parameters.castShadows=!1);const s=new Wr(this.renderer,{...t.parameters});if(t.nodes.length>1){const r=s.updateWorldMatrix.bind(s);s.updateWorldMatrix=()=>{r(),t.nodes.forEach((o,a)=>{s.storages.instances.modelMatrix.value.set(o.worldMatrix.elements,a*16),zi.copy(o.worldMatrix).invert().transpose(),s.storages.instances.normalMatrix.value.set(zi.elements,a*16)}),s.storages.instances.modelMatrix.shouldUpdate=!0,s.storages.instances.normalMatrix.shouldUpdate=!0}}if(i){const r=s.material.inputsBindings.get("instances");this.renderer.shadowCastingLights.forEach(o=>{o.shadow.isActive&&o.shadow.addShadowCastingMesh(s,{bindings:[r]})})}return s.parent=t.parent,this.scenesManager.meshes.push(s),s}})}destroy(){this.scenesManager.meshes.forEach(t=>t.remove()),this.scenesManager.meshes=[],this.scenesManager.getScenesNodes().forEach(t=>{t.destroy()}),this.scenesManager.node.destroy()}};st=new WeakMap;let ua=ha;const la=(n,e={})=>{const t=n.textures.find(G=>G.texture==="baseColorTexture"),i=n.textures.find(G=>G.texture==="normalTexture"),s=n.textures.find(G=>G.texture==="emissiveTexture"),r=n.textures.find(G=>G.texture==="occlusionTexture"),o=n.textures.find(G=>G.texture==="metallicRoughnessTexture"),a=n.attributes.filter(G=>G.name!=="position"),h=a.map((G,xa)=>`@location(${xa}) ${G.name}: ${G.type},`).join(`
	`);let u=`
  ...
  `,l=a.find(G=>G.name==="normal")?"vsOutput.normal = getWorldNormal(attributes.normal);":"";n.parameters.storages&&n.parameters.storages.instances&&(u=`
      ...
      vsOutput.viewDirection = camera.position - vsOutput.worldPosition;
      `,l="vsOutput.normal = normalize((instances[attributes.instanceIndex].normalMatrix * vec4(attributes.normal, 0.0)).xyz);");const d=a.filter(G=>G.name!=="normal").map(G=>`vsOutput.${G.name} = attributes.${G.name};`).join(`
	`);let p=`
      @builtin(position) position: vec4f,
      @location(${a.length}) viewDirection: vec3f,
      @location(${a.length+1}) worldPosition: vec3f,
      ${h}
  `,c="";const m=a.find(G=>G.name==="tangent"),g=!!(i&&m);g&&(p+=`
  ...
  `,P="var color: vec4f = vec4();",w=`
      return color;
  `,S=n.attributes.find(G=>G.name==="color0");let C=S?S.type==="vec3f"?"var baseColor: vec4f = vec4(fsInput.color0, 1.0) * material.baseColorFactor;":"var baseColor: vec4f = fsInput.color0 * material.baseColorFactor;":"var baseColor: vec4f = material.baseColorFactor;";t&&(C=`
    ...
    `),C+=`
      color = baseColor;
  `;let b=n.attributes.find(G=>G.name==="normal")?`
      let faceDirection = select(-1.0, 1.0, fsInput.frontFacing);
      let geometryNormal: vec3f = normalize(faceDirection * fsInput.normal);
    `:"let geometryNormal: vec3f = normalize(vec3(0.0, 0.0, 1.0));";g?b+=`
  ...
  `;let{shadingModel:F}=e;F||(F="PBR");let{chunks:O}=e||{};const{iblParameters:J}=e||{},{environmentMap:Y}=J||{};Y&&F==="IBL"?(n.parameters.uniforms={...n.parameters.uniforms,ibl:{struct:{envRotation:{type:"mat3x3f",value:Y.rotation},diffuseStrength:{type:"f32",value:J?.diffuseStrength??.5},specularStrength:{type:"f32",value:J?.specularStrength??.5}}}},n.parameters.textures=[...n.parameters.textures,Y.lutTexture,Y.diffuseTexture,Y.specularTexture],n.parameters.samplers=[...n.parameters.samplers,Y.sampler]):F==="IBL"&&(L("IBL shading requested but the environment map missing. Defaulting to PBR shading."),F="PBR");const ie={toneMapping:"khronos",receiveShadows:!!n.parameters.receiveShadows,useOcclusion:!0},U=(()=>{switch(F){case"Lambert":default:return on(ie);case"Phong":return hn(ie);case"PBR":return un(ie);case"IBL":return dn(ie)}})(),V="",H="";O?(O.additionalFragmentHead?O.additionalFragmentHead=U+O.additionalFragmentHead:O.additionalFragmentHead=U,O.preliminaryColorContribution?O.preliminaryColorContribution=V+O.preliminaryColorContribution:O.preliminaryColorContribution=V,O.additionalColorContribution?O.additionalColorContribution=H+O.additionalColorContribution:O.additionalColorContribution=H):O={additionalFragmentHead:U,preliminaryColorContribution:V,additionalColorContribution:H};const ee=(()=>{switch(F){case"Lambert":default:return`
      color = vec4(
        getLambert(
          normal,
          worldPosition,
      ...
      color = vec4(
        getIBL(
          ...
          roughness,
          ${Y.sampler.name},
          ${Y.lutTexture.options.name},
          ${Y.specularTexture.options.name},
          ${Y.diffuseTexture.options.name},
          occlusion
        ),
        color.a
      );`}})(),Ae=`  
  ...
  `;return{vertex:{code:M,entryPoint:"main"},fragment:{code:Ae,entryPoint:"main"}}},En=WebGLRenderingContext,da=1179937895,Hs={JSON:1313821514,BIN:5130562},ca=[0,0,0],pa=[0,0,0,1],fa=[1,1,1],ma=typeof window<"u"&&new RegExp(`^${window.location.protocol}`,"i")||RegExp("^(http|https):","i"),ga=/^data:/;class Ei{constructor(){this.gltf=null}static resolveUri(e,t){return e.match(ma)||e.match(ga)?e:t+e}async loadFromUrl(e){const t=e.lastIndexOf("/"),i=t!==0?e.substring(0,t+1):"",s=await fetch(e);if(e.endsWith(".gltf"))return this.loadFromJson(await s.json(),i);if(e.endsWith(".glb"))return this.loadFromBinary(await s.arrayBuffer(),i);throw new Error("Unrecognized file extension")}async loadFromJsonBase(e,t,i=null){if(!t)throw new Error("baseUrl must be specified.");if(!e.asset)throw new Error("Missing asset description.");if(e.asset.minVersion!=="2.0"&&e.asset.version!=="2.0")throw new Error("Incompatible asset version.");for(const o of e.accessors)o.byteOffset=o.byteOffset??0,o.normalized=o.normalized??!1;for(const o of e.bufferViews)o.byteOffset=o.byteOffset??0;for(const o of e.nodes)o.matrix||(o.rotation=o.rotation??pa,o.scale=o.scale??fa,o.translation=o.translation??ca);if(e.samplers)for(const o of e.samplers)o.wrapS=o.wrapS??En.REPEAT,o.wrapT=o.wrapT??En.REPEAT;const s=[];if(i)s.push(Promise.resolve(i));else for(const o in e.buffers){const a=e.buffers[o],h=Ei.resolveUri(a.uri,t);s[o]=fetch(h).then(u=>u.arrayBuffer())}const r=[];for(let o=0;o<e.images?.length;++o){const a=e.images[o];if(a.uri)r[o]=fetch(Ei.resolveUri(a.uri,t)).then(async h=>createImageBitmap(await h.blob()));else{const h=e.bufferViews[a.bufferView];r[o]=s[h.buffer].then(u=>{const l=new Blob([new Uint8Array(u,h.byteOffset,h.byteLength)],{type:a.mimeType});return createImageBitmap(l)})}}return{...e,arrayBuffers:await Promise.all(s),imagesBitmaps:await Promise.all(r)}}async loadFromBinary(e,t){const i=new DataView(e,0,12),s=i.getUint32(0,!0),r=i.getUint32(4,!0),o=i.getUint32(8,!0);if(s!==da)throw new Error("Invalid magic string in binary header.");if(r!==2)throw new Error("Incompatible version in binary header.");const a={};let h=12;for(;h<o;){const d=new DataView(e,h,8),p=d.getUint32(0,!0),c=d.getUint32(4,!0);a[c]=e.slice(h+8,h+8+p),h+=p+8}if(!a[Hs.JSON])throw new Error("File contained no json chunk.");const l=new TextDecoder("utf-8").decode(a[Hs.JSON]);return this.loadFromJson(JSON.parse(l),t,a[Hs.BIN])}async loadFromJson(e,t,i=null){return this.gltf=await this.loadFromJsonBase(e,t,i),this.gltf}}const ya=n=>{const{scene:e}=n;if(!e)return;const t=[];e.computePassEntries.forEach(i=>{t.push({command:"Render ComputePass",content:i.options.label}),i.material.bindGroups.forEach(s=>{s.bufferBindings.forEach(r=>{r.shouldCopyResult&&t.push({command:"Copy buffer to buffer",source:`${r.name} buffer`,destination:`${r.name} result buffer`})})})});for(const i in e.renderPassEntries){let s=0;e.renderPassEntries[i].forEach(r=>{if(!e.getRenderPassEntryLength(r))return;const o=r.renderPass.options.useColorAttachments?r.renderPass.options.colorAttachments.length===0&&r.renderPass.options.useDepth?`${r.renderTexture.options.label} depth pass`:r.renderPass.options.colorAttachments.length>1?`${r.renderTexture.options.label} multiple targets`:r.renderTexture?`${r.renderTexture.options.label}`:"Context current texture":void 0;let a=r.renderPass.options.label;const h={loadOp:r.renderPass.options.useColorAttachments?i==="screen"&&s>0?"load":r.renderPass.options.loadOp:void 0,depthLoadOp:void 0,sampleCount:r.renderPass.options.sampleCount,...r.renderPass.options.qualityRatio!==1&&{qualityRatio:r.renderPass.options.qualityRatio}};if(r.renderPass.options.useDepth&&(h.depthLoadOp=r.renderPass.options.depthLoadOp),s++,r.element)r.element.type==="ShaderPass"&&!(r.element.inputTarget||r.element.outputTarget)&&(t.push({command:"Copy texture to texture",source:o,destination:`${r.element.options.label} renderTexture`}),h.loadOp="clear"),a+=" "+JSON.stringify(h),t.push({command:`Render ${r.element.type}`,source:r.element.options.label,destination:o,descriptor:a}),r.element.type==="ShaderPass"&&!r.element.outputTarget&&r.element.options.copyOutputToRenderTexture?t.push({command:"Copy texture to texture",source:o,destination:`${r.element.options.label} renderTexture`}):r.element.type==="PingPongPlane"&&t.push({command:"Copy texture to texture",source:o,destination:`${r.element.renderTexture.options.label}`});else if(r.stack){a+=" "+JSON.stringify(h);for(const u in r.stack)for(const l in r.stack[u])r.stack[u][l].length&&t.push({command:`Render stack (${u} ${l} objects)`,source:r.stack[u][l],destination:o,descriptor:a})}})}console.table(t)};x.AmbientLight=io,x.BindGroup=Ot,x.Binding=Gt,x.Box3=we,x.BoxGeometry=ta,x.Buffer=Oe,x.BufferBinding=fe,x.Camera=rr,x.ComputeMaterial=ar,x.ComputePass=Ht,x.ComputePipelineEntry=is,x.DOMElement=rs,x.DOMFrustum=dr,x.DOMMesh=mn,x.DOMObject3D=pn,x.DOMTexture=Ue,x.DirectionalLight=co,x.EnvironmentMap=ea,x.FullscreenPlane=es,x.GLTFLoader=Ei,x.GLTFScenesManager=ua,x.GPUCameraRenderer=us,x.GPUCurtains=qo,x.GPUCurtainsRenderer=fi,x.GPUDeviceManager=Kr,x.GPURenderer=as,x.Geometry=Ii,x.HDRLoader=Pn,x.IndexedGeometry=ht,x.IndirectBuffer=Jr,x.Mat3=Me,x.Mat4=D,x.Material=ki,x.Mesh=Wr,x.Object3D=be,x.OrbitControls=Yo,x.PingPongPlane=sa,x.PipelineEntry=ji,x.PipelineManager=jr,x.Plane=gn,x.PlaneGeometry=Vi,x.PointLight=yo,x.ProjectedObject3D=ts,x.Quat=ce,x.Raycaster=na,x.RenderBundle=Do,x.RenderMaterial=Xi,x.RenderPass=Zt,x.RenderPipelineEntry=qe,x.RenderTarget=Wi,x.Sampler=We,x.SamplerBinding=ir,x.Scene=qr,x.ShaderPass=Fo,x.SphereGeometry=ia,x.Texture=K,x.TextureBindGroup=Ui,x.TextureBinding=$i,x.Vec2=_,x.Vec3=f,x.WritableBufferBinding=Fi,x.applyDirectionalShadows=dt,x.applyPointShadows=ct,x.buildShaders=la,x.getDefaultPointShadowDepthFs=Cr,x.getDefaultPointShadowDepthVs=Mr,x.getDefaultShadowDepthVs=br,x.getIBL=dn,x.getIBLIndirect=ln,x.getLambert=on,x.getLambertDirect=nn,x.getPBR=un,x.getPBRDirect=vs,x.getPCFDirectionalShadows=Br,x.getPCFPointShadowContribution=Sr,x.getPCFPointShadows=Tr,x.getPCFShadowContribution=wr,x.getPCFShadows=lt,x.getPhong=hn,x.getPhongDirect=an,x.lambertUtils=ci,x.logSceneCommands=ya,x.pbrUtils=xs,x.toneMappingUtils=bt});
