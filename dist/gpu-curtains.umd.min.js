...
}`,Je={vertex:{getUVCover:on},fragment:{getUVCover:on,getVertexToUVCoords:`
...
`:""}
  ...
  normal = getWorldNormal(normal);
    `,t},"getVertexSkinnedPositionNormal"),Ms=c(({bindings:n=[],geometry:e})=>{let t="";return t+=fo({bindings:n,geometry:e}),t+=`
  var worldPosition: vec4f = vec4(position, 1.0);
  `,t+=mo({bindings:n,geometry:e}),t},"getVertexTransformedPositionNormal"),go=c((n=0,{bindings:e=[],geometry:t})=>`
@vertex fn main(
  attributes: Attributes,
...
}`,"getDefaultPointShadowDepthVs"),bo=c((n=0)=>`
struct PointShadowVSOutput {
  @builtin(position) position: vec4f,
  @location(0) worldPosition: vec3f,
}
...
`,eh=c(({environmentMap:n=null})=>{let e="";return n&&(e+=`
  ...
  outputColor.a *= transmissionAlpha;`:""},"getIBLVolumeRefraction"),Xn=c(({receiveShadows:n=!1,environmentMap:e=null,transmissionBackgroundTexture:t=null,extensionsUsed:i=[]}={})=>`
  var directLight: DirectLight;
  var reflectedLight: ReflectedLight;
...
fn getPBR(
  ...
  ${Xn({receiveShadows:e,environmentMap:s,transmissionBackgroundTexture:r,extensionsUsed:a})}
  
  ${t==="Linear"?"outgoingLight = linearToOutput3(outgoingLight);":t==="Khronos"?"outgoingLight = linearTosRGB(toneMapKhronosPbrNeutral(outgoingLight));":""}
    
  return vec4(outgoingLight, outputColor.a);
}
`,"getPBR"),Kn=c(({geometry:n})=>{const e=n.getAttributeByName("tangent"),t=[];return n.vertexBuffers&&n.vertexBuffers.length&&n.vertexBuffers.forEach(s=>{s.attributes.forEach(r=>{r.name!=="position"&&t.push(r)})}),e&&t.push({name:"bitangent",type:"vec3f"}),`
  @builtin(position) position: vec4f,
  ${t.map((s,r)=>`
...
struct FSInput {
  ...
  `,t},"getBaseColor"),Fi=c(({toneMapping:n="Linear"}={})=>(()=>{switch(n){case"Linear":return"outputColor = vec4(linearToOutput3(outputColor.rgb), outputColor.a);";case"Khronos":return"outputColor = vec4(linearTosRGB(toneMapKhronosPbrNeutral(outputColor.rgb)), outputColor.a);";case!1:default:return""}})(),"applyToneMapping"),Jn=c(({chunks:n=null,toneMapping:e="Linear",geometry:t,materialUniform:i=null,materialUniformName:s="material",baseColorTexture:r=null})=>(n=At(n),`  
${n.additionalHead}
...
@fragment fn main(fsInput: FSInput) -> @location(0) vec4f {       
  ...
  ${Fi({toneMapping:e})}
  return outputColor;
}`),"getUnlitFragmentShaderCode"),Qs=c(({geometry:n=null,normalTexture:e=null}={})=>{let t=`
  ...
  */
  ...
  normal = geometryNormal;`,t},"getNormalTangentBitangent"),er=c(({emissiveTexture:n=null,occlusionTexture:e=null}={})=>{let t=`
  ...
  occlusion = 1.0 + occlusionIntensity * (occlusion - 1.0);`,t},"getEmissiveOcclusion"),Zn=c(({chunks:n=null,toneMapping:e="Linear",geometry:t,materialUniform:i=null,materialUniformName:s="material",receiveShadows:r=!1,baseColorTexture:a=null,normalTexture:o=null,emissiveTexture:h=null,occlusionTexture:l=null})=>(n=At(n),`  
${n.additionalHead}
...
@fragment fn main(fsInput: FSInput) -> @location(0) vec4f {
  ...
  ${Qs({geometry:t,normalTexture:o})}  
  ${er({emissiveTexture:h,occlusionTexture:l})}
  ...
  ${Fi({toneMapping:e})}
  return outputColor;
}`),"getLambertFragmentShaderCode"),Qn=c(({metallicRoughnessTexture:n=null}={})=>{let e="";return n&&(e+=`
  ...
  `,e},"getMetallicRoughness"),ea=c(({specularTexture:n=null,specularFactorTexture:e=null,specularColorTexture:t=null}={})=>{let i="";return n?i+=`
...
@fragment fn main(fsInput: FSInput) -> @location(0) vec4f {       
  ...
  ${Qs({geometry:t,normalTexture:o})}
  ${Qn({metallicRoughnessTexture:u})}
  ${ea({specularTexture:d,specularFactorTexture:f,specularColorTexture:p})}
  ${er({emissiveTexture:h,occlusionTexture:l})}
...
@fragment fn main(fsInput: FSInput) -> @location(0) vec4f {
  ...
  ${Qs({geometry:t,normalTexture:h})}
  ${Qn({metallicRoughnessTexture:d})}
  ${ea({specularTexture:f,specularFactorTexture:p,specularColorTexture:m})}
  ${ah({transmissionTexture:y,thicknessTexture:v})}
  ${er({emissiveTexture:l,occlusionTexture:u})}
  
  // lights
  ${Xn({receiveShadows:a,environmentMap:w,transmissionBackgroundTexture:x,extensionsUsed:r})}
  ...
  ${Fi({toneMapping:e})}
  return outputColor;
}`),"getPBRFragmentShaderCode"),tr=c(({shadingModel:n="PBR",chunks:e=null,toneMapping:t="Linear",geometry:i,materialUniform:s=null,materialUniformName:r="material",extensionsUsed:a=[],receiveShadows:o=!1,baseColorTexture:h=null,normalTexture:l=null,emissiveTexture:u=null,occlusionTexture:d=null,metallicRoughnessTexture:f=null,specularTexture:p=null,specularFactorTexture:m=null,specularColorTexture:y=null,transmissionTexture:v=null,thicknessTexture:x=null,transmissionBackgroundTexture:w=null,environmentMap:T=null})=>(()=>{switch(n){case"Unlit":return Jn({chunks:e,toneMapping:t,geometry:i,materialUniform:s,materialUniformName:r,baseColorTexture:h});case"Lambert":return Zn({chunks:e,toneMapping:t,geometry:i,materialUniform:s,materialUniformName:r,receiveShadows:o,baseColorTexture:h,normalTexture:l,emissiveTexture:u,occlusionTexture:d});case"Phong":return ta({chunks:e,toneMapping:t,geometry:i,materialUniform:s,materialUniformName:r,receiveShadows:o,baseColorTexture:h,normalTexture:l,emissiveTexture:u,occlusionTexture:d,metallicRoughnessTexture:f,specularTexture:p,specularFactorTexture:m,specularColorTexture:y});case"PBR":default:return ia({chunks:e,toneMapping:t,geometry:i,materialUniform:s,materialUniformName:r,extensionsUsed:a,receiveShadows:o,baseColorTexture:h,normalTexture:l,emissiveTexture:u,occlusionTexture:d,metallicRoughnessTexture:f,specularTexture:p,specularFactorTexture:m,specularColorTexture:y,transmissionTexture:v,thicknessTexture:x,transmissionBackgroundTexture:w,environmentMap:T})}})(),"getFragmentShaderCode");var sa=c((n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},"__accessCheck$6"),Ae=c((n,e,t)=>(sa(n,e,"read from private field"),t?t.call(n):e.get(n)),"__privateGet$5"),ir=c((n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},"__privateAdd$6"),oh=c((n,e,t,i)=>(sa(n,e,"write to private field"),e.set(n,t),t),"__privateSet$5"),Lt,et,$i;class ra extends As{static{c(this,"DOMObject3D")}constructor(e,t,i={}){super(e),ir(this,Lt,new g),ir(this,et,new g(1)),ir(this,$i,1),this.boundingBox=new Pe(new g(-1),new g(1)),this._onAfterDOMElementResizeCallback=()=>{},e=hs(e,"DOM3DObject"),this.renderer=e,this.size={shouldUpdate:!0,normalizedWorld:{size:new z(1),position:new z},cameraWorld:{size:new z(1)},scaledWorld:{size:new g(1),position:new g}},this.watchScroll=i.watchScroll,this.camera=this.renderer.camera,this.boundingBox.min.onChange(()=>this.shouldUpdateComputedSizes()),this.boundingBox.max.onChange(()=>this.shouldUpdateComputedSizes()),this.setDOMElement(t),this.renderer.domObjects.push(this)}setDOMElement(e){this.domElement=new Gs({element:e,onSizeChanged:t=>this.resize(t),onPositionChanged:()=>this.onPositionChanged()}),this.updateSizeAndPosition()}onPositionChanged(){this.watchScroll&&this.shouldUpdateComputedSizes()}resetDOMElement(e){this.domElement&&this.domElement.destroy(),this.setDOMElement(e)}resize(e=null){!e&&(!this.domElement||this.domElement?.isResizing)||(this.updateSizeAndPosition(),this._onAfterDOMElementResizeCallback&&this._onAfterDOMElementResizeCallback())}get boundingRect(){return this.domElement?.boundingRect??{width:1,height:1,top:0,right:0,bottom:0,left:0,x:0,y:0}}setTransforms(){super.setTransforms(),this.transforms.origin.model.set(.5,.5,0),this.transforms.origin.world=new g,this.transforms.position.document=new g,this.documentPosition.onChange(()=>this.applyPosition()),this.transformOrigin.onChange(()=>this.setWorldTransformOrigin())}get documentPosition(){return this.transforms.position.document}set documentPosition(e){this.transforms.position.document=e,this.applyPosition()}get DOMObjectWorldScale(){return Ae(this,et).clone()}get worldScale(){return this.DOMObjectWorldScale.multiply(this.scale)}get worldPosition(){return Ae(this,Lt).clone()}get transformOrigin(){return this.transforms.origin.model}set transformOrigin(e){this.transforms.origin.model=e,this.setWorldTransformOrigin()}get worldTransformOrigin(){return this.transforms.origin.world}set worldTransformOrigin(e){this.transforms.origin.world=e}shouldUpdateMatrices(){super.shouldUpdateMatrices(),(this.matricesNeedUpdate||this.size.shouldUpdate)&&(this.updateSizeAndPosition(),this.matricesNeedUpdate=!0),this.size.shouldUpdate=!1}shouldUpdateComputedSizes(){this.size.shouldUpdate=!0}updateSizeAndPosition(){this.setWorldSizes(),this.applyDocumentPosition(),this.shouldUpdateModelMatrix()}applyDocumentPosition(){let e=new g(0,0,0);this.documentPosition.equals(e)||(e=this.documentToWorldSpace(this.documentPosition)),Ae(this,Lt).set(this.position.x+this.size.scaledWorld.position.x+e.x,this.position.y+this.size.scaledWorld.position.y+e.y,this.position.z+this.size.scaledWorld.position.z+this.documentPosition.z/this.camera.CSSPerspective)}applyTransformOrigin(){this.size&&(this.setWorldTransformOrigin(),super.applyTransformOrigin())}updateModelMatrix(){this.modelMatrix.composeFromOrigin(Ae(this,Lt),this.quaternion,this.scale,this.worldTransformOrigin),this.modelMatrix.scale(this.DOMObjectWorldScale),this.shouldUpdateWorldMatrix()}documentToWorldSpace(e=new g){return new g(e.x*this.renderer.pixelRatio/this.renderer.boundingRect.width*this.camera.visibleSize.width,-(e.y*this.renderer.pixelRatio/this.renderer.boundingRect.height)*this.camera.visibleSize.height,e.z)}computeWorldSizes(){const e=this.renderer.boundingRect,t={x:this.boundingRect.width/2+this.boundingRect.left,y:this.boundingRect.height/2+this.boundingRect.top},i={x:e.width/2+e.left,y:e.height/2+e.top},{size:s,center:r}=this.boundingBox;s.x!==0&&s.y!==0&&s.z!==0&&r.divide(s),this.size.normalizedWorld.size.set(this.boundingRect.width/e.width,this.boundingRect.height/e.height),this.size.normalizedWorld.position.set((t.x-i.x)/e.width,(i.y-t.y)/e.height),this.size.cameraWorld.size.set(this.size.normalizedWorld.size.x*this.camera.visibleSize.width,this.size.normalizedWorld.size.y*this.camera.visibleSize.height),this.size.scaledWorld.size.set(this.size.cameraWorld.size.x/s.x,this.size.cameraWorld.size.y/s.y,1),this.size.scaledWorld.size.z=this.size.scaledWorld.size.y*(s.x/s.y/(this.boundingRect.width/this.boundingRect.height)),this.size.scaledWorld.position.set(this.size.normalizedWorld.position.x*this.camera.visibleSize.width,this.size.normalizedWorld.position.y*this.camera.visibleSize.height,0)}setWorldSizes(){this.computeWorldSizes(),this.setWorldScale(),this.setWorldTransformOrigin()}setWorldScale(){Ae(this,et).set(this.size.scaledWorld.size.x,this.size.scaledWorld.size.y,this.size.scaledWorld.size.z*Ae(this,$i)),this.shouldUpdateMatrixStack()}set DOMObjectDepthScaleRatio(e){oh(this,$i,e),this.setWorldScale()}setWorldTransformOrigin(){this.transforms.origin.world=new g((this.transformOrigin.x*2-1)*Ae(this,et).x,-(this.transformOrigin.y*2-1)*Ae(this,et).y,this.transformOrigin.z*Ae(this,et).z),this.shouldUpdateMatrixStack()}updateScrollPosition(e={x:0,y:0}){(e.x||e.y)&&this.domElement.updateScrollPosition(e)}onAfterDOMElementResize(e){return e&&(this._onAfterDOMElementResizeCallback=e),this}destroy(){super.destroy(),this.domElement?.destroy()}}Lt=new WeakMap,et=new WeakMap,$i=new WeakMap;const na={autoloadSources:!0,watchScroll:!0};class aa extends Tn(ra){static{c(this,"DOMMesh")}constructor(e,t,i){super(e,t,{...na,...i}),this._onLoadingCallback=r=>{},i={...na,...i},hs(e,i.label?i.label+" DOMMesh":"DOMMesh"),this.type="DOMMesh";const{autoloadSources:s}=i;this.autoloadSources=s,this.sourcesReady=!1,this.setInitSources()}get ready(){return this._ready}set ready(e){e&&!this._ready&&this.sourcesReady&&this._onReadyCallback&&this._onReadyCallback(),this._ready=e}get sourcesReady(){return this._sourcesReady}set sourcesReady(e){e&&!this._sourcesReady&&this.ready&&this._onReadyCallback&&this._onReadyCallback(),this._sourcesReady=e}addToScene(e=!1){super.addToScene(e),e&&this.renderer.domMeshes.push(this)}removeFromScene(e=!1){super.removeFromScene(e),e&&(this.renderer.domMeshes=this.renderer.domMeshes.filter(t=>t.uuid!==this.uuid))}setInitSources(){let e=0,t=0;if(this.autoloadSources){const i=this.domElement.element.querySelectorAll("img"),s=this.domElement.element.querySelectorAll("video"),r=this.domElement.element.querySelectorAll("canvas");e=i.length+s.length+r.length;const a=c(o=>{t++,this._onLoadingCallback&&this._onLoadingCallback(o),t===e&&(this.sourcesReady=!0)},"onSourceUploaded");e||(this.sourcesReady=!0),i.length&&i.forEach(o=>{const h=this.createDOMTexture({name:o.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>a(h)).loadImage(o.src)}),s.length&&s.forEach(o=>{const h=this.createDOMTexture({name:o.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>a(h)).loadVideo(o)}),r.length&&r.forEach(o=>{const h=this.createDOMTexture({name:o.getAttribute("data-texture-name")??"texture"+this.domTextures.length});h.onSourceUploaded(()=>a(h)).loadCanvas(o)})}else this.sourcesReady=!0}resetDOMElement(e){e?super.resetDOMElement(e):!e&&!this.renderer.production&&L(`${this.options.label}: You are trying to reset a ${this.type} with a HTML element that does not exist. The old HTML element will be kept instead.`)}get pixelRatioBoundingRect(){const e=window.devicePixelRatio??1,t=this.renderer.pixelRatio/e;return Object.keys(this.domElement.boundingRect).reduce((i,s)=>({...i,[s]:this.domElement.boundingRect[s]*t}),{x:0,y:0,width:0,height:0,top:0,right:0,bottom:0,left:0})}computeGeometry(){super.computeGeometry(),this.boundingBox.copy(this.geometry.boundingBox)}onLoading(e){return e&&(this._onLoadingCallback=e),this}}const hh={label:"Plane",instancesCount:1,vertexBuffers:[]};class oa extends aa{static{c(this,"Plane")}constructor(e,t,i={}){e=hs(e,i.label?i.label+" Plane":"Plane");const s={...hh,...i};let{geometry:r,widthSegments:a,heightSegments:o,...h}=s;const{instancesCount:l,vertexBuffers:u,...d}=h;if(!r||r.type!=="PlaneGeometry"){a=a??1,o=o??1;const f=a*o+a;u.length||(r=Ci.getPlaneGeometryByID(f)),r?r.instancesCount=l:(r=new ys({widthSegments:a,heightSegments:o,instancesCount:l,vertexBuffers:u}),Ci.addPlaneGeometry(r))}super(e,t,{geometry:r,...d}),this.type="Plane"}}class Oi extends Us{static{c(this,"GPUCurtainsRenderer")}constructor({deviceManager:e,label:t,container:i,pixelRatio:s=1,autoResize:r=!0,context:a={},renderPass:o,camera:h,lights:l}){super({deviceManager:e,label:t,container:i,pixelRatio:s,autoResize:r,context:a,renderPass:o,camera:h,lights:l}),this.type="GPUCurtainsRenderer"}setRendererObjects(){super.setRendererObjects(),this.domMeshes=[],this.domObjects=[]}onCameraMatricesChanged(){super.onCameraMatricesChanged(),this.domObjects.forEach(e=>{e.updateSizeAndPosition()})}resizeMeshes(){this.meshes.forEach(e=>{"domElement"in e||e.resize(this.boundingRect)}),this.domObjects.forEach(e=>{e.domElement.isResizing||e.domElement.setSize()})}}class lh{static{c(this,"ScrollManager")}constructor({scroll:e={x:0,y:0},delta:t={x:0,y:0},shouldWatch:i=!0,onScroll:s=c((r={x:0,y:0})=>{},"onScroll")}={}){this.scroll=e,this.delta=t,this.shouldWatch=i,this.onScroll=s,this.shouldWatch&&window.addEventListener("scroll",this.setScroll.bind(this),{passive:!0})}setScroll(){this.updateScrollValues({x:window.pageXOffset,y:window.pageYOffset})}updateScrollValues({x:e,y:t}){const i=this.scroll;this.scroll={x:e,y:t},this.delta={x:i.x-this.scroll.x,y:i.y-this.scroll.y},this.onScroll&&this.onScroll(this.delta)}destroy(){this.shouldWatch&&window.removeEventListener("scroll",this.setScroll.bind(this),{passive:!0})}}class uh{static{c(this,"GPUCurtains")}constructor({container:e,label:t,pixelRatio:i=window.devicePixelRatio??1,context:s={},production:r=!1,adapterOptions:a={},renderPass:o,camera:h,lights:l,autoRender:u=!0,autoResize:d=!0,watchScroll:f=!0}={}){this._onScrollCallback=()=>{},this._onErrorCallback=()=>{},this._onContextLostCallback=()=>{},this._onContextDestroyedCallback=()=>{},this.type="CurtainsGPU",this.options={container:e,label:t,pixelRatio:i,camera:h,lights:l,production:r,adapterOptions:a,context:s,renderPass:o,autoRender:u,autoResize:d,watchScroll:f},this.setDeviceManager(),e&&this.setContainer(e),this.initScroll()}setContainer(e){if(e)if(typeof e=="string")if(e=document.querySelector(e),e)this.options.container=e;else{const t=document.createElement("div");t.setAttribute("id","curtains-gpu-canvas"),document.body.appendChild(t),this.options.container=t}else e instanceof Element&&(this.options.container=e);else{const t=document.createElement("div");t.setAttribute("id","curtains-gpu-canvas"),document.body.appendChild(t),this.options.container=t}this.container=this.options.container,this.setMainRenderer()}setMainRenderer(){this.createCurtainsRenderer({deviceManager:this.deviceManager,label:this.options.label||"GPUCurtains main GPUCurtainsRenderer",container:this.options.container,pixelRatio:this.options.pixelRatio,autoResize:this.options.autoResize,context:this.options.context,renderPass:this.options.renderPass,camera:this.options.camera,lights:this.options.lights})}patchRendererOptions(e){return e.pixelRatio===void 0&&(e.pixelRatio=this.options.pixelRatio),e.autoResize===void 0&&(e.autoResize=this.options.autoResize),e}createRenderer(e){return e=this.patchRendererOptions(e),new Os({...e,deviceManager:this.deviceManager})}createCameraRenderer(e){return e=this.patchRendererOptions(e),new Us({...e,deviceManager:this.deviceManager})}createCurtainsRenderer(e){return e=this.patchRendererOptions(e),new Oi({...e,deviceManager:this.deviceManager})}setDeviceManager(){this.deviceManager=new Ln({label:"GPUCurtains default device",production:this.options.production,adapterOptions:this.options.adapterOptions,autoRender:this.options.autoRender,onError:()=>setTimeout(()=>{this._onErrorCallback&&this._onErrorCallback()},0),onDeviceLost:e=>this._onContextLostCallback&&this._onContextLostCallback(e),onDeviceDestroyed:e=>this._onContextDestroyedCallback&&this._onContextDestroyedCallback(e)})}get renderers(){return this.deviceManager.renderers}get renderer(){return this.renderers[0]}async setDevice({adapter:e=null,device:t=null}={}){await this.deviceManager.init({adapter:e,device:t})}async restoreContext(){await this.deviceManager.restoreDevice()}get pingPongPlanes(){return this.renderers?.map(e=>e.pingPongPlanes).flat()}get shaderPasses(){return this.renderers?.map(e=>e.shaderPasses).flat()}get meshes(){return this.renderers?.map(e=>e.meshes).flat()}get domMeshes(){return this.renderers?.filter(e=>e instanceof Oi).map(e=>e.domMeshes).flat()}get domObjects(){return this.renderers?.filter(e=>e instanceof Oi).map(e=>e.domObjects).flat()}get planes(){return this.domMeshes.filter(e=>e instanceof oa)}get computePasses(){return this.renderers?.map(e=>e.computePasses).flat()}get boundingRect(){return this.renderer?.boundingRect}initScroll(){this.scrollManager=new lh({scroll:{x:window.pageXOffset,y:window.pageYOffset},delta:{x:0,y:0},shouldWatch:this.options.watchScroll,onScroll:e=>this.updateScroll(e)})}updateScroll(e={x:0,y:0}){this.domObjects.forEach(t=>{t.domElement&&t.watchScroll&&t.updateScrollPosition(e)}),this._onScrollCallback&&this._onScrollCallback()}updateScrollValues(e={x:0,y:0}){this.scrollManager.updateScrollValues(e)}get scrollDelta(){return this.scrollManager.delta}get scrollValues(){return this.scrollManager.scroll}onBeforeRender(e){return this.deviceManager.onBeforeRender(e),this}onAfterRender(e){return this.deviceManager.onAfterRender(e),this}onScroll(e){return e&&(this._onScrollCallback=e),this}onError(e){return e&&(this._onErrorCallback=e),this}onContextLost(e){return e&&(this._onContextLostCallback=e),this}onContextDestroyed(e){return e&&(this._onContextDestroyedCallback=e),this}render(){this.deviceManager.render()}destroy(){this.deviceManager.destroy(),this.scrollManager?.destroy()}}var sr=c((n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},"__accessCheck$5"),P=c((n,e,t)=>(sr(n,e,"read from private field"),t?t.call(n):e.get(n)),"__privateGet$4"),k=c((n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},"__privateAdd$5"),Ie=c((n,e,t,i)=>(sr(n,e,"write to private field"),e.set(n,t),t),"__privateSet$4"),G=c((n,e,t)=>(sr(n,e,"access private method"),t),"__privateMethod$5"),V,oe,Ve,F,ot,ht,Dt,lt,ki,rr,nr,ha,ar,la,Ui,or,Ii,hr,Vi,lr,Ni,ur,Wi,dr,ji,cr,qi,pr,Hi,fr,tt,ut,Yi,mr,gr,ua,yr,da;const dt=new z,ct=new z,Ne=new g;class dh{static{c(this,"OrbitControls")}constructor({camera:e,element:t=null,target:i=new g,enableZoom:s=!0,minZoom:r=0,maxZoom:a=1/0,zoomSpeed:o=1,enableRotate:h=!0,minPolarAngle:l=0,maxPolarAngle:u=Math.PI,minAzimuthAngle:d=-1/0,maxAzimuthAngle:f=1/0,rotateSpeed:p=1,enablePan:m=!0,panSpeed:y=1}){if(k(this,ki),k(this,nr),k(this,ar),k(this,Ui),k(this,Ii),k(this,Vi),k(this,Ni),k(this,Wi),k(this,ji),k(this,qi),k(this,Hi),k(this,tt),k(this,Yi),k(this,gr),k(this,yr),k(this,V,null),k(this,oe,new g),k(this,Ve,!1),k(this,F,{radius:1,phi:0,theta:0}),k(this,ot,new z),k(this,ht,!1),k(this,Dt,new z),k(this,lt,new g),!e){L("OrbitControls: cannot initialize without a camera.");return}G(this,ki,rr).call(this,{target:i,enableZoom:s,minZoom:r,maxZoom:a,zoomSpeed:o,enableRotate:h,minPolarAngle:l,maxPolarAngle:u,minAzimuthAngle:d,maxAzimuthAngle:f,rotateSpeed:p,enablePan:m,panSpeed:y}),this.element=t??(typeof window<"u"?window:null),this.useCamera(e)}useCamera(e){this.camera=e,this.camera.position.onChange(()=>{this.camera.lookAt(this.target)}),P(this,oe).copy(this.camera.position).sub(this.target),P(this,F).radius=P(this,oe).length(),P(this,F).theta=Math.atan2(P(this,oe).x,P(this,oe).z),P(this,F).phi=Math.acos(Math.min(Math.max(P(this,oe).y/P(this,F).radius,-1),1)),G(this,tt,ut).call(this)}reset({position:e,target:t,enableZoom:i=this.enableZoom,minZoom:s=this.minZoom,maxZoom:r=this.maxZoom,zoomSpeed:a=this.zoomSpeed,enableRotate:o=this.enableRotate,minPolarAngle:h=this.minPolarAngle,maxPolarAngle:l=this.maxPolarAngle,minAzimuthAngle:u=this.minAzimuthAngle,maxAzimuthAngle:d=this.maxAzimuthAngle,rotateSpeed:f=this.rotateSpeed,enablePan:p=this.enablePan,panSpeed:m=this.panSpeed}={}){G(this,ki,rr).call(this,{target:t,enableZoom:i,minZoom:s,maxZoom:r,zoomSpeed:a,enableRotate:o,minPolarAngle:h,maxPolarAngle:l,minAzimuthAngle:u,maxAzimuthAngle:d,rotateSpeed:f,enablePan:p,panSpeed:m}),e&&this.updatePosition(e)}updatePosition(e=new g){e.sub(this.target),P(this,F).radius=e.length(),P(this,F).theta=Math.atan2(e.x,e.z),P(this,F).phi=Math.acos(Math.min(Math.max(e.y/P(this,F).radius,-1),1)),G(this,tt,ut).call(this)}set element(e){P(this,V)&&(!e||P(this,V)!==e)&&G(this,ar,la).call(this),Ie(this,V,e),e&&G(this,nr,ha).call(this)}get element(){return P(this,V)}destroy(){this.element=null}}V=new WeakMap,oe=new WeakMap,Ve=new WeakMap,F=new WeakMap,ot=new WeakMap,ht=new WeakMap,Dt=new WeakMap,lt=new WeakMap,ki=new WeakSet,rr=c(function({target:n,enableZoom:e=this.enableZoom,minZoom:t=this.minZoom,maxZoom:i=this.maxZoom,zoomSpeed:s=this.zoomSpeed,enableRotate:r=this.enableRotate,minPolarAngle:a=this.minPolarAngle,maxPolarAngle:o=this.maxPolarAngle,minAzimuthAngle:h=this.minAzimuthAngle,maxAzimuthAngle:l=this.maxAzimuthAngle,rotateSpeed:u=this.rotateSpeed,enablePan:d=this.enablePan,panSpeed:f=this.panSpeed}={}){n&&(this.target=n),this.enableZoom=e,this.minZoom=t,this.maxZoom=i,this.zoomSpeed=s,this.enableRotate=r,this.minPolarAngle=a,this.maxPolarAngle=o,this.minAzimuthAngle=h,this.maxAzimuthAngle=l,this.rotateSpeed=u,this.enablePan=d,this.panSpeed=f},"setBaseParams_fn"),nr=new WeakSet,ha=c(function(){P(this,V).addEventListener("contextmenu",G(this,Hi,fr).bind(this),!1),P(this,V).addEventListener("mousedown",G(this,Ui,or).bind(this),!1),P(this,V).addEventListener("mousemove",G(this,Vi,lr).bind(this),!1),P(this,V).addEventListener("mouseup",G(this,Wi,dr).bind(this),!1),P(this,V).addEventListener("touchstart",G(this,Ii,hr).bind(this),{passive:!1}),P(this,V).addEventListener("touchmove",G(this,Ni,ur).bind(this),{passive:!1}),P(this,V).addEventListener("touchend",G(this,ji,cr).bind(this),!1),P(this,V).addEventListener("wheel",G(this,qi,pr).bind(this),{passive:!1})},"addEvents_fn"),ar=new WeakSet,la=c(function(){P(this,V).removeEventListener("contextmenu",G(this,Hi,fr).bind(this),!1),P(this,V).removeEventListener("mousedown",G(this,Ui,or).bind(this),!1),P(this,V).removeEventListener("mousemove",G(this,Vi,lr).bind(this),!1),P(this,V).removeEventListener("mouseup",G(this,Wi,dr).bind(this),!1),P(this,V).removeEventListener("touchstart",G(this,Ii,hr).bind(this),{passive:!1}),P(this,V).removeEventListener("touchmove",G(this,Ni,ur).bind(this),{passive:!1}),P(this,V).removeEventListener("touchend",G(this,ji,cr).bind(this),!1),P(this,V).removeEventListener("wheel",G(this,qi,pr).bind(this),{passive:!1})},"removeEvents_fn"),Ui=new WeakSet,or=c(function(n){n.button===0&&this.enableRotate?(Ie(this,Ve,!0),P(this,ot).set(n.clientX,n.clientY)):n.button===2&&this.enablePan&&(Ie(this,ht,!0),P(this,Dt).set(n.clientX,n.clientY)),n.stopPropagation(),n.preventDefault()},"onMouseDown_fn"),Ii=new WeakSet,hr=c(function(n){n.touches.length===1&&this.enableRotate&&(Ie(this,Ve,!0),P(this,ot).set(n.touches[0].pageX,n.touches[0].pageY))},"onTouchStart_fn"),Vi=new WeakSet,lr=c(function(n){P(this,Ve)&&this.enableRotate?G(this,Yi,mr).call(this,n.clientX,n.clientY):P(this,ht)&&this.enablePan&&G(this,gr,ua).call(this,n.clientX,n.clientY)},"onMouseMove_fn"),Ni=new WeakSet,ur=c(function(n){P(this,Ve)&&this.enableRotate&&G(this,Yi,mr).call(this,n.touches[0].pageX,n.touches[0].pageY)},"onTouchMove_fn"),Wi=new WeakSet,dr=c(function(n){Ie(this,Ve,!1),Ie(this,ht,!1)},"onMouseUp_fn"),ji=new WeakSet,cr=c(function(n){Ie(this,Ve,!1),Ie(this,ht,!1)},"onTouchEnd_fn"),qi=new WeakSet,pr=c(function(n){this.enableZoom&&(G(this,yr,da).call(this,n.deltaY),n.preventDefault())},"onMouseWheel_fn"),Hi=new WeakSet,fr=c(function(n){n.preventDefault()},"onContextMenu_fn"),tt=new WeakSet,ut=c(function(){const n=P(this,F).radius*Math.sin(Math.max(1e-6,P(this,F).phi));P(this,oe).x=n*Math.sin(P(this,F).theta),P(this,oe).y=P(this,F).radius*Math.cos(P(this,F).phi),P(this,oe).z=n*Math.cos(P(this,F).theta),this.camera.position.copy(this.target).add(P(this,oe))},"update_fn"),Yi=new WeakSet,mr=c(function(n,e){dt.set(n,e),ct.copy(dt).sub(P(this,ot)).multiplyScalar(this.rotateSpeed),P(this,F).theta-=2*Math.PI*ct.x/this.camera.size.height,P(this,F).phi-=2*Math.PI*ct.y/this.camera.size.height,P(this,F).theta=Math.min(this.maxAzimuthAngle,Math.max(this.minAzimuthAngle,P(this,F).theta)),P(this,F).phi=Math.min(this.maxPolarAngle,Math.max(this.minPolarAngle,P(this,F).phi)),P(this,ot).copy(dt),G(this,tt,ut).call(this)},"rotate_fn"),gr=new WeakSet,ua=c(function(n,e){dt.set(n,e),ct.copy(dt).sub(P(this,Dt)).multiplyScalar(this.panSpeed),P(this,lt).set(0),Ne.copy(this.camera.position).sub(this.target);let t=Ne.length();t*=Math.tan(this.camera.fov/2*Math.PI/180),Ne.set(this.camera.modelMatrix.elements[0],this.camera.modelMatrix.elements[1],this.camera.modelMatrix.elements[2]),Ne.multiplyScalar(-(2*ct.x*t)/this.camera.size.height),P(this,lt).add(Ne),Ne.set(this.camera.modelMatrix.elements[4],this.camera.modelMatrix.elements[5],this.camera.modelMatrix.elements[6]),Ne.multiplyScalar(2*ct.y*t/this.camera.size.height),P(this,lt).add(Ne),P(this,Dt).copy(dt),this.target.add(P(this,lt)),P(this,oe).copy(this.camera.position).sub(this.target),P(this,F).radius=P(this,oe).length(),G(this,tt,ut).call(this)},"pan_fn"),yr=new WeakSet,da=c(function(n){P(this,F).radius=Math.min(this.maxZoom,Math.max(this.minZoom+1e-6,P(this,F).radius+n*this.zoomSpeed/100)),G(this,tt,ut).call(this)},"zoom_fn");var ch=c((n,e,t)=>{if(!e.has(n))throw TypeError("Cannot "+t)},"__accessCheck$4"),Le=c((n,e,t)=>{if(e.has(n))throw TypeError("Cannot add the same private member more than once");e instanceof WeakSet?e.add(n):e.set(n,t)},"__privateAdd$4"),he=c((n,e,t)=>(ch(n,e,"access private method"),t),"__privateMethod$4"),xr,ca,vr,pa,Xi,br,Gt,Ki,wr,fa,Br,ma,Ji,Cr,Sr,ga,Mr,ya;class xa{static{c(this,"HDRLoader")}constructor(){Le(this,xr),Le(this,vr),Le(this,Xi),Le(this,Gt),Le(this,wr),Le(this,Br),Le(this,Ji),Le(this,Sr),Le(this,Mr)}async loadFromUrl(e){const t=await(await fetch(e)).arrayBuffer();return he(this,xr,ca).call(this,new DataView(t))}}xr=new WeakSet,ca=c(function(n){const e={data:n,offset:0},t=he(this,vr,pa).call(this,e);return{width:t.width,height:t.height,exposure:t.exposure,gamma:t.gamma,data:he(this,wr,fa).call(this,e,t)}},"decodeRGBE_fn"),vr=new WeakSet,pa=c(function(n){let e=he(this,Gt,Ki).call(this,n);const t={colorCorr:[1,1,1],exposure:1,gamma:1,width:0,height:0,flipX:!1,flipY:!1};if(e!=="#?RADIANCE"&&e!=="#?RGBE")throw new Error("Incorrect file format!");for(;e!=="";){e=he(this,Gt,Ki).call(this,n);const s=e.split("=");switch(s[0]){case"GAMMA":t.gamma=parseFloat(s[1]);break;case"FORMAT":if(s[1]!=="32-bit_rle_rgbe"&&s[1]!=="32-bit_rle_xyze")throw new Error("Incorrect encoding format!");break;case"EXPOSURE":t.exposure=parseFloat(s[1]);break;case"COLORCORR":t.colorCorr=s[1].replace(/^\s+|\s+$/g,"").split(" ").map(r=>parseFloat(r));break}}e=he(this,Gt,Ki).call(this,n);const i=e.split(" ");return he(this,Xi,br).call(this,i[0],parseInt(i[1]),t),he(this,Xi,br).call(this,i[2],parseInt(i[3]),t),t},"parseHeader_fn"),Xi=new WeakSet,br=c(function(n,e,t){switch(n){case"+X":t.width=e;break;case"-X":t.width=e,t.flipX=!0,console.warn("Flipping horizontal orientation not currently supported");break;case"-Y":t.height=e,t.flipY=!0;break;case"+Y":t.height=e;break}},"parseSize_fn"),Gt=new WeakSet,Ki=c(function(n){let e,t="";for(;(e=n.data.getUint8(n.offset++))!==10;)t+=String.fromCharCode(e);return t},"readLine_fn"),wr=new WeakSet,fa=c(function(n,e){const t=n.data.getUint16(n.offset);let i;if(t===514)i=he(this,Br,ma).call(this,n,e),e.flipX&&he(this,Sr,ga).call(this,i,e),e.flipY&&he(this,Mr,ya).call(this,i,e);else throw new Error("Obsolete HDR file version!");return i},"parseData_fn"),Br=new WeakSet,ma=c(function(n,e){const{width:t,height:i,colorCorr:s}=e,r=new Float32Array(t*i*4);let a=0,{offset:o,data:h}=n;for(let l=0;l<i;++l){if(h.getUint16(o)!==514)throw new Error("Incorrect scanline start hash");if(h.getUint16(o+2)!==t)throw new Error("Scanline doesn't match picture dimension!");o+=4;const u=t*4,d=[];let f=0;for(;f<u;){let p=h.getUint8(o++);if(p>128){const m=p-128;p=h.getUint8(o++);for(let y=0;y<m;++y)d[f++]=p}else for(let m=0;m<p;++m)d[f++]=h.getUint8(o++)}for(f=0;f<t;++f){const p=d[f],m=d[f+t],y=d[f+t*2];let v=d[f+t*3];v=v?Math.pow(2,v-136):0,r[a++]=p*v*s[0],r[a++]=m*v*s[1],r[a++]=y*v*s[2],r[a++]=v}}return r},"parseNewRLE_fn"),Ji=new WeakSet,Cr=c(function(n,e,t){e*=4,t*=4;for(let i=0;i<4;++i){const s=n[e+i];n[e+i]=n[t+i],n[t+i]=s}},"swap_fn"),Sr=new WeakSet,ga=c(function(n,e){const{width:t,height:i}=e,s=t>>1;for(let r=0;r<i;++r){const a=r*t;for(let o=0;o<s;++o){const h=a+o,l=a+t-1-o;he(this,Ji,Cr).call(this,n,h,l)}}},"flipX_fn"),Mr=new WeakSet,ya=c(function(n,e){const{width:t,height:i}=e,s=i>>1;for(let r=0;r<s;++r){const a=r*t,o=(i-1-r)*t;for(let h=0;h<t;++h)he(this,Ji,Cr).call(this,n,a+h,o+h)}},"flipY_fn");const va=`
