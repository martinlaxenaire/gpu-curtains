...
@fragment fn main(fsInput: VSOutput) -> @location(0) vec4f {
  ...
  `;let x=o.attributes.find(R=>R.name==="normal")?`
    ...
    `:"let geometryNormal: vec3f = normalize(vec3(0.0, 0.0, 1.0));";m?x+=`
  ...
  `;return t?t.additionalFragmentHead?t.additionalFragmentHead+=s:t.additionalFragmentHead=s:t={additionalFragmentHead:s},gs(o,e)},Mi=(o,e=null)=>{e=e||{};const t=e?.iblParameters;o.parameters.uniforms={...o.parameters.uniforms,ibl:{struct:{diffuseStrength:{type:"f32",value:t?.diffuseStrength??.5},specularStrength:{type:"f32",value:t?.specularStrength??.5}}}};const{lutTexture:s,envDiffuseTexture:i,envSpecularTexture:r}=t||{},n=i&&i.texture&&r&&r.texture&&s&&s.texture;let a="",h="";n&&(o.parameters.textures=[...o.parameters.textures,s.texture,i.texture,r.texture],s.samplerName=s.samplerName||"defaultSampler",i.samplerName=i.samplerName||"defaultSampler",r.samplerName=r.samplerName||"defaultSampler",a=`  
    ...
    fn getIBLContribution(NdotV: f32, roughness: f32, n: vec3f, reflection: vec3f, diffuseColor: vec3f, f0: vec3f) -> IBLContribution {
      ...
      let diffuseLight: vec4f = textureSample(
        ...
        ${i.samplerName},
        ${i.texture.options.viewDimension==="cube"?"n":"cartesianToPolar(n)"}
      );
