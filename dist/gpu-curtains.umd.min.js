...
@fragment fn main(fsInput: VSOutput) -> @location(0) vec4f {
  ...
  `;return{vertex:{code:b,entryPoint:"main"},fragment:{code:_,entryPoint:"main"}}},ys=(o,e=null)=>{let t=e?.chunks;const s=`
