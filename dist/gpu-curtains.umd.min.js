...
@fragment fn main(fsInput: VSOutput) -> @location(0) vec4f {
  ...
  `,T="var color: vec4f = vec4();",v="return color;",C=o.attributes.find(R=>R.name==="color0");let M=C?C.type==="vec3f"?"var baseColor: vec4f = vec4(fsInput.color0, 1.0) * material.baseColorFactor;":"var baseColor: vec4f = fsInput.color0 * material.baseColorFactor;":"var baseColor: vec4f = material.baseColorFactor;";t&&(M=`
    ...
    `),M+=`
      color = baseColor;
  `;let y=o.attributes.find(R=>R.name==="normal")?"let normal: vec3f = normalize(fsInput.normal);":"let normal: vec3f = vec3(0.0);";m&&(y=`
  ...
  `;e=e??{};let z=e.chunks;z?(z.additionalFragmentHead||(z.additionalFragmentHead=Z),z.preliminaryColorContribution||(z.preliminaryColorContribution=N),z.ambientContribution||(z.ambientContribution=X),z.lightContribution||(z.lightContribution=O),z.additionalColorContribution||(z.additionalColorContribution=Q)):z={additionalFragmentHead:Z,ambientContribution:X,preliminaryColorContribution:N,lightContribution:O,additionalColorContribution:Q};const W=`
    // PBR
    const PI = ${Math.PI};
    ...
    @fragment fn main(fsInput: VSOutput) -> @location(0) vec4f {          
      ...
      ${z.additionalColorContribution}
      
      ${v}
    }
  `;return{vertex:{code:B,entryPoint:"main"},fragment:{code:W,entryPoint:"main"}}},ys=(o,e=null)=>{let t=e?.chunks;const s=`
