...
@fragment fn main(fsInput: VSOutput) -> @location(0) vec4f {
  ...
  `;e=e??{};let z=e.chunks;z?(z.additionalFragmentHead||(z.additionalFragmentHead=U),z.preliminaryColorContribution||(z.preliminaryColorContribution=Z),z.ambientContribution||(z.ambientContribution=Q),z.lightContribution||(z.lightContribution=X),z.additionalColorContribution||(z.additionalColorContribution=N)):z={additionalFragmentHead:U,ambientContribution:Q,preliminaryColorContribution:Z,lightContribution:X,additionalColorContribution:N};const L=`
    // PBR
    const PI = ${Math.PI};
  ...
  `;return{vertex:{code:b,entryPoint:"main"},fragment:{code:L,entryPoint:"main"}}},ys=(o,e=null)=>{let t=e?.chunks;const s=`
