...
//#region src/extras/buffers/IndirectBuffer.ts
...
var IndirectBuffer = class {
	...
	*/
	#createIndirectBuffer() {
		...
		this.geometries.forEach((geometry) => {
			...
			geometry.useIndirectBuffer({
				buffer: this.buffer,
				offset: this.getByteOffsetAtIndex(offset)
			});
			offset++;
		});
	...
	*/
	create() {
		if (this.renderer.ready) this.#createIndirectBuffer();
		else {
	...
	* @private
	*/
	#addGeometryToIndirectMappedBuffer(geometry, mappedBuffer, index = 0) {
