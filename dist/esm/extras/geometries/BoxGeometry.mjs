...
//#region src/extras/geometries/BoxGeometry.ts
/**
...
var BoxGeometry = class extends IndexedGeometry {
	constructor({ instancesCount = 1, vertexBuffers = [], topology, mapBuffersAtCreation = true, widthSegments = 1, heightSegments = 1, depthSegments = 1 } = {}) {
		super({
			verticesOrder: "ccw",
			topology,
			instancesCount,
