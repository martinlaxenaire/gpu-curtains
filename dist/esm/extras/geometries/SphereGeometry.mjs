...
//#region src/extras/geometries/SphereGeometry.ts
/**
...
var SphereGeometry = class extends IndexedGeometry {
	constructor({ topology, instancesCount = 1, vertexBuffers = [], mapBuffersAtCreation = true, widthSegments = 32, heightSegments = 16, phiStart = 0, phiLength = Math.PI * 2, thetaStart = 0, thetaLength = Math.PI } = {}) {
		super({
			verticesOrder: "ccw",
			topology,
			instancesCount,
