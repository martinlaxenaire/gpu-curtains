...
//#region src/curtains/GPUCurtains.ts
/**
...
var GPUCurtains = class {
	...
	setContainer(container) {
		if (!container) {
			...
			if (!container) {
				...
				document.body.appendChild(container);
				this.options.container = container;
			} else this.options.container = container;
		} else if (container instanceof Element) this.options.container = container;
	...
	*/
	setMainRenderer() {
		if (this.options.adapterOptions.featureLevel === "compatibility") {
			if (this.options.lights === void 0 || this.options.lights && !this.options.lights.useUniformsForShadows) this.options.lights = {
				...this.options.lights,
	...
	*/
	createCurtainsRenderer(parameters) {
		parameters = this.patchRendererOptions(parameters);
		return new GPUCurtainsRenderer({
			...parameters,
			deviceManager: this.deviceManager
		});
	}
	...
	*/
	onContextDestroyed(callback) {
		if (callback) this._onContextDestroyedCallback = callback;
		return this;
	}
	/**
