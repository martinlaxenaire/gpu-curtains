...
class GPUDeviceManager {
  ...
  generateMips(texture, commandEncoder = null) {
    ...
    if (!__privateGet(this, _mipsGeneration).pipelineByFormatAndView[texture.texture.format + textureBindingViewDimension]) {
      const entryPoint = `fs${textureBindingViewDimension.replace(/[\W]/, "")}`;
      __privateGet(this, _mipsGeneration).pipelineByFormatAndView[texture.texture.format + textureBindingViewDimension] = this.device.createRenderPipeline({
    ...
    const pipeline = __privateGet(this, _mipsGeneration).pipelineByFormatAndView[texture.texture.format + textureBindingViewDimension];
