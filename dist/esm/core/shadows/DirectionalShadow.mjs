...
//#region src/core/shadows/DirectionalShadow.ts
/** @ignore */
...
*/
var DirectionalShadow = class extends Shadow {
	/**
	...
	*/
	cast({ intensity, bias, normalBias, pcfSamples, radius, depthTextureSize, depthTextureFormat, autoRender, useRenderBundle, camera } = {}) {
		if (camera) {
			...
			this.camera.near = camera.near ?? .1;
