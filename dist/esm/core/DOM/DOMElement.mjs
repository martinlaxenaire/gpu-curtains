...
//#region src/core/DOM/DOMElement.ts
/**
...
var DOMElement = class {
	...
	*/
	set boundingRect(boundingRect) {
		...
		if (!isSameRect) this.onSizeChanged(this.boundingRect);
	}
	/**
	...
	*/
	updateScrollPosition(delta = {
		...
		if (delta.x || delta.y) this.onPositionChanged(this.boundingRect);
	}
	/**
