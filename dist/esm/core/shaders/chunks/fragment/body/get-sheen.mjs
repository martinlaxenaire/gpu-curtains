...
//#region src/core/shaders/chunks/fragment/body/get-sheen.ts
/**
...
*/
const getSheen = ({ extensionsUsed = [], sheenTexture = null, sheenColorTexture = null, sheenRoughnessTexture = null } = {}) => {
	let sheen = `
  var sheenSpecularDirect: vec3f = vec3(0.0);
  var sheenSpecularIndirect: vec3f = vec3(0.0);`;
	if (!extensionsUsed.includes("KHR_materials_sheen")) return sheen;
	if (sheenTexture) {
