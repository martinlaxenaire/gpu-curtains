//#region src/core/shaders/chunks/fragment/body/declare-material-vars.ts
/**
...
*/
const declareMaterialVars = ({ materialUniform = null, materialUniformName = "material", shadingModel = "PBR", environmentMap = null } = {}) => {
	...
	let usedMaterialVars = (() => {
		switch (shadingModel) {
			case "Unlit": return defaultMaterialVars;
			case "Lambert": return defaultLambertMaterialVars;
			case "Phong": return defaultPhongMaterialVars;
			default: return defaultPBRMaterialVars;
		}
	})();
	if (!!environmentMap && shadingModel === "PBR") usedMaterialVars = {
		...usedMaterialVars,
		...defaultEnvMaterialVars
	};
  ...
  var ${key}: ${usedMaterialVars[key].type} = ${usedMaterialVars[key].value};`;
	...
	if (shadingModel === "Phong") if (materialStruct.shininess) materialVars += `
