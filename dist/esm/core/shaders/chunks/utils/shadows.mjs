import { getLambert, getPhong } from './lights.mjs';

const getDefaultShadowDepthVs = (lightShadowIndex = 0) => (
  /* wgsl */
  `
@vertex fn main(
...
const getDefaultPointShadowDepthVs = (pointShadowIndex = 0) => (
  /* wgsl */
  `
...
export { getDefaultPointShadowDepthFs, getDefaultPointShadowDepthVs, getDefaultShadowDepthVs, getLambertWithShadows, getPCFDirectionalShadows, getPCFPointShadowContribution, getPCFPointShadows, getPCFShadowContribution, getPhongWithShadows };
